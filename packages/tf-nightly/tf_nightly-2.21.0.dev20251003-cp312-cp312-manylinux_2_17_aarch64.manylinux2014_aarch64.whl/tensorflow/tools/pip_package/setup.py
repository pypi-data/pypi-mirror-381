...
# result for pip.
_VERSION = '2.21.0-dev20251003'

cuda_version = 12
cuda_wheel_suffix = '-cu12'

nvidia_cublas_version = '>=12.5.3.2,<13.0'
nvidia_cuda_cupti_version = '>=12.5.82,<13.0'
nvidia_cuda_nvcc_version = '>=12.5.82,<13.0'
nvidia_cuda_runtime_version = '>=12.5.82,<13.0'
nvidia_cudnn_version = '>=9.3.0.75,<10.0'
nvidia_cufft_version = '>=11.2.3.61,<12.0'
nvidia_cusolver_version = '>=11.6.3.83,<12.0'
nvidia_cusparse_version = '>=12.5.1.3,<13.0'
nvidia_nccl_version = '>=2.27.7,<3.0'
nvidia_nvjitlink_version = '>=12.5.82,<13.0'
nvidia_cuda_nvrtc_version = '>=12.5.82,<13.0'
nvidia_curand_version = '>=10.3.6.82,<11.0'
