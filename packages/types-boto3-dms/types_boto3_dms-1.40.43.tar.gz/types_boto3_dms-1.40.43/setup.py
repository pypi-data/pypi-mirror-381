"""
Setup script for types-boto3-dms.
...
setup(
    ...
    version="1.40.43",
    packages=["types_boto3_dms"],
    url="https://github.com/youtype/mypy_boto3_builder",
    license="MIT License",
    author="Vlad Emelianov",
    author_email="vlad.emelianov.nz@gmail.com",
    description="Type annotations for boto3 DatabaseMigrationService 1.40.43 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    package_data={"types_boto3_dms": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
