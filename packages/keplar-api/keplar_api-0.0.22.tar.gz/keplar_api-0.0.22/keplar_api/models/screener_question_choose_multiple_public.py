...
class ScreenerQuestionChooseMultiplePublic(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "question", "options", "randomizeOrder", "showSelectAllOfAbove", "showSelectNoneOfAbove"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScreenerQuestionChooseMultiplePublic from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScreenerQuestionChooseMultiplePublic from a dict"""
        if obj is None:
            return None
