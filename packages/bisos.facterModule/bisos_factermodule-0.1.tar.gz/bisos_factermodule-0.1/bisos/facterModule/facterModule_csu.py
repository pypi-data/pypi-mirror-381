...
####+BEGIN: b:py3:cs:cmnd/classHead :cmndName "targetRun" :comment "" :extent "verify" :ro "cli" :parsMand "upload" :parsOpt "targetFile" :argsMin 0 :argsMax 9999 :pyInv ""
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  CmndSvc-   [[elisp:(outline-show-subtree+toggle)][||]] <<targetRun>>  =verify= parsMand=upload parsOpt=targetFile argsMax=9999 ro=cli   [[elisp:(org-cycle)][| ]]
#+end_org """
class targetRun(cs.Cmnd):
    cmndParamsMandatory = [ 'upload', ]
    cmndParamsOptional = [ 'targetFile', ]
    ...
    def cmnd(self,
        ...
        failed = b_io.eh.badOutcome
        callParamsDict = {'upload': upload, 'targetFile': targetFile, }
