...
(setq  b:py:cs:csuList
  (list
   ...
   "bisos.facterModule.facterModule_csu"
   "plantedCsu"
 ))
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | bisos.csPlayer.bleep | bisos.loadAsCs.loadAsCs_csu | bisos.facterModule.facterModule_csu | plantedCsu |
#+end_org """
...
from bisos.facterModule import facterModule_csu

csuList = [ 'bisos.b.cs.ro', 'bisos.csPlayer.bleep', 'bisos.loadAsCs.loadAsCs_csu', 'bisos.facterModule.facterModule_csu', 'plantedCsu', ]
...
from bisos.facter import loader_facter
