...
class GetAccountBalanceApi:
    ...
    def get_balance(self, x_ibm_client_id, x_request_id, account_number, psu_ip_address=None, **kwargs) -> "GetBalance200Response":
        ...
        :param account_number: The number of account without prefix and bankCode (required)
        ...
        :rtype: GetBalance200Response
        """
        if x_ibm_client_id is None:
            raise ValueError("Missing the required parameter `x_ibm_client_id` when calling `get_balance`")
        if x_request_id is None:
            raise ValueError("Missing the required parameter `x_request_id` when calling `get_balance`")
        if account_number is None:
            raise ValueError("Missing the required parameter `account_number` when calling `get_balance`")

        # Construct URL
        url = self.api_client.configuration.host + "/rbcz/premium/api/accounts/{accountNumber}/balance"
        ...
        response = self.api_client.call_api(
            resource_path="/rbcz/premium/api/accounts/{accountNumber}/balance",
            method="GET",
            headers=headers,
            query_params=query_params,
            body=body,
            response_type="GetBalance200Response",
            **kwargs
        )
