...
import unittest
from rbczpremiumapi.Model. GetTransactionList200ResponseTransactionsInnerEntryDetails

class TestGetTransactionList200ResponseTransactionsInnerEntryDetails(unittest.TestCase):
    """GetTransactionList200ResponseTransactionsInnerEntryDetails unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetTransactionList200ResponseTransactionsInnerEntryDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetTransactionList200ResponseTransactionsInnerEntryDetails(
            )
        else:
            return GetTransactionList200ResponseTransactionsInnerEntryDetails(
            )
