...
import unittest
from rbczpremiumapi.PremiumAPI.download_statement_api import DownloadStatementApi

class TestDownloadStatementApi(unittest.TestCase):
    """DownloadStatementApi unit test stubs"""

    def setUp(self):
        self.api = DownloadStatementApi()

    def tearDown(self):
        pass

    def test_download_statement(self):
        """Test case for download_statement
