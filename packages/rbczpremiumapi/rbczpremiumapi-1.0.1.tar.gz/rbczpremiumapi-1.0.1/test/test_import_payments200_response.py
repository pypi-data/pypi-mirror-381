...
import unittest
from rbczpremiumapi.Model. ImportPayments200Response

class TestImportPayments200Response(unittest.TestCase):
    """ImportPayments200Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test ImportPayments200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return ImportPayments200Response(
            )
        else:
            return ImportPayments200Response(
            )
