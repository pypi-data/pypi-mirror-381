...
import unittest
from rbczpremiumapi.Model. ImportPayments415Response

class TestImportPayments415Response(unittest.TestCase):
    """ImportPayments415Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test ImportPayments415Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return ImportPayments415Response(
            )
        else:
            return ImportPayments415Response(
            )
