...
import unittest
from rbczpremiumapi.PremiumAPI.get_batch_detail_api import GetBatchDetailApi

class TestGetBatchDetailApi(unittest.TestCase):
    """GetBatchDetailApi unit test stubs"""

    def setUp(self):
        self.api = GetBatchDetailApi()

    def tearDown(self):
        pass

    def test_get_batch_detail(self):
        """Test case for get_batch_detail
