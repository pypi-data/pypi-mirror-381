...
import unittest
from rbczpremiumapi.PremiumAPI.get_fx_rates_list_api import GetFxRatesListApi

class TestGetFxRatesListApi(unittest.TestCase):
    """GetFxRatesListApi unit test stubs"""

    def setUp(self):
        self.api = GetFxRatesListApi()

    def tearDown(self):
        pass

    def test_get_fx_rates_list(self):
        """Test case for get_fx_rates_list
