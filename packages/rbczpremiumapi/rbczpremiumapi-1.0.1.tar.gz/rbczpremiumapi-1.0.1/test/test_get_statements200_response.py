...
import unittest
from rbczpremiumapi.Model. GetStatements200Response

class TestGetStatements200Response(unittest.TestCase):
    """GetStatements200Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetStatements200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetStatements200Response(
            )
        else:
            return GetStatements200Response(
            )
