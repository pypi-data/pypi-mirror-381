...
class GetStatementListApi:
    ...
    def get_statements(self, x_ibm_client_id, x_request_id, request_body, psu_ip_address=None, page=None, size=None, **kwargs) -> "GetStatements200Response":
        ...
        :type request_body: GetStatementsRequest
        ...
        :rtype: GetStatements200Response
        """
        if x_ibm_client_id is None:
            raise ValueError("Missing the required parameter `x_ibm_client_id` when calling `get_statements`")
        if x_request_id is None:
            raise ValueError("Missing the required parameter `x_request_id` when calling `get_statements`")
        if request_body is None:
            raise ValueError("Missing the required parameter `request_body` when calling `get_statements`")

        # Construct URL
        url = self.api_client.configuration.host + "/rbcz/premium/api/accounts/statements"
        ...
        response = self.api_client.call_api(
            resource_path="/rbcz/premium/api/accounts/statements",
            method="POST",
            headers=headers,
            query_params=query_params,
            body=body,
            response_type="GetStatements200Response",
            **kwargs
        )
