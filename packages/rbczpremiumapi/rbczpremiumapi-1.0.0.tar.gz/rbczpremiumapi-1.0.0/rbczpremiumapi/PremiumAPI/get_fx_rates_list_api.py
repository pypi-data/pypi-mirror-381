...
class GetFxRatesListApi:
    ...
    def get_fx_rates_list(self, x_ibm_client_id, x_request_id, psu_ip_address=None, var_date=None, **kwargs) -> "CurrencyListSimple":
        ...
        :param var_date: The effective date for which the FX rates list is requested. Will default to **now** when not specified.
        ...
        if x_ibm_client_id is None:
            raise ValueError("Missing the required parameter `x_ibm_client_id` when calling `get_fx_rates_list`")
        if x_request_id is None:
            raise ValueError("Missing the required parameter `x_request_id` when calling `get_fx_rates_list`")

        # Construct URL
        url = self.api_client.configuration.host + "/rbcz/premium/api/fxrates"
        ...
        response = self.api_client.call_api(
            resource_path="/rbcz/premium/api/fxrates",
            method="GET",
            headers=headers,
