...
import unittest
from rbczpremiumapi.Model. GetBalance403Response

class TestGetBalance403Response(unittest.TestCase):
    """GetBalance403Response unit test stubs"""
