...
import unittest
from rbczpremiumapi.Model. GetTransactionList200ResponseTransactionsInner

class TestGetTransactionList200ResponseTransactionsInner(unittest.TestCase):
    """GetTransactionList200ResponseTransactionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetTransactionList200ResponseTransactionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetTransactionList200ResponseTransactionsInner(
            )
        else:
            return GetTransactionList200ResponseTransactionsInner(
            )
