...
import unittest
from rbczpremiumapi.Model. GetStatements200ResponseStatementsInner

class TestGetStatements200ResponseStatementsInner(unittest.TestCase):
    """GetStatements200ResponseStatementsInner unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetStatements200ResponseStatementsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetStatements200ResponseStatementsInner(
            )
        else:
            return GetStatements200ResponseStatementsInner(
            )
