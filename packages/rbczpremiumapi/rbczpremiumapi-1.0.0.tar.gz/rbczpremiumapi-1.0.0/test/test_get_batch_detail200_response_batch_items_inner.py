...
import unittest
from rbczpremiumapi.Model. GetBatchDetail200ResponseBatchItemsInner

class TestGetBatchDetail200ResponseBatchItemsInner(unittest.TestCase):
    """GetBatchDetail200ResponseBatchItemsInner unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        ...
        if include_optional:
            return GetBatchDetail200ResponseBatchItemsInner(
            )
        else:
            return GetBatchDetail200ResponseBatchItemsInner(
            )
