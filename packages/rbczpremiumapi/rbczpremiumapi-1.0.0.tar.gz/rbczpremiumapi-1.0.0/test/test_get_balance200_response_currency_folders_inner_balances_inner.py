...
import unittest
from rbczpremiumapi.Model. GetBalance200ResponseCurrencyFoldersInnerBalancesInner

class TestGetBalance200ResponseCurrencyFoldersInnerBalancesInner(unittest.TestCase):
    """GetBalance200ResponseCurrencyFoldersInnerBalancesInner unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetBalance200ResponseCurrencyFoldersInnerBalancesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetBalance200ResponseCurrencyFoldersInnerBalancesInner(
            )
        else:
            return GetBalance200ResponseCurrencyFoldersInnerBalancesInner(
            )
