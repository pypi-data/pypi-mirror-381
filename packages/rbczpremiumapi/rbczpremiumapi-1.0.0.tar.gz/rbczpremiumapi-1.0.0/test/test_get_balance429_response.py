...
import unittest
from rbczpremiumapi.Model. GetBalance429Response

class TestGetBalance429Response(unittest.TestCase):
    """GetBalance429Response unit test stubs"""
