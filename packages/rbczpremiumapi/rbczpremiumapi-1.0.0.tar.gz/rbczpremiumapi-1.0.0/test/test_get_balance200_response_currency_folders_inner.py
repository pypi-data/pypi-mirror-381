...
import unittest
from rbczpremiumapi.Model. GetBalance200ResponseCurrencyFoldersInner

class TestGetBalance200ResponseCurrencyFoldersInner(unittest.TestCase):
    """GetBalance200ResponseCurrencyFoldersInner unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        ...
        if include_optional:
            return GetBalance200ResponseCurrencyFoldersInner(
            )
        else:
            return GetBalance200ResponseCurrencyFoldersInner(
            )
