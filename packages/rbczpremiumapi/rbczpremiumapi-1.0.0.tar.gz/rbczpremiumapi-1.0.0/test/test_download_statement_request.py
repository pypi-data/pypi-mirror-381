...
import unittest
from rbczpremiumapi.Model. DownloadStatementRequest

class TestDownloadStatementRequest(unittest.TestCase):
    """DownloadStatementRequest unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        ...
        if include_optional:
            return DownloadStatementRequest(
            )
        else:
            return DownloadStatementRequest(
            )
