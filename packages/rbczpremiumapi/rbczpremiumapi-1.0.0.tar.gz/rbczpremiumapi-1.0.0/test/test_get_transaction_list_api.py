...
import unittest
from rbczpremiumapi.PremiumAPI.get_transaction_list_api import GetTransactionListApi

class TestGetTransactionListApi(unittest.TestCase):
    """GetTransactionListApi unit test stubs"""

    def setUp(self):
        self.api = GetTransactionListApi()
