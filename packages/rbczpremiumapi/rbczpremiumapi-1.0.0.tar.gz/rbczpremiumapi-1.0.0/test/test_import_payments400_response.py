...
import unittest
from rbczpremiumapi.Model. ImportPayments400Response

class TestImportPayments400Response(unittest.TestCase):
    """ImportPayments400Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        ...
        if include_optional:
            return ImportPayments400Response(
            )
        else:
            return ImportPayments400Response(
            )
