...
import unittest
from rbczpremiumapi.Model. GetAccounts200ResponseAccountsInner

class TestGetAccounts200ResponseAccountsInner(unittest.TestCase):
    """GetAccounts200ResponseAccountsInner unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetAccounts200ResponseAccountsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetAccounts200ResponseAccountsInner(
            )
        else:
            return GetAccounts200ResponseAccountsInner(
            )
