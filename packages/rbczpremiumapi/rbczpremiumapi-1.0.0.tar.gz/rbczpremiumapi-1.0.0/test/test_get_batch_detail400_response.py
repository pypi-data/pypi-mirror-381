...
import unittest
from rbczpremiumapi.Model. GetBatchDetail400Response

class TestGetBatchDetail400Response(unittest.TestCase):
    """GetBatchDetail400Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetBatchDetail400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetBatchDetail400Response(
            )
        else:
            return GetBatchDetail400Response(
            )
