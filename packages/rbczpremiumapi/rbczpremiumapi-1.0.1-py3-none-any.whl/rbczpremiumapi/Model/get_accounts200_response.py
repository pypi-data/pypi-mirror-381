...
if TYPE_CHECKING:
    from .get_accounts200_response_accounts_inner import GetAccounts200ResponseAccountsInner
...
class GetAccounts200Response(BaseModel):
    ...
    accounts: Optional[List['GetAccounts200ResponseAccountsInner']] = None
