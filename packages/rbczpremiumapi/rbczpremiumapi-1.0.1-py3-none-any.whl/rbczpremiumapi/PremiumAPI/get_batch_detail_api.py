...
class GetBatchDetailApi:
    ...
    def get_batch_detail(self, x_ibm_client_id, x_request_id, batch_file_id, psu_ip_address=None, **kwargs) -> "GetBatchDetail200Response":
        ...
        :param batch_file_id: Batch file id  (required)
        :type batch_file_id: int
        ...
        :rtype: GetBatchDetail200Response
        """
        if x_ibm_client_id is None:
            raise ValueError("Missing the required parameter `x_ibm_client_id` when calling `get_batch_detail`")
        if x_request_id is None:
            raise ValueError("Missing the required parameter `x_request_id` when calling `get_batch_detail`")
        if batch_file_id is None:
            raise ValueError("Missing the required parameter `batch_file_id` when calling `get_batch_detail`")

        # Construct URL
        url = self.api_client.configuration.host + "/rbcz/premium/api/payments/batches/{batchFileId}"
        url = url.replace("{" + "batch_file_id" + "}", str(batch_file_id))
        ...
        response = self.api_client.call_api(
            resource_path="/rbcz/premium/api/payments/batches/{batchFileId}",
            method="GET",
            headers=headers,
            query_params=query_params,
            body=body,
            response_type="GetBatchDetail200Response",
            **kwargs
        )
