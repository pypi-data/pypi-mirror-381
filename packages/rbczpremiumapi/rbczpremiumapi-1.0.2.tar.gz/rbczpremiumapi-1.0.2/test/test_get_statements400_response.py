...
import unittest
from rbczpremiumapi.Model. GetStatements400Response

class TestGetStatements400Response(unittest.TestCase):
    """GetStatements400Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetStatements400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetStatements400Response(
            )
        else:
            return GetStatements400Response(
            )
