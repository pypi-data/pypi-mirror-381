...
import unittest
from rbczpremiumapi.Model. GetTransactionList400Response

class TestGetTransactionList400Response(unittest.TestCase):
    """GetTransactionList400Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        ...
        if include_optional:
            return GetTransactionList400Response(
            )
        else:
            return GetTransactionList400Response(
            )
