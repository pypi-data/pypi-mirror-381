...
import unittest
from rbczpremiumapi.Model. GetBalance401Response

class TestGetBalance401Response(unittest.TestCase):
    """GetBalance401Response unit test stubs"""
