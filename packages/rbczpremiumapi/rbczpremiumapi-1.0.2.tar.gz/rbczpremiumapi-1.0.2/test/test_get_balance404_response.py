...
import unittest
from rbczpremiumapi.Model. GetBalance404Response

class TestGetBalance404Response(unittest.TestCase):
    """GetBalance404Response unit test stubs"""
