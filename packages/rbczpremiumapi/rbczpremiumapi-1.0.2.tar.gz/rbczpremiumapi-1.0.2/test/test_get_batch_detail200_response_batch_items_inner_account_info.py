...
import unittest
from rbczpremiumapi.Model. GetBatchDetail200ResponseBatchItemsInnerAccountInfo

class TestGetBatchDetail200ResponseBatchItemsInnerAccountInfo(unittest.TestCase):
    """GetBatchDetail200ResponseBatchItemsInnerAccountInfo unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetBatchDetail200ResponseBatchItemsInnerAccountInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetBatchDetail200ResponseBatchItemsInnerAccountInfo(
            )
        else:
            return GetBatchDetail200ResponseBatchItemsInnerAccountInfo(
            )
