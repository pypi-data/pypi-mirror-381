...
import unittest
from rbczpremiumapi.Model. GetBatchDetail200Response

class TestGetBatchDetail200Response(unittest.TestCase):
    """GetBatchDetail200Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        """Test GetBatchDetail200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return GetBatchDetail200Response(
            )
        else:
            return GetBatchDetail200Response(
            )
