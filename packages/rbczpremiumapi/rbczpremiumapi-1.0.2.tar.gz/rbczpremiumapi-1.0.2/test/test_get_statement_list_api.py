...
import unittest
from rbczpremiumapi.PremiumAPI.get_statement_list_api import GetStatementListApi

class TestGetStatementListApi(unittest.TestCase):
    """GetStatementListApi unit test stubs"""

    def setUp(self):
        self.api = GetStatementListApi()
