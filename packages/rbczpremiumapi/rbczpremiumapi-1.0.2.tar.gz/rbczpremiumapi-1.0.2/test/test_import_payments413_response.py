...
import unittest
from rbczpremiumapi.Model. ImportPayments413Response

class TestImportPayments413Response(unittest.TestCase):
    """ImportPayments413Response unit test stubs"""
    ...
    def make_instance(self, include_optional=False):
        ...
        if include_optional:
            return ImportPayments413Response(
            )
        else:
            return ImportPayments413Response(
            )
