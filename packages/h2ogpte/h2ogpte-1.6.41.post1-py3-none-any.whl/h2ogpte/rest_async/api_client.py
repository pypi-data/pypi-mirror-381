...
from h2ogpte.rest_async.api_response import ApiResponse, T as ApiResponseT
import h2ogpte.rest_async.models
from h2ogpte.rest_async import rest
from h2ogpte.rest_async.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.6.41-post1/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(h2ogpte.rest_async.models, klass)
