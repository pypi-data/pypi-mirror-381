...
from h2ogpte.rest_sync.api_response import ApiResponse, T as ApiResponseT
import h2ogpte.rest_sync.models
from h2ogpte.rest_sync import rest
from h2ogpte.rest_sync.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(h2ogpte.rest_sync.models, klass)
