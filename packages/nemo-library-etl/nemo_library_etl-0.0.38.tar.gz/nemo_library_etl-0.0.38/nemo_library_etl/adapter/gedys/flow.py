...
def extract(cfg: PipelineGedys, logger: Union[logging.Logger, object]) -> None:
    """
...
def transform(cfg: PipelineGedys, logger: Union[logging.Logger, object]) -> None:
    """
...
def load(cfg: PipelineGedys, logger: Union[logging.Logger, object]) -> None:
    """
