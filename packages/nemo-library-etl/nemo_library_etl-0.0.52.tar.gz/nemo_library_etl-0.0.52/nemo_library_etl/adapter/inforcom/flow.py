...
def extract(cfg: PipelineInforCOM, logger: Union[logging.Logger, object]) -> None:
    """
...
def transform(cfg: PipelineInforCOM, logger: Union[logging.Logger, object]) -> None:
    """
...
def load(cfg: PipelineInforCOM, logger: Union[logging.Logger, object]) -> None:
    """
