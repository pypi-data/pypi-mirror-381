...
from nemo_library_etl.adapter.reppl.config_models import PipelineRepPL
...
class RepPLTransform:
    ...
    def __init__(self, cfg: PipelineRepPL):
        """
        Initialize the RepPLTransform instance.
    ...
    def transform(self) -> None:
        ...
        data = file_handler.readJSONL(
            adapter=ETLAdapter.REPPL, step=ETLStep.EXTRACT, entity="pl"
        )
        ...
        file_handler.writeJSONL(
            adapter=ETLAdapter.REPPL,
