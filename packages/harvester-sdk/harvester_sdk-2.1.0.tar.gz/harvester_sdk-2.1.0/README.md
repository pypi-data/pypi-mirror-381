...
### Agentic Commands
- `harvester agent-grok` - **Grok Code Agent** - Fast agentic coding (grok-code-fast-1)
- `harvester agent-claude` - **Claude Code Agent** - Professional coding with Claude Agent SDK
...
**Features:**
- ⚡ **4x faster** than traditional agents
- 💰 **1/10th the cost** of comparable solutions
- 🧰 **11 specialized tools**: file operations, JSON tools (corruption-proof), command execution, directory management
- 🔁 **100 max iterations** with loop detection
- 🎯 **Streaming reasoning traces** - Watch the agent think in real-time
- 📝 **Smart tool selection** - JSON tools, text tools, edit tools automatically chosen
...
- ⚙️ **Subagents** - Parallel task execution
- 📚 **Comprehensive verification** - Built-in quality checks
...
| **Quality** | ✅ Excellent | ✅✅ Maximum thoroughness |
