...
cols = [
    ...
    Col(
        'img', 'Sketch 3', 'images/sketch_*_3.svg', None, 'background: #e9f9fe'
    ),  # set background to light blue for this column
]
...
imagetable(
    ...
    style=(
        ...
        '-webkit-box-shadow: 2px 2px 1px #ccc; box-shadow: 2px 2px 1px #ccc;}'
    ),
)
