...
class BillingAccountMigrationSubscriptionLifecycle(ModelNormal):
    ...
    @strategy.setter
    def strategy(self, new_value):
       self.strategy = new_value
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, strategy, *args, **kwargs):  # noqa: E501
        """BillingAccountMigrationSubscriptionLifecycle - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, strategy, *args, **kwargs):  # noqa: E501
        """BillingAccountMigrationSubscriptionLifecycle - a model defined in OpenAPI
