...
class SimpleResourcePolicyTemplate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, policy_structure, rules, template_type, *args, **kwargs):  # noqa: E501
        """SimpleResourcePolicyTemplate - a model defined in OpenAPI

        Args:
            policy_structure ([SimpleResourcePolicyTemplateStructure]): The list of trees defining the structure of this policy. 
            rules ([RuleConfig]): The rules which may be used in the `policy_structure`. A given rule is only applied by the policy if it is referenced by at least one policy_structure node. 
    ...
    @convert_js_args_to_python_args
    def __init__(self, policy_structure, rules, template_type, *args, **kwargs):  # noqa: E501
        """SimpleResourcePolicyTemplate - a model defined in OpenAPI
