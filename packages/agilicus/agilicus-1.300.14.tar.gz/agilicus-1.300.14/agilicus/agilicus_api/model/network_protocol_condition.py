...
class NetworkProtocolCondition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, condition_type, protocol, *args, **kwargs):  # noqa: E501
        """NetworkProtocolCondition - a model defined in OpenAPI

        Args:
            condition_type (str): The discriminator for the condition
            protocol (str): The specific protocol. 
    ...
    @convert_js_args_to_python_args
    def __init__(self, condition_type, protocol, *args, **kwargs):  # noqa: E501
        """NetworkProtocolCondition - a model defined in OpenAPI
