...
class ServiceAccountSpec(ModelNormal):
    ...
    @property
    def protected_by_id(self):
       return self.get("protected_by_id")

    @protected_by_id.setter
    def protected_by_id(self, new_value):
       self.protected_by_id = new_value

    @property
    def protected_by_type(self):
       return self.get("protected_by_type")

    @protected_by_type.setter
    def protected_by_type(self, new_value):
       self.protected_by_type = new_value
    ...
    def openapi_types():
        ...
        return {
            ...
            'protected_by_id': (str, none_type,),  # noqa: E501
            'protected_by_type': (str, none_type,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'protected_by_id': 'protected_by_id',  # noqa: E501
        'protected_by_type': 'protected_by_type',  # noqa: E501
    }
