...
class SourceSubnetCondition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, condition_type, subnets, *args, **kwargs):  # noqa: E501
        """SourceSubnetCondition - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, condition_type, subnets, *args, **kwargs):  # noqa: E501
        """SourceSubnetCondition - a model defined in OpenAPI
