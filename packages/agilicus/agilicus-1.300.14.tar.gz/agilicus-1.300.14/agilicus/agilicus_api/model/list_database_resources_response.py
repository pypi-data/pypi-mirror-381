...
class ListDatabaseResourcesResponse(ModelNormal):
    ...
    def database_resources(self):
       return self.get("database_resources")

    @database_resources.setter
    def database_resources(self, new_value):
       self.database_resources = new_value
    ...
    def _from_openapi_data(cls, limit, *args, **kwargs):  # noqa: E501
        """ListDatabaseResourcesResponse - a model defined in OpenAPI
