...
class OrganisationCapabilities(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'features': ([FeatureTagName],),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, features, *args, **kwargs):  # noqa: E501
        """OrganisationCapabilities - a model defined in OpenAPI
