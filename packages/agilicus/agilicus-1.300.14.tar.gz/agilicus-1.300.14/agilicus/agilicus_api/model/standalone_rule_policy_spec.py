...
def lazy_import():
    ...
    globals()['EmptiableObjectType'] = EmptiableObjectType
    globals()['StandaloneRulePolicyDescription'] = StandaloneRulePolicyDescription


class StandaloneRulePolicySpec(ModelNormal):
    ...
    @object_id.setter
    def object_id(self, new_value):
       self.object_id = new_value

    @property
    def policy_class(self):
       return self.get("policy_class")

    @policy_class.setter
    def policy_class(self, new_value):
       self.policy_class = new_value

    @property
    def policy_instance(self):
       return self.get("policy_instance")

    @policy_instance.setter
    def policy_instance(self, new_value):
       self.policy_instance = new_value
    ...
    def openapi_types():
        ...
        return {
            ...
            'object_type': (EmptiableObjectType,),  # noqa: E501
            'object_id': (str,),  # noqa: E501
            'policy_class': (str,),  # noqa: E501
            'policy_instance': (str,),  # noqa: E501
            'description': (StandaloneRulePolicyDescription,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'policy_class': 'policy_class',  # noqa: E501
        'policy_instance': 'policy_instance',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, org_id, object_type, object_id, policy_class, policy_instance, *args, **kwargs):  # noqa: E501
        """StandaloneRulePolicySpec - a model defined in OpenAPI

        Args:
            org_id (str): Unique identifier
            object_type (EmptiableObjectType):
        ...
        Keyword Args:
            ...
            description (StandaloneRulePolicyDescription): [optional]  # noqa: E501
            annotations ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): A simple object used to track details about how the policy is used (E.g. template version). . [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, org_id, object_type, object_id, policy_class, policy_instance, *args, **kwargs):  # noqa: E501
        """StandaloneRulePolicySpec - a model defined in OpenAPI
