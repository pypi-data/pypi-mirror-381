...
class CompoundRuleCondition(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, condition_type, condition_list, list_type, *args, **kwargs):  # noqa: E501
        """CompoundRuleCondition - a model defined in OpenAPI

        Args:
            condition_type (str): The discriminator for the condition
            condition_list ([RuleCondition]): The list of conditions whose truth determines the truth of the CompoundRuleCondition. How that the conditions' truth is combined depends on `list_type`. 
    ...
    @convert_js_args_to_python_args
    def __init__(self, condition_type, condition_list, list_type, *args, **kwargs):  # noqa: E501
        """CompoundRuleCondition - a model defined in OpenAPI
