...
class RuleAction(ModelNormal):
    ...
    def _from_openapi_data(cls, action, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            log_message (str): The message to log. If multiple actions output a log, the messages will be combined using a \",\" to separate them. . [optional]  # noqa: E501
            path (str): The path to use in related actions. . [optional]  # noqa: E501
        """
