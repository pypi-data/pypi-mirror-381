...
class ListSSHResourcesResponse(ModelNormal):
    ...
    @property
    def ssh_resources(self):
       return self.get("ssh_resources")

    @ssh_resources.setter
    def ssh_resources(self, new_value):
       self.ssh_resources = new_value
    ...
    def _from_openapi_data(cls, limit, *args, **kwargs):  # noqa: E501
        """ListSSHResourcesResponse - a model defined in OpenAPI
