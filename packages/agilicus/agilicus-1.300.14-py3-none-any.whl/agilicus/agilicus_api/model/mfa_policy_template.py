...
class MFAPolicyTemplate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, seconds_since_last_challenge, labels, template_type, *args, **kwargs):  # noqa: E501
        """MFAPolicyTemplate - a model defined in OpenAPI
        ...
        self.seconds_since_last_challenge = seconds_since_last_challenge
        self.labels = labels
    ...
    @convert_js_args_to_python_args
    def __init__(self, seconds_since_last_challenge, labels, template_type, *args, **kwargs):  # noqa: E501
        """MFAPolicyTemplate - a model defined in OpenAPI
