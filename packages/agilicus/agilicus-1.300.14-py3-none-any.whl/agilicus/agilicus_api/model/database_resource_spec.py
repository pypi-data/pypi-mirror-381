...
class DatabaseResourceSpec(ModelNormal):
    ...
    validations = {
        ('name',): {
            'max_length': 63,
            'regex': {
                'pattern': r'^[a-z][a-z0-9-:]+$',  # noqa: E501
            },
        },
        ('database_protocol',): {
            'max_length': 32,
    ...
    @property
    def database_protocol(self):
       return self.get("database_protocol")

    @database_protocol.setter
    def database_protocol(self, new_value):
       self.database_protocol = new_value

    @property
    def data_source_name(self):
       return self.get("data_source_name")

    @data_source_name.setter
    def data_source_name(self, new_value):
       self.data_source_name = new_value

    @property
    def runtime_parameters(self):
       return self.get("runtime_parameters")

    @runtime_parameters.setter
    def runtime_parameters(self, new_value):
       self.runtime_parameters = new_value
    ...
    def openapi_types():
        ...
        return {
            ...
            'database_protocol': (str,),  # noqa: E501
            'data_source_name': (str,),  # noqa: E501
            'org_id': (str,),  # noqa: E501
            'runtime_parameters': ([str],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'database_protocol': 'database_protocol',  # noqa: E501
        'data_source_name': 'data_source_name',  # noqa: E501
        'org_id': 'org_id',  # noqa: E501
        'runtime_parameters': 'runtime_parameters',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, address, database_protocol, data_source_name, org_id, *args, **kwargs):  # noqa: E501
        """DatabaseResourceSpec - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            runtime_parameters ([str]): Extra runtime parameters which can override or extend the ones applied by the client. These will be serialized into the upstream connection depending on the version of the protocol. . [optional]  # noqa: E501
        ...
        self.database_protocol = database_protocol
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, address, database_protocol, data_source_name, org_id, *args, **kwargs):  # noqa: E501
        """DatabaseResourceSpec - a model defined in OpenAPI
