...
class RegionRouting(ModelNormal):
    ...
    def _from_openapi_data(cls, domains, *args, **kwargs):  # noqa: E501
        """RegionRouting - a model defined in OpenAPI

        Args:
            domains ([Domain]): The domains that address this Region. Use these when configuring external systems such as a DNS CNAME or a firewall. 
        ...
        Keyword Args:
            ...
            requests_enabled (bool): If true, allow this Region to serve RoutingRequests.. [optional]  # noqa: E501
            ...
            permitted_user_ids ([str]): A list of user_ids that are permitted for using this region on a routing request. . [optional]  # noqa: E501
