...
class UserSessionIdentifiers(ModelNormal):
    ...
    def tokens_only(self):
       return self.get("tokens_only")

    @tokens_only.setter
    def tokens_only(self, new_value):
       self.tokens_only = new_value
    ...
    attribute_map = {
        ...
        'tokens_only': 'tokens_only',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, user_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            session_id (str): The unique id of an explicit session to revoke. . [optional]  # noqa: E501
