...
class TrustedCertificateLabelSpec(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'name': (TrustedCertificateLabelName,),  # noqa: E501
    ...
    def _from_openapi_data(cls, name, org_id, *args, **kwargs):  # noqa: E501
        """TrustedCertificateLabelSpec - a model defined in OpenAPI

        Args:
            name (TrustedCertificateLabelName):
