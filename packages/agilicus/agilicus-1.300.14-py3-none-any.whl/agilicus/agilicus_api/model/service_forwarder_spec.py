...
class ServiceForwarderSpec(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'application_service_id': (str, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, name, org_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            application_service_id (str, none_type): The application service id that this service forwarder connects to. . [optional]  # noqa: E501
            connector_id (str, none_type): A unique identifier which can be empty. The meaning of it being empty depends on the context in which it is used, but usually it implies that something is not set. . [optional]  # noqa: E501
        """
