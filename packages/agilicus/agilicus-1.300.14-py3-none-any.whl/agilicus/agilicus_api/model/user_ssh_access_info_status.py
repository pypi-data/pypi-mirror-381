...
def lazy_import():
    ...
    globals()['SSHUsername'] = SSHUsername


class UserSSHAccessInfoStatus(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'username': (SSHUsername,),  # noqa: E501
    ...
    def _from_openapi_data(cls, user_id, org_id, org_name, resource_id, resource_name, resource_type, access_level, *args, **kwargs):  # noqa: E501
        """UserSSHAccessInfoStatus - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            hostname (str): The address of the ssh resource. . [optional]  # noqa: E501
            port (int): The port to connect to. If empty, will default to port 22. . [optional]  # noqa: E501
            ...
            gateway_uri (str): Many resources may be accessed via a gateway. This field provides provides the URI for the gateway, if any, providing access to this object. . [optional]  # noqa: E501
            username (SSHUsername): [optional]  # noqa: E501
