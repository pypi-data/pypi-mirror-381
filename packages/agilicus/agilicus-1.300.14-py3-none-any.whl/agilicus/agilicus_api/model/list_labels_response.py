...
class ListLabelsResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, labels, limit, *args, **kwargs):  # noqa: E501
        """ListLabelsResponse - a model defined in OpenAPI

        Args:
            labels ([Label]):
            limit (int): limit of labels in the response
    ...
    @convert_js_args_to_python_args
    def __init__(self, labels, limit, *args, **kwargs):  # noqa: E501
        """ListLabelsResponse - a model defined in OpenAPI
