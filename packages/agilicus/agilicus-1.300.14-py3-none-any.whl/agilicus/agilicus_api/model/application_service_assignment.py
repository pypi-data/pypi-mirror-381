...
class ApplicationServiceAssignment(ModelNormal):
    ...
    @property
    def expose_as_hostnames(self):
       return self.get("expose_as_hostnames")

    @expose_as_hostnames.setter
    def expose_as_hostnames(self, new_value):
       self.expose_as_hostnames = new_value
    ...
    def openapi_types():
        ...
        return {
            ...
            'expose_as_hostnames': ([Domain],),  # noqa: E501
    ...
    attribute_map = {
        ...
        'expose_as_hostnames': 'expose_as_hostnames',  # noqa: E501
