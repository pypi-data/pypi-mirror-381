...
def lazy_import():
    ...
    globals()['StandaloneRulesetBundle'] = StandaloneRulesetBundle


class ListStandaloneRulesetBundlesResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, standalone_ruleset_bundles, limit, *args, **kwargs):  # noqa: E501
        """ListStandaloneRulesetBundlesResponse - a model defined in OpenAPI

        Args:
            standalone_ruleset_bundles ([StandaloneRulesetBundle]): List of StandaloneRulesetBundle
        ...
        self.standalone_ruleset_bundles = standalone_ruleset_bundles
        self.limit = limit
    ...
    @convert_js_args_to_python_args
    def __init__(self, standalone_ruleset_bundles, limit, *args, **kwargs):  # noqa: E501
        """ListStandaloneRulesetBundlesResponse - a model defined in OpenAPI
