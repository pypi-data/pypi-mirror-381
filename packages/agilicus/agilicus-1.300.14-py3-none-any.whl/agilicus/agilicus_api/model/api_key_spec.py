...
class APIKeySpec(ModelNormal):
    ...
    def _from_openapi_data(cls, user_id, org_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): A meaningful name for the api key. Use this to identify its purpose. The name, if set. An empty string is equivalent to it not being set. . [optional]  # noqa: E501
