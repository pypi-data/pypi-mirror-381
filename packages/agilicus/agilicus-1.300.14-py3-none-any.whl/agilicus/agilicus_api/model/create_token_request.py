...
class CreateTokenRequest(ModelNormal):
    ...
    def create_refresh_token(self):
       return self.get("create_refresh_token")

    @create_refresh_token.setter
    def create_refresh_token(self, new_value):
       self.create_refresh_token = new_value

    @property
    def get_user(self):
       return self.get("get_user")

    @get_user.setter
    def get_user(self, new_value):
       self.get_user = new_value
    ...
    def openapi_types():
        ...
        return {
            ...
            'create_refresh_token': (bool,),  # noqa: E501
            'get_user': (bool,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'create_refresh_token': 'create_refresh_token',  # noqa: E501
        'get_user': 'get_user',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, sub, org, audiences, time_validity, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            create_refresh_token (bool): If true, also create and return a refresh token that allows the created token to be specifically refreshed. . [optional]  # noqa: E501
            get_user (bool): If true, the Raw token will also return the user record . [optional]  # noqa: E501
        """
