...
class SourceInfoPolicyTemplate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, labels, template_type, source_subnets, iso_country_codes, invert, action, *args, **kwargs):  # noqa: E501
        """SourceInfoPolicyTemplate - a model defined in OpenAPI

        Args:
            labels ([LabelName]): Restrict the challenge to accesses for resources with one of these labels. 
        ...
        self.source_subnets = source_subnets
    ...
    @convert_js_args_to_python_args
    def __init__(self, labels, template_type, source_subnets, iso_country_codes, invert, action, *args, **kwargs):  # noqa: E501
        """SourceInfoPolicyTemplate - a model defined in OpenAPI
