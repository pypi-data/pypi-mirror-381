...
def lazy_import():
    ...
    globals()['AgentConnectorQueue'] = AgentConnectorQueue


class AgentConnectorQueueResponse(ModelNormal):
    ...
    @queues.setter
    def queues(self, new_value):
       self.queues = new_value
    ...
    def openapi_types():
        ...
        return {
            'limit': (int,),  # noqa: E501
            'queues': ([AgentConnectorQueue],),  # noqa: E501
    ...
    def _from_openapi_data(cls, limit, *args, **kwargs):  # noqa: E501
        """AgentConnectorQueueResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            queues ([AgentConnectorQueue]): List of AgentConnectorQueue. [optional]  # noqa: E501
