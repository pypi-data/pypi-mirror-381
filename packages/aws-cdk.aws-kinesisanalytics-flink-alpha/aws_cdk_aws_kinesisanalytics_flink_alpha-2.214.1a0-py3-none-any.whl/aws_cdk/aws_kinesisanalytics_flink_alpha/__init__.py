...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.ApplicationAttributes",
    jsii_struct_bases=[],
    name_mapping={
...
class ApplicationAttributes:
    def __init__(
        ...
        *,
        ...
        :param application_arn: (experimental) The ARN of the Flink application. Format: arn::kinesisanalytics:::application/
        :param security_groups: (experimental) The security groups for this Flink application if deployed in a VPC. Default: - no security groups
    ...
    def __repr__(self) -> str:
        return "ApplicationAttributes(%s)" % ", ".join(
...
class ApplicationCode(
    ...
    jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.ApplicationCode",
):
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.ApplicationCodeConfig",
    jsii_struct_bases=[],
    name_mapping={
        ...
        Example::
            ...
            application_code_config = kinesisanalytics_flink_alpha.ApplicationCodeConfig(
                application_code_configuration_property=ApplicationConfigurationProperty(
                    ...
                    application_system_rollback_configuration=ApplicationSystemRollbackConfigurationProperty(
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.ApplicationProps",
    jsii_struct_bases=[],
    name_mapping={
        "code": "code",
        "runtime": "runtime",
...
class ApplicationProps:
    def __init__(
        ...
        *,
        ...
        :param security_groups: (experimental) Security groups to use with a provided VPC. Default: - a new security group is created for this application.
        :param snapshots_enabled: (experimental) Determines if Flink snapshots are enabled. Default: true
        :param vpc: (experimental) Deploy the Flink application in a VPC. Default: - no VPC
...
@jsii.interface(jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.IApplication")
class IApplication(
...
class _IApplicationProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "@aws-cdk/aws-kinesisanalytics-flink-alpha.IApplication"
...
@jsii.enum(jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.LogLevel")
...
@jsii.enum(jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.MetricsLevel")
...
@jsii.data_type(
    jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.PropertyGroups",
    jsii_struct_bases=[],
    name_mapping={},
)
class PropertyGroups:
    def __init__(self) -> None:
        ...
        Example::
            ...
            property_groups = kinesisanalytics_flink_alpha.PropertyGroups()
        '''
        self._values: typing.Dict[builtins.str, typing.Any] = {}
...
class Runtime(
    ...
    jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.Runtime",
):
    ...
    @jsii.python.classproperty
    @jsii.member(jsii_name="FLINK_1_15")
    def FLINK_1_15(cls) -> "Runtime":
        '''(experimental) Flink Version 1.15.

        :stability: experimental
        '''
        return typing.cast("Runtime", jsii.sget(cls, "FLINK_1_15"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="FLINK_1_18")
    def FLINK_1_18(cls) -> "Runtime":
        '''(experimental) Flink Version 1.18.

        :stability: experimental
        '''
        return typing.cast("Runtime", jsii.sget(cls, "FLINK_1_18"))

    @jsii.python.classproperty
    @jsii.member(jsii_name="FLINK_1_19")
    def FLINK_1_19(cls) -> "Runtime":
...
class Application(
    ...
    metaclass=jsii.JSIIMeta,
    jsii_type="@aws-cdk/aws-kinesisanalytics-flink-alpha.Application",
):
...
def _typecheckingstub__ad246f7fae753f9c55cbc4736124d78d668122b77682d352f4613eb0c64936cf(
    *,
    application_arn: builtins.str,
    security_groups: typing.Optional[typing.Sequence[_aws_cdk_aws_ec2_ceddda9d.ISecurityGroup]] = None,
) -> None:
...
def _typecheckingstub__1b3f5ea7b01f2c445236fa2c0bbef9d04ab26dce3d5e0a7fe634f654688abb3f(
    path: builtins.str,
    *,
    deploy_time: typing.Optional[builtins.bool] = None,
    display_name: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__4f5a16b170fb6e6c400ec3e56f19153cd328946a1786624c1886cd8d14940619(
    bucket: _aws_cdk_aws_s3_ceddda9d.IBucket,
    file_key: builtins.str,
    object_version: typing.Optional[builtins.str] = None,
) -> None:
...
def _typecheckingstub__65c9f82daed8b31acdb968f466dda9f9a1c9e180e5072d118bab35365fa96448(
    scope: _constructs_77d1e7e8.Construct,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__47cc21fac9e494abf1ac7f9aadd48c958254bc0341493f99975abdad7ef5d1a4(
    *,
    application_code_configuration_property: typing.Union[_aws_cdk_aws_kinesisanalytics_ceddda9d.CfnApplicationV2.ApplicationConfigurationProperty, typing.Dict[builtins.str, typing.Any]],
    bucket: _aws_cdk_aws_s3_ceddda9d.IBucket,
) -> None:
...
def _typecheckingstub__bb9dbf65afdc65305619bf368726e440990fce7e648f07110f6f6ea5b68761ee(
    *,
    code: ApplicationCode,
    runtime: Runtime,
    application_name: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__6bb38153485e6b404fe25dfe558d2855c7bbd6c7a5a0e278c5336ed22feb47a8(
    policy_statement: _aws_cdk_aws_iam_ceddda9d.PolicyStatement,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__097540094b7582e7d789cf6a116b80ddef50d6da32ceb164de5da9561e9bef53(
    metric_name: builtins.str,
    *,
    account: typing.Optional[builtins.str] = None,
    color: typing.Optional[builtins.str] = None,
...
def _typecheckingstub__2a694f39d30e80ca42dbbc8290e609e5b01e2bd851cacb1ab93d45021cf565fb(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__97c37b53369d987e8a79d7d3042fcd0d9e228da41f3f0c9b98084d676fadb381(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    code: ApplicationCode,
...
def _typecheckingstub__c42f05406bb8ced572c751388e1825bd7dab48d8e6bbd1fdc7daa4d586488843(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    application_arn: builtins.str,
) -> None:
...
def _typecheckingstub__141e4588126ec53159a6df96edadf9ba0eaa657f108566e893ba4a3984b03212(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    *,
    application_arn: builtins.str,
...
def _typecheckingstub__39f9a97194ff1ae295262fee9cb88d054ddc3692873ae0b0fae8e3cf46578c46(
    scope: _constructs_77d1e7e8.Construct,
    id: builtins.str,
    application_name: builtins.str,
) -> None:
...
def _typecheckingstub__c5dd085ae3e1034f2ba58cb3ded49c9b94a495103eef02e9c1f77e00bab7b826(
    policy_statement: _aws_cdk_aws_iam_ceddda9d.PolicyStatement,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__bd7be1e816d1e378b989c42da53244077b88147554f5269f162bf7af509e05e0(
    metric_name: builtins.str,
    *,
    account: typing.Optional[builtins.str] = None,
    color: typing.Optional[builtins.str] = None,
