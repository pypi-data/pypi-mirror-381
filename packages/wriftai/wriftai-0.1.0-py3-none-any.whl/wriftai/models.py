...
from wriftai.common_types import JsonValue, NotRequired, StrEnum, User, Version
...
class ModelsResource(Resource):
    ...
    def create(
        ...
        Args:
            ...
            source_url (Optional[str]): Source url from where the model's code can be
                referenced.
            license_url (Optional[str]): License url where the model's
                usage is specified.
            paper_url (Optional[str]): Paper url from where research info on the model
                can be found.
