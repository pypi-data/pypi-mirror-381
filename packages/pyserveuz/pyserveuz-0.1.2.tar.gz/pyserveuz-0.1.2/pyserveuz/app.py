import inspect # class yoki method ligini aniqlab beradi
import requests
import wsgiadapter # http request yubormasdan , request orqali sorov yuboradi
import os
from webob import Request
from parse import parse
from jinja2 import Environment, FileSystemLoader
from whitenoise import WhiteNoise # static fayllarni topish uchun
...
class PyServeApp:
    ...
    def add_route(self,path,handler,allowed_methods = None):
        ...
        if allowed_methods is None:
            allowed_methods = ["get","post","put","head","options","delete","patch","connect","trace"] 
