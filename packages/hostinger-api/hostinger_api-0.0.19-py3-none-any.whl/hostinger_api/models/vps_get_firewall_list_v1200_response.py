...
class VPSGetFirewallListV1200Response(BaseModel):
    """
    VPSGetFirewallListV1200Response
    """ # noqa: E501
    data: Optional[List[VPSV1FirewallFirewallResource]] = Field(default=None, description="Array of [`VPS.V1.Firewall.FirewallResource`](#model/vpsv1firewallfirewallresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VPSV1FirewallFirewallResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
