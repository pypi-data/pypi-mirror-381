...
class VPSGetPostInstallScriptsV1200Response(BaseModel):
    """
    VPSGetPostInstallScriptsV1200Response
    """ # noqa: E501
    data: Optional[List[VPSV1PostInstallScriptPostInstallScriptResource]] = Field(default=None, description="Array of [`VPS.V1.PostInstallScript.PostInstallScriptResource`](#model/vpsv1postinstallscriptpostinstallscriptresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VPSV1PostInstallScriptPostInstallScriptResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
