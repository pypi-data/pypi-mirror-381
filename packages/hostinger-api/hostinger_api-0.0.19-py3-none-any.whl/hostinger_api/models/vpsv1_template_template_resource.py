...
class VPSV1TemplateTemplateResource(BaseModel):
    """
    ...
    documentation: Optional[StrictStr] = Field(default=None, description="Link to official OS documentation")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "documentation"]
