...
class VPSGetActionsV1200Response(BaseModel):
    """
    VPSGetActionsV1200Response
    """ # noqa: E501
    data: Optional[List[VPSV1ActionActionResource]] = Field(default=None, description="Array of [`VPS.V1.Action.ActionResource`](#model/vpsv1actionactionresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [VPSV1ActionActionResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
