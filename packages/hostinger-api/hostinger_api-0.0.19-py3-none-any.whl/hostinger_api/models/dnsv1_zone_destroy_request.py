...
class DNSV1ZoneDestroyRequest(BaseModel):
    """
    DNSV1ZoneDestroyRequest
    """ # noqa: E501
    filters: List[DNSV1ZoneDestroyRequestFiltersInner] = Field(description="Filter records for deletion")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [DNSV1ZoneDestroyRequestFiltersInner.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
