...
class VPSActionsApi:
    ...
    def get_action_details_v1(
        ...
        _param = self._get_action_details_v1_serialize(
    ...
    @validate_call
    def get_action_details_v1_with_http_info(
        self,
        virtual_machine_id: Annotated[StrictInt, Field(description="Virtual Machine ID")],
        action_id: Annotated[StrictInt, Field(description="Action ID")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_action_details_v1_without_preload_content(
        self,
        virtual_machine_id: Annotated[StrictInt, Field(description="Virtual Machine ID")],
        action_id: Annotated[StrictInt, Field(description="Action ID")],
        _request_timeout: Union[
    ...
    def _get_action_details_v1_serialize(
        self,
        virtual_machine_id,
        action_id,
        _request_auth,
    ...
    def get_actions_v1(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "VPSGetActionsV1200Response",
            '401': "InlineObject1",
            '500': "InlineObject",
        }
        response_data = self.api_client.call_api(
    ...
    def get_actions_v1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[VPSGetActionsV1200Response]:
        """Get actions
