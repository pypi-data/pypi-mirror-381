...
class BillingOrdersApi:
    ...
    @validate_call
    def create_service_order_v1(
        self,
        billing_v1_order_store_request: BillingV1OrderStoreRequest,
        ...
        """(Deprecated) Create service order
        ...
        _param = self._create_service_order_v1_serialize(
    ...
    @validate_call
    def create_service_order_v1_with_http_info(
        self,
        billing_v1_order_store_request: BillingV1OrderStoreRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_service_order_v1_without_preload_content(
        self,
        billing_v1_order_store_request: BillingV1OrderStoreRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_service_order_v1_serialize(
        self,
        billing_v1_order_store_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if billing_v1_order_store_request is not None:
            _body_params = billing_v1_order_store_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/billing/v1/orders',
