...
class DomainsV1ForwardingStoreRequest(BaseModel):
    """
    DomainsV1ForwardingStoreRequest
    """ # noqa: E501
    domain: StrictStr = Field(description="Domain name")
    redirect_type: StrictStr = Field(description="Redirect type")
    redirect_url: StrictStr = Field(description="URL to forward domain to")
    __properties: ClassVar[List[str]] = ["domain", "redirect_type", "redirect_url"]
