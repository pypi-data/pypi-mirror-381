...
class VPSV1VirtualMachineRecoveryStartRequest(BaseModel):
    """
    VPSV1VirtualMachineRecoveryStartRequest
    """ # noqa: E501
    root_password: StrictStr = Field(description="Temporary root password for recovery mode")
    __properties: ClassVar[List[str]] = ["root_password"]
