...
class ReachListContactsV1200Response(BaseModel):
    """
    ReachListContactsV1200Response
    """ # noqa: E501
    data: Optional[List[ReachV1ContactsContactResource]] = Field(default=None, description="Array of [`Reach.V1.Contacts.ContactResource`](#model/reachv1contactscontactresource)")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ReachV1ContactsContactResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
