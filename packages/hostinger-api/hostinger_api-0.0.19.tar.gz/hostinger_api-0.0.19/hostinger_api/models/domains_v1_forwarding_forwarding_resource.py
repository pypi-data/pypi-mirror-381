...
class DomainsV1ForwardingForwardingResource(BaseModel):
    """
    DomainsV1ForwardingForwardingResource
    """ # noqa: E501
    domain: Optional[StrictStr] = Field(default=None, description="Domain name")
    redirect_type: Optional[StrictStr] = Field(default=None, description="Redirect type")
    redirect_url: Optional[StrictStr] = Field(default=None, description="URL domain is forwarded to")
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["domain", "redirect_type", "redirect_url", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "redirect_type": obj.get("redirect_type"),
