...
class VPSV1VirtualMachineRootPasswordUpdateRequest(BaseModel):
    """
    VPSV1VirtualMachineRootPasswordUpdateRequest
    """ # noqa: E501
    password: Annotated[str, Field(min_length=12, strict=True)] = Field(description="Root password for the virtual machine")
