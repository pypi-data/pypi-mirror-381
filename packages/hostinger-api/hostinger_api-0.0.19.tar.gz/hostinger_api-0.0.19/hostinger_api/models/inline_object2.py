...
class InlineObject2(BaseModel):
    ...
    InlineObject2
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Validation error message")
    errors: Optional[InlineObject2Errors] = None
    correlation_id: Optional[StrictStr] = Field(default=None, description="Request correlation ID")
    __properties: ClassVar[List[str]] = ["message", "errors", "correlation_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": InlineObject2Errors.from_dict(obj["errors"]) if obj.get("errors") is not None else None,
