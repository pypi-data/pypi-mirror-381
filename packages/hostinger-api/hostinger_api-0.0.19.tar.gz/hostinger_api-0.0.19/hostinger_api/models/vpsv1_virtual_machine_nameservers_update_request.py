...
class VPSV1VirtualMachineNameserversUpdateRequest(BaseModel):
    """
    VPSV1VirtualMachineNameserversUpdateRequest
    """ # noqa: E501
    ns1: StrictStr
    ns2: Optional[StrictStr] = None
    ns3: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["ns1", "ns2", "ns3"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ns3 (nullable) is None
        # and model_fields_set contains the field
        if self.ns3 is None and "ns3" in self.model_fields_set:
            _dict['ns3'] = None
