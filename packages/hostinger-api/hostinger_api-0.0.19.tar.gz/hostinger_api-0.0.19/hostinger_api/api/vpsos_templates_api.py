...
class VPSOSTemplatesApi:
    ...
    def get_template_details_v1(
        ...
        _param = self._get_template_details_v1_serialize(
    ...
    @validate_call
    def get_template_details_v1_with_http_info(
        self,
        template_id: Annotated[StrictInt, Field(description="Template ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_template_details_v1_without_preload_content(
        self,
        template_id: Annotated[StrictInt, Field(description="Template ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_template_details_v1_serialize(
        self,
        template_id,
        _request_auth,
        _content_type,
    ...
    def get_templates_v1(
        ...
        _param = self._get_templates_v1_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_templates_v1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_templates_v1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_templates_v1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
