...
class VPSDataCentersApi:
    ...
    def get_data_center_list_v1(
    ...
    ) -> List[VPSV1DataCenterDataCenterResource]:
        ...
        _param = self._get_data_center_list_v1_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[VPSV1DataCenterDataCenterResource]",
            '401': "InlineObject1",
            '500': "InlineObject",
        }
    ...
    @validate_call
    def get_data_center_list_v1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[VPSV1DataCenterDataCenterResource]]:
        """Get data center list
    ...
    @validate_call
    def get_data_center_list_v1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_data_center_list_v1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/vps/v1/data-centers',
