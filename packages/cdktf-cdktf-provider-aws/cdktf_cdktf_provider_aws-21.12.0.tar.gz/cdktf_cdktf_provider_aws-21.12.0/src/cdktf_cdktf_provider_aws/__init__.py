r'''
# CDKTF prebuilt bindings for hashicorp/aws provider version 6.15.0

This repo builds and publishes the [Terraform aws provider](https://registry.terraform.io/providers/hashicorp/aws/6.15.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform aws provider](https://registry.terraform.io/providers/hashicorp/aws/6.15.0)
