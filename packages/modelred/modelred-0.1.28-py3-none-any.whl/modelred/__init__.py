...
class ProviderConfig:
    ...
    - HuggingFace: model_name, optional api_key, endpoint_url
    - REST: uri, optional api_key, headers, request/response templates
    - Bedrock: AWS credentials (region, model_id, access keys)
    - SageMaker: AWS credentials (region, endpoint_name, access keys)
