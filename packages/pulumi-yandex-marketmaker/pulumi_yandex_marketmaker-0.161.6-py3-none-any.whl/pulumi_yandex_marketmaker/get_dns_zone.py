...
class GetDnsZoneResult:
    ...
    def private_networks(self) -> Sequence[_builtins.str]:
        """
...
def get_dns_zone(dns_zone_id: Optional[_builtins.str] = None,
    ...
    #
    foo = yandex.get_dns_zone(dns_zone_id=zone1["id"])
    pulumi.export("zone", foo.zone)
    ```


    :param _builtins.str dns_zone_id: The ID of the DNS Zone.
...
def get_dns_zone_output(dns_zone_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('yandex:index/getDnsZone:getDnsZone', __args__, opts=opts, typ=GetDnsZoneResult)
