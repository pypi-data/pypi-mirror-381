...
class GetYdbDatabaseServerlessResult:
    ...
    def document_api_endpoint(self) -> _builtins.str:
        """
...
def get_ydb_database_serverless(database_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database_id: ID of the Yandex Database serverless cluster.
...
def get_ydb_database_serverless_output(database_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
