...
class OrganizationmanagerSamlFederationUserAccountArgs:
    def __init__(__self__, *,
                 ...
                 name_id: pulumi.Input[_builtins.str]):
        """
        The set of arguments for constructing a OrganizationmanagerSamlFederationUserAccount resource.
        :param pulumi.Input[_builtins.str] federation_id: ID of a SAML Federation.
        :param pulumi.Input[_builtins.str] name_id: Name ID of the SAML federated user.
        """
    ...
    def name_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @name_id.setter
    def name_id(self, value: pulumi.Input[_builtins.str]):
...
class _OrganizationmanagerSamlFederationUserAccountState:
    ...
    @_builtins.property
    @pulumi.getter(name="nameId")
    def name_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Name ID of the SAML federated user.
        """
        return pulumi.get(self, "name_id")
    ...
    @name_id.setter
    def name_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "name_id", value)


@pulumi.type_token("yandex:index/organizationmanagerSamlFederationUserAccount:OrganizationmanagerSamlFederationUserAccount")
class OrganizationmanagerSamlFederationUserAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
        $ pulumi import yandex:index/organizationmanagerSamlFederationUserAccount:OrganizationmanagerSamlFederationUserAccount <resource Name> <resource Id>
        ```
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            federation_id: Optional[pulumi.Input[_builtins.str]] = None,
            name_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'OrganizationmanagerSamlFederationUserAccount':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="nameId")
    def name_id(self) -> pulumi.Output[_builtins.str]:
        """
        Name ID of the SAML federated user.
        """
        return pulumi.get(self, "name_id")
