...
def get_alb_http_router(description: Optional[_builtins.str] = None,
...
def get_alb_http_router_output(description: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               folder_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               http_router_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAlbHttpRouterResult]:
    """
    Get information about a Yandex Application Load Balancer HTTP Router. For more information, see [Yandex Cloud Application Load Balancer](https://yandex.cloud/docs/application-load-balancer/quickstart).
    ...
    __ret__ = pulumi.runtime.invoke_output('yandex:index/getAlbHttpRouter:getAlbHttpRouter', __args__, opts=opts, typ=GetAlbHttpRouterResult)
    return __ret__.apply(lambda __response__: GetAlbHttpRouterResult(
