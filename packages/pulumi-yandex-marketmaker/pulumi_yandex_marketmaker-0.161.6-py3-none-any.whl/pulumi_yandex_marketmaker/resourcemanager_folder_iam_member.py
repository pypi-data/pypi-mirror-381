...
class ResourcemanagerFolderIamMember(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        > This resource *must not* be used in conjunction with `ResourcemanagerFolderIamPolicy` or they will conflict over what your policy should be. Similarly, roles controlled by `ResourcemanagerFolderIamBinding` should not be assigned using `ResourcemanagerFolderIamMember`.
