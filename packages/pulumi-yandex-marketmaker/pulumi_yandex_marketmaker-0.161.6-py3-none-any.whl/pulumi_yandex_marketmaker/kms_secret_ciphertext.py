...
class KmsSecretCiphertextArgs:
    def __init__(__self__, *,
                 ...
                 aad_context: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a KmsSecretCiphertext resource.
        :param pulumi.Input[_builtins.str] key_id: ID of the symmetric KMS key to use for encryption.
        :param pulumi.Input[_builtins.str] plaintext: Plaintext to be encrypted.
        :param pulumi.Input[_builtins.str] aad_context: Additional authenticated data (AAD context), optional. If specified, this data will be required for decryption with the `SymmetricDecryptRequest`.
        """
    ...
    def aad_context(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @aad_context.setter
    def aad_context(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _KmsSecretCiphertextState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] aad_context: Additional authenticated data (AAD context), optional. If specified, this data will be required for decryption with the `SymmetricDecryptRequest`.
        :param pulumi.Input[_builtins.str] ciphertext: Resulting CipherText, encoded with `standard` base64 alphabet as defined in RFC 4648 section 4.
        :param pulumi.Input[_builtins.str] key_id: ID of the symmetric KMS key to use for encryption.
        :param pulumi.Input[_builtins.str] plaintext: Plaintext to be encrypted.
        """
        if aad_context is not None:
...
class KmsSecretCiphertext(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        #
        example = yandex.KmsSymmetricKey("example",
    ...
    def get(resource_name: str,
            ...
            ciphertext: Optional[pulumi.Input[_builtins.str]] = None,
            key_id: Optional[pulumi.Input[_builtins.str]] = None,
            plaintext: Optional[pulumi.Input[_builtins.str]] = None) -> 'KmsSecretCiphertext':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="aadContext")
    def aad_context(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Additional authenticated data (AAD context), optional. If specified, this data will be required for decryption with the `SymmetricDecryptRequest`.
        """
        return pulumi.get(self, "aad_context")
