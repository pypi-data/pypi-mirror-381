...
__all__ = ['KmsSymmetricKeyIamMemberArgs', 'KmsSymmetricKeyIamMember']

@pulumi.input_type
class KmsSymmetricKeyIamMemberArgs:
...
@pulumi.input_type
class _KmsSymmetricKeyIamMemberState:
    def __init__(__self__, *,
...
class KmsSymmetricKeyIamMember(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        > Roles controlled by `KmsSymmetricKeyIamBinding` should not be assigned using `KmsSymmetricKeyIamMember`.
        ...
        ```sh
        $ pulumi import yandex:index/kmsSymmetricKeyIamMember:KmsSymmetricKeyIamMember viewer "symmetric_key_id viewer foo@example.com"
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: KmsSymmetricKeyIamMemberArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Allows creation and management of a single member for a single binding within the IAM policy for an existing Yandex KMS Symmetric Key.
        ...
        :param str resource_name: The name of the resource.
        :param KmsSymmetricKeyIamMemberArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KmsSymmetricKeyIamMemberArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KmsSymmetricKeyIamMemberArgs.__new__(KmsSymmetricKeyIamMemberArgs)
        ...
        super(KmsSymmetricKeyIamMember, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            role: Optional[pulumi.Input[str]] = None,
            sleep_after: Optional[pulumi.Input[int]] = None,
            symmetric_key_id: Optional[pulumi.Input[str]] = None) -> 'KmsSymmetricKeyIamMember':
        """
        Get an existing KmsSymmetricKeyIamMember resource's state with the given name, id, and optional extra
        ...
        __props__ = _KmsSymmetricKeyIamMemberState.__new__(_KmsSymmetricKeyIamMemberState)

        __props__.__dict__["member"] = member
        __props__.__dict__["role"] = role
        __props__.__dict__["sleep_after"] = sleep_after
        __props__.__dict__["symmetric_key_id"] = symmetric_key_id
        return KmsSymmetricKeyIamMember(resource_name, opts=opts, __props__=__props__)
