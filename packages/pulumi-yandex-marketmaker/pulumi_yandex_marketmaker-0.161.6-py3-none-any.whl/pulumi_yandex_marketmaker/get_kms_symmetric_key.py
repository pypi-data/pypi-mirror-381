...
class GetKmsSymmetricKeyResult:
    ...
    def default_algorithm(self) -> Optional[_builtins.str]:
        """
    ...
    def symmetric_key_id(self) -> Optional[_builtins.str]:
        """
...
def get_kms_symmetric_key(default_algorithm: Optional[_builtins.str] = None,
                          ...
                          symmetric_key_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str default_algorithm: Encryption algorithm to be used with a new key version, generated with the next rotation. The default value is `AES_128`.
    ...
    :param _builtins.str rotation_period: Interval between automatic rotations. To disable automatic rotation, omit this parameter.
    :param _builtins.str symmetric_key_id: The symmetric key ID.
    """
    __args__ = dict()
...
def get_kms_symmetric_key_output(default_algorithm: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 ...
                                 rotation_period: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 symmetric_key_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetKmsSymmetricKeyResult]:
    """
    Get data from Yandex KMS symmetric key.
    ...
    __ret__ = pulumi.runtime.invoke_output('yandex:index/getKmsSymmetricKey:getKmsSymmetricKey', __args__, opts=opts, typ=GetKmsSymmetricKeyResult)
    return __ret__.apply(lambda __response__: GetKmsSymmetricKeyResult(
        created_at=pulumi.get(__response__, 'created_at'),
        default_algorithm=pulumi.get(__response__, 'default_algorithm'),
        ...
        symmetric_key_id=pulumi.get(__response__, 'symmetric_key_id')))
