...
class KmsAsymmetricSignatureKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] signature_algorithm: Signature algorithm to be used with a new key. The default value is `RSA_2048_SIGN_PSS_SHA_256`.
        """
...
@pulumi.type_token("yandex:index/kmsAsymmetricSignatureKey:KmsAsymmetricSignatureKey")
class KmsAsymmetricSignatureKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            signature_algorithm: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None) -> 'KmsAsymmetricSignatureKey':
        """
