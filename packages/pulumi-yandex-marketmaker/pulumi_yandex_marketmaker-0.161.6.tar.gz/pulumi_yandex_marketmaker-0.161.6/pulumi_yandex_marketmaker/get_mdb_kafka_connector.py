...
class GetMdbKafkaConnectorResult:
    ...
    def tasks_max(self) -> _builtins.int:
        """
...
def get_mdb_kafka_connector(cluster_id: Optional[_builtins.str] = None,
...
def get_mdb_kafka_connector_output(cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
