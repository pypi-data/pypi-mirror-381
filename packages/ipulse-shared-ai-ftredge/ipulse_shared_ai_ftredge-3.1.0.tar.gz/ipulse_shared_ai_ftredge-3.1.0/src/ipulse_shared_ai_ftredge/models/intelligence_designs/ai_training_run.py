...
class AITrainingOrUpdateRun(BaseModel):
    ...
    feature_engineering_applied: Optional[Dict[str, Any]] = Field(None, description="Feature engineering transformations applied during this training run.")
    data_quality_metrics: Optional[Dict[str, Any]] = Field(None, description="Data quality metrics from this training run, e.g., missing value rates, outlier counts.")
    ...
    training_run_cost_usd: Optional[float] = Field(None, description="Cost of this specific training run in USD.")
    ...
    pulse_namespace: Optional[str] = Field(None, description="Namespace for this AI training run.")
