"""
    ...
    The version of the OpenAPI document: v0.125.31
...
class PatchUser(ModelNormal):
    ...
    attribute_map = {
        'allowed_scopes': 'allowed_scopes',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, allowed_scopes, *args, **kwargs):  # noqa: E501
        """PatchUser - a model defined in OpenAPI

        Args:
            allowed_scopes ([str]): List of scopes that the user is allowed to request.
    ...
    @convert_js_args_to_python_args
    def __init__(self, allowed_scopes, *args, **kwargs):  # noqa: E501
        """PatchUser - a model defined in OpenAPI
