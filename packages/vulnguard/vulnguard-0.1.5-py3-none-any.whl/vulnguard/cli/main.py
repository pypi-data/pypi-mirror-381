...
@click.group()
@click.version_option(version="0.1.5", prog_name="vulnguard")
def cli():
    """
...
@click.option('--model', '-m', default='claude-3-5-sonnet-20240620', 
              help='Claude model to use (e.g., claude-3-5-sonnet-20240620, claude-3-haiku-20240307)')
...
def scan(path: str, api_key: Optional[str], model: str, output: Optional[str], format: str, 
    ...
    Examples:
        ...
        vulnguard scan . --model claude-3-haiku-20240307  # Use faster/cheaper model
    """
    try:
...
def report(report_path: str):
    ...
    Examples:
        ...
        vulnguard report .codeguard/scan_results.json
    """
