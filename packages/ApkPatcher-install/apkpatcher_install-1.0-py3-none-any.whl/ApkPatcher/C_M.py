class CM:
    def __init__(self):
        ...
        # ---------------- Libraries Import ----------------
        self.os, self.sys, self.shutil, self.subprocess, self.re, self.time, self.glob, self.zlib, self.pickle, self.zipfile, self.base64, self.binascii, self.random, self.string, self.hashlib, self.argparse, self.json, self.struct, self.tempfile, self.datetime, self.Pool, self.cpu_count, self.Manager = __import__('os'), __import__('sys'), __import__('shutil'), __import__('subprocess'), __import__('re'), __import__('time'), __import__('glob'), __import__('zlib'), __import__('pickle'), __import__('zipfile'), __import__('base64'), __import__('binascii'), __import__('random'), __import__('string'), __import__('hashlib'), __import__('argparse'), __import__('json'), __import__('struct'), __import__('tempfile'), __import__('datetime').datetime, mp.Pool, mp.cpu_count, mp.Manager
