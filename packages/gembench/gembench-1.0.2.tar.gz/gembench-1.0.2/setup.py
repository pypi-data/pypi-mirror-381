...
setup(
    ...
    author="Silan Hu, Shiqi Zhang, Yimin Shi, Xiaokui Xiao",
    author_email="contact@gem-bench.org",
    url="https://gem-bench.org",
    license="Apache-2.0",
    ...
    keywords="llm generative-engine-marketing ad-injection benchmark machine-learning",
    project_urls={
        "Homepage": "https://gem-bench.org",
