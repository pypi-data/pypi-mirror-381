...
class LogicSDK:
    ...
    def batch_evaluate(self, data_points: List[Dict],
                       config: Optional[Union[Dict, Config]] = None) -> List[EvaluationResult]:
        ...
        # algunos backends devuelven 'confidence_level' o 'threshold'
