...
class SequencingGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, technology, platform, meta, sample_id, external_ids, archived, assays, *args, **kwargs):  # noqa: E501
        """SequencingGroup - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, type, technology, platform, meta, sample_id, external_ids, archived, assays, *args, **kwargs):  # noqa: E501
        """SequencingGroup - a model defined in OpenAPI
