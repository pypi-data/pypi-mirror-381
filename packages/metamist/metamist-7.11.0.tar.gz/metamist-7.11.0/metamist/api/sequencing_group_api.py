...
class SequencingGroupApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.archive_sequencing_groups_async = async_wrap(self.archive_sequencing_groups)
        self.archive_sequencing_groups_endpoint = _Endpoint(
            settings={
                'response_type': (bool,),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v1/sequencing-group/archive',
                'operation_id': 'archive_sequencing_groups',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def archive_sequencing_groups(
        self,
        request_body,
        **kwargs
    ):
        """Archive Sequencing Groups  # noqa: E501

        Update the meta fields of a sequencing group  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.archive_sequencing_groups(request_body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['request_body'] = \
            request_body
        return self.archive_sequencing_groups_endpoint.call_with_http_info(**kwargs)
