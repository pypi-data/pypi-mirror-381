...
class ParticipantApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.export_participants_async = async_wrap(self.export_participants)
        self.export_participants_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v1/participant/{project}/export/participant_table.parquet',
                'operation_id': 'export_participants',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def export_participants(
        ...
        **kwargs
        ...
        """Export Participants  # noqa: E501

        Return a parquet table of participants  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.export_participants(project, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['project'] = \
            project
        return self.export_participants_endpoint.call_with_http_info(**kwargs)
