"""
    ...
    The version of the OpenAPI document: 7.11.0
...
class BillingApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.cost_by_sample_async = async_wrap(self.cost_by_sample)
        self.cost_by_sample_endpoint = _Endpoint(
            settings={
                'response_type': ([BillingTotalCostRecord],),
                'auth': [
                    'HTTPBearer'
                ],
                'endpoint_path': '/api/v1/billing/cost-by-sample',
                'operation_id': 'cost_by_sample',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'billing_sample_query_model',
                ],
                'required': [
                    'billing_sample_query_model',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'billing_sample_query_model': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.get_running_cost_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/v1/billing/running-cost',
            ...
            params_map={
                'all': [
                    'billing_running_cost_query_model',
                ],
                'required': [
                    'billing_running_cost_query_model',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'billing_running_cost_query_model': 'body',
                },
                'collection_format_map': {
                }
            },
    ...
    def cost_by_sample(
        ...
        **kwargs
        ...
        """Get Cost By Sample  # noqa: E501

        Get Total cost of selected fields for requested sample or sequencing group  Here are few examples of requests:  1. Get total topic for month of March 2023, ordered by cost DESC:      {         \"fields\": [\"topic\"],         \"start_date\": \"2023-03-01\",         \"end_date\": \"2023-03-31\",         \"search_ids\": [\"sample1\", \"sample2\"]     }  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.cost_by_sample(billing_sample_query_model, async_req=True)
        >>> result = thread.get()

        Args:
            billing_sample_query_model (BillingSampleQueryModel):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['billing_sample_query_model'] = \
            billing_sample_query_model
        return self.cost_by_sample_endpoint.call_with_http_info(**kwargs)
    ...
    def get_running_cost(
        ...
        **kwargs
        ...
        Get running cost for specified fields in database with filtering support e.g. fields = ['gcp_project', 'topic', 'wdl_task_names', 'cromwell_sub_workflow_name', 'compute_category']  Example request with filtering: {     \"field\": \"gcp_project\",     \"invoice_month\": \"202412\",     \"source\": \"gcp_billing\",     \"filters\": {         \"gcp_project\": [\"project1\", \"project2\"]     } }  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_running_cost(billing_running_cost_query_model, async_req=True)
        >>> result = thread.get()

        Args:
            billing_running_cost_query_model (BillingRunningCostQueryModel):
        ...
        kwargs['_content_type'] = kwargs.get(
            '_content_type')
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['billing_running_cost_query_model'] = \
            billing_running_cost_query_model
