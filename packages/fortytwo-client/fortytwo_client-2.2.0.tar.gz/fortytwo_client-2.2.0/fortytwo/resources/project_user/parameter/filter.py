...
class ProjectUserFilter:
    ...
    @staticmethod
    def by_id(project_user_id: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_project_id(project_id: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_user_id(user_id: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_created_at(created_at: Union[str, datetime]) -> Filter:
        """
    ...
    @staticmethod
    def by_updated_at(updated_at: Union[str, datetime]) -> Filter:
        """
    ...
    @staticmethod
    def by_occurrence(occurrence: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_final_mark(final_mark: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_retriable_at(retriable_at: Union[str, datetime]) -> Filter:
        """
    ...
    @staticmethod
    def by_marked_at(marked_at: Union[str, datetime]) -> Filter:
        """
    ...
    @staticmethod
    def by_cursus(cursus: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_campus(campus: Union[str, int]) -> Filter:
        """
