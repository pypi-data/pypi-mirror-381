...
class UserRange:
    ...
    @staticmethod
    def login_range(min_login: str = None, max_login: str = None) -> Range:
        """
    ...
    @staticmethod
    def email_range(min_email: str = None, max_email: str = None) -> Range:
        """
    ...
    @staticmethod
    def pool_year_range(
        min_year: Union[str, int] = None, max_year: Union[str, int] = None
    ) -> Range:
        """
    ...
    def pool_month_range(
        min_month: Union[str, int] = None, max_month: Union[str, int] = None
    ) -> Range:
        """
