...
class UserFilter:
    ...
    @staticmethod
    def by_id(user_id: Union[str, int]) -> Filter:
        """
        Filter users by ID.
    ...
    @staticmethod
    def by_pool_year(year: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_pool_month(month: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_primary_campus_id(campus_id: Union[str, int]) -> Filter:
        """
