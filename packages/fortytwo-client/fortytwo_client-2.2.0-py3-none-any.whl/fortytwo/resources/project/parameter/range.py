...
class ProjectRange:
    ...
    @staticmethod
    def name_range(min_name: str = None, max_name: str = None) -> Range:
        """
    ...
    @staticmethod
    def parent_id_range(
        min_parent_id: Union[str, int] = None, max_parent_id: Union[str, int] = None
    ) -> Range:
        """
    ...
    @staticmethod
    def slug_range(min_slug: str = None, max_slug: str = None) -> Range:
        """
    ...
    @staticmethod
    def position_range(
        min_position: Union[str, int] = None, max_position: Union[str, int] = None
    ) -> Range:
        """
    ...
    def description_range(
        min_description: str = None, max_description: str = None
    ) -> Range:
        """
    ...
    def difficulty_range(
        min_difficulty: Union[str, int] = None, max_difficulty: Union[str, int] = None
    ) -> Range:
        """
