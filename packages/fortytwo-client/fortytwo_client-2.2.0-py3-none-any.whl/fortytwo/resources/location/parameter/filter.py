...
class LocationFilter:
    ...
    @staticmethod
    def by_id(location_id: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_begin_at(begin_at: Union[str, datetime]) -> Filter:
        """
    ...
    @staticmethod
    def by_end_at(end_at: Union[str, datetime]) -> Filter:
        """
    ...
    @staticmethod
    def by_primary(primary: Union[str, bool]) -> Filter:
        """
    ...
    @staticmethod
    def by_campus_id(campus_id: Union[str, int]) -> Filter:
        """
