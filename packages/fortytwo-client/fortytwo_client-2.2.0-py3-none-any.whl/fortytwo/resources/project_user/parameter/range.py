...
class ProjectUserRange:
    ...
    def project_id_range(
        min_project_id: Union[str, int] = None, max_project_id: Union[str, int] = None
    ) -> Range:
        """
    ...
    def occurrence_range(
        min_occurrence: Union[str, int] = None, max_occurrence: Union[str, int] = None
    ) -> Range:
        """
    ...
    def final_mark_range(
        min_final_mark: Union[str, int] = None, max_final_mark: Union[str, int] = None
    ) -> Range:
        """
    ...
    @staticmethod
    def status_range(min_status: str = None, max_status: str = None) -> Range:
        """
