...
class UserParameter:
    ...
    @staticmethod
    def coalition_id(coalition_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def event_id(event_id: Union[str, int]) -> Parameter:
        """
        The event id.
    ...
    @staticmethod
    def accreditation_id(accreditation_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def team_id(team_id: Union[str, int]) -> Parameter:
        """
        The team id.
    ...
    @staticmethod
    def project_id(project_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def partnership_id(partnership_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def expertise_id(expertise_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def cursus_id(cursus_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def campus_id(campus_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def achievement_id(achievement_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def title_id(title_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def quest_id(quest_id: Union[str, int]) -> Parameter:
        """
    ...
    @staticmethod
    def group_id(group_id: Union[str, int]) -> Parameter:
        """
        The group id.
