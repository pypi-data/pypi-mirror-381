...
class ProjectFilter:
    ...
    @staticmethod
    def by_id(project_id: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_visible(visible: Union[str, bool]) -> Filter:
        """
    ...
    @staticmethod
    def by_exam(exam: Union[str, bool]) -> Filter:
        """
    ...
    @staticmethod
    def by_parent_id(parent_id: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_inherited_team(inherited_team: Union[str, bool]) -> Filter:
        """
    ...
    @staticmethod
    def by_position(position: Union[str, int]) -> Filter:
        """
    ...
    @staticmethod
    def by_has_git(has_git: Union[str, bool]) -> Filter:
        """
    ...
    @staticmethod
    def by_has_mark(has_mark: Union[str, bool]) -> Filter:
        """
    ...
    @staticmethod
    def by_difficulty(difficulty: Union[str, int]) -> Filter:
        """
