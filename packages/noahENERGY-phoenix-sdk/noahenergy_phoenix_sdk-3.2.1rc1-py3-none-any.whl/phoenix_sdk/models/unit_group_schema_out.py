...
class UnitGroupSchemaOut(BaseModel):
    """
    UnitGroupSchemaOut
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["created_by_id", "id", "created_at", "updated_at", "name", "company_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnitGroupSchemaOut from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnitGroupSchemaOut from a dict"""
        if obj is None:
            return None
