...
from maleo.crypto.key.rsa.enums import KeyType
from maleo.crypto.key.rsa.loader import with_cryptography
...
class Private(Key):
    password: Annotated[OptionalString, Field(None, description="Key's password")] = (
        None
    )
