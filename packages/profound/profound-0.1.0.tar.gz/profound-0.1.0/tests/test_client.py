...
from profound import Profound, AsyncProfound, APIResponseValidationError
...
def _get_open_connections(client: Profound | AsyncProfound) -> int:
...
class TestProfound:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "profound/_legacy_response.py",
                        "profound/_response.py",
    ...
    def test_multipart_repeating_array(self, client: Profound) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Profound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Profound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Profound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    @mock.patch("profound._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Profound) -> None:
    ...
    @mock.patch("profound._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Profound) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Profound, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncProfound:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncProfound) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncProfound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncProfound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncProfound) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncProfound, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
