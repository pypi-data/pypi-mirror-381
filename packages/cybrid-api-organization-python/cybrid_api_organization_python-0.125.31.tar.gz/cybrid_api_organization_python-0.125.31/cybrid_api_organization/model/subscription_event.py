...
class SubscriptionEvent(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, event_type, object_guid, environment, organization_guid, created_at, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            bank_guid (str): The bank guid for which the event is received.. [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, event_type, object_guid, environment, organization_guid, created_at, *args, **kwargs):  # noqa: E501
        """SubscriptionEvent - a model defined in OpenAPI
