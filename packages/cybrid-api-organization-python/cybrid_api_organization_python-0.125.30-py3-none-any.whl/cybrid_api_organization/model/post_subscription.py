...
class PostSubscription(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, environment, name, url, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            type (str): Type of the subscription.. defaults to "webhook", must be one of ["webhook", ]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, environment, name, url, *args, **kwargs):  # noqa: E501
        """PostSubscription - a model defined in OpenAPI
