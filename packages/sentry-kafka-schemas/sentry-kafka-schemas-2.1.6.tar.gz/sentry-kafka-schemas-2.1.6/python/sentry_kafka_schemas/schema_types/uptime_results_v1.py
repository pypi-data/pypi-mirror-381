from typing import Required, TypedDict, Union, List, Literal
...
CheckStatus = Union[Literal['success'], Literal['failure'], Literal['missed_window']]
"""
check_status.
...
CheckStatusReasonType = Union[Literal['timeout'], Literal['dns_error'], Literal['failure'], Literal['tls_error'], Literal['connection_error'], Literal['redirect_error']]
"""
check_status_reason_type.
