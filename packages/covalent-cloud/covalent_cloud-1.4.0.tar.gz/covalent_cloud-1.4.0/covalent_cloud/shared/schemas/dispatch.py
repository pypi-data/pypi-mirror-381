...
class DispatchRecord(BaseModel):
    ...
    def __str__(self) -> str:
        ...
        started_str = self.started_at.strftime("%Y-%m-%d %H:%M:%S") if self.started_at else "Not started"
        ...
        completion_pct = (self.completed_task_num / self.electron_num * 100) if self.electron_num > 0 else 0
