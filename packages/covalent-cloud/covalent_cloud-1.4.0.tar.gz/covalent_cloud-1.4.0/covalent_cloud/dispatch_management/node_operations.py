    ...
    try:
        ...
        if node is None:
            ...
            if not target_node_ids:
                raise ResourceNotFoundError(f"No nodes found with function name '{node}' in dispatch {dispatch_id}")
