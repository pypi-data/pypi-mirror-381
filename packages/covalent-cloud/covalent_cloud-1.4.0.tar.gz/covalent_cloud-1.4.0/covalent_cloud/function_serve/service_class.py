    ...
    def __call__(self, *args: Any, **kwargs: Any) -> Any:
        ...
        if active_lattice is not None:
            ...
            def _electronic_deploy(
                function_service, dispatcher_uri, api_key, dr_api_token, dr_region, volume, *args, **kwargs
            ):
            ...
            deploy_func = partial(
                _electronic_deploy, self, dispatcher_uri, api_key, dr_api_token, dr_region, self.volume
            )
