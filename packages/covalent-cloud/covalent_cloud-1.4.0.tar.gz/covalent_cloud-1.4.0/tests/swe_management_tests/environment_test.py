...
dependencies:
  ...
  - pip:
    - tensorflow==2.10.0"""
        ...
        with patch('covalent_cloud.swe_management.swe_manager._get_envs_filtered') as mock_get_envs:
...
class TestEdgeCases:
    ...
    def test_get_environment_yaml_large_file(self, mock_settings):
        ...
        large_yaml = "name: large-environment\ndependencies:\n" + "\n".join([f"  - package{i}=1.0" for i in range(1000)])
