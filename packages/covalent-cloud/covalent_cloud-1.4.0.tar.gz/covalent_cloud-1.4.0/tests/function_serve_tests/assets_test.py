...
class TestAssetsMediator:
    ...
    def test_upload_asset_with_auth_headers_asset_type(self, mock_transportable_object_class, mock_asset_api_client_class):
    ...
    def test_upload_asset_with_none_url_gets_presigned_url(self, mock_get_deployment_client, mock_asset_api_client_class):
        ...
        mock_asset_api_client_class.assert_called_once_with(settings=self.mock_settings)
        mock_asset_client.upload_asset.assert_called_once_with("https://presigned.url/upload", original_data)
