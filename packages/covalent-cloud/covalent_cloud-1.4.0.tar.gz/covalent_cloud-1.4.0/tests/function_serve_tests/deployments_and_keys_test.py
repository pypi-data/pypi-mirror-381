...
class TestListFunctionDeployments:
    ...
    def test_list_function_deployments_default_params(self, mock_get_client, mock_settings, sample_deployment_list_response):
    ...
    @patch('covalent_cloud.function_serve.deployment.get_deployment_client')
    def test_list_function_deployments_with_filters(self, mock_get_client, mock_settings, sample_deployment_list_response):
        ...
        assert params["generate_presigned_urls"] == True
    ...
    @patch('covalent_cloud.function_serve.deployment.get_deployment_client')
    def test_list_function_deployments_none_optional_params(self, mock_get_client, mock_settings, sample_deployment_list_response):
...
class TestCreateInferenceApiKey:
    ...
    @patch('covalent_cloud.function_serve.deployment.get_deployment_client')
    def test_create_inference_api_key_success(self, mock_get_client, mock_settings, sample_api_key_response):
...
class TestListInferenceApiKeys:
    ...
    @patch('covalent_cloud.function_serve.deployment.get_deployment_client')
    def test_list_inference_api_keys_success(self, mock_get_client, mock_settings, sample_api_keys_list_response):
...
class TestEdgeCases:
    ...
    def test_function_id_special_characters(self, mock_settings):
        ...
        with patch('covalent_cloud.function_serve.deployment.get_deployment_client') as mock_get_client:
            mock_client = MagicMock()
            mock_response = MagicMock()
            mock_response.json.return_value = []
            mock_client.get.return_value = mock_response
