...
class TestGetDispatchesSuccess:
    ...
    def test_get_dispatches_default_params(self, mock_get_client, mock_settings, sample_dispatch_response):
        ...
        assert params["only_root"] == False

    @patch('covalent_cloud.dispatch_management.interface_functions.get_client')
    def test_get_dispatches_with_filters(self, mock_get_client, mock_settings, sample_dispatch_response):
        ...
        assert params["pinned"] == True
        assert params["only_root"] == True

    @patch('covalent_cloud.dispatch_management.interface_functions.get_client')
    def test_get_dispatches_with_dispatch_ids(self, mock_get_client, mock_settings, sample_dispatch_response):
    ...
    @patch('covalent_cloud.dispatch_management.interface_functions.get_client')
    def test_get_dispatches_with_time_filters(self, mock_get_client, mock_settings, sample_dispatch_response):
...
class TestGetDispatchesEdgeCases:
    ...
    @patch('covalent_cloud.dispatch_management.interface_functions.get_client')
    def test_get_dispatches_empty_dispatch_ids(self, mock_get_client, mock_settings, sample_dispatch_response):
    ...
    @patch('covalent_cloud.dispatch_management.interface_functions.get_client')
    def test_get_dispatches_none_values(self, mock_get_client, mock_settings, sample_dispatch_response):
    ...
    @patch('covalent_cloud.dispatch_management.interface_functions.get_client')
    def test_get_dispatches_max_params(self, mock_get_client, mock_settings, sample_dispatch_response):
