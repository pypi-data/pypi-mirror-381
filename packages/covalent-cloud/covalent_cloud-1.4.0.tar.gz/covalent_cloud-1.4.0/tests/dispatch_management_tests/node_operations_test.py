...
class TestGetNodeResults:
    ...
    @patch('covalent_cloud.dispatch_management.node_operations.rm.get_result_manager')
    def test_get_node_results_by_function_name(self, mock_get_rm, mock_result_manager, mock_settings):
    ...
    @patch('covalent_cloud.dispatch_management.node_operations.rm.get_result_manager')
    def test_get_node_results_invalid_node_id(self, mock_get_rm, mock_result_manager, mock_settings):
    ...
    @patch('covalent_cloud.dispatch_management.node_operations.rm.get_result_manager')
    def test_get_node_results_invalid_function_name(self, mock_get_rm, mock_result_manager, mock_settings):
        """Test getting results for non-existent function name."""
        mock_get_rm.return_value = mock_result_manager
        
        with pytest.raises(ResourceNotFoundError, match="No nodes found with function name 'nonexistent'"):
...
class TestGetNodeErrors:
    ...
    def test_get_node_errors_success(self, mock_get_rm, mock_result_manager, mock_settings):
        ...
        mock_result_manager.result_object.lattice.transport_graph.get_node_value = mock_get_node_value
    ...
    @patch('covalent_cloud.dispatch_management.node_operations.rm.get_result_manager')
    def test_get_node_errors_by_function_name(self, mock_get_rm, mock_result_manager, mock_settings):
...
class TestGetFirstFailure:
    ...
    def test_get_first_failure_success(self, mock_get_rm, mock_result_manager, mock_settings):
        ...
        mock_result_manager.result_object.lattice.transport_graph.get_node_value.side_effect = lambda node_id, attr: {
