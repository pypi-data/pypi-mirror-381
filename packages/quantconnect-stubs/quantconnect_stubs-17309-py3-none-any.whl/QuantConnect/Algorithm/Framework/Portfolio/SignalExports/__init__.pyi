...
class VBaseSignalExport(QuantConnect.Algorithm.Framework.Portfolio.SignalExports.BaseSignalExport):
    ...
    def __init__(self, api_key: str, collection_name: str, store_stamped_file: bool = True, idempotent: bool = False) -> None:
        ...
        :param idempotent: A boolean indicating whether to make the request idempotent. If the request is idempotent, only the first stamp for a given portfolio will be made. If the request is not idempotent, a new stamp will be made for each request.
        """
        ...
