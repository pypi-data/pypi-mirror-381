...
class GitContextFunction(FunctionPlugin):
    ...
    def description(self) -> str:
        return "Get git repository information including latest commit, status, and branch info"
...
class FileContextFunction(FunctionPlugin):
    ...
    @property
    def description(self) -> str:
        return "Get file system information including directory structure and file contents"
    ...
    def parameters(self) -> dict[str, ParameterSchema]:
        return {
            ...
            "info_type": ParameterSchema(
                ...
                required=False,
                default="structure",
                choices=["structure", "content", "stats", "all"],
                description="Type of file information to retrieve",
            ),
    ...
    async def execute(
        ...
        try:
            ...
            if info_type in ["content", "all"] and full_path.is_file():
                file_data["content"] = await self._get_file_content(full_path)
