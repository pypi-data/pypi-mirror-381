...
class InlineObject1NlAlternative(BaseModel):
    """
    ...
    var_from: Optional[InlineObject1NlAlternativeFrom] = Field(default=None, alias="from")
    to: Optional[InlineObject1NlAlternativeFrom] = None
    __properties: ClassVar[List[str]] = ["U21a", "U21b", "U07a", "U07b", "U07-U64", "U10s", "U64a", "U64b", "U09a", "U09b", "U08a", "U08b", "U08-U65", "U10n", "U65a", "U65b", "from", "to"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InlineObject1NlAlternative from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InlineObject1NlAlternative from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "U65a": obj.get("U65a"),
            "U65b": obj.get("U65b"),
            "from": InlineObject1NlAlternativeFrom.from_dict(obj["from"]) if obj.get("from") is not None else None,
            "to": InlineObject1NlAlternativeFrom.from_dict(obj["to"]) if obj.get("to") is not None else None
        })
        return _obj
