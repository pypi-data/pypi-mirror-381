...
class Incident(BaseModel):
    ...
    statuses: Optional[List[IncidentState]] = None
    phase: Optional[StrictStr] = None
    scheduled: Optional[StrictBool] = None
    published: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["title", "startDate", "statuses", "phase", "scheduled", "published"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statuses": [IncidentState.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None,
            "phase": obj.get("phase"),
