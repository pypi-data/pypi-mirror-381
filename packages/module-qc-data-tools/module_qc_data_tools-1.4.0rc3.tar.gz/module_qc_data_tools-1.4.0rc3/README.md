# module-qc-data-tools v1.4.0rc3

This project contains the modules needed to write/read the data files used in
the module QC flow documented at [itk.docs][]. This project is to be added as a
...
<!--<img src="https://gitlab.cern.ch/atlas-itk/pixel/module/module-qc-data-tools/-/raw/main/docs/assets/images/logo.svg" alt="mqdt logo" width="500" role="img">-->
...
[cicd-badge]:            https://gitlab.cern.ch/atlas-itk/pixel/module/module-qc-data-tools/badges/main/pipeline.svg
[cicd-link]:             https://gitlab.cern.ch/atlas-itk/pixel/module/module-qc-data-tools/-/commits/main
...
[docs-link]:                https://atlas-itk-pixel-mqdt.docs.cern.ch
[gitlab-issues-badge]:      https://img.shields.io/static/v1?label=Issues&message=File&color=blue&logo=gitlab
[gitlab-issues-link]:       https://gitlab.cern.ch/atlas-itk/pixel/module/module-qc-data-tools/-/issues
[pypi-link]:                https://pypi.org/project/module-qc-data-tools/
[pypi-downloads-dm]:        https://img.shields.io/pypi/dm/module-qc-data-tools.svg?color=blue&label=Downloads&logo=pypi&logoColor=gold
[pypi-downloads-total]:     https://pepy.tech/badge/module-qc-data-tools
[pypi-platforms]:           https://img.shields.io/pypi/pyversions/module-qc-data-tools
[pypi-version]:             https://img.shields.io/pypi/v/module-qc-data-tools
