...
def search_scenarios_use_case(
    ...
    """Search for scenarios by keyword, MITRE technique, or tag."""
    logger.info(f"--- Searching scenarios with query: '{query}' ---")
    try:
        scenarios = ScenarioUtils.search_scenarios(client, query, limit)
