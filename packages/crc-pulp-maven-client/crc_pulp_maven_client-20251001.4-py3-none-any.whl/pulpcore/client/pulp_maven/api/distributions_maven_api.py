...
class DistributionsMavenApi:
    ...
    def create(
        ...
        :param maven_maven_distribution: (required)
        :type maven_maven_distribution: MavenMavenDistribution
        ...
        _param = self._create_serialize(
            ...
            maven_maven_distribution=maven_maven_distribution,
    ...
    def _create_serialize(
        ...
        if maven_maven_distribution is not None:
            _body_params = maven_maven_distribution
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/pulp/{pulp_domain}/api/v3/distributions/maven/maven/',
    ...
    def delete(
        self,
        maven_maven_distribution_href: StrictStr,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param maven_maven_distribution_href: (required)
        :type maven_maven_distribution_href: str
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._delete_serialize(
            maven_maven_distribution_href=maven_maven_distribution_href,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _delete_serialize(
        ...
        # process the path parameters
        if maven_maven_distribution_href is not None:
            _path_params['maven_maven_distribution_href'] = maven_maven_distribution_href
        # process the query parameters
        # process the header parameters
        if x_task_diagnostics is not None:
            _header_params['X-Task-Diagnostics'] = x_task_diagnostics
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{maven_maven_distribution_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedmavenMavenDistributionResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedmavenMavenDistributionResponseList]:
        """List maven distributions
    ...
    def partial_update(
        ...
        :param maven_maven_distribution_href: (required)
        :type maven_maven_distribution_href: str
        :param patchedmaven_maven_distribution: (required)
        :type patchedmaven_maven_distribution: PatchedmavenMavenDistribution
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            maven_maven_distribution_href=maven_maven_distribution_href,
            patchedmaven_maven_distribution=patchedmaven_maven_distribution,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        self,
        maven_maven_distribution_href,
        patchedmaven_maven_distribution,
        x_task_diagnostics,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if patchedmaven_maven_distribution is not None:
            _body_params = patchedmaven_maven_distribution
    ...
    def read(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MavenMavenDistributionResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MavenMavenDistributionResponse]:
        """Inspect a maven distribution
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{maven_maven_distribution_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{maven_maven_distribution_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
