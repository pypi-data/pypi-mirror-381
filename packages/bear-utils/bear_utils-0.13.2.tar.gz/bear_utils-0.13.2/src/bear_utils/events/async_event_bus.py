...
class AsyncSingletonEventBus(AsyncEventBus, SingletonBase):
    """Asynchronous event bus singleton for registering and emitting async handlers only."""
