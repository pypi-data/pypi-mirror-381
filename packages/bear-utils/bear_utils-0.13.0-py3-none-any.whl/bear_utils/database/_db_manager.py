...
from bear_utils.database._db_config import DatabaseConfig, Schemas, get_default_config
...
# TODO: Need to decide if the default should be bypass=True or False
class DatabaseManager(metaclass=DatabaseManagerMeta, bypass=False):
    ...
    def register_records[T_Table](self, tbl_obj: type[T_Table], name: str | None = None) -> _DynamicRecords[T_Table]:
