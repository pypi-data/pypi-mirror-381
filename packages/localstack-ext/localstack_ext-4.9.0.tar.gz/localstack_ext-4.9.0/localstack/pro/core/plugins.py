...
API_DEPENDENCIES.update({'amplify':[_A,'appsync','cognito'],_C:[_D],_D:[_C],_E:[_A],'backup':[_A],'docdb':[_B],_F:['ecr','events'],_G:['ec2'],'elb':['elbv2'],'emr':[_E,_A],'glacier':[_A],'glue':[_A,'iam'],'iot':['iotanalytics','iot-data','iotwireless'],'kinesisanalytics':['kinesis','dynamodb'],_J:[_B],_B:['rds-data'],_H:['mediastore-data'],'redshift':['redshift-data'],'s3tables':[_A],'timestream':['timestream-write','timestream-query'],_I:[_A]})
