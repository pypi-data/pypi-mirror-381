...
class AccessDeniedForDependencyExceptionReason(StrEnum):
    ACCESS_DENIED_DURING_CREATE_SERVICE_LINKED_ROLE = (
        "ACCESS_DENIED_DURING_CREATE_SERVICE_LINKED_ROLE"
    )


class AccountJoinedMethod(StrEnum):
    INVITED = "INVITED"
    CREATED = "CREATED"
...
class ConstraintViolationExceptionReason(StrEnum):
...
class CreateAccountState(StrEnum):
    IN_PROGRESS = "IN_PROGRESS"
    SUCCEEDED = "SUCCEEDED"
    FAILED = "FAILED"


class EffectivePolicyType(StrEnum):
...
class HandshakeResourceType(StrEnum):
    ACCOUNT = "ACCOUNT"
    ORGANIZATION = "ORGANIZATION"
...
class IAMUserAccessToBilling(StrEnum):
    ALLOW = "ALLOW"
    DENY = "DENY"


class InvalidInputExceptionReason(StrEnum):
...
class AWSOrganizationsNotInUseException(ServiceException):
    ...
    code: str = "AWSOrganizationsNotInUseException"
...
class AccountAlreadyClosedException(ServiceException):
    ...
    code: str = "AccountAlreadyClosedException"
    sender_fault: bool = False
    status_code: int = 400
...
class AccountAlreadyRegisteredException(ServiceException):
    ...
    code: str = "AccountAlreadyRegisteredException"
    sender_fault: bool = False
    status_code: int = 400
...
class AccountOwnerNotVerifiedException(ServiceException):
    ...
    code: str = "AccountOwnerNotVerifiedException"
    sender_fault: bool = False
    status_code: int = 400
...
class AlreadyInOrganizationException(ServiceException):
    ...
    code: str = "AlreadyInOrganizationException"
    sender_fault: bool = False
    status_code: int = 400
...
class ChildNotFoundException(ServiceException):
    ...
    code: str = "ChildNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class ConstraintViolationException(ServiceException):
    ...
    -  ACCOUNT_NUMBER_LIMIT_EXCEEDED: You attempted to exceed the limit on
       ...
       Support <https://console.aws.amazon.com/support/home#/>`__ to request
    ...
    -  ALL_FEATURES_MIGRATION_ORGANIZATION_SIZE_LIMIT_EXCEEDED: Your
    ...
    -  CANNOT_REGISTER_SUSPENDED_ACCOUNT_AS_DELEGATED_ADMINISTRATOR: You
       cannot register a suspended account as a delegated administrator.
    ...
    -  MASTER_ACCOUNT_ADDRESS_DOES_NOT_MATCH_MARKETPLACE: To create an
       ...
       to the management account's address. All accounts in an organization
    ...
    -  MASTER_ACCOUNT_MISSING_BUSINESS_LICENSE: Applies only to the Amazon
       ...
       must have a valid business license. For more information, contact
       customer support.
    ...
    -  MASTER_ACCOUNT_PAYMENT_INSTRUMENT_REQUIRED: To create an organization
       ...
       payment instrument, such as a credit card, with the account. For more
       information, see `Considerations before removing an account from an
       organization <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_account-before-remove.html>`__
       in the *Organizations User Guide*.
...
class CreateAccountStatusNotFoundException(ServiceException):
    ...
    code: str = "CreateAccountStatusNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class DestinationParentNotFoundException(ServiceException):
    ...
    code: str = "DestinationParentNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class DuplicateAccountException(ServiceException):
    ...
    code: str = "DuplicateAccountException"
    sender_fault: bool = False
    status_code: int = 400
...
class DuplicateHandshakeException(ServiceException):
    ...
    code: str = "DuplicateHandshakeException"
    sender_fault: bool = False
    status_code: int = 400
...
class DuplicateOrganizationalUnitException(ServiceException):
    ...
    code: str = "DuplicateOrganizationalUnitException"
    sender_fault: bool = False
    status_code: int = 400
...
class DuplicatePolicyAttachmentException(ServiceException):
    ...
    code: str = "DuplicatePolicyAttachmentException"
    sender_fault: bool = False
    status_code: int = 400
...
class DuplicatePolicyException(ServiceException):
    ...
    code: str = "DuplicatePolicyException"
    sender_fault: bool = False
    status_code: int = 400
...
class EffectivePolicyNotFoundException(ServiceException):
    ...
    code: str = "EffectivePolicyNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class FinalizingOrganizationException(ServiceException):
    ...
    code: str = "FinalizingOrganizationException"
    sender_fault: bool = False
    status_code: int = 400
...
class HandshakeAlreadyInStateException(ServiceException):
    ...
    code: str = "HandshakeAlreadyInStateException"
    sender_fault: bool = False
    status_code: int = 400
...
class HandshakeNotFoundException(ServiceException):
    ...
    code: str = "HandshakeNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class InvalidHandshakeTransitionException(ServiceException):
    ...
    code: str = "InvalidHandshakeTransitionException"
    sender_fault: bool = False
    status_code: int = 400
...
class MalformedPolicyDocumentException(ServiceException):
    ...
    details about service control policy syntax, see `SCP
    syntax <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps_syntax.html>`__
    in the *Organizations User Guide*.
    """
...
class MasterCannotLeaveOrganizationException(ServiceException):
    ...
    code: str = "MasterCannotLeaveOrganizationException"
    sender_fault: bool = False
    status_code: int = 400
...
class OrganizationNotEmptyException(ServiceException):
    ...
    remove all accounts except the management account.
    """

    code: str = "OrganizationNotEmptyException"
    sender_fault: bool = False
    status_code: int = 400
...
class OrganizationalUnitNotEmptyException(ServiceException):
    ...
    code: str = "OrganizationalUnitNotEmptyException"
    sender_fault: bool = False
    status_code: int = 400
...
class OrganizationalUnitNotFoundException(ServiceException):
    ...
    code: str = "OrganizationalUnitNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class ParentNotFoundException(ServiceException):
    ...
    code: str = "ParentNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class PolicyChangesInProgressException(ServiceException):
    ...
    code: str = "PolicyChangesInProgressException"
    sender_fault: bool = False
    status_code: int = 400
...
class PolicyNotAttachedException(ServiceException):
    ...
    code: str = "PolicyNotAttachedException"
    sender_fault: bool = False
    status_code: int = 400
...
class PolicyTypeAlreadyEnabledException(ServiceException):
    ...
    code: str = "PolicyTypeAlreadyEnabledException"
    sender_fault: bool = False
    status_code: int = 400
...
class PolicyTypeNotAvailableForOrganizationException(ServiceException):
    ...
    code: str = "PolicyTypeNotAvailableForOrganizationException"
    sender_fault: bool = False
    status_code: int = 400
...
class PolicyTypeNotEnabledException(ServiceException):
    ...
    code: str = "PolicyTypeNotEnabledException"
    sender_fault: bool = False
    status_code: int = 400
...
class RootNotFoundException(ServiceException):
    ...
    code: str = "RootNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class SourceParentNotFoundException(ServiceException):
    ...
    code: str = "SourceParentNotFoundException"
    sender_fault: bool = False
    status_code: int = 400
...
class TooManyRequestsException(ServiceException):
    ...
    Organizations <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_reference_limits.html>`__
    in the *Organizations User Guide*.
    """
...
class UnsupportedAPIEndpointException(ServiceException):
    ...
    code: str = "UnsupportedAPIEndpointException"
    sender_fault: bool = False
    status_code: int = 400
...
class OrganizationsApi:
    ...
    def attach_policy(
        self, context: RequestContext, policy_id: PolicyId, target_id: PolicyTargetId, **kwargs
    ) -> None:
    ...
    def close_account(self, context: RequestContext, account_id: AccountId, **kwargs) -> None:
        """Closes an Amazon Web Services member account within an organization. You
        can close an account when `all features are
        enabled <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_org_support-all-features.html>`__
        ...
        -  You can close only 10% of member accounts, between 10 and 1000,
           ...
           limit, you can't close additional accounts. For more information, see
           `Closing a member account in your
           organization <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_close.html>`__
           and `Quotas for
           Organizations <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_reference_limits.html>`__
           in the *Organizations User Guide*.
    ...
    def create_account(
        ...
        **kwargs,
        ...
        tools <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/control-access-billing.html#grantaccess>`__.
    ...
    def create_gov_cloud_account(
        ...
        **kwargs,
        ...
        -  Check the CloudTrail log for the ``CreateAccountResult`` event. For
           information on using CloudTrail with Organizations, see `Logging and
           monitoring in
           Organizations <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_security_incident-response.html>`__
           in the *Organizations User Guide*.
        ...
        -  When you create an account in an organization using the Organizations
           ...
           information. For more information, see `Considerations before
           removing an account from an
           organization <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_account-before-remove.html>`__
           in the *Organizations User Guide*.
        ...
        -  Using ``CreateGovCloudAccount`` to create multiple temporary accounts
           ...
           for closing an account, see `Closing a member account in your
           organization <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_close.html>`__
           in the *Organizations User Guide*.
    ...
    def create_organizational_unit(
        ...
        **kwargs,
        ...
        (OUs) <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_ous.html>`__
        in the *Organizations User Guide*.
    ...
    def create_policy(
        self, context: RequestContext, request: CreatePolicyRequest, **kwargs
    ...
    def delete_organization(self, context: RequestContext, **kwargs) -> None:
    ...
    def delete_organizational_unit(
        self, context: RequestContext, organizational_unit_id: OrganizationalUnitId, **kwargs
    ) -> None:
    ...
    def delete_policy(self, context: RequestContext, policy_id: PolicyId, **kwargs) -> None:
    ...
    def describe_create_account_status(
        self, context: RequestContext, create_account_request_id: CreateAccountRequestId, **kwargs
    ...
    def describe_policy(
        self, context: RequestContext, policy_id: PolicyId, **kwargs
    ...
    @handler("DescribeResourcePolicy")
    ...
    def disable_policy_type(
        self, context: RequestContext, root_id: RootId, policy_type: PolicyType, **kwargs
    ...
    def enable_all_features(self, context: RequestContext, **kwargs) -> EnableAllFeaturesResponse:
    ...
    @handler("TagResource")
    def tag_resource(
        self, context: RequestContext, resource_id: TaggableResourceId, tags: Tags, **kwargs
    ) -> None:
    ...
    def untag_resource(
        self, context: RequestContext, resource_id: TaggableResourceId, tag_keys: TagKeys, **kwargs
    ) -> None:
