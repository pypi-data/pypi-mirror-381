...
def cli():from localstack.pro.core.bootstrap import licensingv2 as A;from localstack.utils.bootstrap import setup_logging as B;B();A.get_licensed_environment().activate()
@cli.command('debug')
def debug():
