...
def test_zeo():
    ...
    _run("canYouDigIt --verbose init --truerun --yes")
    _run("canYouDigIt --verbose jobs create --truerun --yes")
    _run("canYouDigIt --verbose runs create --run_name test --truerun")
    _run("canYouDigIt --verbose runs info --truerun")
    _run("canYouDigIt --verbose runs launch --truerun")
    _run("canYouDigIt --verbose full-update --run_name test --truerun")
    ...
    _run("canYouDigIt --verbose runs update --truerun nproc = 2")
