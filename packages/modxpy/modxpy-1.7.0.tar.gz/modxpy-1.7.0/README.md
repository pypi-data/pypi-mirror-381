...
vcompat()'s check range increased SIGNIFICANTLY.
Old range: GENERAL issue checking for only Python 2 to 3,
with about only 4 issues to check against.
New range: checks issues all the way from 2.0 to 3.12!
MASSIVELY increased issues to check against.
---
