...
NEW FUNCTION: vcompat(module_name, python_version)
Checks if a module is compatible with a python
version, if a version was given. If not given, 
returns any potential problems for all general
versions.
---
...
#Output: Compatibility Report for: pygame
  ...
  Location: C:\Users\*User*\AppData\Local\Programs\Python\Python313\Lib\site-packages\pygame\__init__.py
  Documentation: Available
  Public functions: 24
  Public classes: 12
  Target Python version: 2.0
  Compatibility warnings:
    - Uses Python 3 print function (not compatible with Python 2)
{'name': 'pygame', 'version': '2.6.1', 'file': 'C:\\Users\\austi\\AppData\\Local\\Programs\\Python\\Python313\\Lib\\site-packages\\pygame\\__init__.py', 'has_docs': True, 'functions': 24, 'classes': 12}
