...
setup(
    ...
    name="mobio-commit-gen-cli" + run_mode,  # Required
    ...
    description="Mobio Commit Gen CLI",  # Optional
    ...
    # larger catalog.
    keywords="mobio, commit gen cli, contact spam",  # Optional
    ...
    #
    packages=find_namespace_packages(include=["commit_gen.*"]),  # Required
    namespace_packages=["commit_gen"],  # Optional
