...
DEFAULT_NULL_VALUE = "DefaultNullValue"

FOLDER_DELIMITER = os.sep
...
B_UNIT_ATTRIBUTE_B_UNIT_NAME = "name"
...
DEFAULT_MASTER_TABLE_SUFFIX = "_1"

DEFAULT_FOREIGN_TABLE_SUFFIX = "_2"
