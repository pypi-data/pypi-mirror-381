...
class mail:
    ...
    def __connect_with_credentials(self):
        ...
        try:
            ...
            if self.logger: self.logger.info(f"La tentative de connexion à échoué : {str(e)}")
            raise
    ...
    def mark_as_un_seen(self, id):
        ...
        try:
            impa_conn.store(id, '-FLAGS', '\\UnSeen')
        except Exception as e:
            if self.logger: self.logger.info(f"Le changement de flag a échoué: {str(e)}.")
            raise
    ...
    def delete(self,id):
        ...
        try:
            impa_conn.store(id, '+FLAGS', '\\Deleted')
        except Exception as e:
