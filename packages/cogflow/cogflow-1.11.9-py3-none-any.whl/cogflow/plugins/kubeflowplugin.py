...
class KubeflowPlugin:
    ...
    def _create_kfp_client(self, session_cookies: str = None) -> kfp.Client:
        """
        ...
        return kfp.Client(host=self._api_url)

    @staticmethod
    def client(
        api_url: str = None, skip_tls_verify: bool = True, session_cookies: str = None
    ) -> kfp.Client:
        """
        ...
        return kfp_plugin._create_kfp_client(session_cookies=session_cookies)
