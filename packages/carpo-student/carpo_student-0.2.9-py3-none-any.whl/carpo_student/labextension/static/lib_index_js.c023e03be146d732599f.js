...
const fooIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_9__.LabIcon({
    name: 'barpkg:foo',
...
const plugin = {
    ...
    activate: (app, nbTrack, palette, settingRegistry) => {
        ...
        const DEBOUNCE_DELAY = 5000; // 15 seconds delay after user stops typing
...
class RaiseHandHelpButton {
    ...
    createNew(panel, context) {
        const raiseHand = () => {
            ...
            const problem_id = cell.model.sharedModel.getMetadata("problem") || undefined;
            if (problem_id === undefined) {
                (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.showErrorMessage)('Code Share Error', "Can not share non-exercise code cell.");
                return;
            }
            const postBody = {
                message: '',
...
//# sourceMappingURL=lib_index_js.c023e03be146d732599f.js.map