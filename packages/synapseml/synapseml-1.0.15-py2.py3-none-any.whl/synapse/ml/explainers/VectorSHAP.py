...
class VectorSHAP(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        model=None,
        numSamples=None,
        outputCol="VectorSHAP_f0979925586e__output",
        targetClasses=[],
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.explainers.VectorSHAP", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(infWeight=1.0E+8)
        self._setDefault(metricsCol="r2")
        self._setDefault(outputCol="VectorSHAP_f0979925586e__output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.explainers.VectorSHAP"
