...
class UnrollImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        java_obj=None,
        inputCol="image",
        outputCol="UnrollImage_a55359732151_output"
        ):
        super(UnrollImage, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.image.UnrollImage", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(inputCol="image")
        self._setDefault(outputCol="UnrollImage_a55359732151_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.image.UnrollImage"
