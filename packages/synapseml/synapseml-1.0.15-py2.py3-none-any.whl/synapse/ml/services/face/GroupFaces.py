...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    faceIds = Param(Params._dummy(), "faceIds", "ServiceParam: Array of candidate faceId created by Face - Detect. The maximum is 1000 faces.")
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GroupFaces_658a45853253_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_658a45853253_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.face.GroupFaces", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="GroupFaces_658a45853253_error")
        self._setDefault(outputCol="GroupFaces_658a45853253_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.face.GroupFaces"
