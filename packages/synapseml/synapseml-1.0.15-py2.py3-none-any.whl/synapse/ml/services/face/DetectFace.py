...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectFace_3e5fc4b6690c_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_3e5fc4b6690c_output",
        ...
        self._setDefault(errorCol="DetectFace_3e5fc4b6690c_error")
        self._setDefault(outputCol="DetectFace_3e5fc4b6690c_output")
