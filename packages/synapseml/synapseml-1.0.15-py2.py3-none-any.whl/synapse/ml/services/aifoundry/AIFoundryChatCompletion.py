...
@inherit_doc
class AIFoundryChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_9f6072b6b9a8_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_9f6072b6b9a8_output",
        ...
        super(AIFoundryChatCompletion, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.aifoundry.AIFoundryChatCompletion", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="OpenAIChatCompletion_9f6072b6b9a8_error")
        self._setDefault(outputCol="OpenAIChatCompletion_9f6072b6b9a8_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.aifoundry.AIFoundryChatCompletion"

    @staticmethod
    def _from_java(java_stage):
        module_name=AIFoundryChatCompletion.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".AIFoundryChatCompletion"
