...
@inherit_doc
class NER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        errorCol="NER_62d5a9bffef1_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="NER_62d5a9bffef1_output",
        showStats=None,
        showStatsCol=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.text.NER", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(batchSize=10)
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="NER_62d5a9bffef1_error")
        self._setDefault(outputCol="NER_62d5a9bffef1_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.text.NER"

    @staticmethod
    def _from_java(java_stage):
        module_name=NER.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".NER"
