...
@inherit_doc
class TextSentiment(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    opinionMining = Param(Params._dummy(), "opinionMining", "ServiceParam: if set to true, response will contain not only sentiment prediction but also opinion mining (aspect-based sentiment analysis) results.")
    ...
    def __init__(
        ...
        errorCol="TextSentiment_c1b68330bbdb_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        ...
        outputCol="TextSentiment_c1b68330bbdb_output",
        showStats=None,
        showStatsCol=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.text.TextSentiment", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(batchSize=10)
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="TextSentiment_c1b68330bbdb_error")
        self._setDefault(outputCol="TextSentiment_c1b68330bbdb_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.text.TextSentiment"

    @staticmethod
    def _from_java(java_stage):
        module_name=TextSentiment.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".TextSentiment"
