...
class AnalyzeHealthText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="AnalyzeHealthText_d57e97d04fcb_error",
        ...
        outputCol="AnalyzeHealthText_d57e97d04fcb_output",
        pollingDelay=300,
        showStats=None,
        showStatsCol=None,
        ...
        super(AnalyzeHealthText, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.text.AnalyzeHealthText", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(backoffs=[100,500,1000])
        self._setDefault(batchSize=10)
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="AnalyzeHealthText_d57e97d04fcb_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeHealthText_d57e97d04fcb_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.text.AnalyzeHealthText"

    @staticmethod
    def _from_java(java_stage):
        module_name=AnalyzeHealthText.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".AnalyzeHealthText"
