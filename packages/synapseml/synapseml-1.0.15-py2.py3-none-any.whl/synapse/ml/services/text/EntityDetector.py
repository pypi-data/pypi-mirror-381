...
@inherit_doc
class EntityDetector(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        errorCol="EntityDetector_8fa4fae6e446_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="EntityDetector_8fa4fae6e446_output",
        showStats=None,
        showStatsCol=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.text.EntityDetector", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(batchSize=10)
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="EntityDetector_8fa4fae6e446_error")
        self._setDefault(outputCol="EntityDetector_8fa4fae6e446_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.text.EntityDetector"

    @staticmethod
    def _from_java(java_stage):
        module_name=EntityDetector.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".EntityDetector"
