...
@inherit_doc
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    op = Param(Params._dummy(), "op", "ServiceParam: Specify whether to return summary or full list of models.")
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_b69a7d5807a8_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_b69a7d5807a8_output",
        ...
        super(ListCustomModels, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.form.ListCustomModels", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="ListCustomModels_b69a7d5807a8_error")
        self._setDefault(outputCol="ListCustomModels_b69a7d5807a8_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.form.ListCustomModels"

    @staticmethod
    def _from_java(java_stage):
        module_name=ListCustomModels.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".ListCustomModels"
    ...
    def setOp(self, value):
        ...
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        self._java_obj = self._java_obj.setOp(value)
        return self
    
    def setOpCol(self, value):
        """
        Args:
            op: Specify whether to return summary or full list of models.
        """
        self._java_obj = self._java_obj.setOpCol(value)
        return self
