...
@inherit_doc
class AnalyzeCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeCustomModel_b5be858b49ef_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        modelId=None,
        modelIdCol=None,
        outputCol="AnalyzeCustomModel_b5be858b49ef_output",
        pollingDelay=300,
        ...
        super(AnalyzeCustomModel, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.form.AnalyzeCustomModel", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(backoffs=[100,500,1000])
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="AnalyzeCustomModel_b5be858b49ef_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeCustomModel_b5be858b49ef_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.form.AnalyzeCustomModel"

    @staticmethod
    def _from_java(java_stage):
        module_name=AnalyzeCustomModel.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".AnalyzeCustomModel"
