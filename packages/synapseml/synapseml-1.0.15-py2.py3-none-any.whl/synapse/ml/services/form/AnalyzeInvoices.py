...
@inherit_doc
class AnalyzeInvoices(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeInvoices_64b44f8dae58_error",
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        imageUrlCol=None,
        ...
        outputCol="AnalyzeInvoices_64b44f8dae58_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        ...
        super(AnalyzeInvoices, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.form.AnalyzeInvoices", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(backoffs=[100,500,1000])
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="AnalyzeInvoices_64b44f8dae58_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeInvoices_64b44f8dae58_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.form.AnalyzeInvoices"

    @staticmethod
    def _from_java(java_stage):
        module_name=AnalyzeInvoices.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".AnalyzeInvoices"
