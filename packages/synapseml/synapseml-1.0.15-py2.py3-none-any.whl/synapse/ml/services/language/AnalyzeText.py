...
class AnalyzeText(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeText_493265661daf_error",
        handler=None,
        kind=None,
        language=None,
        languageCol=None,
        ...
        outputCol="AnalyzeText_493265661daf_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="AnalyzeText_493265661daf_error")
        self._setDefault(outputCol="AnalyzeText_493265661daf_output")
