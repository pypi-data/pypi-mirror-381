...
class AnalyzeTextLongRunningOperations(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="AnalyzeTextLongRunningOperations_7243c129ff3d_error",
        ...
        outputCol="AnalyzeTextLongRunningOperations_7243c129ff3d_output",
        overlapPolicy=None,
        ...
        self._setDefault(errorCol="AnalyzeTextLongRunningOperations_7243c129ff3d_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeTextLongRunningOperations_7243c129ff3d_output")
