...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GenerateThumbnails_855ca206a8f5_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_855ca206a8f5_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_855ca206a8f5_error")
        self._setDefault(outputCol="GenerateThumbnails_855ca206a8f5_output")
