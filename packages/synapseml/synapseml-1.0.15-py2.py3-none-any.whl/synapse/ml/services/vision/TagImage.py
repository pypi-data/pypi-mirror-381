...
@inherit_doc
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    language = Param(Params._dummy(), "language", "ServiceParam: The desired language for output generation.")
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="TagImage_4aaaa1fb32b9_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_4aaaa1fb32b9_output",
        ...
        super(TagImage, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.vision.TagImage", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="TagImage_4aaaa1fb32b9_error")
        self._setDefault(outputCol="TagImage_4aaaa1fb32b9_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.vision.TagImage"

    @staticmethod
    def _from_java(java_stage):
        module_name=TagImage.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".TagImage"
