...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    detectOrientation = Param(Params._dummy(), "detectOrientation", "ServiceParam: whether to detect image orientation prior to processing")
    ...
    language = Param(Params._dummy(), "language", "ServiceParam: the language to use")
    ...
    def __init__(
        ...
        errorCol="OCR_e3f03d3d0e1c_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_e3f03d3d0e1c_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.vision.OCR", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="OCR_e3f03d3d0e1c_error")
        self._setDefault(outputCol="OCR_e3f03d3d0e1c_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.vision.OCR"
    ...
    def getDetectOrientation(self):
        ...
        Returns:
            detectOrientation: whether to detect image orientation prior to processing
        """
        return self._java_obj.getDetectOrientation()
