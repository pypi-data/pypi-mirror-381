...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AddDocuments_2b156a7c739c_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_2b156a7c739c_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_2b156a7c739c_error")
        self._setDefault(outputCol="AddDocuments_2b156a7c739c_output")
