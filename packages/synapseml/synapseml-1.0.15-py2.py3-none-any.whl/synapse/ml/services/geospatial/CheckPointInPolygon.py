...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    latitude = Param(Params._dummy(), "latitude", "ServiceParam: the latitude of location")
    
    longitude = Param(Params._dummy(), "longitude", "ServiceParam: the longitude of location")
    ...
    userDataIdentifier = Param(Params._dummy(), "userDataIdentifier", "ServiceParam: the identifier for the user uploaded data")
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_a6e67dbae87a_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_a6e67dbae87a_output",
        subscriptionKey=None,
        subscriptionKeyCol=None,
        timeout=60.0,
        url="https://atlas.microsoft.com/",
        userDataIdentifier=None,
        userDataIdentifierCol=None
        ):
        super(CheckPointInPolygon, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.geospatial.CheckPointInPolygon", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="CheckPointInPolygon_a6e67dbae87a_error")
        self._setDefault(outputCol="CheckPointInPolygon_a6e67dbae87a_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.geospatial.CheckPointInPolygon"

    @staticmethod
    def _from_java(java_stage):
        module_name=CheckPointInPolygon.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".CheckPointInPolygon"
    ...
    def setLatitude(self, value):
        ...
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        self._java_obj = self._java_obj.setLatitude(value)
        return self
    ...
    def setLatitudeCol(self, value):
        ...
        Args:
            latitude: the latitude of location
        """
        self._java_obj = self._java_obj.setLatitudeCol(value)
        return self
    ...
    def setLongitude(self, value):
        ...
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        self._java_obj = self._java_obj.setLongitude(value)
        return self
    ...
    def setLongitudeCol(self, value):
        ...
        Args:
            longitude: the longitude of location
        """
        self._java_obj = self._java_obj.setLongitudeCol(value)
        return self
    ...
    def setUserDataIdentifier(self, value):
        ...
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        self._java_obj = self._java_obj.setUserDataIdentifier(value)
        return self
    ...
    def setUserDataIdentifierCol(self, value):
        ...
        Args:
            userDataIdentifier: the identifier for the user uploaded data
        """
        self._java_obj = self._java_obj.setUserDataIdentifierCol(value)
        return self
    ...
    def getLatitude(self):
        ...
        Returns:
            latitude: the latitude of location
        """
        return self._java_obj.getLatitude()
    ...
    def getLongitude(self):
        ...
        Returns:
            longitude: the longitude of location
        """
        return self._java_obj.getLongitude()
    ...
    def getUserDataIdentifier(self):
        ...
        Returns:
            userDataIdentifier: the identifier for the user uploaded data
        """
        return self._java_obj.getUserDataIdentifier()
