...
class OpenAIEmbedding(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        dimensions=None,
        dimensionsCol=None,
        errorCol="OpenAIEmbedding_334d11e3f6af_error",
        handler=None,
        outputCol="OpenAIEmbedding_334d11e3f6af_output",
        ...
        self._setDefault(errorCol="OpenAIEmbedding_334d11e3f6af_error")
        self._setDefault(outputCol="OpenAIEmbedding_334d11e3f6af_output")
