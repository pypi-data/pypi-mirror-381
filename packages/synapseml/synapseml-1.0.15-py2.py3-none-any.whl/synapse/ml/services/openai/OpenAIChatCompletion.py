...
@inherit_doc
class OpenAIChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_f17f2ab1085e_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_f17f2ab1085e_output",
        ...
        super(OpenAIChatCompletion, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.openai.OpenAIChatCompletion", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="OpenAIChatCompletion_f17f2ab1085e_error")
        self._setDefault(outputCol="OpenAIChatCompletion_f17f2ab1085e_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.openai.OpenAIChatCompletion"

    @staticmethod
    def _from_java(java_stage):
        module_name=OpenAIChatCompletion.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".OpenAIChatCompletion"
