...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_96d3500dde1a_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_96d3500dde1a_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_96d3500dde1a_error")
        self._setDefault(outputCol="OpenAICompletion_96d3500dde1a_output")
