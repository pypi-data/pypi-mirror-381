...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    text = Param(Params._dummy(), "text", "ServiceParam: The text to annotate with inferred emotion")
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_db41dc0f64a6_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_db41dc0f64a6_output",
        ...
        super(SpeakerEmotionInference, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.speech.SpeakerEmotionInference", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="SpeakerEmotionInference_db41dc0f64a6_error")
        self._setDefault(outputCol="SpeakerEmotionInference_db41dc0f64a6_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.speech.SpeakerEmotionInference"

    @staticmethod
    def _from_java(java_stage):
        module_name=SpeakerEmotionInference.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".SpeakerEmotionInference"
