...
@inherit_doc
class ConversationTranscription(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        super(ConversationTranscription, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.speech.ConversationTranscription", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.speech.ConversationTranscription"

    @staticmethod
    def _from_java(java_stage):
        module_name=ConversationTranscription.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".ConversationTranscription"
