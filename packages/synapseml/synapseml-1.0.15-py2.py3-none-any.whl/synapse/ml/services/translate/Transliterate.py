...
@inherit_doc
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_36eff88a5a4f_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_36eff88a5a4f_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.translate.Transliterate", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="Transliterate_36eff88a5a4f_error")
        self._setDefault(outputCol="Transliterate_36eff88a5a4f_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.translate.Transliterate"

    @staticmethod
    def _from_java(java_stage):
        module_name=Transliterate.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".Transliterate"
