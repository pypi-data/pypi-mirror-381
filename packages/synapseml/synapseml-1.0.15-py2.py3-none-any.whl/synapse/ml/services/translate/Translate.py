...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Translate_d9ca9b581259_error",
        fromLanguage=None,
        ...
        outputCol="Translate_d9ca9b581259_output",
        ...
        self._setDefault(errorCol="Translate_d9ca9b581259_error")
        self._setDefault(outputCol="Translate_d9ca9b581259_output")
