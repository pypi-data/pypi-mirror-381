...
class BreakSentence(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    language = Param(Params._dummy(), "language", "ServiceParam: Language tag identifying the language of the input text. If a code is not specified, automatic language detection will be applied.")
    
    outputCol = Param(Params._dummy(), "outputCol", "The name of the output column", typeConverter=TypeConverters.toString)
    
    script = Param(Params._dummy(), "script", "ServiceParam: Script tag identifying the script used by the input text. If a script is not specified, the default script of the language will be assumed.")
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="BreakSentence_95d2bf5f4887_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="BreakSentence_95d2bf5f4887_output",
        script=None,
        scriptCol=None,
        ...
        super(BreakSentence, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.translate.BreakSentence", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="BreakSentence_95d2bf5f4887_error")
        self._setDefault(outputCol="BreakSentence_95d2bf5f4887_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.translate.BreakSentence"

    @staticmethod
    def _from_java(java_stage):
        module_name=BreakSentence.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".BreakSentence"
    ...
    def setScript(self, value):
        ...
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        self._java_obj = self._java_obj.setScript(value)
        return self
    ...
    def setScriptCol(self, value):
        ...
        Args:
            script: Script tag identifying the script used by the input text. If a script is not specified, the default script of the language will be assumed.
        """
        self._java_obj = self._java_obj.setScriptCol(value)
        return self
    ...
    def getScript(self):
        ...
        Returns:
            script: Script tag identifying the script used by the input text. If a script is not specified, the default script of the language will be assumed.
        """
        return self._java_obj.getScript()
