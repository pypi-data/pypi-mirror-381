...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryLookup_81f7178f030e_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_81f7178f030e_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_81f7178f030e_error")
        self._setDefault(outputCol="DictionaryLookup_81f7178f030e_output")
