...
@inherit_doc
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    Args:
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_93129dc37136_error",
        handler=None,
        outputCol="Detect_93129dc37136_output",
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.services.translate.Detect", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(concurrency=1)
        self._setDefault(errorCol="Detect_93129dc37136_error")
        self._setDefault(outputCol="Detect_93129dc37136_output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.services.translate.Detect"

    @staticmethod
    def _from_java(java_stage):
        module_name=Detect.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".Detect"
