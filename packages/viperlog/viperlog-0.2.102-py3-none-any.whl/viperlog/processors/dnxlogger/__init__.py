...
if TYPE_CHECKING:
    from plugin_viperlog_dnxlogger import DnxLoggerProcessor, patch_dnxlogger
else:
    try:
        from plugin_viperlog_dnxlogger import DnxLoggerProcessor, patch_dnxlogger
        ...
        getLogger("viperlog").error("The ConsoleProcessor is not available because the 'viperlog[dnxlogger]' or 'viperlog[all]' package is not installed")
