...
class VRobotState(StatesMsgT):
    def __init__(self, instance: StatesMsgT = None) -> None:
        if instance is None:
            ...
            self.collisions = [Collision(c) for c in instance.collisions]
    ...
    def get_dict_data(self):
        return {
            ...
            "pwm": [int(i) for i in self.pwm] if self.pwm is not None else [],
            "actuators": [i for i in self.actuators] if self.actuators is not None else [],
            ...
            "moment_arms": [i for i in self.momentArms] if self.momentArms is not None else [],
            "moi_3x1": self.moi3x1.get_dict_data(),
            "moi_3x3": [i for i in self.moi3x3] if self.moi3x3 is not None else [],
            "extra_props": [i for i in self.extraProps] if self.extraProps is not None else [],
            "collisions": [i.get_dict_data() for i in self.collisions] if self.collisions is not None else [],
            "image_data_0": [i for i in self.imageData0] if self.imageData0 is not None else [],
            "image_data_1": [i for i in self.imageData1] if self.imageData1 is not None else [],
