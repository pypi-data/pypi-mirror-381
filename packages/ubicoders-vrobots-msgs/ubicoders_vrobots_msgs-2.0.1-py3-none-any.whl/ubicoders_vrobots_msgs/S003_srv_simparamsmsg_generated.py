...
def SrvSimParamsMsgAddSysId(builder, sysId):
...
def SrvSimParamsMsgAddStreamToRjs(builder, streamToRjs):
    builder.PrependInt32Slot(5, streamToRjs, 0)

def SrvSimParamsMsgAddStreamToWs(builder, streamToWs):
    builder.PrependInt32Slot(6, streamToWs, 0)

def SrvSimParamsMsgAddNoiseOn(builder, noiseOn):
    builder.PrependInt32Slot(7, noiseOn, 0)

def SrvSimParamsMsgAddImgResolution(builder, imgResolution):
    builder.PrependInt32Slot(8, imgResolution, 0)
...
def SrvSimParamsMsgAddSetImgResolution(builder, setImgResolution):
    builder.PrependInt32Slot(12, setImgResolution, 0)
...
class SrvSimParamsMsgT(object):
    ...
    def _UnPack(self, srvSimParamsMsg):
        ...
        self.sysId = srvSimParamsMsg.SysId()
        ...
        self.imgResolution = srvSimParamsMsg.ImgResolution()
        ...
        self.setImgResolution = srvSimParamsMsg.SetImgResolution()
    ...
    def Pack(self, builder):
        ...
        SrvSimParamsMsgAddSysId(builder, self.sysId)
        ...
        SrvSimParamsMsgAddImgResolution(builder, self.imgResolution)
        ...
        SrvSimParamsMsgAddSetImgResolution(builder, self.setImgResolution)
