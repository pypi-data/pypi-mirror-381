...
class InvokeParallelCallRequest(BaseModel):
    """
    InvokeParallelCallRequest
    """ # noqa: E501
    method: StrictStr = Field(description="HTTP method to use for each request")
    endpoint: StrictStr = Field(description="API Endpoint to call for each data object")
    data_list: List[InvokeParallelCallRequestDataListInner] = Field(description="List of data objects to process in parallel, each with its own connection_id and optionally organization_id")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvokeParallelCallRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvokeParallelCallRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data_list": [InvokeParallelCallRequestDataListInner.from_dict(_item) for _item in obj["data_list"]] if obj.get("data_list") is not None else None,
