...
class PluginsApi:
    ...
    def get_list(
    ...
    ) -> List[GetList200ResponseInner]:
        """get_list

        Get a list of all plugins for the given namespace
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[GetList200ResponseInner]",
        }
    ...
    def get_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetList200ResponseInner]]:
        """get_list
    ...
    def _get_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/plugins/plugins/get_list/{namespace}/',
