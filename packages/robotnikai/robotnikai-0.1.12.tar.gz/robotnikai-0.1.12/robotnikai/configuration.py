...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "knoxApiToken": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = robotnikai.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("robotnikai")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'knoxApiToken' in self.api_key:
            auth['knoxApiToken'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
