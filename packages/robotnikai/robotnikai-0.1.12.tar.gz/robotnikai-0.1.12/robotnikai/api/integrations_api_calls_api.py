...
class IntegrationsAPICallsApi:
    ...
    def invoke_parallel_call(
        self,
        integration_id: StrictStr,
        connection_id: Annotated[Optional[Any], Field(description="Unique identifier for the integration provider account. Defaults to the primary key of the account object. Alternative identifiers may be used based on authentication type: OAuth (email or UID), API Keys (key name), or Basic Authentication (username).")] = None,
        ...
        :type connection_id: InvokeParallelCallConnectionIdParameter
        ...
        :type organization_id: InvokeParallelCallConnectionIdParameter
        :param table: Table name to use for account resolution and validation.
        :type table: InvokeParallelCallConnectionIdParameter
