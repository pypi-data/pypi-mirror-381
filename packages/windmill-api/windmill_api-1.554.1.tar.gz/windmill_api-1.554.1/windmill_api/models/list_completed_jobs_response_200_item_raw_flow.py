...
if TYPE_CHECKING:
    ...
    from ..models.list_completed_jobs_response_200_item_raw_flow_preprocessor_module import (
        ListCompletedJobsResponse200ItemRawFlowPreprocessorModule,
    )
...
class ListCompletedJobsResponse200ItemRawFlow:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, ListCompletedJobsResponse200ItemRawFlowPreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "ListCompletedJobsResponse200ItemRawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = ListCompletedJobsResponse200ItemRawFlowPreprocessorModule.from_dict(
