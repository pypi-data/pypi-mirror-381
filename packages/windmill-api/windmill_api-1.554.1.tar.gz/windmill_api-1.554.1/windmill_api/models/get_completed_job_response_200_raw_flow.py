...
if TYPE_CHECKING:
    ...
    from ..models.get_completed_job_response_200_raw_flow_modules_item import (
        GetCompletedJobResponse200RawFlowModulesItem,
    )
    from ..models.get_completed_job_response_200_raw_flow_preprocessor_module import (
        GetCompletedJobResponse200RawFlowPreprocessorModule,
    )
...
class GetCompletedJobResponse200RawFlow:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, GetCompletedJobResponse200RawFlowPreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "GetCompletedJobResponse200RawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = GetCompletedJobResponse200RawFlowPreprocessorModule.from_dict(_preprocessor_module)
