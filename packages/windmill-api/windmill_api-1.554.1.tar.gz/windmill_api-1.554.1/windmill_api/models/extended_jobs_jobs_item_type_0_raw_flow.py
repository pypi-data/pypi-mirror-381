...
if TYPE_CHECKING:
    from ..models.extended_jobs_jobs_item_type_0_raw_flow_failure_module import (
        ExtendedJobsJobsItemType0RawFlowFailureModule,
    )
    from ..models.extended_jobs_jobs_item_type_0_raw_flow_modules_item import (
        ExtendedJobsJobsItemType0RawFlowModulesItem,
    )
    from ..models.extended_jobs_jobs_item_type_0_raw_flow_preprocessor_module import (
        ExtendedJobsJobsItemType0RawFlowPreprocessorModule,
    )


T = TypeVar("T", bound="ExtendedJobsJobsItemType0RawFlow")


@_attrs_define
class ExtendedJobsJobsItemType0RawFlow:
    """
    Attributes:
        modules (List['ExtendedJobsJobsItemType0RawFlowModulesItem']):
        failure_module (Union[Unset, ExtendedJobsJobsItemType0RawFlowFailureModule]):
        preprocessor_module (Union[Unset, ExtendedJobsJobsItemType0RawFlowPreprocessorModule]):
    ...
    modules: List["ExtendedJobsJobsItemType0RawFlowModulesItem"]
    failure_module: Union[Unset, "ExtendedJobsJobsItemType0RawFlowFailureModule"] = UNSET
    preprocessor_module: Union[Unset, "ExtendedJobsJobsItemType0RawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for modules_item_data in _modules:
            modules_item = ExtendedJobsJobsItemType0RawFlowModulesItem.from_dict(modules_item_data)
        ...
        if isinstance(_failure_module, Unset):
            ...
            failure_module = ExtendedJobsJobsItemType0RawFlowFailureModule.from_dict(_failure_module)
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = ExtendedJobsJobsItemType0RawFlowPreprocessorModule.from_dict(_preprocessor_module)
        ...
        return extended_jobs_jobs_item_type_0_raw_flow
