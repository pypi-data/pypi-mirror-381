...
if TYPE_CHECKING:
    ...
    from ..models.queued_job_raw_flow_preprocessor_module import QueuedJobRawFlowPreprocessorModule
...
class QueuedJobRawFlow:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, QueuedJobRawFlowPreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "QueuedJobRawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = QueuedJobRawFlowPreprocessorModule.from_dict(_preprocessor_module)
