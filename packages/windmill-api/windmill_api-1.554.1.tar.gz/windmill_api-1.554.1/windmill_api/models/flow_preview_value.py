...
if TYPE_CHECKING:
    ...
    from ..models.flow_preview_value_preprocessor_module import FlowPreviewValuePreprocessorModule
...
class FlowPreviewValue:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, FlowPreviewValuePreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "FlowPreviewValuePreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = FlowPreviewValuePreprocessorModule.from_dict(_preprocessor_module)
