...
if TYPE_CHECKING:
    ...
    from ..models.get_hub_flow_by_id_response_200_flow_value_preprocessor_module import (
        GetHubFlowByIdResponse200FlowValuePreprocessorModule,
    )
...
class GetHubFlowByIdResponse200FlowValue:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, GetHubFlowByIdResponse200FlowValuePreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "GetHubFlowByIdResponse200FlowValuePreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = GetHubFlowByIdResponse200FlowValuePreprocessorModule.from_dict(_preprocessor_module)
