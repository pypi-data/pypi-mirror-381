...
if TYPE_CHECKING:
    from ..models.list_queue_response_200_item_raw_flow_failure_module import (
        ListQueueResponse200ItemRawFlowFailureModule,
    )
    from ..models.list_queue_response_200_item_raw_flow_modules_item import ListQueueResponse200ItemRawFlowModulesItem
    from ..models.list_queue_response_200_item_raw_flow_preprocessor_module import (
        ListQueueResponse200ItemRawFlowPreprocessorModule,
    )
...
class ListQueueResponse200ItemRawFlow:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, ListQueueResponse200ItemRawFlowPreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "ListQueueResponse200ItemRawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.list_queue_response_200_item_raw_flow_modules_item import (
            ListQueueResponse200ItemRawFlowModulesItem,
        )
        from ..models.list_queue_response_200_item_raw_flow_preprocessor_module import (
            ListQueueResponse200ItemRawFlowPreprocessorModule,
        )
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = ListQueueResponse200ItemRawFlowPreprocessorModule.from_dict(_preprocessor_module)
