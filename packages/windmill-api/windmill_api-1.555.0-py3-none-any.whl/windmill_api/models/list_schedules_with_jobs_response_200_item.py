...
if TYPE_CHECKING:
    ...
    from ..models.list_schedules_with_jobs_response_200_item_jobs_item import (
        ListSchedulesWithJobsResponse200ItemJobsItem,
    )
...
class ListSchedulesWithJobsResponse200Item:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_retry, Unset):
            ...
            retry = ListSchedulesWithJobsResponse200ItemRetry.from_dict(_retry)
