...
if TYPE_CHECKING:
    from ..models.extended_jobs_jobs_item_type_1_raw_flow_failure_module import (
    ...
    from ..models.extended_jobs_jobs_item_type_1_raw_flow_preprocessor_module import (
        ExtendedJobsJobsItemType1RawFlowPreprocessorModule,
    )


T = TypeVar("T", bound="ExtendedJobsJobsItemType1RawFlow")


@_attrs_define
class ExtendedJobsJobsItemType1RawFlow:
    """
    Attributes:
        modules (List['ExtendedJobsJobsItemType1RawFlowModulesItem']):
        failure_module (Union[Unset, ExtendedJobsJobsItemType1RawFlowFailureModule]):
        preprocessor_module (Union[Unset, ExtendedJobsJobsItemType1RawFlowPreprocessorModule]):
    ...
    modules: List["ExtendedJobsJobsItemType1RawFlowModulesItem"]
    failure_module: Union[Unset, "ExtendedJobsJobsItemType1RawFlowFailureModule"] = UNSET
    preprocessor_module: Union[Unset, "ExtendedJobsJobsItemType1RawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for modules_item_data in _modules:
            modules_item = ExtendedJobsJobsItemType1RawFlowModulesItem.from_dict(modules_item_data)
        ...
        if isinstance(_failure_module, Unset):
            ...
            failure_module = ExtendedJobsJobsItemType1RawFlowFailureModule.from_dict(_failure_module)
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = ExtendedJobsJobsItemType1RawFlowPreprocessorModule.from_dict(_preprocessor_module)
        ...
        return extended_jobs_jobs_item_type_1_raw_flow
