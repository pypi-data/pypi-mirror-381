...
if TYPE_CHECKING:
    from ..models.get_suspended_job_flow_response_200_job_type_0_raw_flow_failure_module import (
        GetSuspendedJobFlowResponse200JobType0RawFlowFailureModule,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_0_raw_flow_modules_item import (
        GetSuspendedJobFlowResponse200JobType0RawFlowModulesItem,
    )
    from ..models.get_suspended_job_flow_response_200_job_type_0_raw_flow_preprocessor_module import (
        GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModule,
    )


T = TypeVar("T", bound="GetSuspendedJobFlowResponse200JobType0RawFlow")


@_attrs_define
class GetSuspendedJobFlowResponse200JobType0RawFlow:
    """
    Attributes:
        modules (List['GetSuspendedJobFlowResponse200JobType0RawFlowModulesItem']):
        failure_module (Union[Unset, GetSuspendedJobFlowResponse200JobType0RawFlowFailureModule]):
        preprocessor_module (Union[Unset, GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModule]):
    ...
    modules: List["GetSuspendedJobFlowResponse200JobType0RawFlowModulesItem"]
    failure_module: Union[Unset, "GetSuspendedJobFlowResponse200JobType0RawFlowFailureModule"] = UNSET
    preprocessor_module: Union[Unset, "GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for modules_item_data in _modules:
            modules_item = GetSuspendedJobFlowResponse200JobType0RawFlowModulesItem.from_dict(modules_item_data)
        ...
        if isinstance(_failure_module, Unset):
            ...
            failure_module = GetSuspendedJobFlowResponse200JobType0RawFlowFailureModule.from_dict(_failure_module)
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = GetSuspendedJobFlowResponse200JobType0RawFlowPreprocessorModule.from_dict(
        ...
        return get_suspended_job_flow_response_200_job_type_0_raw_flow
