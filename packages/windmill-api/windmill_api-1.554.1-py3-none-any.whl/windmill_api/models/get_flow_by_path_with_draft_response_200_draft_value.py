...
if TYPE_CHECKING:
    ...
    from ..models.get_flow_by_path_with_draft_response_200_draft_value_preprocessor_module import (
        GetFlowByPathWithDraftResponse200DraftValuePreprocessorModule,
    )
...
class GetFlowByPathWithDraftResponse200DraftValue:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, GetFlowByPathWithDraftResponse200DraftValuePreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "GetFlowByPathWithDraftResponse200DraftValuePreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = GetFlowByPathWithDraftResponse200DraftValuePreprocessorModule.from_dict(
