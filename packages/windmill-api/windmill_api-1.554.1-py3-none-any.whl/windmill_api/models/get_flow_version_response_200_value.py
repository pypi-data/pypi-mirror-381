...
if TYPE_CHECKING:
    from ..models.get_flow_version_response_200_value_failure_module import GetFlowVersionResponse200ValueFailureModule
    from ..models.get_flow_version_response_200_value_modules_item import GetFlowVersionResponse200ValueModulesItem
    from ..models.get_flow_version_response_200_value_preprocessor_module import (
        GetFlowVersionResponse200ValuePreprocessorModule,
    )


T = TypeVar("T", bound="GetFlowVersionResponse200Value")


@_attrs_define
class GetFlowVersionResponse200Value:
    """
    Attributes:
        modules (List['GetFlowVersionResponse200ValueModulesItem']):
        failure_module (Union[Unset, GetFlowVersionResponse200ValueFailureModule]):
        preprocessor_module (Union[Unset, GetFlowVersionResponse200ValuePreprocessorModule]):
    ...
    modules: List["GetFlowVersionResponse200ValueModulesItem"]
    failure_module: Union[Unset, "GetFlowVersionResponse200ValueFailureModule"] = UNSET
    preprocessor_module: Union[Unset, "GetFlowVersionResponse200ValuePreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.get_flow_version_response_200_value_failure_module import (
            GetFlowVersionResponse200ValueFailureModule,
        )
        from ..models.get_flow_version_response_200_value_modules_item import GetFlowVersionResponse200ValueModulesItem
        from ..models.get_flow_version_response_200_value_preprocessor_module import (
            GetFlowVersionResponse200ValuePreprocessorModule,
        ...
        for modules_item_data in _modules:
            modules_item = GetFlowVersionResponse200ValueModulesItem.from_dict(modules_item_data)
        ...
        if isinstance(_failure_module, Unset):
            ...
            failure_module = GetFlowVersionResponse200ValueFailureModule.from_dict(_failure_module)
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = GetFlowVersionResponse200ValuePreprocessorModule.from_dict(_preprocessor_module)
        ...
        return get_flow_version_response_200_value
