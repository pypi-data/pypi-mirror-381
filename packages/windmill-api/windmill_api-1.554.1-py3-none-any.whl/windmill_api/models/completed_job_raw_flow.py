...
if TYPE_CHECKING:
    ...
    from ..models.completed_job_raw_flow_preprocessor_module import CompletedJobRawFlowPreprocessorModule
...
class CompletedJobRawFlow:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, CompletedJobRawFlowPreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "CompletedJobRawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = CompletedJobRawFlowPreprocessorModule.from_dict(_preprocessor_module)
