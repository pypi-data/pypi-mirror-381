...
class OpenFlowWPathValue:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, OpenFlowWPathValuePreprocessorModule]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = OpenFlowWPathValuePreprocessorModule.from_dict(_preprocessor_module)
