...
if TYPE_CHECKING:
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_failure_module import (
        ListExtendedJobsResponse200JobsItemType0RawFlowFailureModule,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_modules_item import (
        ListExtendedJobsResponse200JobsItemType0RawFlowModulesItem,
    )
    from ..models.list_extended_jobs_response_200_jobs_item_type_0_raw_flow_preprocessor_module import (
        ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModule,
    )


T = TypeVar("T", bound="ListExtendedJobsResponse200JobsItemType0RawFlow")


@_attrs_define
class ListExtendedJobsResponse200JobsItemType0RawFlow:
    """
    Attributes:
        modules (List['ListExtendedJobsResponse200JobsItemType0RawFlowModulesItem']):
        failure_module (Union[Unset, ListExtendedJobsResponse200JobsItemType0RawFlowFailureModule]):
        preprocessor_module (Union[Unset, ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModule]):
    ...
    modules: List["ListExtendedJobsResponse200JobsItemType0RawFlowModulesItem"]
    failure_module: Union[Unset, "ListExtendedJobsResponse200JobsItemType0RawFlowFailureModule"] = UNSET
    preprocessor_module: Union[Unset, "ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for modules_item_data in _modules:
            modules_item = ListExtendedJobsResponse200JobsItemType0RawFlowModulesItem.from_dict(modules_item_data)
        ...
        if isinstance(_failure_module, Unset):
            ...
            failure_module = ListExtendedJobsResponse200JobsItemType0RawFlowFailureModule.from_dict(_failure_module)
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = ListExtendedJobsResponse200JobsItemType0RawFlowPreprocessorModule.from_dict(
        ...
        return list_extended_jobs_response_200_jobs_item_type_0_raw_flow
