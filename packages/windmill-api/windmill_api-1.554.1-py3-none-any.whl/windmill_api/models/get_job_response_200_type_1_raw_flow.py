...
if TYPE_CHECKING:
    from ..models.get_job_response_200_type_1_raw_flow_failure_module import GetJobResponse200Type1RawFlowFailureModule
    from ..models.get_job_response_200_type_1_raw_flow_modules_item import GetJobResponse200Type1RawFlowModulesItem
    from ..models.get_job_response_200_type_1_raw_flow_preprocessor_module import (
        GetJobResponse200Type1RawFlowPreprocessorModule,
    )


T = TypeVar("T", bound="GetJobResponse200Type1RawFlow")


@_attrs_define
class GetJobResponse200Type1RawFlow:
    """
    Attributes:
        modules (List['GetJobResponse200Type1RawFlowModulesItem']):
        failure_module (Union[Unset, GetJobResponse200Type1RawFlowFailureModule]):
        preprocessor_module (Union[Unset, GetJobResponse200Type1RawFlowPreprocessorModule]):
    ...
    modules: List["GetJobResponse200Type1RawFlowModulesItem"]
    failure_module: Union[Unset, "GetJobResponse200Type1RawFlowFailureModule"] = UNSET
    preprocessor_module: Union[Unset, "GetJobResponse200Type1RawFlowPreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.get_job_response_200_type_1_raw_flow_failure_module import (
            GetJobResponse200Type1RawFlowFailureModule,
        )
        from ..models.get_job_response_200_type_1_raw_flow_modules_item import GetJobResponse200Type1RawFlowModulesItem
        from ..models.get_job_response_200_type_1_raw_flow_preprocessor_module import (
            GetJobResponse200Type1RawFlowPreprocessorModule,
        ...
        for modules_item_data in _modules:
            modules_item = GetJobResponse200Type1RawFlowModulesItem.from_dict(modules_item_data)
        ...
        if isinstance(_failure_module, Unset):
            ...
            failure_module = GetJobResponse200Type1RawFlowFailureModule.from_dict(_failure_module)
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = GetJobResponse200Type1RawFlowPreprocessorModule.from_dict(_preprocessor_module)
        ...
        return get_job_response_200_type_1_raw_flow
