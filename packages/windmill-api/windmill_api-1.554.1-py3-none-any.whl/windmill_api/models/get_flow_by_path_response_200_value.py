...
if TYPE_CHECKING:
    ...
    from ..models.get_flow_by_path_response_200_value_preprocessor_module import (
        GetFlowByPathResponse200ValuePreprocessorModule,
    )
...
class GetFlowByPathResponse200Value:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, GetFlowByPathResponse200ValuePreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "GetFlowByPathResponse200ValuePreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.get_flow_by_path_response_200_value_failure_module import (
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = GetFlowByPathResponse200ValuePreprocessorModule.from_dict(_preprocessor_module)
