...
if TYPE_CHECKING:
    ...
    from ..models.open_flow_value_preprocessor_module import OpenFlowValuePreprocessorModule
...
class OpenFlowValue:
    ...
    Attributes:
        ...
        preprocessor_module (Union[Unset, OpenFlowValuePreprocessorModule]):
    ...
    preprocessor_module: Union[Unset, "OpenFlowValuePreprocessorModule"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_preprocessor_module, Unset):
            ...
            preprocessor_module = OpenFlowValuePreprocessorModule.from_dict(_preprocessor_module)
