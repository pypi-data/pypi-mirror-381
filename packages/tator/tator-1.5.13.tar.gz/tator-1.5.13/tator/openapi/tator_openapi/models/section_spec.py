...
class SectionSpec(object):
    ...
    def __init__(self, attributes=None, dtype=None, elemental_id=None, explicit_listing=None, media=None, name=None, object_search=None, path=None, related_search=None, tator_user_sections=None, visible=None, local_vars_configuration=None):  # noqa: E501
