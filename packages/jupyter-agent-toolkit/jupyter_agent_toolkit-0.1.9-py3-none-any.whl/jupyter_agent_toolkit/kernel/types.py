...
# Type Aliases
OutputCallback = Callable[[List[Dict[str, Any]], Optional[int]], Awaitable[None]]
...
class ExecutionResult:
    ...
    Fields:
        ...
        outputs: List of plain dicts (stream, display_data, execute_result, error) as required by nbformat
