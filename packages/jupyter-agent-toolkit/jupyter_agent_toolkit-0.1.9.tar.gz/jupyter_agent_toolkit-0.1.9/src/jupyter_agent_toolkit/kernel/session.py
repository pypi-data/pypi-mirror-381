"""
Session factory for jupyter-agent-toolkit.
...
from .types import ExecutionResult, SessionConfig, OutputCallback
...
class Session:
    ...
    @property
    def kernel_manager(self) -> Optional["KernelManager"]:
        """
...
def create_session(config: SessionConfig = SessionConfig()) -> Session:
    """
