...
from jupyter_agent_toolkit.kernel.transports.server import ServerConfig
...
async def test_server_execute_ok():
    ...
    try:
        ...
        assert any(o.output_type in ("stream", "execute_result", "display_data") for o in res.outputs)
    finally:
        await sess.shutdown()