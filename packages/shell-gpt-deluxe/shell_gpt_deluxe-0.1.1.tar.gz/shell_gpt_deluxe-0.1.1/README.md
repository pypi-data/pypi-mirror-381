...
## ⚡ NEW: Plan-Execute Mode (Extension)

This fork extends ShellGPT with **autonomous multi-step task execution** through the new `--plan-execute` mode. Instead of generating a single command or code snippet, ShellGPT can now decompose complex tasks into structured plans, estimate costs upfront, and execute each step with your approval.

### Key Features

- **🎯 Multi-Step Planning**: LLM generates a complete execution plan with clear steps (code creation, shell commands, verification)
- **💰 Cost Transparency**: See upfront token and cost estimates before execution begins
- **🔍 Smart Verification**: Automatic syntax checking and test execution to validate generated code
- **📦 Dependency Management**: Automatically detects new packages, updates requirements.txt, and runs pip install
- **🛡️ Safety First**: Warns before overwriting files, shows diffs, and requires approval for each step
- **✅ Test-Driven Development**: Creates both code and comprehensive tests, then verifies everything passes
- **🎨 Rich Terminal UI**: Professional formatting with tables, syntax highlighting, and progress indicators

### Quick Start

```shell
# Create a Python calculator with comprehensive tests
sgpt --plan-execute "Create a calculator in Python with unit tests using pytest"

# Build a web scraper with error handling
sgpt --plan-execute "Build a web scraper that fetches top HN stories and saves to JSON"

# Auto-approve all steps (skip interactive approval)
sgpt --plan-execute "Create a Dockerfile for a Flask app" --auto-approve
```

### How It Works

1. **Planning Phase**: LLM analyzes your request and generates a structured plan with steps
2. **Cost Estimate**: See total estimated tokens and costs before proceeding
3. **Step-by-Step Execution**: Each step is displayed with preview and awaits approval (Approve/Modify/Skip/Quit)
4. **Verification**: Code is automatically verified (syntax checks, test execution)
5. **Summary**: See what was accomplished, files created, dependencies installed, tests passed
...
Execution Plan
┏━━━━┳━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━┳━━━━━━━━━━━━┓
┃ #  ┃ Status ┃ Description                        ┃ Type         ┃ Est. Cost  ┃
┡━━━━╇━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━┩
│ 1  │ ○      │ Create calculator.py               │ code         │ $0.0012    │
│ 2  │ ○      │ Create test_calculator.py          │ code         │ $0.0015    │
│ 3  │ ○      │ Install pytest                     │ shell        │ $0.0003    │
│ 4  │ ○      │ Run tests                          │ verification │ $0.0002    │
└────┴────────┴────────────────────────────────────┴──────────────┴────────────┘

Total Estimated Cost: $0.0032 (3200 tokens)
```
...
│ --plan-execute    -planexec               Enable multi-step autonomous task execution.                   │
│ --auto-approve                            Skip step-by-step approval (execute entire plan).              │
│ --hide-costs                              Hide cost estimates in plan display.                           │
╰──────────────────────────────────────────────────────────────────────────────────────────────────────────╯
```

## Installation
```shell
pip install shell-gpt-deluxe
```
By default, ShellGPT-Deluxe uses OpenAI's API and GPT-4 model. You'll need an API key, you can generate one [here](https://beta.openai.com/account/api-keys). You will be prompted for your key which will then be stored in `~/.config/shell_gpt/.sgptrc`. OpenAI API is not free of charge, please refer to the [OpenAI pricing](https://openai.com/pricing) for more information.

> [!TIP]
> Alternatively, you can use locally hosted open source models which are available for free. To use local models, you will need to run your own LLM backend server such as [Ollama](https://github.com/ollama/ollama). To set up ShellGPT-Deluxe with Ollama, please follow this comprehensive [guide](https://github.com/TheR1D/shell_gpt/wiki/Ollama).
>

# Original ShellGPT GUIDE
