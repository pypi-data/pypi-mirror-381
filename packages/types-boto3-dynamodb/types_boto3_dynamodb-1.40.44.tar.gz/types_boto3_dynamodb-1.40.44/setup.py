...
setup(
    ...
    description="Type annotations for boto3 DynamoDB 1.40.44 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    package_data={"types_boto3_dynamodb": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
