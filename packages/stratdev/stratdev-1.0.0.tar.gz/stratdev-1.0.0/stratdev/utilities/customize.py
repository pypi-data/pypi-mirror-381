...
def set_strategy(init:bool=False, strat_path: str='./strategy.py', bt_path: str='./backtest.py') -> None:
    ...
    if change_name == 'Yes':
        ...
        write_to_file(strat_path, [new_strat_line_strategy], [8])
        write_to_file(bt_path, [new_strat_line_import], [3])
        write_to_file(bt_path, [new_strat_line_backtest], [6])
