...
T = TypeVar("T", bound="PaginatedResultApiTagResultsItem")


@_attrs_define
class PaginatedResultApiTagResultsItem:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        paginated_result_api_tag_results_item = cls(
            category=category,
            from_date=from_date,
            id=id,
        ...
        paginated_result_api_tag_results_item.additional_properties = d
        return paginated_result_api_tag_results_item
