...
from ...models.paginated_result_category import PaginatedResultCategory
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/{organisation_group}/{organisation_id}/se-units/categories",
        "params": params,
    }
...
) -> Optional[Union[ErrorResponsePayload, PaginatedResultCategory]]:
    if response.status_code == 200:
        response_200 = PaginatedResultCategory.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponsePayload, PaginatedResultCategory]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponsePayload, PaginatedResultCategory]
    """
