    ...
    async def on_error(
        ...
        async def wrapper(evt: tg.DataReadyEventData) -> None:
            ...
            proc_err_evt = ProcessingErrorEvent(
                ...
                error_msg=(await evt.device.read_attribute("last_error")).value,
            )
