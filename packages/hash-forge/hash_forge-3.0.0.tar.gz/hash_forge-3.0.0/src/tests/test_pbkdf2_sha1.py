...
from hash_forge.hashers import PBKDF2Sha1Hasher


@pytest.fixture
def pbkdf2_hasher() -> PBKDF2Sha1Hasher:
    """
    Fixture for creating a PBKDF2Sha1Hasher instance with a specified number of iterations.
...
def test_pbkdf2_verify_incorrect_data(pbkdf2_hasher: PBKDF2Sha1Hasher) -> None:
    """
...
def test_pbkdf2_needs_rehash_false(pbkdf2_hasher: PBKDF2Sha1Hasher) -> None:
    """
...
def test_pbkdf2_needs_rehash_true(pbkdf2_hasher: PBKDF2Sha1Hasher) -> None:
    """
...
def test_pbkdf2_invalid_hash_format(pbkdf2_hasher: PBKDF2Sha1Hasher) -> None:
    """
