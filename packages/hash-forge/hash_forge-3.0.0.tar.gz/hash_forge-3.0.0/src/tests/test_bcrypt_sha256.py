...
@pytest.fixture
def bcrypt_hasher() -> BCryptSha256Hasher:
    """
    Creates and returns an instance of BCryptSha256Hasher with a specified number of rounds.

    Returns:
        BCryptSha256Hasher: An instance of BCryptSha256Hasher configured with 12 rounds.
    """
    return BCryptSha256Hasher(rounds=12)


def test_bcrypt_hash_format(bcrypt_hasher: BCryptSha256Hasher) -> None:
    """
...
def test_bcrypt_verify_correct_data(bcrypt_hasher: BCryptSha256Hasher) -> None:
    """
...
def test_bcrypt_verify_incorrect_data(bcrypt_hasher: BCryptSha256Hasher) -> None:
    """
...
def test_bcrypt_needs_rehash_false(bcrypt_hasher: BCryptSha256Hasher) -> None:
    """
...
def test_bcrypt_invalid_hash_format(bcrypt_hasher: BCryptSha256Hasher) -> None:
    """
...
def test_bcrypt_unknown_algorithm(bcrypt_hasher: BCryptSha256Hasher) -> None:
    """
