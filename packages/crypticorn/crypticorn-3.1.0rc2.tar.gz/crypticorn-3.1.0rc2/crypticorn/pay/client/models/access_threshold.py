...
class AccessThreshold(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessThreshold from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessThreshold from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"usd_amount": obj.get("usd_amount"), "scope": obj.get("scope")}
        )
        return _obj
