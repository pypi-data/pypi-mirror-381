...
class DashboardField(BaseModel):
    ...
    value: StrictStr = Field(description="The value of the field.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DashboardField from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DashboardField from a dict"""
        if obj is None:
            return None
