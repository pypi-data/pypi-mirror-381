...
class UpdateWalletRequest(BaseModel):
    ...
    name: StrictStr = Field(description="Display name for the wallet")
    id: StrictStr = Field(description="ID of the wallet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "id": obj.get("id")})
        return _obj
