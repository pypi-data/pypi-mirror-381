...
class TestSetCatalogContextCommand(unittest.TestCase):
    ...
    def test_handle_set_catalog_context_success(self, mock_execute_switch):
        ...
        with patch('builtins.print') as mock_print:
            ...
            self.assertTrue(any("Environment variables have been set in the current shell." in call for call in print_calls))
    ...
    def test_command_spec_attributes(self):
        ...
        self.assertEqual(SET_CATALOG_CONTEXT_COMMAND.help, "Switch to catalog and set environment variables")
