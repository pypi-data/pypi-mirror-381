...
from edgeai_sdk.commands.set_catalog_context import (
...
class TestSetCatalogContextCommand(unittest.TestCase):
    ...
    @patch('edgeai_sdk.commands.set_catalog_context._launch_shell')
    @patch('edgeai_sdk.commands.set_catalog_context.execute_catalog_switch')
