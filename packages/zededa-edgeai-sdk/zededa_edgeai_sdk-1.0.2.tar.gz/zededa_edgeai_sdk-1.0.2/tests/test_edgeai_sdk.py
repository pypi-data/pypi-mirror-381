...
from edgeai_sdk.client import ZededaEdgeAIClient, logout
from edgeai_sdk.edgeai_sdk import ZededaEdgeAISDK
...
class TestEdgeAISDK(unittest.TestCase):
    ...
    @patch("edgeai_sdk.services.http.requests.request")
    ...
    def test_logout_clears_environment(self):
        ...
        from edgeai_sdk.commands import logout as logout_module
    ...
    @patch("edgeai_sdk.commands.catalogs.execute_catalog_switch")
    ...
    def test_module_level_list_catalogs(self, mock_client_class):
        ...
        from edgeai_sdk.client import list_catalogs
