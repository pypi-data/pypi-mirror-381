...
from edgeai_sdk import cli
from edgeai_sdk.cli import main
from edgeai_sdk.exceptions import UserCancelledError, AuthenticationError
...
class TestCLI(unittest.TestCase):
    ...
    @patch('edgeai_sdk.commands.register_subcommands')
