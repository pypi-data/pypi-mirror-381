...
from edgeai_sdk.commands import (
    CommandSpec,
    get_command,
    iter_commands,
    register_subcommands,
)
from edgeai_sdk.commands.login import (
    execute_login,
    _normalize_catalog,
    _mask,
)
...
class TestCommandRegistry(unittest.TestCase):
    ...
    def test_iter_commands_returns_all_commands(self):
        """Test that iter_commands yields all available commands (login, catalog, logout, set-catalog-context)."""
...
class TestLoginCommand(unittest.TestCase):
    ...
    @patch("edgeai_sdk.commands.login._login_with_browser")
    @patch("edgeai_sdk.commands.login.apply_environment")
    @patch("edgeai_sdk.commands.login.sanitize_credentials")
    ...
    @patch("edgeai_sdk.commands.login._login_with_credentials")
    @patch("edgeai_sdk.commands.login.apply_environment")
    @patch("edgeai_sdk.commands.login.sanitize_credentials")
    ...
    @patch("edgeai_sdk.commands.login.getpass")
    @patch("edgeai_sdk.commands.login._login_with_credentials")
    @patch("edgeai_sdk.commands.login.apply_environment")
    @patch("edgeai_sdk.commands.login.sanitize_credentials")
