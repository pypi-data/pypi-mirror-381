...
from edgeai_sdk.commands.catalogs import (
...
from edgeai_sdk.exceptions import AuthenticationError
...
class TestCatalogsCommand(unittest.TestCase):
    ...
    @patch("edgeai_sdk.commands.catalogs.ZededaEdgeAISDK")
    @patch("edgeai_sdk.commands.catalogs.apply_environment")
    @patch("edgeai_sdk.commands.catalogs.sanitize_credentials")
    ...
    @patch('edgeai_sdk.commands.catalogs._handle_list_command')
...
class TestCatalogsCommand(unittest.TestCase):
    ...
    @patch("edgeai_sdk.commands.catalogs.execute_catalog_list")
    ...
    def test_handle_cli_list_option(self):
        ...
        with patch('edgeai_sdk.commands.catalogs._handle_list_command') as mock_handle:
            handle_cli(args)
            # The service_url gets resolved to default, not None
            mock_handle.assert_called_once_with("https://studio.edgeai.zededa.dev", False)
