...
class Experiment(BaseModel):
    ...
    dataset_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the dataset this experiment belongs to", alias="datasetId")
    dataset_version_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the dataset version this experiment belongs to", alias="datasetVersionId")
    created_at: Optional[datetime] = Field(default=None, description="Timestamp for when the experiment was created", alias="createdAt")
