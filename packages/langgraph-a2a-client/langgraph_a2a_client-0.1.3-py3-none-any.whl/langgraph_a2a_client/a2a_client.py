...
class A2AClientToolProvider:
    """A2A Client tool provider that manages multiple A2A agents and exposes tools for LangGraph."""
    ...
    def tools(self) -> list[StructuredTool]:
        """Extract all tools as LangChain StructuredTool instances."""
        _tools = [
