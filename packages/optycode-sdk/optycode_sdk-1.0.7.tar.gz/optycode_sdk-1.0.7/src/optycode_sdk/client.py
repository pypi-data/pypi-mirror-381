...
class OptycodeAPI:
    ...
    def log_data(self, user_question: str, model_answer: str, model_id: int, session_id= None, model_input= None, question_id= None, rag_elements= None) -> dict:
        """
    ...
    def log_data_async(self, user_question: str, model_answer: str, model_id: int, session_id= None, model_input= None, question_id= None, rag_elements= None):
        payload = {
            "timestamp": datetime.now().isoformat(),
            "question": user_question,
            "answer": model_answer,
