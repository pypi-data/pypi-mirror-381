...
import behaverify.variations.naive.node_creator as node_creator
...
def write_smv(nodes, variables, declared_enumerations, tick_condition, specifications, hyper_mode, output_file = None, do_not_trim = False):
