...
if TYPE_CHECKING:
    from ..models.patch_user_body_props import PatchUserBodyProps
...
class PatchUserBody:
    ...
    Attributes:
        ...
        props (Union[Unset, PatchUserBodyProps]):
    ...
    props: Union[Unset, "PatchUserBodyProps"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_props, Unset):
            ...
            props = PatchUserBodyProps.from_dict(_props)
