...
T = TypeVar("T", bound="ConfigServiceSettings")
...
class ConfigServiceSettings:
    ...
    Attributes:
        ...
        listen_address (Union[Unset, str]):
        connection_security (Union[Unset, str]):
        tls_cert_file (Union[Unset, str]):
        tls_key_file (Union[Unset, str]):
        use_lets_encrypt (Union[Unset, bool]):
        lets_encrypt_certificate_cache_file (Union[Unset, str]):
        ...
        segment_developer_key (Union[Unset, str]):
        google_developer_key (Union[Unset, str]):
        ...
        allow_cors_from (Union[Unset, str]):
        session_length_web_in_days (Union[Unset, int]):
        session_length_mobile_in_days (Union[Unset, int]):
        session_length_sso_in_days (Union[Unset, int]):
        session_cache_in_minutes (Union[Unset, int]):
        websocket_secure_port (Union[Unset, int]):
        websocket_port (Union[Unset, int]):
        webserver_mode (Union[Unset, str]):
        enable_custom_emoji (Union[Unset, bool]):
        restrict_custom_emoji_creation (Union[Unset, str]):
    """

    site_url: Union[Unset, str] = UNSET
    listen_address: Union[Unset, str] = UNSET
    connection_security: Union[Unset, str] = UNSET
    tls_cert_file: Union[Unset, str] = UNSET
    tls_key_file: Union[Unset, str] = UNSET
    use_lets_encrypt: Union[Unset, bool] = UNSET
    lets_encrypt_certificate_cache_file: Union[Unset, str] = UNSET
    ...
    segment_developer_key: Union[Unset, str] = UNSET
    google_developer_key: Union[Unset, str] = UNSET
    ...
    allow_cors_from: Union[Unset, str] = UNSET
    session_length_web_in_days: Union[Unset, int] = UNSET
    session_length_mobile_in_days: Union[Unset, int] = UNSET
    session_length_sso_in_days: Union[Unset, int] = UNSET
    session_cache_in_minutes: Union[Unset, int] = UNSET
    websocket_secure_port: Union[Unset, int] = UNSET
    websocket_port: Union[Unset, int] = UNSET
    webserver_mode: Union[Unset, str] = UNSET
    enable_custom_emoji: Union[Unset, bool] = UNSET
    restrict_custom_emoji_creation: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_service_settings.additional_properties = d
        return config_service_settings
