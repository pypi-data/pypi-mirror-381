...
T = TypeVar("T", bound="EnvironmentConfigGitLabSettings")


@_attrs_define
class EnvironmentConfigGitLabSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment_config_git_lab_settings = cls(
            enable=enable,
            secret=secret,
            id=id,
            scope=scope,
        ...
        environment_config_git_lab_settings.additional_properties = d
        return environment_config_git_lab_settings
