...
from ..models.add_checklist_item_body_state import AddChecklistItemBodyState
from ..types import UNSET, Unset

T = TypeVar("T", bound="AddChecklistItemBody")


@_attrs_define
class AddChecklistItemBody:
    """
    Attributes:
        title (str): The title of the checklist item. Example: Gather information from customer..
        state (Union[Unset, AddChecklistItemBodyState]): The state of the checklist item. An empty string means that the
            item is not done. Example: closed.
    ...
    title: str
    state: Union[Unset, AddChecklistItemBodyState] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state: Union[Unset, AddChecklistItemBodyState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = AddChecklistItemBodyState(_state)
        ...
        add_checklist_item_body.additional_properties = d
        return add_checklist_item_body
