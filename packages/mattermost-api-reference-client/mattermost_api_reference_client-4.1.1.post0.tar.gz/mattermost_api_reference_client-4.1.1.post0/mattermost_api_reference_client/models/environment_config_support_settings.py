...
class EnvironmentConfigSupportSettings:
    ...
    Attributes:
        ...
        report_a_problem_type (Union[Unset, bool]):
        report_a_problem_mail (Union[Unset, bool]):
    ...
    report_a_problem_type: Union[Unset, bool] = UNSET
    report_a_problem_mail: Union[Unset, bool] = UNSET
