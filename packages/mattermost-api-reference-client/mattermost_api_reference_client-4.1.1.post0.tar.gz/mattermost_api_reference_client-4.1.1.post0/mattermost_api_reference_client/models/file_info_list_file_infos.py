...
T = TypeVar("T", bound="FileInfoListFileInfos")


@_attrs_define
class FileInfoListFileInfos:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file_info_list_file_infos.additional_properties = additional_properties
        return file_info_list_file_infos
