...
T = TypeVar("T", bound="EnvironmentConfigTeamSettings")


@_attrs_define
class EnvironmentConfigTeamSettings:
    """
    Attributes:
        site_name (Union[Unset, bool]):
        max_users_per_team (Union[Unset, bool]):
        enable_team_creation (Union[Unset, bool]):
        enable_user_creation (Union[Unset, bool]):
        enable_open_server (Union[Unset, bool]):
        restrict_creation_to_domains (Union[Unset, bool]):
        enable_custom_brand (Union[Unset, bool]):
        custom_brand_text (Union[Unset, bool]):
        custom_description_text (Union[Unset, bool]):
        restrict_direct_message (Union[Unset, bool]):
        restrict_team_invite (Union[Unset, bool]):
        restrict_public_channel_management (Union[Unset, bool]):
        restrict_private_channel_management (Union[Unset, bool]):
        restrict_public_channel_creation (Union[Unset, bool]):
        restrict_private_channel_creation (Union[Unset, bool]):
        restrict_public_channel_deletion (Union[Unset, bool]):
        restrict_private_channel_deletion (Union[Unset, bool]):
        user_status_away_timeout (Union[Unset, bool]):
        max_channels_per_team (Union[Unset, bool]):
        max_notifications_per_channel (Union[Unset, bool]):
    """

    site_name: Union[Unset, bool] = UNSET
    max_users_per_team: Union[Unset, bool] = UNSET
    ...
    restrict_creation_to_domains: Union[Unset, bool] = UNSET
    enable_custom_brand: Union[Unset, bool] = UNSET
    custom_brand_text: Union[Unset, bool] = UNSET
    custom_description_text: Union[Unset, bool] = UNSET
    restrict_direct_message: Union[Unset, bool] = UNSET
    restrict_team_invite: Union[Unset, bool] = UNSET
    restrict_public_channel_management: Union[Unset, bool] = UNSET
    restrict_private_channel_management: Union[Unset, bool] = UNSET
    restrict_public_channel_creation: Union[Unset, bool] = UNSET
    restrict_private_channel_creation: Union[Unset, bool] = UNSET
    restrict_public_channel_deletion: Union[Unset, bool] = UNSET
    restrict_private_channel_deletion: Union[Unset, bool] = UNSET
    user_status_away_timeout: Union[Unset, bool] = UNSET
    max_channels_per_team: Union[Unset, bool] = UNSET
    max_notifications_per_channel: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment_config_team_settings = cls(
            site_name=site_name,
        ...
        environment_config_team_settings.additional_properties = d
        return environment_config_team_settings
