...
) -> Optional[Union[AppError, list["DataRetentionPolicyWithTeamAndChannelCounts"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, list["DataRetentionPolicyWithTeamAndChannelCounts"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[AppError, list['DataRetentionPolicyWithTeamAndChannelCounts']]
    """
