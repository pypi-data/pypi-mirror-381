...
from ...models.search_channels_for_retention_policy_body import SearchChannelsForRetentionPolicyBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v4/data_retention/policies/{policy_id}/channels/search",
    }
