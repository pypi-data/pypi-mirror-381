...
from ...models.create_user_access_token_body import CreateUserAccessTokenBody
...
def _get_kwargs(
    user_id: str,
    *,
    body: CreateUserAccessTokenBody,
) -> dict[str, Any]:
...
) -> Optional[Union[AppError, UserAccessToken]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, UserAccessToken]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AppError, UserAccessToken]
    """
