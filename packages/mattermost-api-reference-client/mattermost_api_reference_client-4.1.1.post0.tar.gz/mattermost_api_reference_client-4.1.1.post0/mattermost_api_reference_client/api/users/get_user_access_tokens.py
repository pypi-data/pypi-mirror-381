...
) -> Optional[Union[AppError, list["UserAccessTokenSanitized"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, list["UserAccessTokenSanitized"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[AppError, list['UserAccessTokenSanitized']]
    """
