...
from ...models.view_channel_body import ViewChannelBody
...
) -> Optional[Union[AppError, ViewChannelResponse200]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, ViewChannelResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AppError, ViewChannelResponse200]
    """
