...
) -> Optional[Union[AppError, list["OrderedSidebarCategories"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, list["OrderedSidebarCategories"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AppError, list['OrderedSidebarCategories']]
    """
