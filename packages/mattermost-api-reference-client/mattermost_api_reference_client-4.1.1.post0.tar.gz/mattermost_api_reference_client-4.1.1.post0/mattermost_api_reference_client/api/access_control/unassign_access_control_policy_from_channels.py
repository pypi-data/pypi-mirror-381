...
from ...models.unassign_access_control_policy_from_channels_body import UnassignAccessControlPolicyFromChannelsBody
...
def _get_kwargs(
    policy_id: str,
    *,
    body: UnassignAccessControlPolicyFromChannelsBody,
) -> dict[str, Any]:
