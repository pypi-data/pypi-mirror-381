...
from ...models.create_playbook_body import CreatePlaybookBody
...
) -> Optional[Union[CreatePlaybookResponse201, Error]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreatePlaybookResponse201, Error]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CreatePlaybookResponse201, Error]
    """
