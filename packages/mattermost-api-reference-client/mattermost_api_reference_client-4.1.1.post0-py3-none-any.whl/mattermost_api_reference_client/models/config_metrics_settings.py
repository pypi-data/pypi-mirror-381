...
T = TypeVar("T", bound="ConfigMetricsSettings")


@_attrs_define
class ConfigMetricsSettings:
    """
    Attributes:
        enable (Union[Unset, bool]):
        block_profile_rate (Union[Unset, int]):
        listen_address (Union[Unset, str]):
    """

    enable: Union[Unset, bool] = UNSET
    block_profile_rate: Union[Unset, int] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_metrics_settings = cls(
            enable=enable,
            block_profile_rate=block_profile_rate,
            listen_address=listen_address,
        )

        config_metrics_settings.additional_properties = d
        return config_metrics_settings
