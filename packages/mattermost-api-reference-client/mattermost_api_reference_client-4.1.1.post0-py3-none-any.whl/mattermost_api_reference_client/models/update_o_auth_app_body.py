...
T = TypeVar("T", bound="UpdateOAuthAppBody")


@_attrs_define
class UpdateOAuthAppBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_o_auth_app_body.additional_properties = d
        return update_o_auth_app_body
