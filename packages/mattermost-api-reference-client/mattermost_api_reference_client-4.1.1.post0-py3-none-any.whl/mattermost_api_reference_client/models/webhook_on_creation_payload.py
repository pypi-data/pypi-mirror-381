...
T = TypeVar("T", bound="WebhookOnCreationPayload")


@_attrs_define
class WebhookOnCreationPayload:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_on_creation_payload = cls(
            id=id,
            name=name,
        ...
        webhook_on_creation_payload.additional_properties = d
        return webhook_on_creation_payload
