...
class EnvironmentConfigClusterSettings:
    ...
    Attributes:
        ...
        inter_node_listen_address (Union[Unset, bool]):
        inter_node_urls (Union[Unset, bool]):
    """

    enable: Union[Unset, bool] = UNSET
    inter_node_listen_address: Union[Unset, bool] = UNSET
    inter_node_urls: Union[Unset, bool] = UNSET
