...
T = TypeVar("T", bound="ChannelBookmarkWithFileInfo")


@_attrs_define
class ChannelBookmarkWithFileInfo:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    file: Union[Unset, "FileInfo"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_file, Unset):
            ...
            file = FileInfo.from_dict(_file)

        channel_bookmark_with_file_info = cls(
            id=id,
            create_at=create_at,
            update_at=update_at,
            delete_at=delete_at,
        ...
        channel_bookmark_with_file_info.additional_properties = d
        return channel_bookmark_with_file_info
