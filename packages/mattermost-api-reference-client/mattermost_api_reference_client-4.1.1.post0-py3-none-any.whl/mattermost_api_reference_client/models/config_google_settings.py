...
T = TypeVar("T", bound="ConfigGoogleSettings")


@_attrs_define
class ConfigGoogleSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_google_settings.additional_properties = d
        return config_google_settings
