...
T = TypeVar("T", bound="ConfigOffice365Settings")


@_attrs_define
class ConfigOffice365Settings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config_office_365_settings = cls(
            enable=enable,
            secret=secret,
            id=id,
            scope=scope,
        ...
        config_office_365_settings.additional_properties = d
        return config_office_365_settings
