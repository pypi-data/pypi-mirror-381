...
from ...models.accept_remote_cluster_invite_body import AcceptRemoteClusterInviteBody
...
def _get_kwargs(
    *,
    body: AcceptRemoteClusterInviteBody,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = RemoteCluster.from_dict(response.json())
