...
from ...models.check_user_mfa_body import CheckUserMfaBody
...
) -> Optional[Union[AppError, CheckUserMfaResponse200]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, CheckUserMfaResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[AppError, CheckUserMfaResponse200]
    """
