...
from ...models.search_emoji_body import SearchEmojiBody
from ...types import Response


def _get_kwargs(
    *,
    body: SearchEmojiBody,
) -> dict[str, Any]:
...
) -> Optional[Union[AppError, list["Emoji"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, list["Emoji"]]]:
    return Response(
