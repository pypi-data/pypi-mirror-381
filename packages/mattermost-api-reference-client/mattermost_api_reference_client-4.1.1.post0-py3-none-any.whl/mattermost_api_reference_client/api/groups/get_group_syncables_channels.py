...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/v4/groups/{group_id}/channels",
    }
...
) -> Optional[Union[AppError, list["GroupSyncableChannels"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, list["GroupSyncableChannels"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AppError, list['GroupSyncableChannels']]
    """
