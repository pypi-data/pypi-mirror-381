...
) -> Optional[Union[AppError, list["PropertyField"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PropertyField.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AppError, list["PropertyField"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[AppError, list['PropertyField']]
    """
