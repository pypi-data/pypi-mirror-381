...
def _get_kwargs(
    ...
    *,
    ...
    exclude_deleted_users: Union[Unset, bool] = False,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    params["exclude_deleted_users"] = exclude_deleted_users
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        sort (Union[Unset, str]):  Default: ''.
        exclude_deleted_users (Union[Unset, bool]):  Default: False.
