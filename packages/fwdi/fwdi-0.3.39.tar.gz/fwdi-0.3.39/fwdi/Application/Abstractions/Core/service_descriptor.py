...
class ServiceDescriptorFWDI():
    ...
    @classmethod
    def create_static_from_base(cls: type[_CLS_], base_type:type[T], inst_type:type[T], lifetime: ServiceLifetime)-> _CLS_:
        new_instance = cls()
        new_instance.ServiceType = base_type
        new_instance.ImplementationType = inst_type
        new_instance.Implementation = ServiceDescriptorFWDI.__set_inject_v2(inst_type)
        new_instance.Lifetime = lifetime

        return new_instance

    @classmethod
    def create(cls: type[_CLS_], base_type:type[T], inst_type:type[T], lifetime: ServiceLifetime)-> _CLS_: # Old version create_static_from_base
        new_instance = cls()
        new_instance.ServiceType = base_type
        new_instance.ImplementationType = ServiceDescriptorFWDI.__set_inject_v2(inst_type)
        new_instance.Lifetime = lifetime
