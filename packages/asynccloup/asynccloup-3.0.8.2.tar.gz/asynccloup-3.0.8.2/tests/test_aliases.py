...
from asynccloup import Color, Group, HelpTheme, Style
from asynccloup._util import first_bool, identity, reindent
from asynccloup.styling import IStyle
from asynccloup.typing import MISSING
...
def test_command_resolution_with_cloup_subcommand(cli, runner, alias):
    res = runner.invoke(cli, [alias, 'asynccloup'])
    assert res.output.strip() == 'install asynccloup'
