...
if TYPE_CHECKING:
    from asynccloup import HelpFormatter, OptionGroup
...
class ConstraintMixin:
    ...
    async def parse_args(self, ctx: click.Context, args: List[str]) -> List[str]:
        ...
        args = await super().parse_args(ctx, args)  # type: ignore
