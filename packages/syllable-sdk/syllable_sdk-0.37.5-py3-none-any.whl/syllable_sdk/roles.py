...
class Roles(BaseSDK):
    ...
    def list(
        ...
        *,
        ...
        search_fields: Optional[List[models.RoleProperties]] = None,
        search_field_values: Optional[List[str]] = None,
        order_by: OptionalNullable[models.RoleProperties] = UNSET,
        order_by_direction: OptionalNullable[models.OrderByDirection] = UNSET,
        fields: OptionalNullable[List[models.RoleProperties]] = UNSET,
    ...
    ) -> models.ListResponseRoleResponse:
        r"""List Roles
        ...
        request = models.RolesListRequest(
            page=page,
            limit=limit,
    ...
    def create(
        self,
        *,
        request: Union[models.RoleCreateRequest, models.RoleCreateRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.RoleCreateRequest)
        request = cast(models.RoleCreateRequest, request)
    ...
    def update(
        self,
        *,
        request: Union[models.RoleUpdateRequest, models.RoleUpdateRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.RoleUpdateRequest)
        request = cast(models.RoleUpdateRequest, request)
    ...
    def get_by_id(
        ...
        *,
        ...
        request = models.RolesGetByIDRequest(
            role_id=role_id,
        )
