...
class Conversations(BaseSDK):
    ...
    def list(
        ...
        *,
        ...
        search_fields: Optional[List[models.ConversationProperties]] = None,
        search_field_values: Optional[List[str]] = None,
        order_by: OptionalNullable[models.ConversationProperties] = UNSET,
        order_by_direction: OptionalNullable[models.OrderByDirection] = UNSET,
        fields: OptionalNullable[List[models.ConversationProperties]] = UNSET,
    ...
    ) -> models.ListResponseConversation:
        ...
        request = models.ConversationsListRequest(
            page=page,
            limit=limit,
