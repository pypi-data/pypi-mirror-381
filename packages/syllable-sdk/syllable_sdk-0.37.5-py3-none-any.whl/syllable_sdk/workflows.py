...
class Workflows(BaseSDK):
    ...
    def update(
        ...
        *,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.insight_workflow_input,
                False,
                False,
                "json",
    ...
    def delete(
        ...
        *,
        ...
        request = models.InsightsWorkflowDeleteRequest(
            workflow_id=workflow_id,
        )
    ...
    def inactivate(
        ...
        *,
        ...
        request = models.InsightsWorkflowInactivateRequest(
            workflow_id=workflow_id,
        )

        req = self._build_request(
            method="PUT",
            path="/api/v1/insights/workflows/{workflow_id}/inactivate",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def activate(
        ...
        *,
        workflow_id: int,
        insight_workflow_activate: Union[
            models.InsightWorkflowActivate, models.InsightWorkflowActivateTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.InsightsWorkflowActivateRequest(
            workflow_id=workflow_id,
            insight_workflow_activate=utils.get_pydantic_model(
                insight_workflow_activate, models.InsightWorkflowActivate
            ),
        )

        req = self._build_request(
            method="PUT",
            path="/api/v1/insights/workflows/{workflow_id}/activate",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=True,
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.insight_workflow_activate,
                False,
                False,
                "json",
    ...
    def queue_work(
        ...
        *,
        request: Union[
            models.InsightsWorkflowQueueSession,
            models.InsightsWorkflowQueueSessionTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        r"""Queue Insights Workflow For Sessions/Files
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.InsightsWorkflowQueueSession)
        request = cast(models.InsightsWorkflowQueueSession, request)
