...
class Transcript(BaseSDK):
    def get_by_id(
        ...
        *,
    ...
    ) -> models.SessionTranscriptionResponse:
        r"""Get Session Transcript By Id
        ...
        request = models.SessionTranscriptGetByIDRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="session_transcript_get_by_id",
                oauth2_scopes=[],
