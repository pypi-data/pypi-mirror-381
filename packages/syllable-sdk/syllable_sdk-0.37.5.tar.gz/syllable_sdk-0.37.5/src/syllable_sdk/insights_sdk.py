...
class InsightsSDK(BaseSDK):
    ...
    def list(
        ...
        *,
        ...
        search_fields: Optional[List[models.InsightsProperties]] = None,
        search_field_values: Optional[List[str]] = None,
        order_by: OptionalNullable[models.InsightsProperties] = UNSET,
        order_by_direction: OptionalNullable[models.OrderByDirection] = UNSET,
        fields: OptionalNullable[List[models.InsightsProperties]] = UNSET,
        ...
        request = models.InsightsListRequest(
            page=page,
            limit=limit,
