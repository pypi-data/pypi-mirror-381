...
class SessionDebug(BaseSDK):
    def get_session_data_by_sid(
        self,
        *,
        ...
        r"""Get Session Data By Sid

        :param channel_manager_service:
        :param channel_manager_sid:
        ...
        request = models.GetSessionDataBySidRequest(
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/session_debug/sid/{channel_manager_service}/{channel_manager_sid}",
            base_url=base_url,
    ...
    def get_session_data_by_session_id(
        ...
        *,
        ...
        r"""Get Session Data By Session Id
        ...
        request = models.GetSessionDataBySessionIDRequest(
    ...
    def get_session_tool_call_result_by_id(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ToolResultData:
        r"""Get Session Tool Call Result By Id
        ...
        request = models.GetSessionToolCallResultByIDRequest(
            session_id=session_id,
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/session_debug/tool_result/{session_id}/{tool_call_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
