...
class Users(BaseSDK):
    def list(
        ...
        *,
        ...
        search_fields: Optional[List[models.UserProperties]] = None,
        search_field_values: Optional[List[str]] = None,
        order_by: OptionalNullable[models.UserProperties] = UNSET,
        order_by_direction: OptionalNullable[models.OrderByDirection] = UNSET,
        fields: OptionalNullable[List[models.UserProperties]] = UNSET,
    ...
    ) -> models.ListResponseUserResponse:
        r"""List Users
    ...
    def create(
        self,
        *,
        request: Union[models.UserCreateRequest, models.UserCreateRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.UserCreateRequest)
        request = cast(models.UserCreateRequest, request)
    ...
    def update(
        self,
        *,
        request: Union[models.UserUpdateRequest, models.UserUpdateRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.UserUpdateRequest)
        request = cast(models.UserUpdateRequest, request)
    ...
    def delete(
        self,
        *,
        request: Union[models.UserDeleteRequest, models.UserDeleteRequestTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(request, models.UserDeleteRequest)
        request = cast(models.UserDeleteRequest, request)
    ...
    def users_get_by_email(
        ...
        *,
        ...
        request = models.UsersGetByEmailRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="users_get_by_email",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    def users_send_email(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/api/v1/users/{user_email}/send_email",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
    ...
    def users_delete_account(
        ...
        *,
        ...
        r"""Request Removal Of This Account
        ...
        req = self._build_request(
            method="DELETE",
            path="/api/v1/users/delete_account",
            base_url=base_url,
            url_variables=url_variables,
            request=None,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="users_delete_account",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
