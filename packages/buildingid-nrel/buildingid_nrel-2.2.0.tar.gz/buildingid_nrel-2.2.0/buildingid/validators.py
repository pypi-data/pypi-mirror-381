...
def isValidCodeArea(codeArea: openlocationcode.CodeArea) -> bool:
    return (
        isValidCodeLength(codeArea.codeLength)
        and isValidLatitudeCenter(codeArea.latitudeLo, codeArea.latitudeHi, codeArea.latitudeCenter)
        and isValidLongitudeCenter(codeArea.longitudeLo, codeArea.longitudeHi, codeArea.longitudeCenter)
    )
