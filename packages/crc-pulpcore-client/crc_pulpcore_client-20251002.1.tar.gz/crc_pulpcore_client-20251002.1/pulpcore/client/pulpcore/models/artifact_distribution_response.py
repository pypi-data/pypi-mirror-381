...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_labels", "name", "no_content_change_since", "base_url", "hidden", "base_path", "pulp_created", "prn", "pulp_last_updated", "content_guard", "pulp_href"]
