...
class APIClient:
    ...
    def _emit_telemetry(
        ...
        *,
        ...
        log_method("API request telemetry", extra={"api_request": payload})
    ...
    def register_container_module(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Register a container-based module release with the control plane."""

        return self._make_request("POST", "/v1/modules/container", json_data=payload)
