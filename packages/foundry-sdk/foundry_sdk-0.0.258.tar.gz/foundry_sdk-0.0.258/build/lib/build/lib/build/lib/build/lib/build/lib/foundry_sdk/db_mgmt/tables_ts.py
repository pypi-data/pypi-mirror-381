...
class DatasetMapping(Base):
    __tablename__ = "dataset_mapping"

    dataset_id = Column(
        Integer,
        ForeignKey("datasets.dataset_id", name="fk_dataset_mapping_datasets", onupdate="RESTRICT", ondelete="CASCADE"),
        nullable=False,
    )
    ...
    __table_args__ = (
        PrimaryKeyConstraint("dataset_id", "sku_id", "company_id", name="pk_dataset_mapping"),
        ForeignKeyConstraint(
            ["company_id"],
            ["companies.company_id"],
            name="fk_dataset_mapping_companies",
            onupdate="RESTRICT",
            ondelete="CASCADE",
        ),
        ForeignKeyConstraint(
            ...
            name="fk_dataset_mapping_sku_table",
            onupdate="RESTRICT",
            ondelete="CASCADE",
        ),
    )
