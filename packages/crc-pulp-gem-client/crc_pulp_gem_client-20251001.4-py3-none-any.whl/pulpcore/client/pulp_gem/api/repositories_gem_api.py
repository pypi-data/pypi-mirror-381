...
class RepositoriesGemApi:
    ...
    def _add_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{gem_gem_repository_href}add_role/',
    ...
    def create(
        self,
        gem_gem_repository: GemGemRepository,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        ...
        :param gem_gem_repository: (required)
        :type gem_gem_repository: GemGemRepository
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            ...
            gem_gem_repository=gem_gem_repository,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if gem_gem_repository is not None:
            _body_params = gem_gem_repository
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/pulp/{pulp_domain}/api/v3/repositories/gem/gem/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{gem_gem_repository_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedgemGemRepositoryResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedgemGemRepositoryResponseList]:
        """List gem repositorys
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{gem_gem_repository_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _modify_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{gem_gem_repository_href}modify/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{gem_gem_repository_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        self,
        gem_gem_repository_href: StrictStr,
        patchedgem_gem_repository: PatchedgemGemRepository,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param gem_gem_repository_href: (required)
        :type gem_gem_repository_href: str
        :param patchedgem_gem_repository: (required)
        :type patchedgem_gem_repository: PatchedgemGemRepository
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            gem_gem_repository_href=gem_gem_repository_href,
            patchedgem_gem_repository=patchedgem_gem_repository,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patchedgem_gem_repository is not None:
            _body_params = patchedgem_gem_repository
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{gem_gem_repository_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{gem_gem_repository_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _sync_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{gem_gem_repository_href}sync/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{gem_gem_repository_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
