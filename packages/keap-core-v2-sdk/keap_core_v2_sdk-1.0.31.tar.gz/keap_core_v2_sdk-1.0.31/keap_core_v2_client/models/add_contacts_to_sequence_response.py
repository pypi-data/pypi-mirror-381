...
class AddContactsToSequenceResponse(BaseModel):
    """
    AddContactsToSequenceResponse
    """ # noqa: E501
    add_to_sequence_results: Optional[Dict[str, StrictStr]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["add_to_sequence_results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "add_to_sequence_results": obj.get("add_to_sequence_results")
        })
