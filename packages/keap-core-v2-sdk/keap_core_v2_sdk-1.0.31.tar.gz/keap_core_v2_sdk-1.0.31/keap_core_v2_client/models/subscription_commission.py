...
class SubscriptionCommission(BaseModel):
    """
    SubscriptionCommission
    """ # noqa: E501
    dollar_amount: Optional[Union[StrictFloat, StrictInt]] = None
    name: Optional[StrictStr] = None
    percentage: Optional[Union[StrictFloat, StrictInt]] = None
    plan_price: Optional[Union[StrictFloat, StrictInt]] = None
    subscription_id: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["dollar_amount", "name", "percentage", "plan_price", "subscription_id"]
