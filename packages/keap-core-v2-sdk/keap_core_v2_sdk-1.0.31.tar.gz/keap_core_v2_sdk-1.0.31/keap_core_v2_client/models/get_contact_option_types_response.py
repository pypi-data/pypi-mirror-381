...
class GetContactOptionTypesResponse(BaseModel):
    """
    GetContactOptionTypesResponse
    """ # noqa: E501
    option_types: Optional[List[StrictStr]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["option_types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "option_types": obj.get("option_types")
        })
