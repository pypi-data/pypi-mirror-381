...
class UpdateCategoryDiscountRequest(BaseModel):
    ...
    discount_percent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The discount percent. Must be greater than or equal to 0.")
    name: Optional[StrictStr] = None
    product_category_ids: Optional[List[StrictStr]] = None
