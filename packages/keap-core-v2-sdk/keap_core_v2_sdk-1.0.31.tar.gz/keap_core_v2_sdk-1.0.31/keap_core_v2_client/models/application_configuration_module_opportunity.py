...
class ApplicationConfigurationModuleOpportunity(BaseModel):
    """
    ApplicationConfigurationModuleOpportunity
    """ # noqa: E501
    default_stage: Optional[StrictStr] = None
    states: Optional[ApplicationConfigurationModuleOpportunityStates] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["default_stage", "states"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "states": ApplicationConfigurationModuleOpportunityStates.from_dict(obj["states"]) if obj.get("states") is not None else None
        })
