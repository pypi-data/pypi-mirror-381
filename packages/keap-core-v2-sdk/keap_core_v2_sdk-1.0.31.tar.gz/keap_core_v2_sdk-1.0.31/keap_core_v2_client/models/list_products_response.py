...
class ListProductsResponse(BaseModel):
    ...
    products: Optional[List[RestV2Product]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["next_page_token", "products"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "products": [RestV2Product.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
