...
class CreateOpportunityStageRequest(BaseModel):
    """
    CreateOpportunityStageRequest
    """ # noqa: E501
    checklist_items: Optional[List[CreateOpportunityStageChecklistItem]] = None
    name: StrictStr
    order: StrictInt
    probability: StrictInt
    target_number_days: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checklist_items": [CreateOpportunityStageChecklistItem.from_dict(_item) for _item in obj["checklist_items"]] if obj.get("checklist_items") is not None else None,
            "name": obj.get("name"),
            "order": obj.get("order"),
