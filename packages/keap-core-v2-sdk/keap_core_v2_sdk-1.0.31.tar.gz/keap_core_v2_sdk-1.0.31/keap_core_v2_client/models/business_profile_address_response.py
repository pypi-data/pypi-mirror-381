...
class BusinessProfileAddressResponse(BaseModel):
    """
    BusinessProfileAddressResponse
    """ # noqa: E501
    country_code: Optional[StrictStr] = Field(default=None, description="An ISO 3166-1 Country Code (https://en.wikipedia.org/wiki/ISO_3166-1_alpha-3)")
