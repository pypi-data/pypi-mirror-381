...
class FaxNumber(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["field", "number", "type"]
    ...
    def var_field_validate_enum(cls, value):
        ...
        if value not in set(['FAX_NUMBER_FIELD_UNSPECIFIED', 'FAX1', 'FAX2']):
            raise ValueError("must be one of enum values ('FAX_NUMBER_FIELD_UNSPECIFIED', 'FAX1', 'FAX2')")
        return value
