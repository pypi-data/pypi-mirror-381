...
class PaymentMethodConfig(BaseModel):
    ...
    PaymentMethodConfig
    """ # noqa: E501
    session_key: Optional[StrictStr] = Field(default=None, description="A temporary session key required for rendering Keap's payment component.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["session_key"]
