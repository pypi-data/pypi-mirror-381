...
class GetBusinessProfileResponse(BaseModel):
    """
    Profile information about the business that owns/uses this account
    """ # noqa: E501
    address: Optional[BusinessProfileAddressResponse] = None
    ...
    business_type: Optional[StrictStr] = Field(default=None, description="The type of business")
    ...
    __properties: ClassVar[List[str]] = ["address", "business_goals", "business_primary_color", "business_secondary_color", "business_type", "currency_code", "email", "language_tag", "logo_url", "name", "phone", "time_zone", "website"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "address": BusinessProfileAddressResponse.from_dict(obj["address"]) if obj.get("address") is not None else None,
