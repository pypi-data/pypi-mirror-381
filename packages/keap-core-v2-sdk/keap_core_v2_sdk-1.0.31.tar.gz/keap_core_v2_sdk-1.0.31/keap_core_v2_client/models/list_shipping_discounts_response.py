...
class ListShippingDiscountsResponse(BaseModel):
    """
    ListShippingDiscountsResponse
    """ # noqa: E501
    discounts: Optional[List[ShippingDiscount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discounts": [ShippingDiscount.from_dict(_item) for _item in obj["discounts"]] if obj.get("discounts") is not None else None,
