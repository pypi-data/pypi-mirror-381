...
class CreateCategoryDiscountRequest(BaseModel):
    """
    CreateCategoryDiscountRequest
    """ # noqa: E501
    apply_to_commissions: StrictBool
    criteria: Optional[List[DiscountCriteria]] = None
    description: Optional[StrictStr] = None
    discount_percent: Union[StrictFloat, StrictInt] = Field(description="The discount percent. Must be greater than or equal to 0.")
    name: StrictStr
    product_category_ids: List[StrictStr]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["apply_to_commissions", "criteria", "description", "discount_percent", "name", "product_category_ids"]
