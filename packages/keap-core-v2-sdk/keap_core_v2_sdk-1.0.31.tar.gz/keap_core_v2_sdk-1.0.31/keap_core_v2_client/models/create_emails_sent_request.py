...
class CreateEmailsSentRequest(BaseModel):
    """
    CreateEmailsSentRequest
    """ # noqa: E501
    emails: Optional[List[CreateEmailSentRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emails": [CreateEmailSentRequest.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None
        })
