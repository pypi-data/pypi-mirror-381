...
class ListNoteTemplateResponse(BaseModel):
    """
    ListNoteTemplateResponse
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = None
    note_templates: Optional[List[NoteTemplate]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["next_page_token", "note_templates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "note_templates": [NoteTemplate.from_dict(_item) for _item in obj["note_templates"]] if obj.get("note_templates") is not None else None
        })
