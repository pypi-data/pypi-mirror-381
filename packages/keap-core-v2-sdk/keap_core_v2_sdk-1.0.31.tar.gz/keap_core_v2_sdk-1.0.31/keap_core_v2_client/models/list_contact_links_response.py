...
class ListContactLinksResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["links", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "links": [ContactLink.from_dict(_item) for _item in obj["links"]] if obj.get("links") is not None else None,
