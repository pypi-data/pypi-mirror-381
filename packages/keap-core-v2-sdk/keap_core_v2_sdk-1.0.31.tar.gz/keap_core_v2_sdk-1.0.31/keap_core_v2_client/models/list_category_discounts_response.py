...
class ListCategoryDiscountsResponse(BaseModel):
    """
    ListCategoryDiscountsResponse
    """ # noqa: E501
    discounts: Optional[List[CategoryDiscount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discounts": [CategoryDiscount.from_dict(_item) for _item in obj["discounts"]] if obj.get("discounts") is not None else None,
