...
class ListOrderTotalDiscountsResponse(BaseModel):
    ...
    """ # noqa: E501
    discounts: Optional[List[OrderTotalDiscount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discounts": [OrderTotalDiscount.from_dict(_item) for _item in obj["discounts"]] if obj.get("discounts") is not None else None,
