...
class EmailSent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["clicked_time", "contact_id", "headers", "id", "opened_time", "original_provider", "original_provider_id", "provider_source_id", "received_time", "sent_from_address", "sent_from_reply_address", "sent_time", "sent_to_address", "sent_to_bcc_address_list", "sent_to_cc_address_list", "subject"]
