...
class EmailSendTemplateRequest(BaseModel):
    ...
    contact_ids: Optional[List[StrictStr]] = Field(default=None, description="List of contacts to send")
    template_id: Optional[StrictStr] = Field(default=None, description="Template ID")
    user_id: Optional[StrictStr] = Field(default=None, description="user id sending the email")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["address_field", "contact_ids", "template_id", "user_id"]
