...
class ReportExecutionResult(BaseModel):
    ...
    results: Optional[List[ReportEntryRecord]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["page_token", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ReportEntryRecord.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
