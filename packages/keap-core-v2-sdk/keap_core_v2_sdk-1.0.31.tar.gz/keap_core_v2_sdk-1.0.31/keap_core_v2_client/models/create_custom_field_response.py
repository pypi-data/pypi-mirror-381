...
class CreateCustomFieldResponse(BaseModel):
    """
    CreateCustomFieldResponse
    """ # noqa: E501
    custom_field: Optional[CustomFieldMetaData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "custom_field": CustomFieldMetaData.from_dict(obj["custom_field"]) if obj.get("custom_field") is not None else None
        })
