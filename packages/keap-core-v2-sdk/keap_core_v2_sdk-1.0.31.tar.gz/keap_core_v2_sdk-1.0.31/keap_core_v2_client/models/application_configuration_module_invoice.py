...
class ApplicationConfigurationModuleInvoice(BaseModel):
    """
    ApplicationConfigurationModuleInvoice
    """ # noqa: E501
    tax_label: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["tax_label"]
