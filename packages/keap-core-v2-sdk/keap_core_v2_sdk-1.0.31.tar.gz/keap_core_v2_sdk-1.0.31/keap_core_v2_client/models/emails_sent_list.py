...
class EmailsSentList(BaseModel):
    """
    EmailsSentList
    """ # noqa: E501
    emails: Optional[List[EmailSentWithContent]] = None
    errors: Optional[List[EmailSentCreateError]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["emails", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emails": [EmailSentWithContent.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
            "errors": [EmailSentCreateError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
