...
class ApplicationConfigurationModuleOpportunityStates(BaseModel):
    """
    ApplicationConfigurationModuleOpportunityStates
    """ # noqa: E501
    active: Optional[ApplicationConfigurationModuleOpportunityStatesActive] = None
    loss: Optional[ApplicationConfigurationModuleOpportunityStatesLoss] = None
    win: Optional[ApplicationConfigurationModuleOpportunityStatesWin] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["active", "loss", "win"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of win
        if self.win:
            _dict['win'] = self.win.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "active": ApplicationConfigurationModuleOpportunityStatesActive.from_dict(obj["active"]) if obj.get("active") is not None else None,
            "loss": ApplicationConfigurationModuleOpportunityStatesLoss.from_dict(obj["loss"]) if obj.get("loss") is not None else None,
            "win": ApplicationConfigurationModuleOpportunityStatesWin.from_dict(obj["win"]) if obj.get("win") is not None else None
        })
