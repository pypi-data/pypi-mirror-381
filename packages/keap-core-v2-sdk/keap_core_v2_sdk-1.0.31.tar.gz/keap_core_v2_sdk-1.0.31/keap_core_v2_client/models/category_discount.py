...
class CategoryDiscount(BaseModel):
    ...
    product_categories: Optional[List[StrictStr]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["apply_to_commissions", "criteria", "description", "discount_percent", "id", "name", "product_categories"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "product_categories": obj.get("product_categories")
        })
