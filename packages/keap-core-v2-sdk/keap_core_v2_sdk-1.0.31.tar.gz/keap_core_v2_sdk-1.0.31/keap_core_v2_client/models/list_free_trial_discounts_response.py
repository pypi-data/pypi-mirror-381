...
class ListFreeTrialDiscountsResponse(BaseModel):
    """
    ListFreeTrialDiscountsResponse
    """ # noqa: E501
    discounts: Optional[List[FreeTrialDiscount]] = None
    next_page_token: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["discounts", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "discounts": [FreeTrialDiscount.from_dict(_item) for _item in obj["discounts"]] if obj.get("discounts") is not None else None,
