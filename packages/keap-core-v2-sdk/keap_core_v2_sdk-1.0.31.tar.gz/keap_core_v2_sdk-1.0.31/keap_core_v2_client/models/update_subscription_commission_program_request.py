...
class UpdateSubscriptionCommissionProgramRequest(BaseModel):
    """
    UpdateSubscriptionCommissionProgramRequest
    """ # noqa: E501
    dollar_amount: Optional[StrictStr] = None
    percentage: Optional[StrictStr] = None
    subscription_id: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["dollar_amount", "percentage", "subscription_id"]
