...
class CreateFreeTrialDiscountRequest(BaseModel):
    """
    CreateFreeTrialDiscountRequest
    """ # noqa: E501
    criteria: Optional[List[DiscountCriteria]] = None
    description: Optional[StrictStr] = None
    free_trial_days: Optional[StrictInt] = Field(default=None, description="The number of free trial days. Must be a positive number. Defaults to 0.")
    hide_price: Optional[StrictBool] = None
    name: StrictStr
    subscription_plan_id: StrictStr
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["criteria", "description", "free_trial_days", "hide_price", "name", "subscription_plan_id"]
