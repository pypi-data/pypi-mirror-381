...
class ListTaggedContactsResponse(BaseModel):
    """
    ListTaggedContactsResponse
    """ # noqa: E501
    contacts: Optional[List[BasicContact]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contacts": [BasicContact.from_dict(_item) for _item in obj["contacts"]] if obj.get("contacts") is not None else None,
