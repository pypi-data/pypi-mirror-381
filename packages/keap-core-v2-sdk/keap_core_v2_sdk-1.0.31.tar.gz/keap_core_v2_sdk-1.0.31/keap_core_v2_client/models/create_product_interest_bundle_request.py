...
class CreateProductInterestBundleRequest(BaseModel):
    """
    CreateProductInterestBundleRequest
    """ # noqa: E501
    description: StrictStr = Field(description="Product interest bundle description")
    name: StrictStr = Field(description="Product interest bundle name")
