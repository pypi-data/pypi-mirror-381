...
class PaymentMethodConfigsApi:
    ...
    def create_payment_method_config(
        ...
        _param = self._create_payment_method_config_serialize(
    ...
    @validate_call
    def create_payment_method_config_with_http_info(
        self,
        create_payment_method_config_request: Annotated[CreatePaymentMethodConfigRequest, Field(description="request")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaymentMethodConfig]:
        """Create Payment Method Configuration
    ...
    @validate_call
    def create_payment_method_config_without_preload_content(
        self,
        create_payment_method_config_request: Annotated[CreatePaymentMethodConfigRequest, Field(description="request")],
        _request_timeout: Union[
            None,
    ...
    def _create_payment_method_config_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/paymentMethodConfigs',
