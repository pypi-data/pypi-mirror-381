...
class SettingsApi:
    ...
    def _get_application_configurations_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/settings/applications:getConfiguration',
    ...
    def get_contact_option_types(
        ...
        _param = self._get_contact_option_types_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetContactOptionTypesResponse",
            '401': "Error",
            '403': "Error",
            '404': "Error",
            '500': "Error",
    ...
    @validate_call
    def get_contact_option_types_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetContactOptionTypesResponse]:
        """Get Contact Option types
    ...
    @validate_call
    def get_contact_option_types_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_contact_option_types_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/settings/contactOptionTypes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def is_application_enabled(
        ...
        _param = self._is_application_enabled_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetApplicationEnabledStatusResponse",
            '401': "Error",
            '403': "Error",
            '404': "Error",
            '500': "Error",
    ...
    @validate_call
    def is_application_enabled_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetApplicationEnabledStatusResponse]:
        """Get Application Status
    ...
    @validate_call
    def is_application_enabled_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _is_application_enabled_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/settings/applications:isEnabled',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
