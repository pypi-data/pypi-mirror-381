...
class CompanyApi:
    ...
    def _delete_company_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v2/companies/{company_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_company(
        self,
        company_id: Annotated[StrictStr, Field(description="company_id")],
        fields: Annotated[Optional[List[StrictStr]], Field(description="Comma-delimited list of Company properties to include in the response. (Available fields are: `company_name`, `address`, `custom_fields`, `email_address`, `fax_number`, `phone_number`, `website`, `notes`)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def list_companies(
        self,
        fields: Annotated[Optional[List[StrictStr]], Field(description="Comma-delimited list of Company properties to include in the response. (Fields such as `notes`, `fax_number`, `email_address`, `phone_number`, `update_time`, `create_time` and `custom_fields` aren't included, by default.)")] = None,
    ...
    def update_company(
        ...
        update_company_request: Annotated[Optional[UpdateCompanyRequest], Field(description="company")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param update_company_request: company
