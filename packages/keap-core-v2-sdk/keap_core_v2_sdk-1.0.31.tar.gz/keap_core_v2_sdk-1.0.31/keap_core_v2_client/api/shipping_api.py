...
class ShippingApi:
    ...
    def list_shipping_methods(
        ...
        _param = self._list_shipping_methods_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ListRestShippingMethodsResponse",
            '401': "Error",
            '403': "Error",
            '404': "Error",
            '500': "Error",
    ...
    @validate_call
    def list_shipping_methods_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListRestShippingMethodsResponse]:
        """List Shipping methods
    ...
    @validate_call
    def list_shipping_methods_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_shipping_methods_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
