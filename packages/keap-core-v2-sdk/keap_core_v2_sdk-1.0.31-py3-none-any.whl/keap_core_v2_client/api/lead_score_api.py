...
class LeadScoreApi:
    ...
    def get_lead_score_details(
        ...
        _param = self._get_lead_score_details_serialize(
    ...
    @validate_call
    def get_lead_score_details_with_http_info(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_lead_score_details_without_preload_content(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        _request_timeout: Union[
            None,
    ...
    def _get_lead_score_details_serialize(
        self,
        contact_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/contacts/{contact_id}/leadScore',
