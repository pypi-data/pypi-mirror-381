...
class LeadSourcesApi:
    ...
    def create_lead_source(
        self,
        create_lead_source_request: Annotated[CreateLeadSourceRequest, Field(description="The request object to create a new lead source")],
        ...
        :param create_lead_source_request: The request object to create a new lead source (required)
        ...
        _param = self._create_lead_source_serialize(
    ...
    @validate_call
    def create_lead_source_with_http_info(
        self,
        create_lead_source_request: Annotated[CreateLeadSourceRequest, Field(description="The request object to create a new lead source")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_lead_source_without_preload_content(
        self,
        create_lead_source_request: Annotated[CreateLeadSourceRequest, Field(description="The request object to create a new lead source")],
        _request_timeout: Union[
            None,
    ...
    def _create_lead_source_serialize(
        self,
    ...
    def delete_lead_source(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param lead_source_id: The ID of a lead source (required)
        ...
        _param = self._delete_lead_source_serialize(
    ...
    @validate_call
    def delete_lead_source_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_lead_source_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
    ...
    def _delete_lead_source_serialize(
        self,
        lead_source_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v2/leadSources/{lead_source_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_lead_source(
        ...
        _param = self._get_lead_source_serialize(
            lead_source_id=lead_source_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_lead_source_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_lead_source_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
    ...
    def _get_lead_source_serialize(
        self,
        lead_source_id,
        _request_auth,
        _content_type,
    ...
    def list_lead_sources(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are:  - (String) `name` - (String) `status` - (String) `lead_source_category_id` - (String) `vendor` - (String) `medium` - (String) `start_time` - (String) `end_time`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples:  - `filter=name%3D%3Dexample` - `filter=start_time%3D%3D2024-12-22T01:00:00.000Z`")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields:  - `name` - `status` - `vendor` - `medium` - `start_time` - `end_time` - `create_time` - `update_time`  One of the following directions:  - `asc` - `desc`")] = None,
        ...
        :type filter: str
        :param order_by: Attribute and direction to order items. One of the following fields:  - `name` - `status` - `vendor` - `medium` - `start_time` - `end_time` - `create_time` - `update_time`  One of the following directions:  - `asc` - `desc`
        :type order_by: str
        ...
        _param = self._list_lead_sources_serialize(
            filter=filter,
            order_by=order_by,
            page_size=page_size,
    ...
    @validate_call
    def list_lead_sources_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are:  - (String) `name` - (String) `status` - (String) `lead_source_category_id` - (String) `vendor` - (String) `medium` - (String) `start_time` - (String) `end_time`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples:  - `filter=name%3D%3Dexample` - `filter=start_time%3D%3D2024-12-22T01:00:00.000Z`")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields:  - `name` - `status` - `vendor` - `medium` - `start_time` - `end_time` - `create_time` - `update_time`  One of the following directions:  - `asc` - `desc`")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Total number of items to return per page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ListLeadSourcesResponse]:
        """List Lead Sources
    ...
    @validate_call
    def list_lead_sources_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are:  - (String) `name` - (String) `status` - (String) `lead_source_category_id` - (String) `vendor` - (String) `medium` - (String) `start_time` - (String) `end_time`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples:  - `filter=name%3D%3Dexample` - `filter=start_time%3D%3D2024-12-22T01:00:00.000Z`")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields:  - `name` - `status` - `vendor` - `medium` - `start_time` - `end_time` - `create_time` - `update_time`  One of the following directions:  - `asc` - `desc`")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Total number of items to return per page")] = None,
    ...
    def _list_lead_sources_serialize(
        self,
        filter,
        order_by,
        page_size,
    ...
    def update_lead_source(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        create_lead_source_request: Annotated[CreateLeadSourceRequest, Field(description="The request object to update a lead source")],
        ...
        :param lead_source_id: The ID of a lead source (required)
        :type lead_source_id: str
        :param create_lead_source_request: The request object to update a lead source (required)
        :type create_lead_source_request: CreateLeadSourceRequest
        ...
        _param = self._update_lead_source_serialize(
            lead_source_id=lead_source_id,
            create_lead_source_request=create_lead_source_request,
    ...
    @validate_call
    def update_lead_source_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        create_lead_source_request: Annotated[CreateLeadSourceRequest, Field(description="The request object to update a lead source")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
    ...
    @validate_call
    def update_lead_source_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        create_lead_source_request: Annotated[CreateLeadSourceRequest, Field(description="The request object to update a lead source")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
    ...
    def _update_lead_source_serialize(
        self,
        lead_source_id,
        create_lead_source_request,
        update_mask,
