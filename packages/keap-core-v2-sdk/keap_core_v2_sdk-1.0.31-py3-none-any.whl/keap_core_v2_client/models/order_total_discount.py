...
class OrderTotalDiscount(BaseModel):
    """
    OrderTotalDiscount
    """ # noqa: E501
    ...
    discount_value: Optional[Union[StrictFloat, StrictInt]] = None
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["apply_to_commissions", "criteria", "description", "discount_strategy", "discount_type", "discount_value", "id", "name"]
