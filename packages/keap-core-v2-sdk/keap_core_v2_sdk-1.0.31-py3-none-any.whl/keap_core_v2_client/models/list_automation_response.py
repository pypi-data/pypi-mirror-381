...
class ListAutomationResponse(BaseModel):
    """
    ListAutomationResponse
    """ # noqa: E501
    automation_count: Optional[StrictInt] = None
    automations: Optional[List[Automation]] = None
    next_page_token: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["automation_count", "automations", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "automations": [Automation.from_dict(_item) for _item in obj["automations"]] if obj.get("automations") is not None else None,
