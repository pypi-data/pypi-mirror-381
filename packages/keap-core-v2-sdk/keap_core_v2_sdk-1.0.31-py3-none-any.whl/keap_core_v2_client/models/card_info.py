...
class CardInfo(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["brand", "card_type", "expiration_month", "expiration_year", "last_four"]
    ...
    def card_type_validate_enum(cls, value):
        ...
        if value not in set(['CREDIT', 'DEBIT', 'PREPAID', 'ACH']):
            raise ValueError("must be one of enum values ('CREDIT', 'DEBIT', 'PREPAID', 'ACH')")
        return value
