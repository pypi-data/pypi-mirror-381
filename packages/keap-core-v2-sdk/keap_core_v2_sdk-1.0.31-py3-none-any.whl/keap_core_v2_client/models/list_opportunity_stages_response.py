...
class ListOpportunityStagesResponse(BaseModel):
    """
    ListOpportunityStagesResponse
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = None
    stages: Optional[List[RestOpportunityStage]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["next_page_token", "stages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stages": [RestOpportunityStage.from_dict(_item) for _item in obj["stages"]] if obj.get("stages") is not None else None
        })
