...
class PaymentResult(BaseModel):
    ...
    payment_status_message: Optional[StrictStr] = None
    transaction_id: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "invoice_id", "payment_amount", "payment_status_message", "transaction_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payment_status_message": obj.get("payment_status_message"),
