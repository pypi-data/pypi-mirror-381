...
class ListSubscriptionPlansResponse(BaseModel):
    """
    ListSubscriptionPlansResponse
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = None
    subscriptions: Optional[List[SubscriptionPlan]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["next_page_token", "subscriptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [SubscriptionPlan.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
