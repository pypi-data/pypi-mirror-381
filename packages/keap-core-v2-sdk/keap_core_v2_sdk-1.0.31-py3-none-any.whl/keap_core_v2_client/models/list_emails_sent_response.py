...
class ListEmailsSentResponse(BaseModel):
    """
    ListEmailsSentResponse
    """ # noqa: E501
    emails: Optional[List[EmailSent]] = None
    next_page_token: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["emails", "next_page_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emails": [EmailSent.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
