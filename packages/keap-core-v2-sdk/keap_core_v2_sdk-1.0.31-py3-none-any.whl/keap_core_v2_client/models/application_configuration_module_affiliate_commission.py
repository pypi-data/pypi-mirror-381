...
class ApplicationConfigurationModuleAffiliateCommission(BaseModel):
    """
    ApplicationConfigurationModuleAffiliateCommission
    """ # noqa: E501
    calculation_type: Optional[StrictStr] = None
    levels: Optional[StrictInt] = None
    participant_types: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["calculation_type", "levels", "participant_types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "participant_types": obj.get("participant_types")
        })
