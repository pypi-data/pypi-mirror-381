...
class EmailSentCreateError(BaseModel):
    """
    EmailSentCreateError
    """ # noqa: E501
    email: Optional[CreateEmailSentRequest] = None
    error_message: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["email", "error_message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email": CreateEmailSentRequest.from_dict(obj["email"]) if obj.get("email") is not None else None,
