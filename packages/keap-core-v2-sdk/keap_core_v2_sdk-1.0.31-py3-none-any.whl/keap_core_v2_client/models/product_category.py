...
class ProductCategory(BaseModel):
    ...
    ProductCategory
    """ # noqa: E501
    display_order_index: Optional[StrictInt] = None
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    parent_category_id: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["display_order_index", "id", "name", "parent_category_id"]
