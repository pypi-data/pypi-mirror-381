...
class ListRestShippingMethodsResponse(BaseModel):
    """
    ListRestShippingMethodsResponse
    """ # noqa: E501
    shipping_methods: Optional[List[ShippingMethod]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["shipping_methods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shipping_methods": [ShippingMethod.from_dict(_item) for _item in obj["shipping_methods"]] if obj.get("shipping_methods") is not None else None
        })
