...
class RestOpportunityStage(BaseModel):
    """
    ...
    target_number_days: Optional[StrictInt] = None
    updated_time: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["checklist_items", "created_time", "id", "name", "order", "probability", "target_number_days", "updated_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "checklist_items": [ChecklistItem.from_dict(_item) for _item in obj["checklist_items"]] if obj.get("checklist_items") is not None else None,
