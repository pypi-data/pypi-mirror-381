...
class ApplicationConfigurationModuleForms(BaseModel):
    """
    ApplicationConfigurationModuleForms
    """ # noqa: E501
    spam_filters_enabled: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["spam_filters_enabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spam_filters_enabled": obj.get("spam_filters_enabled")
        })
