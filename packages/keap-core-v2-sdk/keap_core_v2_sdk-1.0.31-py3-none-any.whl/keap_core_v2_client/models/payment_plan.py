...
class PaymentPlan(BaseModel):
    ...
    initial_payment_amount: Optional[CurrencyValue] = None
    ...
    __properties: ClassVar[List[str]] = ["auto_charge", "days_between_payments", "days_between_retries", "initial_payment_amount", "initial_payment_date", "initial_payment_percent", "max_charge_attempts", "number_of_payments", "payment_method_id", "plan_start_date"]
