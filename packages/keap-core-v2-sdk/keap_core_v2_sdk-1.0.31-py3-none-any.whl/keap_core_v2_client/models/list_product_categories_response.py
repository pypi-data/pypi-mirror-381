...
class ListProductCategoriesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["next_page_token", "product_categories"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.product_categories:
            ...
            _dict['product_categories'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "product_categories": [ProductCategory.from_dict(_item) for _item in obj["product_categories"]] if obj.get("product_categories") is not None else None
        })
