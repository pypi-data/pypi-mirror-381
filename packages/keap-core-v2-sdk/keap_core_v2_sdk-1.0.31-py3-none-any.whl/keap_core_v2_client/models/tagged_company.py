...
class TaggedCompany(BaseModel):
    """
    TaggedCompany
    """ # noqa: E501
    applied_time: Optional[StrictStr] = Field(default=None, description="The time the tag was applied to the company, in ISO 8601 format.")
    company: Optional[Company] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["applied_time", "company"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applied_time": obj.get("applied_time"),
