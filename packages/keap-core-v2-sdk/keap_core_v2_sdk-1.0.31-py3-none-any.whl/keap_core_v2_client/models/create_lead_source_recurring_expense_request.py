...
class CreateLeadSourceRecurringExpenseRequest(BaseModel):
    """
    ...
    end_time: Optional[StrictStr] = Field(default=None, description="The time the lead source recurring expense ends")
    notes: Optional[StrictStr] = Field(default=None, description="The notes for the lead source recurring expense")
    start_time: Optional[StrictStr] = Field(default=None, description="The time the lead source recurring expense starts")
    title: Optional[StrictStr] = Field(default=None, description="The title of the lead source recurring expense")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["amount", "end_time", "notes", "start_time", "title"]
