...
class ContactLinkType(BaseModel):
    """
    ContactLinkType
    """ # noqa: E501
    create_time: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    max_links: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["create_time", "id", "max_links", "name"]
