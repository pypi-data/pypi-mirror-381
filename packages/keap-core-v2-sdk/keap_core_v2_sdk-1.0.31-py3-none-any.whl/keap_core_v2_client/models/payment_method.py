...
class PaymentMethod(BaseModel):
    ...
    merchant_account_type: Optional[StrictStr] = None
    payment_method_id: Optional[StrictStr] = None
    payment_method_type: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["card_info", "contact_id", "created_time", "merchant_account_id", "merchant_account_type", "payment_method_id", "payment_method_type"]
