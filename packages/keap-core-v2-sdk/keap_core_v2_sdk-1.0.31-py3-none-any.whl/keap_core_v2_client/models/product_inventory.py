...
class ProductInventory(BaseModel):
    ...
    inventory_count: Optional[StrictInt] = Field(default=None, description="The current inventory count for this product. Must be greater than or equal to 0. This field is omitted in List responses.")
