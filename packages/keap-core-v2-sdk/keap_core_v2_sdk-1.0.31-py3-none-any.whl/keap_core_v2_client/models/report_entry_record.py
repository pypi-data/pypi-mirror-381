...
class ReportEntryRecord(BaseModel):
    """
    ReportEntryRecord
    """ # noqa: E501
    columns: Optional[List[ReportEntryValue]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [ReportEntryValue.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
