...
class UpdateOrderItemRequest(BaseModel):
    ...
    """ # noqa: E501
    cost_per_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The cost per unit. Must be greater than or equal to 0.")
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the order item. Must not be whitespace.")
    notes: Optional[StrictStr] = Field(default=None, description="The notes for the order item. Must not be whitespace.")
    price_per_unit: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The price per unit. Must be greater than or equal to 0.")
    quantity: Optional[StrictInt] = Field(default=None, description="The quantity. Must be greater than or equal to 1.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["cost_per_unit", "description", "item_type", "name", "notes", "price_per_unit", "quantity"]
