...
class UpdateOpportunityRequestV2(BaseModel):
    """
    ...
    opportunity_title: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["affiliate_id", "contact_id", "custom_fields", "estimated_close_time", "include_in_forecast", "next_action_notes", "next_action_time", "opportunity_notes", "opportunity_title", "projected_revenue_high", "projected_revenue_low", "stage_id", "user_id"]
