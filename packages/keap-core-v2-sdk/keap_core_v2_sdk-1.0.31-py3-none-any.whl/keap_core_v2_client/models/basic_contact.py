...
class BasicContact(BaseModel):
    ...
    BasicContact
    """ # noqa: E501
    applied_time: Optional[StrictStr] = Field(default=None, description="The time the tag was applied to the contact, in ISO 8601 format.")
    email: Optional[StrictStr] = None
    family_name: Optional[StrictStr] = None
    given_name: Optional[StrictStr] = None
    id: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["applied_time", "email", "family_name", "given_name", "id"]
