...
class UpdateProductDiscountRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["apply_to_commissions", "criteria", "description", "discount_type", "discount_value", "name", "product_id"]
