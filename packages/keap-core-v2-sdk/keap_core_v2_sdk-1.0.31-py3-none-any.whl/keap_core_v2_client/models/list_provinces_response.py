...
class ListProvincesResponse(BaseModel):
    """
    ListProvincesResponse
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = None
    provinces: List[Province] = Field(description="A key-value pair of province code and province name.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["next_page_token", "provinces"]
