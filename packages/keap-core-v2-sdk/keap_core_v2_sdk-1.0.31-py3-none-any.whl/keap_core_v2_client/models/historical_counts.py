...
class HistoricalCounts(BaseModel):
    ...
    HistoricalCounts
    """ # noqa: E501
    var_24_hours: Optional[StrictInt] = Field(default=None, alias="24_hours")
    var_30_days: Optional[StrictInt] = Field(default=None, alias="30_days")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["24_hours", "30_days"]
