...
class ListOpportunitiesResponse(BaseModel):
    ...
    opportunities: Optional[List[RestV2Opportunity]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["next_page_token", "opportunities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "opportunities": [RestV2Opportunity.from_dict(_item) for _item in obj["opportunities"]] if obj.get("opportunities") is not None else None
        })
