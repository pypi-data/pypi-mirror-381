...
class RabbitMQConsumerBase:
    ...
    async def process_message(self, message: IncomingMessage) -> bool:
        ...
        try:
            ...
            logger.error("Failed to process message", extra={"error": str(e)})
    ...
    async def monitor_and_fetch(self):
        ...
        try:
            ...
            logger.error(f"Error in monitor loop: {str(e)}", extra={"error": str(e), "error_type": type(e).__name__})
    ...
    async def start_consuming(self):
        ...
        while self.should_stop is False:
            try:
                ...
                logger.error("❌ Error in consumer loop", extra={"error": str(e), "error_type": type(e).__name__})
                self.stats["errors"] += 1
