...
class Kalibr:
    ...
    def action(self, name: str, description: str = ""):
        ...
        def decorator(func: Callable):
            ...
            # Create handler that accepts both GET (query params) and POST (JSON body)
    ...
    def _extract_params(self, func: Callable) -> Dict:
        ...
        for param_name, param in sig.parameters.items():
            ...
            # Check type hints first, then annotations
    ...
    def _setup_routes(self):
        ...
        # Override OpenAPI generation to include servers
        def custom_openapi():
