...
class Kalibr:
    ...
    def action(self, name: str, description: str = ""):
        """Decorator to register an action that accepts JSON body (Claude & GPT compatible)."""
        def decorator(func: Callable):
            ...
            async def endpoint_handler(request: Request):
                ...
                # Pass JSON body into function
                result = func(**body)
                return result

            # Register POST only (AI models will always POST JSON)
