...
-------------------------------------------------------------------------
Added:
* Include on the filtered configuration list configurations with name edited 

Changed:
* Configuration filtered list not only shows configuration with description 
  edited
* icepapsnapshot check use two snapshot files instead to compare with a 
  real time snapshot

Fixed:
* Fix difference between configuration default name and date
* Fix wrong use of configuration folder and configuration file
...
* Fix bug to set default configuration
