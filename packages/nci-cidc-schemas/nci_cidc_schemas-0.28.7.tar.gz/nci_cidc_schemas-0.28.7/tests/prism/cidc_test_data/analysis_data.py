...
@analysis_data_generator
def scrnaseq_analysis() -> PrismTestData:
    upload_type = "scrnaseq_analysis"
    prismify_args = get_prismify_args(upload_type)
    prismify_patch = {
        "analysis": {
            "scrnaseq_analysis": [
                {
                    "records": [
                        {
                            "cimac_id": "CTTTPP111.00",
                            "clustering_rds": {"upload_placeholder": "01010101"},
                            "report_html": {"upload_placeholder": "02020202-020202"},
                            "star_sorted_by_coord_bam": {
                                "upload_placeholder": "03030303-030303"
                            },
                            "star_sorted_by_coord_bam_bai": {
                                "upload_placeholder": "040404-040404"
                            },
                            "star_log_final_out": {
                                "upload_placeholder": "05050505-0505005"
                            },
                            "star_log_out": {"upload_placeholder": "06060606-060606"},
                            "star_log_progress_out": {
                                "upload_placeholder": "07070707-070707"
                            },
                            "star_sj_out": {"upload_placeholder": "080808-0808"},
                            "star_barcode_stats": {
                                "upload_placeholder": "090909-090909"
                            },
                            "star_gene_features_stats": {
                                "upload_placeholder": "101010-101010"
                            },
                            "star_gene_summary_csv": {
                                "upload_placeholder": "11111111-11111111"
                            },
                            "star_gene_umi_per_cell_sorted": {
                                "upload_placeholder": "12121212-12121212"
                            },
                            "star_gene_filtered_barcodes": {
                                "upload_placeholder": "13131313-13131313"
                            },
                            "star_gene_filtered_matrix": {
                                "upload_placeholder": "14141414-141414"
                            },
                            "star_gene_filtered_features_tsv": {
                                "upload_placeholder": "15151515-15151515"
                            },
                            "star_gene_raw_barcodes": {
                                "upload_placeholder": "16161616-161616"
                            },
                            "star_gene_raw_matrix": {
                                "upload_placeholder": "17171717-171717"
                            },
                            "star_gene_raw_features_tsv": {
                                "upload_placeholder": "1818181818-181818"
                            },
                            "comments": "a comment",
                        },
                    ],
                    "batch_id": "XYZ",
                    "samples_metadata_csv": {"upload_placeholder": "191919-191919"},
                    "config_yaml": {"upload_placeholder": "202020-202020"},
                    "r_package_versions": {"upload_placeholder": "212121-21212121"},
                    "integration_rds": {"upload_placeholder": "2222222-2222222"},
                    "integration_heatmap_plots": {
                        "upload_placeholder": "23232323-232323"
                    },
                    "integration_markers_zip": {
                        "upload_placeholder": "24242424-24242424"
                    },
                    "integration_split_percent_plots": {
                        "upload_placeholder": "25252525-252525"
                    },
                    "integration_split_umap_plots": {
                        "upload_placeholder": "26262626-26262626"
                    },
                    "integration_umap_plots": {
                        "upload_placeholder": "27272727-27272727"
                    },
                    "excluded_samples": [
                        {"cimac_id": "CTTTPP112.00", "reason_excluded": "low coverage"},
                    ],
                }
            ]
        },
    ...
    cimac_id = "CTTTPP111.00"
    cimac_ids = [cimac_id, "CTTTPP112.00"]

    upload_entries = [
        LocalFileUploadEntry(
            local_path=f"gs://scrna/clustering/{cimac_id}_clustering.rds",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/clustering.rds",
            upload_placeholder=f"01010101",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/report/{cimac_id}_report.html",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/report.html",
            upload_placeholder=f"02020202-020202",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Aligned.sortedByCoord.out.bam'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/star_sorted_by_cord.bam",
            upload_placeholder=f"03030303-030303",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Aligned.sortedByCoord.out.bam.bai'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/star_sorted_by_cord.bam.bai",
            upload_placeholder=f"040404-040404",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Log.final.out'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/log_final.out",
            upload_placeholder=f"05050505-0505005",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Log.out'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/log.out",
            upload_placeholder=f"06060606-060606",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Log.progress.out'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/log_progress.out",
            upload_placeholder=f"07070707-070707",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.SJ.out.tab'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/sj_out.tab",
            upload_placeholder=f"080808-0808",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Barcodes.stats'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/barcodes.stats",
            upload_placeholder=f"090909-090909",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/Features.stats'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_features.stats",
            upload_placeholder=f"101010-101010",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/Summary.csv'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_summary.csv",
            upload_placeholder=f"11111111-11111111",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/UMIperCellSorted.txt'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_umi_per_cell_sorted.txt",
            upload_placeholder=f"12121212-12121212",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/filtered/barcodes.tsv'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_filtered_barcodes.tsv",
            upload_placeholder=f"13131313-13131313",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/filtered/matrix.mtx'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_filtered_matrix.mtx",
            upload_placeholder=f"14141414-141414",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/filtered/features.tsv'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_filtered_features.tsv",
            upload_placeholder=f"15151515-15151515",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/raw/barcodes.tsv'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_raw_barcodes.tsv",
            upload_placeholder=f"16161616-161616",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/raw/matrix.mtx'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_raw_matrix.mtx",
            upload_placeholder=f"17171717-171717",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://scrna/star/{cimac_id}.Solo.out/Gene/raw/features.tsv'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/{cimac_id}/gene_raw_features.tsv",
            upload_placeholder=f"1818181818-181818",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"samples_metadata.csv'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/samples_metadata.csv",
            upload_placeholder=f"191919-191919",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"config.yaml'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/config.yaml",
            upload_placeholder=f"202020-202020",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"R_package_versions.csv'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/R_package_versions.csv",
            upload_placeholder=f"212121-21212121",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"integration.rds'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/integration.rds",
            upload_placeholder=f"2222222-2222222",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"integration_heatmap_plots.zip'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/integration_heatmap_plots.zip",
            upload_placeholder=f"23232323-232323",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"integration_markers.zip'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/integration_markers.zip",
            upload_placeholder=f"24242424-24242424",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"integration_split_percent_plots.zip'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/integration_split_percent_plots.zip",
            upload_placeholder=f"25252525-252525",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"integration_split_umap_plots.zip'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/integration_split_umap_plots.zip",
            upload_placeholder=f"26262626-26262626",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"integration_umap_plots.zip'",
            gs_key=f"test_prism_trial_id/scrnaseq_analysis/XYZ/integration_umap_plots.zip",
            upload_placeholder=f"27272727-27272727",
            metadata_availability=False,
            allow_empty=False,
        ),
    ]
...
@analysis_data_generator
def visium_analysis() -> PrismTestData:
    upload_type = "visium_analysis"
    prismify_args = get_prismify_args(upload_type)
    prismify_patch = {
        "analysis": {
            "visium_analysis": [
                {
                    "records": [
                        {
                            ...
                            "spatial_variable_features_rds": {
                                "upload_placeholder": "050505-050505"
                            },
                            "visium_spaceranger_output_zip": {
                                "upload_placeholder": "3333-3333"
                            },
                            "comments": "a comment",
                        },
                    ],
                    ...
                    "config_yaml": {"upload_placeholder": "202020-202020"},
                    "r_package_versions": {"upload_placeholder": "212121-21212121"},
                    "merged_rds": {"upload_placeholder": "2222222-2222222"},
                    "excluded_samples": [
                        {"cimac_id": "CTTTPP112.00", "reason_excluded": "low coverage"},
                    ],
                }
    ...
    upload_entries = [
        LocalFileUploadEntry(
            local_path=f"gs://visium/spatial_variable_features/{cimac_id}_spatial_variable_features.rds",
            gs_key=f"test_prism_trial_id/visium_analysis/XYZ/{cimac_id}/spatial_variable_features.rds",
            upload_placeholder=f"050505-050505",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://visium/report/{cimac_id}_report.html",
            gs_key=f"test_prism_trial_id/visium_analysis/XYZ/{cimac_id}/report.html",
            upload_placeholder=f"02020202-020202",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"gs://visium/{cimac_id}_spaceranger.zip",
            gs_key=f"test_prism_trial_id/visium_analysis/XYZ/{cimac_id}/visium_spaceranger_output.zip",
            upload_placeholder=f"3333-3333",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"samples_metadata.csv",
            gs_key=f"test_prism_trial_id/visium_analysis/XYZ/samples_metadata.csv",
            upload_placeholder=f"191919-191919",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"config.yaml",
            gs_key=f"test_prism_trial_id/visium_analysis/XYZ/config.yaml",
            upload_placeholder=f"202020-202020",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"R_package_versions.csv",
            gs_key=f"test_prism_trial_id/visium_analysis/XYZ/R_package_versions.csv",
            upload_placeholder=f"212121-21212121",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path=f"merged.rds",
            gs_key=f"test_prism_trial_id/visium_analysis/XYZ/merged.rds",
            upload_placeholder=f"2222222-2222222",
            metadata_availability=False,
            allow_empty=False,
        ),
