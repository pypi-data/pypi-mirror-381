...
def mihc() -> PrismTestData:
    ...
    prismify_patch = {
        ...
        "assays": {
            "mihc": [
                {
                    "samples_file": {
                        "upload_placeholder": "865f4bae-bca8-42f6-a3b7-cb4db27b2e24"
                    },
                    "panel": "Not Provided",
                    "antibodies": [
                        {
                            "antibody": "PD-L1",
                            "export_name": "Not applicable",
                            "clone": "E1L3N",
                            "company": "Cell Signaling Technology",
                            "cat_num": "13684S",
                            "lot_num": "13",
                            "staining_order": 1,
                            "primary_ab_dilution": "1/400",
                            "dilutent": "BOND Primary Antibody Diluent (Leica Biosystems catalog #: AR9352)",
                            "fluor_dilution": "Not applicable",
                            "antigen_retrieval_time": "00:40:00",
                            "primary_incubation_time": "00:15:00",
                            "amplification_time": "00:08:00",
                        },
                        {
                            "antibody": "FOXP3",
                            "clone": "236A/E7",
                            ...
                            "lot_num": "GR3438341-5",
                            "staining_order": 2,
                            "primary_ab_dilution": "1/80",
                            "dilutent": "BOND Primary Antibody Diluent (Leica Biosystems catalog #: AR9352)",
                            "fluor_dilution": "Not applicable",
                            "antigen_retrieval_time": "00:20:00",
                            "primary_incubation_time": "00:15:00",
                            "amplification_time": "00:08:00",
                        },
                    ],
                    ...
                    "assay_creator": "Mount Sinai",
                    "slide_scanner_model": "Not Provided",
                    "staining": "Bond RX",
                    "imaging_status": "Yes",
                    "batch_id": "1234",
                }
    ...
    upload_entries = [
        LocalFileUploadEntry(
            local_path="mihc/samples_report.csv",
            gs_key="test_prism_trial_id/mihc/1234/sample_report.csv",
            upload_placeholder="865f4bae-bca8-42f6-a3b7-cb4db27b2e24",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="samples.ome.tiff",
            gs_key="test_prism_trial_id/mihc/CTTTPP111.01/tilemap.ome.tiff",
            upload_placeholder="865f4bae-bca8-42f6-a3b7-cb4db27b2e69",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            ...
            gs_key="test_prism_trial_id/mihc/CTTTPP111.01/tilestats.csv",
            upload_placeholder="865f4bae-bca8-42f6-a3b7-cb4db27b2221",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="run.h5ad",
            gs_key="test_prism_trial_id/mihc/CTTTPP111.01/h5ad.h5ad",
            upload_placeholder="865f4bae-bca8-42f6-a3b7-cb4db27b1244",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="run.tar.gz",
            gs_key="test_prism_trial_id/mihc/CTTTPP111.01/multitiffs.tar.gz",
            upload_placeholder="865f4bae-bca8-42f6-a3b7-cb4db27b1564",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="stains.zip",
            gs_key="test_prism_trial_id/mihc/CTTTPP111.01/stains.zip",
            upload_placeholder="865f4bae-bca8-42f6-a3b7-cb4db27b1999",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            ...
            gs_key="test_prism_trial_id/mihc/CTTTPP111.01/geo_jsons.zip",
            upload_placeholder="865f4bae-bca8-42f6-a3b7-cb4db27b329",
            metadata_availability=False,
            allow_empty=False,
        ),
...
@assay_data_generator
def maldi_glycan() -> PrismTestData:
    upload_type = "maldi_glycan"
    prismify_args = get_prismify_args(upload_type)
    prismify_patch = {
        "protocol_identifier": "test_prism_trial_id",
        "assays": {
                    ...
                    "records": [
                        {
                            ...
                            "details": {
                                "ibd_file": {
                                    "upload_placeholder": "d658b480-ed78-4717-621-31122"
                                },
                                "imzml_file": {
                                    "upload_placeholder": "d658b480-ed7-4717-b621-1144"
                                },
                                "channels_csv": {
                                    "upload_placeholder": "d658b48-ed78-4717-b621-1144a"
                                },
                                "tiff_zip": {
                                    "upload_placeholder": "d658b480-e8-4717-b621-1144aa"
                                },
                            },
                        },
                        {
                            ...
                            "details": {
                                "ibd_file": {
                                    "upload_placeholder": "2658b480-ed78-4717-b621-312"
                                },
                                "imzml_file": {
                                    "upload_placeholder": "2658b480-ed78-4717-b621-14"
                                },
                                "channels_csv": {
                                    "upload_placeholder": "2658b0-ed78-4717-b621-1144a"
                                },
                                "tiff_zip": {
                                    "upload_placeholder": "2658b480-ed7-717-b621-1144aa"
                                },
                            },
                        },
                    ],
    ...
    upload_entries = [
        LocalFileUploadEntry(
            local_path="molecular.tsv",
            upload_placeholder="d658b480-ed78-4717-b622-3e2112",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/molecular_assignments.tsv",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="metadata.tsv",
            upload_placeholder="d658b480-ed78-4717-b622-3ea112",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/metadata.tsv",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="first.ibd",
            upload_placeholder="d658b480-ed78-4717-621-31122",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/CTTTPP121.01/ibd_file.ibd",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="first.imzml",
            upload_placeholder="d658b480-ed7-4717-b621-1144",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/CTTTPP121.01/imzml_file.imzml",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="channels1.csv",
            upload_placeholder="d658b48-ed78-4717-b621-1144a",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/CTTTPP121.01/channels.csv",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="tiff1.zip",
            upload_placeholder="d658b480-e8-4717-b621-1144aa",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/CTTTPP121.01/tiff.zip",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="second.ibd",
            upload_placeholder="2658b480-ed78-4717-b621-312",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/CTTTPP122.01/ibd_file.ibd",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="second.imzml",
            upload_placeholder="2658b480-ed78-4717-b621-14",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/CTTTPP122.01/imzml_file.imzml",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="channels2.csv",
            upload_placeholder="2658b0-ed78-4717-b621-1144a",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/CTTTPP122.01/channels.csv",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="tiff2.zip",
            upload_placeholder="2658b480-ed7-717-b621-1144aa",
            gs_key="test_prism_trial_id/maldi_glycan/test_batch/CTTTPP122.01/tiff.zip",
            metadata_availability=False,
            allow_empty=False,
        ),
    ]
    ...
    cimac_ids = [
        record["cimac_id"]
        for batch in prismify_patch["assays"]["maldi_glycan"]
        for record in batch["records"]
    ]
    base_trial = get_test_trial(cimac_ids)
...
def visium() -> PrismTestData:
            ...
            "visium": [
                {
                    ...
                    "azimuth_reference": "adiposeref",
                    "tabula_sapiens_reference": "bladder",
                    "spatial_gene_expression_platform": "Visium Spatial Gene Expression for FFPE",
                    "human_transcriptome_probe_set_version": "Visium Human Transcriptome Probe Set v1.0",
                    "samples_metadata_csv": {
                        "upload_placeholder": "d658b480-ed78-4717-b622-3e2223"
                    },
                    "records": [
                        {
                            "cimac_id": "CTTTPP121.01",
                            "details": {
                                "read_1_fastq_gz": {
                                    "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-3e3dd8361"
                                },
                                "read_2_fastq_gz": {
                                    "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-3e3dd83113"
                                },
                                "loupe_alignment_file": {
                                    "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-32e3dd823112"
                                },
                                "lane": 1,
                                "slide_serial_code": "serial_string",
                                "slide_capture_area": "capture string",
                                "library_yield_ng": 23,
                                "dv200": 0.4,
                                "brightfield_image": {
                                    "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-312322ff"
                                },
                                "dark_image": {
                                    "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-311fff"
                                },
                                "colorized_image": {
                                    "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-4123444444"
                                },
                                "cytassist_image": {
                                    "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-311ff2341324fq"
                                },
                                "dapi_index": 2,
                                "comments": "a comment",
                            },
    ...
    upload_entries = [
        LocalFileUploadEntry(
            local_path="samples.csv",
            upload_placeholder="d658b480-ed78-4717-b622-3e2223",
            gs_key="test_prism_trial_id/visium/test_batch/samples_metadata.csv",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="read1.gz",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-3e3dd8361",
            gs_key="test_prism_trial_id/visium/test_batch/CTTTPP121.01/fastq/S1_L001_R1_001.fastq.gz",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="read2.gz",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-3e3dd83113",
            gs_key="test_prism_trial_id/visium/test_batch/CTTTPP121.01/fastq/S1_L001_R2_001.fastq.gz",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="loupe.json",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-32e3dd823112",
            gs_key="test_prism_trial_id/visium/test_batch/CTTTPP121.01/loupe_alignment_file.json",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="bright.tiff",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-312322ff",
            gs_key="test_prism_trial_id/visium/test_batch/CTTTPP121.01/brightfield.tiff",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="dark.tiff",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-311fff",
            gs_key="test_prism_trial_id/visium/test_batch/CTTTPP121.01/dark_image.tiff",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="color.tiff",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-4123444444",
            gs_key="test_prism_trial_id/visium/test_batch/CTTTPP121.01/colorized.tiff",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="cytassist.tiff",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-311ff2341324fq",
            gs_key="test_prism_trial_id/visium/test_batch/CTTTPP121.01/cytassist.tiff",
            metadata_availability=False,
            allow_empty=False,
        ),
    ]
    ...
    cimac_ids = [
        record["cimac_id"]
        for batch in prismify_patch["assays"]["visium"]
        for record in batch["records"]
    ]
    base_trial = get_test_trial(cimac_ids)
