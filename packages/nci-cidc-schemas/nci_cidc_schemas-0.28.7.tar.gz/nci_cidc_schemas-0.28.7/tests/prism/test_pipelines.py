    ...
    if "wes" in template.type or template.type == "tumor_normal_pairing":
        for partic in full_ct["participants"]:
            ...
            if partic_id == "CTTTPP1":
                ...
                partic["samples"][0]["processed_sample_derivative"] = "ctDNA"
                ...
                for n in (0, 1):
                    partic["samples"][n]["processed_sample_derivative"] = "ctDNA"
                ...
                for i in range(len(partic["samples"])):
                    partic["samples"][i]["processed_sample_derivative"] = "ctDNA"
