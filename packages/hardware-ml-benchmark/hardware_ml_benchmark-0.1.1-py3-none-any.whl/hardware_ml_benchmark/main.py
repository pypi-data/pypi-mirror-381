...
hardware-benchmark --device cuda:0 --task classification --model resnet18 --dataset MNIST --samples 100
hardware-benchmark --device cpu --task detection --model yolov8n --dataset Test-Images --samples 500
