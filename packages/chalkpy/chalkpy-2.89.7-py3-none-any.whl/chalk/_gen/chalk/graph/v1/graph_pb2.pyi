...
class StreamResolverMessageProducer(_message.Message):
    __slots__ = ("send_to", "output_features", "feature_expressions")
...
class StreamResolver(_message.Message):
    ...
    feature_expressions: _containers.MessageMap[str, FeatureExpression]
    message_producer: StreamResolverMessageProducer
    def __init__(
        self,
        fqn: _Optional[str] = ...,
        ...
        updates_materialized_aggregations: bool = ...,
        feature_expressions: _Optional[_Mapping[str, FeatureExpression]] = ...,
        message_producer: _Optional[_Union[StreamResolverMessageProducer, _Mapping]] = ...,
    ) -> None: ...
