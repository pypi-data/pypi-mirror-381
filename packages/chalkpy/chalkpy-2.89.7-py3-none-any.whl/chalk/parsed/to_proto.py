...
class ToProtoConverter:
        ...
        res = pb.FeatureType(
            group_by=pb.GroupByFeatureType(
                ...
                aggregation=pb.WindowAggregation(
                    ...
                    if mat.aggregation in ("approx_top_k", "first_k", "last_k")
                    else None,
                ),
                tags=f.tags,
                ...
                window_info=(
                    pb.WindowInfo(
                        ...
                        aggregation=pb.WindowAggregation(
                            ...
                            approx_top_k_arg_k=aggregation_kwargs.get("k")
                            if wmp.aggregation in ("approx_top_k", "first_k", "last_k")
                            else None,
                        )
                        if wmp is not None
                        else None,
    ...
    def convert_stream_resolver(cls, r: StreamResolver) -> pb.StreamResolver:
        ...
        message_producer: pb.StreamResolverMessageProducer | None = None
        if r.message_producer_parsed is not None:
            message_producer = pb.StreamResolverMessageProducer(
                ...
                feature_expressions={
                    str(k): graph_pb2.FeatureExpression(underscore_expr=cls.convert_underscore(v))
