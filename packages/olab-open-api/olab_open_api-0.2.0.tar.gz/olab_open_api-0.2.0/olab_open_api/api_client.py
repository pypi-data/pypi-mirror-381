...
from olab_open_api.api_response import ApiResponse, T as ApiResponseT
import olab_open_api.models
from olab_open_api import rest
from olab_open_api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(olab_open_api.models, klass)
