...
class OpenapiMarketDataOpenAPI(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chainId", "childMarkets", "conditionId", "createdAt", "cutoffAt", "marketId", "marketTitle", "noLabel", "noTokenId", "questionId", "quoteToken", "resolvedAt", "resultTokenId", "rules", "status", "statusEnum", "volume", "yesLabel", "yesTokenId"]
