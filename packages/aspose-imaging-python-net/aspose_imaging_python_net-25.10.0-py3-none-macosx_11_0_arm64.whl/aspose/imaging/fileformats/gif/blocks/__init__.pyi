...
class GifApplicationExtensionBlock(aspose.imaging.fileformats.gif.GifBlock):
    ...
    @property
    def EXTENSION_INTRODUCER(self) -> int:
    ...
    @property
    def APPLICATION_IDENTIFIER_SIZE(self) -> int:
        '''Specifies the application identifier size.'''
        raise NotImplementedError()

    @property
    def APPLICATION_AUTHENTICATION_CODE_SIZE(self) -> int:
...
class GifFrameBlock(aspose.imaging.RasterCachedImage):
    ...
    @property
    def IMAGE_DESCRIPTOR_SIZE(self) -> int:
