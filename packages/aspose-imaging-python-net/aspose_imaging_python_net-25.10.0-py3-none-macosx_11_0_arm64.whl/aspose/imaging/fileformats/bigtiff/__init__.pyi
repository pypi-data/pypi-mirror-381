...
class BigTiffImage(aspose.imaging.fileformats.tiff.TiffImage):
    '''With the :py:class:`aspose.imaging.fileformats.bigtiff.BigTiffImage` class you can effortlessly manipulate
    ...
    def __init__(self, frame : aspose.imaging.fileformats.tiff.TiffFrame) -> None:
        '''Create a new instance of the :py:class:`aspose.imaging.fileformats.bigtiff.BigTiffImage` class by initializing
    ...
    def __init__(self, frames : List[aspose.imaging.fileformats.tiff.TiffFrame]) -> None:
        '''Begin utilizing the :py:class:`aspose.imaging.fileformats.bigtiff.BigTiffImage` class seamlessly by
    ...
    def create_with_frame(frame : aspose.imaging.fileformats.tiff.TiffFrame) -> aspose.imaging.fileformats.bigtiff.BigTiffImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.bigtiff.BigTiffImage` class.
