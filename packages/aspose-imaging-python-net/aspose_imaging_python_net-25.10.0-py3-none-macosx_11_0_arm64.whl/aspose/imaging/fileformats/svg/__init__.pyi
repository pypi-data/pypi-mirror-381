...
class FontStoringArgs:
    ...
    @property
    def source_font_stream(self) -> io._IOBase:
        '''Gets the source font stream.'''
        raise NotImplementedError()
    
    @property
    def dest_font_stream(self) -> io._IOBase:
        '''Gets the dest font stream.'''
        raise NotImplementedError()
    
    @dest_font_stream.setter
    def dest_font_stream(self, value : io._IOBase) -> None:
    ...
    def font_file_uri(self, value : str) -> None:
    ...
    def dispose_stream(self, value : bool) -> None:
    ...
    def font_store_type(self, value : aspose.imaging.fileformats.svg.FontStoreType) -> None:
...
class ISvgResourceKeeperCallback:
    ...
    def on_image_resource_ready(self, image_data : List[int], image_type : aspose.imaging.fileformats.svg.SvgImageType, suggested_file_name : str, use_embedded_image : List[bool]) -> str:
    ...
    def on_font_resource_ready(self, args : aspose.imaging.fileformats.svg.FontStoringArgs) -> None:
        '''Called when the font resource is ready for export.
        
        :param args: The font storing options.'''
        raise NotImplementedError()
    
    def on_svg_document_ready(self, html_data : List[int], suggested_file_name : str) -> str:
...
class SvgImage(aspose.imaging.VectorImage):
    ...
    def __init__(self, path : str) -> None:
        '''Instantiates a new object of the :py:class:`aspose.imaging.fileformats.svg.SvgImage` class, utilizing the
    ...
    def __init__(self, stream : io._IOBase) -> None:
        '''Creates a new instance of the :py:class:`aspose.imaging.fileformats.svg.SvgImage` class, loading the image
    ...
    def __init__(self, width : int, height : int) -> None:
        '''Instantiates a new :py:class:`aspose.imaging.fileformats.svg.SvgImage` object with the specified width and
    ...
    @overload
    def __init__(self, svg_options : aspose.imaging.imageoptions.SvgOptions, width : int, height : int) -> None:
        '''Creates a new instance of the :py:class:`aspose.imaging.fileformats.svg.SvgImage` class with specified SVG
    ...
    def cache_data(self) -> None:
        ...
        the underlying :py:attr:`aspose.imaging.DataStreamSupporter.data_stream_container`. This
    ...
    @staticmethod
    def create_from_stream(stream : io._IOBase) -> aspose.imaging.fileformats.svg.SvgImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.svg.SvgImage` class.
    ...
    def is_cached(self) -> bool:
        ...
        retrieval and processing workflows for enhanced performance and efficiency.'''
        raise NotImplementedError()
    
    @property
    def bits_per_pixel(self) -> int:
        '''Retrieves the bits per pixel count of the image. It\'s important to note that
        this parameter is not applicable to vector images, as they are not measured in
        pixels. This property provides crucial information about the image\'s color
        depth, aiding in processing and manipulation tasks.'''
        raise NotImplementedError()
    ...
    def file_format(self) -> aspose.imaging.FileFormat:
        ...
        image data effectively across different systems and applications.'''
        raise NotImplementedError()
