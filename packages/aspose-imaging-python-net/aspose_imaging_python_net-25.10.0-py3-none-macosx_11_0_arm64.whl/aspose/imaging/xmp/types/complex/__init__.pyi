...
class ComplexTypeBase(aspose.imaging.xmp.types.XmpTypeBase):
    '''Represents base abstraction for XMP Complex value type.'''
    
    def __init__(self, prefix : str, namespace_uri : str) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.xmp.types.complex.ComplexTypeBase` class.
