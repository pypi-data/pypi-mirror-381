...
class AutoMaskingGraphCutOptions(GraphCutMaskingOptions):
    ...
    @property
    def BACKGROUND_OBJECT_NUMBER(self) -> int:
    ...
    def assumed_objects(self, value : System.Collections.Generic.List`1[[Aspose.Imaging.Masking.Options.AssumedObjectData]]) -> None:
