...
class Complex:
    ...
    @property
    def SIZE_OF_DOUBLE(self) -> int:
        '''The size of :py:class:`float`.'''
        raise NotImplementedError()

    @property
    def SIZE_OF_COMPLEX(self) -> int:
        '''The size of complex.'''
        raise NotImplementedError()

    @property
    def ZERO(self) -> aspose.imaging.imagefilters.complexutils.Complex:
        '''Zero complex.'''
        raise NotImplementedError()

    @property
    def ONE(self) -> aspose.imaging.imagefilters.complexutils.Complex:
    ...
    @property
    def I(self) -> aspose.imaging.imagefilters.complexutils.Complex:
