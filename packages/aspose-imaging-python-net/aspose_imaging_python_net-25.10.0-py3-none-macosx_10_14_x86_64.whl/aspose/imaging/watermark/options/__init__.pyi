...
class ContentAwareFillWatermarkOptions(WatermarkOptions):
    ...
    @property
    def mask(self) -> System.Collections.Generic.IEnumerable`1[[Aspose.Imaging.Point]]:
        '''Gets the mask.'''
        raise NotImplementedError()
    
    @mask.setter
    def mask(self, value : System.Collections.Generic.IEnumerable`1[[Aspose.Imaging.Point]]) -> None:
        '''Sets the mask.'''
        raise NotImplementedError()
