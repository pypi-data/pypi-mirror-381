...
class XmpMediaManagementPackage(aspose.imaging.xmp.XmpPackage):
    '''Represents XMP Media Management namespace.'''
    
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.xmp.schemas.xmpmm.XmpMediaManagementPackage` class.'''
    ...
    @overload
    def set_document_id(self, guid : System.Guid) -> None:
    ...
    @overload
    def set_document_id(self, guid : str) -> None:
        '''Sets the document identifier.
    ...
    @overload
    def set_instance_id(self, guid : System.Guid) -> None:
        '''Sets instance id.
    ...
    @overload
    def set_instance_id(self, guid : str) -> None:
        '''Sets instance id.
    ...
    @overload
    def set_original_document_id(self, guid : System.Guid) -> None:
    ...
    @overload
    def set_original_document_id(self, guid : str) -> None:
        '''Sets the original document id.
    ...
    def set_derived_from(self, resource_ref : aspose.imaging.xmp.types.complex.resourceref.ResourceRef) -> None:
        '''Sets the derived from.
        
        :param resource_ref: The resource reference.'''
        raise NotImplementedError()
    
    def set_document_id_as_guid(self, guid : System.Guid) -> None:
        '''Sets the document identifier.
        
        :param guid: The unique identifier.'''
        raise NotImplementedError()
    
    def set_instance_id_as_guid(self, guid : System.Guid) -> None:
        '''Sets instance id.
        
        :param guid: The unique identifier.'''
        raise NotImplementedError()
    
    def set_original_document_id_as_guid(self, guid : System.Guid) -> None:
        '''Sets the original document id.
