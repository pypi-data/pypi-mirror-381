...
class StreamExtensions:
    ...
    @staticmethod
    def create_memory_stream() -> io._IOBase:
        '''Creates a MemoryStream.
        
        :returns: The MemoryStream instance.'''
        raise NotImplementedError()
    
    @staticmethod
    def create_memory_stream_with_size(capacity : int) -> io._IOBase:
    ...
    @staticmethod
    def create_memory_stream_from_bytes(array : List[int]) -> io._IOBase:
        '''Creates a MemoryStream with a given array inside.
        
        :param array: The array for wrapping.
        :returns: The MemoryStream instance.'''
        raise NotImplementedError()
    
    @staticmethod
    def create_file_stream(path : str, file_mode : System.IO.FileMode) -> io._IOBase:
