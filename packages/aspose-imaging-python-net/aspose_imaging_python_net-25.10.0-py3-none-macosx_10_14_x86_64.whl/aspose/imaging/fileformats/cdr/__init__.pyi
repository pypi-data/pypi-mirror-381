...
class CdrImage(aspose.imaging.VectorMultipageImage):
    ...
    def __init__(self, stream : io._IOBase, load_options : aspose.imaging.LoadOptions) -> None:
        '''Start working with the :py:class:`aspose.imaging.fileformats.cdr.CdrImage` class effortlessly by
    ...
    def is_cached(self) -> bool:
        ...
        faster access to object information.'''
        raise NotImplementedError()
    
    @property
    def bits_per_pixel(self) -> int:
        '''Retrieve the bit depth of the image effortlessly with this user-friendly property.
        Ideal for developers seeking to determine the level of detail or color depth present
    ...
    def page_count(self) -> int:
        ...
        intuitive property. Ideal for developers seeking to manage multi-page images
        dynamically, ensuring efficient navigation and manipulation of image content.'''
        raise NotImplementedError()
    
    @property
    def pages(self) -> List[aspose.imaging.Image]:
        '''Retrieve the pages of the image seamlessly with this intuitive property.
        Ideal for developers seeking to access and manipulate individual pages within
        multi-page images, ensuring efficient navigation and processing.'''
        raise NotImplementedError()
    
    @property
    def default_page(self) -> aspose.imaging.Image:
        '''Retrieve the default page of the image with ease using this user-friendly property.
        Perfect for developers seeking quick access to the primary page of their image,
        ensuring efficient navigation and management.'''
        raise NotImplementedError()
    
    @property
    def cdr_document(self) -> aspose.imaging.fileformats.cdr.objects.CdrDocument:
        '''Effortlessly retrieve or update the CDR document using this intuitive property.
        Ideal for developers seeking to access or modify the CDR document, ensuring
        flexibility and efficiency in their applications.'''
        raise NotImplementedError()
    

class CdrImagePage(aspose.imaging.VectorImage):
    '''The Cdr image page'''
    ...
    @property
    def parent_image(self) -> aspose.imaging.fileformats.cdr.CdrImage:
