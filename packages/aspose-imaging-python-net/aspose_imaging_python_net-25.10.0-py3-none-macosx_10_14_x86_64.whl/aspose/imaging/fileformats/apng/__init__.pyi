...
class ApngFrame(aspose.imaging.RasterCachedImage):
    '''Craft animated PNG (APNG) image frames from single-page raster images with our API.
    Seamlessly set animation and frame duration, program the number of frames, and
    adjust gamma and contrast levels, ensuring captivating and customizable animations
...
class ApngImage(aspose.imaging.RasterCachedMultipageImage):
    ...
    def __init__(self, options : aspose.imaging.imageoptions.ApngOptions, width : int, height : int) -> None:
        '''Begin working with the :py:class:`aspose.imaging.fileformats.apng.ApngImage` class by initializing
    ...
    @overload
    def resize(self, new_width : int, new_height : int, resize_type : aspose.imaging.ResizeType) -> None:
        '''Resize the image seamlessly with this intuitive method. Perfect for developers
        seeking to adjust the dimensions of their images dynamically.
    ...
    @overload
    def resize_width_proportionally(self, new_width : int, resize_type : aspose.imaging.ResizeType) -> None:
        '''Proportionally resize the width of the image effortlessly with this intuitive method.
        Ideal for developers seeking to maintain the aspect ratio of their images while
        adjusting their dimensions.
    ...
    @overload
    def resize_height_proportionally(self, new_height : int, resize_type : aspose.imaging.ResizeType) -> None:
        '''Effortlessly adjust the height of your image while maintaining its proportions
        with this intuitive method. Perfect for developers looking to resize images
        dynamically while preserving their aspect ratio.
    ...
    def rotate(self, angle : float, resize_proportionally : bool, background_color : aspose.imaging.Color) -> None:
        ...
        Perfect for developers seeking to adjust the orientation of their images dynamically.
    ...
    @overload
    def crop(self, rectangle : aspose.imaging.Rectangle) -> None:
        '''Effortlessly crop the image to focus on specific areas with this intuitive method.
        Perfect for developers seeking to refine the composition of their images dynamically.
    ...
    @overload
    def crop(self, left_shift : int, right_shift : int, top_shift : int, bottom_shift : int) -> None:
        '''Crop the image while adjusting shifts seamlessly with this intuitive method.
        Ideal for developers seeking precise control over the cropping process
        to focus on specific areas of their Apng images.
    ...
    @overload
    def dither(self, dithering_method : aspose.imaging.DitheringMethod, bits_count : int, custom_palette : aspose.imaging.IColorPalette) -> None:
        '''Easily apply dithering effects to the current image with this intuitive method.
        Ideal for developers looking to add texture or reduce color banding in their images.
    ...
    @overload
    def adjust_gamma(self, gamma : float) -> None:
        '''Apply gamma correction to the image using a floating-point coefficient
        with this intuitive method. Ideal for developers seeking precise color control
        in their images.
    ...
    @overload
    def adjust_gamma(self, gamma_red : float, gamma_green : float, gamma_blue : float) -> None:
        '''Perform gamma correction on the image separately for the red, green, and blue channels
        using individual coefficients with this intuitive method. Ideal for developers seeking
        to fine-tune color balance and enhance the visual quality of their images.
    ...
    @overload
    def add_frame(self) -> aspose.imaging.fileformats.apng.ApngFrame:
        '''Easily append a new frame to the end of your frame collection with this
        straightforward method. Ideal for developers looking to expand their
        frame collection dynamically for animations with multi-frame images.
        A new frame will be created according to the size of the current image.
        
        :returns: The newly created APNG frame.'''
        raise NotImplementedError()
    
    @overload
    def add_frame(self, frame_image : aspose.imaging.RasterImage) -> None:
        '''Effortlessly expand your frame collection by adding a new frame to the end
        with this intuitive method. Perfect for developers seeking to enhance their
        animations of multi-frame images dynamically.
        The contents of the new frame will be filled from the specified image.
        
        :param frame_image: The frame image.'''
        raise NotImplementedError()
    
    @overload
    def add_frame(self, frame_image : aspose.imaging.RasterImage, frame_time : int) -> None:
        ...
        :param frame_image: The frame image.
        :param frame_time: The frame duration, in milliseconds.'''
        raise NotImplementedError()
    
    @overload
    def insert_frame(self, index : int) -> aspose.imaging.fileformats.apng.ApngFrame:
    ...
    @overload
    def insert_frame(self, index : int, frame_image : aspose.imaging.RasterImage) -> None:
    ...
    @overload
    def insert_frame(self, index : int, frame_image : aspose.imaging.RasterImage, frame_time : int) -> None:
        '''Inserts new frame into the own frame collection at the specified index.
        The contents of the new frame will be filled from the specified image.
    ...
    def get_default_options(self, args : List[Any]) -> aspose.imaging.ImageOptionsBase:
        ...
        Ideal for developers seeking quick access to default Apng image settings.
    ...
    def rotate_flip(self, rotate_flip_type : aspose.imaging.RotateFlipType) -> None:
        '''Effortlessly manipulate the active frame by rotating, flipping, or both
        with this intuitive method. Ideal for developers seeking to customize
        image frame orientations.
    ...
    def binarize_fixed(self, threshold : int) -> None:
        '''Effortlessly binarize the image using a predefined threshold with this
        intuitive method. Ideal for developers seeking to convert images into binary form,
        simplifying them for further processing or analysis.
    ...
    def binarize_otsu(self) -> None:
        '''Perform binarization on the image using Otsu thresholding with this intuitive method.
        Ideal for developers seeking to automatically determine the optimal threshold for
        converting images into binary form, enhancing their clarity and suitability for further analysis.'''
        raise NotImplementedError()
    
    def grayscale(self) -> None:
        '''Easily transform the image into its grayscale representation with this intuitive method.
        Ideal for developers seeking to convert color images to grayscale, simplifying their
        visualization or analysis processes.'''
        raise NotImplementedError()
    ...
    def adjust_brightness(self, brightness : int) -> None:
        '''Easily adjust the ``brightness`` of the image with this intuitive method,
    ...
    def adjust_contrast(self, contrast : float) -> None:
        '''Enhance the contrast of the :py:class:`aspose.imaging.Image`
        to make details stand out with this intuitive method. Ideal for developers
        seeking to improve the visual clarity and impact of their images dynamically.
    ...
    def filter(self, rectangle : aspose.imaging.Rectangle, options : aspose.imaging.imagefilters.filteroptions.FilterOptionsBase) -> None:
        '''Effortlessly apply filters to the specified rectangle of the image with this
        intuitive method. Perfect for developers seeking to enhance or modify specific areas.
    ...
    def add_page(self, page : aspose.imaging.RasterImage) -> None:
        ...
        Perfect for developers seeking to expand the content of their image files dynamically.
        
        :param page: The page to add.'''
        raise NotImplementedError()
    
    def pop_frame_at(self, index : int) -> aspose.imaging.fileformats.apng.ApngFrame:
        ...
        of frames in their animations.
        
        :param index: The index.
        :returns: The removed APNG frame.'''
        raise NotImplementedError()
    
    def remove_frame_at(self, index : int) -> None:
    ...
    def remove_all_frames(self) -> None:
        '''Clear your frame collection by removing all frames with this intuitive method.
        Ideal for developers seeking to reset or refresh their animations.'''
        raise NotImplementedError()
    
    def set_default_image(self, image : aspose.imaging.RasterImage) -> None:
        ...
        the default image in their animations.
        
        :param image: The image.'''
        raise NotImplementedError()
    
    def reset_default_image(self) -> None:
        ...
        (it cannot be deleted using this method).'''
        raise NotImplementedError()
    ...
    def page_count(self) -> int:
        ...
        Ideal for developers needing quick access to page count information.'''
        raise NotImplementedError()
    
    @property
    def pages(self) -> List[aspose.imaging.Image]:
        '''Effortlessly access the pages of your image with this convenient property.
        Perfect for developers seeking quick and easy access to individual pages for manipulation.'''
        raise NotImplementedError()
    
    @property
    def num_plays(self) -> int:
        '''Effortlessly control the number of times your animation loops with this
        versatile property. Perfect for developers seeking precise control over
        animation behavior, with support for infinite looping in case of the
        value equals to 0.'''
        raise NotImplementedError()
    ...
    def default_frame_time(self) -> int:
        ...
        this flexible property. Perfect for developers seeking to customize frame timing
        efficiently in their animations.'''
        raise NotImplementedError()
    ...
    def interlaced(self) -> bool:
        '''Quickly determine whether this :py:class:`aspose.imaging.fileformats.png.PngImage` object is interlaced
