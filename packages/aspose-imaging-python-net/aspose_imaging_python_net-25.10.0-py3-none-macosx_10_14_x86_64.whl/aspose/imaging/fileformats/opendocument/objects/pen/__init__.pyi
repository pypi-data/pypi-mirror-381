...
class OdPen:
    ...
    @property
    def pen_style(self) -> aspose.imaging.fileformats.opendocument.objects.pen.OdPenStyle:
        '''Gets the pen style.'''
        raise NotImplementedError()
    
    @pen_style.setter
    def pen_style(self, value : aspose.imaging.fileformats.opendocument.objects.pen.OdPenStyle) -> None:
        '''Sets the pen style.'''
        raise NotImplementedError()
