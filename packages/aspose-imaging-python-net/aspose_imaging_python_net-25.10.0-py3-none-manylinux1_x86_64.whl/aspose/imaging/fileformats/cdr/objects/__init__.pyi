...
class CdrDocument(CdrObjectContainer):
    ...
    @clip_ids.setter
    def clip_ids(self, value : System.Collections.Generic.List`1[[System.Int16]]) -> None:
        '''Sets the clip ids.'''
        raise NotImplementedError()
...
class CdrOutline(CdrDictionaryItem):
    ...
    @dash_array.setter
    def dash_array(self, value : System.Collections.Generic.List`1[[System.Int32]]) -> None:
        '''Sets the dash array.'''
        raise NotImplementedError()
...
class CdrTransforms(CdrObject):
    ...
    @transforms.setter
    def transforms(self, value : System.Collections.Generic.List`1[[Aspose.Imaging.Matrix]]) -> None:
        '''Sets the transforms.'''
        raise NotImplementedError()
