...
class Jpeg2000Image(aspose.imaging.RasterCachedImage):
    ...
    def __init__(self, path : str) -> None:
        '''Start working with the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class by initializing a new
    ...
    @overload
    def __init__(self, path : str, bits_per_pixel : int) -> None:
        '''Get started easily with the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class by creating a new
    ...
    def __init__(self, stream : io._IOBase) -> None:
        '''Easily initialize a new instance of the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class by
    ...
    @overload
    def __init__(self, stream : io._IOBase, bits_per_pixel : int) -> None:
        '''Initialize a new instance of the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class with a stream to
    ...
    def __init__(self, width : int, height : int) -> None:
        '''Create a new instance of the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class, specifying the
    ...
    @overload
    def __init__(self, width : int, height : int, options : aspose.imaging.imageoptions.Jpeg2000Options) -> None:
        '''Instantiate a new :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` object, providing the width, height,
    ...
    @overload
    def __init__(self, width : int, height : int, bits_count : int) -> None:
        '''Create a new instance of the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class with parameters for
    ...
    def __init__(self, image : aspose.imaging.RasterImage) -> None:
        '''Instantiate a new :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class with a raster image. This
    ...
    @overload
    def __init__(self, raster_image : aspose.imaging.RasterImage, bits_per_pixel : int) -> None:
        '''Initialize a fresh :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` instance with a raster image and
    ...
    def create_from_file_with_bpp(path : str, bits_per_pixel : int) -> aspose.imaging.fileformats.jpeg2000.Jpeg2000Image:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class.
    ...
    @staticmethod
    def create_from_stream(stream : io._IOBase) -> aspose.imaging.fileformats.jpeg2000.Jpeg2000Image:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class.
    ...
    @staticmethod
    def create_from_stream_with_bpp(stream : io._IOBase, bits_per_pixel : int) -> aspose.imaging.fileformats.jpeg2000.Jpeg2000Image:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.jpeg2000.Jpeg2000Image` class.
    ...
    def bits_per_pixel(self) -> int:
        '''This property returns the depth of the image, measured in bits per pixel (bpp). It
        indicates the amount of color information stored in each pixel of the image.
        Understanding the image depth is crucial for determining the color fidelity and
        quality of the image. With this information, users can gauge the level of detail
    ...
    def file_format(self) -> aspose.imaging.FileFormat:
        '''Retrieve the format of the image file. This property provides information about the
        file format of the image. Utilize this property to determine the format of the
        image file programmatically, facilitating appropriate handling and processing based
    ...
    def raw_line_size(self) -> int:
        '''This property retrieves the size of a single line of raw image data in bytes. It
        indicates the amount of memory occupied by a single row of pixels in the image\'s
        raw data format. Understanding the raw line size is essential for tasks such as
        memory allocation, data manipulation, and image processing algorithms that operate
        on individual image lines.'''
        raise NotImplementedError()
    ...
    def horizontal_resolution(self) -> float:
        '''This property allows you to retrieve or modify the horizontal resolution of the
        :py:class:`aspose.imaging.RasterImage`, measured in pixels per inch (PPI). Adjusting this
        resolution can impact the size and quality of the image when printed or displayed.
        By setting the horizontal resolution, users can optimize the image for specific
        output devices or applications, ensuring the best possible visual results.'''
        raise NotImplementedError()
    ...
    def vertical_resolution(self) -> float:
        '''This property provides access to the vertical resolution of the
        :py:class:`aspose.imaging.RasterImage`, measured in pixels per inch (PPI). Modifying this
        resolution can affect the quality and size of the image when printed or displayed.
        By adjusting the vertical resolution, users can optimize the image for different
        output devices or applications, ensuring optimal visual rendering.'''
        raise NotImplementedError()
