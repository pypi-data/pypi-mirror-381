...
class BigTiffReader(aspose.imaging.fileformats.tiff.filemanagement.TiffStreamReader):
    '''The little endian BigTiff reader.'''
    
    @overload
    def __init__(self, data : List[int]) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.tiff.filemanagement.bigtiff.BigTiffReader` class.
...
class BigTiffReaderBE(aspose.imaging.fileformats.tiff.filemanagement.TiffBigEndianStreamReader):
    '''The big endian BigTiff stream writer.'''
    
    @overload
    def __init__(self, data : List[int]) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.tiff.filemanagement.bigtiff.BigTiffReaderBE` class.
...
class BigTiffWriter(aspose.imaging.fileformats.tiff.filemanagement.TiffStreamWriter):
...
class BigTiffWriterBE(aspose.imaging.fileformats.tiff.filemanagement.TiffBigEndianStreamWriter):
    '''The big endian BigTiff stream writer.'''
    
    def __init__(self, writer : aspose.imaging.StreamContainer) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.tiff.filemanagement.bigtiff.BigTiffWriterBE` class.
