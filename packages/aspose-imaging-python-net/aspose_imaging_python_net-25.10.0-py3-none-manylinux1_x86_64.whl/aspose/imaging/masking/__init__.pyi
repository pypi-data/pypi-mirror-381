...
class ImageMasking:
    ...
    def __init__(self, source_image : aspose.imaging.RasterImage) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.masking.ImageMasking` class.
        
        :param source_image: The source image.'''
        raise NotImplementedError()
    
    @overload
    def load_session(self, stream : io._IOBase) -> aspose.imaging.masking.IMaskingSession:
    ...
    @staticmethod
    def apply_mask(target_image : aspose.imaging.RasterImage, mask : aspose.imaging.RasterImage, masking_options : aspose.imaging.masking.options.MaskingOptions) -> None:
    ...
    def load_session_from_stream(self, stream : io._IOBase) -> aspose.imaging.masking.IMaskingSession:
        '''Load the session from the specified stream.
