...
class WatermarkRemover:
    ...
    @staticmethod
    def paint_over(source : aspose.imaging.RasterImage, options : aspose.imaging.watermark.options.WatermarkOptions) -> aspose.imaging.RasterImage:
        '''Remove the watermark from the raster image.
        
        :param source: The source raster image.
