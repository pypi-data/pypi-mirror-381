...
class DitheringMode:
    ...
    @property
    def method(self) -> aspose.imaging.DitheringMethod:
        '''Dithering algorithm selection.'''
        raise NotImplementedError()
    
    @method.setter
    def method(self, value : aspose.imaging.DitheringMethod) -> None:
        '''Dithering algorithm selection.'''
        raise NotImplementedError()
    ...
    @property
    def custom_palette(self) -> aspose.imaging.IColorPalette:
        '''The custom palette for dithering.'''
        raise NotImplementedError()
    
    @custom_palette.setter
    def custom_palette(self, value : aspose.imaging.IColorPalette) -> None:
        '''The custom palette for dithering.'''
        raise NotImplementedError()
