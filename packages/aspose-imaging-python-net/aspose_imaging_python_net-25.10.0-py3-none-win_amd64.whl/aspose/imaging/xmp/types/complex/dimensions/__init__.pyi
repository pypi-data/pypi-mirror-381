...
class Dimensions(aspose.imaging.xmp.types.complex.ComplexTypeBase):
    '''Containing dimensions for a drawn object.'''
    
    @overload
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.xmp.types.complex.dimensions.Dimensions` class.'''
