...
class XmpBasicPackage(aspose.imaging.xmp.XmpPackage):
    ...
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.xmp.schemas.xmpbaseschema.XmpBasicPackage` class.'''
    ...
    def set_created_date_str(self, created_date : str) -> None:
        '''Adds resource created date.
    ...
    def set_metadata_date_str(self, metadata_date : str) -> None:
        '''Adds metadata last changed date.
        
        :param metadata_date: Metadata date.'''
        raise NotImplementedError()
    
    def set_modify_date_str(self, modified_date : str) -> None:
        '''Adds resource last modified date.
