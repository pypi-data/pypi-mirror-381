...
class BitmapCoreHeader:
    ...
    @bitmap_width.setter
    def bitmap_width(self, value : int) -> None:
        '''Sets bitmap width.'''
        raise NotImplementedError()
    ...
    def bitmap_height(self, value : int) -> None:
        '''Sets bitmap height.'''
        raise NotImplementedError()
    ...
    def bitmap_planes(self, value : int) -> None:
    ...
    @property
    def BITMAP_CORE_HEADER_SIZE(self) -> int:
        '''The BITMAPCOREHEADER aka OS21XBITMAPHEADER header size'''
        raise NotImplementedError()

    @property
    def OS_22X_BITMAP_HEADER_SIZE(self) -> int:
        '''The bitmap core header2 size'''
        raise NotImplementedError()

    @property
    def OS_22X_BITMAP_HEADER_FULL_SIZE(self) -> int:
        '''The bitmap core header2 size'''
        raise NotImplementedError()

    @property
    def BITMAP_INFO_HEADER_SIZE(self) -> int:
        '''The bitmap information header size v3'''
        raise NotImplementedError()

    @property
    def BITMAP_INFO_HEADER_SIZE_V2(self) -> int:
        '''The bitmap information header size v2'''
        raise NotImplementedError()

    @property
    def BITMAP_INFO_HEADER_SIZE_V3(self) -> int:
        '''The bitmap information header size v3'''
        raise NotImplementedError()

    @property
    def BITMAP_INFO_HEADER_SIZE_V4(self) -> int:
        '''The bitmap information header size v4'''
        raise NotImplementedError()

    @property
    def BITMAP_INFO_HEADER_SIZE_V5(self) -> int:
...
class BitmapInfoHeader(BitmapCoreHeader):
    ...
    def bitmap_compression(self, value : int) -> None:
    ...
    def bitmap_image_size(self, value : int) -> None:
    ...
    def bitmap_x_pels_per_meter(self, value : int) -> None:
    ...
    def bitmap_y_pels_per_meter(self, value : int) -> None:
    ...
    def bitmap_colors_used(self, value : int) -> None:
    ...
    def bitmap_colors_important(self, value : int) -> None:
        '''Sets number of important palette colors.'''
        raise NotImplementedError()
    
    @property
    def extra_bit_masks(self) -> List[int]:
        '''Gets the extra bit masks.
        Present only in case the DIB header is the BITMAPINFOHEADER and the :py:attr:`aspose.imaging.fileformats.bmp.BitmapInfoHeader.bitmap_compression` is set to either :py:attr:`aspose.imaging.fileformats.bmp.BitmapCompression.BITFIELDS` (RGB) or :py:attr:`aspose.imaging.fileformats.bmp.BitmapCompression.ALPHA_BITFIELDS` (RGBA).'''
        raise NotImplementedError()
    
    @extra_bit_masks.setter
    def extra_bit_masks(self, value : List[int]) -> None:
        '''Sets the extra bit masks.
        Present only in case the DIB header is the BITMAPINFOHEADER and the :py:attr:`aspose.imaging.fileformats.bmp.BitmapInfoHeader.bitmap_compression` is set to either :py:attr:`aspose.imaging.fileformats.bmp.BitmapCompression.BITFIELDS` (RGB) or :py:attr:`aspose.imaging.fileformats.bmp.BitmapCompression.ALPHA_BITFIELDS` (RGBA).'''
        raise NotImplementedError()
...
class BitmapV4Header(BitmapInfoHeader):
    ...
    def red_mask(self) -> int:
        '''Gets the color mask that specifies the red component of each pixel, valid only if bV4Compression is set to BI_BITFIELDS.'''
        raise NotImplementedError()
    
    @red_mask.setter
    def red_mask(self, value : int) -> None:
        '''Sets the color mask that specifies the red component of each pixel, valid only if bV4Compression is set to BI_BITFIELDS.'''
        raise NotImplementedError()
    
    @property
    def green_mask(self) -> int:
        '''Gets the color mask that specifies the green component of each pixel, valid only if bV4Compression is set to BI_BITFIELDS.'''
        raise NotImplementedError()
    
    @green_mask.setter
    def green_mask(self, value : int) -> None:
        '''Sets the color mask that specifies the green component of each pixel, valid only if bV4Compression is set to BI_BITFIELDS.'''
        raise NotImplementedError()
    
    @property
    def blue_mask(self) -> int:
        '''Gets the color mask that specifies the blue component of each pixel, valid only if bV4Compression is set to BI_BITFIELDS.'''
        raise NotImplementedError()
    
    @blue_mask.setter
    def blue_mask(self, value : int) -> None:
        '''Sets the color mask that specifies the blue component of each pixel, valid only if bV4Compression is set to BI_BITFIELDS.'''
        raise NotImplementedError()
    
    @property
    def alpha_mask(self) -> int:
        '''Gets the color mask that specifies the alpha component of each pixel.'''
        raise NotImplementedError()
    
    @alpha_mask.setter
    def alpha_mask(self, value : int) -> None:
        '''Sets the color mask that specifies the alpha component of each pixel.'''
        raise NotImplementedError()
    
    @property
    def cs_type(self) -> int:
        '''Gets the color space of the DIB.'''
        raise NotImplementedError()
    
    @cs_type.setter
    def cs_type(self, value : int) -> None:
        '''Sets the color space of the DIB.'''
        raise NotImplementedError()
    ...
    @endpoints.setter
    def endpoints(self, value : aspose.imaging.fileformats.bmp.structures.CieCoordinatesTriple) -> None:
    ...
    def gamma_green(self) -> int:
        '''Gets the gamma green.'''
        raise NotImplementedError()
    
    @gamma_green.setter
    def gamma_green(self, value : int) -> None:
        '''Sets the gamma green.'''
        raise NotImplementedError()
...
class BitmapV5Header(BitmapV4Header):
    ...
    @intent.setter
    def intent(self, value : int) -> None:
    ...
    @profile_data.setter
    def profile_data(self, value : int) -> None:
    ...
    @profile_size.setter
    def profile_size(self, value : int) -> None:
...
class BmpImage(aspose.imaging.RasterCachedImage):
    ...
    def __init__(self, path : str) -> None:
        ...
        running with :py:class:`aspose.imaging.fileformats.bmp.BmpImage` objects quickly and efficiently.
        
        :param path: The path to load image from and initialize pixel and palette data with.'''
        raise NotImplementedError()
    
    @overload
    def __init__(self, path : str, bits_per_pixel : int, compression : aspose.imaging.fileformats.bmp.BitmapCompression, horizontal_resolution : float, vertical_resolution : float) -> None:
        '''Effortlessly create a new instance of the  :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class with this constructor,
    ...
    def __init__(self, stream : io._IOBase) -> None:
        '''Begin using the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class effortlessly by initializing a new instance
    ...
    @overload
    def __init__(self, stream : io._IOBase, bits_per_pixel : int, compression : aspose.imaging.fileformats.bmp.BitmapCompression, horizontal_resolution : float, vertical_resolution : float) -> None:
        '''Start working with the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class seamlessly by creating
    ...
    def __init__(self, raster_image : aspose.imaging.RasterImage) -> None:
        '''Effortlessly create a new instance of the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class
    ...
    @overload
    def __init__(self, raster_image : aspose.imaging.RasterImage, bits_per_pixel : int, compression : aspose.imaging.fileformats.bmp.BitmapCompression, horizontal_resolution : float, vertical_resolution : float) -> None:
        '''Start working with the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class seamlessly by creating a new instance
    ...
    def __init__(self, width : int, height : int) -> None:
        '''Start using the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class effortlessly by creating a new instance
    ...
    @overload
    def __init__(self, width : int, height : int, bits_per_pixel : int, palette : aspose.imaging.IColorPalette) -> None:
        '''Begin using the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class seamlessly by initializing a new instance
    ...
    @overload
    def __init__(self, width : int, height : int, bits_per_pixel : int, palette : aspose.imaging.IColorPalette, compression : aspose.imaging.fileformats.bmp.BitmapCompression, horizontal_resolution : float, vertical_resolution : float) -> None:
        '''Effortlessly create a new instance of the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class with this constructor,
    ...
    def set_resolution(self, dpi_x : float, dpi_y : float) -> None:
        '''Adjust the resolution of your :py:class:`aspose.imaging.RasterImage` effortlessly with this
    ...
    def create_from_file_with_params(path : str, bits_per_pixel : int, compression : aspose.imaging.fileformats.bmp.BitmapCompression, horizontal_resolution : float, vertical_resolution : float) -> aspose.imaging.fileformats.bmp.BmpImage:
        ...
        a quick and efficient way to incorporate :py:class:`aspose.imaging.fileformats.bmp.BmpImage` objects into their projects.
    ...
    @staticmethod
    def create_from_stream(stream : io._IOBase) -> aspose.imaging.fileformats.bmp.BmpImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class.
        
        :param stream: The stream to load image from and initialize pixel and palette data with.'''
        raise NotImplementedError()
    
    @staticmethod
    def create_from_stream_with_params(stream : io._IOBase, bits_per_pixel : int, compression : aspose.imaging.fileformats.bmp.BitmapCompression, horizontal_resolution : float, vertical_resolution : float) -> aspose.imaging.fileformats.bmp.BmpImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.bmp.BmpImage` class.
    ...
    def horizontal_resolution(self) -> float:
        ...
        measured in pixels per inch, of the :py:class:`aspose.imaging.RasterImage` object. Ideal for
    ...
    def vertical_resolution(self) -> float:
        ...
        of this :py:class:`aspose.imaging.RasterImage` object with this property. Perfect for developers requiring
