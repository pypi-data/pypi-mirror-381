...
class PngImage(aspose.imaging.RasterCachedImage):
    ...
    Grayscale, Indexed Color, TrueColor, and alpha channels. Seamlessly process XMP metadata,
    enabling comprehensive image metadata management, while easily loading PNG images,
    performing diverse manipulations, applying filters, and converting images to other file
    formats for optimal versatility and customization.'''
    
    @overload
    def __init__(self, width : int, height : int) -> None:
        '''Initialize a new object of the :py:class:`aspose.imaging.fileformats.png.PngImage` class by providing the
    ...
    def __init__(self, path : str) -> None:
        '''Constructs a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class using the path
    ...
    def __init__(self, raster_image : aspose.imaging.RasterImage) -> None:
        '''Creates a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class by providing a raster
    ...
    @overload
    def __init__(self, path : str, color_type : aspose.imaging.fileformats.png.PngColorType) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class by specifying the
    ...
    @overload
    def __init__(self, raster_image : aspose.imaging.RasterImage, color_type : aspose.imaging.fileformats.png.PngColorType) -> None:
        '''Creates a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class by specifying a
    ...
    def __init__(self, stream : io._IOBase) -> None:
        '''Creates a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class by initializing it
    ...
    @overload
    def __init__(self, width : int, height : int, color_type : aspose.imaging.fileformats.png.PngColorType) -> None:
        '''Instantiate a fresh instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class, specifying
    ...
    @overload
    def __init__(self, png_options : aspose.imaging.imageoptions.PngOptions, width : int, height : int) -> None:
        '''Initialize a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class, incorporating
    ...
    @staticmethod
    def create_with_width_height(width : int, height : int) -> aspose.imaging.fileformats.png.PngImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class.
    ...
    @staticmethod
    def create_from_image(raster_image : aspose.imaging.RasterImage) -> aspose.imaging.fileformats.png.PngImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class.
    ...
    @staticmethod
    def create_from_file_with_color_type(path : str, color_type : aspose.imaging.fileformats.png.PngColorType) -> aspose.imaging.fileformats.png.PngImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class.
    ...
    @staticmethod
    def create_from_image_with_color_type(raster_image : aspose.imaging.RasterImage, color_type : aspose.imaging.fileformats.png.PngColorType) -> aspose.imaging.fileformats.png.PngImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class.
    ...
    @staticmethod
    def create_from_stream(stream : io._IOBase) -> aspose.imaging.fileformats.png.PngImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class.
    ...
    @staticmethod
    def create_with_width_height_color_type(width : int, height : int, color_type : aspose.imaging.fileformats.png.PngColorType) -> aspose.imaging.fileformats.png.PngImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class.
    ...
    @staticmethod
    def create_with_width_height_options(png_options : aspose.imaging.imageoptions.PngOptions, width : int, height : int) -> aspose.imaging.fileformats.png.PngImage:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.png.PngImage` class.
    ...
    def file_format(self) -> aspose.imaging.FileFormat:
        '''Retrieves the format of the file associated with the image instance. This
        property provides essential information regarding the file type, enabling
        efficient handling and processing based on the specific format requirements.'''
        raise NotImplementedError()
    ...
    def raw_data_format(self) -> aspose.imaging.PixelDataFormat:
        '''Accesses the raw data format of the image. This property provides insight into
        how the image data is structured internally, which can be useful for advanced
        image processing tasks or format conversion.'''
        raise NotImplementedError()
    ...
    def horizontal_resolution(self) -> float:
        '''Retrieve or modify the horizontal resolution of the image. This property
        represents the number of pixels per inch along the horizontal axis of the
        image. Adjusting this resolution can affect the physical size of the image when
    ...
    def has_alpha(self) -> bool:
        ...
        which determines its transparency. This property is useful for applications
        that need to handle transparency, allowing developers to determine whether
        additional processing is required to handle transparent areas in the image.'''
        raise NotImplementedError()
    ...
    def interlaced(self) -> bool:
        '''Retrieves a boolean value indicating whether the :py:class:`aspose.imaging.fileformats.png.PngImage` is
    ...
    def is_interlaced(self) -> bool:
        '''Returns a boolean value indicating if the image instance is interlaced. This
        property is crucial for optimizing loading strategies and ensuring efficient
        performance during image processing or display tasks.'''
        raise NotImplementedError()
    

class PngColorType(enum.Enum):
    GRAYSCALE = enum.auto()
