...
class IcoImage(aspose.imaging.RasterCachedMultipageImage):
    ...
    @overload
    def __init__(self, width : int, height : int, options : aspose.imaging.imageoptions.IcoOptions) -> None:
        '''Start ICO image creation effortlessly using the :py:class:`aspose.imaging.fileformats.ico.IcoImage` class. This
        ...
        :param options: The ICO creation options.'''
        raise NotImplementedError()
    
    @overload
    def __init__(self, image : aspose.imaging.Image, ico_options : aspose.imaging.imageoptions.IcoOptions) -> None:
        '''Crafted for simplicity and efficiency, the :py:class:`aspose.imaging.fileformats.ico.IcoImage` class empowers
        ...
        :py:class:`aspose.imaging.fileformats.ico.IcoImage` class simplifies ICO image management, allowing you to focus
        on delivering exceptional experiences.
        
        :param image: The image.
        :param ico_options: The ICO options.'''
        raise NotImplementedError()
    ...
    def add_page(self, page : aspose.imaging.RasterImage) -> None:
        ...
        :py:class:`aspose.imaging.imageoptions.IcoOptions`. This method seamlessly incorporates raster images into
    ...
    @overload
    def add_page(self, page : aspose.imaging.Image) -> None:
        '''Enrich your ICO image effortlessly by inserting an image page entry using the default
        settings from :py:class:`aspose.imaging.imageoptions.IcoOptions`. This method conveniently converts the
    ...
    @overload
    def add_page(self, page : aspose.imaging.Image, ico_options : aspose.imaging.imageoptions.IcoOptions) -> None:
        '''Diversify your ICO image effortlessly by integrating an image entry tailored to
        your needs with the specified :py:class:`aspose.imaging.imageoptions.IcoOptions`. This method seamlessly
    ...
    def add_raster_page(self, page : aspose.imaging.RasterImage) -> None:
        '''Adds an image entry to the ICO image according to default :py:class:`aspose.imaging.imageoptions.IcoOptions` as 32-bit PNG.
    ...
    def remove_page(self, index : int) -> None:
        ...
        designated :link:`index` within the file. This method provides precise
        control over your image composition, allowing you to refine your ICO file with ease.
    ...
    def file_format(self) -> aspose.imaging.FileFormat:
        ...
        integration into your workflow. By using this property, you gain access to critical
        information about the format of your file, ensuring compatibility and efficient processing.'''
        raise NotImplementedError()
    ...
    def has_alpha(self) -> bool:
        '''Determine whether alpha channel is present in this instance with this property. It
        offers a quick way to check if the image or document contains an alpha channel,
        which is crucial for various image processing and rendering tasks. Ideal for
        ensuring compatibility and handling transparency effects in images or documents.'''
        raise NotImplementedError()
    ...
    def page_count(self) -> int:
        ...
        property. By invoking this property, you effortlessly retrieve the total number of
        pages contained within the file.'''
        raise NotImplementedError()
    ...
    def pages(self) -> List[aspose.imaging.Image]:
        ...
        this property. By accessing this property, you gain access to a collection or array
        containing all the pages present within the document.'''
        raise NotImplementedError()
