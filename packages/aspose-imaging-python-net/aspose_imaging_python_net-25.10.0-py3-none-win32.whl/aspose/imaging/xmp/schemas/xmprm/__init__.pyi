...
class XmpRightsManagementPackage(aspose.imaging.xmp.XmpPackage):
    '''Represents XMP Rights Management namespace.'''
    
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.xmp.schemas.xmprm.XmpRightsManagementPackage` class.'''
    ...
    def set_marked_as_right_management(self, value : bool) -> None:
        '''Marks as right management content
        
        :param value: if set to ``true`` that this is a rights-managed resource.'''
        raise NotImplementedError()
    ...
    def set_usage_terms(self, usage_terms : aspose.imaging.xmp.LangAlt) -> None:
        '''Sets the usage terms.
        
        :param usage_terms: The usage terms.'''
        raise NotImplementedError()
    
    def set_web_statement(self, web_statement_url : str) -> None:
        '''Sets the web statement.
        
        :param web_statement_url: The web statement URL.'''
        raise NotImplementedError()
