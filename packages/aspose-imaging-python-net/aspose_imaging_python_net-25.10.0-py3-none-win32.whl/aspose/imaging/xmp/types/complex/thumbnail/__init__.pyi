...
class Thumbnail(aspose.imaging.xmp.types.complex.ComplexTypeBase):
    '''Represents thumbnail image for a file.'''
    
    @overload
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.xmp.types.complex.thumbnail.Thumbnail` class.'''
