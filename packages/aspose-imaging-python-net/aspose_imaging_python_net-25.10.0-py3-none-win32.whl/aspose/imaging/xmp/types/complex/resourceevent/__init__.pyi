...
class ResourceEvent(aspose.imaging.xmp.types.complex.ComplexTypeBase):
    '''Containing dimensions for a drawn object.'''
    
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.xmp.types.complex.resourceevent.ResourceEvent` class.'''
    ...
    @property
    def instance_id(self) -> System.Guid:
        '''Gets value of the xmpMM:InstanceId.'''
        raise NotImplementedError()
    
    @instance_id.setter
    def instance_id(self, value : System.Guid) -> None:
        '''Sets value of the xmpMM:InstanceId.'''
        raise NotImplementedError()
    ...
    @property
    def sofware_agent_name(self) -> str:
        '''Gets the software agent name.'''
        raise NotImplementedError()
    
    @sofware_agent_name.setter
    def sofware_agent_name(self, value : str) -> None:
        '''Sets the software agent name.'''
        raise NotImplementedError()
    ...
    @action_date.setter
    def action_date(self, value : datetime) -> None:
