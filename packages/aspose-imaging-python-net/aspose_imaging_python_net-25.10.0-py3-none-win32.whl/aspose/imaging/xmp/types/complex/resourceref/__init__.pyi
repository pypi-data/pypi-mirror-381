...
class ResourceRef(aspose.imaging.xmp.types.complex.ComplexTypeBase):
    '''Used to indicate prior versions, originals of renditions, originals for derived documents, and so on.'''
    
    def __init__(self) -> None:
        '''Initializes a new instance of the Aspose.Imaging.Xmp.Types.Complex class.'''
    ...
    @document_uri.setter
    def document_uri(self, value : str) -> None:
        '''Sets the document URI.'''
        raise NotImplementedError()
    
    @property
    def file_path_uri(self) -> str:
        '''Gets the file path URI.'''
        raise NotImplementedError()
    
    @file_path_uri.setter
    def file_path_uri(self, value : str) -> None:
        '''Sets the file path URI.'''
        raise NotImplementedError()
