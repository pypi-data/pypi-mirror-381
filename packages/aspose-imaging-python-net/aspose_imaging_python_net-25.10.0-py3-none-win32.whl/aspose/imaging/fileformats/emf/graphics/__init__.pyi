...
class EmfRecorderGraphics2D(MetafileRecorderGraphics2D):
    '''The Emf recorder graphics'''
    
    def __init__(self, frame : aspose.imaging.Rectangle, device_size : aspose.imaging.Size, device_size_mm : aspose.imaging.Size) -> None:
        '''Initializes a new instance of the :py:class:`aspose.imaging.fileformats.emf.graphics.EmfRecorderGraphics2D` class.
        
        :param frame: The frame.
        :param device_size: Size of the device.
        :param device_size_mm: The device size mm.'''
    ...
    def end_recording(self) -> aspose.imaging.fileformats.emf.EmfImage:
        '''Ends the recording.
    ...
    @staticmethod
    def from_emf_image(emf_image : aspose.imaging.fileformats.emf.EmfImage) -> aspose.imaging.fileformats.emf.graphics.EmfRecorderGraphics2D:
        '''Gets an instance of the :py:class:`aspose.imaging.fileformats.emf.graphics.EmfRecorderGraphics2D` containing all records from the Emf image.
        
        :param emf_image: The Emf image to read records from.
        :returns: An instance of the :py:class:`aspose.imaging.fileformats.emf.graphics.EmfRecorderGraphics2D`'''
        raise NotImplementedError()
