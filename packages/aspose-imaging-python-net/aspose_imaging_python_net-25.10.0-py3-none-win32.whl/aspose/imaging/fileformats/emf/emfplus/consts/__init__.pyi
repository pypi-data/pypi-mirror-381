...
class EmfPlusImageEffectsIdentifiers:
    ...
    @property
    def BLUR_EFFECT_GUID(self) -> str:
        '''Specifies the blur effect.'''
        raise NotImplementedError()

    @property
    def BRIGHTNESS_CONTRAST_EFFECT_GUID(self) -> str:
        '''Specifies the brightness contrast effect.'''
        raise NotImplementedError()

    @property
    def COLOR_BALANCE_EFFECT_GUID(self) -> str:
        '''Specifies the color balance effect.'''
        raise NotImplementedError()

    @property
    def COLOR_CURVE_EFFECT_GUID(self) -> str:
        '''Specifies the color curve effect.'''
        raise NotImplementedError()

    @property
    def COLOR_LOOKUP_TABLE_EFFECT_GUID(self) -> str:
        '''Specifies the color lookup table effect.'''
        raise NotImplementedError()

    @property
    def COLOR_MATRIX_EFFECT_GUID(self) -> str:
        '''Specifies the color matrix effect.'''
        raise NotImplementedError()

    @property
    def HUE_SATURATION_LIGHTNESS_EFFECT_GUID(self) -> str:
        '''Specifies the hue saturation lightness effect.'''
        raise NotImplementedError()

    @property
    def LEVELS_EFFECT_GUID(self) -> str:
        '''Specifies the levels effect.'''
        raise NotImplementedError()

    @property
    def RED_EYE_CORRECTION_EFFECT_GUID(self) -> str:
        '''Specifies the red-eye correction effect.'''
        raise NotImplementedError()

    @property
    def SHARPEN_EFFECT_GUID(self) -> str:
        '''Specifies the sharpen effect.'''
        raise NotImplementedError()

    @property
    def TINT_EFFECT_GUID(self) -> str:
