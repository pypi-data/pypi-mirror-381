...
class OdImage(aspose.imaging.VectorMultipageImage):
    ...
    def bits_per_pixel(self) -> int:
        '''Retrieves the count of bits per pixel for the image. This property provides insight
        into the level of detail and color depth represented in the image, aiding in various
        image processing tasks and optimizations.'''
        raise NotImplementedError()
    ...
    def page_count(self) -> int:
        '''Retrieves the total count of pages within the image. This property is essential for
        applications managing multi-page images, enabling them to accurately determine the
        number of pages available for processing or display.'''
        raise NotImplementedError()
    ...
    def default_page(self) -> aspose.imaging.Image:
        '''Retrieves the default page associated with the image, providing essential access to
        the primary page within the image collection. This property streamlines navigation
        and manipulation of image data, enhancing the efficiency of software development
        workflows.'''
        raise NotImplementedError()
...
class OdgImage(OdImage):
    ...
    @overload
    def __init__(self, stream_container : aspose.imaging.StreamContainer, options : aspose.imaging.LoadOptions) -> None:
        '''Start a new creation of the :py:class:`aspose.imaging.fileformats.opendocument.OdgImage` class object with the
    ...
    def __init__(self, stream_container : aspose.imaging.StreamContainer) -> None:
        '''Crafted for seamless integration into software solutions, the :py:class:`aspose.imaging.fileformats.opendocument.OdgImage`
...
class OtgImage(OdImage):
    ...
    def __init__(self, stream_container : aspose.imaging.StreamContainer, load_options : aspose.imaging.LoadOptions) -> None:
        '''Initialize a new :py:class:`aspose.imaging.fileformats.opendocument.OtgImage` object by providing a stream container
    ...
    @overload
    def __init__(self, stream_container : aspose.imaging.StreamContainer) -> None:
        '''Create a new object of the :py:class:`aspose.imaging.fileformats.opendocument.OtgImage` class by supplying a stream
    ...
    def file_format(self) -> aspose.imaging.FileFormat:
        ...
        integration and manipulation of OTG files in their software systems.'''
        raise NotImplementedError()
