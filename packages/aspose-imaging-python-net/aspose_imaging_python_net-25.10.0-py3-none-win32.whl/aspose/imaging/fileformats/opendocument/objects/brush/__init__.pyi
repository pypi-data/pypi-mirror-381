...
class OdBrush:
    ...
    def clone(self) -> Any:
        ...
        :returns: The return new instance of source brush'''
        raise NotImplementedError()
    
    @property
    def brush_style(self) -> aspose.imaging.fileformats.opendocument.objects.brush.OdBrushStyle:
        '''Gets the style.'''
        raise NotImplementedError()
    

class OdGradientBrush(OdBrush):
    '''The gradient fill'''
    ...
    @property
    def gradient_style(self) -> aspose.imaging.fileformats.opendocument.enums.OdGradientStyle:
        '''Gets the gradient style.'''
        raise NotImplementedError()
    
    @gradient_style.setter
    def gradient_style(self, value : aspose.imaging.fileformats.opendocument.enums.OdGradientStyle) -> None:
    ...
    @start_color.setter
    def start_color(self, value : int) -> None:
    ...
    @end_color.setter
    def end_color(self, value : int) -> None:
        '''Sets the end color.'''
        raise NotImplementedError()
