...
class InterruptMonitor(IInterruptMonitor):
    '''Represents information about interruption.'''
    ...
    @staticmethod
    def set_thread_local_instance(value: aspose.imaging.multithreading.IInterruptMonitor) -> None:
        '''Gets the IInterruptMonitor instance which is unique for each thread.'''
    @property
    def thread_local_instance(self) -> aspose.imaging.multithreading.IInterruptMonitor:
