...
class TexasEthicsCommissionScraper(BaseScraper):
    ...
    async def scrape_texas_disclosures(self) -> List[TradingDisclosure]:
        ...
        try:
            ...
            texas_politicians = [
                "Greg Abbott", "Dan Patrick", "Dade Phelan", "Ken Paxton",
                "Glenn Hegar", "Sid Miller", "George P. Bush"
            ]
...
class NewYorkJCOPEScraper(BaseScraper):
    ...
    async def scrape_new_york_disclosures(self) -> List[TradingDisclosure]:
        ...
        try:
            ...
            ny_politicians = [
                "Kathy Hochul", "Antonio Delgado", "Carl Heastie", "Andrea Stewart-Cousins",
                "Letitia James", "Thomas DiNapoli", "Adrienne Harris"
            ]
...
class FloridaCommissionEthicsScraper(BaseScraper):
    ...
    async def scrape_florida_disclosures(self) -> List[TradingDisclosure]:
        ...
        try:
            ...
            fl_politicians = [
                "Ron DeSantis", "Jeanette Nuñez", "Ashley Moody", "Jimmy Patronis",
                "Nikki Fried", "Paul Renner", "Kathleen Passidomo"
            ]
...
class IllinoisEthicsScraper(BaseScraper):
    ...
    async def scrape_illinois_disclosures(self) -> List[TradingDisclosure]:
        ...
        try:
            ...
            il_politicians = [
                "J.B. Pritzker", "Juliana Stratton", "Kwame Raoul", "Susana Mendoza",
                "Mike Frerichs", "Jesse White", "Emanuel Chris Welch"
            ]
...
class PennsylvaniaEthicsScraper(BaseScraper):
    ...
    async def scrape_pennsylvania_disclosures(self) -> List[TradingDisclosure]:
        ...
        try:
            ...
            pa_politicians = [
                "Josh Shapiro", "Austin Davis", "Michelle Henry", "Stacy Garrity",
                "Al Schmidt", "Russell Redding", "Bryan Cutler"
            ]
...
class MassachusettsEthicsCommissionScraper(BaseScraper):
    ...
    async def scrape_massachusetts_disclosures(self) -> List[TradingDisclosure]:
        ...
        try:
            ...
            ma_politicians = [
                "Maura Healey", "Kim Driscoll", "Andrea Campbell", "Deb Goldberg",
                "Ron Mariano", "Karen Spilka", "William Galvin"
            ]
