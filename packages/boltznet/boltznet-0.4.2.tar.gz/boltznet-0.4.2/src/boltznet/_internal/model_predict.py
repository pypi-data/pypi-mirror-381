...
class baseSeqPredict:
    ...
    def plotSeqResponseByInds(self,inds=None, seqnames=None, annots=None, fig=None, tf_names=None, highlights=None, savefilename=None, title=None, maxN = 10, row_titles=None, dpi=300, perc_th=0.1, ranking_mode='full_sequence', **kwargs):
...
class baseGenomePredict(baseSeqPredict):
    ...
    def __genomewidePredict__(self):
        ...
        # now lets percentile the fullWinSum by making the average value 0 and the top value 1
