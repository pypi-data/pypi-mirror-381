...
class fileGenome(genome):
    ...
    def __init_annot__(self):
        '''Initialize the annotation on this genome from fasta file.  If we have a genbank file, the sequence and annots are loaded in __init_genome_seq__'''
    ...
    def __init_genome_seq__(self):
        '''Initialilze the genome sequence from fasta or genbank'''
