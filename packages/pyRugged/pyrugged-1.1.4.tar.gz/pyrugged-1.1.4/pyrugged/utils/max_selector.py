...
class MaxSelector(Selector):
    ...
    This selector considers NaN values correspond
    ...
    def select_first(self, v_1: float, v_2: float) -> bool:
        ...
        Returns
        -------
            result : true if 'v_1' is higher than 'v_2', or if 'v_2' is NaN

        """

        return (v_1 > v_2) or math.isnan(float(v_2))
