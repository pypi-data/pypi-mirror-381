...
"""Test of pyrugged Class Constants"""
...
class Constants:
    ...
    WGS84_EARTH_ANGULAR_VELOCITY = 7.292115e-5
    ...
    JPL_SSD_SUN_MERCURY_MASS_RATIO = 6023600

    # Sun/Mercury attraction coefficient (m³/s²).
    JPL_SSD_MERCURY_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_MERCURY_MASS_RATIO

    # Sun/Venus mass ratio: 408523.71.
    JPL_SSD_SUN_VENUS_MASS_RATIO = 408523.71

    # Sun/Venus attraction coefficient (m³/s²).
    JPL_SSD_VENUS_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_VENUS_MASS_RATIO

    # Sun/(Earth + Moon) mass ratio: 328900.56.
    JPL_SSD_SUN_EARTH_PLUS_MOON_MASS_RATIO = 328900.56

    # Sun/(Earth + Moon) attraction coefficient (m³/s²).
    JPL_SSD_EARTH_PLUS_MOON_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_EARTH_PLUS_MOON_MASS_RATIO

    # Earth/Moon mass ratio: 81.30059.
    JPL_SSD_EARTH_MOON_MASS_RATIO = 81.300596

    # Moon attraction coefficient (m³/s²).
    JPL_SSD_MOON_GM = JPL_SSD_EARTH_PLUS_MOON_GM / (1.0 + JPL_SSD_EARTH_MOON_MASS_RATIO)

    # Earth attraction coefficient (m³/s²).
    JPL_SSD_EARTH_GM = JPL_SSD_MOON_GM * JPL_SSD_EARTH_MOON_MASS_RATIO

    # Sun/(Mars system) mass ratio: 3098708.0.
    JPL_SSD_SUN_MARS_SYSTEM_MASS_RATIO = 3098708.0

    # Sun/(Mars system) attraction coefficient (m³/s²).
    JPL_SSD_MARS_SYSTEM_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_MARS_SYSTEM_MASS_RATIO

    # Sun/(Jupiter system) mass ratio: 1047.3486.
    JPL_SSD_SUN_JUPITER_SYSTEM_MASS_RATIO = 1047.3486

    # Sun/(Jupiter system) ttraction coefficient (m³/s²).
    JPL_SSD_JUPITER_SYSTEM_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_JUPITER_SYSTEM_MASS_RATIO

    # Sun/(Saturn system) mass ratio: 3497.898.
    JPL_SSD_SUN_SATURN_SYSTEM_MASS_RATIO = 3497.898

    # Sun/(Saturn system) attraction coefficient (m³/s²).
    JPL_SSD_SATURN_SYSTEM_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_SATURN_SYSTEM_MASS_RATIO

    # Sun/(Uranus system) mass ratio: 22902.98.
    JPL_SSD_SUN_URANUS_SYSTEM_MASS_RATIO = 22902.98

    # Sun/(Uranus system) attraction coefficient (m³/s²).
    JPL_SSD_URANUS_SYSTEM_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_URANUS_SYSTEM_MASS_RATIO

    # Sun/(Neptune system) mass ratio: 19412.24.
    JPL_SSD_SUN_NEPTUNE_SYSTEM_MASS_RATIO = 19412.24

    # Sun/(Neptune system) attraction coefficient (m³/s²).
    JPL_SSD_NEPTUNE_SYSTEM_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_NEPTUNE_SYSTEM_MASS_RATIO

    # Sun/(Pluto system) mass ratio: 1.35e8.
    JPL_SSD_SUN_PLUTO_SYSTEM_MASS_RATIO = 1.35e8

    # Sun/(Pluto system) ttraction coefficient (m³/s²).
    JPL_SSD_PLUTO_SYSTEM_GM = JPL_SSD_SUN_GM / JPL_SSD_SUN_PLUTO_SYSTEM_MASS_RATIO
