...
class FridayClient:
    ...
    def get_profile(self, profile_url: str, realtime: bool = False) -> dict:
        """
        Fetch and analyze a LinkedIn profile with caching support.
        
        Args:
            profile_url (str): LinkedIn profile URL to analyze
            realtime (bool, optional): If True, bypasses cache and fetches fresh data. Defaults to False.
            
        Returns:
            dict: Analyzed profile data with fields like name, headline, experience, education, etc.
        ...
        """
        return self._make_request("GET", "/profile", params={
