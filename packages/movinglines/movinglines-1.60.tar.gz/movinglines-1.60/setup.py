...
setup(
    ...
    zip_safe=False,
    install_requires=['numpy','geopy','scipy','pyephem','Pillow','cartopy<0.20.1','shapely<2.0.0','pykml','rasterio','gpxpy','bs4','xlwings','json_tricks','simplekml','matplotlib<3.6.0','owslib','ipdb','flightplandb','asyncio','pytz','pandas'],
    ...
    package_data={"": ["*.txt","*.tle","*.md","*.json","*.ico","*.tif","*.kmz",#]},
