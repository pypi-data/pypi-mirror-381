    ...
    def get_ocr_output(self, header_list: list, ticket: dict) -> dict:
        ...
        if 'determinations' in ticket:
            ...
            if len(vendor_doc_questions) > 1:
                raise Exception("Multiple vendor doc questions found")

            # value is equal to the item in vendor_doc_questions that matches ticket['key']
