...
class PredictionSet(BaseModel):
    ...
    associated_phenotypes: Optional[List[StrictStr]] = Field(default=None, description="Ontological terms for diseases or phenotypes associated with this prediction set.")
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['activity level', 'binding effect', 'functional effect', 'protein stability']):
            raise ValueError("must be one of enum values ('activity level', 'binding effect', 'functional effect', 'protein stability')")
        return value
