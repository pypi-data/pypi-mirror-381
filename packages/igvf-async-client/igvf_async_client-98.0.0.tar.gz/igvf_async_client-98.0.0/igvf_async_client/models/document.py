...
class Document(BaseModel):
    ...
    standardized_file_format: Optional[StrictBool] = Field(default=None, description="Specifies whether this format is an IGVF-standardized file format defined by Focus Groups or produced by a uniform pipeline.")
    id: Optional[StrictStr] = Field(default=None, alias="@id")
    type: Optional[List[StrictStr]] = Field(default=None, alias="@type")
    summary: Optional[StrictStr] = Field(default=None, description="A summary of the document.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "status", "lab", "award", "attachment", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "document_type", "characterization_method", "urls", "standardized_file_format", "@id", "@type", "summary"]
    ...
    def document_type_validate_enum(cls, value):
        ...
        if value not in set(['cell fate change protocol', 'characterization', 'computational protocol', 'experimental protocol', 'file format specification', 'image', 'library structure seqspec', 'model source data', 'pipeline log', 'pipeline parameters', 'plate map', 'plasmid map', 'plasmid sequence', 'quality control report', 'standards']):
            raise ValueError("must be one of enum values ('cell fate change protocol', 'characterization', 'computational protocol', 'experimental protocol', 'file format specification', 'image', 'library structure seqspec', 'model source data', 'pipeline log', 'pipeline parameters', 'plate map', 'plasmid map', 'plasmid sequence', 'quality control report', 'standards')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "urls": obj.get("urls"),
            "standardized_file_format": obj.get("standardized_file_format"),
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
