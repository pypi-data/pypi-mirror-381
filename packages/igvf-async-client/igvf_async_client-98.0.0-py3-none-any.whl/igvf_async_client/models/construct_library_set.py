...
class ConstructLibrarySet(BaseModel):
    ...
    control_types: Optional[List[StrictStr]] = Field(default=None, description="The types of control this construct library set set represents.")
    ...
    samples: Optional[List[StrictStr]] = Field(default=None, description="The samples this construct library set was applied to.")
    file_sets: Optional[List[StrictStr]] = Field(default=None, description="The file sets that used this construct library set.")
    preferred_assay_titles: Optional[List[StrictStr]] = Field(default=None, description="The preferred assay titles of the file sets that used this construct library set.")
    ...
    def collections_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['ACMG73', 'Benchmark', 'ClinGen', 'ENCODE', 'GREGoR', 'IGVF_catalog_beta_v0.1', 'IGVF_catalog_beta_v0.2', 'IGVF_catalog_beta_v0.3', 'IGVF_catalog_beta_v0.4', 'IGVF_catalog_beta_v0.5', 'IGVF_catalog_v1.0', 'IGVF phase 1', 'MaveDB', 'Morphic', 'MPRAbase', 'StanfordFCC', 'TF Perturb-seq Project', 'TOPMED Freeze 8', 'VarChAMP', 'Vista', 'Williams Syndrome Research']):
                raise ValueError("each list item must be one of ('ACMG73', 'Benchmark', 'ClinGen', 'ENCODE', 'GREGoR', 'IGVF_catalog_beta_v0.1', 'IGVF_catalog_beta_v0.2', 'IGVF_catalog_beta_v0.3', 'IGVF_catalog_beta_v0.4', 'IGVF_catalog_beta_v0.5', 'IGVF_catalog_v1.0', 'IGVF phase 1', 'MaveDB', 'Morphic', 'MPRAbase', 'StanfordFCC', 'TF Perturb-seq Project', 'TOPMED Freeze 8', 'VarChAMP', 'Vista', 'Williams Syndrome Research')")
        return value
    ...
    @field_validator('control_types')
    def control_types_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        for i in value:
            if i not in set(['reference transduction', 'non-targeting']):
                raise ValueError("each list item must be one of ('reference transduction', 'non-targeting')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "control_types": obj.get("control_types"),
            "scope": obj.get("scope"),
