...
class Item(BaseModel):
    ...
    # data type: IndexFile
    oneof_schema_12_validator: Optional[IndexFile] = None
    ...
    oneof_schema_40_validator: Optional[MpraQualityMetric] = None
    # data type: PerturbSeqQualityMetric
    oneof_schema_41_validator: Optional[PerturbSeqQualityMetric] = None
    # data type: SingleCellAtacSeqQualityMetric
    oneof_schema_42_validator: Optional[SingleCellAtacSeqQualityMetric] = None
    # data type: SingleCellRnaSeqQualityMetric
    oneof_schema_43_validator: Optional[SingleCellRnaSeqQualityMetric] = None
    # data type: StarrSeqQualityMetric
    oneof_schema_44_validator: Optional[StarrSeqQualityMetric] = None
    # data type: InVitroSystem
    oneof_schema_45_validator: Optional[InVitroSystem] = None
    # data type: MultiplexedSample
    oneof_schema_46_validator: Optional[MultiplexedSample] = None
    # data type: PrimaryCell
    oneof_schema_47_validator: Optional[PrimaryCell] = None
    # data type: TechnicalSample
    oneof_schema_48_validator: Optional[TechnicalSample] = None
    # data type: Tissue
    oneof_schema_49_validator: Optional[Tissue] = None
    # data type: WholeOrganism
    oneof_schema_50_validator: Optional[WholeOrganism] = None
    # data type: Software
    oneof_schema_51_validator: Optional[Software] = None
    # data type: SoftwareVersion
    oneof_schema_52_validator: Optional[SoftwareVersion] = None
    # data type: Source
    oneof_schema_53_validator: Optional[Source] = None
    # data type: Treatment
    oneof_schema_54_validator: Optional[Treatment] = None
    # data type: User
    oneof_schema_55_validator: Optional[User] = None
    # data type: Workflow
    oneof_schema_56_validator: Optional[Workflow] = None
