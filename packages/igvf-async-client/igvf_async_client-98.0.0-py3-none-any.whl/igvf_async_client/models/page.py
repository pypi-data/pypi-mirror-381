...
class Page(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "lab", "award", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "parent", "name", "title", "layout", "@id", "@type", "summary", "canonical_uri"]
