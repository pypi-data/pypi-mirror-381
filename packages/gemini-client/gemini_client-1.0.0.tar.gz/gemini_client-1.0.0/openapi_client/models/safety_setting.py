...
class SafetySetting(BaseModel):
    ...
    """ # noqa: E501
    category: StrictStr = Field(description="Required. The category for this setting.")
    threshold: StrictStr = Field(description="Required. Controls the probability threshold at which harm is blocked.")
    __properties: ClassVar[List[str]] = ["category", "threshold"]
