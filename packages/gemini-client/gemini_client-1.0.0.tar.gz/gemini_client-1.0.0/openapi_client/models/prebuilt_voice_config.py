...
class PrebuiltVoiceConfig(BaseModel):
    ...
    """ # noqa: E501
    voice_name: Optional[StrictStr] = Field(default=None, description="The name of the preset voice to use.", alias="voiceName")
    __properties: ClassVar[List[str]] = ["voiceName"]
