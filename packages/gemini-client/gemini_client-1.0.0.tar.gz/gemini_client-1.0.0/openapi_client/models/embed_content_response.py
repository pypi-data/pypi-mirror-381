...
class EmbedContentResponse(BaseModel):
    ...
    """ # noqa: E501
    embedding: Optional[ContentEmbedding] = Field(default=None, description="Output only. The embedding generated from the input content.")
    __properties: ClassVar[List[str]] = ["embedding"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "embedding": ContentEmbedding.from_dict(obj["embedding"]) if obj.get("embedding") is not None else None
        })
        return _obj
