...
class GenerateAnswerResponseInputFeedback(BaseModel):
    """
    ...
    """ # noqa: E501
    block_reason: Optional[StrictInt] = Field(default=None, description="Optional. If set, the input was blocked and no candidates are returned.  Rephrase the input.", alias="blockReason")
    safety_ratings: Optional[List[SafetyRating]] = Field(default=None, description="Ratings for safety of the input.  There is at most one rating per category.", alias="safetyRatings")
