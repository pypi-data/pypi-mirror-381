...
class MetadataFilter(BaseModel):
    ...
    """ # noqa: E501
    key: StrictStr = Field(description="Required. The key of the metadata to filter on.")
    conditions: List[Condition] = Field(description="Required. The `Condition`s for the given key that will trigger this filter.  Multiple `Condition`s are joined by logical ORs.")
    __properties: ClassVar[List[str]] = ["key", "conditions"]
