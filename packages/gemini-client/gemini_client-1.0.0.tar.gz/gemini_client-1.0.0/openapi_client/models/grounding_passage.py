...
class GroundingPassage(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identifier for the passage for attributing this passage in grounded  answers.")
    content: Optional[Content] = Field(default=None, description="Content of the passage.")
