...
class SpeakerVoiceConfig(BaseModel):
    ...
    """ # noqa: E501
    speaker: StrictStr = Field(description="Required. The name of the speaker to use. Should be the same as in the  prompt.")
    voice_config: VoiceConfig = Field(description="Required. The configuration for the voice to use.", alias="voiceConfig")
    __properties: ClassVar[List[str]] = ["speaker", "voiceConfig"]
