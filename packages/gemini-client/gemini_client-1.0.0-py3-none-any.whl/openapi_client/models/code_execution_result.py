...
class CodeExecutionResult(BaseModel):
    ...
    """ # noqa: E501
    outcome: StrictInt = Field(description="Required. Outcome of the code execution.")
    output: Optional[StrictStr] = Field(default=None, description="Optional. Contains stdout when code execution is successful, stderr or  other description otherwise.")
    __properties: ClassVar[List[str]] = ["outcome", "output"]
