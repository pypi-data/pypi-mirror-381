...
class BatchEmbedContentsResponse(BaseModel):
    ...
    """ # noqa: E501
    embeddings: Optional[List[ContentEmbedding]] = Field(default=None, description="Output only. The embeddings for each request, in the same order as provided  in the batch request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "embeddings": [ContentEmbedding.from_dict(_item) for _item in obj["embeddings"]] if obj.get("embeddings") is not None else None
        })
        return _obj
