...
class ExecutableCode(BaseModel):
    ...
    """ # noqa: E501
    language: StrictInt = Field(description="Required. Programming language of the `code`.")
    code: StrictStr = Field(description="Required. The code to be executed.")
    __properties: ClassVar[List[str]] = ["language", "code"]
