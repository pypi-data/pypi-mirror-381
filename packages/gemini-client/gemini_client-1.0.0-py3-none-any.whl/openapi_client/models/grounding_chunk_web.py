...
class GroundingChunkWeb(BaseModel):
    ...
    Chunk from the web.
    """ # noqa: E501
    uri: Optional[StrictStr] = Field(default=None, description="URI reference of the chunk.")
    title: Optional[StrictStr] = Field(default=None, description="Title of the chunk.")
    __properties: ClassVar[List[str]] = ["uri", "title"]
