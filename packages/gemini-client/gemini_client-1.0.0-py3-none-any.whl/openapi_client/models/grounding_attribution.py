...
class GroundingAttribution(BaseModel):
    ...
    """ # noqa: E501
    source_id: Optional[AttributionSourceId] = Field(default=None, description="Output only. Identifier for the source contributing to this attribution.", alias="sourceId")
    content: Optional[Content] = Field(default=None, description="Grounding source content that makes up this attribution.")
    __properties: ClassVar[List[str]] = ["sourceId", "content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sourceId": AttributionSourceId.from_dict(obj["sourceId"]) if obj.get("sourceId") is not None else None,
