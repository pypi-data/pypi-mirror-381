...
class FileData(BaseModel):
    ...
    URI based data.
    """ # noqa: E501
    mime_type: Optional[StrictStr] = Field(default=None, description="Optional. The IANA standard MIME type of the source data.", alias="mimeType")
    file_uri: StrictStr = Field(description="Required. URI.", alias="fileUri")
    __properties: ClassVar[List[str]] = ["mimeType", "fileUri"]
