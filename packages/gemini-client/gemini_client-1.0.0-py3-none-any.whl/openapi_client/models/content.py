...
class Content(BaseModel):
    ...
    """ # noqa: E501
    parts: Optional[List[Part]] = Field(default=None, description="Ordered `Parts` that constitute a single message. Parts may have different  MIME types.")
    role: Optional[StrictStr] = Field(default=None, description="Optional. The producer of the content. Must be either 'user' or 'model'.   Useful to set for multi-turn conversations, otherwise can be left blank  or unset.")
