...
class ModalityTokenCount(BaseModel):
    ...
    """ # noqa: E501
    modality: Optional[StrictStr] = Field(default=None, description="The modality associated with this token count.")
    token_count: Optional[StrictInt] = Field(default=None, description="Number of tokens.", alias="tokenCount")
    __properties: ClassVar[List[str]] = ["modality", "tokenCount"]
