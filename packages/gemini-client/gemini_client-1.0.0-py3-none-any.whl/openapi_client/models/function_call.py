...
class FunctionCall(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Optional. The unique id of the function call. If populated, the client to  execute the `function_call` and return the response with the matching `id`.")
    ...
    args: Optional[Dict[str, Any]] = Field(default=None, description="Optional. The function parameters and values in JSON object format.")
    __properties: ClassVar[List[str]] = ["id", "name", "args"]
