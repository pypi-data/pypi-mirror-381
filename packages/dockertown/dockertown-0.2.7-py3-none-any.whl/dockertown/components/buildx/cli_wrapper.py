...
from ...client_config import ClientConfig, DockerCLICaller, ReloadableObject
from ...components.image.cli_wrapper import Image, ImageCLI
from ...utils import (
    ValidPath,
    format_dict_for_cli,
    run,
...
from .imagetools.cli_wrapper import ImagetoolsCLI
from .models import BuilderInspectResult
...
class BuildxCLI(DockerCLICaller):
    ...
    def version(self) -> Dict:
        ...
        print(version)
        # {"source": "github.com/docker/buildx", "version": "0.4.2", "sha": "fb7b670b764764dc4716df3eba07ffdae4cc47b2"}
        ```
        """
