...
from pyqode.qt.QtCore import QTimer, Signal, QRegularExpression
from pyqode.qt.QtGui import QRegularExpressionValidator
...
class ChangeExtensionPanel(Panel):
    ...
    def _check(self):
        ...
        self._ext_edit.setValidator(QRegularExpressionValidator(QRegularExpression(r'\.\w+'), self))
