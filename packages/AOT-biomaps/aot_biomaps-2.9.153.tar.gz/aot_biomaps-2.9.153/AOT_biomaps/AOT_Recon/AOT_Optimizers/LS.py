...
def LS(
    ...
    return _LS_GPU_stable(SMatrix, y, numIterations, alpha, isSavingEachIteration, tumor_str)

def _LS_GPU_stable(SMatrix, y, numIterations, alpha, isSavingEachIteration, tumor_str):
    """
    ...
    for k in trange(numIterations, desc=description):
        ...
        if isSavingEachIteration and k % 100 == 0:
...
# Placeholder for other methods (raise NotImplementedError)
