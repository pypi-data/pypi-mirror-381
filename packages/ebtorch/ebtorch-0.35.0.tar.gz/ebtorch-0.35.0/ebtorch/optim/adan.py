...
#                      All Rights Reserved.
#                      [orig. work: https://arxiv.org/abs/2208.06677;
#                       orig. code: https://github.com/sail-sg/Adan]
#
# Copyright (c) 2022-* Garena Online Private Limited. All Rights Reserved.
#
    ...
    def step(self):
        ...
        if self.defaults["max_grad_norm"] > 0:
            ...
            clip_global_grad_norm = torch.clamp(
                max_grad_norm / (global_grad_norm + group["eps"]),  # skipcq: PYL-W0631
                max=1.0,
            )
        else:
