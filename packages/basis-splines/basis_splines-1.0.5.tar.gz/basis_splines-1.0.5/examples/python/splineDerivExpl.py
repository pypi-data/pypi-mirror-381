...
def main():
    ...
    # spline derivative (explicit transformation)
    basisDeriv = bs.Basis()  # create empty basis object
    trf = basis.derivative(basisDeriv)
    splines[1] = bs.Spline(basisDeriv, trf @ splines[0].getCoefficients())
