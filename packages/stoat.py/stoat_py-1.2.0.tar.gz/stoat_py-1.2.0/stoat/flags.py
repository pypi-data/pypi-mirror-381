...
class BotFlags(BaseFlags, support_kwargs=False):
    ...
    def official(cls) -> int:
        """:class:`bool`: Whether the bot is created by Stoat."""
        return 1 << 1
...
class UserBadges(BaseFlags, support_kwargs=True):
    ...
    def developer(cls) -> int:
        """:class:`bool`: Whether user is Stoat developer."""
        return 1 << 0

    @flag()
    def translator(cls) -> int:
        """:class:`bool`: Whether the user helped translate Stoat."""
        return 1 << 1

    @flag()
    def supporter(cls) -> int:
        """:class:`bool`: Whether the user monetarily supported Stoat."""
        return 1 << 2
    ...
    @flag()
    def founder(cls) -> int:
        """:class:`bool`: Whether the user is a Stoat founder."""
        return 1 << 4
