from wowool.portal.client.defines import WOWOOL_PORTAL_KEY_ENV_NAME, WOWOOL_PORTAL_HOST_DEFAULT, WOWOOL_PORTAL_HOST_ENV_NAME
...
class Portal:
    ...
    def __init__(self, api_key: str | None = None, host: str | None = None):
        self._api_key = resolve_variable(WOWOOL_PORTAL_KEY_ENV_NAME, api_key)
