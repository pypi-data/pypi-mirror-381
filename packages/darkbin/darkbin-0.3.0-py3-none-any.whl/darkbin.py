#!/usr/bin/env python3
"""
bin_info.py - BIN info & CC extractor with interactive menu

Features:
1. Lookup BIN info (pretty table / JSON)
2. Extract CCs from file in format CC|MM|YYYY|CVV
   - Filter by BIN (first 6 digits) and/or Country
   - Output preserves original line
   - Shows top 10 matched CCs and summary
3. Interactive menu with help instructions, including import usage
"""
    ...
    if choice == "1":
        ...
        help_text = textwrap.dedent("""
            ...
            [bold]1. Lookup BIN info:[/bold]
               - CLI: python3 bin_info.py -b <BIN|CardNumber>
            ...
            [bold]2. Extract CCs from file:[/bold]
               ...
               - CLI:
                 python3 bin_info.py -i input.txt -o output.txt [--filter-bin 512356] [--filter-country KZ]
            ...
            [bold]3. Import and use programmatically:[/bold]
               from bin_info import stormx_bininfo, extract_ccs_from_file, pretty_table
