...
class ChartChartOption(BaseModel):
    """
    ChartChartOption
    """ # noqa: E501
    id: Annotated[str, Field(min_length=1, strict=True)]
    type: Annotated[str, Field(min_length=1, strict=True)]
    chart_options: Optional[Dict[str, Any]] = Field(default=None, alias="chartOptions")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "chartOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "chartOptions": obj.get("chartOptions")
        })
