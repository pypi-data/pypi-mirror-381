...
class TestSuiteControllerTestSuiteBulkRequest(BaseModel):
    """
    TestSuiteControllerTestSuiteBulkRequest
    """ # noqa: E501
    ids: Annotated[List[TestSuiteControllerTestSuiteApiId], Field(min_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ids": [TestSuiteControllerTestSuiteApiId.from_dict(_item) for _item in obj["ids"]] if obj.get("ids") is not None else None
        })
