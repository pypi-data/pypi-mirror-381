...
class DailyExecutionStatistics(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of execution_counts
        if self.execution_counts:
            _dict['executionCounts'] = self.execution_counts.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "duration": DailyExecutionStatisticsDuration.from_dict(obj["duration"]) if obj.get("duration") is not None else None,
            "executionCounts": DailyExecutionStatisticsExecutionCounts.from_dict(obj["executionCounts"]) if obj.get("executionCounts") is not None else None,
