...
class IAMTenantAccessControllerApiRoleAssignment(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "permissions": [IAMTenantAccessControllerApiUserPermission.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None
        })
