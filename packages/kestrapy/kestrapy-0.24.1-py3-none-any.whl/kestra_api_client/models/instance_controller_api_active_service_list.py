...
class InstanceControllerApiActiveServiceList(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "services": [InstanceControllerApiActiveService.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
