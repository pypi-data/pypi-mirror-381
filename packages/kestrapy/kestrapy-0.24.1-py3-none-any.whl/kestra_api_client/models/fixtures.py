...
class Fixtures(BaseModel):
    ...
    tasks: Optional[List[TaskFixture]] = None
    trigger: Optional[TriggerFixture] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["inputs", "files", "tasks", "trigger"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "files": obj.get("files"),
            "tasks": [TaskFixture.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
            "trigger": TriggerFixture.from_dict(obj["trigger"]) if obj.get("trigger") is not None else None
        })
