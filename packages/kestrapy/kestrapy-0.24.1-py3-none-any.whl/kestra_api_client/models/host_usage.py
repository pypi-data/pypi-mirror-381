...
class HostUsage(BaseModel):
    ...
    hardware: Optional[HostUsageHardware] = None
    os: Optional[HostUsageOs] = None
    jvm: Optional[HostUsageJvm] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["uuid", "hardware", "os", "jvm"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of jvm
        if self.jvm:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "uuid": obj.get("uuid"),
            "hardware": HostUsageHardware.from_dict(obj["hardware"]) if obj.get("hardware") is not None else None,
            "os": HostUsageOs.from_dict(obj["os"]) if obj.get("os") is not None else None,
            "jvm": HostUsageJvm.from_dict(obj["jvm"]) if obj.get("jvm") is not None else None
        })
