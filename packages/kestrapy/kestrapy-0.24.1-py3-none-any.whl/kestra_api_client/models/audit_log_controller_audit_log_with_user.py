...
class AuditLogControllerAuditLogWithUser(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of audit_log
        if self.audit_log:
            _dict['auditLog'] = self.audit_log.to_dict()
