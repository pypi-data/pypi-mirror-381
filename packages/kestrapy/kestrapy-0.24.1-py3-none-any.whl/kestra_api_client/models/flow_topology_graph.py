...
class FlowTopologyGraph(BaseModel):
    """
    FlowTopologyGraph
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [FlowNode.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "edges": [FlowTopologyGraphEdge.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None
        })
