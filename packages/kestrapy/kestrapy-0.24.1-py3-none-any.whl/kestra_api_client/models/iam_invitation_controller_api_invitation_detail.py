...
class IAMInvitationControllerApiInvitationDetail(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "roles": [ApiRoleSummary.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None,
            "groups": [ApiGroupSummary.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
