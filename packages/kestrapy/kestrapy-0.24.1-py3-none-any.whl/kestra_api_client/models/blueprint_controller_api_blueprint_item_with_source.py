...
class BlueprintControllerApiBlueprintItemWithSource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "description", "includedTasks", "tags", "publishedAt", "source", "kind"]
