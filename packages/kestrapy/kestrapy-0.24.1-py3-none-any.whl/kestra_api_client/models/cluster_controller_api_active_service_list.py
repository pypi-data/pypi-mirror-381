...
class ClusterControllerApiActiveServiceList(BaseModel):
    """
    ClusterControllerApiActiveServiceList
    """ # noqa: E501
    total: Optional[StrictInt] = None
    services: Optional[List[ClusterControllerApiActiveService]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "services": [ClusterControllerApiActiveService.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None
        })
        return _obj
