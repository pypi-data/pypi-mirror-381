...
class ClusterControllerApiPluginVersionDetailsApiPluginClasses(BaseModel):
    """
    ClusterControllerApiPluginVersionDetailsApiPluginClasses
    """ # noqa: E501
    type: Optional[StrictStr] = None
    classes: Optional[List[ClusterControllerApiPluginVersionDetailsApiPluginClass]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "classes": [ClusterControllerApiPluginVersionDetailsApiPluginClass.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
        return _obj
