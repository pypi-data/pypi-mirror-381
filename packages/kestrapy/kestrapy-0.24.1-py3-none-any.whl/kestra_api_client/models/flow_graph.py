...
class FlowGraph(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": [AbstractGraph.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "edges": [FlowGraphEdge.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None,
            "clusters": [FlowGraphCluster.from_dict(_item) for _item in obj["clusters"]] if obj.get("clusters") is not None else None,
            "flowables": obj.get("flowables")
        })
