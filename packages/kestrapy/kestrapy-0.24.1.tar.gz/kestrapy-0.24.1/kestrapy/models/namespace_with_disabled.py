...
class NamespaceWithDisabled(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "deleted", "allowedTriggers", "storageIsolation", "secretIsolation", "description", "variables", "pluginDefaults", "allowedNamespaces", "workerGroup", "storageType", "storageConfiguration", "secretType", "secretReadOnly", "secretConfiguration", "outputsInInternalStorage", "disabled"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in allowed_triggers (list)
        _items = []
        if self.allowed_triggers:
            for _item_allowed_triggers in self.allowed_triggers:
                if _item_allowed_triggers:
                    _items.append(_item_allowed_triggers.to_dict())
            _dict['allowedTriggers'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allowedTriggers": [NamespaceAllowedTrigger.from_dict(_item) for _item in obj["allowedTriggers"]] if obj.get("allowedTriggers") is not None else None,
