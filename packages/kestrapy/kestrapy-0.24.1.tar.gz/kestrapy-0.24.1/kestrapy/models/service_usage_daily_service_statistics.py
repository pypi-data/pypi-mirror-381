...
class ServiceUsageDailyServiceStatistics(BaseModel):
    """
    ServiceUsageDailyServiceStatistics
    """ # noqa: E501
    type: Optional[StrictStr] = None
    values: Optional[List[ServiceUsageDailyStatistics]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "values": [ServiceUsageDailyStatistics.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
