...
class IAMServiceAccountControllerApiServiceAccountRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["groups", "name", "description", "superAdmin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [IAMServiceAccountControllerApiGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "name": obj.get("name"),
