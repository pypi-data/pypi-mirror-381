...
class InstanceControllerApiWorkerGroupList(BaseModel):
    """
    ApiWorkerGroupList.
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workerGroups": [InstanceControllerApiWorkerGroupItem.from_dict(_item) for _item in obj["workerGroups"]] if obj.get("workerGroups") is not None else None
        })
