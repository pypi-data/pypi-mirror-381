...
class InstanceControllerApiPluginVersionDetailsApiPluginClasses(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "classes": [InstanceControllerApiPluginVersionDetailsApiPluginClass.from_dict(_item) for _item in obj["classes"]] if obj.get("classes") is not None else None
        })
