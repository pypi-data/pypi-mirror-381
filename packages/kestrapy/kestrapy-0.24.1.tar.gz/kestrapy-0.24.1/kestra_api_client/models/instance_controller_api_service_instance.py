...
class InstanceControllerApiServiceInstance(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "state": obj.get("state"),
            "server": InstanceControllerApiServerInstance.from_dict(obj["server"]) if obj.get("server") is not None else None,
