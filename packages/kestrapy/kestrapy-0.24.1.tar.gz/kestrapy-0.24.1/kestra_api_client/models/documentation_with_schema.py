...
class DocumentationWithSchema(BaseModel):
    """
    DocumentationWithSchema
    """ # noqa: E501
    markdown: Optional[StrictStr] = None
    var_schema: Optional[PluginSchema] = Field(default=None, alias="schema")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["markdown", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schema": PluginSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None
        })
