...
class CreateSecurityIntegrationRequest(BaseModel):
    """
    Create SecurityIntegration Request
    """ # noqa: E501
    name: Annotated[str, Field(strict=True)] = Field(description="The name of security integration.")
    description: StrictStr = Field(description="The description of security integration.")
