...
class PatchOperationPath(BaseModel):
    """
    PatchOperationPath
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of value_path_expression
        if self.value_path_expression:
            _dict['valuePathExpression'] = self.value_path_expression.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "valuePathExpression": ValuePathExpression.from_dict(obj["valuePathExpression"]) if obj.get("valuePathExpression") is not None else None
        })
