...
class Backfill(BaseModel):
    ...
    current_date: Optional[datetime] = Field(default=None, alias="currentDate")
    paused: Optional[StrictBool] = None
    inputs: Optional[Dict[str, Dict[str, Any]]] = None
    labels: Optional[List[Label]] = None
    previous_next_execution_date: Optional[datetime] = Field(default=None, alias="previousNextExecutionDate")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["start", "end", "currentDate", "paused", "inputs", "labels", "previousNextExecutionDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "previousNextExecutionDate": obj.get("previousNextExecutionDate")
        })
