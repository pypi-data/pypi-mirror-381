...
class PagedResultsApiGroupSummary(BaseModel):
    """
    PagedResultsApiGroupSummary
    """ # noqa: E501
    results: List[ApiGroupSummary]
    total: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ApiGroupSummary.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "total": obj.get("total")
        })
