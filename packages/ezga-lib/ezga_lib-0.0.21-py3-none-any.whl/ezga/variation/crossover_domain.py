...
def crossover_field_stitch(
    *,
    ...
    def _xover(structA, structB):
        ...
        u_atoms = np.vstack([
            structA.AtomPositionManager.atomPositions_fractional,
            structB.AtomPositionManager.atomPositions_fractional
        ])  # shape (N, dim)
        ...
        plt.scatter(x[~maskA], y[~maskA], c="grey", s=30, alpha=0.4, label="Other atoms")
        plt.scatter(x[maskA], y[maskA], c="red", s=50, alpha=0.7, edgecolor="k", label="Near interface")
