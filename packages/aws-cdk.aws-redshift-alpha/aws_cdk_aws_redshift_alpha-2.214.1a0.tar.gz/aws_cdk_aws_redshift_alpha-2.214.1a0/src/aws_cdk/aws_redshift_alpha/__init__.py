...
class ClusterProps:
    def __init__(
        ...
        *,
        ...
        :param availability_zone_relocation: (experimental) Whether to enable relocation for an Amazon Redshift cluster between Availability Zones after the cluster is created. Default: - false
        ...
        :param resource_action: (experimental) The Amazon Redshift operation to be performed. Default: - no operation
    ...
    @builtins.property
    def maintenance_track_name(self) -> typing.Optional["MaintenanceTrackName"]:
        ...
        return typing.cast(typing.Optional["MaintenanceTrackName"], result)
...
@jsii.enum(jsii_type="@aws-cdk/aws-redshift-alpha.MaintenanceTrackName")
class MaintenanceTrackName(enum.Enum):
...
@jsii.enum(jsii_type="@aws-cdk/aws-redshift-alpha.ResourceAction")
class ResourceAction(enum.Enum):
    ...
    :stability: experimental
    '''
    FAILOVER_PRIMARY_COMPUTE = "FAILOVER_PRIMARY_COMPUTE"
...
class Table(
    ...
    def __init__(
        ...
        *,
        ...
        :param timeout: (experimental) Handler timeout duration. Valid values are between 1 second and 15 minutes. Default: - 1 minute
        :param cluster: (experimental) The cluster containing the database.
        :param database_name: (experimental) The name of the database.
        :param admin_user: (experimental) The secret containing credentials to a Redshift user with administrator privileges. Secret JSON schema: ``{ username: string; password: string }``. Default: - the admin secret is taken from the cluster
