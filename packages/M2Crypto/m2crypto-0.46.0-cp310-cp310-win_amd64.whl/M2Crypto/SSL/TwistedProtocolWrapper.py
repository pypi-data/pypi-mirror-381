...
def connectSSL(
    ...
    reactor: twisted.internet.reactor = twisted.internet.reactor,
...
def connectTCP(
    ...
    reactor: object = twisted.internet.reactor,
...
class TLSProtocolWrapper(ProtocolWrapper):
    ...
    def write(self, data: bytes) -> None:
        ...
        try:
            ...
            e.args = (
                m2.ssl_get_verify_result(self.ssl._ptr()),
                e.args[0],
            )
            raise e
    ...
    def connectionLost(self, reason: Union[str, bytes]) -> None:
        self.clear()
