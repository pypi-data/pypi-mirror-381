...
from nfsefoz import xml
from nfsefoz.utils import pkcs12_data
...
class NFSeAbrasf(BaseNFSe):
    ...
    def __init__(self, pfx_file=None, pfx_passwd=None, target='production'):
        ...
        self.ws_url = nfsefoz.ABRASF_WSURL[self.__api_version__][target]
...
class NFSeBetha(BaseNFSe):
    ...
    def __init__(self, pfx_file=None, pfx_passwd=None, target='production'):
        ...
        self.ws_url = nfsefoz.BETHA_WSURL[self.__api_version__][target]
