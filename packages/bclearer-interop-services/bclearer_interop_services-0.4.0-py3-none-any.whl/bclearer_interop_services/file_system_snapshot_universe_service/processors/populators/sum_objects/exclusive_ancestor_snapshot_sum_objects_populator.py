...
@run_and_log_function()
def populate_exclusive_ancestor_snapshot_sum_objects(
...
def __add_parent_to_child(
    ...
    add_bie_id_to_sum_dictionary_by_type(
        source_bie_objects_dictionary=parent_file_system_snapshot_object.exclusive_ancestor_sum_objects,
        target_sum_objects_dictionary=child_file_system_snapshot_object.exclusive_ancestor_sum_objects,
        direction=BieFileSystemSnapshotDomainTypes.ANCESTORS,
    )

    add_bie_id_to_sum_dictionary_by_type(
        source_bie_objects_dictionary=parent_file_system_snapshot_object.extended_objects,
        target_sum_objects_dictionary=child_file_system_snapshot_object.exclusive_ancestor_sum_objects,
        direction=BieFileSystemSnapshotDomainTypes.ANCESTORS,
    )
