...
class CreateStorageServiceRequest(BaseModel):
    ...
    description: Annotated[
        ...
        Field(None, description='Description of storage service entity.'),
    ]
    serviceType: storageService.StorageServiceType
    connection: Optional[storageService.StorageConnection] = None
    tags: Annotated[
        Optional[List[tagLabel.TagLabel]],
        Field(None, description='Tags for this Object Store Service.'),
    ]
    owners: Annotated[
        Optional[entityReferenceList.EntityReferenceList],
        Field(None, description='Owners of this object store service.'),
    ]
