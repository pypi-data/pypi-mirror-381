...
class CreateSecurityServiceRequest(BaseModel):
    ...
    description: Annotated[
        ...
        Field(None, description='Description of security service entity.'),
    ]
    serviceType: securityService.SecurityServiceType
    connection: Optional[securityService.SecurityConnection] = None
    tags: Annotated[
        Optional[List[tagLabel.TagLabel]],
        Field(None, description='Tags for this Security Service.'),
    ]
    owners: Annotated[
