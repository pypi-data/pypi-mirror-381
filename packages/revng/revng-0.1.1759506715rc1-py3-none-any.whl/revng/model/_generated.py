...
class StatementComment(StructBase, AllMixin):
    ...
    *if* we have a way to uniquely identify said statement.
    ...
    address set.
    """
    Location: "TypedList[MetaAddress]" = field(default=TypedListDescriptor(MetaAddress))
...
class DisassemblyConfiguration(StructBase, AllMixin):
    ...
    AddressStyle: "DisassemblyConfigurationAddressStyle" = field(
        metadata={
            "optional": True,
            "default_value": lambda: DisassemblyConfigurationAddressStyle(),
        },
        default_factory=lambda: DisassemblyConfigurationAddressStyle(),
    )
    ...
    ImmediateStyle: "DisassemblyConfigurationImmediateStyle" = field(
        metadata={
            "optional": True,
            "default_value": lambda: DisassemblyConfigurationImmediateStyle(),
        },
        default_factory=lambda: DisassemblyConfigurationImmediateStyle(),
    )
...
class PrimitiveType(Type, StructBase, AllMixin):
    ...
    """
    PrimitiveKind: "PrimitiveKind" = field(default=no_default)
...
class PointerType(Type, StructBase, AllMixin):
    ...
    """
    PointerSize: "int" = field(default=no_default)
    """The pointee type."""
    PointeeType: "Type" = field(default=no_default)
...
class ArrayType(Type, StructBase, AllMixin):
    ...
    ElementCount: "int" = field(default=no_default)
    """The type of the elements in this array."""
    ElementType: "Type" = field(default=no_default)
...
class TypedefDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    UnderlyingType: "Type" = field(default=no_default)
...
class DefinedType(Type, StructBase, AllMixin):
    ...
    Definition: "Reference[TypeDefinition, Binary]" = field(default_factory=lambda: Reference(""))
...
class EnumDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    """
    Entries: "TypedList[EnumEntry]" = field(default=TypedListDescriptor(EnumEntry))
...
class CABIFunctionDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    ABI: "ABI" = field(default=no_default)
    """The list of formal arguments of the function type."""
    Arguments: "TypedList[Argument]" = field(default=TypedListDescriptor(Argument))
...
class RawFunctionDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    Architecture: "Architecture" = field(default=no_default)
...
class StructDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    Size: "int" = field(default=no_default)
    """The list of fields of this `struct`."""
    Fields: "TypedList[StructField]" = field(default=TypedListDescriptor(StructField))
...
class UnionDefinition(TypeDefinition, StructBase, AllMixin):
    ...
    Fields: "TypedList[UnionField]" = field(default=TypedListDescriptor(UnionField))
...
class Binary(StructBase, BinaryMixin):
    ...
    Version: "int" = field(
        metadata={"optional": True, "default_value": lambda: 0}, default_factory=lambda: 6
    )
    """The architecture for this binary."""
    Architecture: "Architecture" = field(
        metadata={"optional": True, "default_value": lambda: Architecture()},
        default_factory=lambda: Architecture(),
    )
    ...
    DefaultABI: "ABI" = field(
        metadata={"optional": True, "default_value": lambda: ABI()}, default_factory=lambda: ABI()
    )
