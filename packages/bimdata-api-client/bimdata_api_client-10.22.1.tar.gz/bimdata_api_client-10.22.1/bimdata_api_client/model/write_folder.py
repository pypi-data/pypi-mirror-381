...
class WriteFolder(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created_at, id, updated_at, created_by, groups_permissions, nature, name, user_permission, type, *args, **kwargs):  # noqa: E501
