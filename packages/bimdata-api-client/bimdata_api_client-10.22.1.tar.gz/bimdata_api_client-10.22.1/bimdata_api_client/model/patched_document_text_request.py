...
class PatchedDocumentTextRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """PatchedDocumentTextRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            language (str, none_type): * `spanish` - spanish * `french` - french * `german` - german * `english` - english * `italian` - italian. [optional]  # noqa: E501
        """
