#!/usr/bin/env python3
"""
OpenHCS Pipeline Script - Generated from tmplsq2uc32.pkl
Generated: 2025-07-21 21:34:24.776151
"""
...
def export_debug_data(subprocess_data, output_path, data_file_path=None, log_file_path=None):
    """
    Export debug data including subprocess data, data files, and log files.

    Args:
        subprocess_data: The subprocess data to export
        output_path: Base path for exported files
        data_file_path: Optional path to data file to copy
        log_file_path: Optional path to log file to copy
