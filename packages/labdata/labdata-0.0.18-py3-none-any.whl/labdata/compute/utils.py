...
def run_analysis(target, jobids, compute_obj, project = None):
    ...
    if target == 'slurm':  # run with slurm
        ...
        for cmd in _get_cmds(jobids,project):
            os.system(cmd)
...
class BaseCompute():
    ...
    def __init__(self,job_id, project = None, allow_s3 = None):
        '''
...
class PopulateCompute(BaseCompute):
    ...
    def __init__(self,job_id, project = None, allow_s3 = None, delete_results = False, **kwargs):
