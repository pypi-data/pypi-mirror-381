...
from fovus.commands.job.commands.list_runs.job_list_runs_command import (
    job_list_runs_command,
)
...
from fovus.commands.job.commands.terminate_task.job_terminate_task_command import (
    job_terminate_task_command,
)
...
job_command.add_command(job_list_runs_command)
...
job_command.add_command(job_terminate_task_command)
