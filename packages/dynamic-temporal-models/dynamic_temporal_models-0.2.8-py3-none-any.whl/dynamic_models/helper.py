...
async def process_workflow(wflow: input_module.Workflow, input_data: input_module.WorkflowInput, wait_execution: bool):
    workflow_executor = workflow.execute_child_workflow if wait_execution else workflow.start_child_workflow
