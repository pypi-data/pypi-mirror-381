...
@pytest.fixture
def kb_context(postgres_datasource, extraction_service, pgvector_datasource):
    """
...
class TestKnowledgeBaseService:
    ...
    def test_complete_knowledge_base_workflow_with_invoice(
        ...
        with patch(
            ...
            with patch(
                "sema4ai_docint.services._knowledge_base_service.get_file",
                return_value=test_pdf_path,
            ):
                with patch(
