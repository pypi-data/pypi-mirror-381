...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-synthetics)](https://pypistats.org/packages/mypy-boto3-synthetics)
...
`mypy-boto3-synthetics` dependency in production. However, there is an issue in
