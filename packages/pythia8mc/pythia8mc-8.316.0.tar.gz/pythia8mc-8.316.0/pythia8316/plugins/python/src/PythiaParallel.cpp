...
void bind_Pythia8_PythiaParallel(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // Pythia8::PythiaParallel file:Pythia8/PythiaParallel.h line:18
		...
		cl.def("stat", [](Pythia8::PythiaParallel &o) -> void { return o.stat(); }, "");
		cl.def("stat", (void (Pythia8::PythiaParallel::*)(bool)) &Pythia8::PythiaParallel::stat, "C++: Pythia8::PythiaParallel::stat(bool) --> void", pybind11::arg("combine"));
