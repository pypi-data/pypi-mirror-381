...
class test_device(unittest.TestCase):
    ...
    def test_device_parse_with_connection_alias(self):
        device = Device(name='aDevice', os='iosxe')
        device.custom.setdefault("abstraction", {})["order"] = ["os"]
        ...
        * Loopback100                   0         0         0         0         0         0         0         0         0
        ...
        out = device.parse('show interfaces Loopback100 summary', output=output, connection_alias=None)
...
class TestParserWithConnectionPool(unittest.TestCase):

    @classmethod
    def setUpClass(self):       

        self.md = MockDeviceTcpWrapper(device_os='iosxe', port=0, state='general_exec', console_mode=False)
        self.md.start()
    ...
    def test_parser_with_connection_pool(self):

        tb = loader.load(self.testbed)
        r = tb.devices.Router

        r.connect(pool_size=2)

        output = """
        Cisco IOS XE Software, Version BLD_POLARIS_DEV_LATEST_20250331_002044
        Cisco IOS Software [IOSXE], Catalyst L3 Switch Software (CAT9K_IOSXE), Experimental Version 17.18.20250331:004924 [BLD_POLARIS_DEV_LATEST_20250331_002044:/nobackup/mcpre/s2c-build-ws 101]
        Copyright (c) 1986-2025 by Cisco Systems, Inc.
        Compiled Sun 30-Mar-25 17:49 by mcpre
        ...
        ott-c9300-65 uptime is 6 hours, 47 minutes
        Uptime for this control processor is 6 hours, 50 minutes
        ...
        cisco C9300-48U (X86) processor with 1051053K/6147K bytes of memory.
        Processor board ID FOC2632Y8AD
        ...
        Base Ethernet MAC Address          : 04:a7:41:3c:de:00
        Motherboard Assembly Number        : 73-19919-05
        Motherboard Serial Number          : FOC26305FRK
        Model Revision Number              : C0
        Motherboard Revision Number        : A0
        Model Number                       : C9300-48U
        System Serial Number               : FOC2632Y8AD
        CLEI Code Number                   : INM2S10ARF
        Switch Ports Model              SW Version        SW Image              Mode   
        ------ ----- -----              ----------        ----------            ----   
        *    1 65    C9300-48U          17.18.01          CAT9K_IOSXE           INSTALL
        """

        parsed_output = {
            'version': {
                'bootldr': 'System Bootstrap, Version 17.12.0.1r, DEVELOPMENT SOFTWARE',
                'build_label': 'BLD_POLARIS_DEV_LATEST_20250331_002044',
                'chassis': 'C9300-48U',
                'chassis_sn': 'FOC2632Y8AD',
                'compiled_by': 'mcpre',
                'compiled_date': 'Sun 30-Mar-25 17:49',
                ...
                'hostname': 'ott-c9300-65',
                'image_id': 'CAT9K_IOSXE',
                'image_type': 'developer image',
                'label': '[BLD_POLARIS_DEV_LATEST_20250331_002044:/nobackup/mcpre/s2c-build-ws 101]',
                'last_reload_reason': 'PowerOn',
                'license_package': {
                    'dna-advantage': {
                ...
                'number_of_intfs': {
                    'Forty Gigabit Ethernet': '2',
                    'Gigabit Ethernet': '52',
                    'Ten Gigabit Ethernet': '8',
                    'TwentyFive Gigabit Ethernet': '2',
                    'Virtual Ethernet': '1',
                },
                'os': 'IOS-XE',
                'platform': 'Catalyst L3 Switch',
                'processor_type': 'X86',
                'returned_to_rom_by': 'PowerOn',
                'rom': 'IOS-XE ROMMON',
                'rtr_type': 'C9300-48U',
                'switch_num': {
                    '1': {
                        'active': True,
                        'clei_code_num': 'INM2S10ARF',
                        'mac_address': '04:a7:41:3c:de:00',
                        'mb_assembly_num': '73-19919-05',
                        'mb_rev_num': 'A0',
                        'mb_sn': 'FOC26305FRK',
                        'mode': 'INSTALL',
                        'model': 'C9300-48U',
                        ...
                        'model_rev_num': 'C0',
                        'ports': '65',
                        'sw_image': 'CAT9K_IOSXE',
                        'sw_ver': '17.18.01',
                        'system_sn': 'FOC2632Y8AD',
                        'uptime': '6 hours, 50 minutes',
                    },
                },
                'system_image': 'flash:packages.conf',
                'uptime': '6 hours, 47 minutes',
                'uptime_this_cp': '6 hours, 50 minutes',
                'version': '17.18.20250331:004924',
                'version_short': '17.18',
                'xe_version': 'BLD_POLARIS_DEV_LATEST_20250331_002044',
            },
        }

        out = r.parse('show version', output=output, timeout=10)
