...
class TrCIDBQ02400(TRAccnoAbstract):
    ...
    def _build_response(self, resp: Optional[object], resp_json: Optional[Dict[str, Any]], resp_headers: Optional[Dict[str, Any]], exc: Optional[Exception]) -> CIDBQ02400Response:
        if exc is not None:
            return CIDBQ02400Response(header=None, block1=None, block2=[], rsp_cd="", rsp_msg="", error_msg=str(exc))
        ...
        result = CIDBQ02400Response(
            ...
            block1=CIDBQ02400OutBlock1.model_validate(block1) if block1 is not None else None,
            block2=[CIDBQ02400OutBlock2.model_validate(item) for item in block2],
