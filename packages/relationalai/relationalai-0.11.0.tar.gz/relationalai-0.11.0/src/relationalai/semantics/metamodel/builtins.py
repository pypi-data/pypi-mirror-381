...
sqrt = f.relation(
    ...
    overloads=[
        ...
        f.relation("sqrt", [f.input_field("a", types.GenericDecimal), f.field("b", types.GenericDecimal)]),
    ],
)
...
string_binary_builtins = [num_chars, starts_with, ends_with, contains, like_match, lower, upper, strip]

date_builtins = [date_year, date_month, date_day, date_add, date_subtract, datetime_add, datetime_subtract, dates_period_days, datetimes_period_milliseconds]
...
math_builtins = [abs, *abs.overloads, natural_log, *natural_log.overloads, sqrt, *sqrt.overloads,
                 ...
                 power, *power.overloads, trunc_div, *trunc_div.overloads, ceil, *ceil.overloads,
