        ...
        *,
        ...
        if 'Update' == task.method_name:
            if only_validate:
                ...
                return rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.UpdateResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MousePositionWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.UpdateRequest, task.request),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MousePositionWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
...
class MousePositionSingletonServicer(MousePositionBaseServicer):
    ...
    async def _Update(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.Update(context, state, request)
...
class MousePositionServicer(MousePositionBaseServicer):
    ...
    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.MousePosition]
    ...
    @property
    def state(self) -> rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.MousePosition:
        state = MousePositionServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = MousePositionServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.MousePosition):
        state = MousePositionServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Update(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Update(context, request)
        finally:
    ...
    async def _Position(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Position(context, request)
        finally:
            MousePositionServicer._state.set(None)
...
class MousePosition:
    ...
    class UpdateTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.UpdateResponse]:
    ...
    class PositionTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class WeakReference(IMPORT_typing.Generic[MousePosition_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def Position(
            ...
            ) -> IMPORT_typing.AsyncIterator[rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionRequest)
                ...
                __request__ = rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionRequest(
                )
        ...
        class _Idempotently(IMPORT_typing.Generic[MousePosition_IdempotentlyScheduleTypeVar]):
            ...
            async def Update(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
                *,
                left: IMPORT_typing.Optional[int] = None,
                top: IMPORT_typing.Optional[int] = None,
            ) -> rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.UpdateResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.UpdateRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.UpdateRequest)
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> MousePosition.WeakReference._UntilChangesSatisfies[rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.MousePosition]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
            ...
            def Position(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            ) -> MousePosition.WeakReference._UntilChangesSatisfies[rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        class _Schedule:
            ...
            async def Update(
                ...
                *,
                ...
                if left is not None and not isinstance(
                    left,
                    int,
                ):
                    raise TypeError(
                ...
                if top is not None and not isinstance(
                    top,
                    int,
                ):
                    raise TypeError(
                ...
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.UpdateRequest(
        ...
        async def Update(
            ...
            *,
            ...
            return await __this__._writer(__context__).Update(
                __request__,
                idempotency=__idempotency__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
        ...
        async def Position(
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).Position(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
    ...
    class _Forall:
        ...
        async def Update(
            ...
            *,
            left: IMPORT_typing.Optional[int] = None,
            top: IMPORT_typing.Optional[int] = None,
        ) -> list[rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.UpdateResponse]:
        ...
        async def Position(
            ...
            __context__: IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WriterContext | IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.std.presence.mouse_tracker.v1.mouse_position_pb2.PositionResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    MousePosition.ref(
                        id
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> MousePosition.WeakReference[MousePosition.WeakReference._Schedule]:
        return MousePosition.WeakReference(
            # TODO(https://github.com/reboot-dev/mono/issues/3226): add support for calling other applications.
            # For now this always stays within the application that creates the context.
            application_id=None,
