...
import rbt.std.presence.v1.presence_pb2
import rbt.std.presence.v1.presence_pb2_grpc
import rbt.v1alpha1.options_pb2
# Additionally re-export all messages and enums from the pb2 module.
from rbt.std.presence.v1.presence_pb2 import (
    ListRequest,
    ListResponse,
    SubscribeRequest,
    SubscribeResponse,
...
class PresenceServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):

    def __init__(
        self,
        *,
        servicer: PresenceBaseServicer,
        ...
        super().__init__(
            ...
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.presence.v1.Presence'),
            service_names = [
                IMPORT_reboot_aio_types.ServiceName("rbt.std.presence.v1.PresenceMethods"),
            ],
        ...
        self.request_type_by_method_name: dict[str, type[IMPORT_google_protobuf_message.Message]] = {
            'Subscribe': rbt.std.presence.v1.presence_pb2.SubscribeRequest,
            'List': rbt.std.presence.v1.presence_pb2.ListRequest,
            'Watch': rbt.std.presence.v1.presence_pb2.WatchRequest,
        }
    ...
    def add_to_server(self, server: IMPORT_grpc.aio.Server) -> None:
        rbt.std.presence.v1.presence_pb2_grpc.add_PresenceMethodsServicer_to_server(
            self, server
        )
    ...
    async def react_query(
        ...
        if method == 'Subscribe':
            ...
            logger.warning(
                ...
                f"Method '{method}' is invalid for servicer Presence."
                "\n"
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                request = rbt.std.presence.v1.presence_pb2.ListRequest()
                ...
                async with self._state_manager.reactively(
                    ...
                    authorize=self._maybe_authorize(
                        method_name='rbt.std.presence.v1.PresenceMethods.List',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        async def run__List(validating_effects: bool) -> IMPORT_google_protobuf_message.Message:
                            return await self.__List(
                                context,
                                state,
                                request,
    ...
    async def react_mutate(
        ...
        if method == 'Subscribe':
            request = rbt.std.presence.v1.presence_pb2.SubscribeRequest()
            request.ParseFromString(request_bytes)
            ...
            while True:
                ...
                stub = rbt.std.presence.v1.presence_pb2_grpc.PresenceMethodsStub(
                ...
                try:
                    ...
                    if status is not None:
                        raise Presence.SubscribeAborted.from_status(
                            status
                        ) from None
                    raise Presence.SubscribeAborted.from_grpc_aio_rpc_error(
                        error
                     ) from None
            ...
            logger.warning(
                ...
                "Method 'List' is invalid for servicer Presence."
                "\n"
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.InvalidMethod(),
                message=
                f"Method 'Watch' can not be called via React (for now)"
            )
        else:
            logger.warning(
                "Got a react mutate request with an invalid method name: "
    ...
    async def dispatch(
        ...
        *,
        ...
        if 'Subscribe' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.presence.v1.presence_pb2.SubscribeResponse()
            ...
            async def run_Subscribe(
                ...
                *,
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (PresenceWorkflowStub(
                            context=context,
                            state_ref=context._state_ref,
                        ).Subscribe(
                            IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.SubscribeRequest, task.request),
                        ...
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.presence.v1.PresenceMethods.Subscribe', []):
        ...
        elif 'List' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.presence.v1.presence_pb2.ListResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (PresenceWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.ListRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.presence.v1.PresenceMethods.List', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise
        ...
        elif 'Watch' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.presence.v1.presence_pb2.WatchResponse()
            ...
            async def run_Watch(
                ...
                *,
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await self.__Watch(
                            context,
                            IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.WatchRequest, task.request),
                            validating_effects=validating_effects,
                        )
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.presence.v1.PresenceMethods.Watch', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise

            @IMPORT_reboot_aio_internals_middleware.maybe_run_function_twice_to_validate_effects
            async def run_Watch_reactively(
                    ...
                    try:
                        ...
                        while True:
                            ...
                            if len(done) == 0:
                                ...
                                logger.warning(
                                    f'Still waiting for method Presence.Watch '
            ...
            return await run_Watch_reactively(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                        state_ref=IMPORT_reboot_aio_types.StateRef(task.task_id.state_ref),
        ...
        raise RuntimeError(
            ...
            f"on 'Presence' which does not exist"
        )
    ...
    async def __Subscribe(
        ...
        state: rbt.std.presence.v1.presence_pb2.Presence,
        request: rbt.std.presence.v1.presence_pb2.SubscribeRequest,
        *,
        validating_effects: bool,
    ) -> Presence.SubscribeEffects:
        try:
            response = (
            ...
            IMPORT_reboot_aio_types.assert_type(
                response,
                [rbt.std.presence.v1.presence_pb2.SubscribeResponse],
            )
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='Presence.Subscribe',
                validating_effects=validating_effects,
                context=context,
            )
            return Presence.SubscribeEffects(
                state=state,
                response=response,
            ...
            aborted_type = Presence.SubscribeAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.std.presence.v1.Presence.Subscribe') {aborted}; propagating as 'Unknown'\n" +
                ...
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    ...
                    # information.
                    message=f"unhandled (in 'rbt.std.presence.v1.Presence.Subscribe') {aborted}"
                )
            else:
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.presence.v1.Presence.Subscribe') {aborted}"
                        )
                elif (
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.presence.v1.Presence.Subscribe') "
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.presence.v1.Presence.Subscribe') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.std.presence.v1.Presence.Subscribe') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Subscribe(
        ...
        *,
        ...
        if idempotent_mutation is not None:
            response = rbt.std.presence.v1.presence_pb2.SubscribeResponse()
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                self.tasks_dispatcher,
                authorize=self._maybe_authorize(
                    method_name='rbt.std.presence.v1.PresenceMethods.Subscribe',
        ...
        *,
    ...
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.std.presence.v1.presence_pb2.SubscribeResponse]:
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await PresenceServicerTasks(
                    context=context,
                    state_ref=context._state_ref,
                ).Subscribe(
                    request,
    ...
    async def __List(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.std.presence.v1.presence_pb2.ListResponse:
        try:
            response = (
                await self._servicer._List(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Presence.ListAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.std.presence.v1.Presence.List') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.std.presence.v1.Presence.List') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.presence.v1.Presence.List') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.presence.v1.Presence.List') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.presence.v1.Presence.List') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.std.presence.v1.Presence.List') {type(exception).__name__}: {exception}"
            )
    ...
    async def _List(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='List'
        )
    ...
    async def _schedule_List(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.std.presence.v1.presence_pb2.ListResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.presence.v1.Presence'),
            method='List',
        ...
        response = rbt.std.presence.v1.presence_pb2.ListResponse()
    ...
    async def List(
        ...
        async def _run(
            ...
            try:
                if headers.task_schedule is not None:
                    context, response = await self._schedule_List(
                        headers=headers,
                        request=request,
                        grpc_context=grpc_context,
                    )
    ...
    async def __Watch(
        self,
        context: IMPORT_reboot_aio_contexts.WorkflowContext,
        request: rbt.std.presence.v1.presence_pb2.WatchRequest,
        *,
        validating_effects: bool,
    ) -> rbt.std.presence.v1.presence_pb2.WatchResponse:
        try:
            response = (
                await self._servicer._Watch(
                    context=context,
                    request=request
                )
            )
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Presence.WatchAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.std.presence.v1.Presence.Watch') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.std.presence.v1.Presence.Watch') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.presence.v1.Presence.Watch') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.presence.v1.Presence.Watch') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.presence.v1.Presence.Watch') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.std.presence.v1.Presence.Watch') {type(exception).__name__}: {exception}"
            )


    async def _schedule_Watch(
        self,
        *,
        request: rbt.std.presence.v1.presence_pb2.WatchRequest,
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.std.presence.v1.presence_pb2.WatchResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.presence.v1.Presence'),
            method='Watch',
        ...
        response = rbt.std.presence.v1.presence_pb2.WatchResponse()
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                transaction=transaction,
                authorize=self._maybe_authorize(
                    method_name='rbt.std.presence.v1.PresenceMethods.Watch',
                    headers=context._headers,
                    auth=context.auth,
                    request=request,
                ),
    ...
    async def Watch(
        ...
        async def _run(
            ...
            try:
                ...
                context, response = await self._schedule_Watch(
                    headers=headers,
                    request=request,
                    grpc_context=grpc_context,
                )
    ...
    def _maybe_authorize(
        ...
        *,
        ...
        request: IMPORT_typing.Optional[PresenceRequestTypes] = None,
    ) -> IMPORT_typing.Optional[IMPORT_typing.Callable[[IMPORT_typing.Optional[PresenceStateType]], IMPORT_typing.Awaitable[None]]]:
        ...
        async def authorize(state: IMPORT_typing.Optional[PresenceStateType]) -> None:
            ...
            try:
                ...
                raise TypeError(
                    ...
                    f"`rbt.std.presence.v1.Presence('{headers.state_ref.id}')`"
                ) from e
...
class _PresenceStub(IMPORT_reboot_aio_stubs.Stub):

    __state_type_name__ = IMPORT_reboot_aio_types.StateTypeName('rbt.std.presence.v1.Presence')
    ...
    def __init__(
        ...
        *,
        ...
        self._rbt_std_presence_v1_presencemethods_stub = rbt.std.presence.v1.presence_pb2_grpc.PresenceMethodsStub(channel)


class PresenceReaderStub(_PresenceStub):
    ...
    async def List(
        ...
        *,
        ...
        state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.presence.v1.Presence')
        service_name = IMPORT_reboot_aio_types.ServiceName('rbt.std.presence.v1.PresenceMethods')
        method = 'List'
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_std_presence_v1_presencemethods_stub.List,
                request,
                unary=True,
                reader=True,
                response_type=rbt.std.presence.v1.presence_pb2.ListResponse,
                aborted_type=Presence.ListAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.std.presence.v1.presence_pb2.ListResponse,
                )
        return await call()
...
class PresenceWriterStub(_PresenceStub):
    ...
    async def Subscribe(
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                IMPORT_reboot_aio_types.StateTypeName('rbt.std.presence.v1.Presence'),
                IMPORT_reboot_aio_types.ServiceName('rbt.std.presence.v1.PresenceMethods'),
                'Subscribe',
                self._rbt_std_presence_v1_presencemethods_stub.Subscribe,
                request,
                unary=True,
                reader=False,
                response_type=rbt.std.presence.v1.presence_pb2.SubscribeResponse,
                aborted_type=Presence.SubscribeAborted,
                metadata=metadata,
...
class PresenceWorkflowStub(_PresenceStub):
...
class PresenceTasksStub(_PresenceStub):
                ...
                for (key, value) in await call.trailing_metadata():  # type: ignore[misc, attr-defined]
                    if key == IMPORT_reboot_aio_headers.TASK_ID_UUID:
                        return IMPORT_rbt_v1alpha1.tasks_pb2.TaskId(
                            state_type=IMPORT_reboot_aio_types.StateTypeName('rbt.std.presence.v1.Presence'),
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                IMPORT_reboot_aio_types.ServiceName('rbt.std.presence.v1.PresenceMethods'),
                'Watch',
                self._rbt_std_presence_v1_presencemethods_stub.Watch,
                request,
                unary=True,
                reader=False,
                response_type=rbt.std.presence.v1.presence_pb2.WatchResponse,
                aborted_type=Presence.WatchAborted,
                metadata=metadata,
                idempotency_key=idempotency_key,
                bearer_token=bearer_token,
...
PresenceStateType: IMPORT_typing.TypeAlias = rbt.std.presence.v1.presence_pb2.Presence
PresenceRequestTypes: IMPORT_typing.TypeAlias = \
        rbt.std.presence.v1.presence_pb2.SubscribeRequest \
        | rbt.std.presence.v1.presence_pb2.ListRequest \
        | rbt.std.presence.v1.presence_pb2.WatchRequest

class PresenceAuthorizer(
    IMPORT_rebootdev.aio.auth.authorizers.Authorizer[PresenceStateType, PresenceRequestTypes],
):
    StateType: IMPORT_typing.TypeAlias = PresenceStateType
    RequestTypes: IMPORT_typing.TypeAlias = PresenceRequestTypes
        ...
        *,
        Subscribe: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.std.presence.v1.presence_pb2.Presence,
              rbt.std.presence.v1.presence_pb2.SubscribeRequest,
            ]
        ] = None,
        subscribe: IMPORT_typing.Optional[
        ...
        if list is not None and List is not None:
            raise ValueError(
                f"Cannot specify both 'List' and 'list' authorizer rules"
            )
        self._list = list or List
        if watch is not None and Watch is not None:
            raise ValueError(
                f"Cannot specify both 'Watch' and 'watch' authorizer rules"
            )
        self._watch = watch or Watch
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[PresenceStateType],
        request: IMPORT_typing.Optional[PresenceRequestTypes],
        **kwargs,
    ) -> IMPORT_rebootdev.aio.auth.authorizers.Authorizer.Decision:
        if method_name == 'rbt.std.presence.v1.PresenceMethods.Subscribe':
            return await self.Subscribe(
                context=context,
                state=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.Presence, state),
                request=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.SubscribeRequest, request),
            )
        elif method_name == 'rbt.std.presence.v1.PresenceMethods.List':
            return await self.List(
                context=context,
                state=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.Presence, state),
                request=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.ListRequest, request),
            )
        elif method_name == 'rbt.std.presence.v1.PresenceMethods.Watch':
            return await self.Watch(
                context=context,
                state=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.Presence, state),
                request=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.WatchRequest, request),
            )
        else:
            return IMPORT_rbt_v1alpha1.errors_pb2.PermissionDenied()

    # For 'rbt.std.presence.v1.PresenceMethods.Subscribe'.
    async def Subscribe(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.std.presence.v1.PresenceMethods.List'.
    async def List(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        ...
        return await (self._list or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.Presence, state),
            request=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.ListRequest, request),
        )

    # For 'rbt.std.presence.v1.PresenceMethods.Watch'.
    async def Watch(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        ...
        return await (self._watch or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.Presence, state),
            request=IMPORT_typing.cast(rbt.std.presence.v1.presence_pb2.WatchRequest, request),
        )
...
class PresenceBaseServicer(IMPORT_reboot_aio_servicers.Servicer):
    Authorizer: IMPORT_typing.TypeAlias = PresenceAuthorizer

    __service_names__ = [
        IMPORT_reboot_aio_types.ServiceName('rbt.std.presence.v1.PresenceMethods'),
    ]
    __state_type_name__ = IMPORT_reboot_aio_types.StateTypeName('rbt.std.presence.v1.Presence')
    __state_type__ = rbt.std.presence.v1.presence_pb2.Presence
    __file_descriptor__ = rbt.std.presence.v1.presence_pb2.DESCRIPTOR
    ...
    def __init__(self):
        ...
        # 'create_middleware()'.
        self._middleware: IMPORT_typing.Optional[PresenceServicerMiddleware] = None
    ...
    def create_middleware(
        ...
        *,
        ...
        app_internal_api_key_secret: str,
        ready: IMPORT_asyncio.Event,
    ) -> PresenceServicerMiddleware:
        self._middleware = PresenceServicerMiddleware(
            servicer=self,
            application_id=application_id,
            consensus_id=consensus_id,
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> Presence.WeakReference[Presence.WeakReference._WriterSchedule]:
        ...
        return Presence.WeakReference(
            ...
            schedule_type=Presence.WeakReference._WriterSchedule,
    ...
    class Effects(IMPORT_reboot_aio_state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            IMPORT_reboot_aio_types.assert_type(state, [rbt.std.presence.v1.presence_pb2.Presence])
    ...
    class SubscribeEffects(Effects):
        def __init__(
            ...
            *,
            ...
            IMPORT_reboot_aio_types.assert_type(state, [rbt.std.presence.v1.presence_pb2.Presence])
            IMPORT_reboot_aio_types.assert_type(response, [rbt.std.presence.v1.presence_pb2.SubscribeResponse])
    ...
    class InlineWriterCallable(IMPORT_typing.Protocol[InlineWriterCallableResult]):
        async def __call__(
            self,
            state: rbt.std.presence.v1.presence_pb2.Presence
        ) -> PresenceBaseServicer.InlineWriterCallableResult:
            ...
    ...
    class WorkflowState:
        ...
        async def write(
            ...
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: PresenceBaseServicer.InlineWriterCallable[None],
        ...
        async def write(
            ...
            idempotency_alias: str,
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: PresenceBaseServicer.InlineWriterCallable[PresenceBaseServicer.InlineWriterCallableResult],
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            *,
            type: type[PresenceBaseServicer.InlineWriterCallableResult],
        ) -> PresenceBaseServicer.InlineWriterCallableResult:
            ...
            ...
            async def _read(
                ...
                with context.idempotently(
                    ...
                    return await IMPORT_reboot_aio_workflows.at_least_once(
                        ...
                        context,
                        read,
                        type=rbt.std.presence.v1.presence_pb2.Presence,
                    )
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: PresenceBaseServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                method_name = f"Presence.{task.method_name} inline writer"
        ...
        def per_workflow(self, alias: IMPORT_typing.Optional[str] = None):
            return PresenceBaseServicer.WorkflowState._Idempotently(
        ...
        class _Always:
            ...
            async def read(
                ...
                return await PresenceBaseServicer.WorkflowState._Idempotently(
                    servicer=self._servicer,
                    alias=None,
        ...
        def always(self):
            return PresenceBaseServicer.WorkflowState._Always(
                servicer=self._servicer,
            )
...
class PresenceSingletonServicer(PresenceBaseServicer):

    @property
    def state(self):
        return PresenceBaseServicer.WorkflowState(
            servicer=self
        )
    ...
    async def _Subscribe(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.std.presence.v1.Presence('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.Subscribe()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            return await self.Subscribe(context, state, request)
    ...
    async def _List(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.std.presence.v1.Presence('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.List()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Watch(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.std.presence.v1.Presence('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.Watch()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            return await self.Watch(context, request)




class PresenceServicer(PresenceBaseServicer):

    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.std.presence.v1.presence_pb2.Presence]
    ...
    _instances: dict[str, PresenceServicer] = {}

    def _instance(self, state_id: str):
        instances = PresenceServicer._instances
    ...
    @property
    def state(self) -> rbt.std.presence.v1.presence_pb2.Presence:
        state = PresenceServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = PresenceServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.std.presence.v1.presence_pb2.Presence):
        state = PresenceServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Subscribe(
        ...
        # `_state is None`.
        assert PresenceServicer._state.get() is None
        PresenceServicer._state.set(state)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Subscribe(context, request)
        finally:
            PresenceServicer._state.set(None)
    ...
    async def _List(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.std.presence.v1.Presence('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.List()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.List(context, request)
        finally:
            PresenceServicer._state.set(None)
    ...
    async def _Watch(
        ...
        PresenceServicer._workflow.set(True)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.std.presence.v1.Presence('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.Watch()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.Watch(context, request)
        finally:
            PresenceServicer._workflow.set(False)
...
Presence_ScheduleTypeVar = IMPORT_typing.TypeVar('Presence_ScheduleTypeVar', 'Presence.WeakReference._Schedule', 'Presence.WeakReference._WriterSchedule')
Presence_IdempotentlyScheduleTypeVar = IMPORT_typing.TypeVar('Presence_IdempotentlyScheduleTypeVar', 'Presence.WeakReference._Schedule', 'Presence.WeakReference._WriterSchedule')

Presence_UntilCallableType = IMPORT_typing.TypeVar('Presence_UntilCallableType')

class PresenceSingleton:
    Servicer: IMPORT_typing.TypeAlias = PresenceSingletonServicer


class Presence:


    Servicer: IMPORT_typing.TypeAlias = PresenceServicer

    singleton: IMPORT_typing.TypeAlias = PresenceSingleton

    Effects: IMPORT_typing.TypeAlias = PresenceBaseServicer.Effects

    Authorizer: IMPORT_typing.TypeAlias = PresenceAuthorizer

    State: IMPORT_typing.TypeAlias = rbt.std.presence.v1.presence_pb2.Presence
    ...
    class SubscribeTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.v1.presence_pb2.SubscribeResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.presence.v1.presence_pb2.SubscribeResponse:
                channel = self._channel_manager.get_channel_to_state(
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            "but expecting type 'rbt.std.presence.v1.presence_pb2.SubscribeResponse'; "
    ...
    SubscribeEffects: IMPORT_typing.TypeAlias = PresenceBaseServicer.SubscribeEffects
    ...
    class ListTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.v1.presence_pb2.ListResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.presence.v1.presence_pb2.ListResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.std.presence.v1.presence_pb2.ListResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class ListAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class WatchTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.v1.presence_pb2.WatchResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.presence.v1.presence_pb2.WatchResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.std.presence.v1.presence_pb2.WatchResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class WatchAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class WeakReference(IMPORT_typing.Generic[Presence_ScheduleTypeVar]):

        _schedule_type: type[Presence_ScheduleTypeVar]
        ...
        def __init__(
            ...
            *,
            schedule_type: type[Presence_ScheduleTypeVar],
            bearer_token: IMPORT_typing.Optional[str] = None,
            servicer: IMPORT_typing.Optional[PresenceBaseServicer] = None,
        ):
            self._application_id = application_id
            self._state_ref = IMPORT_reboot_aio_types.StateRef.from_id(
              Presence.__state_type_name__,
              state_id,
            )
            self._schedule_type = schedule_type
            self._idempotency_manager: IMPORT_typing.Optional[IMPORT_reboot_aio_idempotency.IdempotencyManager] = None
            self._reader_stub: IMPORT_typing.Optional[PresenceReaderStub] = None
            self._writer_stub: IMPORT_typing.Optional[PresenceWriterStub] = None
            self._workflow_stub: IMPORT_typing.Optional[PresenceWorkflowStub] = None
            self._tasks_stub: IMPORT_typing.Optional[PresenceTasksStub] = None
        ...
        def _reader(
            ...
            if self._reader_stub is None:
                self._reader_stub = PresenceReaderStub(
                    context=context,
                    state_ref=self._state_ref,
            ...
            if self._idempotency_manager is None:
                ...
                raise IMPORT_reboot_aio_call.MixedContextsError(
                    "This `WeakReference` for `Presence` with ID "
        ...
        def _writer(
            ...
            if self._writer_stub is None:
                self._writer_stub = PresenceWriterStub(
                    context=context,
                    state_ref=self._state_ref,
                    bearer_token=self._bearer_token,
                )
        ...
        def _workflow(
            self,
            context: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
        ) -> PresenceWorkflowStub:
            if self._workflow_stub is None:
                self._workflow_stub = PresenceWorkflowStub(
                    context=context,
                    state_ref=self._state_ref,
                    bearer_token=self._bearer_token,
                )
        ...
        def _tasks(
            ...
            if self._tasks_stub is None:
                self._tasks_stub = PresenceTasksStub(
                    context=context,
                    state_ref=self._state_ref,
                    bearer_token=self._bearer_token,
                )
        ...
        class _Reactively:
            ...
            async def List(
            ...
            ) -> IMPORT_typing.AsyncIterator[rbt.std.presence.v1.presence_pb2.ListResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.v1.presence_pb2.ListRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.v1.presence_pb2.ListRequest)
                ...
                __request__ = rbt.std.presence.v1.presence_pb2.ListRequest(
                )
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.std.presence.v1.presence_pb2.ListResponse()
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.std.presence.v1.PresenceMethods.List' "
        ...
        def reactively(self):
            return Presence.WeakReference._Reactively(
                application_id=self._application_id,
                state_ref=self._state_ref,
                bearer_token=self._bearer_token,
            )

        class _Idempotently(IMPORT_typing.Generic[Presence_IdempotentlyScheduleTypeVar]):

            _weak_reference: Presence.WeakReference[Presence_IdempotentlyScheduleTypeVar]

            def __init__(
                self,
                *,
                weak_reference: Presence.WeakReference[Presence_IdempotentlyScheduleTypeVar],
                idempotency: IMPORT_reboot_aio_idempotency.Idempotency,
            ):
            ...
            def schedule(
                ...
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
            ) -> Presence_IdempotentlyScheduleTypeVar:
            ...
            def spawn(
                ...
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
            ) -> Presence.WeakReference._Spawn:
                return Presence.WeakReference._Spawn(
                    self._weak_reference._application_id,
                    self._weak_reference._tasks,
                    when=when,
                    idempotency=self._idempotency,
            ...
            async def read(
                ...
                return await PresenceBaseServicer.WorkflowState._Idempotently._read(
            ...
            async def write(
                ...
                *,
                ...
                return await PresenceBaseServicer.WorkflowState._Idempotently._write_validating_effects(
                    self._weak_reference._servicer,
                    self._idempotency,
                    context,
                    writer,
            ...
            async def Subscribe(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
                *,
                subscriber_id: IMPORT_typing.Optional[str] = None,
            ) -> rbt.std.presence.v1.presence_pb2.SubscribeResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.v1.presence_pb2.SubscribeRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.v1.presence_pb2.SubscribeRequest)
            ...
            async def List(
                ...
                return await __this__._weak_reference.List(
                    __context__,
                    __options__,
                )
            ...
            async def Watch(
                ...
                *,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.v1.presence_pb2.WatchRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.v1.presence_pb2.WatchRequest)
                ...
                def error_message_supplement():
                    if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                        return f"'Watch' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].schedule([...]).Watch(context, [...])`"
                    else:
                        return f"'Watch' is a workflow and can not be called from '{type(__context__).__name__}'"
        ...
        @IMPORT_typing.overload
        def idempotently(self, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> Presence.WeakReference._Idempotently[Presence_ScheduleTypeVar]:
            ...

        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID, generated: bool = False) -> Presence.WeakReference._Idempotently[Presence_ScheduleTypeVar]:
            ...
        ...
        ) -> Presence.WeakReference._Idempotently[Presence_ScheduleTypeVar]:
            return Presence.WeakReference._Idempotently(
                weak_reference=self,
        ...
        class _UntilChangesSatisfies(IMPORT_typing.Generic[Presence_UntilCallableType]):

            _idempotency_alias: str
            _context: IMPORT_reboot_aio_contexts.WorkflowContext
            _callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[Presence_UntilCallableType]]
            _type: type[Presence_UntilCallableType]
            ...
            def __init__(
                ...
                *,
                idempotency_alias: str,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[Presence_UntilCallableType]],
                type: type[Presence_UntilCallableType],
            ):
            ...
            async def satisfies(
                self,
                condition: IMPORT_typing.Callable[[Presence_UntilCallableType], bool],
            ):
        ...
        class _Until:
            ...
            _weak_reference: Presence.WeakReference
            _idempotency_alias: str

            def __init__(
                self,
                *,
                weak_reference: Presence.WeakReference,
                idempotency_alias: str,
            ):
                self._weak_reference = weak_reference
                self._idempotency_alias = idempotency_alias
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> Presence.WeakReference._UntilChangesSatisfies[rbt.std.presence.v1.presence_pb2.Presence]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
                ...
                return Presence.WeakReference._UntilChangesSatisfies(
            ...
            def List(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            ) -> Presence.WeakReference._UntilChangesSatisfies[rbt.std.presence.v1.presence_pb2.ListResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        def until(self, alias: str):
            return Presence.WeakReference._Until(
                weak_reference=self,
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                application_id: IMPORT_typing.Optional[IMPORT_reboot_aio_types.ApplicationId],
                tasks: IMPORT_typing.Callable[[IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext], PresenceTasksStub],
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
                idempotency: IMPORT_typing.Optional[IMPORT_reboot_aio_idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Subscribe(
                ...
                *,
                ...
                if subscriber_id is not None and not isinstance(
                    subscriber_id,
                    str,
                ):
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.presence.v1.presence_pb2.SubscribeRequest': field 'subscriber_id' is not "
                        f"of required type 'str'"
                    )
                # TODO: mypy-protobuf declares that
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.presence.v1.presence_pb2.SubscribeRequest(
                    subscriber_id=subscriber_id,  # type: ignore[arg-type]
                )
            ...
            async def Watch(
                ...
                *,
                ...
                if subscriber_id is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.presence.v1.presence_pb2.WatchRequest': field 'subscriber_id' is not "
                        f"of required type 'str'"
                    )
                # TODO: mypy-protobuf declares that
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.presence.v1.presence_pb2.WatchRequest(
                    subscriber_id=subscriber_id,  # type: ignore[arg-type]
                )
            ...
            async def Subscribe(
                ...
                *,
                ...
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WriterContext):
                    return (await PresenceServicerTasks(
                        context=__context__,
        ...
        async def Subscribe(
            ...
            *,
            ...
            return await __this__._writer(__context__).Subscribe(
                __request__,
                idempotency=__idempotency__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
        ...
        async def List(
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().List(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                    )
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).List(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
            ...
            *,
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'Watch' is a workflow and can not be called from a '{type(__context__).__name__}'"
    ...
    class _Forall:
        ...
        async def Subscribe(
            ...
            *,
            subscriber_id: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.std.presence.v1.presence_pb2.SubscribeResponse]:
        ...
        async def List(
            ...
            __context__: IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WriterContext | IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.std.presence.v1.presence_pb2.ListResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Presence.ref(
                        id
    ...
    @classmethod
    def forall(cls, ids: list[str]) -> Presence._Forall:
        return Presence._Forall(ids)
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> Presence.WeakReference[Presence.WeakReference._Schedule]:
        return Presence.WeakReference(
            # TODO(https://github.com/reboot-dev/mono/issues/3226): add support for calling other applications.
            # For now this always stays within the application that creates the context.
            application_id=None,
            state_id=state_id,
            schedule_type=Presence.WeakReference._Schedule,
            bearer_token=bearer_token,
        )
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> Presence._ConstructIdempotently:
        ...

    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID, generated: bool = False) -> Presence._ConstructIdempotently:
        ...
    ...
    def idempotently(
        ...
        *,
        ...
        each_iteration: IMPORT_typing.Optional[bool] = None,
        generated: bool = False,
    ) -> Presence._ConstructIdempotently:
        return Presence._ConstructIdempotently(
...
class PresenceServicerNodeAdaptor(Presence.singleton.Servicer):
            ...
            try:
                ...
                if result.HasField('state'):
                    with IMPORT_reboot_aio_tracing.span(
                        ...
                        state.CopyFrom(
                            rbt.std.presence.v1.presence_pb2.Presence.FromString(
                                result.state
                            )
                        )
                ...
                with IMPORT_reboot_aio_tracing.span(
                    ...
                    return rbt.std.presence.v1.presence_pb2.SubscribeResponse.FromString(result.response)
    ...
    async def List(
        ...
        try:
            ...
            return rbt.std.presence.v1.presence_pb2.ListResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from List")
    ...
    async def Watch(
        ...
        try:
            ...
            assert result.HasField('response')
            return rbt.std.presence.v1.presence_pb2.WatchResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from Watch")
...
class PresenceWeakReferenceNodeAdaptor(Presence.WeakReference[Presence.WeakReference._Schedule]):
