        ...
        *,
        ...
        if 'Send' == task.method_name:
            if only_validate:
                ...
                return rbt.thirdparty.mailgun.v1.mailgun_pb2.SendResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (MessageWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.thirdparty.mailgun.v1.mailgun_pb2.SendRequest, task.request),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.thirdparty.mailgun.v1.mailgun_pb2.SendWorkflowResponse()
...
class MessageSingletonServicer(MessageBaseServicer):
    ...
    async def SendWorkflow(
        ...
        # overrides the 'PascalCase' version - it will override that
        # method and will just work.
        return await self.send_workflow(
            context,
            request,
        )
    ...
    async def _Send(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.Send(context, state, request)
    ...
    async def _SendWorkflow(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.SendWorkflow(context, request)
...
class MessageServicer(MessageBaseServicer):
    ...
    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.thirdparty.mailgun.v1.mailgun_pb2.Message]
    ...
    @property
    def state(self) -> rbt.thirdparty.mailgun.v1.mailgun_pb2.Message:
        state = MessageServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = MessageServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.thirdparty.mailgun.v1.mailgun_pb2.Message):
        state = MessageServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Send(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Send(context, request)
        finally:
    ...
    async def _SendWorkflow(
        ...
        MessageServicer._workflow.set(True)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.SendWorkflow(context, request)
        finally:
            MessageServicer._workflow.set(False)
...
class Message:
    ...
    class SendTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.thirdparty.mailgun.v1.mailgun_pb2.SendResponse]:
    ...
    class SendWorkflowTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.thirdparty.mailgun.v1.mailgun_pb2.SendWorkflowResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class WeakReference(IMPORT_typing.Generic[Message_ScheduleTypeVar]):
        ...
        class _Idempotently(IMPORT_typing.Generic[Message_IdempotentlyScheduleTypeVar]):
            ...
            async def SendWorkflow(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
                *,
                send_request: IMPORT_typing.Optional[rbt.thirdparty.mailgun.v1.mailgun_pb2.SendRequest] = None,
            ) -> rbt.thirdparty.mailgun.v1.mailgun_pb2.SendWorkflowResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.thirdparty.mailgun.v1.mailgun_pb2.SendWorkflowRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.thirdparty.mailgun.v1.mailgun_pb2.SendWorkflowRequest)
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> Message.WeakReference._UntilChangesSatisfies[rbt.thirdparty.mailgun.v1.mailgun_pb2.Message]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        class _Schedule:
            ...
            async def SendWorkflow(
                ...
                *,
                ...
                __request__ = rbt.thirdparty.mailgun.v1.mailgun_pb2.SendWorkflowRequest(
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> Message.WeakReference[Message.WeakReference._Schedule]:
        return Message.WeakReference(
            # TODO(https://github.com/reboot-dev/mono/issues/3226): add support for calling other applications.
            # For now this always stays within the application that creates the context.
            application_id=None,
    ...
    async def Send(
        ...
        *,
        recipient: IMPORT_typing.Optional[str] = None,
        sender: IMPORT_typing.Optional[str] = None,
        subject: IMPORT_typing.Optional[str] = None,
        domain: IMPORT_typing.Optional[str] = None,
        text: IMPORT_typing.Optional[str] = None,
        html: IMPORT_typing.Optional[str] = None,
    ) -> tuple[Message.WeakReference, rbt.thirdparty.mailgun.v1.mailgun_pb2.SendResponse]:
        ...
        # `google.protobuf.message.Message` constructor arguments are
        # always non-None, when in reality they are optional.
        __request__ = rbt.thirdparty.mailgun.v1.mailgun_pb2.SendRequest(
    ...
    class _ConstructIdempotently:
        ...
        async def Send(
            ...
            *,
            ...
            # UX improvement: check that neither positional argument was accidentally
            # given a gRPC request type.
            IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.thirdparty.mailgun.v1.mailgun_pb2.SendRequest)
            IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.thirdparty.mailgun.v1.mailgun_pb2.SendRequest)
