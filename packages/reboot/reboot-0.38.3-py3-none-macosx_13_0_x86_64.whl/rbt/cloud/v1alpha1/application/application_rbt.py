...
IMPORT_reboot_versioning.check_generated_code_compatible("0.38.3")
...
from rbt.cloud.v1alpha1.application.application_pb2 import (
    ActiveRevisionsRequest,
    ActiveRevisionsResponse,
...
class ApplicationServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    def __init__(
        self,
        *,
        servicer: ApplicationBaseServicer,
        ...
        self.request_type_by_method_name: dict[str, type[IMPORT_google_protobuf_message.Message]] = {
            ...
            'PushInfo': rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest,
            'Up': rbt.cloud.v1alpha1.application.application_pb2.UpRequest,
            'UpWorkflow': rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest,
            'Down': rbt.cloud.v1alpha1.application.application_pb2.DownRequest,
            'DownWorkflow': rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest,
            'RevisionStatus': rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest,
            'Logs': rbt.cloud.v1alpha1.application.application_pb2.LogsRequest,
            'ActiveRevisions': rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest,
            'Status': rbt.cloud.v1alpha1.application.application_pb2.StatusRequest,
            'IsAdmin': rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest,
        }
        ...
        self._specified_errors_by_service_method_name: dict[str, list[str]] = {
            'rbt.cloud.v1alpha1.application.ApplicationMethods.Up': [
                ...
                'rbt.cloud.v1alpha1.application.application_pb2.ConcurrentModificationError',
            ],
        ...
        if method == 'Create':
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                context.auth = await self._maybe_verify_token(
                    headers=headers, method='PushInfo'
                )

                request = rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest()
                ...
                async with self._state_manager.reactively(
                    ...
                    authorize=self._maybe_authorize(
                        method_name='rbt.cloud.v1alpha1.application.ApplicationMethods.PushInfo',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        async def run__PushInfo(validating_effects: bool) -> IMPORT_google_protobuf_message.Message:
                            return await self.__PushInfo(
                                context,
                                state,
                                request,
            ...
            yield  # Necessary for type checking.
        elif method == 'RevisionStatus':

            context = self.create_context(
                headers=headers,
                state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
                method='RevisionStatus',
                context_type=IMPORT_reboot_aio_contexts.ReaderContext,
            )

            with IMPORT_reboot_aio_tracing.span(
                state_name=f"{context.state_type_name}('{context.state_id}')",
                span_name="RevisionStatus() (reactively)",
                # The naming above matches Python, but not TypeScript.
                python_specific=True,
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
            ):
                context.auth = await self._maybe_verify_token(
                    headers=headers, method='RevisionStatus'
                )

                request = rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest()
                request.ParseFromString(request_bytes)
                ...
                async with self._state_manager.reactively(
                    ...
                    self._servicer.__state_type__,
                    authorize=self._maybe_authorize(
                        method_name='rbt.cloud.v1alpha1.application.ApplicationMethods.RevisionStatus',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        # see https://github.com/reboot-dev/respect/issues/2636.
                        @IMPORT_reboot_aio_internals_middleware.maybe_run_function_twice_to_validate_effects
                        async def run__RevisionStatus(validating_effects: bool) -> IMPORT_google_protobuf_message.Message:
                            return await self.__RevisionStatus(
                                context,
                                state,
                                request,
                                validating_effects=validating_effects,
                        ...
                        response = await run__RevisionStatus()
            ...
            yield  # Necessary for type checking.
        elif method == 'ActiveRevisions':

            context = self.create_context(
                headers=headers,
                state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
                method='ActiveRevisions',
                context_type=IMPORT_reboot_aio_contexts.ReaderContext,
            )

            with IMPORT_reboot_aio_tracing.span(
                state_name=f"{context.state_type_name}('{context.state_id}')",
                span_name="ActiveRevisions() (reactively)",
                # The naming above matches Python, but not TypeScript.
                python_specific=True,
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
            ):
                context.auth = await self._maybe_verify_token(
                    headers=headers, method='ActiveRevisions'
                )

                request = rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest()
                request.ParseFromString(request_bytes)
                ...
                async with self._state_manager.reactively(
                    ...
                    self._servicer.__state_type__,
                    authorize=self._maybe_authorize(
                        method_name='rbt.cloud.v1alpha1.application.ApplicationMethods.ActiveRevisions',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        # see https://github.com/reboot-dev/respect/issues/2636.
                        @IMPORT_reboot_aio_internals_middleware.maybe_run_function_twice_to_validate_effects
                        async def run__ActiveRevisions(validating_effects: bool) -> IMPORT_google_protobuf_message.Message:
                            return await self.__ActiveRevisions(
                                context,
                                state,
                                request,
                                validating_effects=validating_effects,
                        ...
                        response = await run__ActiveRevisions()
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                request = rbt.cloud.v1alpha1.application.application_pb2.StatusRequest()
                request.ParseFromString(request_bytes)
                ...
                async with self._state_manager.reactively(
                    ...
                    self._servicer.__state_type__,
                    authorize=self._maybe_authorize(
                        method_name='rbt.cloud.v1alpha1.application.ApplicationMethods.Status',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
            ...
            with IMPORT_reboot_aio_tracing.span(
                state_name=f"{context.state_type_name}('{context.state_id}')",
                span_name="IsAdmin() (reactively)",
                # The naming above matches Python, but not TypeScript.
                python_specific=True,
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
            ):
                context.auth = await self._maybe_verify_token(
                    headers=headers, method='IsAdmin'
                )

                request = rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest()
                request.ParseFromString(request_bytes)
                ...
                async with self._state_manager.reactively(
                    ...
                    self._servicer.__state_type__,
                    authorize=self._maybe_authorize(
                        method_name='rbt.cloud.v1alpha1.application.ApplicationMethods.IsAdmin',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
                    ...
                    async for (state, idempotency_keys) in states:
                        ...
                        # see https://github.com/reboot-dev/respect/issues/2636.
                        @IMPORT_reboot_aio_internals_middleware.maybe_run_function_twice_to_validate_effects
                        async def run__IsAdmin(validating_effects: bool) -> IMPORT_google_protobuf_message.Message:
                            return await self.__IsAdmin(
                                context,
                                state,
                                request,
                                validating_effects=validating_effects,
    ...
    async def react_mutate(
        ...
        if method == 'Create':
            ...
            logger.warning(
                ...
                "Method 'PushInfo' is invalid for servicer Application."
                "\n"
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.InvalidMethod(),
                message=
                f"Method 'UpWorkflow' can not be called via React (for now)"
            )
        elif method == 'Down':
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.InvalidMethod(),
                message=
                f"Method 'DownWorkflow' can not be called via React (for now)"
            )
        elif method == 'RevisionStatus':
            # Invariant here is that users should not have called this
            # directly but only through code generated React
            ...
            logger.warning(
                "Got a react mutate request with an invalid method name: "
                "Method 'RevisionStatus' is invalid for servicer Application."
                "\n"
                "Do you have an old browser tab still open for an older version "
                "of this application, or a different application all together?"
            )
            ...
            logger.warning(
                "Got a react mutate request with an invalid method name: "
                "Method 'Logs' is invalid for servicer Application."
                "\n"
                "Do you have an old browser tab still open for an older version "
                "of this application, or a different application all together?"
            )
            ...
            logger.warning(
                "Got a react mutate request with an invalid method name: "
                "Method 'ActiveRevisions' is invalid for servicer Application."
                "\n"
                "Do you have an old browser tab still open for an older version "
                "of this application, or a different application all together?"
            )
            ...
            logger.warning(
                "Got a react mutate request with an invalid method name: "
                "Method 'Status' is invalid for servicer Application."
                "\n"
                "Do you have an old browser tab still open for an older version "
                "of this application, or a different application all together?"
            )
            ...
            logger.warning(
                "Got a react mutate request with an invalid method name: "
                "Method 'IsAdmin' is invalid for servicer Application."
                "\n"
                "Do you have an old browser tab still open for an older version "
                "of this application, or a different application all together?"
            )
    ...
    async def dispatch(
        ...
        *,
        ...
        if 'Create' == task.method_name:
        ...
        elif 'PushInfo' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse()

            # Use an inline method to create a new scope, so that we can use
            # variable names like `context` and `effects` in multiple branches
            # in this code (notably when there are multiple task types) without
            # hitting a mypy error that the variable's type is not consistent.
            async def run_PushInfo(
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                *,
                validating_effects: bool = False,
            ):
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.cloud.v1alpha1.application.ApplicationMethods.PushInfo', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise


            return await run_PushInfo(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                        state_ref=IMPORT_reboot_aio_types.StateRef(task.task_id.state_ref),
        ...
        elif 'UpWorkflow' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse()

            # Use an inline method to create a new scope, so that we can use
            # variable names like `context` and `effects` in multiple branches
            # in this code (notably when there are multiple task types) without
            # hitting a mypy error that the variable's type is not consistent.
            async def run_UpWorkflow(
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                *,
                validating_effects: bool = False,
            ):
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await self.__UpWorkflow(
                            context,
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest, task.request),
                            validating_effects=validating_effects,
                        )
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.cloud.v1alpha1.application.ApplicationMethods.UpWorkflow', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise

            @IMPORT_reboot_aio_internals_middleware.maybe_run_function_twice_to_validate_effects
            async def run_UpWorkflow_reactively(
                    ...
                    try:
                        ...
                        while True:
                            ...
                            if len(done) == 0:
                                ...
                                logger.warning(
                                    f'Still waiting for method Application.UpWorkflow '
            ...
            return await run_UpWorkflow_reactively(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                        state_ref=IMPORT_reboot_aio_types.StateRef(task.task_id.state_ref),
        ...
        elif 'DownWorkflow' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse()

            # Use an inline method to create a new scope, so that we can use
            # variable names like `context` and `effects` in multiple branches
            # in this code (notably when there are multiple task types) without
            # hitting a mypy error that the variable's type is not consistent.
            async def run_DownWorkflow(
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                *,
                validating_effects: bool = False,
            ):
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await self.__DownWorkflow(
                            context,
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest, task.request),
                            validating_effects=validating_effects,
                        )
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.cloud.v1alpha1.application.ApplicationMethods.DownWorkflow', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise

            @IMPORT_reboot_aio_internals_middleware.maybe_run_function_twice_to_validate_effects
            async def run_DownWorkflow_reactively(
                validating_effects: bool,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ):
                async with self._state_manager.reactively(
                    ...
                    try:
                        ...
                        while True:
                            ...
                            if len(done) == 0:
                                assert validating_effects and timeout is not None
                                logger.warning(
                                    f'Still waiting for method Application.DownWorkflow '
                                    'to complete after re-running to validate effects.'
                                )
                                timeout += 5  # seconds
                                continue
            ...
            return await run_DownWorkflow_reactively(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                        state_ref=IMPORT_reboot_aio_types.StateRef(task.task_id.state_ref),
        ...
        elif 'RevisionStatus' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse()

            # Use an inline method to create a new scope, so that we can use
            # variable names like `context` and `effects` in multiple branches
            # in this code (notably when there are multiple task types) without
            # hitting a mypy error that the variable's type is not consistent.
            async def run_RevisionStatus(
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                *,
                validating_effects: bool = False,
            ):
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.cloud.v1alpha1.application.ApplicationMethods.RevisionStatus', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise


            return await run_RevisionStatus(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                        state_ref=IMPORT_reboot_aio_types.StateRef(task.task_id.state_ref),
        ...
        elif 'ActiveRevisions' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse()

            # Use an inline method to create a new scope, so that we can use
            # variable names like `context` and `effects` in multiple branches
            # in this code (notably when there are multiple task types) without
            # hitting a mypy error that the variable's type is not consistent.
            async def run_ActiveRevisions(
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                *,
                validating_effects: bool = False,
            ):
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.cloud.v1alpha1.application.ApplicationMethods.ActiveRevisions', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise


            return await run_ActiveRevisions(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                        state_ref=IMPORT_reboot_aio_types.StateRef(task.task_id.state_ref),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.cloud.v1alpha1.application.application_pb2.StatusResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.StatusRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.cloud.v1alpha1.application.ApplicationMethods.Status', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise
        ...
        elif 'IsAdmin' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse()

            # Use an inline method to create a new scope, so that we can use
            # variable names like `context` and `effects` in multiple branches
            # in this code (notably when there are multiple task types) without
            # hitting a mypy error that the variable's type is not consistent.
            async def run_IsAdmin(
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                *,
                validating_effects: bool = False,
            ):
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (ApplicationWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.cloud.v1alpha1.application.ApplicationMethods.IsAdmin', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise


            return await run_IsAdmin(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                        state_ref=IMPORT_reboot_aio_types.StateRef(task.task_id.state_ref),
    ...
    async def __Create(
        ...
        *,
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.Create') {aborted}"
                        )
                elif (
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Create') "
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Create') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await ApplicationServicerTasks(
                    context=context,
                    state_ref=context._state_ref,
                ).Create(
                    request,
    ...
    async def __PushInfo(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse:
        try:
            response = (
                await self._servicer._PushInfo(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='Application.PushInfo',
                validating_effects=validating_effects,
                context=context,
            )
            return response
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Application.PushInfoAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') {type(exception).__name__}: {exception}"
            )
    ...
    async def _PushInfo(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='PushInfo'
        )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.reader(
                ...
                response = await self.__PushInfo(
                    context,
                    state,
                    request,
                    validating_effects=validating_effects,
    ...
    async def _schedule_PushInfo(
        self,
        *,
        request: rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest,
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            method='PushInfo',
        ...
        response = rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse()
    ...
    async def PushInfo(
        ...
        async def _run(
            ...
            try:
                if headers.task_schedule is not None:
                    context, response = await self._schedule_PushInfo(
                        headers=headers,
                        request=request,
                        grpc_context=grpc_context,
                    )
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.Up') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Up') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Up') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
    ...
    async def _Up(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='Up'
        )
    ...
    async def __UpWorkflow(
        self,
        context: IMPORT_reboot_aio_contexts.WorkflowContext,
        request: rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest,
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse:
        try:
            response = (
                await self._servicer._UpWorkflow(
                    context=context,
                    request=request
                )
            )
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='Application.UpWorkflow',
                validating_effects=validating_effects,
                context=context,
            )
            return response
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Application.UpWorkflowAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') {type(exception).__name__}: {exception}"
            )


    async def _schedule_UpWorkflow(
        self,
        *,
        request: rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest,
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            method='UpWorkflow',
        ...
        response = rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse()
        ...
        async with self._state_manager.transactionally(
            ...
            # Try to verify the token if a token verifier exists.
            context.auth = await self._maybe_verify_token(
                headers=headers, method='UpWorkflow'
            )
            ...
            async with self._state_manager.writer(
                ...
                transaction=transaction,
                authorize=self._maybe_authorize(
                    method_name='rbt.cloud.v1alpha1.application.ApplicationMethods.UpWorkflow',
                    headers=context._headers,
                    auth=context.auth,
                    request=request,
                ),
    ...
    async def UpWorkflow(
        ...
        async def _run(
            ...
            try:
                ...
                context, response = await self._schedule_UpWorkflow(
                    headers=headers,
                    request=request,
                    grpc_context=grpc_context,
                )
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.Down') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Down') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Down') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
    ...
    async def _Down(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='Down'
        )
    ...
    async def __DownWorkflow(
        self,
        context: IMPORT_reboot_aio_contexts.WorkflowContext,
        request: rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest,
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse:
        try:
            response = (
                await self._servicer._DownWorkflow(
                    context=context,
                    request=request
                )
            )
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='Application.DownWorkflow',
                validating_effects=validating_effects,
                context=context,
            )
            return response
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Application.DownWorkflowAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') {type(exception).__name__}: {exception}"
            )


    async def _schedule_DownWorkflow(
        self,
        *,
        request: rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest,
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            method='DownWorkflow',
        ...
        response = rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse()
        ...
        async with self._state_manager.transactionally(
            ...
            # Try to verify the token if a token verifier exists.
            context.auth = await self._maybe_verify_token(
                headers=headers, method='DownWorkflow'
            )
            ...
            async with self._state_manager.writer(
                ...
                transaction=transaction,
                authorize=self._maybe_authorize(
                    method_name='rbt.cloud.v1alpha1.application.ApplicationMethods.DownWorkflow',
                    headers=context._headers,
                    auth=context.auth,
                    request=request,
                ),
    ...
    async def DownWorkflow(
        ...
        async def _run(
            ...
            try:
                # rebootdev.aio.contexts.WorkflowContext must be scheduled!
                assert headers.task_schedule is not None
                context, response = await self._schedule_DownWorkflow(
                    headers=headers,
                    request=request,
                    grpc_context=grpc_context,
                )
    ...
    async def __RevisionStatus(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse:
        try:
            response = (
                await self._servicer._RevisionStatus(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='Application.RevisionStatus',
                validating_effects=validating_effects,
                context=context,
            )
            return response
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Application.RevisionStatusAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') {type(exception).__name__}: {exception}"
            )
    ...
    async def _RevisionStatus(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='RevisionStatus'
        )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.reader(
                ...
                response = await self.__RevisionStatus(
                    context,
                    state,
                    request,
                    validating_effects=validating_effects,
    ...
    async def _schedule_RevisionStatus(
        self,
        *,
        request: rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest,
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            method='RevisionStatus',
        ...
        response = rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse()
    ...
    async def RevisionStatus(
        ...
        async def _run(
            ...
            try:
                if headers.task_schedule is not None:
                    context, response = await self._schedule_RevisionStatus(
                        headers=headers,
                        request=request,
                        grpc_context=grpc_context,
                    )
                ...
                return await self._RevisionStatus(
                    request,
                    context,
                    validating_effects=validating_effects,
                    grpc_context=grpc_context,
    ...
    async def __Logs(
        ...
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: rbt.cloud.v1alpha1.application.application_pb2.Application,
        request: rbt.cloud.v1alpha1.application.application_pb2.LogsRequest,
        *,
        validating_effects: bool,
    ) -> IMPORT_typing.AsyncIterable[rbt.cloud.v1alpha1.application.application_pb2.LogsResponse]:
        try:
            async for response in self._servicer._Logs(
                ...
                IMPORT_reboot_aio_types.assert_type(response, [rbt.cloud.v1alpha1.application.application_pb2.LogsResponse])
                yield response
        except IMPORT_reboot_aio_contexts.RetryReactively:
            # Retrying reactively, just let this propagate.
            raise
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Application.LogsAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Logs') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Logs') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.Logs') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Logs') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Logs') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Logs') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Logs(
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            authorizer = self._maybe_authorize(
                method_name='rbt.cloud.v1alpha1.application.ApplicationMethods.Logs',
                headers=context._headers,
                auth=context.auth,
                request=request,
            )
    ...
    async def __ActiveRevisions(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse:
        try:
            response = (
                await self._servicer._ActiveRevisions(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='Application.ActiveRevisions',
                validating_effects=validating_effects,
                context=context,
            )
            return response
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Application.ActiveRevisionsAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') {type(exception).__name__}: {exception}"
            )
    ...
    async def _ActiveRevisions(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='ActiveRevisions'
        )
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.reader(
                ...
                response = await self.__ActiveRevisions(
                    context,
                    state,
                    request,
                    validating_effects=validating_effects,
    ...
    async def _schedule_ActiveRevisions(
        self,
        *,
        request: rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest,
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            method='ActiveRevisions',
        ...
        response = rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse()
    ...
    async def ActiveRevisions(
        ...
        async def _run(
            ...
            try:
                if headers.task_schedule is not None:
                    context, response = await self._schedule_ActiveRevisions(
                        headers=headers,
                        request=request,
                        grpc_context=grpc_context,
                    )
                ...
                return await self._ActiveRevisions(
                    request,
                    context,
                    validating_effects=validating_effects,
                    grpc_context=grpc_context,
    ...
    async def __Status(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.StatusResponse:
        try:
            response = (
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='Application.Status',
                validating_effects=validating_effects,
                context=context,
            )
            return response
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Application.StatusAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Status') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Status') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.Status') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Status') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Status') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.Status') {type(exception).__name__}: {exception}"
            )
    ...
    async def _schedule_Status(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.StatusResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            method='Status',
        ...
        response = rbt.cloud.v1alpha1.application.application_pb2.StatusResponse()
    ...
    async def __IsAdmin(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse:
        try:
            response = (
                await self._servicer._IsAdmin(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='Application.IsAdmin',
                validating_effects=validating_effects,
                context=context,
            )
            return response
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = Application.IsAdminAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') {type(exception).__name__}: {exception}"
            )
    ...
    async def _IsAdmin(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='IsAdmin'
        )
    ...
    async def _schedule_IsAdmin(
        self,
        *,
        request: rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest,
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.application.Application'),
            method='IsAdmin',
        ...
        response = rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse()
    ...
    async def IsAdmin(
        ...
        async def _run(
            ...
            try:
                if headers.task_schedule is not None:
                    context, response = await self._schedule_IsAdmin(
                        headers=headers,
                        request=request,
                        grpc_context=grpc_context,
                    )
        ...
        *,
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_cloud_v1alpha1_application_applicationmethods_stub.PushInfo,
                request,
                unary=True,
                reader=True,
                response_type=rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse,
                aborted_type=Application.PushInfoAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse,
                )
        return await call()
        ...
        *,
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_cloud_v1alpha1_application_applicationmethods_stub.RevisionStatus,
                request,
                unary=True,
                reader=True,
                response_type=rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse,
                aborted_type=Application.RevisionStatusAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse,
                )
        return await call()
        ...
        *,
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_cloud_v1alpha1_application_applicationmethods_stub.Logs,
                request,
                unary=False,
                reader=True,
                response_type=rbt.cloud.v1alpha1.application.application_pb2.LogsResponse,
                aborted_type=Application.LogsAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        *,
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_cloud_v1alpha1_application_applicationmethods_stub.ActiveRevisions,
                request,
                unary=True,
                reader=True,
                response_type=rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse,
                aborted_type=Application.ActiveRevisionsAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse,
                )
        return await call()
        ...
        *,
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_cloud_v1alpha1_application_applicationmethods_stub.Status,
                request,
                unary=True,
                reader=True,
                response_type=rbt.cloud.v1alpha1.application.application_pb2.StatusResponse,
                aborted_type=Application.StatusAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.cloud.v1alpha1.application.application_pb2.StatusResponse,
                )
        return await call()
        ...
        *,
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_cloud_v1alpha1_application_applicationmethods_stub.IsAdmin,
                request,
                unary=True,
                reader=True,
                response_type=rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse,
                aborted_type=Application.IsAdminAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse,
                )
        return await call()
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                IMPORT_reboot_aio_types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationMethods'),
                'UpWorkflow',
                self._rbt_cloud_v1alpha1_application_applicationmethods_stub.UpWorkflow,
                request,
                unary=True,
                reader=False,
                response_type=rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse,
                aborted_type=Application.UpWorkflowAborted,
                metadata=metadata,
                idempotency_key=idempotency_key,
                bearer_token=bearer_token,
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                IMPORT_reboot_aio_types.ServiceName('rbt.cloud.v1alpha1.application.ApplicationMethods'),
                'DownWorkflow',
                self._rbt_cloud_v1alpha1_application_applicationmethods_stub.DownWorkflow,
                request,
                unary=True,
                reader=False,
                response_type=rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse,
                aborted_type=Application.DownWorkflowAborted,
                metadata=metadata,
                idempotency_key=idempotency_key,
                bearer_token=bearer_token,
...
class ApplicationServicerTasks:
...
ApplicationRequestTypes: IMPORT_typing.TypeAlias = \
        ...
        | rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.UpRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.DownRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.LogsRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.StatusRequest \
        | rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest

class ApplicationAuthorizer(
    IMPORT_rebootdev.aio.auth.authorizers.Authorizer[ApplicationStateType, ApplicationRequestTypes],
):
    ...
    def __init__(
        ...
        *,
        ...
        PushInfo: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest,
            ]
        ] = None,
        push_info: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest,
            ]
        ] = None,
        Up: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.UpRequest,
            ]
        ...
        UpWorkflow: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest,
            ]
        ] = None,
        up_workflow: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest,
            ]
        ] = None,
        Down: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.DownRequest,
            ]
        ...
        DownWorkflow: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest,
            ]
        ] = None,
        down_workflow: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest,
            ]
        ] = None,
        RevisionStatus: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest,
            ]
        ] = None,
        revision_status: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest,
            ]
        ...
        ActiveRevisions: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest,
            ]
        ] = None,
        active_revisions: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest,
            ]
        ...
        IsAdmin: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest,
            ]
        ] = None,
        is_admin: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.application.application_pb2.Application,
              rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest,
            ]
        ...
        if push_info is not None and PushInfo is not None:
            raise ValueError(
                f"Cannot specify both 'PushInfo' and 'push_info' authorizer rules"
            )
        self._push_info = push_info or PushInfo
        if up is not None and Up is not None:
            raise ValueError(
                f"Cannot specify both 'Up' and 'up' authorizer rules"
            )
        self._up = up or Up
        if up_workflow is not None and UpWorkflow is not None:
            raise ValueError(
                f"Cannot specify both 'UpWorkflow' and 'up_workflow' authorizer rules"
            )
        self._up_workflow = up_workflow or UpWorkflow
        if down is not None and Down is not None:
            raise ValueError(
                f"Cannot specify both 'Down' and 'down' authorizer rules"
            )
        self._down = down or Down
        if down_workflow is not None and DownWorkflow is not None:
            raise ValueError(
                f"Cannot specify both 'DownWorkflow' and 'down_workflow' authorizer rules"
            )
        self._down_workflow = down_workflow or DownWorkflow
        if revision_status is not None and RevisionStatus is not None:
            raise ValueError(
                f"Cannot specify both 'RevisionStatus' and 'revision_status' authorizer rules"
            )
        self._revision_status = revision_status or RevisionStatus
        if logs is not None and Logs is not None:
            raise ValueError(
                f"Cannot specify both 'Logs' and 'logs' authorizer rules"
            )
        self._logs = logs or Logs
        if active_revisions is not None and ActiveRevisions is not None:
            raise ValueError(
                f"Cannot specify both 'ActiveRevisions' and 'active_revisions' authorizer rules"
            )
        self._active_revisions = active_revisions or ActiveRevisions
        ...
        if is_admin is not None and IsAdmin is not None:
            raise ValueError(
                f"Cannot specify both 'IsAdmin' and 'is_admin' authorizer rules"
            )
        self._is_admin = is_admin or IsAdmin
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[ApplicationStateType],
        request: IMPORT_typing.Optional[ApplicationRequestTypes],
        **kwargs,
        ...
        if method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Create':
            return await self.Create(
                context=context,
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.CreateRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.PushInfo':
            return await self.PushInfo(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Up':
            return await self.Up(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.UpWorkflow':
            return await self.UpWorkflow(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Down':
            return await self.Down(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.DownWorkflow':
            return await self.DownWorkflow(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.RevisionStatus':
            return await self.RevisionStatus(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Logs':
            return await self.Logs(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.LogsRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.ActiveRevisions':
            return await self.ActiveRevisions(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Status':
            return await self.Status(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.StatusRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.IsAdmin':
            return await self.IsAdmin(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest, request),
            )
        else:
    ...
    # For 'rbt.cloud.v1alpha1.application.ApplicationMethods.PushInfo'.
    async def PushInfo(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        ...
        return await (self._push_info or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest, request),
        )
    ...
    async def Up(
        ...
        *,
        ...
        return await (self._up or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpRequest, request),
        )

    # For 'rbt.cloud.v1alpha1.application.ApplicationMethods.UpWorkflow'.
    async def UpWorkflow(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        ...
        return await (self._up_workflow or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest, request),
        )
    ...
    async def Down(
        ...
        *,
        ...
        return await (self._down or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownRequest, request),
        )

    # For 'rbt.cloud.v1alpha1.application.ApplicationMethods.DownWorkflow'.
    async def DownWorkflow(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        ...
        return await (self._down_workflow or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest, request),
        )

    # For 'rbt.cloud.v1alpha1.application.ApplicationMethods.RevisionStatus'.
    async def RevisionStatus(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        ...
        return await (self._revision_status or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest, request),
        )

    # For 'rbt.cloud.v1alpha1.application.ApplicationMethods.Logs'.
    async def Logs(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.cloud.v1alpha1.application.ApplicationMethods.ActiveRevisions'.
    async def ActiveRevisions(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        ...
        return await (self._active_revisions or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest, request),
        )

    # For 'rbt.cloud.v1alpha1.application.ApplicationMethods.Status'.
    async def Status(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.cloud.v1alpha1.application.ApplicationMethods.IsAdmin'.
    async def IsAdmin(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        ...
        return await (self._is_admin or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest, request),
        )
...
class ApplicationBaseServicer(IMPORT_reboot_aio_servicers.Servicer):
    ...
    class InlineWriterCallable(IMPORT_typing.Protocol[InlineWriterCallableResult]):
        async def __call__(
            self,
            state: rbt.cloud.v1alpha1.application.application_pb2.Application
        ) -> ApplicationBaseServicer.InlineWriterCallableResult:
            ...
    ...
    class WorkflowState:
        ...
        async def write(
            ...
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: ApplicationBaseServicer.InlineWriterCallable[None],
        ...
        async def write(
            ...
            idempotency_alias: str,
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: ApplicationBaseServicer.InlineWriterCallable[ApplicationBaseServicer.InlineWriterCallableResult],
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            *,
            type: type[ApplicationBaseServicer.InlineWriterCallableResult],
        ) -> ApplicationBaseServicer.InlineWriterCallableResult:
            ...
            ...
            async def _read(
                ...
                with context.idempotently(
                    ...
                    return await IMPORT_reboot_aio_workflows.at_least_once(
                        ...
                        context,
                        read,
                        type=rbt.cloud.v1alpha1.application.application_pb2.Application,
                    )
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: ApplicationBaseServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                method_name = f"Application.{task.method_name} inline writer"
        ...
        def per_workflow(self, alias: IMPORT_typing.Optional[str] = None):
            return ApplicationBaseServicer.WorkflowState._Idempotently(
        ...
        class _Always:
            ...
            async def read(
                ...
                return await ApplicationBaseServicer.WorkflowState._Idempotently(
                    servicer=self._servicer,
                    alias=None,
        ...
        def always(self):
            return ApplicationBaseServicer.WorkflowState._Always(
                servicer=self._servicer,
            )
...
class ApplicationSingletonServicer(ApplicationBaseServicer):

    @property
    def state(self):
        return ApplicationBaseServicer.WorkflowState(
            servicer=self
        )
    ...
    async def DownWorkflow(
        ...
        # overrides the 'PascalCase' version - it will override that
        # method and will just work.
        return await self.down_workflow(
            context,
            request,
        )
    ...
    async def RevisionStatus(
        ...
        # overrides the 'PascalCase' version - it will override that
        # method and will just work.
        return await self.revision_status(
            context,
            state,
            request,
        )
    ...
    async def ActiveRevisions(
        ...
        # overrides the 'PascalCase' version - it will override that
        # method and will just work.
        return await self.active_revisions(
            context,
            state,
            request,
        )
    ...
    async def _Create(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
    ...
    async def _PushInfo(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.PushInfo()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _Up(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.Up()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            return await self.Up(context, state, request)
    ...
    async def _UpWorkflow(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.UpWorkflow()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            return await self.UpWorkflow(context, request)
    ...
    async def _Down(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.Down()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            return await self.Down(context, state, request)
    ...
    async def _DownWorkflow(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.DownWorkflow()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            return await self.DownWorkflow(context, request)
    ...
    async def _RevisionStatus(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.RevisionStatus()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
    ...
    async def _ActiveRevisions(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.ActiveRevisions()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
                self.ActiveRevisions(
                    context,
                    state,
                    request,
                )
    ...
    async def _IsAdmin(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.IsAdmin()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
...
class ApplicationServicer(ApplicationBaseServicer):

    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.cloud.v1alpha1.application.application_pb2.Application]
    ...
    _instances: dict[str, ApplicationServicer] = {}

    def _instance(self, state_id: str):
        instances = ApplicationServicer._instances
    ...
    @property
    def state(self) -> rbt.cloud.v1alpha1.application.application_pb2.Application:
        state = ApplicationServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = ApplicationServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.cloud.v1alpha1.application.application_pb2.Application):
        state = ApplicationServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def Logs(
        ...
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        request: rbt.cloud.v1alpha1.application.application_pb2.LogsRequest,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.LogsResponse:
        # During the migration from 'PascalCase' to 'snake_case' method
        # naming in Python servicers, we call the 'snake_case' version
        # by default, so new names will do the correct thing making the
        # code to be backwards compatible for some time and if a servicer
    ...
    async def _Create(
        ...
        # `_state is None`.
        assert ApplicationServicer._state.get() is None
        ApplicationServicer._state.set(state)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            ...
            ApplicationServicer._state.set(None)
    ...
    async def _PushInfo(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.PushInfo()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.PushInfo(context, request)
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _Up(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.Up()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.Up(context, request)
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _UpWorkflow(
        ...
        ApplicationServicer._workflow.set(True)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.UpWorkflow()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.UpWorkflow(context, request)
        finally:
            ApplicationServicer._workflow.set(False)
    ...
    async def _Down(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.Down()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.Down(context, request)
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _DownWorkflow(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.DownWorkflow()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.DownWorkflow(context, request)
        finally:
            ApplicationServicer._workflow.set(False)
    ...
    async def _RevisionStatus(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.RevisionStatus()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.RevisionStatus(context, request)
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _ActiveRevisions(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.ActiveRevisions()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.ActiveRevisions(context, request)
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _Status(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Status(context, request)
        finally:
            ApplicationServicer._state.set(None)
    ...
    async def _IsAdmin(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.cloud.v1alpha1.application.Application('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.IsAdmin()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.IsAdmin(context, request)
        finally:
            ApplicationServicer._state.set(None)
...
Application_UntilCallableType = IMPORT_typing.TypeVar('Application_UntilCallableType')

class ApplicationSingleton:
    Servicer: IMPORT_typing.TypeAlias = ApplicationSingletonServicer
...
class Application:
    ...
    singleton: IMPORT_typing.TypeAlias = ApplicationSingleton

    Effects: IMPORT_typing.TypeAlias = ApplicationBaseServicer.Effects
    ...
    class PushInfoTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class PushInfoAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    UpEffects: IMPORT_typing.TypeAlias = ApplicationBaseServicer.UpEffects

    class UpAborted(IMPORT_rebootdev.aio.aborted.Aborted):

        MethodError = IMPORT_typing.Union[
            rbt.cloud.v1alpha1.application.application_pb2.InvalidInputError,             rbt.cloud.v1alpha1.application.application_pb2.ConcurrentModificationError        ]
        ...
        def is_declared_error(cls, message: IMPORT_google_protobuf_message.Message) -> bool:
            if message.DESCRIPTOR.full_name == 'rbt.cloud.v1alpha1.application.InvalidInputError':
                return True
            elif message.DESCRIPTOR.full_name == 'rbt.cloud.v1alpha1.application.ConcurrentModificationError':
                return True
            return False

    class UpWorkflowTask:
        """Represents a scheduled task running for the
        state. Note that this is not a coroutine because we are trying
        to convey the semantics that the task is already running (or
        will soon be).
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class UpWorkflowAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    DownEffects: IMPORT_typing.TypeAlias = ApplicationBaseServicer.DownEffects

    class DownAborted(IMPORT_rebootdev.aio.aborted.Aborted):
        ...
        @classmethod
        def is_declared_error(cls, message: IMPORT_google_protobuf_message.Message) -> bool:
            if message.DESCRIPTOR.full_name == 'rbt.cloud.v1alpha1.application.ConcurrentModificationError':
                return True
            return False

    class DownWorkflowTask:
        """Represents a scheduled task running for the
        state. Note that this is not a coroutine because we are trying
        to convey the semantics that the task is already running (or
        will soon be).
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class DownWorkflowAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class RevisionStatusTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class RevisionStatusAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class LogsTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.LogsResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.LogsResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    response = rbt.cloud.v1alpha1.application.application_pb2.LogsResponse()
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.cloud.v1alpha1.application.application_pb2.LogsResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class ActiveRevisionsTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class ActiveRevisionsAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class StatusTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.StatusResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.StatusResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.cloud.v1alpha1.application.application_pb2.StatusResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class IsAdminTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class IsAdminAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class WeakReference(IMPORT_typing.Generic[Application_ScheduleTypeVar]):
        ...
        def __init__(
            ...
            *,
            ...
            bearer_token: IMPORT_typing.Optional[str] = None,
            servicer: IMPORT_typing.Optional[ApplicationBaseServicer] = None,
        ):
        ...
        def _reader(
            ...
            if self._idempotency_manager is None:
                ...
                raise IMPORT_reboot_aio_call.MixedContextsError(
                    ...
                    f"`Application.ref('{self.state_id}')`."
                )
        ...
        class _Reactively:
            ...
            async def PushInfo(
            ...
            ) -> IMPORT_typing.AsyncIterator[rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest)
                ...
                __request__ = rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest(
                )
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse()
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.cloud.v1alpha1.application.ApplicationMethods.PushInfo' "
            ...
            async def RevisionStatus(
                ...
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                revision_number: IMPORT_typing.Optional[int] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest(
                    revision_number=revision_number,  # type: ignore[arg-type]
                )
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse()
                                __response__.ParseFromString(__query_response__.response)
                                yield __response__
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.cloud.v1alpha1.application.ApplicationMethods.RevisionStatus' "
                                f"failed with a retryable error: '{exception}'; "
                                "will retry..."
                            )
                            await __query_backoff__()
            ...
            async def ActiveRevisions(
                ...
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest(
                )
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse()
                                __response__.ParseFromString(__query_response__.response)
                                yield __response__
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.cloud.v1alpha1.application.ApplicationMethods.ActiveRevisions' "
                                f"failed with a retryable error: '{exception}'; "
                                "will retry..."
                            )
                            await __query_backoff__()
            ...
            async def Status(
                ...
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.cloud.v1alpha1.application.application_pb2.StatusResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.StatusRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.StatusRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.cloud.v1alpha1.application.application_pb2.StatusRequest(
                )
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.cloud.v1alpha1.application.application_pb2.StatusResponse()
                                __response__.ParseFromString(__query_response__.response)
                                yield __response__
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.cloud.v1alpha1.application.ApplicationMethods.Status' "
                                f"failed with a retryable error: '{exception}'; "
                                "will retry..."
                            )
                            await __query_backoff__()
            ...
            ) -> IMPORT_typing.AsyncIterator[rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest(
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse()
                                __response__.ParseFromString(__query_response__.response)
                                yield __response__
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.cloud.v1alpha1.application.ApplicationMethods.IsAdmin' "
                                f"failed with a retryable error: '{exception}'; "
                                "will retry..."
                            )
                            await __query_backoff__()
        ...
        class _Idempotently(IMPORT_typing.Generic[Application_IdempotentlyScheduleTypeVar]):
            ...
            def spawn(
                ...
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
            ) -> Application.WeakReference._Spawn:
                return Application.WeakReference._Spawn(
                    self._weak_reference._application_id,
                    self._weak_reference._tasks,
                    when=when,
                    idempotency=self._idempotency,
            ...
            async def read(
                ...
                return await ApplicationBaseServicer.WorkflowState._Idempotently._read(
            ...
            async def write(
                ...
                *,
                ...
                return await ApplicationBaseServicer.WorkflowState._Idempotently._write_validating_effects(
                    self._weak_reference._servicer,
                    self._idempotency,
                    context,
                    writer,
            ...
            async def PushInfo(
                ...
                return await __this__._weak_reference.PushInfo(
                    __context__,
                    __options__,
                )
            ...
            async def Up(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
                *,
                digest: IMPORT_typing.Optional[str] = None,
            ) -> rbt.cloud.v1alpha1.application.application_pb2.UpResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
            ...
            async def UpWorkflow(
                ...
                *,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest)
                ...
                def error_message_supplement():
                    if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                        return f"'UpWorkflow' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].schedule([...]).UpWorkflow(context, [...])`"
                    else:
                        return f"'UpWorkflow' is a workflow and can not be called from '{type(__context__).__name__}'"
                ...
                return await (
                    await __this__.spawn().UpWorkflow(
                        __context__,
                        __options__,
            ...
            async def DownWorkflow(
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest)

                def error_message_supplement():
                    if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                        return f"'DownWorkflow' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].schedule([...]).DownWorkflow(context, [...])`"
                    else:
                        return f"'DownWorkflow' is a workflow and can not be called from '{type(__context__).__name__}'"
                ...
                return await (
                    await __this__.spawn().DownWorkflow(
                        __context__,
                        __options__,
                    )
                )
            ...
            async def RevisionStatus(
                ...
                *,
                ...
                return await __this__._weak_reference.RevisionStatus(
                    __context__,
                    __options__,
                    revision_number=revision_number,
                )
            ...
            async def ActiveRevisions(
                ...
                return await __this__._weak_reference.ActiveRevisions(
                    __context__,
                    __options__,
                )
            ...
            async def IsAdmin(
                ...
                *,
                ...
                return await __this__._weak_reference.IsAdmin(
                    __context__,
                    __options__,
                    user_id=user_id,
                )
        ...
        @IMPORT_typing.overload
        def idempotently(self, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> Application.WeakReference._Idempotently[Application_ScheduleTypeVar]:
            ...

        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID, generated: bool = False) -> Application.WeakReference._Idempotently[Application_ScheduleTypeVar]:
            ...
        ...
        class _UntilChangesSatisfies(IMPORT_typing.Generic[Application_UntilCallableType]):

            _idempotency_alias: str
            _context: IMPORT_reboot_aio_contexts.WorkflowContext
            _callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[Application_UntilCallableType]]
            _type: type[Application_UntilCallableType]
            ...
            def __init__(
                ...
                *,
                idempotency_alias: str,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[Application_UntilCallableType]],
                type: type[Application_UntilCallableType],
            ):
            ...
            async def satisfies(
                self,
                condition: IMPORT_typing.Callable[[Application_UntilCallableType], bool],
            ):
        ...
        class _Until:
            ...
            _weak_reference: Application.WeakReference
            _idempotency_alias: str
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> Application.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.application.application_pb2.Application]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
                ...
                return Application.WeakReference._UntilChangesSatisfies(
            ...
            def PushInfo(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            ) -> Application.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def RevisionStatus(
                ...
                *,
                revision_number: IMPORT_typing.Optional[int] = None,
            ) -> Application.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def ActiveRevisions(
                ...
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext,
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            ) -> Application.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def Status(
                ...
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext,
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            ) -> Application.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.application.application_pb2.StatusResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def IsAdmin(
                ...
                *,
                user_id: IMPORT_typing.Optional[str] = None,
            ) -> Application.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        def until(self, alias: str):
            return Application.WeakReference._Until(
                weak_reference=self,
        ...
        class _Schedule:
            ...
            async def Up(
                ...
                *,
                ...
                if digest is not None and not isinstance(
                    digest,
                    str,
                ):
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.cloud.v1alpha1.application.application_pb2.UpRequest': field 'digest' is not "
            ...
            async def UpWorkflow(
                ...
                *,
                ...
                if revision_number is not None and not isinstance(
                    revision_number,
                    int,
                ):
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest': field 'revision_number' is not "
                        f"of required type 'int'"
                    )
                # TODO: mypy-protobuf declares that
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest(
                    revision_number=revision_number,  # type: ignore[arg-type]
                )
            ...
            async def DownWorkflow(
                ...
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest(
                )
            ...
            async def RevisionStatus(
                ...
                *,
                ...
                if revision_number is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest': field 'revision_number' is not "
                        f"of required type 'int'"
                    )
                # TODO: mypy-protobuf declares that
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
            ...
            async def IsAdmin(
                ...
                *,
                ...
                if user_id is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest': field 'user_id' is not "
                        f"of required type 'str'"
                    )
                # TODO: mypy-protobuf declares that
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
        ...
        class _WriterSchedule:
            ...
            async def PushInfo(
                ...
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WriterContext):
                    return (await ApplicationServicerTasks(
                        context=__context__,
        ...
        class _Spawn:
            ...
            async def PushInfo(
                ...
                return Application.PushInfoTask(
                    __context__,
                    task_id=__task_id__,
                )
            ...
            async def UpWorkflow(
                ...
                *,
                ...
                return Application.UpWorkflowTask(
                    __context__,
                    task_id=__task_id__,
                )
            ...
            async def DownWorkflow(
                ...
                return Application.DownWorkflowTask(
                    __context__,
                    task_id=__task_id__,
                )
            ...
            async def RevisionStatus(
                ...
                *,
                revision_number: IMPORT_typing.Optional[int] = None,
            ) -> Application.RevisionStatusTask:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest)
                ...
                return Application.RevisionStatusTask(
                    __context__,
                    task_id=__task_id__,
                )
            ...
            async def ActiveRevisions(
                ...
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> Application.ActiveRevisionsTask:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest)
                ...
                return Application.ActiveRevisionsTask(
                    __context__,
                    task_id=__task_id__,
                )
            ...
            async def IsAdmin(
                ...
                *,
                ...
                return Application.IsAdminTask(
                    __context__,
                    task_id=__task_id__,
                )
        ...
        async def PushInfo(
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().PushInfo(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                    )
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).PushInfo(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
            ...
            *,
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().Up(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                        digest=digest,
                    )
            ...
            *,
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'UpWorkflow' is a workflow and can not be called from a '{type(__context__).__name__}'"
        ...
        async def Down(
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().Down(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                    )
        ...
        async def DownWorkflow(
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'DownWorkflow' is a workflow and can not be called from a '{type(__context__).__name__}'"
            ...
            *,
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().RevisionStatus(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                        revision_number=revision_number,
                    )
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).RevisionStatus(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
                idempotency=__options__.idempotency if __options__ is not None else None,
        ...
        async def Logs(
            ...
            __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            *,
            last: IMPORT_typing.Optional[int] = None,
            follow: IMPORT_typing.Optional[bool] = None,
            revisions: IMPORT_typing.Optional[IMPORT_typing.Iterable[rbt.cloud.v1alpha1.logs.logs_pb2.LogsRequest.RevisionFilter]] = None,
            revision_numbers: IMPORT_typing.Optional[IMPORT_typing.Iterable[int]] = None,
            sources: IMPORT_typing.Optional[IMPORT_typing.Iterable[int]] = None,
        ) -> IMPORT_typing.AsyncIterable[rbt.cloud.v1alpha1.application.application_pb2.LogsResponse]:
            # UX improvement: check that neither positional argument was accidentally
            # given a gRPC request type.
            IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.application.application_pb2.LogsRequest)
            IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.application.application_pb2.LogsRequest)
            ...
            if last is not None and not isinstance(
                ...
                raise TypeError(
                    f"Can not construct protobuf message of type "
                    f"'rbt.cloud.v1alpha1.application.application_pb2.LogsRequest': field 'last' is not "
                    f"of required type 'int'"
                )
            if follow is not None and not isinstance(
                follow,
                bool,
            ):
                raise TypeError(
                    f"Can not construct protobuf message of type "
                    f"'rbt.cloud.v1alpha1.application.application_pb2.LogsRequest': field 'follow' is not "
                    f"of required type 'bool'"
                )
            if revisions is not None and not isinstance(
                revisions,
                IMPORT_typing.Iterable,
            ):
                raise TypeError(
                    f"Can not construct protobuf message of type "
                    f"'rbt.cloud.v1alpha1.application.application_pb2.LogsRequest': field 'revisions' is not "
                    f"of required type 'typing.Iterable[rbt.cloud.v1alpha1.logs.logs_pb2.LogsRequest.RevisionFilter]'"
                )
            if revision_numbers is not None and not isinstance(
                revision_numbers,
                IMPORT_typing.Iterable,
            ):
                raise TypeError(
                    f"Can not construct protobuf message of type "
                    f"'rbt.cloud.v1alpha1.application.application_pb2.LogsRequest': field 'revision_numbers' is not "
            ...
            if sources is not None and not isinstance(
                ...
                raise TypeError(
                    f"Can not construct protobuf message of type "
                    f"'rbt.cloud.v1alpha1.application.application_pb2.LogsRequest': field 'sources' is not "
                    f"of required type 'typing.Iterable[int]'"
                )
            # TODO: mypy-protobuf declares that
            # `google.protobuf.message.Message` constructor arguments are
            # always non-None, when in reality they are optional.
            __request__ = rbt.cloud.v1alpha1.application.application_pb2.LogsRequest(
                last=last,  # type: ignore[arg-type]
                follow=follow,  # type: ignore[arg-type]
                revisions=revisions,  # type: ignore[arg-type]
                revision_numbers=revision_numbers,  # type: ignore[arg-type]
        ...
        async def ActiveRevisions(
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().ActiveRevisions(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                    )
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).ActiveRevisions(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
                idempotency=__options__.idempotency if __options__ is not None else None,
        ...
        async def Status(
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).Status(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
                idempotency=__options__.idempotency if __options__ is not None else None,
            ...
            *,
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().IsAdmin(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                        user_id=user_id,
                    )
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).IsAdmin(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
                idempotency=__options__.idempotency if __options__ is not None else None,
    ...
    class _Forall:
        ...
        async def PushInfo(
            ...
            __context__: IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WriterContext | IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse]:
        ...
        async def Up(
            ...
            *,
            digest: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.cloud.v1alpha1.application.application_pb2.UpResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Application.ref(
                        id
        ...
        async def Down(
            ...
            __context__: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.cloud.v1alpha1.application.application_pb2.DownResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Application.ref(
                        id
        ...
        async def RevisionStatus(
            ...
            *,
            revision_number: IMPORT_typing.Optional[int] = None,
        ) -> list[rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Application.ref(
                        id
        ...
        async def ActiveRevisions(
            ...
            __context__: IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WriterContext | IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Application.ref(
                        id
        ...
        async def Status(
            ...
            __context__: IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WriterContext | IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.cloud.v1alpha1.application.application_pb2.StatusResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Application.ref(
                        id
        ...
        async def IsAdmin(
            ...
            *,
            user_id: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Application.ref(
                        id
    ...
    @classmethod
    def forall(cls, ids: list[str]) -> Application._Forall:
        return Application._Forall(ids)
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> Application._ConstructIdempotently:
        ...

    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID, generated: bool = False) -> Application._ConstructIdempotently:
        ...
...
class ApplicationServicerNodeAdaptor(Application.singleton.Servicer):
            ...
            try:
                ...
                if result.HasField('state'):
                    with IMPORT_reboot_aio_tracing.span(
                        ...
                        state.CopyFrom(
                            rbt.cloud.v1alpha1.application.application_pb2.Application.FromString(
                                result.state
                            )
                        )
                ...
                with IMPORT_reboot_aio_tracing.span(
                    ...
                    return rbt.cloud.v1alpha1.application.application_pb2.CreateResponse.FromString(result.response)
    ...
    async def PushInfo(
        ...
        try:
            ...
            return rbt.cloud.v1alpha1.application.application_pb2.PushInfoResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from PushInfo")
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            try:
                ...
                with IMPORT_reboot_aio_tracing.span(
                    ...
                    return rbt.cloud.v1alpha1.application.application_pb2.UpResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from Up")
    ...
    async def UpWorkflow(
        ...
        try:
            ...
            assert result.HasField('response')
            return rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from UpWorkflow")
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            try:
                ...
                with IMPORT_reboot_aio_tracing.span(
                    ...
                    return rbt.cloud.v1alpha1.application.application_pb2.DownResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from Down")
    ...
    async def DownWorkflow(
        ...
        try:
            ...
            assert result.HasField('response')
            return rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from DownWorkflow")
    ...
    async def RevisionStatus(
        ...
        try:
            ...
            return rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from RevisionStatus")
    ...
    async def ActiveRevisions(
        ...
        try:
            ...
            return rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from ActiveRevisions")
    ...
    async def Status(
        ...
        try:
            ...
            return rbt.cloud.v1alpha1.application.application_pb2.StatusResponse.FromString(result.response)
    ...
    async def IsAdmin(
        ...
        try:
            ...
            return rbt.cloud.v1alpha1.application.application_pb2.IsAdminResponse.FromString(result.response)
        raise RuntimeError("Unexpected result from IsAdmin")
