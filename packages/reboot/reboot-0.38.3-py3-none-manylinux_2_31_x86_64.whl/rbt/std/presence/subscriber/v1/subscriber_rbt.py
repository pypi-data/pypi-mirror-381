        ...
        *,
        ...
        if 'Create' == task.method_name:
            if only_validate:
                ...
                return rbt.std.presence.subscriber.v1.subscriber_pb2.CreateResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SubscriberWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.presence.subscriber.v1.subscriber_pb2.CreateRequest, task.request),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SubscriberWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.presence.subscriber.v1.subscriber_pb2.ToggleResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SubscriberWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.presence.subscriber.v1.subscriber_pb2.ToggleRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=IMPORT_reboot_aio_idempotency.Idempotency(
                                alias=f'Task {IMPORT_uuid.UUID(bytes=task.task_id.task_uuid)}',
                            ),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.presence.subscriber.v1.subscriber_pb2.WaitForDisconnectResponse()
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.presence.subscriber.v1.subscriber_pb2.StatusResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SubscriberWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.presence.subscriber.v1.subscriber_pb2.StatusRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
...
class SubscriberSingletonServicer(SubscriberBaseServicer):
    ...
    async def WaitForDisconnect(
        ...
        # overrides the 'PascalCase' version - it will override that
        # method and will just work.
        return await self.wait_for_disconnect(
            context,
            request,
        )
    ...
    async def _Toggle(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.Toggle(context, state, request)
    ...
    async def _WaitForDisconnect(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.WaitForDisconnect(context, request)
...
class SubscriberServicer(SubscriberBaseServicer):
    ...
    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.std.presence.subscriber.v1.subscriber_pb2.Subscriber]
    ...
    @property
    def state(self) -> rbt.std.presence.subscriber.v1.subscriber_pb2.Subscriber:
        state = SubscriberServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = SubscriberServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.std.presence.subscriber.v1.subscriber_pb2.Subscriber):
        state = SubscriberServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Connect(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Connect(context, request)
        finally:
            SubscriberServicer._state.set(None)
    ...
    async def _Toggle(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Toggle(context, request)
        finally:
            SubscriberServicer._state.set(None)
    ...
    async def _WaitForDisconnect(
        ...
        SubscriberServicer._workflow.set(True)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.WaitForDisconnect(context, request)
        finally:
            SubscriberServicer._workflow.set(False)
...
class Subscriber:
    ...
    class CreateTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.subscriber.v1.subscriber_pb2.CreateResponse]:
    ...
    class ConnectTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class ToggleTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.subscriber.v1.subscriber_pb2.ToggleResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class WaitForDisconnectTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.subscriber.v1.subscriber_pb2.WaitForDisconnectResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class StatusTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.presence.subscriber.v1.subscriber_pb2.StatusResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class WeakReference(IMPORT_typing.Generic[Subscriber_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def Connect(
                ...
                *,
                nonce: IMPORT_typing.Optional[str] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectRequest)
                ...
                __request__ = rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectRequest(
            ...
            async def Status(
                ...
                __context__: IMPORT_reboot_aio_external.ExternalContext | IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WorkflowContext,
                __options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.std.presence.subscriber.v1.subscriber_pb2.StatusResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.StatusRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.StatusRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.presence.subscriber.v1.subscriber_pb2.StatusRequest(
                )
        ...
        class _Idempotently(IMPORT_typing.Generic[Subscriber_IdempotentlyScheduleTypeVar]):
            ...
            async def Create(
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.CreateRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.CreateRequest)
            ...
            async def Toggle(
                ...
                *,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.ToggleRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.ToggleRequest)
            ...
            async def WaitForDisconnect(
                ...
                *,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.WaitForDisconnectRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.presence.subscriber.v1.subscriber_pb2.WaitForDisconnectRequest)
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> Subscriber.WeakReference._UntilChangesSatisfies[rbt.std.presence.subscriber.v1.subscriber_pb2.Subscriber]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def Connect(
                ...
                *,
                nonce: IMPORT_typing.Optional[str] = None,
            ) -> Subscriber.WeakReference._UntilChangesSatisfies[rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def Status(
                ...
                __context__: IMPORT_reboot_aio_contexts.WorkflowContext,
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            ) -> Subscriber.WeakReference._UntilChangesSatisfies[rbt.std.presence.subscriber.v1.subscriber_pb2.StatusResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        class _Schedule:
            ...
            async def Create(
                ...
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.presence.subscriber.v1.subscriber_pb2.CreateRequest(
                )
            ...
            async def Connect(
                ...
                *,
                ...
                if nonce is not None and not isinstance(
                    nonce,
                    str,
                ):
                    raise TypeError(
            ...
            async def Toggle(
                ...
                *,
                ...
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.presence.subscriber.v1.subscriber_pb2.ToggleRequest(
                    nonce=nonce,  # type: ignore[arg-type]
                )
            ...
            async def WaitForDisconnect(
                ...
                *,
                ...
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.presence.subscriber.v1.subscriber_pb2.WaitForDisconnectRequest(
                    nonce=nonce,  # type: ignore[arg-type]
                )
        ...
        async def Connect(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).Connect(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
        ...
        async def Toggle(
            ...
            *,
            ...
            return await __this__._writer(__context__).Toggle(
                __request__,
                idempotency=__idempotency__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
    ...
    class _Forall:
        ...
        async def Create(
            ...
            __context__: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.std.presence.subscriber.v1.subscriber_pb2.CreateResponse]:
        ...
        async def Connect(
            ...
            *,
            nonce: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.std.presence.subscriber.v1.subscriber_pb2.ConnectResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Subscriber.ref(
                        id
        ...
        async def Toggle(
            ...
            *,
            nonce: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.std.presence.subscriber.v1.subscriber_pb2.ToggleResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Subscriber.ref(
                        id
        ...
        async def Status(
            ...
            __context__: IMPORT_reboot_aio_contexts.ReaderContext | IMPORT_reboot_aio_contexts.WriterContext | IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.std.presence.subscriber.v1.subscriber_pb2.StatusResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Subscriber.ref(
                        id
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> Subscriber.WeakReference[Subscriber.WeakReference._Schedule]:
        return Subscriber.WeakReference(
            # TODO(https://github.com/reboot-dev/mono/issues/3226): add support for calling other applications.
            # For now this always stays within the application that creates the context.
            application_id=None,
