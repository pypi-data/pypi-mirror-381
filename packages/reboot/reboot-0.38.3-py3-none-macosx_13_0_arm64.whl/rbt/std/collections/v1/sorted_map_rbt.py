...
class SortedMapServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):

    def __init__(
        self,
        *,
        servicer: SortedMapBaseServicer,
        ...
        super().__init__(
            ...
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            service_names = [
                IMPORT_reboot_aio_types.ServiceName("rbt.std.collections.v1.SortedMapMethods"),
            ],
        ...
        self.request_type_by_method_name: dict[str, type[IMPORT_google_protobuf_message.Message]] = {
            ...
            'Get': rbt.std.collections.v1.sorted_map_pb2.GetRequest,
            'Range': rbt.std.collections.v1.sorted_map_pb2.RangeRequest,
            'ReverseRange': rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest,
        }
        ...
        self._specified_errors_by_service_method_name: dict[str, list[str]] = {
            'rbt.std.collections.v1.SortedMapMethods.Range': [
                'rbt.std.collections.v1.sorted_map_pb2.InvalidRangeError',
            ],
    ...
    def add_to_server(self, server: IMPORT_grpc.aio.Server) -> None:
        rbt.std.collections.v1.sorted_map_pb2_grpc.add_SortedMapMethodsServicer_to_server(
            self, server
        )
    ...
    async def react_query(
        ...
        if method == 'Insert':
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                request = rbt.std.collections.v1.sorted_map_pb2.GetRequest()
                ...
                async with self._state_manager.reactively(
                    ...
                    authorize=self._maybe_authorize(
                        method_name='rbt.std.collections.v1.SortedMapMethods.Get',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                async with self._state_manager.reactively(
                    ...
                    self._servicer.__state_type__,
                    authorize=self._maybe_authorize(
                        method_name='rbt.std.collections.v1.SortedMapMethods.Range',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                request = rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest()
                request.ParseFromString(request_bytes)
                ...
                async with self._state_manager.reactively(
                    ...
                    self._servicer.__state_type__,
                    authorize=self._maybe_authorize(
                        method_name='rbt.std.collections.v1.SortedMapMethods.ReverseRange',
                        headers=headers,
                        auth=context.auth,
                        request=request,
                    ),
    ...
    async def react_mutate(
        ...
        if method == 'Insert':
            ...
            while True:
                ...
                stub = rbt.std.collections.v1.sorted_map_pb2_grpc.SortedMapMethodsStub(
            ...
            logger.warning(
                ...
                "Method 'Get' is invalid for servicer SortedMap."
                "\n"
            ...
            logger.warning(
                "Got a react mutate request with an invalid method name: "
                "Method 'ReverseRange' is invalid for servicer SortedMap."
                "\n"
                "Do you have an old browser tab still open for an older version "
                "of this application, or a different application all together?"
            )
    ...
    async def dispatch(
        ...
        *,
        ...
        if 'Insert' == task.method_name:
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.InsertRequest, task.request),
                        ...
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.collections.v1.SortedMapMethods.Insert', []):
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.RemoveRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=IMPORT_reboot_aio_idempotency.Idempotency(
                                alias=f'Task {IMPORT_uuid.UUID(bytes=task.task_id.task_uuid)}',
                            ),
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.collections.v1.SortedMapMethods.Remove', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise
        ...
        elif 'Get' == task.method_name:
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.collections.v1.sorted_map_pb2.GetResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.GetRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.collections.v1.SortedMapMethods.Get', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.RangeRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.collections.v1.SortedMapMethods.Range', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SortedMapWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
                        ...
                        # Do not retry a task if the error was specified in the
                        # proto file.
                        if error_type in self._specified_errors_by_service_method_name.get('rbt.std.collections.v1.SortedMapMethods.ReverseRange', []):
                            await complete(task, (None, aborted.error))
                            return (None, aborted.error)
                        raise
    ...
    async def __Insert(
        ...
        *,
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.collections.v1.SortedMap.Insert') {aborted}"
                        )
                elif (
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.collections.v1.SortedMap.Insert') "
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.Insert') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                self.tasks_dispatcher,
                authorize=self._maybe_authorize(
                    method_name='rbt.std.collections.v1.SortedMapMethods.Insert',
        ...
        *,
    ...
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.InsertResponse]:
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = await SortedMapServicerTasks(
                    context=context,
                    state_ref=context._state_ref,
                ).Insert(
                    request,
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.collections.v1.SortedMap.Remove') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.collections.v1.SortedMap.Remove') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.Remove') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                self.tasks_dispatcher,
                authorize=self._maybe_authorize(
                    method_name='rbt.std.collections.v1.SortedMapMethods.Remove',
                    headers=context._headers,
                    auth=context.auth,
                    request=request,
                ),
    ...
    async def _schedule_Remove(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.RemoveResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            method='Remove',
    ...
    async def __Get(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.std.collections.v1.sorted_map_pb2.GetResponse:
        try:
            response = (
                await self._servicer._Get(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = SortedMap.GetAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.std.collections.v1.SortedMap.Get') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.Get') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.collections.v1.SortedMap.Get') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.collections.v1.SortedMap.Get') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.Get') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.Get') {type(exception).__name__}: {exception}"
            )
    ...
    async def _Get(
        ...
        *,
        ...
        # Try to verify the token if a token verifier exists.
        context.auth = await self._maybe_verify_token(
            headers=context._headers, method='Get'
        )
    ...
    async def _schedule_Get(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.GetResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            method='Get',
        ...
        response = rbt.std.collections.v1.sorted_map_pb2.GetResponse()
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.collections.v1.SortedMap.Range') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.collections.v1.SortedMap.Range') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.Range') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
    ...
    async def _schedule_Range(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.RangeResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            method='Range',
    ...
    async def __ReverseRange(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse:
        try:
            response = (
            ...
            self.maybe_raise_effect_validation_retry(
                logger=logger,
                idempotency_manager=context,
                method_name='SortedMap.ReverseRange',
                validating_effects=validating_effects,
                context=context,
            )
            return response
            ...
            # in `public/rebootdev/aio/internals/tasks_dispatcher.py` instead.
            aborted_type: IMPORT_typing.Optional[type] = None
            aborted_type = SortedMap.ReverseRangeAborted
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                # Not logging when within `node` as we already log there.
                if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                    logger.warning(
                        f"Unhandled (in 'rbt.std.collections.v1.SortedMap.ReverseRange') {aborted}; propagating as 'Unknown'\n" +
                        ''.join(IMPORT_traceback.format_exception(aborted))
                    )
                raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                    IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                    ...
                    # debugging, it does expose implementation
                    # information.
                    message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.ReverseRange') {aborted}"
                )
            else:
                if (
                    aborted_type is not None and
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled but declared error (in 'rbt.std.collections.v1.SortedMap.ReverseRange') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    "Unhandled (in 'rbt.std.collections.v1.SortedMap.ReverseRange') "
                    f"{type(decode_error).__name__}{': ' + str(decode_error) if len(str(decode_error)) > 0 else ''}; "
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.ReverseRange') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                ...
                # debugging, it does expose implementation
                # information.
                message=f"unhandled (in 'rbt.std.collections.v1.SortedMap.ReverseRange') {type(exception).__name__}: {exception}"
            )
    ...
    async def _schedule_ReverseRange(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
            method='ReverseRange',
        ...
        response = rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse()
    ...
    def _maybe_authorize(
        ...
        *,
        ...
        request: IMPORT_typing.Optional[SortedMapRequestTypes] = None,
    ) -> IMPORT_typing.Optional[IMPORT_typing.Callable[[IMPORT_typing.Optional[SortedMapStateType]], IMPORT_typing.Awaitable[None]]]:
        ...
        async def authorize(state: IMPORT_typing.Optional[SortedMapStateType]) -> None:
            ...
            try:
                ...
                raise TypeError(
                    ...
                    f"`rbt.std.collections.v1.SortedMap('{headers.state_ref.id}')`"
                ) from e
...
class _SortedMapStub(IMPORT_reboot_aio_stubs.Stub):

    __state_type_name__ = IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap')
    ...
    def __init__(
        ...
        *,
        ...
        self._rbt_std_collections_v1_sortedmapmethods_stub = rbt.std.collections.v1.sorted_map_pb2_grpc.SortedMapMethodsStub(channel)
...
class SortedMapReaderStub(_SortedMapStub):
    ...
    async def Get(
        ...
        *,
        ...
        state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap')
        service_name = IMPORT_reboot_aio_types.ServiceName('rbt.std.collections.v1.SortedMapMethods')
        method = 'Get'
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_std_collections_v1_sortedmapmethods_stub.Get,
                request,
                unary=True,
                reader=True,
                response_type=rbt.std.collections.v1.sorted_map_pb2.GetResponse,
                aborted_type=SortedMap.GetAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.std.collections.v1.sorted_map_pb2.GetResponse,
                )
        return await call()
        ...
        *,
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_std_collections_v1_sortedmapmethods_stub.Range,
                request,
                unary=True,
                reader=True,
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.std.collections.v1.sorted_map_pb2.RangeResponse,
                )
        return await call()
        ...
        *,
        ...
        async def call():
            async with self._call(
                ...
                service_name,
                method,
                self._rbt_std_collections_v1_sortedmapmethods_stub.ReverseRange,
                request,
                unary=True,
                reader=True,
                response_type=rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse,
                aborted_type=SortedMap.ReverseRangeAborted,
                metadata=metadata,
                bearer_token=bearer_token,
            ) as call:
        ...
        if isinstance(self._context, IMPORT_reboot_aio_contexts.WorkflowContext):
            ...
            with self._context.idempotently(
                ...
                return await IMPORT_reboot_aio_workflows.at_least_once(
                    ...
                    self._context,
                    call,
                    type=rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse,
                )
        return await call()
    ...
    async def Insert(
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
                IMPORT_reboot_aio_types.ServiceName('rbt.std.collections.v1.SortedMapMethods'),
                'Insert',
                self._rbt_std_collections_v1_sortedmapmethods_stub.Insert,
                request,
                unary=True,
                reader=False,
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            async with self._call(
                ...
                IMPORT_reboot_aio_types.ServiceName('rbt.std.collections.v1.SortedMapMethods'),
                'Remove',
                self._rbt_std_collections_v1_sortedmapmethods_stub.Remove,
                request,
                unary=True,
                reader=False,
                ...
                for (key, value) in await call.trailing_metadata():  # type: ignore[misc, attr-defined]
                    if key == IMPORT_reboot_aio_headers.TASK_ID_UUID:
                        return IMPORT_rbt_v1alpha1.tasks_pb2.TaskId(
                            state_type=IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
...
SortedMapStateType: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.SortedMap
SortedMapRequestTypes: IMPORT_typing.TypeAlias = \
        rbt.std.collections.v1.sorted_map_pb2.InsertRequest \
        | rbt.std.collections.v1.sorted_map_pb2.RemoveRequest \
        | rbt.std.collections.v1.sorted_map_pb2.GetRequest \
        | rbt.std.collections.v1.sorted_map_pb2.RangeRequest \
        | rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest

class SortedMapAuthorizer(
    IMPORT_rebootdev.aio.auth.authorizers.Authorizer[SortedMapStateType, SortedMapRequestTypes],
):
    StateType: IMPORT_typing.TypeAlias = SortedMapStateType
    RequestTypes: IMPORT_typing.TypeAlias = SortedMapRequestTypes
    ...
    def __init__(
        ...
        *,
        ...
        if get is not None and Get is not None:
            raise ValueError(
                f"Cannot specify both 'Get' and 'get' authorizer rules"
            )
        self._get = get or Get
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[SortedMapStateType],
        request: IMPORT_typing.Optional[SortedMapRequestTypes],
        **kwargs,
    ) -> IMPORT_rebootdev.aio.auth.authorizers.Authorizer.Decision:
        if method_name == 'rbt.std.collections.v1.SortedMapMethods.Insert':
            return await self.Insert(
                context=context,
                state=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                request=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.InsertRequest, request),
            )
        elif method_name == 'rbt.std.collections.v1.SortedMapMethods.Remove':
            return await self.Remove(
                context=context,
                state=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                request=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.RemoveRequest, request),
            )
        elif method_name == 'rbt.std.collections.v1.SortedMapMethods.Get':
            return await self.Get(
                context=context,
                state=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                request=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.GetRequest, request),
            )
        elif method_name == 'rbt.std.collections.v1.SortedMapMethods.Range':
            return await self.Range(
                context=context,
                state=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                request=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.RangeRequest, request),
            )
        elif method_name == 'rbt.std.collections.v1.SortedMapMethods.ReverseRange':
            return await self.ReverseRange(
                context=context,
                state=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                request=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest, request),
            )
        else:
            return IMPORT_rbt_v1alpha1.errors_pb2.PermissionDenied()

    # For 'rbt.std.collections.v1.SortedMapMethods.Insert'.
    async def Insert(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.std.collections.v1.SortedMapMethods.Remove'.
    async def Remove(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.std.collections.v1.SortedMapMethods.Get'.
    async def Get(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.std.collections.v1.SortedMapMethods.Range'.
    async def Range(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
    ...
    # For 'rbt.std.collections.v1.SortedMapMethods.ReverseRange'.
    async def ReverseRange(
        self,
        *,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
...
class SortedMapBaseServicer(IMPORT_reboot_aio_servicers.Servicer):
    Authorizer: IMPORT_typing.TypeAlias = SortedMapAuthorizer
    ...
    def __init__(self):
        ...
        # 'create_middleware()'.
        self._middleware: IMPORT_typing.Optional[SortedMapServicerMiddleware] = None
    ...
    class Effects(IMPORT_reboot_aio_state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            IMPORT_reboot_aio_types.assert_type(state, [rbt.std.collections.v1.sorted_map_pb2.SortedMap])
    ...
    class InsertEffects(Effects):
        def __init__(
            ...
            *,
            ...
            IMPORT_reboot_aio_types.assert_type(state, [rbt.std.collections.v1.sorted_map_pb2.SortedMap])
            IMPORT_reboot_aio_types.assert_type(response, [rbt.std.collections.v1.sorted_map_pb2.InsertResponse])
    ...
    class RemoveEffects(Effects):
        def __init__(
            ...
            *,
            ...
            IMPORT_reboot_aio_types.assert_type(state, [rbt.std.collections.v1.sorted_map_pb2.SortedMap])
            IMPORT_reboot_aio_types.assert_type(response, [rbt.std.collections.v1.sorted_map_pb2.RemoveResponse])
    ...
    class InlineWriterCallable(IMPORT_typing.Protocol[InlineWriterCallableResult]):
        async def __call__(
            self,
            state: rbt.std.collections.v1.sorted_map_pb2.SortedMap
        ) -> SortedMapBaseServicer.InlineWriterCallableResult:
            ...
    ...
    class WorkflowState:
        ...
        async def write(
            ...
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: SortedMapBaseServicer.InlineWriterCallable[None],
        ...
        async def write(
            ...
            idempotency_alias: str,
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: SortedMapBaseServicer.InlineWriterCallable[SortedMapBaseServicer.InlineWriterCallableResult],
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            *,
            type: type[SortedMapBaseServicer.InlineWriterCallableResult],
        ) -> SortedMapBaseServicer.InlineWriterCallableResult:
            ...
            ...
            async def _read(
                ...
                with context.idempotently(
                    ...
                    return await IMPORT_reboot_aio_workflows.at_least_once(
                        ...
                        context,
                        read,
                        type=rbt.std.collections.v1.sorted_map_pb2.SortedMap,
                    )
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: SortedMapBaseServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                method_name = f"SortedMap.{task.method_name} inline writer"
        ...
        def per_workflow(self, alias: IMPORT_typing.Optional[str] = None):
            return SortedMapBaseServicer.WorkflowState._Idempotently(
        ...
        class _Always:
            ...
            async def read(
                ...
                return await SortedMapBaseServicer.WorkflowState._Idempotently(
                    servicer=self._servicer,
                    alias=None,
        ...
        def always(self):
            return SortedMapBaseServicer.WorkflowState._Always(
                servicer=self._servicer,
            )
...
class SortedMapSingletonServicer(SortedMapBaseServicer):

    @property
    def state(self):
        return SortedMapBaseServicer.WorkflowState(
            servicer=self
        )
    ...
    async def _Insert(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.std.collections.v1.SortedMap('{context.state_id}')",
    ...
    async def _Get(
        ...
        with IMPORT_reboot_aio_tracing.span(
                state_name=f"rbt.std.collections.v1.SortedMap('{context.state_id}')",
                span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(self)}.Get()",
                level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                python_specific=True,
        ):
            response = (
...
class SortedMapServicer(SortedMapBaseServicer):

    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.std.collections.v1.sorted_map_pb2.SortedMap]
    ...
    _instances: dict[str, SortedMapServicer] = {}

    def _instance(self, state_id: str):
        instances = SortedMapServicer._instances
    ...
    @property
    def state(self) -> rbt.std.collections.v1.sorted_map_pb2.SortedMap:
        state = SortedMapServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = SortedMapServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.std.collections.v1.sorted_map_pb2.SortedMap):
        state = SortedMapServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Insert(
        ...
        # `_state is None`.
        assert SortedMapServicer._state.get() is None
        SortedMapServicer._state.set(state)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            ...
            SortedMapServicer._state.set(None)
    ...
    async def _Get(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                    state_name=f"rbt.std.collections.v1.SortedMap('{context.state_id}')",
                    span_name=f"{IMPORT_reboot_aio_tracing.qualified_type_name(instance)}.Get()",
                    level=IMPORT_reboot_aio_tracing.TraceLevel.CUSTOMER,
                    python_specific=True,
            ):
                return await instance.Get(context, request)
        finally:
            SortedMapServicer._state.set(None)
...
SortedMap_ScheduleTypeVar = IMPORT_typing.TypeVar('SortedMap_ScheduleTypeVar', 'SortedMap.WeakReference._Schedule', 'SortedMap.WeakReference._WriterSchedule')
SortedMap_IdempotentlyScheduleTypeVar = IMPORT_typing.TypeVar('SortedMap_IdempotentlyScheduleTypeVar', 'SortedMap.WeakReference._Schedule', 'SortedMap.WeakReference._WriterSchedule')

SortedMap_UntilCallableType = IMPORT_typing.TypeVar('SortedMap_UntilCallableType')

class SortedMapSingleton:
    Servicer: IMPORT_typing.TypeAlias = SortedMapSingletonServicer


class SortedMap:


    Servicer: IMPORT_typing.TypeAlias = SortedMapServicer

    singleton: IMPORT_typing.TypeAlias = SortedMapSingleton

    Effects: IMPORT_typing.TypeAlias = SortedMapBaseServicer.Effects

    Authorizer: IMPORT_typing.TypeAlias = SortedMapAuthorizer

    State: IMPORT_typing.TypeAlias = rbt.std.collections.v1.sorted_map_pb2.SortedMap
    ...
    class InsertTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.collections.v1.sorted_map_pb2.InsertResponse]:
    ...
    InsertEffects: IMPORT_typing.TypeAlias = SortedMapBaseServicer.InsertEffects
    ...
    class RemoveTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.collections.v1.sorted_map_pb2.RemoveResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    RemoveEffects: IMPORT_typing.TypeAlias = SortedMapBaseServicer.RemoveEffects
    ...
    class GetTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.collections.v1.sorted_map_pb2.GetResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.collections.v1.sorted_map_pb2.GetResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.std.collections.v1.sorted_map_pb2.GetResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class GetAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class RangeTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.collections.v1.sorted_map_pb2.RangeResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class RangeAborted(IMPORT_rebootdev.aio.aborted.Aborted):
        ...
        @classmethod
        def is_declared_error(cls, message: IMPORT_google_protobuf_message.Message) -> bool:
            if message.DESCRIPTOR.full_name == 'rbt.std.collections.v1.InvalidRangeError':
                return True
            return False
    ...
    class ReverseRangeTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse]:
            """Awaits for task to finish and returns its response."""
            async def wait_for_task() -> rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse:
                channel = self._channel_manager.get_channel_to_state(
                    IMPORT_reboot_aio_types.StateTypeName(self._task_id.state_type),
                    IMPORT_reboot_aio_types.StateRef(self._task_id.state_ref),
                )
                ...
                try:
                    ...
                    if (
                        ...
                        raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                            ...
                            f"task with UUID {IMPORT_uuid.UUID(bytes=self._task_id.task_uuid)} "
                            f"has a response of type '{response_or_error.TypeName()}' "
                            "but expecting type 'rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse'; "
                            "are you waiting on a task of the correct method?",
                        ) from None
    ...
    class WeakReference(IMPORT_typing.Generic[SortedMap_ScheduleTypeVar]):
        ...
        def __init__(
            ...
            *,
            ...
            bearer_token: IMPORT_typing.Optional[str] = None,
            servicer: IMPORT_typing.Optional[SortedMapBaseServicer] = None,
        ):
            ...
            self._reader_stub: IMPORT_typing.Optional[SortedMapReaderStub] = None
            self._writer_stub: IMPORT_typing.Optional[SortedMapWriterStub] = None
            self._workflow_stub: IMPORT_typing.Optional[SortedMapWorkflowStub] = None
            self._tasks_stub: IMPORT_typing.Optional[SortedMapTasksStub] = None
        ...
        class _Reactively:
            ...
            async def Get(
                ...
                *,
            ...
            ) -> IMPORT_typing.AsyncIterator[rbt.std.collections.v1.sorted_map_pb2.GetResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.collections.v1.sorted_map_pb2.GetRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.collections.v1.sorted_map_pb2.GetRequest)
                ...
                __request__ = rbt.std.collections.v1.sorted_map_pb2.GetRequest(
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.std.collections.v1.sorted_map_pb2.GetResponse()
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.std.collections.v1.SortedMapMethods.Get' "
            ...
            async def Range(
                ...
                *,
                ...
                end_key: IMPORT_typing.Optional[str] = None,
                limit: IMPORT_typing.Optional[int] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.std.collections.v1.sorted_map_pb2.RangeResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.collections.v1.sorted_map_pb2.RangeRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.collections.v1.sorted_map_pb2.RangeRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.collections.v1.sorted_map_pb2.RangeRequest(
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.std.collections.v1.sorted_map_pb2.RangeResponse()
                                __response__.ParseFromString(__query_response__.response)
                                yield __response__
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.std.collections.v1.SortedMapMethods.Range' "
                                f"failed with a retryable error: '{exception}'; "
                                "will retry..."
                            )
                            await __query_backoff__()
            ...
            async def ReverseRange(
                ...
                *,
                ...
                end_key: IMPORT_typing.Optional[str] = None,
                limit: IMPORT_typing.Optional[int] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest)
                IMPORT_reboot_aio_types.assert_type(__context__, [IMPORT_reboot_aio_external.ExternalContext, IMPORT_reboot_aio_contexts.ReaderContext, IMPORT_reboot_aio_contexts.WorkflowContext])

                # TODO: mypy-protobuf declares that
                # `google.protobuf.message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest(
                    start_key=start_key,  # type: ignore[arg-type]
                    end_key=end_key,  # type: ignore[arg-type]
                    limit=limit,  # type: ignore[arg-type]
                )
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse()
                                __response__.ParseFromString(__query_response__.response)
                                yield __response__
                        ...
                        if IMPORT_rebootdev.aio.aborted.is_grpc_retryable_exception(exception):
                            logger.debug(
                                "Reactive read to 'rbt.std.collections.v1.SortedMapMethods.ReverseRange' "
                                f"failed with a retryable error: '{exception}'; "
                                "will retry..."
                            )
                            await __query_backoff__()
        ...
        class _Idempotently(IMPORT_typing.Generic[SortedMap_IdempotentlyScheduleTypeVar]):
            ...
            def spawn(
                ...
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
            ) -> SortedMap.WeakReference._Spawn:
                return SortedMap.WeakReference._Spawn(
                    self._weak_reference._application_id,
                    self._weak_reference._tasks,
                    when=when,
                    idempotency=self._idempotency,
            ...
            async def read(
                ...
                return await SortedMapBaseServicer.WorkflowState._Idempotently._read(
            ...
            async def write(
                ...
                *,
                ...
                return await SortedMapBaseServicer.WorkflowState._Idempotently._write_validating_effects(
                    self._weak_reference._servicer,
                    self._idempotency,
                    context,
                    writer,
            ...
            async def Insert(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
                *,
                entries: IMPORT_typing.Optional[dict[str, bytes]] = None,
            ) -> rbt.std.collections.v1.sorted_map_pb2.InsertResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.collections.v1.sorted_map_pb2.InsertRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.collections.v1.sorted_map_pb2.InsertRequest)
            ...
            async def Remove(
                ...
                *,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.collections.v1.sorted_map_pb2.RemoveRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.collections.v1.sorted_map_pb2.RemoveRequest)
            ...
            async def Get(
                ...
                *,
                ...
                return await __this__._weak_reference.Get(
                    __context__,
                    __options__,
                    key=key,
                )
        ...
        @IMPORT_typing.overload
        def idempotently(self, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> SortedMap.WeakReference._Idempotently[SortedMap_ScheduleTypeVar]:
            ...

        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID, generated: bool = False) -> SortedMap.WeakReference._Idempotently[SortedMap_ScheduleTypeVar]:
            ...
        ...
        class _UntilChangesSatisfies(IMPORT_typing.Generic[SortedMap_UntilCallableType]):

            _idempotency_alias: str
            _context: IMPORT_reboot_aio_contexts.WorkflowContext
            _callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[SortedMap_UntilCallableType]]
            _type: type[SortedMap_UntilCallableType]
            ...
            def __init__(
                ...
                *,
                idempotency_alias: str,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
                callable: IMPORT_typing.Callable[[], IMPORT_typing.Awaitable[SortedMap_UntilCallableType]],
                type: type[SortedMap_UntilCallableType],
            ):
            ...
            async def satisfies(
                self,
                condition: IMPORT_typing.Callable[[SortedMap_UntilCallableType], bool],
            ):
        ...
        class _Until:
            ...
            _weak_reference: SortedMap.WeakReference
            _idempotency_alias: str
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> SortedMap.WeakReference._UntilChangesSatisfies[rbt.std.collections.v1.sorted_map_pb2.SortedMap]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                ...
                return SortedMap.WeakReference._UntilChangesSatisfies(
            ...
            def Get(
                ...
                *,
                key: IMPORT_typing.Optional[str] = None,
            ) -> SortedMap.WeakReference._UntilChangesSatisfies[rbt.std.collections.v1.sorted_map_pb2.GetResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def Range(
                ...
                *,
                ...
                end_key: IMPORT_typing.Optional[str] = None,
                limit: IMPORT_typing.Optional[int] = None,
            ) -> SortedMap.WeakReference._UntilChangesSatisfies[rbt.std.collections.v1.sorted_map_pb2.RangeResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
            ...
            def ReverseRange(
                ...
                *,
                ...
                end_key: IMPORT_typing.Optional[str] = None,
                limit: IMPORT_typing.Optional[int] = None,
            ) -> SortedMap.WeakReference._UntilChangesSatisfies[rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        def until(self, alias: str):
            return SortedMap.WeakReference._Until(
                weak_reference=self,
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                application_id: IMPORT_typing.Optional[IMPORT_reboot_aio_types.ApplicationId],
                tasks: IMPORT_typing.Callable[[IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext], SortedMapTasksStub],
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
                idempotency: IMPORT_typing.Optional[IMPORT_reboot_aio_idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Insert(
                ...
                *,
                ...
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.collections.v1.sorted_map_pb2.InsertRequest(
            ...
            async def Remove(
                ...
                *,
                ...
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.collections.v1.sorted_map_pb2.RemoveRequest(
            ...
            async def Get(
                ...
                *,
                ...
                if key is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.collections.v1.sorted_map_pb2.GetRequest': field 'key' is not "
            ...
            async def ReverseRange(
                ...
                *,
                ...
                if start_key is not None and not isinstance(
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest': field 'start_key' is not "
                        f"of required type 'str'"
                    )
                if end_key is not None and not isinstance(
                    end_key,
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest': field 'end_key' is not "
                        f"of required type 'str'"
                    )
                if limit is not None and not isinstance(
                    limit,
                    ...
                    raise TypeError(
                        f"Can not construct protobuf message of type "
                        f"'rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest': field 'limit' is not "
                        f"of required type 'int'"
                    )
                # TODO: mypy-protobuf declares that
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
            ...
            async def Insert(
                ...
                *,
                ...
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WriterContext):
                    return (await SortedMapServicerTasks(
                        context=__context__,
        ...
        class _Spawn:
            ...
            async def ReverseRange(
                ...
                *,
                ...
                return SortedMap.ReverseRangeTask(
                    __context__,
                    task_id=__task_id__,
                )
        ...
        async def Insert(
            ...
            *,
            ...
            return await __this__._writer(__context__).Insert(
                __request__,
                idempotency=__idempotency__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
        ...
        async def Remove(
            ...
            *,
            ...
            return await __this__._writer(__context__).Remove(
                __request__,
                idempotency=__idempotency__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
            ...
            *,
            ...
            if __options__ is None or __options__.idempotency is None:
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WorkflowContext):
                    ...
                    return await __this__.idempotently().Get(
                        __context__,
                        __options__ or IMPORT_reboot_aio_call.Options(),
                        key=key,
                    )
    ...
    class _Forall:
        ...
        async def Insert(
            ...
            *,
            entries: IMPORT_typing.Optional[dict[str, bytes]] = None,
        ) -> list[rbt.std.collections.v1.sorted_map_pb2.InsertResponse]:
        ...
        async def Remove(
            ...
            *,
            keys: IMPORT_typing.Optional[IMPORT_typing.Iterable[str]] = None,
        ) -> list[rbt.std.collections.v1.sorted_map_pb2.RemoveResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    SortedMap.ref(
                        id
        ...
        async def Get(
            ...
            *,
            key: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.std.collections.v1.sorted_map_pb2.GetResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    SortedMap.ref(
                        id
        ...
        async def Range(
            ...
            *,
            ...
            end_key: IMPORT_typing.Optional[str] = None,
            limit: IMPORT_typing.Optional[int] = None,
        ) -> list[rbt.std.collections.v1.sorted_map_pb2.RangeResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    SortedMap.ref(
                        id
        ...
        async def ReverseRange(
            ...
            *,
            ...
            end_key: IMPORT_typing.Optional[str] = None,
            limit: IMPORT_typing.Optional[int] = None,
        ) -> list[rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    SortedMap.ref(
                        id
    ...
    @classmethod
    def forall(cls, ids: list[str]) -> SortedMap._Forall:
        return SortedMap._Forall(ids)
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> SortedMap._ConstructIdempotently:
        ...

    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID, generated: bool = False) -> SortedMap._ConstructIdempotently:
        ...
...
class SortedMapServicerNodeAdaptor(SortedMap.singleton.Servicer):
            ...
            try:
                ...
                if result.HasField('state'):
                    with IMPORT_reboot_aio_tracing.span(
                        ...
                        state.CopyFrom(
                            rbt.std.collections.v1.sorted_map_pb2.SortedMap.FromString(
                                result.state
                            )
                        )
                ...
                with IMPORT_reboot_aio_tracing.span(
                    ...
                    return rbt.std.collections.v1.sorted_map_pb2.InsertResponse.FromString(result.response)
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            try:
                ...
                with IMPORT_reboot_aio_tracing.span(
                    ...
                    return rbt.std.collections.v1.sorted_map_pb2.RemoveResponse.FromString(result.response)
    ...
    async def Get(
        ...
        try:
            ...
            return rbt.std.collections.v1.sorted_map_pb2.GetResponse.FromString(result.response)
    ...
    async def Range(
        ...
        try:
            ...
            return rbt.std.collections.v1.sorted_map_pb2.RangeResponse.FromString(result.response)
    ...
    async def ReverseRange(
        ...
        try:
            ...
            return rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse.FromString(result.response)
