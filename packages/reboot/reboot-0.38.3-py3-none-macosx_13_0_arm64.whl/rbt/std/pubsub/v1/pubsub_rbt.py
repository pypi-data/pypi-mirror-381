        ...
        *,
        ...
        if 'Publish' == task.method_name:
            if only_validate:
                ...
                return rbt.std.pubsub.v1.pubsub_pb2.PublishResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (TopicWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.pubsub.v1.pubsub_pb2.PublishRequest, task.request),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.pubsub.v1.pubsub_pb2.SubscribeResponse()
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (TopicWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.std.pubsub.v1.pubsub_pb2.SubscribeRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=IMPORT_reboot_aio_idempotency.Idempotency(
                                alias=f'Task {IMPORT_uuid.UUID(bytes=task.task_id.task_uuid)}',
                            ),
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return rbt.std.pubsub.v1.pubsub_pb2.BrokerResponse()
...
class TopicSingletonServicer(TopicBaseServicer):
    ...
    async def _Publish(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.Publish(context, state, request)
    ...
    async def _Broker(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.Broker(context, request)
...
class TopicServicer(TopicBaseServicer):
    ...
    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.std.pubsub.v1.pubsub_pb2.Topic]
    ...
    @state.setter
    def state(self, new_state: rbt.std.pubsub.v1.pubsub_pb2.Topic):
        state = TopicServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Publish(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Publish(context, request)
        finally:
    ...
    async def _Broker(
        ...
        TopicServicer._workflow.set(True)
        try:
            # Wrap the call to the developer's method in a `span` so that it
            # is traced using its fully-qualified Python name.
            instance = self._instance(context.state_id)
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Broker(context, request)
        finally:
            TopicServicer._workflow.set(False)
...
class Topic:
    ...
    class PublishTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.pubsub.v1.pubsub_pb2.PublishResponse]:
    ...
    class SubscribeTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.pubsub.v1.pubsub_pb2.SubscribeResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class BrokerTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.std.pubsub.v1.pubsub_pb2.BrokerResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class WeakReference(IMPORT_typing.Generic[Topic_ScheduleTypeVar]):
        ...
        class _Idempotently(IMPORT_typing.Generic[Topic_IdempotentlyScheduleTypeVar]):
            ...
            async def Publish(
                ...
                *,
                ...
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.pubsub.v1.pubsub_pb2.PublishRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.pubsub.v1.pubsub_pb2.PublishRequest)
            ...
            async def Subscribe(
                ...
                __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
                *,
                queue_id: IMPORT_typing.Optional[str] = None,
            ) -> rbt.std.pubsub.v1.pubsub_pb2.SubscribeResponse:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.pubsub.v1.pubsub_pb2.SubscribeRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.pubsub.v1.pubsub_pb2.SubscribeRequest)
            ...
            async def Broker(
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.std.pubsub.v1.pubsub_pb2.BrokerRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.std.pubsub.v1.pubsub_pb2.BrokerRequest)
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> Topic.WeakReference._UntilChangesSatisfies[rbt.std.pubsub.v1.pubsub_pb2.Topic]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        class _Schedule:
            ...
            async def Publish(
                ...
                *,
                ...
                __request__ = rbt.std.pubsub.v1.pubsub_pb2.PublishRequest(
            ...
            async def Subscribe(
                ...
                *,
                ...
                if queue_id is not None and not isinstance(
                    queue_id,
                    str,
                ):
                    raise TypeError(
                ...
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.pubsub.v1.pubsub_pb2.SubscribeRequest(
                    queue_id=queue_id,  # type: ignore[arg-type]
                )
            ...
            async def Broker(
                ...
                # `IMPORT_google_protobuf_message.Message` constructor arguments are
                # always non-None, when in reality they are optional.
                __request__ = rbt.std.pubsub.v1.pubsub_pb2.BrokerRequest(
                )
        ...
        async def Publish(
            ...
            *,
            ...
            return await __this__._writer(__context__).Publish(
                __request__,
                idempotency=__idempotency__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
    ...
    class _Forall:
        ...
        async def Publish(
            ...
            *,
            ...
            any: IMPORT_typing.Optional[google.protobuf.any_pb2.Any] = None,
            items: IMPORT_typing.Optional[IMPORT_typing.Iterable[rbt.std.item.v1.item_pb2.Item]] = None,
        ) -> list[rbt.std.pubsub.v1.pubsub_pb2.PublishResponse]:
        ...
        async def Subscribe(
            ...
            *,
            queue_id: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.std.pubsub.v1.pubsub_pb2.SubscribeResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    Topic.ref(
                        id
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> Topic.WeakReference[Topic.WeakReference._Schedule]:
        return Topic.WeakReference(
            # TODO(https://github.com/reboot-dev/mono/issues/3226): add support for calling other applications.
            # For now this always stays within the application that creates the context.
            application_id=None,
