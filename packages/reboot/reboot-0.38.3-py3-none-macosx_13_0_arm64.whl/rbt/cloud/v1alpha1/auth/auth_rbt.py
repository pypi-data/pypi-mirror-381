                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (APIKeyWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.auth.auth_pb2.CreateRequest, task.request),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (APIKeyWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.auth.auth_pb2.RevokeRequest, task.request),
                            bearer_token=__internal_magic_token__,
                            idempotency=IMPORT_reboot_aio_idempotency.Idempotency(
                                alias=f'Task {IMPORT_uuid.UUID(bytes=task.task_id.task_uuid)}',
                            ),
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (APIKeyWorkflowStub(
                            ...
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest, task.request),
                            bearer_token=__internal_magic_token__,
                        ))
                        await complete(task, (response, None))
                        return (response, None)
...
class APIKeySingletonServicer(APIKeyBaseServicer):
    ...
    async def _Revoke(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return await self.Revoke(context, state, request)
...
class APIKeyServicer(APIKeyBaseServicer):
    ...
    _state: IMPORT_contextvars.ContextVar[
        IMPORT_typing.Optional[rbt.cloud.v1alpha1.auth.auth_pb2.APIKey]
    ...
    @property
    def state(self) -> rbt.cloud.v1alpha1.auth.auth_pb2.APIKey:
        state = APIKeyServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
            )
        workflow = APIKeyServicer._workflow.get()
        if workflow:
            raise RuntimeError(
    ...
    @state.setter
    def state(self, new_state: rbt.cloud.v1alpha1.auth.auth_pb2.APIKey):
        state = APIKeyServicer._state.get()
        if state is None:
            raise RuntimeError(
                "`state` property is only relevant within a `Servicer` method"
    ...
    async def _Revoke(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Revoke(context, request)
        finally:
            APIKeyServicer._state.set(None)
    ...
    async def _Authenticate(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return await instance.Authenticate(context, request)
        finally:
            APIKeyServicer._state.set(None)
...
class APIKey:
    ...
    class CreateTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.auth.auth_pb2.CreateResponse]:
    ...
    class RevokeTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.auth.auth_pb2.RevokeResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class AuthenticateTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
            """Awaits for task to finish and returns its response."""
    ...
    class WeakReference(IMPORT_typing.Generic[APIKey_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def Authenticate(
                ...
                *,
                secret: IMPORT_typing.Optional[str] = None,
            ) -> IMPORT_typing.AsyncIterator[rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest)
                ...
                __request__ = rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest(
        ...
        class _Idempotently(IMPORT_typing.Generic[APIKey_IdempotentlyScheduleTypeVar]):
            ...
            async def Revoke(
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.auth.auth_pb2.RevokeRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.auth.auth_pb2.RevokeRequest)
        ...
        class _Until:
            ...
            def read(
                self,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ) -> APIKey.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.auth.auth_pb2.APIKey]:
                IMPORT_reboot_aio_types.assert_type(
                    context,
            ...
            def Authenticate(
                ...
                *,
                secret: IMPORT_typing.Optional[str] = None,
            ) -> APIKey.WeakReference._UntilChangesSatisfies[rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
                IMPORT_reboot_aio_types.assert_type(
                    __context__,
                    [IMPORT_reboot_aio_contexts.WorkflowContext],
                )
        ...
        class _Schedule:
            ...
            async def Revoke(
                ...
                # always non-None, when in reality they are optional.
                __request__ = rbt.cloud.v1alpha1.auth.auth_pb2.RevokeRequest(
                )
        ...
        async def Revoke(
            ...
            return await __this__._writer(__context__).Revoke(
                __request__,
                idempotency=__idempotency__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
        ...
        async def Authenticate(
            ...
            *,
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).Authenticate(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
    ...
    class _Forall:
        ...
        async def Revoke(
            ...
            __context__: IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext,
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
        ) -> list[rbt.cloud.v1alpha1.auth.auth_pb2.RevokeResponse]:
        ...
        async def Authenticate(
            ...
            *,
            secret: IMPORT_typing.Optional[str] = None,
        ) -> list[rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateResponse]:
            return await IMPORT_asyncio.gather(
                *[
                    APIKey.ref(
                        id
    ...
    async def Create(
        ...
        *,
        ...
        # `google.protobuf.message.Message` constructor arguments are
        # always non-None, when in reality they are optional.
        __request__ = rbt.cloud.v1alpha1.auth.auth_pb2.CreateRequest(
    ...
    class _ConstructIdempotently:
        ...
        async def Create(
            ...
            *,
            ...
            # UX improvement: check that neither positional argument was accidentally
            # given a gRPC request type.
            IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.auth.auth_pb2.CreateRequest)
            IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.auth.auth_pb2.CreateRequest)
