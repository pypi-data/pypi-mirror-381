...
def _save_conda_and_requirements(
    dst_dir, conda_env, pip_requirements, extra_pip_requirements
):
    """
...
def _save_model_metadata(
    ...
    pyfunc.add_to_model(
        ...
        artifacts={
            _ARTIFACT_NAME: {
                CONFIG_KEY_ARTIFACT_RELATIVE_PATH: _JOHNSNOWLABS_MODEL_PATH_SUB
            },
        },
...
def _save_python_model_with_johnsnowlabs_flavor(
    ...
    pyfunc.add_to_model(
        ...
        code=pyfunc_flavor.get("code", code_dir_subpath),
        python_model=pyfunc_flavor.get("python_model"),
        artifacts={
            _ARTIFACT_NAME: {
                CONFIG_KEY_ARTIFACT_RELATIVE_PATH: _JOHNSNOWLABS_MODEL_PATH_SUB
            }
...
def _load_pyfunc(path, spark=None):
    ...
    if "python_model" in pyfunc_conf:
        import mlflow.pyfunc.model
