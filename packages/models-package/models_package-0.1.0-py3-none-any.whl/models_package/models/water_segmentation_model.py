...
class WaterSegmentationModel(ModelSegmentation):
    def __init__(
        ...
        super().__init__(model_path=model_path, model_name=name)
    ...
    def make_predictions(self, s1_data, s2_data, slope_data):
        ...
        model.load_state_dict(torch.load(f'{os.getcwd()}/model/s1s2_model_{NAME_IMG_BANDS_INDX}.pth', map_location=self.device))
