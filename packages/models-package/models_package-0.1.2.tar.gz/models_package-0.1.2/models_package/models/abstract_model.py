...
class ModelSegmentation(ABC):
    ...
    # Load the model weights (optional - override in child classes if needed)
    def load_model(self):
        """
        Load the model weights. Override in child classes if explicit loading is needed.
        Some models may handle loading automatically or differently.
        """
        pass
