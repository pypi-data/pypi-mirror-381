...
class DistributionsRpmApi:
    ...
    def add_role(
        self,
        rpm_rpm_distribution_href: StrictStr,
        ...
        _param = self._add_role_serialize(
            rpm_rpm_distribution_href=rpm_rpm_distribution_href,
    ...
    def _add_role_serialize(
        ...
        if rpm_rpm_distribution_href is not None:
            _path_params['rpm_rpm_distribution_href'] = rpm_rpm_distribution_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_distribution_href}add_role/',
    ...
    def create(
        ...
        :param rpm_rpm_distribution: (required)
        :type rpm_rpm_distribution: RpmRpmDistribution
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            ...
            rpm_rpm_distribution=rpm_rpm_distribution,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if rpm_rpm_distribution is not None:
            _body_params = rpm_rpm_distribution
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/pulp/{pulp_domain}/api/v3/distributions/rpm/rpm/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{rpm_rpm_distribution_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedrpmRpmDistributionResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedrpmRpmDistributionResponseList]:
        """List rpm distributions
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_rpm_distribution_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_rpm_distribution_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        ...
        :param rpm_rpm_distribution_href: (required)
        :type rpm_rpm_distribution_href: str
        :param patchedrpm_rpm_distribution: (required)
        :type patchedrpm_rpm_distribution: PatchedrpmRpmDistribution
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            rpm_rpm_distribution_href=rpm_rpm_distribution_href,
            patchedrpm_rpm_distribution=patchedrpm_rpm_distribution,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patchedrpm_rpm_distribution is not None:
            _body_params = patchedrpm_rpm_distribution
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_distribution_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_distribution_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_distribution_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
