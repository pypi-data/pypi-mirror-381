...
class AcsRpmApi:
    ...
    def add_role(
        self,
        rpm_rpm_alternate_content_source_href: StrictStr,
        ...
        _param = self._add_role_serialize(
            rpm_rpm_alternate_content_source_href=rpm_rpm_alternate_content_source_href,
    ...
    def _add_role_serialize(
        ...
        if rpm_rpm_alternate_content_source_href is not None:
            _path_params['rpm_rpm_alternate_content_source_href'] = rpm_rpm_alternate_content_source_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_alternate_content_source_href}add_role/',
    ...
    def create(
        ...
        :param rpm_rpm_alternate_content_source: (required)
        :type rpm_rpm_alternate_content_source: RpmRpmAlternateContentSource
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._create_serialize(
            ...
            rpm_rpm_alternate_content_source=rpm_rpm_alternate_content_source,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RpmRpmAlternateContentSourceResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _create_serialize(
        self,
        pulp_domain,
        rpm_rpm_alternate_content_source,
        x_task_diagnostics,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if rpm_rpm_alternate_content_source is not None:
            _body_params = rpm_rpm_alternate_content_source
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/pulp/{pulp_domain}/api/v3/acs/rpm/rpm/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{rpm_rpm_alternate_content_source_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedrpmRpmAlternateContentSourceResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedrpmRpmAlternateContentSourceResponseList]:
        """List rpm alternate content sources
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_rpm_alternate_content_source_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_rpm_alternate_content_source_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        ...
        :param rpm_rpm_alternate_content_source_href: (required)
        :type rpm_rpm_alternate_content_source_href: str
        :param patchedrpm_rpm_alternate_content_source: (required)
        :type patchedrpm_rpm_alternate_content_source: PatchedrpmRpmAlternateContentSource
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            rpm_rpm_alternate_content_source_href=rpm_rpm_alternate_content_source_href,
            patchedrpm_rpm_alternate_content_source=patchedrpm_rpm_alternate_content_source,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        self,
        rpm_rpm_alternate_content_source_href,
        patchedrpm_rpm_alternate_content_source,
        x_task_diagnostics,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if patchedrpm_rpm_alternate_content_source is not None:
            _body_params = patchedrpm_rpm_alternate_content_source
    ...
    def _refresh_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_alternate_content_source_href}refresh/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_alternate_content_source_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
