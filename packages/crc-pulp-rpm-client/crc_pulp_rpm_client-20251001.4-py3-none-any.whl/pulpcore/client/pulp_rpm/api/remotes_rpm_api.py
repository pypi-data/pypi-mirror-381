...
class RemotesRpmApi:
    ...
    def add_role(
        ...
        _param = self._add_role_serialize(
            rpm_rpm_remote_href=rpm_rpm_remote_href,
    ...
    def _add_role_serialize(
        ...
        if rpm_rpm_remote_href is not None:
            _path_params['rpm_rpm_remote_href'] = rpm_rpm_remote_href
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_remote_href}add_role/',
    ...
    def create(
        ...
        :param rpm_rpm_remote: (required)
        :type rpm_rpm_remote: RpmRpmRemote
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    def _create_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if rpm_rpm_remote is not None:
            _body_params = rpm_rpm_remote
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/pulp/{pulp_domain}/api/v3/remotes/rpm/rpm/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='{rpm_rpm_remote_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedrpmRpmRemoteResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedrpmRpmRemoteResponseList]:
        """List rpm remotes
    ...
    def _list_roles_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_rpm_remote_href}list_roles/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _my_permissions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{rpm_rpm_remote_href}my_permissions/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def partial_update(
        ...
        :param rpm_rpm_remote_href: (required)
        :type rpm_rpm_remote_href: str
        :param patchedrpm_rpm_remote: (required)
        :type patchedrpm_rpm_remote: PatchedrpmRpmRemote
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._partial_update_serialize(
            rpm_rpm_remote_href=rpm_rpm_remote_href,
            patchedrpm_rpm_remote=patchedrpm_rpm_remote,
            x_task_diagnostics=x_task_diagnostics,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patchedrpm_rpm_remote is not None:
            _body_params = patchedrpm_rpm_remote
    ...
    def _remove_role_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_remote_href}remove_role/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_remote_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{rpm_rpm_remote_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
