...
class Video360Processor:
    ...
    def _parse_spherical_tags(
        ...
        for tag_name, _tag_value in tags.items():
    ...
    async def extract_viewport_duplicate(
    ...
    async def analyze_360_content_duplicate(self, video_path: Path) -> Video360Analysis:
        """
