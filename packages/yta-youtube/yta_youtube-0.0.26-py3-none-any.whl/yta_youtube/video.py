...
we download them with that specific name and them, if
...
class YoutubeVideo:
    ...
    def __init__(
        ...
        self.id = id_or_url
        # We need to initialize the yt-dlp instace to be able
    ...
    def download_audio(
        ...
        """
        Download only the audio with no video.
    ...
    def _get_subtitles(
        ...
        """
        Common method to obtain the subtitles with the
        specified language and format for the given
        'subtitles', that are the subtitles once they
        have been parsed by our system.
    ...
    def _download_format(
        ...
        """
        Download the given 'format', associated with the also
        provided 'filename', and stores using the given
        'output_filename'.

        This method returns the final name with which 
        the format has been downloaded.
        """
