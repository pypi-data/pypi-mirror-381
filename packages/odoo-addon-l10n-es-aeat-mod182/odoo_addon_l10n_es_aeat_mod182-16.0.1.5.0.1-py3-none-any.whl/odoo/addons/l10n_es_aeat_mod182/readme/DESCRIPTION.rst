...
diseños físicos y lógicos del 182.
...
* En el caso de facturas de proveedor con IRPF, no deben ser presentadas en
  ...
  proveedor la opción de "Incluir en el informe 182".

De acuerdo con la normativa, no están obligados a presentar el modelo 182:
...
* Los obligados tributarios que deban informar sobre las operaciones
  ...
  operaciones que expresamente deban incluirse en el modelo 182.
