...
import os
import typing
__all__ = ['LoadSTLGeometry', 'STLGeometry']
class STLGeometry(netgen.libngpy._meshing.NetgenGeometry):
    ...
    def GetDirtyTrigs(self, **kwargs) -> None:
        ...
    def GetVicinity(self, node: int, size: int, node_type: str = 'trig') -> STLGeometry:
        ...
    def MovePointToMiddle(self, arg0: int, arg1: int) -> None:
        ...
