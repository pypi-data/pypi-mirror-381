...
class FlatArray_I_S:
    ...
    def __setitem__(self, arg0: int, arg1: int) -> int:
        ...
    @typing.overload
    def __setitem__(self, arg0: slice, arg1: int) -> None:
        ...
    def __str__(self) -> str:
        ...
class FlatArray_S_S:
...
class MPI_Comm:
    ...
    def Min(self, arg0: int) -> int:
        ...
    def SubComm(self, procs: list[int]) -> MPI_Comm:
        ...
    @typing.overload
...
class PajeTrace:
    @staticmethod
    def SetMaxTracefileSize(arg0: int) -> None:
        ...
    @staticmethod
    ...
    def __exit__(self, *args) -> None:
        ...
    def __init__(self, filename: str = 'ng.trace', size: int = 1000, threads: bool = True, thread_counter: bool = False, memory: bool = True) -> None:
        """
        size in Megabytes
        """
class Table_I:
    def __getitem__(self, arg0: int) -> FlatArray_I_S:
        ...
...
def GetTotalMemory() -> int:
    ...
def InitMPI(mpi_library_path: os.PathLike | None = None) -> None:
    ...
