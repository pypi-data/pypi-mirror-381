...
class ConnectorModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["connector_id", "connector_name", "connector_type", "embedding_model", "number_of_files", "refresh_frequency", "last_refreshed", "next_refresh", "is_indexing", "n_tokens"]
