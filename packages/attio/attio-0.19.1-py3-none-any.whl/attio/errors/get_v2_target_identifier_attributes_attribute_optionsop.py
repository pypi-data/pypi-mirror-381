...
from attio.models import (
    get_v2_target_identifier_attributes_attribute_optionsop as models_get_v2_target_identifier_attributes_attribute_optionsop,
)
...
class GetV2TargetIdentifierAttributesAttributeOptionsNotFoundError(SDKError):
    ...
    data: GetV2TargetIdentifierAttributesAttributeOptionsNotFoundErrorData = field(
        hash=False
    )
