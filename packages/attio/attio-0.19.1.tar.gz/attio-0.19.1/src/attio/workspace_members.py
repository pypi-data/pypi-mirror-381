...
class WorkspaceMembers(BaseSDK):
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.GetV2WorkspaceMembersResponse, http_res
            )
    ...
    async def get_v2_workspace_members_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def get_v2_workspace_members_workspace_member_id_(
        self,
        *,
        ...
        request = models.GetV2WorkspaceMembersWorkspaceMemberIDRequest(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.GetV2WorkspaceMembersWorkspaceMemberIDResponse, http_res
            )
        if utils.match_response(http_res, "404", "application/json"):
            response_data = unmarshal_json_response(
                errors.GetV2WorkspaceMembersWorkspaceMemberIDNotFoundErrorData, http_res
            )
            raise errors.GetV2WorkspaceMembersWorkspaceMemberIDNotFoundError(
    ...
    async def get_v2_workspace_members_workspace_member_id__async(
        self,
        *,
        workspace_member_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
