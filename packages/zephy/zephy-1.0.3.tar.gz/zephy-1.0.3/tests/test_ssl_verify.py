...
class TestSSLVerification:
    ...
    def test_cli_ssl_verify_flags(self):
        ...
        with patch('sys.argv', ['aeolus', '--tfe-org', 'test-org', '--azure-subscription', 'test-sub', '--no-tfe-ssl-verify', '--dry-run']):
            result = main.main()
    ...
    def test_cli_ssl_verify_default(self):
        ...
        with patch('sys.argv', ['aeolus', '--tfe-org', 'test-org', '--azure-subscription', 'test-sub', '--dry-run']):
            result = main.main()
