...
setup(**{
    ...
    'entry_points': {
        'backendai_cli_v10': [
            'ag = ai.backend.agent.cli.__main__:main',
    ...
    'install_requires': (
        ...
        'async_timeout~=4.0',
        'attrs>=25.3',
        """backend.ai-cli==25.15.0
""",
        """backend.ai-common==25.15.0
""",
        """backend.ai-kernel-binary==25.15.0
""",
        """backend.ai-kernel-helper==25.15.0
""",
        """backend.ai-kernel==25.15.0
""",
        'backend.ai-krunner-static-gnu==4.4.0',
        """backend.ai-logging==25.15.0
""",
        """backend.ai-plugin==25.15.0
""",
        'cachetools~=5.5.0',
        'callosum~=1.0.3',
        'cattrs~=24.1.1',
...
""",
    ...
    'packages': (
        'ai.backend.agent',
        'ai.backend.agent.cli',
        'ai.backend.agent.config',
        'ai.backend.agent.docker',
        'ai.backend.agent.docker.metadata',
        'ai.backend.agent.dummy',
        'ai.backend.agent.kubernetes',
        'ai.backend.agent.metrics',
        'ai.backend.agent.observer',
        'ai.backend.agent.plugin',
        'ai.backend.agent.stage',
        'ai.backend.agent.stage.kernel_lifecycle',
        'ai.backend.agent.stage.kernel_lifecycle.docker',
        'ai.backend.agent.stage.kernel_lifecycle.docker.mount',
        'ai.backend.agent.vendor',
        'ai.backend.agent.watcher',
    ),
    'project_urls': {
