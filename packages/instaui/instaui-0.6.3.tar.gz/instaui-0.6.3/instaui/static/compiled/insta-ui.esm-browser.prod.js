...
import { toRaw as dn, toValue as be, normalizeClass as ut, normalizeStyle as hr, cloneVNode as se, vModelDynamic as pr, vShow as mr, withDirectives as hn, h as J, toDisplayString as pn, withModifiers as gr, resolveDynamicComponent as yr, normalizeProps as vr, TransitionGroup as wr, createTextVNode as _r, unref as K, toRef as me, readonly as kt, customRef as ye, ref as U, onBeforeUnmount as Er, onMounted as mn, nextTick as Se, getCurrentScope as br, onScopeDispose as Sr, getCurrentInstance as ze, watch as G, isRef as Ot, shallowRef as ae, watchEffect as Rt, computed as B, inject as ce, shallowReactive as kr, defineComponent as Z, reactive as Or, provide as H, onUnmounted as Rr, onErrorCaptured as Nr, openBlock as fe, createElementBlock as Ee, createElementVNode as gn, createVNode as Pr, createCommentVNode as ft, mergeProps as de, createBlock as yn, Teleport as Vr, renderSlot as Cr, useAttrs as Ar, Fragment as xr, useSlots as Ke, KeepAlive as $r } from "vue";
let vn;
function Tr(e) {
  vn = e;
}
  ...
  function r(l, f) {
    ...
    const k = [new Promise((v) => {
      _ = G(
        [e, l],
        ([O, A]) => {
          t !== (O === A) && (_ ? _() : Se(() => _ == null ? void 0 : _()), v(O));
        },
        {
          flush: d,
          deep: p,
...
function Cs(e, t, n) {
  ...
  }), s ? B(() => (c.value = !0, h.value)) : h;
}
const Oe = On ? window : void 0, As = On ? window.document : void 0;
function Vt(e) {
  var t;
  const n = te(e);
...
function Is(e, t = {}) {
  const { window: n = Oe } = t, r = Cn(() => n && "matchMedia" in n && typeof n.matchMedia == "function");
  let s;
  const o = U(!1), i = (h) => {
    o.value = h.matches;
  }, a = () => {
...
function gt(e, t, n, r = {}) {
  ...
  if (!n)
    try {
      n = An("getDefaultStorage", () => {
        var P;
        return (P = Oe) == null ? void 0 : P.localStorage;
      })();
    } catch (P) {
      d(P);
    }
  ...
  l && a && Vn(() => {
    n instanceof Storage ? Lt(l, "storage", L) : Lt(l, Ft, Q), p && L();
  }), p || L();
  function O(P, I) {
    if (l) {
      const F = {
  ...
  function A(P) {
    try {
      const I = n.getItem(e);
      if (P == null)
        O(I, null), n.removeItem(e);
      else {
        const F = w.write(P);
        I !== F && (n.setItem(e, F), O(I, F));
      }
    } catch (I) {
      d(I);
    }
...
function Ws(e = {}) {
  const {
    ...
    dark: "dark",
    ...e.modes || {}
  }, f = js({ window: s }), d = B(() => f.value ? "dark" : "light"), p = c || (i == null ? Pn(r) : gt(i, r, o, { window: s, listenToStorageChanges: a })), m = B(() => p.value === "auto" ? d.value : p.value), y = An(
    "updateHTMLAttrs",
    (v, O, A) => {
...
const jn = /#/g, bo = /&/g, So = /\//g, ko = /=/g, Oo = /\?/g, Bn = /\+/g, Ro = /%5B/g, No = /%5D/g, Ln = /%5E/g, Po = /%60/g, Fn = /%7B/g, Vo = /%7C/g, Wn = /%7D/g, Co = /%20/g;
function At(e) {
  return encodeURI("" + e).replace(Vo, "|").replace(Ro, "[").replace(No, "]");
}
function Ao(e) {
  return At(e).replace(Fn, "{").replace(Wn, "}").replace(Ln, "^");
}
function vt(e) {
  return At(e).replace(Bn, "%2B").replace(Co, "+").replace(jn, "%23").replace(bo, "%26").replace(Po, "`").replace(Fn, "{").replace(Wn, "}").replace(Ln, "^");
}
function xo(e) {
  return vt(e).replace(ko, "%3D");
}
function $o(e) {
  return At(e).replace(jn, "%23").replace(Oo, "%3F");
}
function To(e) {
...
function Re(e) {
  try {
    ...
    R.NODE_ENV !== "production" && N(`Error decoding "${e}". Using original value`);
  }
  return "" + e;
}
...
function Wo(e) {
  ...
  if ("el" in e) {
    ...
    if (!s) {
      R.NODE_ENV !== "production" && N(`Couldn't find element using selector "${e.el}" returned by scrollBehavior.`);
      return;
    }
    t = Fo(s, e);
  } else
...
let zo = () => location.protocol + "//" + location.host;
function Kn(e, t) {
...
function Go(e) {
  ...
  function o(c, h, u) {
    const l = e.indexOf("#"), f = l > -1 ? (n.host && document.querySelector("base") ? e : e.slice(l)) + c : zo() + e + c;
    try {
      t[u ? "replaceState" : "pushState"](h, "", f), s.value = h;
    } catch (d) {
      R.NODE_ENV !== "production" ? N("Error with push/replace State", d) : console.error(d), n[u ? "replace" : "assign"](f);
    }
  }
  function i(c, h) {
  ...
  function a(c, h) {
    ...
    R.NODE_ENV !== "production" && !t.state && N(`history.state seems to have been manually replaced without preserving the necessary values. Make sure to preserve existing history state if you are manually calling history.replaceState:
...
function Jo(e) {
  return e = location.host ? e || location.pathname + location.search : "", e.includes("#") || (e += "#"), R.NODE_ENV !== "production" && !e.endsWith("#/") && !e.endsWith("#") && N(`A hash base must end with a "#":
...
function Pe(e, t) {
  return R.NODE_ENV !== "production" ? x(new Error(Qo[e](t)), {
    type: e,
    [_t]: !0
  }, t) : x(new Error(), {
    type: e,
...
function ai(e, t) {
  ...
  function o(l, f, d) {
    const p = !d, m = Zt(l);
    R.NODE_ENV !== "production" && fi(m, f), m.aliasOf = d && d.record;
    const y = tn(t, l), _ = [m];
    if ("alias" in l) {
    ...
    for (const v of _) {
      ...
      if (f && O[0] !== "/") {
        ...
        v.path = f.record.path + (O && T + O);
      }
      if (R.NODE_ENV !== "production" && v.path === "*")
        throw new Error(`Catch all routes ("*") must now be defined using a param with a custom regexp.
See more at https://router.vuejs.org/guide/migration/#Removed-star-or-catch-all-routes.`);
      if (w = ii(v, f, y), R.NODE_ENV !== "production" && f && O[0] === "/" && hi(w, f), d ? (d.alias.push(w), R.NODE_ENV !== "production" && ui(d, w)) : (k = k || w, k !== w && k.alias.push(w), p && l.name && !en(w) && (R.NODE_ENV !== "production" && di(l, f), i(l.name))), Qn(w) && c(w), m.children) {
        const A = m.children;
  ...
  function h(l, f) {
    ...
    if ("name" in l && l.name) {
      ...
      if (R.NODE_ENV !== "production") {
        const k = Object.keys(l.params || {}).filter((v) => !d.keys.find((O) => O.name === v));
      ...
      m = l.path, R.NODE_ENV !== "production" && !m.startsWith("/") && N(`The Matcher cannot resolve relative paths but received "${m}". Unless you directly called \`matcher.resolve("${m}")\`, this is probably a bug in vue-router. Please open an issue at https://github.com/vuejs/router/issues/new/choose.`), d = n.find((k) => k.re.test(m)), d && (p = d.parse(m), y = d.record.name);
    else {
...
function pi(e, t) {
  ...
  const s = mi(e);
  return s && (r = t.lastIndexOf(s, r - 1), R.NODE_ENV !== "production" && r < 0 && N(`Finding ancestor route "${s.record.path}" failed for "${e.record.path}"`)), r;
}
function mi(e) {
  let t = e;
  for (; t = t.parent; )
...
function gi(e) {
  ...
  for (let s = 0; s < r.length; ++s) {
    const o = r[s].replace(Bn, " "), i = o.indexOf("="), a = Re(i < 0 ? o : o.slice(0, i)), c = i < 0 ? null : Re(o.slice(i + 1));
    if (a in t) {
      let h = t[a];
...
const vi = Symbol(R.NODE_ENV !== "production" ? "router view location matched" : ""), rn = Symbol(R.NODE_ENV !== "production" ? "router view depth" : ""), Qe = Symbol(R.NODE_ENV !== "production" ? "router" : ""), xt = Symbol(R.NODE_ENV !== "production" ? "route location" : ""), bt = Symbol(R.NODE_ENV !== "production" ? "router view location" : "");
function Ve() {
  let e = [];
  function t(r) {
    return e.push(r), () => {
...
function lt(e, t, n, r, s = (o) => o()) {
  const o = [];
  for (const i of e) {
    R.NODE_ENV !== "production" && !i.components && !i.children.length && N(`Record with path "${i.path}" is either missing a "component(s)" or "children" property.`);
    for (const a in i.components) {
      ...
      if (!(t !== "beforeRouteEnter" && !i.instances[a]))
        if (Mn(c)) {
          ...
          let h = c();
          R.NODE_ENV !== "production" && !("catch" in h) && (N(`Component "${a}" in record with path "${i.path}" is a function that does not return a Promise. If you were passing a functional component, make sure to add a "displayName" to the component. This will break in production if not fixed.`), h = Promise.resolve(h)), o.push(() => h.then((u) => {
            if (!u)
...
function sn(e) {
  ...
  const o = B(() => {
    const u = K(e.to);
    return R.NODE_ENV !== "production" && (!r || u !== s) && (He(u) || (r ? N(`Invalid value for prop "to" in useLink()
- to:`, u, `
- previous to:`, s, `
...
- props:`, e)), s = u, r = !0), t.resolve(u);
  ...
  }), a = B(() => i.value > -1 && ki(n.params, o.value.params)), c = B(() => i.value > -1 && i.value === n.matched.length - 1 && Un(n.params, o.value.params));
  function h(u = {}) {
    if (Si(u)) {
  ...
  if (R.NODE_ENV !== "production" && ie) {
    ...
    if (u) {
      ...
      u.__vrl_devtools = u.__vrl_devtools || [], u.__vrl_devtools.push(l), Rt(() => {
...
const Ei = /* @__PURE__ */ Z({
  ...
  useLink: sn,
  setup(e, { slots: t }) {
    const n = Or(sn(e)), { options: r } = ce(Qe), s = B(() => ({
...
const an = (e, t, n) => e ?? t ?? n, Oi = /* @__PURE__ */ Z({
  name: "RouterView",
  ...
  setup(e, { attrs: t, slots: n }) {
    ...
    const r = ce(bt), s = B(() => e.route || r.value), o = ce(rn, 0), i = B(() => {
      let h = K(o);
    ...
    H(rn, B(() => i.value + 1)), H(vi, a), H(bt, s);
    const c = U();
    return G(() => [c.value, a.value, e.name], ([h, u, l], [f, d, p]) => {
      ...
      if (R.NODE_ENV !== "production" && ie && y.ref) {
        const _ = {
          depth: i.value,
          name: l.name,
          path: l.path,
  ...
  _o({
    ...
    typeof s.now != "function" && console.warn("[Vue Router]: You seem to be using an outdated version of Vue Devtools. Are you still using the Beta release instead of the stable one? You can find the links at https://devtools.vuejs.org/guide/installation.html."), s.on.inspectComponent((u, l) => {
      ...
      X(l.__vrl_devtools) && (l.__devtoolsApi = s, l.__vrl_devtools.forEach((f) => {
        ...
        f.error ? (d = f.error, p = Ti, y = Ii) : f.isExactActive ? (p = Zn, m = "This is exactly active") : f.isActive && (p = Xn, m = "This link is active"), u.tags.push({
          label: d,
          textColor: y,
          tooltip: m,
          backgroundColor: p
...
function St(e, t) {
  ...
  const s = e.record.path.toLowerCase(), o = Re(s);
...
function Bi(e) {
  const t = ai(e.routes, e), n = e.parseQuery || gi, r = e.stringifyQuery || nn, s = e.history;
  ...
  const u = it.bind(null, (g) => "" + g), l = it.bind(null, To), f = (
    // @ts-expect-error: intentionally avoid the type check
    it.bind(null, Re)
  );
  function d(g, b) {
    let E, S;
    return qn(g) ? (E = t.getRecordMatcher(g), R.NODE_ENV !== "production" && !E && N(`Parent route "${String(g)}" not found when adding child route`, b), S = b) : S = g, t.addRoute(S, E);
  }
  function p(g) {
    const b = t.getRecordMatcher(g);
    b ? t.removeRoute(b) : R.NODE_ENV !== "production" && N(`Cannot remove non-existent route "${String(g)}"`);
  }
  function m() {
  ...
  function _(g, b) {
    if (b = x({}, b || c.value), typeof g == "string") {
      ...
      return R.NODE_ENV !== "production" && (pe.startsWith("//") ? N(`Location "${g}" resolved to "${pe}". A resolved location cannot start with multiple slashes.`) : j.matched.length || N(`No match found for location with path "${g}"`)), x(V, j, {
        params: f(j.params),
        hash: Re(V.hash),
        redirectedFrom: void 0,
        href: pe
    ...
    if (R.NODE_ENV !== "production" && !He(g))
      return N(`router.resolve() was passed an invalid location. This will fail in production.
- Location:`, g), _({});
    let E;
    if (g.path != null)
      R.NODE_ENV !== "production" && "params" in g && !("name" in g) && // @ts-expect-error: the type is never
    ...
    R.NODE_ENV !== "production" && $ && !$.startsWith("#") && N(`A \`hash\` should always start with the character "#". Replace "${$}" with "#${$}".`), S.params = u(f(S.params));
    const W = Mo(r, x({}, g, {
      hash: Ao($),
      path: S.path
    })), C = s.createHref(W);
    return R.NODE_ENV !== "production" && (C.startsWith("//") ? N(`Location "${g}" resolved to "${C}". A resolved location cannot start with multiple slashes.`) : S.matched.length || N(`No match found for location with path "${g.path != null ? g.path : g}"`)), x({
      fullPath: W,
 ...
 Are you always returning a new location within a navigation guard? That would lead to this error. Only return when redirecting or aborting, that should fix this. This might break in production if not fixed.`), Promise.reject(new Error("Infinite redirect in navigation guard"))) : T(
  ...
  function cr() {
    ee || (ee = s.listen((g, b, E) => {
      ...
      h = S;
      const W = c.value;
      ie && Uo(Gt(W.fullPath, E.delta), Je()), P(S, W).catch((C) => oe(
        C,
        12
        /* ErrorTypes.NAVIGATION_CANCELLED */
      ) ? C : oe(
  ...
  function nt(g, b, E) {
    rt(g);
    const S = $t.list();
    return S.length ? S.forEach(($) => $(g, b, E)) : (R.NODE_ENV !== "production" && N("uncaught error during route navigation:"), console.error(g)), Promise.reject(g);
  }
  function lr() {
  ...
  function Tt(g, b, E, S) {
    ...
    if (!ie || !$)
      return Promise.resolve();
    const W = !E && Ho(Gt(g.fullPath, 0)) || (S || !E) && history.state && history.state.scroll || null;
    return Se().then(() => $(g, b, W)).then((C) => C && Wo(C)).catch((C) => nt(C, g, b));
  }
  const st = (g) => s.go(g);
  let ot;
  const je = /* @__PURE__ */ new Set(), It = {
    ...
    install(g) {
      const b = this;
      g.component("RouterLink", bi), g.component("RouterView", Ri), g.config.globalProperties.$router = b, Object.defineProperty(g.config.globalProperties, "$route", {
        enumerable: !0,
        get: () => K(c)
      }), ie && // used for the initial navigation client side to avoid pushing
      // multiple times when the router is used in multiple apps
      !ot && c.value === le && (ot = !0, v(s.location).catch(($) => {
        R.NODE_ENV !== "production" && N("Unexpected error when starting the router:", $);
      }));
      const E = {};
      for (const $ in le)
      ...
      }, R.NODE_ENV !== "production" && ie && Vi(g, b, t);
    }
  };
  function we(g) {
...
function Hi(e, t, n) {
  ...
  const { id: r } = e;
  if (zi(n.vforSetting, r, t), Ki(n.slotSetting, r, t), e.routerParam) {
    const d = D(r, e.routerParam), p = Wi(), m = B(() => p.params);
  ...
  (s = e.data) == null || s.forEach((d) => {
    ...
    const { id: p, constData: m } = d, _ = m !== void 0 ? t.getValue(d.value) : d.value, w = D(r, p), k = eo({ ...d, value: _ });
    t._registerBinding(w, k), H(w, k);
  }), (c = e.web_computed) == null || c.forEach((d) => {
    const p = D(r, d.id), m = no(d);
    t._registerBinding(p, m), H(p, m);
...
function Gi(e, t) {
  ...
  function d(v) {
    if (v != null && v.item) {
      const { id: O, value: A, sourceInfo: T } = v.item;
      if (T) {
        const { index: P, key: I } = T;
        o && (o.value = P), i && (i.value = I);
      }
      const L = D(e.id, O), Q = c({ r: m(L) });
      Q.value = A;
    }
    if (v != null && v.index) {
      const { id: O, value: A } = v.index, T = D(e.id, O), L = c({ r: m(T) });
      L.value = A;
    }
    if (v != null && v.key) {
      const { id: O, value: A } = v.key, T = D(e.id, O), L = c({ r: m(T) });
      L.value = A;
    }
  }
  function p(v) {
    if (!v)
      return;
    const { id: O, value: A } = v, T = D(e.id, O), L = c({ r: m(T) });
    L.value = A;
  }
  function m(v) {
    return s.get(v);
...
function Qi(e, t, n, r) {
  const s = new Set(e == null ? void 0 : e.map((c) => D(c.sid, c.id))), o = Yi(
    e,
    s,
    t,
    n
...
const ia = {
  ...
  setup(e) {
    ...
    G(r, (a) => {
      ...
      }), Qr(t.meta.mode), oa(a.icons)), ra(t.meta.mode);
    });
    const { hasError: o, errorMessage: i } = na(n);
    return (a, c) => (fe(), Ee("div", ia, [
      K(s) ? (fe(), Ee("div", aa, c[0] || (c[0] = [
        ...
        K(o) ? (fe(), Ee("div", ca, pn(K(i)), 1)) : ft("", !0)
      ], 2))
    ]));
  }
}), un = /* @__PURE__ */ new Map([
...
const ha = "insta-Heading", pa = Z(ma, {
  props: [
    "as",
    "as_child",
    "size",
...
const ga = /* @__PURE__ */ Z({
...
}), ya = ["width", "height", "color"], va = ["xlink:href"], wa = /* @__PURE__ */ Z({
  __name: "Icon",
  props: {
    size: {},
    icon: {},
  ...
  setup(e) {
    const t = e, n = me(() => t.icon ? t.icon.split(":")[1] : ""), r = me(() => t.size || "1em"), s = me(() => t.color || "currentColor"), o = me(() => t.rawSvg || null), i = B(() => `#${t.icon}`), a = Ar(), c = sa(o, {
      size: me(() => t.size),
      color: me(() => t.color),
      attrs: a
    });
    return (h, u) => (fe(), Ee(xr, null, [
      n.value ? (fe(), Ee("svg", de({
        ...
        gn("use", { "xlink:href": i.value }, null, 8, va)
      ], 16, ya)) : ft("", !0),
...
const et = [
  ...
  "gap_x",
  "gap_y"
].concat(et), Ea = ["direction"].concat(_a), ba = [
  "as_child",
  "size",
  "display",
  "align",
  "ctn_size"
].concat(et), Sa = ["as", "as_child", "display"].concat(et), ka = [
  "as",
  "as_child",
  "display",
  "areas",
  ...
  "gap_x",
  "gap_y"
].concat(et), Oa = "insta-Box", Ra = Z(Na, {
  props: Sa
});
function Na(e) {
  const t = Ke();
...
function Aa(e) {
  ...
  return () => {
    var a;
    const n = { ...Va, ...Xe(e) }, { classes: r, style: s } = Ze(n), o = de(
      { class: r, style: s },
      { class: Pa }
    ), i = (a = t.default) == null ? void 0 : a.call(t);
    return e.as_child && i && i.length > 0 ? (Ye(i), se(i[0], o)) : J(e.as || "div", o, i);
...
function Ia(e) {
  ...
  return () => {
    var c;
    const n = { ...$a, ...Xe(e) }, r = Ze(n), [s, o] = Da(r.classes, r.style), i = de(
      { class: s, style: o },
      { class: xa }
...
const ja = "insta-Container", Ba = Z(La, {
  props: ba
});
function La(e) {
  const t = Ke();
...
function Qa(e, t) {
  e.component("insta-ui", la), e.component("teleport", ga), e.component("icon", wa), e.component("heading", pa), e.component("box", Ra), e.component("flex", Ca), e.component("grid", Ta), e.component("container", Ba), e.component("ui-text", Wa), t.router && Ha(e, t);
}
export {
  Ue as convertDynamicProperties,
  Qa as install,
  Ja as useBindingGetter
};
