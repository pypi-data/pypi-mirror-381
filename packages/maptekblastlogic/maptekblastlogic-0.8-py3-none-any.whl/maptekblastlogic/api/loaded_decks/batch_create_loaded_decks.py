...
) -> Optional[Union[Any, ErrorModel, List[int]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorModel, List[int]]]:
    return Response(
