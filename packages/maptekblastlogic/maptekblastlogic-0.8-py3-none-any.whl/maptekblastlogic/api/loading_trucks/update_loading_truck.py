...
def _get_kwargs(
    site_code: str,
    loading_truck_id: int,
    *,
    body: LoadingTruckModel,
    if_match: str,
) -> Dict[str, Any]:
    ...
    _kwargs: Dict[str, Any] = {
        "method": "put",
        "url": f"/site/{site_code}/truck/{loading_truck_id}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Update an existing loading truck.

     Requires permissions:  Edit Site Resources

    Args:
        site_code (str):
        loading_truck_id (int):
        if_match (str):
        body (LoadingTruckModel): A truck used to load blast products into holes.
