...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/site/{site_code}/backfillingEntry/{backfilling_entry_id}",
    }
...
) -> Optional[Union[BackfillingEntryModel, ErrorModel]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = BackfillingEntryModel.from_dict(response.json())
