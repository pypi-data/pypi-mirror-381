...
def _get_kwargs(
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/site/{site_code}/personnel",
    }
...
) -> Optional[Union[ErrorModel, List["PersonModel"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PersonModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorModel, List["PersonModel"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorModel, List['PersonModel']]
    """
