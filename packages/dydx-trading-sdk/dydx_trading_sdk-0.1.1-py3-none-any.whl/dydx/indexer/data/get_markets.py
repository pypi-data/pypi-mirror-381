...
class GetMarkets(IndexerMixin):
  @overload
  async def get_markets(self, market: str | None = None, *, limit: int | None = None, validate: bool | None = None, unsafe: Literal[True]) -> Markets:
    ...
  @overload
  async def get_markets(self, market: str | None = None, *, limit: int | None = None, validate: bool | None = None, unsafe: bool = False) -> Response[Markets]:
    ...
  async def get_markets(
    self, market: str | None = None, *, limit: int | None = None, validate: bool | None = None, unsafe: bool = False,
  ...
  async def get_market(
    ...
    > [dYdX API docs](https://docs.dydx.xyz/indexer-client/http#get-perpetual-markets)
    """
    r = await self.get_markets(market, limit=limit, validate=validate, unsafe=False)
    if unsafe:
      return r['markets'][market] # type: ignore
    elif r['status'] == 'OK': # type: ignore
      return {
        'status': 'OK',
        'data': r['data']['markets'][market], # type: ignore
      }
    else:
