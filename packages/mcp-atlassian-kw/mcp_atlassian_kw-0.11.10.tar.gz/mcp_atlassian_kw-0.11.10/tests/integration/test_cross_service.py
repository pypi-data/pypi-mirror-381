...
from mcp_atlassian_kw.confluence import ConfluenceConfig
from mcp_atlassian_kw.jira import JiraConfig
...
from mcp_atlassian_kw.servers.main import AtlassianMCP, main_lifespan
...
class TestSharedAuthentication:
    ...
    async def test_authentication_context_in_request(self):
        ...
        with patch(
            "mcp_atlassian_kw.servers.dependencies.get_http_request", return_value=request
        ):
            ...
            with (
                patch("mcp_atlassian_kw.jira.JiraFetcher") as mock_jira_fetcher,
                patch(
                    "mcp_atlassian_kw.confluence.ConfluenceFetcher"
...
class TestCrossServiceErrorHandling:
    ...
    async def test_jira_failure_does_not_affect_confluence(self):
        ...
        with MockEnvironment.basic_auth_env():
            ...
            with patch(
                "mcp_atlassian_kw.jira.config.JiraConfig.from_env"
            ) as mock_jira_config:
    ...
    async def test_confluence_failure_does_not_affect_jira(self):
        ...
        with MockEnvironment.basic_auth_env():
            ...
            with patch(
                "mcp_atlassian_kw.confluence.config.ConfluenceConfig.from_env"
            ) as mock_conf_config:
...
class TestConcurrentServiceInitialization:
    ...
    async def test_parallel_fetcher_creation(self):
        ...
        with MockEnvironment.oauth_env():
            ...
            with (
                patch(
                    "mcp_atlassian_kw.servers.dependencies.get_http_request",
