...
def test_init_from_env():
    ...
    with (
        ...
        patch("mcp_atlassian_kw.confluence.client.Confluence") as mock_confluence,
        patch("mcp_atlassian_kw.preprocessing.confluence.ConfluencePreprocessor"),
        patch("mcp_atlassian_kw.confluence.client.configure_ssl_verification"),
    ):
...
def test_process_html_content():
    ...
    # Arrange
    with (
        patch("mcp_atlassian_kw.confluence.client.ConfluenceConfig.from_env"),
        patch("mcp_atlassian_kw.confluence.client.Confluence"),
        patch(
            "mcp_atlassian_kw.preprocessing.confluence.ConfluencePreprocessor"
...
def test_get_user_details_by_accountid():
    ...
    with (
        patch("mcp_atlassian_kw.confluence.client.ConfluenceConfig.from_env"),
        patch("mcp_atlassian_kw.confluence.client.Confluence") as mock_confluence_class,
        patch("mcp_atlassian_kw.preprocessing.confluence.ConfluencePreprocessor"),
        patch("mcp_atlassian_kw.confluence.client.configure_ssl_verification"),
    ):
