...
class LegacyBackendFactory:
    ...
    def _initialize_nvidia_backend(self) -> None:
        ...
        try:
            ...
            # Create a mock NVIDIA backend as fallback
            self._backends["nvidia"] = self._create_mock_backend("nvidia")
    ...
    def _initialize_amd_backend(self) -> None:
        ...
        try:
            ...
            # Create a mock AMD backend as fallback
            self._backends["amd"] = self._create_mock_backend("amd")
    ...
    def _initialize_intel_backend(self) -> None:
        ...
        try:
            ...
            # Create a mock Intel backend as fallback
            self._backends["intel"] = self._create_mock_backend("intel")
