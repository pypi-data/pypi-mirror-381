...
from goodmem_client.api_response import ApiResponse, T as ApiResponseT
import goodmem_client.models
from goodmem_client import rest
from goodmem_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(goodmem_client.models, klass)
