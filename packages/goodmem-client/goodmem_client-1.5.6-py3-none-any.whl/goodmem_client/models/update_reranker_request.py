...
class UpdateRerankerRequest(BaseModel):
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="User-facing name of the reranker", alias="displayName")
    ...
    api_path: Optional[StrictStr] = Field(default=None, description="API path for reranking request", alias="apiPath")
    ...
    __properties: ClassVar[List[str]] = ["validateLabelStrategy", "displayName", "description", "endpointUrl", "apiPath", "modelIdentifier", "supportedModalities", "credentials", "replaceLabels", "mergeLabels", "version", "monitoringEndpoint"]
