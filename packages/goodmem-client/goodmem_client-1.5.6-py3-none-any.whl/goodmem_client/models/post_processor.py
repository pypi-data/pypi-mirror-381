...
class PostProcessor(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the post-processor to apply.")
    config: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Configuration parameters for the post-processor.")
