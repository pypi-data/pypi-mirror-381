...
class RerankerCreationRequest(BaseModel):
    ...
    credentials: Optional[StrictStr] = Field(default=None, description="API credentials (optional for local services)")
    ...
    __properties: ClassVar[List[str]] = ["validate", "displayName", "description", "providerType", "endpointUrl", "apiPath", "modelIdentifier", "supportedModalities", "credentials", "labels", "version", "monitoringEndpoint", "ownerId"]
