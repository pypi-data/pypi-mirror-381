...
class EmbedderCreationRequest(BaseModel):
    ...
    api_path: Optional[StrictStr] = Field(default=None, description="API path for embeddings request (defaults to /embeddings if not provided)", alias="apiPath")
    ...
    credentials: StrictStr = Field(description="API credentials (required)")
    ...
    __properties: ClassVar[List[str]] = ["validate", "displayName", "description", "providerType", "endpointUrl", "apiPath", "modelIdentifier", "dimensionality", "distributionType", "maxSequenceLength", "supportedModalities", "credentials", "labels", "version", "monitoringEndpoint", "ownerId"]
