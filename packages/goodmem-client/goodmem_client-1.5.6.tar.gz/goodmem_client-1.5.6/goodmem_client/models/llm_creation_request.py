...
class LLMCreationRequest(BaseModel):
    ...
    credentials: StrictStr = Field(description="API credentials (empty allowed for local services)")
    ...
    __properties: ClassVar[List[str]] = ["validate", "displayName", "description", "providerType", "endpointUrl", "apiPath", "modelIdentifier", "supportedModalities", "credentials", "labels", "version", "monitoringEndpoint", "capabilities", "defaultSamplingParams", "maxContextLength", "clientConfig", "ownerId"]
