...
class BondLenghError(Exception):
    ...
    def __init__(
        self, atom_1=None, atom_2=None, dist: int = 0.0, threshold: float = 0.8
    ):
        self.message = "WARNING: Atoms {} and {} are closer than {} A, {}".format(
            atom_1, atom_2, dist, threshold
        )
...
class BBConnectivityError(Exception):
    ...
    def __init__(self, connectivity=None, found_connectivity=None):
        self.message = (
            "ERROR: The building block connectivity should be {} buy is {}".format(
                connectivity, found_connectivity
            )
        )
...
class ConnectionGroupError(Exception):
    ...
    def __init__(self, conn_1=None, conn_2=None):
        self.message = "ERROR: The connection group {} not compatible with {}".format(
            conn_1, conn_2
        )
