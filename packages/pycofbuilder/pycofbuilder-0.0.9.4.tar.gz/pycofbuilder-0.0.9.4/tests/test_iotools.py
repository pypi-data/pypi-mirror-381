...
def test_read_cif_symmetry_default():
    ...
    atomTypes, cartPos, cellMatrix, partialCharges = read_cif(
        file_path, "RIO_13_symmetry.cif", usePymatgen=True
    )
...
def test_read_cif_symmetry_ase():
    ...
    atomTypes, cartPos, cellMatrix, partialCharges = read_cif(
        file_path, "RIO_13_symmetry.cif", useASE=True
    )
...
def test_read_cif_charges_default():
    ...
    atomTypes, cartPos, cellMatrix, partialCharges = read_cif(
        file_path, "RIO_13_P1_charge.cif"
    )
...
def test_read_cif_charges_pymatgen():
    ...
    atomTypes, cartPos, cellMatrix, partialCharges = read_cif(
        file_path, "RIO_13_P1_charge.cif", usePymatgen=True
    )
...
def test_read_cif_charges_ase():
    ...
    atomTypes, cartPos, cellMatrix, partialCharges = read_cif(
        file_path, "RIO_13_P1_charge.cif", useASE=True
    )
