...
class ConnectCasesClient(BaseClient):
    ...
    def batch_get_case_rule(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_connectcases/client/#batch_get_case_rule)
        """
    ...
    def create_case_rule(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_connectcases/client/#create_case_rule)
        """
    ...
    def list_case_rules(
        ...
        [Show types-boto3 documentation](https://youtype.github.io/types_boto3_docs/types_boto3_connectcases/client/#list_case_rules)
        """
