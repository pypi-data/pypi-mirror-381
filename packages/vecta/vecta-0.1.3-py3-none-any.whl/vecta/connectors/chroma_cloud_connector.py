"""ChromaDB Cloud connector implementation."""
...
class ChromaCloudConnector(BaseVectorDBConnector):
    def __init__(
        self,
        tenant: str,
        database: str,
        ...
        """Initialize ChromaDB Cloud connector."""
        ...
        try:
            # Create cloud client
            self.client = CloudClient(tenant=tenant, database=database, api_key=api_key)

            # Change this line to use get_or_create_collection
            self.collection = self.client.get_or_create_collection(name=collection_name)
        except Exception as e:
            raise ValueError(
                f"Could not connect to Chroma Cloud or access collection '{collection_name}': {e}"
            )
