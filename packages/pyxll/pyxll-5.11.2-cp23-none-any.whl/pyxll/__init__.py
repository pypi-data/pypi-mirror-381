...
class TableBase:
    ...
    def skipped_columns(self):
        ...
        """
        return None
    skipped_columns = property(skipped_columns)
    ...
    def formatter(self, formatter):
        self.__formatter = formatter
    formatter = formatter.setter(formatter)
...
class Table(TableBase):
    ...
    preserve_columns = property(preserve_columns)
...
class BaseFormatter(object):
    ...
    def apply_if_nested():
        ...
        """
        return False
    apply_if_nested = staticmethod(apply_if_nested)
    ...
    apply_styles = staticmethod(apply_styles)
