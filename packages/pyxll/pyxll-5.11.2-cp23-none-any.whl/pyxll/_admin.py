...
class TOKEN_PRIVILEGES(ctypes.Structure):
    ...
    Privileges = property(Privileges)
...
class SID(ctypes.Structure):
    ...
    def SubAuthority(self):
        ...
        array._obj = self
        return array
    SubAuthority = property(SubAuthority)
...
open_effective_token = contextlib.contextmanager(open_effective_token)
...
enable_privileges = contextlib.contextmanager(enable_privileges)
