...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-chime-sdk-meetings)](https://pypistats.org/packages/mypy-boto3-chime-sdk-meetings)
...
`mypy-boto3-chime-sdk-meetings` dependency in production. However, there is an
