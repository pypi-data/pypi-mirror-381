...
# Extended column list including adjusted prices for CAFE data source
STOCK_COLUMNS_CAFEF_ADJUSTED=[
    'code', 'date',
    'close', 'open', 'high', 'low', 'adjust_price', 'change', 'percent_change',
    'volume_match', 'value_match', 'volume_reconcile', 'value_reconcile',
...
# Adjusted price column names for easy reference
ADJUSTED_PRICE_COLUMNS = ['adjusted_open', 'adjusted_high', 'adjusted_low', 'adjusted_close', 'adjustment_factor']
