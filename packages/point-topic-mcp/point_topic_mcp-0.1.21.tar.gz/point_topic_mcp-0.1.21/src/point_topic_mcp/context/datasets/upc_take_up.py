...
"""
    },
    {
        ...
        "response": """
-- This query demonstrates time-series analysis, which is best handled by the 'long' historical tables.
...
-- The QUALIFY clause is a clean Snowflake-specific way to filter based on window function results.
-- Here we limit the output to the most recent 4 quarters available in the dataset.
