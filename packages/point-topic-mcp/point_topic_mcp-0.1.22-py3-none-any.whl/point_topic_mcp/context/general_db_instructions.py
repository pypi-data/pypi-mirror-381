...
12. If querying about a specific operator or entity, be sure to use the exact name. Sometimes you hae to get the distinct value list for this.
13. Always write lowercase SQL, because uppercase SQL is for people who like to shout at their databases
