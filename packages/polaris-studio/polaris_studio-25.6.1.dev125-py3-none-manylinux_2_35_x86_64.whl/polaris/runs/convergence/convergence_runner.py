...
def run_async(async_end_of_loop_fn, config, current_iteration, output_dir):
    t = Thread(target=async_end_of_loop_fn, args=(config, current_iteration, output_dir))
    t.start()
