...
class Repository(BaseModel):
    ...
    url: Annotated[HttpUrl, AfterValidator(_normalize_http_url)]
...
class Configuration(BaseModel):
    ...
    repositories: dict[PurlType, list[Repository]] = Field(default_factory=_default_repositories)
    ...
    @classmethod
    def _validate_repositories(cls, value: dict[PurlType, list[Repository]]) -> dict[PurlType, list[Repository]]:
