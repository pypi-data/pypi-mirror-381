"""
BioQL Training - DEPLOY VERSION
================================
This runs as a deployed function, no local connection needed
"""
...
app = modal.App(name="bioql-training-deployed", image=image)
...
@app.function(
    ...
    volumes={"/data": volume},
    retries=3,
    schedule=modal.Period(days=7)  # Auto-redeploy weekly if needed
)
def train():
...
print(f"Results: {{result.counts}}")'''
    ...
    # Training arguments - MORE FREQUENT CHECKPOINTS
    print("[5/5] Training (frequent checkpoints every 100 steps)...\n")
