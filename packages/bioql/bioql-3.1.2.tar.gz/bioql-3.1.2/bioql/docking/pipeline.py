...
def dock(
    ...
    elif backend == "quantum" or backend.startswith("ibm_") or backend.startswith("ionq_") or backend == "ibm_quantum":
...
def _dock_quantum(
    ...
    try:
        ...
        runner = QuantumRunner(api_key=api_key, backend=backend)
