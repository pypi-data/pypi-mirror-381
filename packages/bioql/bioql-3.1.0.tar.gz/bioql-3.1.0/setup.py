...
setup(
    ...
    author_email='bioql@example.com',
    description='Quantum Computing for Bioinformatics - NOW WITH 164 BILLION NATURAL LANGUAGE PATTERNS!',
    long_description=read_long_description(),
    long_description_content_type='text/markdown',
    url='https://github.com/yourusername/bioql',
    project_urls={
        'Bug Reports': 'https://github.com/yourusername/bioql/issues',
        'Source': 'https://github.com/yourusername/bioql',
