...
def open_sheet_by_path(path: str, title: str):
    ...
    df_goods = load_goods(sh)
    df_exp_2023 = load_expectation_2023(sh)
    df_exp_2024 = load_expectation_2024(sh)
    df_exp_2025 = load_expectation_2025(sh)

    _delete_sheet1_if_empty(sh)

    return sh, df_goods, df_exp_2023, df_exp_2024, df_exp_2025
...
def load_goods(sh) -> pd.DataFrame:
...
def load_expectation_2023(sh) -> pd.DataFrame:
...
def load_expectation_2024(sh) -> pd.DataFrame:
    HEADERS = ["품명", "1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"]
    df = pd.DataFrame(
        [
...
def load_expectation_2025(sh) -> pd.DataFrame:
    HEADERS = ["품명", "1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"]
    df = pd.DataFrame(
        [
