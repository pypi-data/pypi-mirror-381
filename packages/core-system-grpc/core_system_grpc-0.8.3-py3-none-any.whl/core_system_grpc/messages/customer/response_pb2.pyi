...
class GetCustomersByShopResponse(_message.Message):
    ...
    result: _containers.RepeatedCompositeFieldContainer[_common_pb2.Customer]
    length: str
    def __init__(self, result: _Optional[_Iterable[_Union[_common_pb2.Customer, _Mapping]]] = ..., length: _Optional[str] = ...) -> None: ...
