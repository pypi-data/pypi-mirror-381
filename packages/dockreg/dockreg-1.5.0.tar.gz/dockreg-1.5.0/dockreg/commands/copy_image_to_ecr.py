...
from dockreg.docker import DockerObjectRef, DockerRegistryRef, list_images
from dockreg.exceptions import DockregError
from dockreg.lib.aws import aws_account_id, ecr_create_repo, ecr_docker_login
    ...
    def execute(args: Namespace) -> int:
        ...
        for src_img in source_images:
            ...
            if result.returncode != 0:
                raise DockregError(f'Image copy failed with status {result.returncode}')
        return 0
