...
class IDEType(Enum):
    ...
    CURSOR = "cursor"
    GEMINI = "gemini"
    # KIRO = "kiro"  # Temporarily disabled - Kiro doesn't support remote OAuth servers yet
    ROO = "roo"
    VSCODE = "vscode"
    WINDSURF = "windsurf"
    UNKNOWN = "unknown"
...
# Temporarily disabled - Kiro doesn't support remote OAuth servers yet
...
class IDEContextDetector:
    ...
    def __init__(self) -> None:
        ...
        self.strategies: list[IDEContextStrategy] = [
            ...
            # KiroContextStrategy(),  # Temporarily disabled - Kiro doesn't support remote OAuth servers yet
            RooContextStrategy(),
