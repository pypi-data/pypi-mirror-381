...
class DatabaseInstance:
    ...
    def __init__(self, config: DatabaseConfig) -> None:
        ...
        self.connect_args = config.get("connect_args", None)
    ...
    def _build_database_url(
        ...
        scheme = f"{self.db_backend}+{self.db_driver_async}" if async_mode else self.db_backend
    ...
    def _initialize_db_settings(self) -> dict:
        ...
        if self.db_ssl and self.db_backend == "mysql":
            settings["connect_args"] = {**settings.get("connect_args", {}), "ssl": True}
