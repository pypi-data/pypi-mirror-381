...
class CCurrentScenarioDict:
    ...
    var_map = {
        "GUID": "guid",
        "strTitle": "title",
        "strScenFileName": "scene_file_name",
        "strDescription": "description",
        "m_Time": "time",
        "bDaylightSavingTime": "daylight_saving_time",
        "m_FirstTimeRunDateTime": "first_time_run_datetime",
        "strDaylightSavingTime_Start": "daylight_saving_time_start",
        "strDaylightSavingTime_End": "daylight_saving_time_end",
        "m_StartTime": "star_time",
        "m_Duration": "duration",
        "sMeta_Complexity": "meat_complexity",
        "sMeta_Difficulty": "meta_difficulty",
...
class CDoctrineDict:
    ...
    var_map = {
        "strGuid": "guid",
        "m_DoctrineOwner": "doctrine_owner",
        "m_Nukes": "nukes",
        "m_WCS_Air": "wcs_air",
        "m_WCS_Surface": "wcs_surface",
        "m_WCS_Submarine": "wcs_submarine",
        "m_WCS_Land": "wcs_land",
        "m_IgnorePlottedCourseWhenAttacking": "ignore_plotted_course_when_attacking",
        "m_BehaviorTowardsAmbigousTarget": "behavior_towards_ambigous_target",
        "m_ShootTourists": "shoot_tourists",
        "m_IgnoreEMCONUnderAttack": "ignore_emcon_under_attack",
        "m_UseTorpedoesKinematicRange": "use_torpedoes_kinematic_range",
        "m_AutomaticEvasion": "automatic_evasion",
        "m_UseRefuel": "use_refuel",
        "m_RefuelSelection": "refuel_selection",
        "m_RefuelAllies": "refuel_allies",
        "m_AirOpsTempo": "air_ops_tempo",
        "m_QuickTurnAround": "quick_turnaround",
        "m_BingoJoker": "bingo_joker",
        "m_BingoJokerRTB": "bingo_joker_rtb",
        "m_WeaponState": "weapon_state",
        "m_WeaponStateRTB": "weapon_state_rtb",
        "m_GunStrafeGroundTargets": "gun_strafe_ground_targets",
        "m_JettisonOrdnance": "jettison_ordnance",
        "m_SAM_ASUW": "sam_asuw",
        "m_MaintainStandoff": "maintain_standoff",
        "m_AvoidContact": "avoid_contact",
        "m_DiveWhenThreatsDetected": "dive_when_threats_detected",
        "m_RechargePercentagePatrol": "recharge_percentage_patrol",
        "m_RechargePercentageAttack": "recharge_percentage_attack",
        "m_AIPUsage": "aip_usage",
        "m_DippingSonar": "dipping_sonar",
        "m_WithdrawDamageThreshold": "withdraw_damage_threshold",
        "m_WithdrawFuelThreshold": "withdraw_fuel_threshold",
        "m_WithdrawAttackThreshold": "withdraw_attack_threshold",
        "m_WithdrawDefenceThreshold": "withdraw_defence_threshold",
        "m_RedeployDamageThreshold": "redeploy_damage_threshold",
        "m_RedeployFuelThreshold": "redeploy_fuel_threshold",
        "m_RedeployAttackDamageThreshold": "redeploy_attack_threshold",
        "m_RedeployDefenceDamageThreshold": "redeploy_defence_threshold",
        "m_bEMCON_AccordingSuperior": "emcon_according_superior",
        "m_EMCON_SettingsForRadar": "emcon_radar_mode",
        "m_EMCON_SettingsForSonar": "emcon_sonar_mode",
        "m_EMCON_SettingsForOECM": "emcon_oecm_mode",
        "m_WRA_WeaponRule_WeaponDBID": "weapon_rule_db_id",
        "m_WRA_WeaponRule": "weapon_rule",
        "bchkUseNuclerWeapon": "use_nuclear",
        "bchkWeaponStateAir": "weapon_control_air_edit",
        "bchkWeaponStateSea": "weapon_control_surface_edit",
        "bchkWeaponStateSeaLatent": "weapon_control_subsurface_edit",
        "bchkWeaponStateland": "weapon_control_land_edit",
        "bchkIgnoreRoutes": "ignore_routes_edit",
        "bchkFuzzlocationOfTheReceIvingstation": "engage_fuzzy_targets_edit",
        "bchkImminentTarget": "engage_opportunity_targets_edit",
        "bchkIgnoreElectromagneticControl": "ignore_emcon_edit",
        "bchkTopedopower": "torpedo_kinematic_range_edit",
        "bchkAutoAcoid": "auto_evade_edit",
        "bchkComeOn": "refuel_edit",
        "bchkSelectUnitComeOn": "refuel_selected_edit",
        "bchkAlliedUnitComeOn": "refuel_allies_edit",
        "bchkAirOpsTempo_Player": "air_ops_tempo_edit",
        "bchkQTA_Player": "quick_turnaround_edit",
        "bchkBingoJoker_Player": "fuel_state_planned_edit",
        "bchkBingoJokerRTB_Player": "fuel_state_rtb_edit",
        "bchkWeaponStateFirast": "weapon_state_planned_edit",
        "bchkWeaponStateReturn": "weapon_state_rtb_edit",
        "bchkAirToGroundUserEdit": "gun_strafe_edit",
        "bchkAbandonedAmmunition": "jettison_ordnance_edit",
        "bchkSAM_ASUW_Player": "sam_asuw_edit",
        "bchkKeepTargetDistance": "maintain_standoff_edit",
        "bchkToAvoidTheSearch": "avoid_contact_edit",
        "bchkThreatWasDetectedAndDived": "dive_on_threat_edit",
        "bchkSetSail": "recharge_patrol_edit",
    ...
    class Labels:
        nukes = {0: "不授权，禁止使用", 1: "授权，可以使用", 2: "多样", 3: "未配置"}

        wcs_air = {0: "自由开火", 1: "谨慎开火", 2: "限制开火", 3: "多样", 4: "未配置"}
        wcs_surface = {0: "自由开火", 1: "谨慎开火", 2: "限制开火", 3: "多样", 4: "未配置"}
        wcs_submarine = {0: "自由开火", 1: "谨慎开火", 2: "限制开火", 3: "多样", 4: "未配置"}
        wcs_land = {0: "自由开火", 1: "谨慎开火", 2: "限制开火", 3: "多样", 4: "未配置"}
        ignore_plotted_course_when_attacking = {0: "不忽略", 1: "忽略", 2: "多样", 3: "未配置"}
        behavior_towards_ambigous_target = {0: "忽略模糊性", 1: "乐观决策", 2: "悲观决策", 3: "多样", 4: "未配置"}
        shoot_tourists = {0: "否,只与任务相关的目标进行交战", 1: "是,可对临机目标进行射击", 2: "多样", 3: "未配置"}
        ignore_emcon_under_attack = {0: "不忽略,考虑电磁管控", 1: "忽略,不考虑电磁管控", 2: "多样", 3: "未配置"}
        use_torpedoes_kinematic_range = {
            0: "自动与手动发射都使用动力航程",
            1: "只有手动发射时使用动力航程",
            2: "使用实际航程",
            3: "多样",
        ...
        automatic_evasion = {0: "否", 1: "是", 2: "多样", 3: "未配置"}
        use_refuel = {0: "允许,不允许加油机对加油机加油", 1: "不允许", 2: "允许", 3: "多样", 4: "未配置"}
        refuel_selection = {
            0: "选择最近的加油机",
            1: "选择位于我们和目标之间的加油机",
        ...
        refuel_allies = {0: "补给", 1: "只接收", 2: "只传送", 3: "不补给", 4: "多样", 5: "未配置"}
        air_ops_tempo = {0: "大批出动", 1: "可持续性出动", 2: "多样", 3: "未配置"}
        quick_turnaround = {
            0: "可以快速出动",
        ...
        gun_strafe_ground_targets = {0: "否", 1: "是", 2: "多样", 3: "未配置"}
        jettison_ordnance = {0: "不抛弃", 1: "抛弃", 2: "多样", 3: "未配置"}
        sam_asuw = {0: "不能使用反舰模式", 1: "可以使用反舰模式", 2: "多样", 3: "未配置"}
        maintain_standoff = {0: "否", 1: "是", 2: "多样", 3: "未配置"}
        avoid_contact = {0: "不规避", 1: "除自防御外尽可能规避", 2: "总是规避", 3: "多样", 4: "未配置"}
        dive_when_threats_detected = {
            0: "当电子侦察措施探测和目标接近时下潜",
        ...
        aip_usage = {0: "不使用", 1: "只在进攻时", 2: "总是", 3: "多样", 4: "未配置"}
        dipping_sonar = {0: "盘旋于150英尺高时自动部署", 1: "人工或任务部署", 2: "多样", 3: "未配置"}
        withdraw_damage_threshold = {
            0: "忽略",
            1: "毁伤程度大于5%",
            2: "毁伤程度大于25%",
            3: "毁伤程度大于50%",
        ...
        emcon_radar_mode = {0: "静默", 1: "激活", 2: "多样", 3: "未配置"}
        emcon_sonar_mode = {0: "静默", 1: "激活", 2: "多样", 3: "未配置"}
        emcon_oecm_mode = {0: "静默", 1: "激活", 2: "多样", 3: "未配置"}
...
class CSideDict:
    ...
    var_map = {
        "strName": "name",
        "strGuid": "guid",
        "m_PosturesDictionary": "postures_dictionary",
        "fCamerAltitude": "camera_altitude",
        "fCenterLatitude": "center_latitude",
        "fCenterLongitude": "center_longitude",
        "bAIOnly": "ai_only",
        "bCATC": "catc",
        "bCollectiveResponsibility": "collective_responsibility",
        "iSideStopCount": "side_stop_count",
        "iTotalScore": "total_score",
        "m_AwarenessLevel": "awareness_level",
        "m_ContactList": "contact_list",
        "m_Doctrine": "doctrine",
        "m_Expenditures": "expenditures",
        "m_Losses": "losses",
        "m_ProficiencyLevel": "proficiency_level",
        "m_ScoringLogs": "scoring_logs",
        "m_WarDamageOtherTotal": "war_damage_other_total",
        "strBriefing": "briefing",
        "strCloseResult": "close_result",
        "strFriendlyColorKey": "friendly_color_key",
        "strHostileColoryKey": "hostile_color_key",
    ...
    class Labels:
        awareness_level = {-1: "一无所知", 0: "普通水平", 1: "知其属方", 2: "知其属方及单元", 3: "无所不知无"}
        proficiency_level = {0: "新手", 1: "实习", 2: "普通", 3: "老手", 4: "顶级"}


class CActiveUnitDict:
    class Info(Enum):
        strName = "string 名称"
        strGuid = "string GUID"
    ...
    var_map = {
        "strName": "name",
        "strGuid": "guid",
        "fAltitude_AGL": "altitude_agl",
        "iAltitude_ASL": "altitude_asl",
        "m_Side": "side",
        "strUnitClass": "unit_class",
        "dLatitude": "latitude",
        "dLongitude": "longitude",
        "fCurrentHeading": "current_heading",
        "fCurrentSpeed": "current_speed",
        "fCurrentAltitude_ASL": "current_altitude_asl",
        "fPitch": "pitch",
        "fRoll": "roll",
        "fDesiredSpeed": "desired_speed",
        "m_MaxThrottle": "max_throttle",
        "fMaxSpeed": "max_speed",
        "fMinSpeed": "min_speed",
        "fCurrentAlt": "current_alt",
        "fDesiredAlt": "desired_alt",
        ...
        "m_DockFacilitiesComponent": "dock_facilities_component",
        "m_DockAircrafts": "dock_aircrafts",
        "m_AirFacilitiesComponent": "air_facilities_component",
        "m_CommDevices": "comm_devices",
        "m_Engines": "engines",
        "m_Sensors": "sensors",
        "m_Mounts": "mounts",
        "strDamageState": "damage_state",
        "iFireIntensityLevel": "fire_intensity_level",
        "iFloodingIntensityLevel": "flooding_intensity_level",
        ...
        "m_CurrentThrottle": "current_throttle",
        "bIsCommsOnLine": "is_comms_online",
        "bIsIsolatedPOVObject": "is_isolated_pov_object",
        "bTerrainFollowing": "terrain_following",
        "bIsRegroupNeeded": "is_regroup_needed",
        "bHoldPosition": "hold_position",
        "bAutoDetectable": "auto_detectable",
        "m_Cargo": "cargo",
        "dFuelPercentage": "fuel_percentage",
        "m_CommLink": "comm_link",
        "m_NoneMCMSensors": "none_mcm_sensors",
        "iDisturbState": "disturb_state",
        "iMultipleMissionCount": "multiple_mission_count",
    ...
    class Labels:
        max_throttle = {0: "完全停止", 1: "原地徘徊", 2: "巡航", 3: "全速", 4: "军用", 5: "滑行"}
        fire_intensity_level = {0: "无火", 1: "小火", 2: "中火", 3: "猛火", 4: "大火"}
        flooding_intensity_level = {0: "未进水", 1: "少量", 2: "中等", 3: "严重", 4: "翻覆"}
        proficiency_level = {0: "新手", 1: "实习", 2: "普通", 3: "老手", 4: "顶级"}
        current_throttle = {0: "完全停止", 1: "原地徘徊", 2: "巡航", 3: "全速", 4: "军用", 5: "滑行"}
        disturb_state = {0: "显示干扰", 1: "显示不干扰示"}
...
class CGroupDict:
    ...
    var_map = {
        **CActiveUnitDict.var_map,
        "fHoverSpeed": "hover_speed",
        "fLowSpeed": "low_speed",
        "fCruiseSpeed": "cruise_speed",
        "fMilitarySpeed": "military_speed",
        "fAddForceSpeed": "add_force_speed",
        "m_GroupType": "group_type",
        "m_GroupCenter": "group_center",
        "m_GroupLead": "group_lead",
...
class CSubmarineDict:
    ...
    var_map = {
        **CActiveUnitDict.var_map,
        "dPercentageDiesel": "percentage_diesel",
        "dPercentageBattery": "percentage_battery",
        "m_Category": "category",
        "m_CIC": "cic",
        "m_Rudder": "rudder",
        "m_PressureHull": "pressure_hull",
        "strFuelState": "fuel_state",
        "m_Type": "type",
        "strCavitation": "cavitation",
        "fHoverSpeed": "hover_speed",
        "fLowSpeed": "low_speed",
        "fCruiseSpeed": "cruise_speed",
        "fMilitarySpeed": "military_speed",
        "fAddForceSpeed": "add_force_speed",
        "iThermoclineUpDepth": "thermocline_up_depth",
        "iThermoclineDownDepth": "thermocline_down_depth",
        "strDamageInfo": "damage_info",
        "strWeaponInfo": "weapon_info",
        "strMagazinesInfo": "magazines_info",
        "strFuelInfo": "fuel_info",
        "strStatusInfo": "status_info",
        "strTimeToReadyInfo": "time_to_ready_info",
        "strWayPointName": "way_point_name",
    }

    class Labels(CActiveUnitDict.Labels):
        bearing_type = {0: "固定的,不随领队朝向变化而变化", 1: "旋转的,随领队朝向改变旋转改"}
        category = {1001: "其他", 2001: "潜艇", 2002: "生物", 2003: "假目标"}
        type = {
            1001: "其他",
            2001: "辅助/实验潜艇",
            2002: "辅助货运潜艇",
...
class CAircraftDict:
    ...
    var_map = {
        **CActiveUnitDict.var_map,
        ...
        "m_Category": "category",
        "m_Type": "type",
        "m_CurrentHostUnit": "current_host_unit",
        "iLoadoutDBID": "loadout_db_id",
        "m_LoadoutGuid": "loadout_guid",
        "strAirOpsConditionString": "air_ops_condition_str",
        "strFinishPrepareTime": "finish_prepare_time",
        "strQuickTurnAroundInfo": "quick_turn_around_info",
        "fHoverSpeed": "hover_speed",
        "fLowSpeed": "low_speed",
        "fCruiseSpeed": "cruise_speed",
        "fMilitarySpeed": "military_speed",
        "fAddForceSpeed": "add_force_speed",
        "strFuelState": "fuel_state",
        "fDesiredAltitude": "desired_altitude",
        "m_MaintenanceLevel": "maintenance_level",
        "fFuelConsumptionCruise": "fuel_consumption_cruise",
        "fAbnTime": "abn_time",
        "iFuelRecsMaxQuantity": "fuel_recs_max_quantity",
        "iCurrentFuelQuantity": "current_fuel_quantity",
        "bQuickTurnaround_Enabled": "quick_turnaround_enabled",
        "bIsAirRefuelingCapable": "air_refueling_capable",
        "strShowTankerHeader": "show_tanker_header",
        "m_ShowTanker": "show_tanker",
        "m_bProbeRefuelling": "probe_refuelling",
...
class CSatelliteDict:
    ...
    var_map = {
        **CActiveUnitDict.var_map,
        "m_SatelliteCategory": "satellite_category",
        "m_TracksPoints": "tracks_points",
    }

    class Labels(CActiveUnitDict.Labels):
        satellite_category = {1001: "未知", 2001: "地球同步卫星"}
...
class CSensorDict:
    ...
    var_map = {
        ...
        "m_CoverageArc": "coverage_arc",
        "bActive": "active",
        "strDescription": "description",
        "strWorkStatus": "work_status",
        "m_SensorType": "sensor_type",
        "m_SensorRole": "sensor_role",
        "fMaxRange": "max_range",
        "fMinRange": "min_range",
    ...
    class Labels:
        component_status = {0: "正常工作", 1: "受到毁伤", 2: "已被摧毁"}
        damage_severity = {0: "轻", 1: "中", 2: "重"}
        sensor_type = {
            1001: "未知",
            2001: "雷达",
            2002: "半主动",
...
class CLoadoutDict:
    ...
    var_map = {
        ...
        "strGuid": "guid",
        "idbid": "db_id",
        "strLoadWeaponCount": "load_weapon_count",
        "m_LoadRatio": "load_ratio",
        "m_AircraftGuid": "aircraft_guid",
...
class CMountDict:
    ...
    var_map = {
        ...
        "m_DamageSeverity": "damage_severity",
        "m_CoverageArc": "coverage_arc",
        "strWeaponFireState": "weapon_fire_state",
        "strLoadWeaponCount": "load_weapon_count",
        "m_LoadRatio": "load_ratio",
        "m_Sensors": "sensor_guids",
        "m_ReloadPrioritySet": "reload_priority_set",
    }
...
class CWeaponDict:
    ...
    var_map = {
        **CActiveUnitDict.var_map,
        "m_strDataLinkParentGuid": "data_link_parent_guid",
        "m_PrimaryTargetGuid": "primary_target_guid",
        "fRangeASWMin": "range_asw_min",
        "fRangeASWMax": "rage_asw_max",
        "fRangeLandMin": "range_land_min",
        "fRangeLandMax": "range_land_max",
        "fRangeASUWMin": "range_asuw_min",
        "fRangeASUWMax": "range_asuw_max",
        "fRangeAAWMin": "range_aaw_min",
        "fRangeAAWMax": "range_aaw_max",
        "m_WeaponType": "weapon_type",
        "m_WeaponTargetType": "weapon_target_type",
        "bIsOfAirLaunchedGuidedWeapon": "is_of_air_launched_guided_weapon",
        "bSonobuoyActive": "sonobuoy_active",
        "m_FiringUnitGuid": "firing_unit_guid",
        "m_ParentMount": "parent_mount",
        "m_ParentMagazine": "parent_magazine",
        "m_SonobuoyDepthSetting": "sonobuoy_depth_setting",
        "strSonobuoyRemainingTime": "sonobuoy_remaining_time",
    }
...
class CSideWayDict:
    ...
    var_map = {
        ...
        "m_Side": "side",
        "m_bShow": "show",
        "m_eSideWayType": "side_way_type",
        "m_WayPoints": "way_points",
    }

    class Labels:
        side_way_type = {0: "作战单元预设航线", 1: "武器预设航行"}
...
class CWayPointDict:
    ...
    var_map = {
        ...
        "dLatitude": "latitude",
        "fAltitude": "altitude",
        "m_ActiveUnit": "active_unit",
        "m_WaypointType": "waypoint_type",
        "m_ThrottlePreset": "throttle_preset",
        "m_AltitudePreset": "altitude_preset",
        "m_DepthPreset": "depth_preset",
        "bTerrainFollowing": "terrain_following",
        "fDesiredSpeed": "desired_speed",
        "fDesiredAltitude": "desired_altitude",
        "m_Doctrine": "doctrine",
    ...
    class Labels:
        ...
        throttle_preset = {0: "停车", 1: "低速", 2: "巡航", 3: "全速", 4: "最大", 5: "无", 6: "滑行"}
        altitude_preset = {
            0: "无",
            1: "最小高度：0米",
            2: "1000英尺",
        ...
        radar_state = {0: "未开机", 1: "开机", 2: "不确定"}
        sonar_state = {0: "未开机", 1: "开机", 2: "不确定"}
        ecm_state = {0: "未开机", 1: "开机", 2: "不确定"}
...
class CContactDict:
    ...
    var_map = {
        ...
        "bSideIsKnown": "side_is_known",
        "m_IdentificationStatus": "identification_status",
        "m_ActualUnit": "actual_unit",
        "m_OriginalDetectorSide": "original_detector_side",
        "m_SidePostureStanceDictionary": "side_posture_stance_dictionary",
        "bSpeedKnown": "speed_known",
        "bHeadingKnown": "heading_known",
        "bAltitudeKnown": "altitude_known",
        "strElectromagnetismEradiateTitle": "electromagnetism_eradiate_title",
        "strElectromagnetismEradiate": "electromagnetism_eradiate",
        "strMatchingTitle": "matching_title",
        "m_MatchingDBIDList": "matching_db_id_list",
        "strRadiantPoint": "radiant_point",
        "m_DetectionRecord": "detection_record",
        "m_UncertaintyArea": "uncertainty_area",
        "strAge": "age",
        "fMaxDetectRange": "max_detect_range",
        "fMaxRange_DetectSurfaceAndFacility": "max_range_detect_surface_and_facility",
        "fMaxRange_DetectSubsurface": "max_range_detect_subsurface",
        "fTimeSinceDetection_Visual": "time_since_detection_visual",
        "iWeaponsAimingAtMe": "weapons_aiming_at_me",
        "fAirRangeMax": "air_range_max",
        "fSurfaceRangeMax": "surface_range_max",
        "fLandRangeMax": "land_range_max",
...
class CLoggedMessageDict:
    ...
    var_map = {
        ...
        "Longitude": "longitude",
        "Latitude": "latitude",
        "ReporterID": "reporter_guid",
        "ContactActiveUnitGUID": "contact_active_unit_guid",
    }
...
class CSimEventDict:
    ...
    var_map = {
        ...
        "strGuid": "guid",
        "strDescription": "description",
        "bIsRepeatable": "repeatable",
        "bIsActive": "active",
        "bIsMessageShown": "message_shown",
...
class CTriggerUnitDetectedDict:
    ...
    var_map = {
        ...
        "strGuid": "guid",
        "strDescription": "description",
        "m_EventTriggerType": "event_trigger_type",
        "strTargetSide": "target_side",
    ...
    class Labels:
        target_type = {0: "未知", 1: "飞机", 2: "船只", 3: "潜艇", 4: "设施", 5: "瞄准点", 6: "武器"}
        identification_status = {
            0: "未知",
            1: "已知空域（如空中、地面）",
            2: "已知类型（如飞机、导弹）",
...
class CTriggerUnitDamagedDict:
    ...
    class Labels:
        ...
        target_type = {0: "未知", 1: "飞机", 2: "船只", 3: "潜艇", 4: "设施", 5: "瞄准点", 6: "武器", 7: "卫星"}
        target_subtype = {
            1: {
                1001: "其他",
                2001: "战斗机",
...
class CTriggerPointsDict:
    ...
    var_map = {
        ...
        "strDescription": "description",
        "m_EventTriggerType": "event_trigger_type",
        "m_strSideID": "side_guid",
        "m_reachDirection": "reach_direction",
...
class CTriggerTimeDict:
    ...
    var_map = {
        ...
        "strDescription": "description",
        "m_EventTriggerType": "event_trigger_type",
        "strCurrentSetting": "current_setting",
        "m_Time": "time",
    }
...
class CTriggerUnitRemainsInAreaDict:
    ...
    var_map = {
        ...
        "m_ETOA": "e_to_a",
        "m_LTOA": "l_to_a",
        "m_ReferencePoint": "reference_point",
    }
...
class CConditionScenHasStartedDict:
    ...
    var_map = {
        ...
        "strGuid": "guid",
        "strDescription": "description",
        "m_EventConditionType": "event_condition_type",
        "bModifier": "modifier",
    }

    class Labels:
        event_condition_type = {0: "推演方立场", 1: "想定开始执行", 2: "LUA脚本"}
...
class CConditionSidePostureDict:
    ...
    var_map = {
        ...
        "m_EventConditionType": "event_condition_type",
        "bModifier": "modifier",
        "strObserverSideID": "observer_side_guid",
        "strTargetSideID": "target_side_guid",
        "m_TargetPosture": "target_posture",
    }

    class Labels:
        event_condition_type = {0: "推演方立场", 1: "想定开始执行", 2: "LUA脚本"}
        target_posture = {0: "中立", 1: "友方", 2: "不友好", 3: "敌对", 4: "未知"}
...
class CActionMessageDict:
    ...
    var_map = {
        ...
        "strGuid": "guid",
        "strDescription": "description",
        "m_EventActionType": "event_action_type",
        "m_strSideID": "side_guid",
        "strMessageText": "message_text",
    }

    class Labels(CActionDict.Labels):
        pass
...
class CActionChangeMissionStatusDict:
    ...
    var_map = {
        ...
        "m_EventActionType": "event_action_type",
        "m_strSideID": "side_guid",
        "strMissionID": "mission_id",
        "m_newmissionStatus": "new_mission_status",
    }
...
class CMissionDict:
    class Info(Enum):
        ...
        strGuid = "string GUID"
        m_Side = "string 方GUID"
        side_name = "string 推演方名称"
        m_Category = "int 任务类别 (枚举量)"
        m_MissionClass = "int 任务类型 (枚举量)"
        m_MissionStatus = "int 任务状态 (枚举量)"
        m_FlightSize = "int 飞机设置-编队规模"
        bTankerFollowsReceivers = "bool 加油机遵循受油机的飞行计划"
        strDescription = "string 任务描述"
        bLaunchMissionWithoutTankersInPlace = "bool 加油机没到位的情况下启动任务"
        bUseGroupSizeHardLimit = "bool 水面舰艇/潜艇数低于编队规模要求不能出击"
        m_AssignedUnits = "string 已分配单元的集合"
        strMaxReceiversInQueuePerTanker_Airborne = "string 每架加油机允许加油队列最大长度"
        m_GroupSize = "int 水面舰艇/潜艇设置-编队规模"
        m_TankerUsage = "int 空中加油机使用方式 (枚举量)"
        m_Doctrine = "string 条令GUID"
        strTankerMinNumber_Station = "string 阵位上加油机最小数量"
        m_UnassignedUnits = "string 未分配单元的集合"
        m_strSideWayGUID = "string 单元航线GUID"
        strFuelQtyToStartLookingForTanker_Airborne = "string 受油机寻找加油机的时机条件"
        bUseRefuel = "bool 空中加油是否与上级保持一致"
        bUseFlightSizeHardLimit = "bool 飞机数低于编队规模要求不能起飞"
        m_UseRefuel = "int 飞机设置-空中加油 (枚举量)"
        bUseActionPlan = "bool 使用行动预案"
        strTankerMinNumber_Airborne = "string 留空的加油机最小数量"
        strTankerMinNumber_Total = "string 需要加油机的最小数量"
    ...
    var_map = {
        ...
        "side_name": "side_name",
        "m_Category": "category",
        "m_MissionClass": "mission_class",
        "m_MissionStatus": "mission_status",
        "m_FlightSize": "filght_size",
        "bTankerFollowsReceivers": "tanker_follows_receivers",
        "strDescription": "description",
        "bLaunchMissionWithoutTankersInPlace": "launch_mission_without_tankers_in_place",
        "bUseGroupSizeHardLimit": "use_group_size_hard_limit",
        "m_AssignedUnits": "assigned_units",
        "strMaxReceiversInQueuePerTanker_Airborne": "max_receivers_in_queue_per_tanker_airborne",
        "m_GroupSize": "group_size",
        "m_TankerUsage": "tanker_usage",
        "m_Doctrine": "doctrine",
        "strTankerMinNumber_Station": "tanker_min_number_station",
        "m_UnassignedUnits": "unassigned_units",
        "m_strSideWayGUID": "side_way_guid",
        "strFuelQtyToStartLookingForTanker_Airborne": "fuel_qty_to_start_looking_for_tanker_airborne",
        "bUseRefuel": "use_refuel",
        "bUseFlightSizeHardLimit": "use_flight_size_hard_limit",
        "m_UseRefuel": "refuel",
        "bUseActionPlan": "use_action_plan",
        "strTankerMinNumber_Airborne": "tanker_min_number_airborne",
        "strTankerMinNumber_Total": "tanker_min_number_total",
        "m_TransitThrottle_Aircraft": "transit_throttle_airecraft",
        "m_StationThrottle_Aircraft": "station_throttle_aircraft",
        "strTransitAltitude_Aircraft": "transit_altitude_aircraft",
        "strStationAltitude_Aircraft": "station_altitude_aircraft",
        "m_TransitThrottle_Submarine": "transit_throttle_submarine",
        "m_StationThrottle_Submarine": "station_throttle_submarine",
        "strTransitDepth_Submarine": "transit_depth_submarine",
        "strStationDepth_Submarine": "station_depth_submarine",
        "m_TransitThrottle_Ship": "transit_throttle_ship",
        "m_StationThrottle_Ship": "station_throttle_ship",
    }

    class Labels:
        category = {0: "任务", 1: "任务包", 2: "任务池"}
        mission_class = {
            0: "未知",
            1: "打击/截击",
            2: "巡逻",
        ...
        mission_status = {0: "激活状态", 1: "未激活", 2: "已完成"}
        use_refuel = {0: "允许,但不允许加油机对加油机加油", 1: "不允许", 2: "允许", 3: "多样", 4: "未配置"}
        tanker_usage = {0: "自动使用", 1: "任务中使用"}
...
class CPatrolMissionDict:
    ...
    class Labels(CMissionDict.Labels):
        ...
        cbo_sonobuoys_type = {0: "温跃层随机", 1: "浅_温跃层之上", 2: "深_温跃层之下"}
...
class CStrikeMissionDict:
    ...
    var_map = {
        **CMissionDict.var_map,
        "m_StrikeType": "strike_type",
        "m_MinimumContactStanceToTrigger": "minimum_contact_stance_to_trigger",
        "m_Bingo": "bingo",
        "m_MinAircraftReq_Strikers": "min_aircraft_req_strikers",
        "iMinResponseRadius": "min_response_radius",
        "iMaxResponseRadius": "max_response_radius",
        "m_RadarBehaviour": "radar_behaviour",
        "bUseAutoPlanner": "use_auto_planner",
        "bOneTimeOnly": "one_time_only",
        "bPrePlannedOnly": "pre_planned_only",
        "m_SpecificTargets": "specific_targets",
        "m_strSideWeaponWayGUID": "side_weapon_way_guid",
        "m_EscortFlightSize": "escort_flight_size",
        "m_MinAircraftReqEscorts": "min_aircraft_req_escorts",
        "m_MaxAircraftToFlyEscort": "max_aircraft_to_fly_escort",
        "iEscortResponseRadius": "escort_response_radius",
        "m_EscortFlightSizeNo": "escort_flight_size_no",
        "m_MinAircraftReqEscortsNo": "min_aircraft_req_escorts_no",
        "m_MaxAircraftToFlyEscortNo": "max_aircraft_to_fly_escort_no",
        "bUseFlightSizeHardLimitEscort": "use_flight_size_hard_limit_escort",
        "m_EscortGroupSize": "escort_group_size",
        "bUseGroupSizeHardLimitEscort": "use_group_size_hard_limit_escort",
    ...
    class Labels(CMissionDict.Labels):
        strike_type = {0: "空中截击", 1: "对陆打击", 2: "对海打击", 3: "对潜突击"}
        radar_behaviour = {
            0: "整个飞行计划全部使用任务电磁管控",
...
class CCargoMissionDict:
    ...
    var_map = {
        **CMissionDict.var_map,
        "m_Motherships": "motherships",
        "m_MountsToUnload": "mounts_to_unload",
    }
...
class CFerryMissionDict:
    ...
    var_map = {
        **CMissionDict.var_map,
        "m_FerryMissionBehavior": "ferry_mission_behavior",
        "m_FlightSize": "flight_size",
    }

    class Labels(CMissionDict.Labels):
        ferry_mission_behavior = {0: "单向", 1: "循环", 2: "随机"}
...
class CReferencePointDict:
    ...
    var_map = {
        ...
        "dLatitude": "latitude",
        "fAltitude": "altitude",
        "m_RelativeToUnit": "relative_to_unit",
        "fRelativeBearing": "relative_bearing",
        "fRelativeDistance": "relative_distance",
        "m_BearingType": "bearing_type",
        "bIsLocked": "locked",
    }

    class Labels:
        bearing_type = {0: "固定的，不随领队朝向变化而变化", 1: "旋转的，随领队朝向改变旋转"}
...
class CNoNavZoneDict:
    ...
    var_map = {
        ...
        "m_Side": "side",
        "strDescription": "description",
        "m_AreaRefPointList": "area_ref_point_list",
        "m_AffectedUnitTypes": "affected_unit_types",
        "bIsActive": "active",
        "bIsLocked": "locked",
    }


class CExclusionZoneDict:
    class Info(Enum):
        strName = "string 名称"
        strGuid = "string GUID"
        m_Side = "string 所属推演方GUID"
    ...
    var_map = {
        ...
        "m_AffectedUnitTypes": "affected_unit_types",
        "bIsActive": "active",
        "m_MarkViolatorAs": "mark_violator_as",
    }

    class Labels:
        mark_violator_as = {0: "中立", 1: "友方", 2: "不友好", 3: "敌对", 4: "未知"}
