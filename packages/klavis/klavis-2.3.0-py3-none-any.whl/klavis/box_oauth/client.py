...
from .raw_client import AsyncRawBoxOauthClient, RawBoxOauthClient


class BoxOauthClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawBoxOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawBoxOauthClient:
        """
...
class AsyncBoxOauthClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawBoxOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawBoxOauthClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawBoxOauthClient
        """
        return self._raw_client
    ...
    async def authorize_box(
        ...
        *,
        ...
        async def main() -> None:
            await client.box_oauth.authorize_box(
                instance_id="instance_id",
            )
