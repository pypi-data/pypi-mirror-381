...
from .raw_client import AsyncRawXeroOauthClient, RawXeroOauthClient


class XeroOauthClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawXeroOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawXeroOauthClient:
        """
...
class AsyncXeroOauthClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawXeroOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawXeroOauthClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawXeroOauthClient
        """
        return self._raw_client
    ...
    async def authorize_xero(
        ...
        *,
        ...
        async def main() -> None:
            await client.xero_oauth.authorize_xero(
                instance_id="instance_id",
            )
