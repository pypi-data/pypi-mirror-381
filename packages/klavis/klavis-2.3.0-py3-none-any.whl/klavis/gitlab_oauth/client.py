...
from .raw_client import AsyncRawGitlabOauthClient, RawGitlabOauthClient


class GitlabOauthClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawGitlabOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawGitlabOauthClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        RawGitlabOauthClient
        """
...
class AsyncGitlabOauthClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawGitlabOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawGitlabOauthClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawGitlabOauthClient
        """
        return self._raw_client
    ...
    async def authorize_gitlab(
        ...
        *,
        ...
        async def main() -> None:
            await client.gitlab_oauth.authorize_gitlab(
                instance_id="instance_id",
            )
