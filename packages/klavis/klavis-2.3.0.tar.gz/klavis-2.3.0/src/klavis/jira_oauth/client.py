...
from .raw_client import AsyncRawJiraOauthClient, RawJiraOauthClient


class JiraOauthClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawJiraOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawJiraOauthClient:
        """
...
class AsyncJiraOauthClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawJiraOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawJiraOauthClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawJiraOauthClient
        """
        return self._raw_client
    ...
    async def authorize_jira(
        ...
        *,
        ...
        async def main() -> None:
            await client.jira_oauth.authorize_jira(
                instance_id="instance_id",
            )
