...
from .raw_client import AsyncRawAsanaOauthClient, RawAsanaOauthClient


class AsanaOauthClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawAsanaOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawAsanaOauthClient:
        """
...
class AsyncAsanaOauthClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawAsanaOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawAsanaOauthClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawAsanaOauthClient
        """
        return self._raw_client
    ...
    async def authorize_asana(
        ...
        *,
        ...
        async def main() -> None:
            await client.asana_oauth.authorize_asana(
                instance_id="instance_id",
            )
