...
class _IProfileAssociationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_route53profiles.IProfileAssociationRef"
    pass
...
class _IProfileRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_route53profiles.IProfileRef"
    pass
...
@jsii.interface(
    jsii_type="aws-cdk-lib.aws_route53profiles.IProfileResourceAssociationRef"
)
...
class _IProfileResourceAssociationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_route53profiles.IProfileResourceAssociationRef"
    pass
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_route53profiles.ProfileAssociationReference",
    jsii_struct_bases=[],
...
class ProfileAssociationReference:
    def __init__(self, *, profile_association_id: builtins.str) -> None:
        ...
        Example::
            ...
            profile_association_reference = route53profiles.ProfileAssociationReference(
                profile_association_id="profileAssociationId"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__24c4339ba98c0f96c08c700629579449ef5714b4d84851de7785559dca32bbeb)
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_route53profiles.ProfileReference",
    jsii_struct_bases=[],
...
class ProfileReference:
    def __init__(self, *, profile_arn: builtins.str, profile_id: builtins.str) -> None:
        ...
        Example::
            ...
            profile_reference = route53profiles.ProfileReference(
                profile_arn="profileArn",
                profile_id="profileId"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2a300c456c92b36d9ae33efc165ff9de466d7a709dcfb5fdf5ab9fcdead24128)
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_route53profiles.ProfileResourceAssociationReference",
    jsii_struct_bases=[],
...
class ProfileResourceAssociationReference:
    def __init__(self, *, profile_resource_association_id: builtins.str) -> None:
        ...
        Example::
            ...
            profile_resource_association_reference = route53profiles.ProfileResourceAssociationReference(
                profile_resource_association_id="profileResourceAssociationId"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__44c54baf153bc59a385c78b803679679442515e2cc7e89453862340e0bfe9d3e)
...
@jsii.implements(_IInspectable_c2943556, IProfileAssociationRef, _ITaggableV2_4e6798f8)
...
@jsii.implements(_IInspectable_c2943556, IProfileResourceAssociationRef)
...
def _typecheckingstub__24c4339ba98c0f96c08c700629579449ef5714b4d84851de7785559dca32bbeb(
    *,
...
def _typecheckingstub__2a300c456c92b36d9ae33efc165ff9de466d7a709dcfb5fdf5ab9fcdead24128(
    *,
...
def _typecheckingstub__44c54baf153bc59a385c78b803679679442515e2cc7e89453862340e0bfe9d3e(
    *,
