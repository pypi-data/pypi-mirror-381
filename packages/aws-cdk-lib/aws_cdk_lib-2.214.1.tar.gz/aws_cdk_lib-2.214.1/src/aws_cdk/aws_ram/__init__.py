...
@jsii.interface(jsii_type="aws-cdk-lib.aws_ram.IPermissionRef")
...
class _IPermissionRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_ram.IPermissionRef"
    pass
...
@jsii.interface(jsii_type="aws-cdk-lib.aws_ram.IResourceShareRef")
class IResourceShareRef(_constructs_77d1e7e8.IConstruct, typing_extensions.Protocol):
...
class _IResourceShareRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_ram.IResourceShareRef"
    pass
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_ram.PermissionReference",
    jsii_struct_bases=[],
...
class PermissionReference:
    def __init__(self, *, permission_arn: builtins.str) -> None:
        ...
        Example::
            ...
            permission_reference = ram.PermissionReference(
                permission_arn="permissionArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__f5fe362e9364acdd71f3404623a406e386d30be9e71e779c74e74d22efef3058)
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_ram.ResourceShareReference",
    jsii_struct_bases=[],
...
class ResourceShareReference:
    def __init__(self, *, resource_share_arn: builtins.str) -> None:
        ...
        Example::
            ...
            resource_share_reference = ram.ResourceShareReference(
                resource_share_arn="resourceShareArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__e3f5afe047761ea681366c3219f74995706e7222b10945d52d0503552e65f401)
...
@jsii.implements(_IInspectable_c2943556, IPermissionRef, _ITaggable_36806126)
class CfnPermission(
...
@jsii.implements(_IInspectable_c2943556, IResourceShareRef, _ITaggable_36806126)
...
def _typecheckingstub__f5fe362e9364acdd71f3404623a406e386d30be9e71e779c74e74d22efef3058(
    *,
...
def _typecheckingstub__e3f5afe047761ea681366c3219f74995706e7222b10945d52d0503552e65f401(
    *,
