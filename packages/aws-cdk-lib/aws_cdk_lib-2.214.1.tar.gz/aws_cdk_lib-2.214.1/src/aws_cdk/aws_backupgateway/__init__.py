...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_backupgateway.HypervisorReference",
    jsii_struct_bases=[],
    name_mapping={"hypervisor_arn": "hypervisorArn"},
)
class HypervisorReference:
    def __init__(self, *, hypervisor_arn: builtins.str) -> None:
        '''A reference to a Hypervisor resource.

        :param hypervisor_arn: The HypervisorArn of the Hypervisor resource.
        ...
        Example::
            ...
            hypervisor_reference = backupgateway.HypervisorReference(
                hypervisor_arn="hypervisorArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__783eea993f624cede3b099c2ea106f011de5377a1ca0675546b11638d130fc11)
            check_type(argname="argument hypervisor_arn", value=hypervisor_arn, expected_type=type_hints["hypervisor_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "hypervisor_arn": hypervisor_arn,
        }

    @builtins.property
    def hypervisor_arn(self) -> builtins.str:
        '''The HypervisorArn of the Hypervisor resource.'''
        result = self._values.get("hypervisor_arn")
        assert result is not None, "Required property 'hypervisor_arn' is missing"
    ...
    def __repr__(self) -> str:
        return "HypervisorReference(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class _IHypervisorRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_backupgateway.IHypervisorRef"
    pass
...
@jsii.implements(_IInspectable_c2943556, IHypervisorRef, _ITaggable_36806126)
class CfnHypervisor(
...
def _typecheckingstub__783eea993f624cede3b099c2ea106f011de5377a1ca0675546b11638d130fc11(
    *,
    hypervisor_arn: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
