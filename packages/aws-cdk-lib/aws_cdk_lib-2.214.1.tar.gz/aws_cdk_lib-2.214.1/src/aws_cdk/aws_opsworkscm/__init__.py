...
class _IServerRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_opsworkscm.IServerRef"
    pass
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_opsworkscm.ServerReference",
    jsii_struct_bases=[],
...
class ServerReference:
    def __init__(self, *, server_arn: builtins.str) -> None:
        ...
        Example::
            ...
            server_reference = opsworkscm.ServerReference(
                server_arn="serverArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__efb0bb7be8727c5c26e64e2bd48c669d8cc0c3f61daf5483d3f50d5d580d1993)
...
def _typecheckingstub__efb0bb7be8727c5c26e64e2bd48c669d8cc0c3f61daf5483d3f50d5d580d1993(
    *,
