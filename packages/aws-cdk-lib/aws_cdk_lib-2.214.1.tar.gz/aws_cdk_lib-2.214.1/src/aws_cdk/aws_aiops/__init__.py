...
@jsii.interface(jsii_type="aws-cdk-lib.aws_aiops.IInvestigationGroupRef")
...
class _IInvestigationGroupRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_aiops.IInvestigationGroupRef"
    pass
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_aiops.InvestigationGroupReference",
    jsii_struct_bases=[],
...
class InvestigationGroupReference:
    def __init__(self, *, investigation_group_arn: builtins.str) -> None:
        ...
        Example::
            ...
            investigation_group_reference = aiops.InvestigationGroupReference(
                investigation_group_arn="investigationGroupArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__0728b599603b3f187233df96bdf8630b568be5d39e35fc79a53ca1c86a6df3c0)
...
@jsii.implements(_IInspectable_c2943556, IInvestigationGroupRef, _ITaggableV2_4e6798f8)
...
def _typecheckingstub__0728b599603b3f187233df96bdf8630b568be5d39e35fc79a53ca1c86a6df3c0(
    *,
