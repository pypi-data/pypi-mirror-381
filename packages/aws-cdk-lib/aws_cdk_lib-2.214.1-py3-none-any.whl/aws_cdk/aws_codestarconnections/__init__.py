...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_codestarconnections.ConnectionReference",
    jsii_struct_bases=[],
...
class ConnectionReference:
    def __init__(self, *, connection_arn: builtins.str) -> None:
        ...
        Example::
            ...
            connection_reference = codestarconnections.ConnectionReference(
                connection_arn="connectionArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__5396aab9f664826eb601b0e7b2f636f7dc0987d87f0a475b8cdec7489f7ffcf9)
            check_type(argname="argument connection_arn", value=connection_arn, expected_type=type_hints["connection_arn"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "connection_arn": connection_arn,
        }
...
class _IConnectionRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_codestarconnections.IConnectionRef"
    pass
...
class _IRepositoryLinkRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_codestarconnections.IRepositoryLinkRef"
    pass
...
class _ISyncConfigurationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_codestarconnections.ISyncConfigurationRef"
    pass
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_codestarconnections.RepositoryLinkReference",
    jsii_struct_bases=[],
...
class RepositoryLinkReference:
    def __init__(self, *, repository_link_arn: builtins.str) -> None:
        ...
        Example::
            ...
            repository_link_reference = codestarconnections.RepositoryLinkReference(
                repository_link_arn="repositoryLinkArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__ee35b8af6d1a8a200c075f542df81ad873c65c68e02eb59d842183368d21a8a0)
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_codestarconnections.SyncConfigurationReference",
    jsii_struct_bases=[],
...
class SyncConfigurationReference:
    def __init__(self, *, resource_name: builtins.str, sync_type: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b634cefa50e32d2a97d5fd1418bc1f5138c553ce37089613c24a531253632947)
            check_type(argname="argument resource_name", value=resource_name, expected_type=type_hints["resource_name"])
            check_type(argname="argument sync_type", value=sync_type, expected_type=type_hints["sync_type"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "resource_name": resource_name,
...
@jsii.implements(_IInspectable_c2943556, IConnectionRef, _ITaggable_36806126)
class CfnConnection(
...
@jsii.implements(_IInspectable_c2943556, IRepositoryLinkRef, _ITaggableV2_4e6798f8)
...
@jsii.implements(_IInspectable_c2943556, ISyncConfigurationRef)
...
def _typecheckingstub__5396aab9f664826eb601b0e7b2f636f7dc0987d87f0a475b8cdec7489f7ffcf9(
    *,
    connection_arn: builtins.str,
) -> None:
    """Type checking stubs"""
...
def _typecheckingstub__ee35b8af6d1a8a200c075f542df81ad873c65c68e02eb59d842183368d21a8a0(
    *,
...
def _typecheckingstub__b634cefa50e32d2a97d5fd1418bc1f5138c553ce37089613c24a531253632947(
    *,
    resource_name: builtins.str,
    sync_type: builtins.str,
) -> None:
