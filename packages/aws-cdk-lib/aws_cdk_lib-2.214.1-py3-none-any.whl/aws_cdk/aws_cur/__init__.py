...
class _IReportDefinitionRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_cur.IReportDefinitionRef"
    pass
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_cur.ReportDefinitionReference",
    jsii_struct_bases=[],
...
class ReportDefinitionReference:
    def __init__(self, *, report_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2979cdcade39e5d1bf0ab37d6e3ce4f62ee86743bfd37b32e36912460dd8726e)
            check_type(argname="argument report_name", value=report_name, expected_type=type_hints["report_name"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "report_name": report_name,
        }
...
def _typecheckingstub__2979cdcade39e5d1bf0ab37d6e3ce4f62ee86743bfd37b32e36912460dd8726e(
    *,
    report_name: builtins.str,
) -> None:
    """Type checking stubs"""
