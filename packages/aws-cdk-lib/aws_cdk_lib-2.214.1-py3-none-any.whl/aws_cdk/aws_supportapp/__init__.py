...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_supportapp.AccountAliasReference",
    jsii_struct_bases=[],
...
class AccountAliasReference:
    def __init__(self, *, account_alias_resource_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__d7bce26384bb1ea8c73bd783ac8c88e9a47e69e9341eade99f10b02b18bc8932)
...
class _IAccountAliasRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_supportapp.IAccountAliasRef"
    pass
...
class _ISlackChannelConfigurationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_supportapp.ISlackChannelConfigurationRef"
    pass
...
class _ISlackWorkspaceConfigurationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_supportapp.ISlackWorkspaceConfigurationRef"
    pass
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_supportapp.SlackChannelConfigurationReference",
    jsii_struct_bases=[],
...
class SlackChannelConfigurationReference:
    def __init__(self, *, channel_id: builtins.str, team_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6536cd8d4126ffda45dfe864631c09b062bcddb6e95ea6d6ee9615dd58ab3288)
            check_type(argname="argument channel_id", value=channel_id, expected_type=type_hints["channel_id"])
            check_type(argname="argument team_id", value=team_id, expected_type=type_hints["team_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "channel_id": channel_id,
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_supportapp.SlackWorkspaceConfigurationReference",
    jsii_struct_bases=[],
...
class SlackWorkspaceConfigurationReference:
    def __init__(self, *, team_id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__c4da25497e3d298c3ca4e2022afcce84c930b55bc50a5b54d0a1e735676ea2b5)
            check_type(argname="argument team_id", value=team_id, expected_type=type_hints["team_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "team_id": team_id,
        }
...
@jsii.implements(_IInspectable_c2943556, IAccountAliasRef)
...
@jsii.implements(_IInspectable_c2943556, ISlackChannelConfigurationRef)
class CfnSlackChannelConfiguration(
    ...
    def channel_role_arn(self, value: builtins.str) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "channelRoleArn", value) # pyright: ignore[reportArgumentType]
    ...
    def notify_on_case_severity(self, value: builtins.str) -> None:
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "notifyOnCaseSeverity", value) # pyright: ignore[reportArgumentType]
    ...
    def notify_on_add_correspondence_to_case(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "notifyOnAddCorrespondenceToCase", value) # pyright: ignore[reportArgumentType]
    ...
    def notify_on_create_or_reopen_case(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "notifyOnCreateOrReopenCase", value) # pyright: ignore[reportArgumentType]
    ...
    def notify_on_resolve_case(
        ...
        if __debug__:
            ...
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "notifyOnResolveCase", value) # pyright: ignore[reportArgumentType]


@jsii.implements(_IInspectable_c2943556, ISlackWorkspaceConfigurationRef)
class CfnSlackWorkspaceConfiguration(
    ...
    def slack_workspace_configuration_ref(self) -> SlackWorkspaceConfigurationReference:
        '''A reference to a SlackWorkspaceConfiguration resource.'''
...
def _typecheckingstub__d7bce26384bb1ea8c73bd783ac8c88e9a47e69e9341eade99f10b02b18bc8932(
    *,
...
def _typecheckingstub__6536cd8d4126ffda45dfe864631c09b062bcddb6e95ea6d6ee9615dd58ab3288(
    *,
    channel_id: builtins.str,
    team_id: builtins.str,
) -> None:
...
def _typecheckingstub__c4da25497e3d298c3ca4e2022afcce84c930b55bc50a5b54d0a1e735676ea2b5(
    *,
    team_id: builtins.str,
) -> None:
    """Type checking stubs"""
