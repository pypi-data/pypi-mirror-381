...
@jsii.interface(jsii_type="aws-cdk-lib.aws_codegurureviewer.IRepositoryAssociationRef")
...
class _IRepositoryAssociationRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_codegurureviewer.IRepositoryAssociationRef"
    pass
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_codegurureviewer.RepositoryAssociationReference",
    jsii_struct_bases=[],
...
class RepositoryAssociationReference:
    def __init__(self, *, association_arn: builtins.str) -> None:
        ...
        Example::
            ...
            repository_association_reference = codegurureviewer.RepositoryAssociationReference(
                association_arn="associationArn"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__590266e2f4ce54b44a45ca718992f643455c41eb8984c7ad065ed82d3e370487)
...
@jsii.implements(_IInspectable_c2943556, IRepositoryAssociationRef, _ITaggable_36806126)
...
def _typecheckingstub__590266e2f4ce54b44a45ca718992f643455c41eb8984c7ad065ed82d3e370487(
    *,
