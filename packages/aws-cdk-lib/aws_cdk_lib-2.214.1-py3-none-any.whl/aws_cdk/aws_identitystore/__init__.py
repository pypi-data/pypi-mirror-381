...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_identitystore.GroupMembershipReference",
    jsii_struct_bases=[],
    name_mapping={
        "identity_store_id": "identityStoreId",
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            group_membership_reference = identitystore.GroupMembershipReference(
                identity_store_id="identityStoreId",
                membership_id="membershipId"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2976daea5ac1ea9d018c3f3c8114e7ac9b9c7059a2566800a5b9edb71732bf9f)
            check_type(argname="argument identity_store_id", value=identity_store_id, expected_type=type_hints["identity_store_id"])
...
@jsii.data_type(
    jsii_type="aws-cdk-lib.aws_identitystore.GroupReference",
    jsii_struct_bases=[],
    ...
    def __init__(
        ...
        *,
        ...
        Example::
            ...
            group_reference = identitystore.GroupReference(
                group_id="groupId",
                identity_store_id="identityStoreId"
            )
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6393bb01a64c0abb877963f69fc09c5374f5b32bfbd1b6e37dc4ed43b1c3972a)
            check_type(argname="argument group_id", value=group_id, expected_type=type_hints["group_id"])
            check_type(argname="argument identity_store_id", value=identity_store_id, expected_type=type_hints["identity_store_id"])
        self._values: typing.Dict[builtins.str, typing.Any] = {
            "group_id": group_id,
...
class _IGroupMembershipRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_identitystore.IGroupMembershipRef"
    pass
...
class _IGroupRefProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "aws-cdk-lib.aws_identitystore.IGroupRef"
    pass
...
@jsii.implements(_IInspectable_c2943556, IGroupMembershipRef)
...
def _typecheckingstub__2976daea5ac1ea9d018c3f3c8114e7ac9b9c7059a2566800a5b9edb71732bf9f(
    *,
    identity_store_id: builtins.str,
    membership_id: builtins.str,
) -> None:
...
def _typecheckingstub__6393bb01a64c0abb877963f69fc09c5374f5b32bfbd1b6e37dc4ed43b1c3972a(
    *,
    group_id: builtins.str,
    identity_store_id: builtins.str,
) -> None:
