...
class ProviderInfo(BaseModel):
    ...
    description: StrictStr = Field(description="The Provider's description recommended to be shown next to the name.              This is flavor text, not a full, human-readable description of the provider.")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "logoUrl", "subtext", "description", "health", "subProviders"]
