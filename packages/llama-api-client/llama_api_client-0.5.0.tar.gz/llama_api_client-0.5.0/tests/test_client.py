...
from llama_api_client._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: LlamaAPIClient | AsyncLlamaAPIClient) -> int:
...
class TestLlamaAPIClient:
    client = LlamaAPIClient(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "llama_api_client/_legacy_response.py",
                        "llama_api_client/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "llama_api_client/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LlamaAPIClientError):
            with update_env(**{"LLAMA_API_KEY": Omit()}):
                client2 = LlamaAPIClient(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(LLAMA_API_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            client = LlamaAPIClient(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: LlamaAPIClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: LlamaAPIClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: LlamaAPIClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = LlamaAPIClient(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = LlamaAPIClient(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_omit_retry_count_header(
        self, client: LlamaAPIClient, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncLlamaAPIClient:
    client = AsyncLlamaAPIClient(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(LlamaAPIClientError):
            with update_env(**{"LLAMA_API_KEY": Omit()}):
                client2 = AsyncLlamaAPIClient(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(LLAMA_API_CLIENT_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncLlamaAPIClient(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncLlamaAPIClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncLlamaAPIClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncLlamaAPIClient) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncLlamaAPIClient(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncLlamaAPIClient(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncLlamaAPIClient, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
