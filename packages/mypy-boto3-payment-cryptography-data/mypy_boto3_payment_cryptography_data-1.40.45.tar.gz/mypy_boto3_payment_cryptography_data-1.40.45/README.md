...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-payment-cryptography-data)](https://pypistats.org/packages/mypy-boto3-payment-cryptography-data)
...
`mypy-boto3-payment-cryptography-data` dependency in production. However, there
