...
class ModalDialog:
    ...
    def render_signal_menu(
        self, signals: List[Dict[str, Any]], process_info: Dict[str, Any]
    ) -> Optional[int]:
            ...
            try:
                ...
                if key == curses.KEY_UP:
                    ...
                    if selected_signal.get("dangerous"):
                        confirm = self.render_confirmation(
                ...
                if dialog:
                    try:
                        ...
                        # Cleanup failure is not critical during error handling
                        pass
                return None
    ...
    def render_confirmation(self, message: str, title: str = "Confirm") -> bool:
        ...
        try:
            ...
            dialog.addstr(
                options_y, start_x + len(yes_text) + 10, no_text, curses.A_BOLD
            )
    ...
    def render_status(
        self, message: str, success: bool = True, duration_ms: int = 500
    ) -> None:
