...
class ProcessTerminator:
    ...
    SIGNALS = [
        {
            "num": signal.SIGTERM,
            "name": "SIGTERM",
            "desc": "Terminate (graceful shutdown)",
            "default": True,
        },
        {
            "num": signal.SIGKILL,
            "name": "SIGKILL",
            "desc": "Kill (immediate, cannot be caught)",
            "dangerous": True,
        },
    ...
    def __init__(self, ai_process_monitor: Any = None) -> None:
    ...
    def terminate_process(
        self, pid: int, signal_num: int = signal.SIGTERM, force: bool = False
    ) -> Dict[str, Any]:
    ...
    def _verify_process_exists(self, pid: int) -> Dict[str, Any]:
        ...
        """
        info = {"exists": False, "accessible": False, "is_zombie": False, "message": ""}
    ...
    def _check_permissions(self, proc: psutil.Process) -> Dict[str, Any]:
        ...
        try:
            ...
            info["reason"] = (
                ...
                "(likely requires elevated privileges)"
            )
    ...
    def _is_system_critical(self, proc: psutil.Process) -> Dict[str, Any]:
        ...
        """
        info = {"is_critical": False, "reason": "", "safe_to_kill": True}
            ...
            try:
                ...
                if parent and parent.pid == 1:
                    ...
                    if base_name not in safe_user_processes:
                        info["is_critical"] = True
                        info["safe_to_kill"] = False
                        info["reason"] = "System service (parent is init/systemd)"
                        return info
    ...
    def _get_ai_warnings(self, proc: psutil.Process) -> Dict[str, Any]:
        ...
        """
        info = {"has_warnings": False, "warnings": [], "data_loss_risk": "low"}
        ...
        try:
            ...
            is_distributed = any(
                indicator in cmdline for indicator in distributed_indicators
            )
