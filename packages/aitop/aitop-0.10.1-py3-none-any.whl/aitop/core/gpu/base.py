...
class GPUInfo:
    ...
    All memory values (memory_used, memory_total, and processes memory) are in MB (megabytes).
    Framework version fields store vendor-specific driver and toolkit versions (e.g., CUDA, ROCm).
    """
    index: int
    name: str
