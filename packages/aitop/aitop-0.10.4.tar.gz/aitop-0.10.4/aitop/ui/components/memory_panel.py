...
class MemoryPanel:
    ...
    def _render_memory_details(
        self, memory_types: Dict[str, float], y: int, indent: int = 4
    ) -> int:
    ...
    def create_warning_message(
        self, threshold: float = 90.0, memory_stats: MemoryStats = None
    ) -> str:
        ...
        if memory_stats.swap_total > 0 and memory_stats.swap_percent >= threshold:
