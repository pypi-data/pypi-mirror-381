...
class SystemApi(object):
    ...
    def get_release_notes(self, **kwargs):
        """
        Get the release notes for the upcoming version, the currently installed version, and for the recently installed versions
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.get_release_notes(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :return: ReleaseNotesOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ReleaseNotesOutputV1
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_release_notes_with_http_info(**kwargs)
        else:
            (data) = self.get_release_notes_with_http_info(**kwargs)
            return data

    def get_release_notes_with_http_info(self, **kwargs):
        """
        Get the release notes for the upcoming version, the currently installed version, and for the recently installed versions
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_release_notes_with_http_info(callback=callback_function)
        ...
        return self.api_client.call_api('/system/release-notes', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type=params.get('_response_type', 'ReleaseNotesOutputV1'),
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
