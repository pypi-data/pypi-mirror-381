...
class DatasourcesApi(object):
    ...
    def clear_datasource_cache(self, **kwargs):
        """
        Clear cache for all items in this datasource and their dependents.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.clear_datasource_cache(id=id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: (required)
        :param bool recompile_formulas: If true, dependent formulas will be marked as needing recompilation in addition to having their caches cleared. This can be significantly more expensive. It is also typically not necessary because Seeq detects events that require recompilation of dependent formulas and performs the necessary recompilation automatically. Consider consulting Seeq Support before using this option.
        :return: DatasourceCacheClearOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: DatasourceCacheClearOutputV1
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.clear_datasource_cache_with_http_info(**kwargs)
        else:
            (data) = self.clear_datasource_cache_with_http_info(**kwargs)
            return data

    def clear_datasource_cache_with_http_info(self, **kwargs):
        """
        Clear cache for all items in this datasource and their dependents.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.clear_datasource_cache_with_http_info(id=id_value, callback=callback_function)
        ...
        all_params = ['id', 'recompile_formulas']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method clear_datasource_cache" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `clear_datasource_cache`")
        ...
        query_params = []
        if 'recompile_formulas' in params:
            query_params.append(('recompileFormulas', params['recompile_formulas']))
        ...
        return self.api_client.call_api('/datasources/{id}/cache', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type=params.get('_response_type', 'DatasourceCacheClearOutputV1'),
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_precached_items(self, **kwargs):
        """
        Get a list of the data IDs in the specified datasource of signals and conditions to pre-cache.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.get_precached_items(datasource_class=datasource_class_value, datasource_id=datasource_id_value, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str datasource_class: (required)
        :param str datasource_id: (required)
        :param int limit:
        :param str previous_page_last_data_id: The data ID of the last item of the previous page, or null to fetch the first page. Only items with data IDs strictly greater than this data ID will be returned.
        :return: PrecachedItemsOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: PrecachedItemsOutputV1
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_precached_items_with_http_info(**kwargs)
        else:
            (data) = self.get_precached_items_with_http_info(**kwargs)
            return data

    def get_precached_items_with_http_info(self, **kwargs):
        """
        Get a list of the data IDs in the specified datasource of signals and conditions to pre-cache.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_precached_items_with_http_info(datasource_class=datasource_class_value, datasource_id=datasource_id_value, callback=callback_function)
        ...
        all_params = ['datasource_class', 'datasource_id', 'limit', 'previous_page_last_data_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_precached_items" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('datasource_class' not in params) or (params['datasource_class'] is None):
            raise ValueError("Missing the required parameter `datasource_class` when calling `get_precached_items`")
        # verify the required parameter 'datasource_id' is set
        if ('datasource_id' not in params) or (params['datasource_id'] is None):
            raise ValueError("Missing the required parameter `datasource_id` when calling `get_precached_items`")
        ...
        if 'limit' in params:
            query_params.append(('limit', params['limit']))
        if 'previous_page_last_data_id' in params:
            query_params.append(('previousPageLastDataId', params['previous_page_last_data_id']))
        ...
        return self.api_client.call_api('/datasources/{datasourceClass}/{datasourceId}/precached-items', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type=params.get('_response_type', 'PrecachedItemsOutputV1'),
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
