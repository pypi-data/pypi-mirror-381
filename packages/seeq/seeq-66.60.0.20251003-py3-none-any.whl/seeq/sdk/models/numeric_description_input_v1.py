...
class NumericDescriptionInputV1(object):
    ...
    def __init__(self, created_at=None, creator_id=None, icon=None, max=None, min=None, name=None, precision=None, unit_of_measure=None, updated_at=None):
        """
    ...
    def created_at(self):
        ...
        The time the numeric description was created
    ...
    def creator_id(self):
        ...
        The creator of the numeric description
    ...
    def icon(self):
        """
        Gets the icon of this NumericDescriptionInputV1.
        Icon of the numeric description

        :return: The icon of this NumericDescriptionInputV1.
        :rtype: str
        """
        return self._icon
    ...
    def icon(self, icon):
        """
        Sets the icon of this NumericDescriptionInputV1.
        Icon of the numeric description

        :param icon: The icon of this NumericDescriptionInputV1.
        :type: str
        """
    ...
    def precision(self):
        ...
        Measurement precision of the specified unit of measure and min/max values eg: 0.1 for decimal precision
    ...
    def updated_at(self):
        ...
        The time the numeric description was last updated
