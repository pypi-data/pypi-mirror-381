...
class ItemOutputV1(object):
    ...
    def __init__(self, cached=False, datasource=None, description=None, effective_permissions=None, evidence_table_definition_id=None, fingerprint=None, id=None, is_archived=False, is_redacted=False, name=None, properties=None, scoped_to=None, status_message=None, translation_key=None, type=None, workbook_id=None):
        """
    ...
    def evidence_table_definition_id(self):
        """
        Gets the evidence_table_definition_id of this ItemOutputV1.
        ID of the evidence Table Definition when the item is a Vantage workbook

        :return: The evidence_table_definition_id of this ItemOutputV1.
        :rtype: str
        """
    ...
    def evidence_table_definition_id(self, evidence_table_definition_id):
        """
        Sets the evidence_table_definition_id of this ItemOutputV1.
        ID of the evidence Table Definition when the item is a Vantage workbook

        :param evidence_table_definition_id: The evidence_table_definition_id of this ItemOutputV1.
        :type: str
        """
