...
class SignalMonitorOutputV1(object):
    ...
    def frequency(self, frequency):
        ...
        :type: str
        """
        allowed_values = ["FIVE", "FIFTEEN", "THIRTY", "SIXTY"]
    ...
    def sample_event_types(self, sample_event_types):
        ...
        if not set(sample_event_types).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `sample_event_types` [{0}], must be a subset of [{1}]"
                .format(", ".join(map(str, set(sample_event_types)-set(allowed_values))),
