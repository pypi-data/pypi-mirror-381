...
class SendEmailInputV1(object):
    ...
    swagger_types = {
        ...
        'reply_to': 'list[SendEmailContactV1]'
    }
    ...
    def __init__(self, to_emails=None, cc_emails=None, bcc_emails=None, subject=None, content=None, attachments=None, reply_to=None):
        """
    ...
    def reply_to(self):
        """
        Gets the reply_to of this SendEmailInputV1.
        List of reply-to email addresses for the email. Currently limited to 1 recipient, but list structure maintained for future multi-recipient support. Use null or empty list for no reply-to.

        :return: The reply_to of this SendEmailInputV1.
        :rtype: list[SendEmailContactV1]
        """
    ...
    def reply_to(self, reply_to):
        """
        Sets the reply_to of this SendEmailInputV1.
        List of reply-to email addresses for the email. Currently limited to 1 recipient, but list structure maintained for future multi-recipient support. Use null or empty list for no reply-to.

        :param reply_to: The reply_to of this SendEmailInputV1.
        :type: list[SendEmailContactV1]
        """
