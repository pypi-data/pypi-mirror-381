...
class WorkbookOutputV1(object):
    ...
    swagger_types = {
        ...
        'evidence_table_definition_id': 'str',
        'id': 'str',
        'is_archived': 'bool',
        'is_redacted': 'bool',
        'locked_metadata': 'str',
    ...
    attribute_map = {
        ...
        'evidence_table_definition_id': 'evidenceTableDefinitionId',
        'id': 'id',
    ...
    def __init__(self, ancestors=None, created_at=None, creator=None, description=None, effective_permissions=None, evidence_table_definition_id=None, id=None, is_archived=False, is_redacted=False, locked_metadata=None, marked_as_favorite=False, name=None, owner=None, parent_folder_id=None, status_message=None, translation_key=None, type=None, updated_at=None, worksheets=None):
        """
        ...
        self._evidence_table_definition_id = None
        self._id = None
        ...
        if evidence_table_definition_id is not None:
          self.evidence_table_definition_id = evidence_table_definition_id
        if id is not None:
          self.id = id
    ...
    @property
    def evidence_table_definition_id(self):
        """
        Gets the evidence_table_definition_id of this WorkbookOutputV1.
        ID of the Evidence Table Definition (present only for Vantage workbooks)

        :return: The evidence_table_definition_id of this WorkbookOutputV1.
        :rtype: str
        """
        return self._evidence_table_definition_id

    @evidence_table_definition_id.setter
    def evidence_table_definition_id(self, evidence_table_definition_id):
        """
        Sets the evidence_table_definition_id of this WorkbookOutputV1.
        ID of the Evidence Table Definition (present only for Vantage workbooks)

        :param evidence_table_definition_id: The evidence_table_definition_id of this WorkbookOutputV1.
        :type: str
        """

        self._evidence_table_definition_id = evidence_table_definition_id
    ...
    def locked_metadata(self):
        """
        Gets the locked_metadata of this WorkbookOutputV1.
        The user who locked this analysis

        :return: The locked_metadata of this WorkbookOutputV1.
        :rtype: str
        """
    ...
    def locked_metadata(self, locked_metadata):
        """
        Sets the locked_metadata of this WorkbookOutputV1.
        The user who locked this analysis

        :param locked_metadata: The locked_metadata of this WorkbookOutputV1.
        :type: str
        """
