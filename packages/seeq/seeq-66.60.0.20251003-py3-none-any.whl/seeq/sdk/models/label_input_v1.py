...
class LabelInputV1(object):
    ...
    def __init__(self, archived=False, category_id=None, icon=None, name=None, parent_id=None):
        """
    ...
    def archived(self):
        """
        Gets the archived of this LabelInputV1.
        If true, the label will be archived, if false it will be unarchived

        :return: The archived of this LabelInputV1.
        :rtype: bool
        """
    ...
    def archived(self, archived):
        """
        Sets the archived of this LabelInputV1.
        If true, the label will be archived, if false it will be unarchived

        :param archived: The archived of this LabelInputV1.
        :type: bool
        """
