...
class ColumnRuleInputV1(object):
    ...
    swagger_types = {
        ...
        'context_condition': 'ColumnRuleContextConditionInputV1',
        'datasource': 'ColumnRuleDatasourceInputV1',
        'descendant': 'ColumnRuleDescendantInputV1',
        'descendant_search': 'ColumnRuleDescendantSearchInputV1',
        'event_asset_creator': 'ColumnRuleEventAssetCreatorInputV1',
        'event_property': 'ColumnRuleEventPropertyInputV1',
        'find_descendant': 'ColumnRuleFindDescendantInputV1',
        'find_property': 'ColumnRuleFindPropertyInputV1',
        ...
        'preserve_existing': 'ColumnRulePreserveExistingInputV1',
        'scalar_creator': 'ColumnRuleScalarCreatorInputV1',
        'search_ancestor': 'ColumnRuleSearchAncestorInputV1',
    ...
    attribute_map = {
        ...
        'find_descendant': 'findDescendant',
    ...
    def __init__(self, ancestor=None, asset_creator=None, concat_columns=None, constant=None, context_condition=None, datasource=None, descendant=None, descendant_search=None, event_asset_creator=None, event_property=None, find_descendant=None, find_property=None, formula_creator=None, get_item_property=None, item_search=None, item_type=None, manager=None, path=None, path_search=None, preserve_existing=None, scalar_creator=None, search_ancestor=None, set_item_property=None, text_extractor=None, text_replacement=None, tree_path_creator=None):
        """
        ...
        self._descendant_search = None
        self._event_asset_creator = None
        self._event_property = None
        self._find_descendant = None
        ...
        self._preserve_existing = None
        self._scalar_creator = None
        self._search_ancestor = None
        ...
        if descendant_search is not None:
          self.descendant_search = descendant_search
        if event_asset_creator is not None:
          self.event_asset_creator = event_asset_creator
        if event_property is not None:
          self.event_property = event_property
        if find_descendant is not None:
          self.find_descendant = find_descendant
        if find_property is not None:
          self.find_property = find_property
        ...
        if search_ancestor is not None:
    ...
    def context_condition(self):
        """
        Gets the context_condition of this ColumnRuleInputV1.

        :return: The context_condition of this ColumnRuleInputV1.
        :rtype: ColumnRuleContextConditionInputV1
        """
    ...
    def context_condition(self, context_condition):
        """
        Sets the context_condition of this ColumnRuleInputV1.

        :param context_condition: The context_condition of this ColumnRuleInputV1.
        :type: ColumnRuleContextConditionInputV1
        """
    ...
    def datasource(self):
        """
        Gets the datasource of this ColumnRuleInputV1.

        :return: The datasource of this ColumnRuleInputV1.
        :rtype: ColumnRuleDatasourceInputV1
        """
    ...
    def datasource(self, datasource):
        """
        Sets the datasource of this ColumnRuleInputV1.

        :param datasource: The datasource of this ColumnRuleInputV1.
        :type: ColumnRuleDatasourceInputV1
        """
    ...
    @property
    def descendant_search(self):
        """
        Gets the descendant_search of this ColumnRuleInputV1.

        :return: The descendant_search of this ColumnRuleInputV1.
        :rtype: ColumnRuleDescendantSearchInputV1
        """
        return self._descendant_search

    @descendant_search.setter
    def descendant_search(self, descendant_search):
        """
        Sets the descendant_search of this ColumnRuleInputV1.

        :param descendant_search: The descendant_search of this ColumnRuleInputV1.
        :type: ColumnRuleDescendantSearchInputV1
        """

        self._descendant_search = descendant_search

    @property
    def event_asset_creator(self):
        """
        Gets the event_asset_creator of this ColumnRuleInputV1.

        :return: The event_asset_creator of this ColumnRuleInputV1.
        :rtype: ColumnRuleEventAssetCreatorInputV1
        """
        return self._event_asset_creator

    @event_asset_creator.setter
    def event_asset_creator(self, event_asset_creator):
        """
        Sets the event_asset_creator of this ColumnRuleInputV1.

        :param event_asset_creator: The event_asset_creator of this ColumnRuleInputV1.
        :type: ColumnRuleEventAssetCreatorInputV1
        """

        self._event_asset_creator = event_asset_creator
    ...
    @property
    def find_descendant(self):
        """
        Gets the find_descendant of this ColumnRuleInputV1.

        :return: The find_descendant of this ColumnRuleInputV1.
        :rtype: ColumnRuleFindDescendantInputV1
        """
        return self._find_descendant

    @find_descendant.setter
    def find_descendant(self, find_descendant):
        """
        Sets the find_descendant of this ColumnRuleInputV1.

        :param find_descendant: The find_descendant of this ColumnRuleInputV1.
        :type: ColumnRuleFindDescendantInputV1
        """

        self._find_descendant = find_descendant

    @property
    def find_property(self):
        """
        Gets the find_property of this ColumnRuleInputV1.

        :return: The find_property of this ColumnRuleInputV1.
        :rtype: ColumnRuleFindPropertyInputV1
        """
        return self._find_property

    @find_property.setter
    def find_property(self, find_property):
        """
        Sets the find_property of this ColumnRuleInputV1.

        :param find_property: The find_property of this ColumnRuleInputV1.
        :type: ColumnRuleFindPropertyInputV1
        """

        self._find_property = find_property
    ...
    def preserve_existing(self):
        """
        Gets the preserve_existing of this ColumnRuleInputV1.

        :return: The preserve_existing of this ColumnRuleInputV1.
        :rtype: ColumnRulePreserveExistingInputV1
        """
        return self._preserve_existing

    @preserve_existing.setter
    def preserve_existing(self, preserve_existing):
        """
        Sets the preserve_existing of this ColumnRuleInputV1.

        :param preserve_existing: The preserve_existing of this ColumnRuleInputV1.
        :type: ColumnRulePreserveExistingInputV1
        """
    ...
    @property
    def search_ancestor(self):
        """
        Gets the search_ancestor of this ColumnRuleInputV1.

        :return: The search_ancestor of this ColumnRuleInputV1.
        :rtype: ColumnRuleSearchAncestorInputV1
        """
        return self._search_ancestor

    @search_ancestor.setter
    def search_ancestor(self, search_ancestor):
        """
        Sets the search_ancestor of this ColumnRuleInputV1.

        :param search_ancestor: The search_ancestor of this ColumnRuleInputV1.
        :type: ColumnRuleSearchAncestorInputV1
        """

        self._search_ancestor = search_ancestor
