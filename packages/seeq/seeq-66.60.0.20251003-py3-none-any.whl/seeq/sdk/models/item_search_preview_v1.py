...
class ItemSearchPreviewV1(object):
    ...
    def __init__(self, ancestors=None, datasource=None, description=None, has_active_children=False, has_children=False, id=None, included_properties=None, is_archived=False, is_asset_group_item=False, is_redacted=False, name=None, parameters=None, source_value_unit_of_measure=None, translation_key=None, type=None, value_unit_of_measure=None):
        """
    ...
    def has_active_children(self):
        """
        Gets the has_active_children of this ItemSearchPreviewV1.
        A boolean indicating whether or not child items exist for this item in the asset tree; the value will be true only if the child items are not archived

        :return: The has_active_children of this ItemSearchPreviewV1.
        :rtype: bool
        """
    ...
    def has_active_children(self, has_active_children):
        """
        Sets the has_active_children of this ItemSearchPreviewV1.
        A boolean indicating whether or not child items exist for this item in the asset tree; the value will be true only if the child items are not archived

        :param has_active_children: The has_active_children of this ItemSearchPreviewV1.
        :type: bool
        """
