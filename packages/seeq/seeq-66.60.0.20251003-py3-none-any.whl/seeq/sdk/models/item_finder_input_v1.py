...
class ItemFinderInputV1(object):
    ...
    swagger_types = {
        ...
        'hierarchy_searches': 'list[HierarchySearchV1]',
    ...
    attribute_map = {
        ...
        'hierarchy_searches': 'hierarchySearches',
    ...
    def __init__(self, cron_schedule=None, description=None, enabled=True, fixed_list_searches=None, hierarchy_searches=None, include_hierarchy=False, name=None, property_searches=None, scaling_table_uuid_column_searches=None, scoped_to=None, searches=None, timezone=None):
        """
        ...
        if hierarchy_searches is not None:
          self.hierarchy_searches = hierarchy_searches
    ...
    @property
    def hierarchy_searches(self):
        """
        Gets the hierarchy_searches of this ItemFinderInputV1.
        The list of searches for finding hierarchy nodes based on item hierarchies. This search can only be used if includeHierarchy is true.

        :return: The hierarchy_searches of this ItemFinderInputV1.
        :rtype: list[HierarchySearchV1]
        """
        return self._hierarchy_searches

    @hierarchy_searches.setter
    def hierarchy_searches(self, hierarchy_searches):
        """
        Sets the hierarchy_searches of this ItemFinderInputV1.
        The list of searches for finding hierarchy nodes based on item hierarchies. This search can only be used if includeHierarchy is true.

        :param hierarchy_searches: The hierarchy_searches of this ItemFinderInputV1.
        :type: list[HierarchySearchV1]
        """

        self._hierarchy_searches = hierarchy_searches

    @property
    def include_hierarchy(self):
        """
        Gets the include_hierarchy of this ItemFinderInputV1.
        Whether the item finder will include hierarchy information

        :return: The include_hierarchy of this ItemFinderInputV1.
        :rtype: bool
        """
        return self._include_hierarchy

    @include_hierarchy.setter
    def include_hierarchy(self, include_hierarchy):
        """
        Sets the include_hierarchy of this ItemFinderInputV1.
        Whether the item finder will include hierarchy information

        :param include_hierarchy: The include_hierarchy of this ItemFinderInputV1.
        :type: bool
        """
