...
class FormulaParameterInputV1(object):
    ...
    def __init__(self, formula=None, id=None, name=None, type=None, unbound=False):
        """
    ...
    def type(self):
        """
        Gets the type of this FormulaParameterInputV1.
        The type of FormulaFunction. Valid types are 'FormulaFunction', 'AggregatingFormulaFunction', 'UserDefinedFormulaFunction', and 'Chart'. This is required if 'formula' is specified. This field is ignored if 'id' is specified

        :return: The type of this FormulaParameterInputV1.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this FormulaParameterInputV1.
        The type of FormulaFunction. Valid types are 'FormulaFunction', 'AggregatingFormulaFunction', 'UserDefinedFormulaFunction', and 'Chart'. This is required if 'formula' is specified. This field is ignored if 'id' is specified

        :param type: The type of this FormulaParameterInputV1.
        :type: str
        """
