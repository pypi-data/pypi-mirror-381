...
class TreeItemOutputV1(object):
    ...
    def __init__(self, cached=False, children=None, created_by=None, datasource=None, description=None, effective_permissions=None, evidence_table_definition_id=None, fingerprint=None, has_active_children=False, has_children=False, id=None, is_archived=False, is_redacted=False, manually_added=None, name=None, parameters=None, properties=None, scoped_to=None, status_message=None, translation_key=None, type=None, value_unit_of_measure=None, workbook_id=None):
        ...
        self._has_active_children = None
    ...
    def evidence_table_definition_id(self):
        """
        Gets the evidence_table_definition_id of this TreeItemOutputV1.
        ID of the evidence Table Definition when the item is a Vantage workbook

        :return: The evidence_table_definition_id of this TreeItemOutputV1.
        :rtype: str
        """
    ...
    def evidence_table_definition_id(self, evidence_table_definition_id):
        """
        Sets the evidence_table_definition_id of this TreeItemOutputV1.
        ID of the evidence Table Definition when the item is a Vantage workbook

        :param evidence_table_definition_id: The evidence_table_definition_id of this TreeItemOutputV1.
        :type: str
        """
    ...
    def has_active_children(self):
        """
        Gets the has_active_children of this TreeItemOutputV1.
        True if this item has active children

        :return: The has_active_children of this TreeItemOutputV1.
        :rtype: bool
        """
        return self._has_active_children

    @has_active_children.setter
    def has_active_children(self, has_active_children):
        """
        Sets the has_active_children of this TreeItemOutputV1.
        True if this item has active children

        :param has_active_children: The has_active_children of this TreeItemOutputV1.
        :type: bool
        """

        self._has_active_children = has_active_children
