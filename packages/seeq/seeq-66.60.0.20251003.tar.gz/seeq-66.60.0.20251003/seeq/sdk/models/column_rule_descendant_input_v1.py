...
class ColumnRuleDescendantInputV1(object):
    ...
    def property_match_operator(self):
        ...
        The operator to use for matching the property value. Available options are EQUALS, EQUALS_IGNORE_CASE, NOT_EQUALS, WITHIN, STRING_CONTAINS, REGEX_MATCHES, and NOT_REGEX_MATCHES.
