...
class ConditionMonitorNotificationConfigurationInputV1(object):
    ...
    def __init__(self, bcc_email_recipients=None, capsule_grouping=None, capsule_properties=None, cc_email_recipients=None, contextual_text=None, reply_to_email_recipients=None, timezone=None, to_email_recipients=None):
        """
    ...
    def reply_to_email_recipients(self):
        """
        Gets the reply_to_email_recipients of this ConditionMonitorNotificationConfigurationInputV1.
        Email addresses or Seeq Identity IDs that will be in the Reply-To list of the email

        :return: The reply_to_email_recipients of this ConditionMonitorNotificationConfigurationInputV1.
        :rtype: list[str]
        """
    ...
    def reply_to_email_recipients(self, reply_to_email_recipients):
        """
        Sets the reply_to_email_recipients of this ConditionMonitorNotificationConfigurationInputV1.
        Email addresses or Seeq Identity IDs that will be in the Reply-To list of the email

        :param reply_to_email_recipients: The reply_to_email_recipients of this ConditionMonitorNotificationConfigurationInputV1.
        :type: list[str]
        """
