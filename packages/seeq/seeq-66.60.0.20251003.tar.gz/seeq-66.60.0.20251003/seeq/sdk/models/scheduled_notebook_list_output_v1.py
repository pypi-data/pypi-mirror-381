...
class ScheduledNotebookListOutputV1(object):
    ...
    def __init__(self, limit=None, next=None, offset=None, prev=None, scheduled_notebooks=None, status_message=None):
        """
    ...
    def limit(self):
        """
        Gets the limit of this ScheduledNotebookListOutputV1.
        The pagination limit, the total number of collection items that will be returned in this page of results

        :return: The limit of this ScheduledNotebookListOutputV1.
        :rtype: int
        """
        return self._limit
    ...
    def limit(self, limit):
        """
        Sets the limit of this ScheduledNotebookListOutputV1.
        The pagination limit, the total number of collection items that will be returned in this page of results

        :param limit: The limit of this ScheduledNotebookListOutputV1.
        :type: int
        """
    ...
    def next(self):
        """
        Gets the next of this ScheduledNotebookListOutputV1.
        The href of the next set of paginated results

        :return: The next of this ScheduledNotebookListOutputV1.
        :rtype: str
        """
        return self._next
    ...
    def next(self, next):
        """
        Sets the next of this ScheduledNotebookListOutputV1.
        The href of the next set of paginated results

        :param next: The next of this ScheduledNotebookListOutputV1.
        :type: str
        """
    ...
    def offset(self):
        """
        Gets the offset of this ScheduledNotebookListOutputV1.
        The pagination offset, the index of the first collection item that will be returned in this page of results

        :return: The offset of this ScheduledNotebookListOutputV1.
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        """
        Sets the offset of this ScheduledNotebookListOutputV1.
        The pagination offset, the index of the first collection item that will be returned in this page of results

        :param offset: The offset of this ScheduledNotebookListOutputV1.
        :type: int
        """
    ...
    def prev(self):
        """
        Gets the prev of this ScheduledNotebookListOutputV1.
        The href of the previous set of paginated results

        :return: The prev of this ScheduledNotebookListOutputV1.
        :rtype: str
        """
        return self._prev
    ...
    def prev(self, prev):
        """
        Sets the prev of this ScheduledNotebookListOutputV1.
        The href of the previous set of paginated results

        :param prev: The prev of this ScheduledNotebookListOutputV1.
        :type: str
        """
