...
class ProjectInputV1(object):
    ...
    def __init__(self, configuration=None, description=None, folder_id=None, name=None, owner_id=None, project_type=None, resource_size=None, startup_environment=None):
        """
        ...
        self._startup_environment = None
        ...
        if startup_environment is not None:
          self.startup_environment = startup_environment
    ...
    def startup_environment(self):
        """
        Gets the startup_environment of this ProjectInputV1.
        The name of the Python environment to launch the project. Defaults to 'system'. Format of Python environment is 'python3XX' where XX are digits.

        :return: The startup_environment of this ProjectInputV1.
        :rtype: str
        """
        return self._startup_environment

    @startup_environment.setter
    def startup_environment(self, startup_environment):
        """
        Sets the startup_environment of this ProjectInputV1.
        The name of the Python environment to launch the project. Defaults to 'system'. Format of Python environment is 'python3XX' where XX are digits.

        :param startup_environment: The startup_environment of this ProjectInputV1.
        :type: str
        """

        self._startup_environment = startup_environment
