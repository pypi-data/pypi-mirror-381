...
class ConnectionInputV1(object):
    ...
    def __init__(self, backup_name=None, datasource_id=None, enabled=True, json=None, max_concurrent_requests=None, max_results_per_requests=None, transforms=None):
        """
