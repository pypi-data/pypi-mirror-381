...
class ItemsApi(object):
    ...
    def get_parent_datasources(self, **kwargs):
        """
        Get the datasources with items accessible to the current user
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        to be invoked when receiving the response.
        >>> def callback_function(response):
        >>>     pprint(response)
        >>>
        >>> thread = api.get_parent_datasources(callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int offset: The pagination offset, the index of the first collection item that will be returned in this page of results.
        :param int limit: The pagination limit, the total number of collection items that will be returned in this page of results.
        :return: DatasourcePairsOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: DatasourcePairsOutputV1
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_parent_datasources_with_http_info(**kwargs)
        else:
            (data) = self.get_parent_datasources_with_http_info(**kwargs)
            return data

    def get_parent_datasources_with_http_info(self, **kwargs):
        """
        Get the datasources with items accessible to the current user
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please define a `callback` function
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_parent_datasources_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_parent_datasources" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/items/parent-datasources', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type=params.get('_response_type', 'DatasourcePairsOutputV1'),
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def set_item_user_attributes(self, **kwargs):
        ...
        :param str id: ID of the item to set user attributes for (required)
        :return: ItemUserAttributesOutputV1
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ItemUserAttributesOutputV1
