...
class AccessKeysApi(object):
    ...
    def create_key(self, **kwargs):
        """
        Creates a new Access Key associated with the current session.May be used by User Admins to create Access Keys for other users.
    ...
    def get_keys(self, **kwargs):
        ...
        :param str user_id: If specified, getAll will be ignored and keys for the specified user will be returned. Only administrators may get keys for other users.
    ...
    def get_keys_with_http_info(self, **kwargs):
        ...
        all_params = ['offset', 'limit', 'get_all', 'user_id']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
