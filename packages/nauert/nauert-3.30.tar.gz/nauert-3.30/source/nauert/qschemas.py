...
class BeatwiseQSchema(QSchema):
    ...
    ..  container:: example
        ...
        ...
        beatspan: Duration(numerator=5, denominator=16)
        search_tree: UnweightedSearchTree(definition={7: None})
        tempo: MetronomeMark(reference_duration=Duration(numerator=1, denominator=4), units_per_minute=54, textual_indication=None, custom_markup=None, decimal=False)
    ...
    ..  container:: example
        ...
        >>> q_schema[0]["beatspan"]
        Duration(numerator=5, denominator=32)
...
class MeasurewiseQSchema(QSchema):
    ...
    ..  container:: example
        ...
        search_tree: UnweightedSearchTree(definition={7: None})
        tempo: MetronomeMark(...)
        time_signature: TimeSignature(pair=(3, 4), partial=None)
        use_full_measure: True
    ...
    ..  container:: example
        ...
        TimeSignature(pair=(7, 32), partial=None)
        ...
        TimeSignature(pair=(5, 8), partial=None)
