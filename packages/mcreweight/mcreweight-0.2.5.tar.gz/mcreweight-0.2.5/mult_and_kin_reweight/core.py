...
def apply_weights_pipeline(args, plotdir, weightsdir):
    """
    ...
    joblib.dump(w_normalized, f"{weightsdir}/mcweights_" + "_".join(args.vars) + ".pkl")
    ...
    print("Saving weights to output ROOT file...")
