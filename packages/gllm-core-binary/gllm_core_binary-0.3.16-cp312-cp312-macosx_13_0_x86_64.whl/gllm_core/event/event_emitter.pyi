...
class EventEmitter:
    ...
    def with_stream_handler(cls, event_level: EventLevel = ..., hooks: list[BaseEventHook] | None = None) -> EventEmitter:
        ...
        """
    async def emit(self, value: str | dict[str, Any], event_level: EventLevel = ..., event_type: EventType = ..., metadata: dict[str, Any] | None = None, disabled_handlers: list[str] | None = None) -> None:
