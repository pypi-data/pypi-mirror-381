...
from ._configuration import FabricCopyJobClientConfiguration
...
class FabricCopyJobClient:  # pylint: disable=client-accepts-api-version-keyword
    """FabricCopyJobClient.
    ...
    def __init__(
        ...
        self._config = FabricCopyJobClientConfiguration(credential=credential, **kwargs)
