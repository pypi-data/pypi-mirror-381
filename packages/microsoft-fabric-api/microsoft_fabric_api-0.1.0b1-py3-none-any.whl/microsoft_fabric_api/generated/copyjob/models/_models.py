...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.copyjob.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.copyjob.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.copyjob.models.ItemType
        """
...
class CopyJobDefinition(_serialization.Model):
    """CopyJob public definition object. Refer to `Copy job definition
    </rest/api/fabric/articles/item-management/definitions/copyjob-definition>`_ for more details
    on how to craft a CopyJob public definition.
    ...
    :vartype parts: list[~microsoft.fabric.api.copyjob.models.CopyJobDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[CopyJobDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.CopyJobDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword format: The format of the item definition.
        :paramtype format: str
        :keyword parts: A list of definition parts. Required.
        :paramtype parts: list[~microsoft.fabric.api.copyjob.models.CopyJobDefinitionPart]
        """
        super().__init__(**kwargs)
        self.format = format
        self.parts = parts
...
class CopyJobDefinitionPart(_serialization.Model):
    """CopyJob definition part object.

    :ivar path: The CopyJob public definition part path.
    :vartype path: str
    :ivar payload: The CopyJob public definition part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.copyjob.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The CopyJob public definition part path.
        :paramtype path: str
        :keyword payload: The CopyJob public definition part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.copyjob.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class CopyJobDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: CopyJob public definition object. Refer to `Copy job definition
     </rest/api/fabric/articles/item-management/definitions/copyjob-definition>`_ for more details
     on how to craft a CopyJob public definition. Required.
    :vartype definition: ~microsoft.fabric.api.copyjob.models.CopyJobDefinition
    """
    ...
    _attribute_map = {
        "definition": {"key": "definition", "type": "CopyJobDefinition"},
    }
...
class CopyJobs(PaginatedResponse):
    """A list of CopyJobs.
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of CopyJobs. Required.
    :vartype value: list[~microsoft.fabric.api.copyjob.models.CopyJob]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[CopyJob]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.CopyJob"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of CopyJobs. Required.
        :paramtype value: list[~microsoft.fabric.api.copyjob.models.CopyJob]
        """
        super().__init__(continuation_token=continuation_token, continuation_uri=continuation_uri, **kwargs)
        self.value = value


class CreateCopyJobRequest(_serialization.Model):
    """Create CopyJob request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The CopyJob display name. The display name must follow naming rules
     according to item type. Required.
    :vartype display_name: str
    :ivar description: The CopyJob description. Maximum length is 256 characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the CopyJob is created with the
     workspace as its folder.
    :vartype folder_id: str
    :ivar definition: The CopyJob public definition.
    :vartype definition: ~microsoft.fabric.api.copyjob.models.CopyJobDefinition
    """
    ...
    def __init__(
        ...
        *,
        ...
        definition: Optional["_models.CopyJobDefinition"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The CopyJob display name. The display name must follow naming rules
         according to item type. Required.
        :paramtype display_name: str
        :keyword description: The CopyJob description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the CopyJob is created with the
         workspace as its folder.
        :paramtype folder_id: str
        :keyword definition: The CopyJob public definition.
        :paramtype definition: ~microsoft.fabric.api.copyjob.models.CopyJobDefinition
        """
        super().__init__(**kwargs)
        self.display_name = display_name
        self.description = description
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.copyjob.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.copyjob.models.ErrorResponseDetails]
    """
...
class UpdateCopyJobDefinitionRequest(_serialization.Model):
    """Update CopyJob public definition request payload.
    ...
    def __init__(self, *, definition: "_models.CopyJobDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: CopyJob public definition object. Refer to `Copy job definition
         </rest/api/fabric/articles/item-management/definitions/copyjob-definition>`_ for more details
         on how to craft a CopyJob public definition. Required.
        :paramtype definition: ~microsoft.fabric.api.copyjob.models.CopyJobDefinition
        """
...
class UpdateCopyJobRequest(_serialization.Model):
