...
class CreateNotebookRequest(_serialization.Model):
    """Create notebook request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The notebook display name. The display name must follow naming rules
     according to item type. Required.
    :vartype display_name: str
    :ivar description: The notebook description. Maximum length is 256 characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the notebook is created with the
     workspace as its folder.
    :vartype folder_id: str
    :ivar definition: The notebook public definition.
    :vartype definition: ~microsoft.fabric.api.notebook.models.NotebookDefinition
    """
    ...
    _attribute_map = {
        ...
        "definition": {"key": "definition", "type": "NotebookDefinition"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        definition: Optional["_models.NotebookDefinition"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The notebook display name. The display name must follow naming rules
         according to item type. Required.
        :paramtype display_name: str
        :keyword description: The notebook description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the notebook is created with the
         workspace as its folder.
        :paramtype folder_id: str
        :keyword definition: The notebook public definition.
        :paramtype definition: ~microsoft.fabric.api.notebook.models.NotebookDefinition
        """
...
class Duration(_serialization.Model):
    ...
    :vartype time_unit: str or ~microsoft.fabric.api.notebook.models.TimeUnit
    """
    ...
    def __init__(self, *, value: float, time_unit: Union[str, "_models.TimeUnit"], **kwargs: Any) -> None:
        ...
        :paramtype time_unit: str or ~microsoft.fabric.api.notebook.models.TimeUnit
        """
        super().__init__(**kwargs)
        self.value = value
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.notebook.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.notebook.models.ErrorResponseDetails]
    """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.notebook.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.notebook.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.notebook.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class ItemReference(_serialization.Model):
    ...
    :vartype reference_type: str or ~microsoft.fabric.api.notebook.models.ItemReferenceType
    """
...
class LivySession(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :vartype state: str or ~microsoft.fabric.api.notebook.models.State
    ...
    :vartype origin: str or ~microsoft.fabric.api.notebook.models.Origin
    ...
    :vartype submitter: ~microsoft.fabric.api.notebook.models.Principal
    :ivar item: ID of the item.
    :vartype item: ~microsoft.fabric.api.notebook.models.ItemReferenceById
    :ivar item_type: The item type. Known values are: "Dashboard", "Report", "SemanticModel",
     ...
     "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
     and "UserDataFunction".
    :vartype item_type: str or ~microsoft.fabric.api.notebook.models.ItemType
    ...
    :vartype job_type: str or ~microsoft.fabric.api.notebook.models.JobType
    ...
    :vartype queued_duration: ~microsoft.fabric.api.notebook.models.Duration
    :ivar running_duration: Time it took the job to run.
    :vartype running_duration: ~microsoft.fabric.api.notebook.models.Duration
    :ivar total_duration: Total duration of the job.
    :vartype total_duration: ~microsoft.fabric.api.notebook.models.Duration
    ...
    :vartype creator_item: ~microsoft.fabric.api.notebook.models.ItemReferenceById
    ...
    :vartype consumer_id: ~microsoft.fabric.api.notebook.models.Principal
    ...
    def __init__(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :keyword state: Current state of the job. Known values are: "InProgress", "Cancelled",
         "NotStarted", "Succeeded", "Failed", and "Unknown".
        :paramtype state: str or ~microsoft.fabric.api.notebook.models.State
        ...
        :paramtype origin: str or ~microsoft.fabric.api.notebook.models.Origin
        ...
        :paramtype submitter: ~microsoft.fabric.api.notebook.models.Principal
        :keyword item: ID of the item.
        :paramtype item: ~microsoft.fabric.api.notebook.models.ItemReferenceById
        :keyword item_type: The item type. Known values are: "Dashboard", "Report", "SemanticModel",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype item_type: str or ~microsoft.fabric.api.notebook.models.ItemType
        ...
        :keyword job_type: Current state of the job. Known values are: "Unknown", "SparkSession",
         "SparkBatch", and "JupyterSession".
        :paramtype job_type: str or ~microsoft.fabric.api.notebook.models.JobType
        ...
        :paramtype queued_duration: ~microsoft.fabric.api.notebook.models.Duration
        :keyword running_duration: Time it took the job to run.
        :paramtype running_duration: ~microsoft.fabric.api.notebook.models.Duration
        :keyword total_duration: Total duration of the job.
        :paramtype total_duration: ~microsoft.fabric.api.notebook.models.Duration
        ...
        :paramtype creator_item: ~microsoft.fabric.api.notebook.models.ItemReferenceById
        ...
        :paramtype consumer_id: ~microsoft.fabric.api.notebook.models.Principal
...
class LivySessions(PaginatedResponse):
    ...
    :vartype value: list[~microsoft.fabric.api.notebook.models.LivySession]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype value: list[~microsoft.fabric.api.notebook.models.LivySession]
        """
...
class NotebookDefinition(_serialization.Model):
    """Notebook public definition object. Refer to this `article
    </rest/api/fabric/articles/item-management/definitions/notebook-definition>`_ for more details
    on how to craft a notebook public definition.

    All required parameters must be populated in order to send to server.

    :ivar format: The format of the Notebook definition. Supported format: ``ipynb`` and
     ``fabricGitSource``. If no format is provided, ``fabricGitSource`` is used.
    :vartype format: str
    :ivar parts: A list of definition parts. Required.
    :vartype parts: list[~microsoft.fabric.api.notebook.models.NotebookDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[NotebookDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.NotebookDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword format: The format of the Notebook definition. Supported format: ``ipynb`` and
         ``fabricGitSource``. If no format is provided, ``fabricGitSource`` is used.
        :paramtype format: str
        :keyword parts: A list of definition parts. Required.
        :paramtype parts: list[~microsoft.fabric.api.notebook.models.NotebookDefinitionPart]
        """
        super().__init__(**kwargs)
        self.format = format
        self.parts = parts
...
class NotebookDefinitionPart(_serialization.Model):
    """Notebook definition part object.

    :ivar path: The notebook part path. Supported notebook content extensions: ``.ipynb`` for
     ``ipynb`` format; ``.py``\\ , ``.scala``\\ , ``.r``\\ , ``.sql`` for ``fabricGitSource``
     format.
    :vartype path: str
    :ivar payload: The notebook part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.notebook.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The notebook part path. Supported notebook content extensions: ``.ipynb`` for
         ``ipynb`` format; ``.py``\\ , ``.scala``\\ , ``.r``\\ , ``.sql`` for ``fabricGitSource``
         format.
        :paramtype path: str
        :keyword payload: The notebook part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.notebook.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class NotebookDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: Notebook public definition object. Refer to this `article
     </rest/api/fabric/articles/item-management/definitions/notebook-definition>`_ for more details
     on how to craft a notebook public definition. Required.
    :vartype definition: ~microsoft.fabric.api.notebook.models.NotebookDefinition
    """
...
class Notebooks(PaginatedResponse):
    """A list of notebooks.
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of notebooks. Required.
    :vartype value: list[~microsoft.fabric.api.notebook.models.Notebook]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[Notebook]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.Notebook"],
        continuation_token: Optional[str] = None,
        continuation_uri: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of notebooks. Required.
        :paramtype value: list[~microsoft.fabric.api.notebook.models.Notebook]
        """
        super().__init__(continuation_token=continuation_token, continuation_uri=continuation_uri, **kwargs)
        self.value = value
...
class Principal(_serialization.Model):
    ...
    :ivar type: The type of the principal. Additional principal types may be added over time.
     ...
     "EntireTenant".
    :vartype type: str or ~microsoft.fabric.api.notebook.models.PrincipalType
    :ivar user_details: User principal specific details. Applicable when the principal type is
     ``User``.
    :vartype user_details: ~microsoft.fabric.api.notebook.models.PrincipalUserDetails
    ...
    :vartype service_principal_details:
     ~microsoft.fabric.api.notebook.models.PrincipalServicePrincipalDetails
    :ivar group_details: Group specific details. Applicable when the principal type is ``Group``.
    :vartype group_details: ~microsoft.fabric.api.notebook.models.PrincipalGroupDetails
    ...
    :vartype service_principal_profile_details:
     ~microsoft.fabric.api.notebook.models.PrincipalServicePrincipalProfileDetails
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The type of the principal. Additional principal types may be added over time.
         Required. Known values are: "User", "ServicePrincipal", "Group", "ServicePrincipalProfile", and
         "EntireTenant".
        :paramtype type: str or ~microsoft.fabric.api.notebook.models.PrincipalType
        :keyword group_details: Group specific details. Applicable when the principal type is
         ``Group``.
        :paramtype group_details: ~microsoft.fabric.api.notebook.models.PrincipalGroupDetails
...
class PrincipalGroupDetails(_serialization.Model):
    ...
    :vartype group_type: str or ~microsoft.fabric.api.notebook.models.GroupType
    """
    ...
    def __init__(self, *, group_type: Optional[Union[str, "_models.GroupType"]] = None, **kwargs: Any) -> None:
        ...
        :paramtype group_type: str or ~microsoft.fabric.api.notebook.models.GroupType
        """
        super().__init__(**kwargs)
...
class PrincipalServicePrincipalProfileDetails(_serialization.Model):
    ...
    :vartype parent_principal: ~microsoft.fabric.api.notebook.models.Principal
    """
    ...
    def __init__(self, *, parent_principal: Optional["_models.Principal"] = None, **kwargs: Any) -> None:
        ...
        :paramtype parent_principal: ~microsoft.fabric.api.notebook.models.Principal
        """
        super().__init__(**kwargs)
...
class UpdateNotebookDefinitionRequest(_serialization.Model):
    """Update notebook public definition request payload.
    ...
    def __init__(self, *, definition: "_models.NotebookDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: Notebook public definition object. Refer to this `article
         </rest/api/fabric/articles/item-management/definitions/notebook-definition>`_ for more details
         on how to craft a notebook public definition. Required.
        :paramtype definition: ~microsoft.fabric.api.notebook.models.NotebookDefinition
        """
...
class UpdateNotebookRequest(_serialization.Model):
