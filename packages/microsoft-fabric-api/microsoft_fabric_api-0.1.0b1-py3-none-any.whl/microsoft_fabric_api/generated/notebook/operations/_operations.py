...
def build_items_list_notebooks_request(
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/notebooks"
...
def build_items_create_notebook_request(workspace_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_items_get_notebook_request(workspace_id: str, notebook_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = "/workspaces/{workspaceId}/notebooks/{notebookId}"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
        "notebookId": _SERIALIZER.url("notebook_id", notebook_id, "str"),
    }
...
def build_items_update_notebook_request(workspace_id: str, notebook_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_items_delete_notebook_request(workspace_id: str, notebook_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_items_get_notebook_definition_request(  # pylint: disable=name-too-long
    workspace_id: str, notebook_id: str, *, format: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/notebooks/{notebookId}/getDefinition"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
        "notebookId": _SERIALIZER.url("notebook_id", notebook_id, "str"),
    }
...
def build_items_update_notebook_definition_request(  # pylint: disable=name-too-long
    workspace_id: str, notebook_id: str, *, update_metadata: Optional[bool] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/notebooks/{notebookId}/updateDefinition"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
        "notebookId": _SERIALIZER.url("notebook_id", notebook_id, "str"),
    }
...
def build_livy_sessions_list_livy_sessions_request(  # pylint: disable=name-too-long
    workspace_id: str, notebook_id: str, *, continuation_token_parameter: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/notebooks/{notebookId}/livySessions"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
        "notebookId": _SERIALIZER.url("notebook_id", notebook_id, "str"),
    }
...
def build_livy_sessions_get_livy_session_request(  # pylint: disable=name-too-long
    workspace_id: str, notebook_id: str, livy_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/notebooks/{notebookId}/livySessions/{livyId}"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
        "notebookId": _SERIALIZER.url("notebook_id", notebook_id, "str"),
...
class ItemsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~microsoft.fabric.api.notebook.FabricNotebookClient`'s
    ...
    def list_notebooks(
        ...
        :return: An iterator like instance of Notebook
        :rtype: ~azure.core.paging.ItemPaged[~microsoft.fabric.api.notebook.models.Notebook]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[_models._models.Notebooks] = kwargs.pop("cls", None)  # pylint: disable=protected-access
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_items_list_notebooks_request(
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                _models._models.Notebooks, pipeline_response  # pylint: disable=protected-access
            )
    ...
    def _create_notebook_initial(
        self, workspace_id: str, create_notebook_request: Union[_models.CreateNotebookRequest, IO[bytes]], **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        _json = None
        _content = None
        if isinstance(create_notebook_request, (IOBase, bytes)):
            _content = create_notebook_request
        else:
            _json = self._serialize.body(create_notebook_request, "CreateNotebookRequest")

        _request = build_items_create_notebook_request(
            workspace_id=workspace_id,
    ...
    @overload
    def begin_create_notebook(
        self,
        workspace_id: str,
        create_notebook_request: _models.CreateNotebookRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.Notebook]:
    ...
    def begin_create_notebook(
        self,
        workspace_id: str,
        create_notebook_request: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.Notebook]:
    ...
    def begin_create_notebook(
        ...
        * To create a notebook the workspace must be on a supported Fabric capacity. For more
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.Notebook] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._create_notebook_initial(
                workspace_id=workspace_id,
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("Notebook", pipeline_response.http_response)
            if cls:
        ...
        if cont_token:
            return LROPoller[_models.Notebook].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.Notebook](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    @distributed_trace
    def get_notebook(self, workspace_id: str, notebook_id: str, **kwargs: Any) -> _models.Notebook:
        ...
        :return: Notebook
        :rtype: ~microsoft.fabric.api.notebook.models.Notebook
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
        ...
        _request = build_items_get_notebook_request(
            workspace_id=workspace_id,
    ...
    def update_notebook(
        ...
        workspace_id: str,
        notebook_id: str,
        update_notebook_request: _models.UpdateNotebookRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Notebook:
        ...
        :param notebook_id: The notebook ID. Required.
        :type notebook_id: str
        :param update_notebook_request: Update notebook request payload. Required.
        :type update_notebook_request: ~microsoft.fabric.api.notebook.models.UpdateNotebookRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Notebook
    ...
    def update_notebook(
        ...
        workspace_id: str,
        notebook_id: str,
        update_notebook_request: IO[bytes],
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.Notebook:
        ...
        :type notebook_id: str
        :param update_notebook_request: Update notebook request payload. Required.
        :type update_notebook_request: IO[bytes]
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: Notebook
    ...
    def update_notebook(
        ...
        workspace_id: str,
        notebook_id: str,
        update_notebook_request: Union[_models.UpdateNotebookRequest, IO[bytes]],
        **kwargs: Any
    ) -> _models.Notebook:
        """Updates the properties of the specified notebook.
        ...
        :param notebook_id: The notebook ID. Required.
        :type notebook_id: str
        :param update_notebook_request: Update notebook request payload. Is either a
         UpdateNotebookRequest type or a IO[bytes] type. Required.
        :type update_notebook_request: ~microsoft.fabric.api.notebook.models.UpdateNotebookRequest or
         IO[bytes]
        :return: Notebook
        :rtype: ~microsoft.fabric.api.notebook.models.Notebook
        :raises ~azure.core.exceptions.HttpResponseError:
        ...
        _json = None
        _content = None
        if isinstance(update_notebook_request, (IOBase, bytes)):
            _content = update_notebook_request
        else:
            _json = self._serialize.body(update_notebook_request, "UpdateNotebookRequest")

        _request = build_items_update_notebook_request(
            workspace_id=workspace_id,
            notebook_id=notebook_id,
            content_type=content_type,
            json=_json,
    ...
    @distributed_trace
    def delete_notebook(  # pylint: disable=inconsistent-return-statements
        self, workspace_id: str, notebook_id: str, **kwargs: Any
    ) -> None:
        ...
        _request = build_items_delete_notebook_request(
            workspace_id=workspace_id,
            notebook_id=notebook_id,
            headers=_headers,
            params=_params,
    ...
    def _get_notebook_definition_initial(
        self, workspace_id: str, notebook_id: str, *, format: Optional[str] = None, **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
            404: ResourceNotFoundError,
        ...
        _request = build_items_get_notebook_definition_request(
            workspace_id=workspace_id,
            notebook_id=notebook_id,
            format=format,
            headers=_headers,
    ...
    @distributed_trace
    def begin_get_notebook_definition(
        self, workspace_id: str, notebook_id: str, *, format: Optional[str] = None, **kwargs: Any
    ) -> LROPoller[_models.NotebookDefinitionResponse]:
        ...
        cls: ClsType[_models.NotebookDefinitionResponse] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._get_notebook_definition_initial(
                workspace_id=workspace_id,
                notebook_id=notebook_id,
                format=format,
                cls=lambda x, y, z: x,
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("NotebookDefinitionResponse", pipeline_response.http_response)
            if cls:
                return cls(pipeline_response, deserialized, {})  # type: ignore
            return deserialized
        ...
        if polling is True:
            ...
            polling_method = polling
        if cont_token:
            return LROPoller[_models.NotebookDefinitionResponse].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.NotebookDefinitionResponse](
            self._client, raw_result, get_long_running_output, polling_method  # type: ignore
        )

    def _update_notebook_definition_initial(
        self,
        workspace_id: str,
        notebook_id: str,
        update_notebook_definition_request: Union[_models.UpdateNotebookDefinitionRequest, IO[bytes]],
        *,
        ...
        **kwargs: Any
        ...
        _json = None
        _content = None
        if isinstance(update_notebook_definition_request, (IOBase, bytes)):
            _content = update_notebook_definition_request
        else:
            _json = self._serialize.body(update_notebook_definition_request, "UpdateNotebookDefinitionRequest")

        _request = build_items_update_notebook_definition_request(
            workspace_id=workspace_id,
            notebook_id=notebook_id,
    ...
    @overload
    def begin_update_notebook_definition(
        self,
        workspace_id: str,
        notebook_id: str,
        update_notebook_definition_request: _models.UpdateNotebookDefinitionRequest,
        *,
        update_metadata: Optional[bool] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    def begin_update_notebook_definition(
        ...
        workspace_id: str,
        notebook_id: str,
        update_notebook_definition_request: IO[bytes],
        *,
        update_metadata: Optional[bool] = None,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    def begin_update_notebook_definition(
        ...
        **kwargs: Any
        ...
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._update_notebook_definition_initial(
                workspace_id=workspace_id,
                notebook_id=notebook_id,
...
class LivySessionsOperations:
    ...
    def list_livy_sessions(
        self, workspace_id: str, notebook_id: str, *, continuation_token_parameter: Optional[str] = None, **kwargs: Any
        ...
        :rtype: ~azure.core.paging.ItemPaged[~microsoft.fabric.api.notebook.models.LivySession]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    @distributed_trace
    def get_livy_session(self, workspace_id: str, notebook_id: str, livy_id: str, **kwargs: Any) -> _models.LivySession:
        ...
        :type livy_id: str
        :return: LivySession
        :rtype: ~microsoft.fabric.api.notebook.models.LivySession
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
