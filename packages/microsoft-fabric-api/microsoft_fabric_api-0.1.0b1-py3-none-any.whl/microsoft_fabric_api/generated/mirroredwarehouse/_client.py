...
from ._configuration import FabricMirroredWarehouseClientConfiguration
...
class FabricMirroredWarehouseClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricMirroredWarehouseClientConfiguration(credential=credential, **kwargs)
