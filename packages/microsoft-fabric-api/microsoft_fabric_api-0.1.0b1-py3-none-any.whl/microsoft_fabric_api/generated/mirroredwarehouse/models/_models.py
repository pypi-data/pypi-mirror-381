...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.mirroredwarehouse.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details:
     list[~microsoft.fabric.api.mirroredwarehouse.models.ErrorResponseDetails]
    """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.mirroredwarehouse.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.mirroredwarehouse.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.mirroredwarehouse.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
...
class MirroredWarehouses(PaginatedResponse):
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of mirrored warehouses. Required.
    :vartype value: list[~microsoft.fabric.api.mirroredwarehouse.models.MirroredWarehouse]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[MirroredWarehouse]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.MirroredWarehouse"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of mirrored warehouses. Required.
        :paramtype value: list[~microsoft.fabric.api.mirroredwarehouse.models.MirroredWarehouse]
        """
