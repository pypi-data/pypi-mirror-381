...
from ._configuration import FabricKQLDashboardClientConfiguration
...
class FabricKQLDashboardClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricKQLDashboardClientConfiguration(credential=credential, **kwargs)
