...
from ._configuration import FabricMLModelClientConfiguration
from ._serialization import Deserializer, Serializer
from .operations import EndpointOperations, ItemsOperations
...
class FabricMLModelClient:  # pylint: disable=client-accepts-api-version-keyword
    """FabricMLModelClient.
    ...
    :vartype endpoint: microsoft.fabric.api.mlmodel.operations.EndpointOperations
    ...
    def __init__(
        ...
        self._config = FabricMLModelClientConfiguration(credential=credential, **kwargs)
