...
from ._configuration import FabricApacheAirflowJobClientConfiguration
...
class FabricApacheAirflowJobClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricApacheAirflowJobClientConfiguration(credential=credential, **kwargs)
