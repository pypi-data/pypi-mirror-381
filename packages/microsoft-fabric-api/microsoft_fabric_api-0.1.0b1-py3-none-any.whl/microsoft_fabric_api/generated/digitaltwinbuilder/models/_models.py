...
class CreateDigitalTwinBuilderRequest(_serialization.Model):
    """Create digitaltwinbuilder request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The digitaltwinbuilder display name. The display name must follow naming
     rules according to item type i.e., It should start with letter, only has numbers and letters or
     _ and is less than 100. Required.
    :vartype display_name: str
    :ivar description: The digitaltwinbuilder description. Maximum length is 256 characters.
    :vartype description: str
    :ivar definition: The `DigitalTwinBuilder public definition
     </rest/api/fabric/articles/item-management/definitions/digital-twin-builder-definition>`_.
    :vartype definition:
     ~microsoft.fabric.api.digitaltwinbuilder.models.DigitalTwinBuilderDefinition
    """
    ...
    _attribute_map = {
        ...
        "definition": {"key": "definition", "type": "DigitalTwinBuilderDefinition"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        definition: Optional["_models.DigitalTwinBuilderDefinition"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The digitaltwinbuilder display name. The display name must follow naming
         rules according to item type i.e., It should start with letter, only has numbers and letters or
         _ and is less than 100. Required.
        :paramtype display_name: str
        :keyword description: The digitaltwinbuilder description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword definition: The `DigitalTwinBuilder public definition
         </rest/api/fabric/articles/item-management/definitions/digital-twin-builder-definition>`_.
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.digitaltwinbuilder.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.digitaltwinbuilder.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.digitaltwinbuilder.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class DigitalTwinBuilderDefinition(_serialization.Model):
    """DigitalTwinBuilder public definition object.
    ...
    :vartype parts:
     list[~microsoft.fabric.api.digitaltwinbuilder.models.DigitalTwinBuilderDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[DigitalTwinBuilderDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.DigitalTwinBuilderDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
...
class DigitalTwinBuilderDefinitionPart(_serialization.Model):
    """DigitalTwinBuilder definition part object.

    :ivar path: The DigitalTwinBuilder part path.
    :vartype path: str
    :ivar payload: The DigitalTwinBuilder part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.digitaltwinbuilder.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The DigitalTwinBuilder part path.
        :paramtype path: str
        :keyword payload: The DigitalTwinBuilder part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.digitaltwinbuilder.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class DigitalTwinBuilderDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: DigitalTwinBuilder public definition object. Required.
    :vartype definition:
     ~microsoft.fabric.api.digitaltwinbuilder.models.DigitalTwinBuilderDefinition
    """
...
class DigitalTwinBuilders(PaginatedResponse):
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of digitaltwinbuilders. Required.
    :vartype value: list[~microsoft.fabric.api.digitaltwinbuilder.models.DigitalTwinBuilder]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[DigitalTwinBuilder]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.DigitalTwinBuilder"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of digitaltwinbuilders. Required.
        :paramtype value: list[~microsoft.fabric.api.digitaltwinbuilder.models.DigitalTwinBuilder]
        """
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.digitaltwinbuilder.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details:
     list[~microsoft.fabric.api.digitaltwinbuilder.models.ErrorResponseDetails]
    """
...
class UpdateDigitalTwinBuilderDefinitionRequest(_serialization.Model):  # pylint: disable=name-too-long
    """Update digitaltwinbuilder public definition request payload.
    ...
    def __init__(self, *, definition: "_models.DigitalTwinBuilderDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: DigitalTwinBuilder public definition object. Required.
        :paramtype definition:
         ~microsoft.fabric.api.digitaltwinbuilder.models.DigitalTwinBuilderDefinition
        """
        super().__init__(**kwargs)
...
class UpdateDigitalTwinBuilderRequest(_serialization.Model):
    """Update DigitalTwinBuilder request.
