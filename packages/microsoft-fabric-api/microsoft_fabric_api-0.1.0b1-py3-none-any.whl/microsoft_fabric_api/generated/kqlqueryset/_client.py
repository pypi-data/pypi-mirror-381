...
from ._configuration import FabricKQLQuerysetClientConfiguration
...
class FabricKQLQuerysetClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricKQLQuerysetClientConfiguration(credential=credential, **kwargs)
