...
class CreateKQLQuerysetRequest(_serialization.Model):
    """Create KQL queryset request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The KQL queryset display name. The display name must follow naming rules
     according to item type. Required.
    :vartype display_name: str
    :ivar description: The KQL queryset description. Maximum length is 256 characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the KQL queryset is created with the
     workspace as its folder.
    :vartype folder_id: str
    :ivar definition: The KQL queryset public definition.
    :vartype definition: ~microsoft.fabric.api.kqlqueryset.models.KQLQuerysetDefinition
    """
    ...
    _attribute_map = {
        ...
        "definition": {"key": "definition", "type": "KQLQuerysetDefinition"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        definition: Optional["_models.KQLQuerysetDefinition"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The KQL queryset display name. The display name must follow naming rules
         according to item type. Required.
        :paramtype display_name: str
        :keyword description: The KQL queryset description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the KQL queryset is created with
         the workspace as its folder.
        :paramtype folder_id: str
        :keyword definition: The KQL queryset public definition.
        :paramtype definition: ~microsoft.fabric.api.kqlqueryset.models.KQLQuerysetDefinition
        """
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.kqlqueryset.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.kqlqueryset.models.ErrorResponseDetails]
    """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.kqlqueryset.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.kqlqueryset.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.kqlqueryset.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class KQLQuerysetDefinition(_serialization.Model):
    """KQL queryset public definition object.
    ...
    :vartype parts: list[~microsoft.fabric.api.kqlqueryset.models.KQLQuerysetDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[KQLQuerysetDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.KQLQuerysetDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword format: The format of the item definition.
        :paramtype format: str
        :keyword parts: A list of definition parts. Required.
        :paramtype parts: list[~microsoft.fabric.api.kqlqueryset.models.KQLQuerysetDefinitionPart]
        """
        super().__init__(**kwargs)
        self.format = format
        self.parts = parts
...
class KQLQuerysetDefinitionPart(_serialization.Model):
    """KQL queryset definition part object.

    :ivar path: The KQL queryset part path.
    :vartype path: str
    :ivar payload: The KQL queryset part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.kqlqueryset.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The KQL queryset part path.
        :paramtype path: str
        :keyword payload: The KQL queryset part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.kqlqueryset.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class KQLQuerysetDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: KQL queryset public definition object. Required.
    :vartype definition: ~microsoft.fabric.api.kqlqueryset.models.KQLQuerysetDefinition
    """
...
class KQLQuerysets(PaginatedResponse):
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of KQL querysets. Required.
    :vartype value: list[~microsoft.fabric.api.kqlqueryset.models.KQLQueryset]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[KQLQueryset]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.KQLQueryset"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of KQL querysets. Required.
        :paramtype value: list[~microsoft.fabric.api.kqlqueryset.models.KQLQueryset]
        """
        super().__init__(continuation_token=continuation_token, continuation_uri=continuation_uri, **kwargs)
        self.value = value


class UpdateKQLQuerysetDefinitionRequest(_serialization.Model):
    """Update KQL queryset public definition request payload.
    ...
    def __init__(self, *, definition: "_models.KQLQuerysetDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: KQL queryset public definition object. Required.
        :paramtype definition: ~microsoft.fabric.api.kqlqueryset.models.KQLQuerysetDefinition
        """
        super().__init__(**kwargs)
        self.definition = definition
...
class UpdateKQLQuerysetRequest(_serialization.Model):
    """Update KQL queryset request.
