...
from ._configuration import FabricPaginatedReportClientConfiguration
...
class FabricPaginatedReportClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricPaginatedReportClientConfiguration(credential=credential, **kwargs)
