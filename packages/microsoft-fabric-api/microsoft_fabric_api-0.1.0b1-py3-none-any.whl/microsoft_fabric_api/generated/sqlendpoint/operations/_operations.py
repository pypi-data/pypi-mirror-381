...
from .._vendor import FabricSQLEndpointClientMixinABC
...
def build_items_list_sql_endpoints_request(
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/sqlEndpoints"
...
def build_items_refresh_sql_endpoint_metadata_request(  # pylint: disable=name-too-long
    workspace_id: str, sql_endpoint_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/sqlEndpoints/{sqlEndpointId}/refreshMetadata"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
        "sqlEndpointId": _SERIALIZER.url("sql_endpoint_id", sql_endpoint_id, "str"),
    }
...
def build_items_get_connection_string_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/sqlEndpoints/{sqlEndpointId}/connectionString"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
        "sqlEndpointId": _SERIALIZER.url("sql_endpoint_id", sql_endpoint_id, "str"),
    }
...
def build_fabric_sql_endpoint_update_sql_audit_settings_request(  # pylint: disable=name-too-long
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/sqlEndpoints/{itemId}/settings/sqlAudit"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
...
def build_fabric_sql_endpoint_get_sql_audit_settings_request(  # pylint: disable=name-too-long
    workspace_id: str, item_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_fabric_sql_endpoint_set_audit_actions_and_groups_request(  # pylint: disable=name-too-long
    workspace_id: str, item_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/sqlEndpoints/{itemId}/settings/sqlAudit/setAuditActionsAndGroups"
    path_format_arguments = {
        "workspaceId": _SERIALIZER.url("workspace_id", workspace_id, "str"),
        "itemId": _SERIALIZER.url("item_id", item_id, "str"),
    }
...
class ItemsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~microsoft.fabric.api.sqlendpoint.FabricSQLEndpointClient`'s
    ...
    def list_sql_endpoints(
    ...
    ) -> Iterable["_models.SQLEndpoint"]:
        """Returns a list of SQL endpoints from the specified workspace.
        ...
        :return: An iterator like instance of SQLEndpoint
        :rtype: ~azure.core.paging.ItemPaged[~microsoft.fabric.api.sqlendpoint.models.SQLEndpoint]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[_models._models.SQLEndpoints] = kwargs.pop("cls", None)  # pylint: disable=protected-access
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_items_list_sql_endpoints_request(
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                _models._models.SQLEndpoints, pipeline_response  # pylint: disable=protected-access
            )
    ...
    def _refresh_sql_endpoint_metadata_initial(
        self,
        workspace_id: str,
        sql_endpoint_id: str,
        sql_endpoint_refresh_metadata_request: Optional[
            Union[_models.SqlEndpointRefreshMetadataRequest, IO[bytes]]
        ] = None,
        **kwargs: Any
    ) -> Iterator[bytes]:
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
        ...
        _json = None
        _content = None
        if isinstance(sql_endpoint_refresh_metadata_request, (IOBase, bytes)):
            _content = sql_endpoint_refresh_metadata_request
        else:
            if sql_endpoint_refresh_metadata_request is not None:
                _json = self._serialize.body(sql_endpoint_refresh_metadata_request, "SqlEndpointRefreshMetadataRequest")
            else:
                _json = None

        _request = build_items_refresh_sql_endpoint_metadata_request(
            workspace_id=workspace_id,
    ...
    @overload
    def begin_refresh_sql_endpoint_metadata(
        self,
        workspace_id: str,
        sql_endpoint_id: str,
        sql_endpoint_refresh_metadata_request: Optional[_models.SqlEndpointRefreshMetadataRequest] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.TableSyncStatuses]:
    ...
    def begin_refresh_sql_endpoint_metadata(
        ...
        workspace_id: str,
        sql_endpoint_id: str,
        sql_endpoint_refresh_metadata_request: Optional[IO[bytes]] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> LROPoller[_models.TableSyncStatuses]:
    ...
    def begin_refresh_sql_endpoint_metadata(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.TableSyncStatuses] = kwargs.pop("cls", None)
        polling: Union[bool, PollingMethod] = kwargs.pop("polling", True)
        lro_delay = kwargs.pop("polling_interval", self._config.polling_interval)
        cont_token: Optional[str] = kwargs.pop("continuation_token", None)
        if cont_token is None:
            raw_result = self._refresh_sql_endpoint_metadata_initial(
                workspace_id=workspace_id,
                sql_endpoint_id=sql_endpoint_id,
        ...
        def get_long_running_output(pipeline_response):
            deserialized = self._deserialize("TableSyncStatuses", pipeline_response.http_response)
            if cls:
        ...
        if cont_token:
            return LROPoller[_models.TableSyncStatuses].from_continuation_token(
                polling_method=polling_method,
                continuation_token=cont_token,
                client=self._client,
                deserialization_callback=get_long_running_output,
            )
        return LROPoller[_models.TableSyncStatuses](
    ...
    def get_connection_string(
        ...
        **kwargs: Any
        ...
        -------------------------
         ...
         SqlEndpoint.Read.All or SqlEndpoint.ReadWrite.All or Item.Read.All or Item.ReadWrite.All
        ...
        :param workspace_id: The workspace ID. Required.
        :type workspace_id: str
        :param sql_endpoint_id: The SQL endpoint ID. Required.
        :type sql_endpoint_id: str
        :keyword guest_tenant_id: The guest tenant ID if the end user's tenant is different from the
         SQL endpoint's tenant. Default value is None.
        ...
        :paramtype private_link_type: str or ~microsoft.fabric.api.sqlendpoint.models.PrivateLinkType
        :return: ConnectionStringResponse
        :rtype: ~microsoft.fabric.api.sqlendpoint.models.ConnectionStringResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map: MutableMapping[int, Type[HttpResponseError]] = {
            401: ClientAuthenticationError,
...
class FabricSQLEndpointClientOperationsMixin(FabricSQLEndpointClientMixinABC):
    ...
    def update_sql_audit_settings(
        ...
        workspace_id: str,
        item_id: str,
        update_audit_settings_request: Optional[_models.SqlAuditSettingsUpdate] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type item_id: str
        :param update_audit_settings_request: Update SQL audit settings request payload. Default value
         is None.
        :type update_audit_settings_request:
         ~microsoft.fabric.api.sqlendpoint.models.SqlAuditSettingsUpdate
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: SqlAuditSettings
        :rtype: ~microsoft.fabric.api.sqlendpoint.models.SqlAuditSettings
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def update_sql_audit_settings(
        ...
        workspace_id: str,
        item_id: str,
        update_audit_settings_request: Optional[IO[bytes]] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.SqlAuditSettings:
    ...
    def update_sql_audit_settings(
        ...
        workspace_id: str,
        item_id: str,
        update_audit_settings_request: Optional[Union[_models.SqlAuditSettingsUpdate, IO[bytes]]] = None,
        **kwargs: Any
    ) -> _models.SqlAuditSettings:
        """Update settings associated with the SQL endpoint.
        ...
        :param update_audit_settings_request: Update SQL audit settings request payload. Is either a
         SqlAuditSettingsUpdate type or a IO[bytes] type. Default value is None.
        :type update_audit_settings_request:
         ~microsoft.fabric.api.sqlendpoint.models.SqlAuditSettingsUpdate or IO[bytes]
        :return: SqlAuditSettings
        :rtype: ~microsoft.fabric.api.sqlendpoint.models.SqlAuditSettings
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        ...
        if isinstance(update_audit_settings_request, (IOBase, bytes)):
            ...
            if update_audit_settings_request is not None:
                _json = self._serialize.body(update_audit_settings_request, "SqlAuditSettingsUpdate")
            else:
                _json = None

        _request = build_fabric_sql_endpoint_update_sql_audit_settings_request(
            workspace_id=workspace_id,
            item_id=item_id,
            content_type=content_type,
            json=_json,
    ...
    def get_sql_audit_settings(self, workspace_id: str, item_id: str, **kwargs: Any) -> _models.SqlAuditSettings:
        ...
        _request = build_fabric_sql_endpoint_get_sql_audit_settings_request(
            workspace_id=workspace_id,
            item_id=item_id,
            headers=_headers,
            params=_params,
    ...
    def set_audit_actions_and_groups(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _request = build_fabric_sql_endpoint_set_audit_actions_and_groups_request(
            workspace_id=workspace_id,
            item_id=item_id,
            content_type=content_type,
            json=_json,
