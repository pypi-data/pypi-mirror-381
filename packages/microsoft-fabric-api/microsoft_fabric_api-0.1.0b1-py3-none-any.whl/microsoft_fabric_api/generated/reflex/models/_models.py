...
class CreateReflexRequest(_serialization.Model):
    """Create Reflex request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The Reflex display name. The display name must follow naming rules
     according to item type. Required.
    :vartype display_name: str
    :ivar description: The Reflex description. Maximum length is 256 characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the Reflex is created with the
     workspace as its folder.
    :vartype folder_id: str
    :ivar definition: The Reflex public definition.
    :vartype definition: ~microsoft.fabric.api.reflex.models.ReflexDefinition
    """
    ...
    _attribute_map = {
        ...
        "definition": {"key": "definition", "type": "ReflexDefinition"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        definition: Optional["_models.ReflexDefinition"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The Reflex display name. The display name must follow naming rules
         according to item type. Required.
        :paramtype display_name: str
        :keyword description: The Reflex description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the Reflex is created with the
         workspace as its folder.
        :paramtype folder_id: str
        :keyword definition: The Reflex public definition.
        :paramtype definition: ~microsoft.fabric.api.reflex.models.ReflexDefinition
        """
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.reflex.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.reflex.models.ErrorResponseDetails]
    """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.reflex.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.reflex.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.reflex.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class ReflexDefinition(_serialization.Model):
    """Reflex public definition object. Refer to this `article
    </rest/api/fabric/articles/item-management/definitions/reflex-definition>`_ for more details on
    how to craft a Reflex public definition.

    All required parameters must be populated in order to send to server.

    :ivar format: The format of the item definition. Supported format: ``json``.
    :vartype format: str
    :ivar parts: A list of definition parts. Required.
    :vartype parts: list[~microsoft.fabric.api.reflex.models.ReflexDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[ReflexDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.ReflexDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword format: The format of the item definition. Supported format: ``json``.
        :paramtype format: str
        :keyword parts: A list of definition parts. Required.
        :paramtype parts: list[~microsoft.fabric.api.reflex.models.ReflexDefinitionPart]
        """
        super().__init__(**kwargs)
        self.format = format
        self.parts = parts
...
class ReflexDefinitionPart(_serialization.Model):
    """Reflex definition part object.

    :ivar path: The Reflex public definition part path.
    :vartype path: str
    :ivar payload: The Reflex public definition part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.reflex.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The Reflex public definition part path.
        :paramtype path: str
        :keyword payload: The Reflex public definition part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.reflex.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class ReflexDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: Reflex public definition object. Refer to this `article
     </rest/api/fabric/articles/item-management/definitions/reflex-definition>`_ for more details on
     how to craft a Reflex public definition. Required.
    :vartype definition: ~microsoft.fabric.api.reflex.models.ReflexDefinition
    """
...
class Reflexes(PaginatedResponse):
    """A list of Reflexes.
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of Reflexes. Required.
    :vartype value: list[~microsoft.fabric.api.reflex.models.Reflex]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[Reflex]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.Reflex"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of Reflexes. Required.
        :paramtype value: list[~microsoft.fabric.api.reflex.models.Reflex]
        """
        super().__init__(continuation_token=continuation_token, continuation_uri=continuation_uri, **kwargs)
        self.value = value


class UpdateReflexDefinitionRequest(_serialization.Model):
    ...
    def __init__(self, *, definition: "_models.ReflexDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: Reflex public definition object. Refer to this `article
         </rest/api/fabric/articles/item-management/definitions/reflex-definition>`_ for more details on
         how to craft a Reflex public definition. Required.
        :paramtype definition: ~microsoft.fabric.api.reflex.models.ReflexDefinition
        """
...
class UpdateReflexRequest(_serialization.Model):
