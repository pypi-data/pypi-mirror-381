...
from ._configuration import FabricReflexClientConfiguration
...
class FabricReflexClient:  # pylint: disable=client-accepts-api-version-keyword
    """FabricReflexClient.
    ...
    def __init__(
        ...
        self._config = FabricReflexClientConfiguration(credential=credential, **kwargs)
