...
from ._configuration import FabricEventhouseClientConfiguration
...
class FabricEventhouseClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricEventhouseClientConfiguration(credential=credential, **kwargs)
