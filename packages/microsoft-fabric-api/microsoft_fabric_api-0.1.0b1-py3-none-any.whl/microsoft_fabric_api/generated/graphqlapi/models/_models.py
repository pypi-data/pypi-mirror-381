...
class CreateGraphQLApiRequest(_serialization.Model):
    """Create API for GraphQL request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The API for GraphQL display name. The display name must follow naming rules
     according to item type. Required.
    :vartype display_name: str
    :ivar description: The API for GraphQL description. Maximum length is 256 characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the API for GraphQL is created with
     the workspace as its folder.
    :vartype folder_id: str
    :ivar definition: The API for GraphQL public definition.
    :vartype definition: ~microsoft.fabric.api.graphqlapi.models.GraphQLApiPublicDefinition
    """
    ...
    _attribute_map = {
        ...
        "definition": {"key": "definition", "type": "GraphQLApiPublicDefinition"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        definition: Optional["_models.GraphQLApiPublicDefinition"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The API for GraphQL display name. The display name must follow naming
         rules according to item type. Required.
        :paramtype display_name: str
        :keyword description: The API for GraphQL description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the API for GraphQL is created
         with the workspace as its folder.
        :paramtype folder_id: str
        :keyword definition: The API for GraphQL public definition.
        :paramtype definition: ~microsoft.fabric.api.graphqlapi.models.GraphQLApiPublicDefinition
        """
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.graphqlapi.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.graphqlapi.models.ErrorResponseDetails]
    """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.graphqlapi.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.graphqlapi.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.graphqlapi.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class GraphQLApiDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: API for GraphQL public definition object. To create the definition, see
     `GraphQLApi definition
     </rest/api/fabric/articles/item-management/definitions/graphql-api-definition>`_. Required.
    :vartype definition: ~microsoft.fabric.api.graphqlapi.models.GraphQLApiPublicDefinition
    """
...
class GraphQLApiPublicDefinition(_serialization.Model):
    ...
    :vartype parts: list[~microsoft.fabric.api.graphqlapi.models.GraphQLApiPublicDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[GraphQLApiPublicDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.GraphQLApiPublicDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword format: The format of the item definition.
        :paramtype format: str
        :keyword parts: A list of definition parts. Required.
        :paramtype parts: list[~microsoft.fabric.api.graphqlapi.models.GraphQLApiPublicDefinitionPart]
        """
        super().__init__(**kwargs)
        self.format = format
        self.parts = parts
...
class GraphQLApiPublicDefinitionPart(_serialization.Model):
    """API for GraphQL definition part object.

    :ivar path: The API for GraphQL definition part path.
    :vartype path: str
    :ivar payload: The API for GraphQL definition part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.graphqlapi.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The API for GraphQL definition part path.
        :paramtype path: str
        :keyword payload: The API for GraphQL definition part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.graphqlapi.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class GraphQLApis(PaginatedResponse):
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of API for GraphQL items. Required.
    :vartype value: list[~microsoft.fabric.api.graphqlapi.models.GraphQLApi]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[GraphQLApi]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.GraphQLApi"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of API for GraphQL items. Required.
        :paramtype value: list[~microsoft.fabric.api.graphqlapi.models.GraphQLApi]
        """
...
class UpdateGraphQLApiDefinitionRequest(_serialization.Model):
    ...
    def __init__(self, *, definition: "_models.GraphQLApiPublicDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: API for GraphQL public definition object. To create the definition, see
         `GraphQLApi definition
         </rest/api/fabric/articles/item-management/definitions/graphql-api-definition>`_. Required.
        :paramtype definition: ~microsoft.fabric.api.graphqlapi.models.GraphQLApiPublicDefinition
        """
...
class UpdateGraphQLApiRequest(_serialization.Model):
