...
from ._configuration import FabricGraphQLApiClientConfiguration
...
class FabricGraphQLApiClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricGraphQLApiClientConfiguration(credential=credential, **kwargs)
