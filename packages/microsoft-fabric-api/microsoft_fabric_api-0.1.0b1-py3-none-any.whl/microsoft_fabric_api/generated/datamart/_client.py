...
from ._configuration import FabricDatamartClientConfiguration
...
class FabricDatamartClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricDatamartClientConfiguration(credential=credential, **kwargs)
