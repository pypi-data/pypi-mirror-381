...
def build_items_list_datamarts_request(
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/datamarts"
...
class ItemsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~microsoft.fabric.api.datamart.FabricDatamartClient`'s
    ...
    def list_datamarts(
    ...
    ) -> Iterable["_models.Datamart"]:
        """Returns a list of datamarts from the specified workspace.
        ...
        :return: An iterator like instance of Datamart
        :rtype: ~azure.core.paging.ItemPaged[~microsoft.fabric.api.datamart.models.Datamart]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[_models._models.Datamarts] = kwargs.pop("cls", None)  # pylint: disable=protected-access
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_items_list_datamarts_request(
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                _models._models.Datamarts, pipeline_response  # pylint: disable=protected-access
            )
