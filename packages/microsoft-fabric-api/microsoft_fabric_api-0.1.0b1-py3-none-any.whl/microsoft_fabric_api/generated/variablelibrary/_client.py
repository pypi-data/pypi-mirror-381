...
from ._configuration import FabricVariableLibraryClientConfiguration
...
class FabricVariableLibraryClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricVariableLibraryClientConfiguration(credential=credential, **kwargs)
