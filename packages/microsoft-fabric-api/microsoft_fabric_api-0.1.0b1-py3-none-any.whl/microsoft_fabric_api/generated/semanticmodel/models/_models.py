...
class BindSemanticModelConnectionRequest(_serialization.Model):
    """The payload of a bindConnection request to bind a data source reference of a semantic model to
    a data connection.

    All required parameters must be populated in order to send to server.

    :ivar connection_binding: The details of the connection binding. Required.
    :vartype connection_binding: ~microsoft.fabric.api.semanticmodel.models.ConnectionBinding
    """

    _validation = {
        "connection_binding": {"required": True},
    }

    _attribute_map = {
        "connection_binding": {"key": "connectionBinding", "type": "ConnectionBinding"},
    }

    def __init__(self, *, connection_binding: "_models.ConnectionBinding", **kwargs: Any) -> None:
        """
        :keyword connection_binding: The details of the connection binding. Required.
        :paramtype connection_binding: ~microsoft.fabric.api.semanticmodel.models.ConnectionBinding
        """
        super().__init__(**kwargs)
        self.connection_binding = connection_binding


class ConnectionBinding(_serialization.Model):
    ...
    :vartype id: str
    :ivar connectivity_type: The connectivity type of the connection. Known values are:
     "ShareableCloud", "PersonalCloud", "OnPremisesGateway", "OnPremisesGatewayPersonal",
     "VirtualNetworkGateway", "Automatic", and "None".
    :vartype connectivity_type: str or ~microsoft.fabric.api.semanticmodel.models.ConnectivityType
    :ivar connection_details: The connection details of the connection. Required.
    :vartype connection_details: ~microsoft.fabric.api.semanticmodel.models.ListConnectionDetails
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype id: str
        :keyword connectivity_type: The connectivity type of the connection. Known values are:
         "ShareableCloud", "PersonalCloud", "OnPremisesGateway", "OnPremisesGatewayPersonal",
         "VirtualNetworkGateway", "Automatic", and "None".
        :paramtype connectivity_type: str or
         ~microsoft.fabric.api.semanticmodel.models.ConnectivityType
        :keyword connection_details: The connection details of the connection. Required.
        :paramtype connection_details: ~microsoft.fabric.api.semanticmodel.models.ListConnectionDetails
        """
        super().__init__(**kwargs)
        self.id = id
...
class CreateSemanticModelRequest(_serialization.Model):
    """Create semantic model request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The semantic model display name. The display name must follow naming rules
     according to item type. Required.
    :vartype display_name: str
    :ivar description: The semantic model description. Maximum length is 256 characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the semantic model is created with
     the workspace as its folder.
    :vartype folder_id: str
    :ivar definition: The semantic model public definition. Required.
    :vartype definition: ~microsoft.fabric.api.semanticmodel.models.SemanticModelDefinition
    """
    ...
    _attribute_map = {
        ...
        "definition": {"key": "definition", "type": "SemanticModelDefinition"},
    }
    ...
    def __init__(
        ...
        *,
        display_name: str,
        definition: "_models.SemanticModelDefinition",
        description: Optional[str] = None,
        folder_id: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The semantic model display name. The display name must follow naming
         rules according to item type. Required.
        :paramtype display_name: str
        :keyword description: The semantic model description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the semantic model is created with
         the workspace as its folder.
        :paramtype folder_id: str
        :keyword definition: The semantic model public definition. Required.
        :paramtype definition: ~microsoft.fabric.api.semanticmodel.models.SemanticModelDefinition
        """
        super().__init__(**kwargs)
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.semanticmodel.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.semanticmodel.models.ErrorResponseDetails]
    """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.semanticmodel.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.semanticmodel.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.semanticmodel.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class SemanticModelDefinition(_serialization.Model):
    """`Semantic model public definition
    </rest/api/fabric/articles/item-management/definitions/semantic-model-definition>`_ object.
    ...
    :vartype parts: list[~microsoft.fabric.api.semanticmodel.models.SemanticModelDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[SemanticModelDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.SemanticModelDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword format: The format of the item definition.
        :paramtype format: str
        :keyword parts: A list of definition parts. Required.
        :paramtype parts: list[~microsoft.fabric.api.semanticmodel.models.SemanticModelDefinitionPart]
        """
        super().__init__(**kwargs)
        self.format = format
        self.parts = parts
...
class SemanticModelDefinitionPart(_serialization.Model):
    """Semantic model definition part object.

    :ivar path: The semantic model part path.
    :vartype path: str
    :ivar payload: The semantic model part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.semanticmodel.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The semantic model part path.
        :paramtype path: str
        :keyword payload: The semantic model part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.semanticmodel.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class SemanticModelDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: `Semantic model public definition
     </rest/api/fabric/articles/item-management/definitions/semantic-model-definition>`_ object.
     Required.
    :vartype definition: ~microsoft.fabric.api.semanticmodel.models.SemanticModelDefinition
    """
...
class SemanticModels(PaginatedResponse):
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of semantic models. Required.
    :vartype value: list[~microsoft.fabric.api.semanticmodel.models.SemanticModel]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[SemanticModel]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.SemanticModel"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of semantic models. Required.
        :paramtype value: list[~microsoft.fabric.api.semanticmodel.models.SemanticModel]
        """
        super().__init__(continuation_token=continuation_token, continuation_uri=continuation_uri, **kwargs)
        self.value = value


class UpdateSemanticModelDefinitionRequest(_serialization.Model):
    ...
    def __init__(self, *, definition: "_models.SemanticModelDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: `Semantic model public definition
         </rest/api/fabric/articles/item-management/definitions/semantic-model-definition>`_ object.
         Required.
        :paramtype definition: ~microsoft.fabric.api.semanticmodel.models.SemanticModelDefinition
        """
...
class UpdateSemanticModelRequest(_serialization.Model):
