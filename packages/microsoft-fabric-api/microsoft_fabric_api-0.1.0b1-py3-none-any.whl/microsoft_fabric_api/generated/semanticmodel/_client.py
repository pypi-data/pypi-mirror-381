...
from ._configuration import FabricSemanticModelClientConfiguration
...
class FabricSemanticModelClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricSemanticModelClientConfiguration(credential=credential, **kwargs)
