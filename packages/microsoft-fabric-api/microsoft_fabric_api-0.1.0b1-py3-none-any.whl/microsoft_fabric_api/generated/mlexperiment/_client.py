...
from ._configuration import FabricMLExperimentClientConfiguration
...
class FabricMLExperimentClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricMLExperimentClientConfiguration(credential=credential, **kwargs)
