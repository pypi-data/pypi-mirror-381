...
class CreateMLExperimentRequest(_serialization.Model):
    """Create machine learning experiment request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The machine learning experiment display name. The display name must follow
     naming rules according to item type. Required.
    :vartype display_name: str
    :ivar description: The machine learning experiment description. Maximum length is 256
     characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the machine learning experiment is
    ...
    def __init__(
        ...
        """
        :keyword display_name: The machine learning experiment display name. The display name must
         follow naming rules according to item type. Required.
        :paramtype display_name: str
        :keyword description: The machine learning experiment description. Maximum length is 256
         characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the machine learning experiment is
         created with the workspace as its folder.
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.mlexperiment.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.mlexperiment.models.ErrorResponseDetails]
    """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.mlexperiment.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.mlexperiment.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.mlexperiment.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class MLExperiment(Item):
    ...
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.mlexperiment.models.ItemTag]
    :ivar properties: The machine learning experiment properties.
    :vartype properties: ~microsoft.fabric.api.mlexperiment.models.MLExperimentProperties
    """
    ...
    _attribute_map = {
        ...
        "folder_id": {"key": "folderId", "type": "str"},
        "tags": {"key": "tags", "type": "[ItemTag]"},
        "properties": {"key": "properties", "type": "MLExperimentProperties"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        display_name: Optional[str] = None,
        description: Optional[str] = None,
        properties: Optional["_models.MLExperimentProperties"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The item display name.
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.mlexperiment.models.ItemType
        :keyword properties: The machine learning experiment properties.
        :paramtype properties: ~microsoft.fabric.api.mlexperiment.models.MLExperimentProperties
        """
        super().__init__(display_name=display_name, description=description, type=type, **kwargs)
        self.properties = properties


class MLExperimentProperties(_serialization.Model):
    """The machine learning experiment properties.

    Variables are only populated by the server, and will be ignored when sending a request.

    :ivar ml_flow_experiment_id: The internal machine learning flow experiment ID.
    :vartype ml_flow_experiment_id: str
    """

    _validation = {
        "ml_flow_experiment_id": {"readonly": True},
    }

    _attribute_map = {
        "ml_flow_experiment_id": {"key": "mlFlowExperimentId", "type": "str"},
    }

    def __init__(self, **kwargs: Any) -> None:
        """ """
        super().__init__(**kwargs)
        self.ml_flow_experiment_id = None
...
class MLExperiments(PaginatedResponse):
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of machine learning experiments. Required.
    :vartype value: list[~microsoft.fabric.api.mlexperiment.models.MLExperiment]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[MLExperiment]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.MLExperiment"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of machine learning experiments. Required.
        :paramtype value: list[~microsoft.fabric.api.mlexperiment.models.MLExperiment]
        """
        super().__init__(continuation_token=continuation_token, continuation_uri=continuation_uri, **kwargs)
        self.value = value


class UpdateMLExperimentRequest(_serialization.Model):
