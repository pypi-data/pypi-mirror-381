...
from ._configuration import FabricDataPipelineClientConfiguration
...
class FabricDataPipelineClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricDataPipelineClientConfiguration(credential=credential, **kwargs)
