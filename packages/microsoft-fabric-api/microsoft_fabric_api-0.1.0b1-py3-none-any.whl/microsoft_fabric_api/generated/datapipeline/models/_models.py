...
class CreateDataPipelineRequest(_serialization.Model):
    """Create data pipeline request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The data pipeline display name. Required.
    :vartype display_name: str
    :ivar description: The data pipeline description. Maximum length is 256 characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the data pipeline is created with the
     workspace as its folder.
    :vartype folder_id: str
    :ivar definition: The data pipeline public definition.
    :vartype definition: ~microsoft.fabric.api.datapipeline.models.DataPipelineDefinition
    """
    ...
    _attribute_map = {
        ...
        "definition": {"key": "definition", "type": "DataPipelineDefinition"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        definition: Optional["_models.DataPipelineDefinition"] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The data pipeline display name. Required.
        :paramtype display_name: str
        :keyword description: The data pipeline description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the data pipeline is created with
         the workspace as its folder.
        :paramtype folder_id: str
        :keyword definition: The data pipeline public definition.
        :paramtype definition: ~microsoft.fabric.api.datapipeline.models.DataPipelineDefinition
        """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.datapipeline.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.datapipeline.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.datapipeline.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class DataPipelineDefinition(_serialization.Model):
    """Data pipeline public definition object.
    ...
    :vartype parts: list[~microsoft.fabric.api.datapipeline.models.DataPipelineDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[DataPipelineDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.DataPipelineDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword format: The format of the item definition.
        :paramtype format: str
        :keyword parts: A list of definition parts. Required.
        :paramtype parts: list[~microsoft.fabric.api.datapipeline.models.DataPipelineDefinitionPart]
        """
        super().__init__(**kwargs)
        self.format = format
        self.parts = parts
...
class DataPipelineDefinitionPart(_serialization.Model):
    """Data pipeline definition part object.

    :ivar path: The data pipeline part path.
    :vartype path: str
    :ivar payload: The data pipeline part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.datapipeline.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The data pipeline part path.
        :paramtype path: str
        :keyword payload: The data pipeline part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.datapipeline.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class DataPipelineDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: Data pipeline public definition object. Required.
    :vartype definition: ~microsoft.fabric.api.datapipeline.models.DataPipelineDefinition
    """
...
class DataPipelines(PaginatedResponse):
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of data pipelines. Required.
    :vartype value: list[~microsoft.fabric.api.datapipeline.models.DataPipeline]
    """
    ...
    _attribute_map = {
        "continuation_token": {"key": "continuationToken", "type": "str"},
        "continuation_uri": {"key": "continuationUri", "type": "str"},
        "value": {"key": "value", "type": "[DataPipeline]"},
    }

    def __init__(
        self,
        *,
        value: List["_models.DataPipeline"],
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of data pipelines. Required.
        :paramtype value: list[~microsoft.fabric.api.datapipeline.models.DataPipeline]
        """
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.datapipeline.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.datapipeline.models.ErrorResponseDetails]
    """
...
class UpdateDataPipelineDefinitionRequest(_serialization.Model):
    """Update data pipeline public definition request payload.
    ...
    def __init__(self, *, definition: "_models.DataPipelineDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: Data pipeline public definition object. Required.
        :paramtype definition: ~microsoft.fabric.api.datapipeline.models.DataPipelineDefinition
        """
        super().__init__(**kwargs)
        self.definition = definition
...
class UpdateDataPipelineRequest(_serialization.Model):
    """Update data pipeline request.

    :ivar display_name: The data pipeline display name. The display name must follow naming rules
    ...
    def __init__(self, *, display_name: Optional[str] = None, description: Optional[str] = None, **kwargs: Any) -> None:
        """
        :keyword display_name: The data pipeline display name. The display name must follow naming
