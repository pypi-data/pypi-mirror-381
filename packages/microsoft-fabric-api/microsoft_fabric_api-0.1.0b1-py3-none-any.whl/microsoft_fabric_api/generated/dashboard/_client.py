...
from ._configuration import FabricDashboardClientConfiguration
...
class FabricDashboardClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricDashboardClientConfiguration(credential=credential, **kwargs)
