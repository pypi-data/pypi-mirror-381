...
def build_items_list_dashboards_request(
    ...
    # Construct URL
    _url = "/workspaces/{workspaceId}/dashboards"
...
class ItemsOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~microsoft.fabric.api.dashboard.FabricDashboardClient`'s
    ...
    def list_dashboards(
        ...
        :rtype: ~azure.core.paging.ItemPaged[~microsoft.fabric.api.dashboard.models.Dashboard]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}

        cls: ClsType[_models._models.Dashboards] = kwargs.pop("cls", None)  # pylint: disable=protected-access
        ...
        def prepare_request(next_link=None):
            if not next_link:
                ...
                _request = build_items_list_dashboards_request(
        ...
        def extract_data(pipeline_response):
            deserialized = self._deserialize(
                _models._models.Dashboards, pipeline_response  # pylint: disable=protected-access
            )
