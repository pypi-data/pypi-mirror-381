...
from ._configuration import FabricReportClientConfiguration
...
class FabricReportClient:  # pylint: disable=client-accepts-api-version-keyword
    """FabricReportClient.
    ...
    def __init__(
        ...
        self._config = FabricReportClientConfiguration(credential=credential, **kwargs)
