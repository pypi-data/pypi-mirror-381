...
class CreateReportRequest(_serialization.Model):
    """Create report request payload.

    All required parameters must be populated in order to send to server.

    :ivar display_name: The report display name. The display name must follow naming rules
     according to item type. Required.
    :vartype display_name: str
    :ivar description: The report description. Maximum length is 256 characters.
    :vartype description: str
    :ivar folder_id: The folder ID. If not specified or null, the report is created with the
     workspace as its folder.
    :vartype folder_id: str
    :ivar definition: The report public definition. Required.
    :vartype definition: ~microsoft.fabric.api.report.models.ReportDefinition
    """
    ...
    _attribute_map = {
        ...
        "definition": {"key": "definition", "type": "ReportDefinition"},
    }
    ...
    def __init__(
        ...
        *,
        display_name: str,
        definition: "_models.ReportDefinition",
        description: Optional[str] = None,
        folder_id: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        """
        :keyword display_name: The report display name. The display name must follow naming rules
         according to item type. Required.
        :paramtype display_name: str
        :keyword description: The report description. Maximum length is 256 characters.
        :paramtype description: str
        :keyword folder_id: The folder ID. If not specified or null, the report is created with the
         workspace as its folder.
        :paramtype folder_id: str
        :keyword definition: The report public definition. Required.
        :paramtype definition: ~microsoft.fabric.api.report.models.ReportDefinition
        """
...
class ErrorResponseDetails(_serialization.Model):
    ...
    :vartype related_resource: ~microsoft.fabric.api.report.models.ErrorRelatedResource
    """
...
class ErrorResponse(ErrorResponseDetails):
    ...
    :vartype more_details: list[~microsoft.fabric.api.report.models.ErrorResponseDetails]
    """
...
class Item(_serialization.Model):
    ...
    :vartype type: str or ~microsoft.fabric.api.report.models.ItemType
    :ivar workspace_id: The workspace ID.
    :vartype workspace_id: str
    :ivar folder_id: The folder ID.
    :vartype folder_id: str
    :ivar tags: List of applied tags.
    :vartype tags: list[~microsoft.fabric.api.report.models.ItemTag]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword type: The item type. Required. Known values are: "Dashboard", "Report",
         ...
         "WarehouseSnapshot", "DigitalTwinBuilder", "DigitalTwinBuilderFlow", "AnomalyDetector", "Map",
         and "UserDataFunction".
        :paramtype type: str or ~microsoft.fabric.api.report.models.ItemType
        """
        super().__init__(**kwargs)
        self.id = None
        self.display_name = display_name
...
class ReportDefinition(_serialization.Model):
    """Report public definition object. Refer to this `article
    </rest/api/fabric/articles/item-management/definitions/report-definition>`_ for more details on
    how to craft a report public definition.
    ...
    :vartype parts: list[~microsoft.fabric.api.report.models.ReportDefinitionPart]
    """
    ...
    _attribute_map = {
        ...
        "parts": {"key": "parts", "type": "[ReportDefinitionPart]"},
    }

    def __init__(
        self, *, parts: List["_models.ReportDefinitionPart"], format: Optional[str] = None, **kwargs: Any
    ) -> None:
        """
        :keyword format: The format of the item definition.
        :paramtype format: str
        :keyword parts: A list of definition parts. Required.
        :paramtype parts: list[~microsoft.fabric.api.report.models.ReportDefinitionPart]
        """
        super().__init__(**kwargs)
        self.format = format
        self.parts = parts
...
class ReportDefinitionPart(_serialization.Model):
    """Report definition part object.

    :ivar path: The report part path.
    :vartype path: str
    :ivar payload: The report part payload.
    :vartype payload: str
    :ivar payload_type: The payload type. "InlineBase64"
    :vartype payload_type: str or ~microsoft.fabric.api.report.models.PayloadType
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword path: The report part path.
        :paramtype path: str
        :keyword payload: The report part payload.
        :paramtype payload: str
        :keyword payload_type: The payload type. "InlineBase64"
        :paramtype payload_type: str or ~microsoft.fabric.api.report.models.PayloadType
        """
        super().__init__(**kwargs)
        self.path = path
...
class ReportDefinitionResponse(_serialization.Model):
    ...
    :ivar definition: Report public definition object. Refer to this `article
     </rest/api/fabric/articles/item-management/definitions/report-definition>`_ for more details on
     how to craft a report public definition. Required.
    :vartype definition: ~microsoft.fabric.api.report.models.ReportDefinition
    """
...
class Reports(PaginatedResponse):
    """A list of reports.
    ...
    :ivar continuation_uri: The URI of the next result set batch. If there are no more records,
     it's removed from the response.
    :vartype continuation_uri: str
    :ivar value: A list of reports. Required.
    :vartype value: list[~microsoft.fabric.api.report.models.Report]
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword continuation_uri: The URI of the next result set batch. If there are no more records,
         it's removed from the response.
        :paramtype continuation_uri: str
        :keyword value: A list of reports. Required.
        :paramtype value: list[~microsoft.fabric.api.report.models.Report]
        """
        super().__init__(continuation_token=continuation_token, continuation_uri=continuation_uri, **kwargs)
        self.value = value


class UpdateReportDefinitionRequest(_serialization.Model):
    ...
    def __init__(self, *, definition: "_models.ReportDefinition", **kwargs: Any) -> None:
        """
        :keyword definition: Report public definition object. Refer to this `article
         </rest/api/fabric/articles/item-management/definitions/report-definition>`_ for more details on
         how to craft a report public definition. Required.
        :paramtype definition: ~microsoft.fabric.api.report.models.ReportDefinition
        """
...
class UpdateReportRequest(_serialization.Model):
