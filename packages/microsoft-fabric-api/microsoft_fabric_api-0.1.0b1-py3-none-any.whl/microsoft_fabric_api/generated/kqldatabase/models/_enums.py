...
class KqlDatabaseType(str, Enum, metaclass=CaseInsensitiveEnumMeta):
    """The KQL database type. Additional ``KQLDatabaseType`` types may be added over time."""

    READ_WRITE = "ReadWrite"
    """Allows read and write operations on the database."""
    SHORTCUT = "Shortcut"
    """A shortcut is an embedded reference allowing read only operations on a source database. The
    source can be in the same or different tenants, either in an Azure Data Explorer cluster or a
    Fabric Eventhouse."""
