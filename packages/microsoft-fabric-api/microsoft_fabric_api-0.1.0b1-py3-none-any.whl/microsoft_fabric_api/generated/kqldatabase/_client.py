...
from ._configuration import FabricKQLDatabaseClientConfiguration
...
class FabricKQLDatabaseClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricKQLDatabaseClientConfiguration(credential=credential, **kwargs)
