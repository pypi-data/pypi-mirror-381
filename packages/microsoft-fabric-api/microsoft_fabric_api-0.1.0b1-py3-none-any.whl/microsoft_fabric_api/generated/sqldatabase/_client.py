...
from ._configuration import FabricSQLDatabaseClientConfiguration
...
class FabricSQLDatabaseClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    def __init__(
        ...
        self._config = FabricSQLDatabaseClientConfiguration(credential=credential, **kwargs)
