from ...generated import mounteddatafactory
...
class FabricMountedDataFactoryClient(mounteddatafactory.FabricMountedDataFactoryClient):
    """FabricMountedDataFactoryClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.mounteddatafactory.operations.ItemsOperations
