...
class ItemsOperations(_operations.ItemsOperations):
    ...
    def create_mounted_data_factory(self, workspace_id: None, create_mounted_data_factory_request: None) -> _models.MountedDataFactory:
        ...
        * To create a MountedDataFactory the workspace must be on a supported Fabric capacity. For more
        ...
        extractor = self.begin_create_mounted_data_factory(workspace_id=workspace_id, create_mounted_data_factory_request=create_mounted_data_factory_request)
    ...
    def begin_create_mounted_data_factory(self, workspace_id: None, create_mounted_data_factory_request: None) -> _LROResultExtractor[_models.MountedDataFactory]:
        """Creates a mounted data factory in the specified workspace.
    ...
    def get_mounted_data_factory_definition(self, workspace_id: None, mounted_data_factory_id: None) -> _models.MountedDataFactoryDefinitionResponse:
        ...
        extractor = self.begin_get_mounted_data_factory_definition(workspace_id=workspace_id, mounted_data_factory_id=mounted_data_factory_id)
    ...
    def begin_get_mounted_data_factory_definition(self, workspace_id: None, mounted_data_factory_id: None) -> _LROResultExtractor[_models.MountedDataFactoryDefinitionResponse]:
        """Returns the specified mounted data factory public definition.
    ...
    def update_mounted_data_factory_definition(self, workspace_id: None, mounted_data_factory_id: None, update_mounted_data_factory_definition_request: None) -> None:
    ...
    def begin_update_mounted_data_factory_definition(self, workspace_id: None, mounted_data_factory_id: None, update_mounted_data_factory_definition_request: None) -> LROPoller[None]:
        """Overrides the definition for the specified mounted data factory.
