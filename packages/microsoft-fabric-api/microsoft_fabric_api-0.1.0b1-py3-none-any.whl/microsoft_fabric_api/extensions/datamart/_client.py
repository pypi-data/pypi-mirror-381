from ...generated import datamart
...
class FabricDatamartClient(datamart.FabricDatamartClient):
    """FabricDatamartClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.datamart.operations.ItemsOperations
