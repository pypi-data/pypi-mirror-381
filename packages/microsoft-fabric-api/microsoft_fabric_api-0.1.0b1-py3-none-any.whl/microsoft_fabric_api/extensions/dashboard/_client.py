from ...generated import dashboard
...
class FabricDashboardClient(dashboard.FabricDashboardClient):
    """FabricDashboardClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.dashboard.operations.ItemsOperations
