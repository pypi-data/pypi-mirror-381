from ...generated import eventhouse
...
class FabricEventhouseClient(eventhouse.FabricEventhouseClient):
    """FabricEventhouseClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.eventhouse.operations.ItemsOperations
