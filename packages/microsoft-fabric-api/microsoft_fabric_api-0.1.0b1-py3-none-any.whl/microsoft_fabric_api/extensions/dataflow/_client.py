from ...generated import dataflow
...
class FabricDataflowClient(dataflow.FabricDataflowClient):
    """FabricDataflowClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.dataflow.operations.ItemsOperations
