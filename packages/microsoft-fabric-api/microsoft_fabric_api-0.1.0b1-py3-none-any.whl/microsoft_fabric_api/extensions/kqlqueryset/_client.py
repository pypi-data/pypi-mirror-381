from ...generated import kqlqueryset
...
class FabricKQLQuerysetClient(kqlqueryset.FabricKQLQuerysetClient):
    """FabricKQLQuerysetClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.kqlqueryset.operations.ItemsOperations
