from ...generated import warehouse
from typing import Any, TYPE_CHECKING

from .operations import ItemsOperations, RestorePointsOperations
...
class FabricWarehouseClient(warehouse.FabricWarehouseClient):
    """FabricWarehouseClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.warehouse.operations.ItemsOperations
    ...
    def __init__(
        ...
        self.restorepoints = RestorePointsOperations(self._client, self._config, self._serialize, self._deserialize)  # type: ignore
