from ...generated import notebook
...
class FabricNotebookClient(notebook.FabricNotebookClient):
    """FabricNotebookClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.notebook.operations.ItemsOperations
