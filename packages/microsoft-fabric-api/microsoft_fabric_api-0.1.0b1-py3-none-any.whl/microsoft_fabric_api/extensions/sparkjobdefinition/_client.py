from ...generated import sparkjobdefinition
...
class FabricSparkJobDefinitionClient(sparkjobdefinition.FabricSparkJobDefinitionClient):
    """FabricSparkJobDefinitionClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.sparkjobdefinition.operations.ItemsOperations
