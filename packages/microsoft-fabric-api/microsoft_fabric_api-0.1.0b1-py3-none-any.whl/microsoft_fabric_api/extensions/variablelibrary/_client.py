from ...generated import variablelibrary
...
class FabricVariableLibraryClient(variablelibrary.FabricVariableLibraryClient):
    """FabricVariableLibraryClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.variablelibrary.operations.ItemsOperations
