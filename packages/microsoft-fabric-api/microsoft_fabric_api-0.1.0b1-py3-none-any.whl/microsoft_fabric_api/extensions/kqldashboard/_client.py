from ...generated import kqldashboard
...
class FabricKQLDashboardClient(kqldashboard.FabricKQLDashboardClient):
    """FabricKQLDashboardClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.kqldashboard.operations.ItemsOperations
