from ...generated import paginatedreport
...
class FabricPaginatedReportClient(paginatedreport.FabricPaginatedReportClient):
    """FabricPaginatedReportClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.paginatedreport.operations.ItemsOperations
