from ...generated import sqldatabase
...
class FabricSQLDatabaseClient(sqldatabase.FabricSQLDatabaseClient):
    """FabricSQLDatabaseClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.sqldatabase.operations.ItemsOperations
