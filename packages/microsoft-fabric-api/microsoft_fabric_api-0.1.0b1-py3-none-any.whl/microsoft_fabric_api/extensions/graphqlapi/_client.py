from ...generated import graphqlapi
...
class FabricGraphQLApiClient(graphqlapi.FabricGraphQLApiClient):
    """FabricGraphQLApiClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.graphqlapi.operations.ItemsOperations
