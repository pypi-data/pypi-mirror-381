from ...generated import sqlendpoint
...
class FabricSQLEndpointClient(sqlendpoint.FabricSQLEndpointClient):
    """FabricSQLEndpointClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.sqlendpoint.operations.ItemsOperations
