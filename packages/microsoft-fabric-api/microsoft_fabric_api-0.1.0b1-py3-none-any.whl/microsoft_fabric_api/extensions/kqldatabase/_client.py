from ...generated import kqldatabase
...
class FabricKQLDatabaseClient(kqldatabase.FabricKQLDatabaseClient):
    """FabricKQLDatabaseClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.kqldatabase.operations.ItemsOperations
