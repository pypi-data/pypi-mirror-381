from ...generated import warehousesnapshot
...
class FabricWarehouseSnapshotClient(warehousesnapshot.FabricWarehouseSnapshotClient):
    """FabricWarehouseSnapshotClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.warehousesnapshot.operations.ItemsOperations
