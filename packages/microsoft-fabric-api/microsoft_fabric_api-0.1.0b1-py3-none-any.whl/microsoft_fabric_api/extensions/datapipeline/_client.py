from ...generated import datapipeline
...
class FabricDataPipelineClient(datapipeline.FabricDataPipelineClient):
    """FabricDataPipelineClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.datapipeline.operations.ItemsOperations
