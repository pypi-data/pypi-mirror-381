from ...generated import digitaltwinbuilder
...
class FabricDigitalTwinBuilderClient(digitaltwinbuilder.FabricDigitalTwinBuilderClient):
    """FabricDigitalTwinBuilderClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.digitaltwinbuilder.operations.ItemsOperations
