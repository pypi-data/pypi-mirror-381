from ...generated import lakehouse
from typing import Any, TYPE_CHECKING

from .operations import ItemsOperations, TablesOperations
...
class FabricLakehouseClient(lakehouse.FabricLakehouseClient):
    """FabricLakehouseClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.lakehouse.operations.ItemsOperations
    ...
    def __init__(
        ...
        self.tables = TablesOperations(self._client, self._config, self._serialize, self._deserialize)  # type: ignore
