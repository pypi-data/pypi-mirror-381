from ...generated import semanticmodel
...
class FabricSemanticModelClient(semanticmodel.FabricSemanticModelClient):
    """FabricSemanticModelClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.semanticmodel.operations.ItemsOperations
