from ...generated import environment
...
class FabricEnvironmentClient(environment.FabricEnvironmentClient):
    """FabricEnvironmentClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.environment.operations.ItemsOperations
