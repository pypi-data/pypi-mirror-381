from ...generated import digitaltwinbuilderflow
...
class FabricDigitalTwinBuilderFlowClient(digitaltwinbuilderflow.FabricDigitalTwinBuilderFlowClient):
    """FabricDigitalTwinBuilderFlowClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.digitaltwinbuilderflow.operations.ItemsOperations
