from ...generated import eventstream
...
class FabricEventstreamClient(eventstream.FabricEventstreamClient):
    """FabricEventstreamClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.eventstream.operations.ItemsOperations
