from ...generated import mlmodel
from typing import Any, TYPE_CHECKING

from .operations import ItemsOperations, EndpointOperations
...
class FabricMLModelClient(mlmodel.FabricMLModelClient):
    """FabricMLModelClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.mlmodel.operations.ItemsOperations
    ...
    def __init__(
        ...
        self.endpoint = EndpointOperations(self._client, self._config, self._serialize, self._deserialize)  # type: ignore
