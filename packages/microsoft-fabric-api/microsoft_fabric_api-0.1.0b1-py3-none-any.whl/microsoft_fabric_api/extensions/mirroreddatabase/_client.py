from ...generated import mirroreddatabase
...
class FabricMirroredDatabaseClient(mirroreddatabase.FabricMirroredDatabaseClient):
    """FabricMirroredDatabaseClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.mirroreddatabase.operations.ItemsOperations
