...
class FabricCopyJobClient(copyjob.FabricCopyJobClient):
    """FabricCopyJobClient.

    :ivar items: ItemsOperations operations
    :vartype items: microsoft.fabric.api.copyjob.operations.ItemsOperations
