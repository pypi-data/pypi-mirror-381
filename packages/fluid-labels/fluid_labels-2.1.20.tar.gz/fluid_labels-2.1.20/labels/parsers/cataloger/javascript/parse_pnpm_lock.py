...
from labels.parsers.cataloger.javascript.utils import package_url
...
def parse_pnpm_lock(
    ...
    package_yaml = parse_yaml_with_tree_sitter(reader.read_closer.read())

    if not isinstance(package_yaml, IndexedDict):
