...
class RoleConfiguration(BaseModel):
    ...
    role_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the role configuration, generated on creation.")
    __properties: ClassVar[List[str]] = ["company_id", "role_name", "schema_version", "base_salary_minor_units", "currency", "overtime_policy", "leave_policies", "working_hours_per_day", "working_days_per_week", "is_active", "role_id"]
