...
class TestLeavePolicyDeduction(unittest.TestCase):
    """LeavePolicyDeduction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeavePolicyDeduction:
        """Test LeavePolicyDeduction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeavePolicyDeduction`
        """
        model = LeavePolicyDeduction()
        if include_optional:
            return LeavePolicyDeduction(
                type = 'percent',
                value = 0
            )
        else:
    ...
    def testLeavePolicyDeduction(self):
        """Test LeavePolicyDeduction"""
