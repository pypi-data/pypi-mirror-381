...
class TestSalaryInfo(unittest.TestCase):
    """SalaryInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SalaryInfo:
        """Test SalaryInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SalaryInfo`
        """
        model = SalaryInfo()
        if include_optional:
            return SalaryInfo(
