...
class PayrollAutomationApi:
    ...
    @validate_call
    def payroll_runs_run_id_get(
        self,
        run_id: Annotated[StrictStr, Field(description="The UUID of the payroll run job.")],
        ...
        :param run_id: The UUID of the payroll run job. (required)
        :type run_id: str
        ...
        _param = self._payroll_runs_run_id_get_serialize(
            run_id=run_id,
    ...
    @validate_call
    def payroll_runs_run_id_get_with_http_info(
        self,
        run_id: Annotated[StrictStr, Field(description="The UUID of the payroll run job.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def payroll_runs_run_id_get_without_preload_content(
        self,
        run_id: Annotated[StrictStr, Field(description="The UUID of the payroll run job.")],
        _request_timeout: Union[
            None,
    ...
    def _payroll_runs_run_id_get_serialize(
        self,
        run_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payroll/runs/{run_id}',
