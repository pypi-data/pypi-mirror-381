...
class RatingDefinitionParamsFieldConfiguration(UniversalBaseModel):
    ...
    max_value: int
    style: typing.Optional[RatingDefinitionParamsFieldConfigurationStyle] = pydantic.Field(default=None)
    """
    Field type
    """
