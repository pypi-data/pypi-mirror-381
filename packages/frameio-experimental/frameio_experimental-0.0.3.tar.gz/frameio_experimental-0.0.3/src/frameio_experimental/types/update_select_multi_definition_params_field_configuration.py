...
class UpdateSelectMultiDefinitionParamsFieldConfiguration(UniversalBaseModel):
    ...
    options: typing.Optional[typing.List[UpdateSelectMultiDefinitionParamsFieldConfigurationOptionsItem]] = None
