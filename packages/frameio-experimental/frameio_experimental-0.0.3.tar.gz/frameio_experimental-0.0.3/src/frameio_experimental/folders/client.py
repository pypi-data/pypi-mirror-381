    ...
    def copy(
        ...
        *,
        ...
        Copy folder.
              ...
              This endpoint has been added to `Current Version` of the API.
              <br><br>
              Please see https://developer.adobe.com/frameio/api/current/#tag/Folders/operation/folders.copy.
              <br><br>
        ...
        --------
        from frameio_experimental import FrameioExperimental
        from frameio_experimental.folders import FolderCopyParamsData
