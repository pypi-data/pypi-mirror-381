...
class State:
    def __init__(self, 
                 ...
                 ionize_rule: str = 'default',
                 tautomerize_rule: str = 'default') -> None:
        self.smiles = smiles
        ...
        self.ionize_rule = ionize_rule
        self.tautomerize_rule = tautomerize_rule
    ...
    def make_tautomers(self) -> list[Self]:
        ...
        if self.tautomerize_rule == "comprehensive":
            t = ComprehensiveTautomers(self.smiles).enumerate()
        elif self.tautomerize_rule == "rdkit":
...
class StateNetwork:
    ...
    def build(self, 
        ...
        self.initial_state = State(smiles=smiles,
                              tautomerize_rule=tautomerize_rule,
                              ionize_rule=ionize_rule,
