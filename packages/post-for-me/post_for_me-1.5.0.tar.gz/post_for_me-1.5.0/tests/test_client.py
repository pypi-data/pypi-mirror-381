...
from post_for_me import PostForMe, AsyncPostForMe, APIResponseValidationError
from post_for_me._types import Omit
from post_for_me._utils import asyncify
from post_for_me._models import BaseModel, FinalRequestOptions
from post_for_me._exceptions import APIStatusError, PostForMeError, APITimeoutError, APIResponseValidationError
from post_for_me._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: PostForMe | AsyncPostForMe) -> int:
...
class TestPostForMe:
    client = PostForMe(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "post_for_me/_legacy_response.py",
                        "post_for_me/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "post_for_me/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(PostForMeError):
            with update_env(**{"POST_FOR_ME_API_KEY": Omit()}):
                client2 = PostForMe(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: PostForMe) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = PostForMe(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(POST_FOR_ME_BASE_URL="http://localhost:5000/from/env"):
            client = PostForMe(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            PostForMe(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            PostForMe(
    ...
    def test_base_url_trailing_slash(self, client: PostForMe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: PostForMe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: PostForMe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            PostForMe(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = PostForMe(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = PostForMe(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_omit_retry_count_header(
        self, client: PostForMe, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncPostForMe:
    client = AsyncPostForMe(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(PostForMeError):
            with update_env(**{"POST_FOR_ME_API_KEY": Omit()}):
                client2 = AsyncPostForMe(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncPostForMe) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(POST_FOR_ME_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncPostForMe(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncPostForMe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncPostForMe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncPostForMe) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncPostForMe(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncPostForMe(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncPostForMe, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
