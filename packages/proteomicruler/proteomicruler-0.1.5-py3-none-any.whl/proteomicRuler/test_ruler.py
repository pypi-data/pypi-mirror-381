...
class TestRuler(TestCase):
    def __init__(self, methodName: str = ...) -> None:
        ...
        self.da = pd.read_csv(
            r"C:\Users\Toan Phung\Downloads\raw (20).txt",
            sep="\t")
...
class Test(TestCase):
    def test_add_mw(self):
        df = pd.read_csv(r"\\estorage.dundee.ac.uk\lfs-mrc-data\proteinchem\Fred Lamoliatte\Students\20250922_KadyPatton\20250924_KPatton_MSF_120556\report.pg_matrix.tsv", sep="\t")
        ...
        intensity_columns = [i for i in df.columns if i.startswith("\\")]
        accession_id_col = "Protein.Group"
