...
class CrossServiceComponent(RootModel["Union[FullComponent, DataStoreComponent]"]):
    root: Union[FullComponent, DataStoreComponent] = Field(
        ...,
...
class LineageExportResponse(BaseModel):
    ...
    items: List[FullComponent] = Field(
