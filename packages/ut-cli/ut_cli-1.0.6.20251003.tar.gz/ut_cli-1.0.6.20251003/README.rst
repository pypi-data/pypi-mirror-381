...
#. **Modules**
   ...
   #. **aoeq.py** *Array of Equate Module*
   #  **doeq.py** *Dictionary of Equates Module*
   #. **kwargs.py** *Command Line Module*
...
TheArray of Equates  Module ``aoeq.py`` contains the single static class ``AoEq``.
...
^^^^^^^
  ...
  .. table:: *Methods of class AoEq*
   ...
   |Name   |Description                                    |
   +=======+===============================================+
   |sh_a_eq|Show array of equate source and target elements|
   +-------+-----------------------------------------------+
...
"""""""""
  ...
  ..Parameter-of-Method-sh_a_eq-label:
  .. table:: *Parameter of Method sh_a_eq*

   +----+-----+-----------------------------+
   |Name|Type |Description                  |
   +====+=====+=============================+
   |eq  |TyStr|Equate string (contains '='.)|
   +----+-----+-----------------------------+
...
TheArray of Equates  Module ``doeq.py`` contains the single static class ``DoEq``.

Class: DoEq
-----------

The static Class ``DoEq`` contains no variables and the subsequent methods.
...
^^^^^^^
  ...
  .. table:: *Methods of class AoEq*
   ...
   |Name            |Description                                            |
   +================+=======================================================+
   |_set_sh_prof    |Set array of key 'sh_prof' in dictionary of equates.   |
   +----------------+-------------------------------------------------------+
   |sh_value        |Assign values of dictionary of equates.                |
   +----------------+-------------------------------------------------------+
   |sh_d_valid_parms|Show dictionary of valid parameters.                   |
   +----------------+-------------------------------------------------------+
   |verify          |Verify dictionary of equates with Parameter dictionary.|
   +----------------+-------------------------------------------------------+

internal Method: _set_sh_prof
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
        
Parameter
"""""""""

  ..Parameter-of-Method-_set_sh_prof-label:
  .. table:: *Parameter of Method _set_sh_prof*
...
"""""""""
  ...
  .. table:: *Parameter of Method sh_d_eq*
   ...
   +---------+------+----------------------------+
   |d_eq     |TyDoEq|Dictionary of Equate strings|
   +---------+------+----------------------------+
...
""""""""""""
  ...
  .. table:: *Return Value of Method sh_d_eq*
   ...
   |Name|Type  |Description                |
   +====+======+===========================+
   |d_eq|TyDoEq|Dictionary of valid equates|
   +----+------+---------------------------+

Method: sh_d_valid_parms
^^^^^^^^^^^^^^^^^^^^^^^^
        
Parameter
"""""""""

  ..Parameter-of-Method-sh_d_valid_parms-label:
  .. table:: *Parameter of Method sh_d_valid_parms*
   ...
   |cls    |class |current class           |
   +-------+------+------------------------+
   |d_eq   |TyDoEq|Array of Equate strings |
   +-------+------+------------------------+
...
""""""""""""
  ...
  .. Return-Value-of-Method-sh_d_valid_parms-label:
  .. table:: *Return Value of Method sh_d_valid_parms*

   +----+------+------------------------------+
   |Name|Type  |Description                   |
   +====+======+==============================+
   |d_eq|TyDoEq|Dictionary of valid parameters|
   +----+------+------------------------------+
...
""""""""""""
  ...
  .. Return-Value-of-Method-sh_value-label:
  .. table:: *Return Value of Method sh_value*
...
""""""""""""
  ...
  .. table:: *Return Value of Method verify*
   ...
   |Name|Type  |Description          |
   +====+======+=====================+
   |d_eq|TyDoEq|Dictionary of Equates|
   +----+------+---------------------+
...
The static Class ``KwArgs`` contains no variables and the subsequent method.
...
"""""""""
  ...
  .. table:: *Parameter of Method sh*
   ...
   |cls      |class |current class    |
   +---------+------+-----------------+
   |cls_app  |class |Application class|
   +---------+------+-----------------+
   |cls_parms|class |Parameter class  |
   +---------+------+-----------------+
   |\*args   |TyAny |keyword arguments|
   +---------+------+-----------------+
...
""""""""""""
  ...
  .. table:: *Return Value of Method sh_d_eq*
   ...
   |Name  |Type |Description                    |
   +======+=====+===============================+
   |kwargs|TyDic|Dictionary of keyword arguments|
   +------+-----+-------------------------------+
