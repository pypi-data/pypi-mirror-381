...
class RFDETRTrainer(BaseTrainer):
    ...
    def init(self, training_job):
        ...
        # Calculate train/test split ratios from the training job
        train_ratio = training_job.split_ratio
        val_ratio = (1.0 - train_ratio)
        test_ratio = 0.0
        
        self.logger.info(f"📊 Dataset split configuration: Train={train_ratio:.2f}, Test={test_ratio:.2f}")
