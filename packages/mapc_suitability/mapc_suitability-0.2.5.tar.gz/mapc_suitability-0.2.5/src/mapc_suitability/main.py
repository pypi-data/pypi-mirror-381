...
def get_gdf_from_zipped_link(url, file_type:str, layer_name=None):
    """
...
def if_overlap (layer_1, 
    ...
    if fields:
        ...
        overlap_grouped = overlap_only.groupby(by=id_field).reset_index()
