...
def _real_main(_prog, *argv):
    ...
    parser.add_argument(
        ...
        """)
    parser.add_argument(
        '--fake-separators', default=False, action=argparse.BooleanOptionalAction,
        help="Output separators as bookmarks with name '--------' and a placeholder URL.")
    ...
    with contextlib.ExitStack() as stack:
        ...
        Bookmarks.read(
            ...
            **{k: getattr(args, k) for k in ("fill_special", "fill_ids", "fill_timestamps", "prefix_ids")}
            ...
            fp_out, fmt_out,
            **{k: getattr(args, k) for k in ("cull_special", "cull_attr", "fake_separators")}
        )
    return 0
