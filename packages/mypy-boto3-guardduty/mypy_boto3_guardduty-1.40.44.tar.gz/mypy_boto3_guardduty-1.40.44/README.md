...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-guardduty)](https://pypistats.org/packages/mypy-boto3-guardduty)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 GuardDuty 1.40.44](https://pypi.org/project/boto3/)
...
`mypy-boto3-guardduty` dependency in production. However, there is an issue in
...
list_threat_entity_sets_paginator: ListThreatEntitySetsPaginator = client.get_paginator(
    "list_threat_entity_sets"
)
list_threat_intel_sets_paginator: ListThreatIntelSetsPaginator = client.get_paginator(
    "list_threat_intel_sets"
)
list_trusted_entity_sets_paginator: ListTrustedEntitySetsPaginator = client.get_paginator(
