...
#define NEURON_DATA_DIR "/tmp/tmprknstwym/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmprknstwym/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/opt/python/cp310-cp310/bin/python)"};
