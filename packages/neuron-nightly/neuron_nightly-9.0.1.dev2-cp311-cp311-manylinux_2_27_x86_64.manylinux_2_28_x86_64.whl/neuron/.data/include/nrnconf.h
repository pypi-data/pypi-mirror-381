...
#define NEURON_DATA_DIR "/tmp/tmp5s874_3x/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmp5s874_3x/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/opt/python/cp311-cp311/bin/python)"};
