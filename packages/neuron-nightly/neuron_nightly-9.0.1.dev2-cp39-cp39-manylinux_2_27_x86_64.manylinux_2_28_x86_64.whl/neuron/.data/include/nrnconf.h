...
#define NEURON_DATA_DIR "/tmp/tmpwg10tps8/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpwg10tps8/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/opt/python/cp39-cp39/bin/python)"};
