...
#define NEURON_DATA_DIR "/var/folders/y6/nj790rtn62lfktb1sh__79hc0000gn/T/tmpyohbv6h_/wheel/platlib/share/nrn"

/* host triplet */
#define NRNHOST "arm64-Darwin"
...
#define NRN_LIBDIR "/var/folders/y6/nj790rtn62lfktb1sh__79hc0000gn/T/tmpyohbv6h_/wheel/platlib/lib"

/* Name of package */
#define PACKAGE "nrn"

/* Define to the version of this package. */
#define PACKAGE_VERSION "9.0.0.post2"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/private/var/folders/y6/nj790rtn62lfktb1sh__79hc0000gn/T/build-env-fjancom1/bin/python)"};
   constexpr std::array<std::string_view, 1> supported_python_versions{"3.13"};
#endif
   constexpr std::string_view shared_library_prefix{"lib"};
   constexpr std::string_view shared_library_suffix{".dylib"};
   constexpr std::string_view system_processor{"arm64"};
}
#endif
