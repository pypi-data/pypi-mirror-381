...
#define NEURON_DATA_DIR "/tmp/tmphav8rlde/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmphav8rlde/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/opt/python/cp313-cp313/bin/python)"};
