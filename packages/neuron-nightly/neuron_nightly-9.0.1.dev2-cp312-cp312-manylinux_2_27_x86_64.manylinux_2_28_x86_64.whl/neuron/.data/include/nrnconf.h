...
#define NEURON_DATA_DIR "/tmp/tmpej25dkzo/wheel/platlib/share/nrn"
...
#define NRN_LIBDIR "/tmp/tmpej25dkzo/wheel/platlib/lib"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/opt/python/cp312-cp312/bin/python)"};
