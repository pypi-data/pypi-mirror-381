...
class SesSentEmailBody(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SesSentEmailBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SesSentEmailBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "html_part": obj.get("html_part"),
            "text_part": obj.get("text_part")
        })
        return _obj
