...
class Budget(_message.Message):
    __slots__ = ('name', 'display_name', 'budget_filter', 'amount', 'threshold_rules', 'notifications_rule', 'etag')
    NAME_FIELD_NUMBER: _ClassVar[int]
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    BUDGET_FILTER_FIELD_NUMBER: _ClassVar[int]
    AMOUNT_FIELD_NUMBER: _ClassVar[int]
    THRESHOLD_RULES_FIELD_NUMBER: _ClassVar[int]
    NOTIFICATIONS_RULE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str]=..., display_name: _Optional[str]=..., budget_filter: _Optional[_Union[Filter, _Mapping]]=..., amount: _Optional[_Union[BudgetAmount, _Mapping]]=..., threshold_rules: _Optional[_Iterable[_Union[ThresholdRule, _Mapping]]]=..., notifications_rule: _Optional[_Union[NotificationsRule, _Mapping]]=..., etag: _Optional[str]=...) -> None:
        ...
...
class NotificationsRule(_message.Message):
