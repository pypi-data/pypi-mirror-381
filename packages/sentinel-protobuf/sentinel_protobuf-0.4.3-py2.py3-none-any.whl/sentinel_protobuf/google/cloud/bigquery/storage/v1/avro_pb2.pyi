...
class AvroSerializationOptions(_message.Message):
    __slots__ = ('enable_display_name_attribute',)
    ENABLE_DISPLAY_NAME_ATTRIBUTE_FIELD_NUMBER: _ClassVar[int]
    enable_display_name_attribute: bool

    def __init__(self, enable_display_name_attribute: bool=...) -> None:
        ...