...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/bigquery/migration/v2/migration_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MIGRATIONSERVICE'].methods_by_name['CreateMigrationWorkflow']._serialized_options = b'\xdaA\x19parent,migration_workflow\x82\xd3\xe4\x93\x02C"-/v2/{parent=projects/*/locations/*}/workflows:\x12migration_workflow'
    _globals['_MIGRATIONSERVICE'].methods_by_name['GetMigrationWorkflow']._loaded_options = None
    _globals['_MIGRATIONSERVICE'].methods_by_name['GetMigrationWorkflow']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x02/\x12-/v2/{name=projects/*/locations/*/workflows/*}'
    _globals['_MIGRATIONSERVICE'].methods_by_name['ListMigrationWorkflows']._loaded_options = None
    _globals['_MIGRATIONSERVICE'].methods_by_name['ListMigrationWorkflows']._serialized_options = b'\xdaA\x06parent\x82\xd3\xe4\x93\x02/\x12-/v2/{parent=projects/*/locations/*}/workflows'
    _globals['_MIGRATIONSERVICE'].methods_by_name['DeleteMigrationWorkflow']._loaded_options = None
    _globals['_MIGRATIONSERVICE'].methods_by_name['DeleteMigrationWorkflow']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x02/*-/v2/{name=projects/*/locations/*/workflows/*}'
    _globals['_MIGRATIONSERVICE'].methods_by_name['StartMigrationWorkflow']._loaded_options = None
    _globals['_MIGRATIONSERVICE'].methods_by_name['StartMigrationWorkflow']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x028"3/v2/{name=projects/*/locations/*/workflows/*}:start:\x01*'
    _globals['_MIGRATIONSERVICE'].methods_by_name['GetMigrationSubtask']._loaded_options = None
    _globals['_MIGRATIONSERVICE'].methods_by_name['GetMigrationSubtask']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x02:\x128/v2/{name=projects/*/locations/*/workflows/*/subtasks/*}'
    _globals['_MIGRATIONSERVICE'].methods_by_name['ListMigrationSubtasks']._loaded_options = None
    _globals['_MIGRATIONSERVICE'].methods_by_name['ListMigrationSubtasks']._serialized_options = b'\xdaA\x06parent\x82\xd3\xe4\x93\x02:\x128/v2/{parent=projects/*/locations/*/workflows/*}/subtasks'
    _globals['_CREATEMIGRATIONWORKFLOWREQUEST']._serialized_start = 338
    _globals['_CREATEMIGRATIONWORKFLOWREQUEST']._serialized_end = 517
    _globals['_GETMIGRATIONWORKFLOWREQUEST']._serialized_start = 520
    _globals['_GETMIGRATIONWORKFLOWREQUEST']._serialized_end = 670
    _globals['_LISTMIGRATIONWORKFLOWSREQUEST']._serialized_start = 673
    _globals['_LISTMIGRATIONWORKFLOWSREQUEST']._serialized_end = 849
    _globals['_LISTMIGRATIONWORKFLOWSRESPONSE']._serialized_start = 852
    _globals['_LISTMIGRATIONWORKFLOWSRESPONSE']._serialized_end = 993
    _globals['_DELETEMIGRATIONWORKFLOWREQUEST']._serialized_start = 995
    _globals['_DELETEMIGRATIONWORKFLOWREQUEST']._serialized_end = 1101
    _globals['_STARTMIGRATIONWORKFLOWREQUEST']._serialized_start = 1103
    _globals['_STARTMIGRATIONWORKFLOWREQUEST']._serialized_end = 1208
    _globals['_GETMIGRATIONSUBTASKREQUEST']._serialized_start = 1211
    _globals['_GETMIGRATIONSUBTASKREQUEST']._serialized_end = 1364
    _globals['_LISTMIGRATIONSUBTASKSREQUEST']._serialized_start = 1367
    _globals['_LISTMIGRATIONSUBTASKSREQUEST']._serialized_end = 1595
    _globals['_LISTMIGRATIONSUBTASKSRESPONSE']._serialized_start = 1598
    _globals['_LISTMIGRATIONSUBTASKSRESPONSE']._serialized_end = 1736
    _globals['_MIGRATIONSERVICE']._serialized_start = 1739
    _globals['_MIGRATIONSERVICE']._serialized_end = 3350