...
class UpdateDataPolicyRequest(_message.Message):
    __slots__ = ('data_policy', 'update_mask', 'allow_missing')
    DATA_POLICY_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, data_policy: _Optional[_Union[DataPolicy, _Mapping]]=..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]]=..., allow_missing: bool=...) -> None:
        ...
...
class DataMaskingPolicy(_message.Message):
    ...
    class PredefinedExpression(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        RANDOM_HASH: _ClassVar[DataMaskingPolicy.PredefinedExpression]
    ...
    RANDOM_HASH: DataMaskingPolicy.PredefinedExpression
