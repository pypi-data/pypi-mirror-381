...
class ConnectSettings(_message.Message):
    __slots__ = ('kind', 'server_ca_cert', 'ip_addresses', 'region', 'database_version', 'backend_type', 'psc_enabled', 'dns_name')
    ...
    def __init__(self, kind: _Optional[str]=..., server_ca_cert: _Optional[_Union[_cloud_sql_resources_pb2.SslCert, _Mapping]]=..., ip_addresses: _Optional[_Iterable[_Union[_cloud_sql_resources_pb2.IpMapping, _Mapping]]]=..., region: _Optional[str]=..., database_version: _Optional[_Union[_cloud_sql_resources_pb2.SqlDatabaseVersion, str]]=..., backend_type: _Optional[_Union[_cloud_sql_resources_pb2.SqlBackendType, str]]=..., psc_enabled: bool=..., dns_name: _Optional[str]=...) -> None:
        ...
