...
from google.cloud.discoveryengine.v1 import answer_pb2 as _answer_pb2
from google.cloud.discoveryengine.v1 import conversation_pb2 as _conversation_pb2
from google.cloud.discoveryengine.v1 import safety_pb2 as _safety_pb2
...
class ConverseConversationResponse(_message.Message):
    __slots__ = ('reply', 'conversation', 'search_results')
    ...
    def __init__(self, reply: _Optional[_Union[_conversation_pb2.Reply, _Mapping]]=..., conversation: _Optional[_Union[_conversation_pb2.Conversation, _Mapping]]=..., search_results: _Optional[_Iterable[_Union[_search_service_pb2.SearchResponse.SearchResult, _Mapping]]]=...) -> None:
        ...
...
class AnswerQueryRequest(_message.Message):
    __slots__ = ('serving_config', 'query', 'session', 'safety_spec', 'related_questions_spec', 'grounding_spec', 'answer_generation_spec', 'search_spec', 'query_understanding_spec', 'asynchronous_mode', 'user_pseudo_id', 'user_labels', 'end_user_spec')

    class SafetySpec(_message.Message):
        __slots__ = ('enable', 'safety_settings')
        ...
        class SafetySetting(_message.Message):
            ...
            class HarmBlockThreshold(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                HARM_BLOCK_THRESHOLD_UNSPECIFIED: _ClassVar[AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold]
                BLOCK_LOW_AND_ABOVE: _ClassVar[AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold]
                BLOCK_MEDIUM_AND_ABOVE: _ClassVar[AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold]
                BLOCK_ONLY_HIGH: _ClassVar[AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold]
                BLOCK_NONE: _ClassVar[AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold]
                OFF: _ClassVar[AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold]
            HARM_BLOCK_THRESHOLD_UNSPECIFIED: AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold
            BLOCK_LOW_AND_ABOVE: AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold
            BLOCK_MEDIUM_AND_ABOVE: AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold
            BLOCK_ONLY_HIGH: AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold
            BLOCK_NONE: AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold
            OFF: AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold
            CATEGORY_FIELD_NUMBER: _ClassVar[int]
            THRESHOLD_FIELD_NUMBER: _ClassVar[int]
            category: _safety_pb2.HarmCategory
            threshold: AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold

            def __init__(self, category: _Optional[_Union[_safety_pb2.HarmCategory, str]]=..., threshold: _Optional[_Union[AnswerQueryRequest.SafetySpec.SafetySetting.HarmBlockThreshold, str]]=...) -> None:
                ...
        ENABLE_FIELD_NUMBER: _ClassVar[int]
        SAFETY_SETTINGS_FIELD_NUMBER: _ClassVar[int]
        enable: bool
        safety_settings: _containers.RepeatedCompositeFieldContainer[AnswerQueryRequest.SafetySpec.SafetySetting]

        def __init__(self, enable: bool=..., safety_settings: _Optional[_Iterable[_Union[AnswerQueryRequest.SafetySpec.SafetySetting, _Mapping]]]=...) -> None:
            ...
    ...
    class SearchSpec(_message.Message):
        ...
        class SearchParams(_message.Message):
            __slots__ = ('max_return_results', 'filter', 'boost_spec', 'order_by', 'search_result_mode', 'data_store_specs')
            ...
            def __init__(self, max_return_results: _Optional[int]=..., filter: _Optional[str]=..., boost_spec: _Optional[_Union[_search_service_pb2.SearchRequest.BoostSpec, _Mapping]]=..., order_by: _Optional[str]=..., search_result_mode: _Optional[_Union[_search_service_pb2.SearchRequest.ContentSearchSpec.SearchResultMode, str]]=..., data_store_specs: _Optional[_Iterable[_Union[_search_service_pb2.SearchRequest.DataStoreSpec, _Mapping]]]=...) -> None:
                ...
    ...
    class QueryUnderstandingSpec(_message.Message):
        __slots__ = ('query_classification_spec', 'query_rephraser_spec', 'disable_spell_correction')
        ...
        class QueryClassificationSpec(_message.Message):
            ...
            class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                ...
                USER_DEFINED_CLASSIFICATION_QUERY: _ClassVar[AnswerQueryRequest.QueryUnderstandingSpec.QueryClassificationSpec.Type]
            ...
            USER_DEFINED_CLASSIFICATION_QUERY: AnswerQueryRequest.QueryUnderstandingSpec.QueryClassificationSpec.Type
        ...
        class QueryRephraserSpec(_message.Message):
            __slots__ = ('disable', 'max_rephrase_steps', 'model_spec')
            ...
            class ModelSpec(_message.Message):
                ...
                class ModelType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                    __slots__ = ()
                    MODEL_TYPE_UNSPECIFIED: _ClassVar[AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec.ModelType]
                    SMALL: _ClassVar[AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec.ModelType]
                    LARGE: _ClassVar[AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec.ModelType]
                MODEL_TYPE_UNSPECIFIED: AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec.ModelType
                SMALL: AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec.ModelType
                LARGE: AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec.ModelType
                MODEL_TYPE_FIELD_NUMBER: _ClassVar[int]
                model_type: AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec.ModelType

                def __init__(self, model_type: _Optional[_Union[AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec.ModelType, str]]=...) -> None:
                    ...
            ...
            model_spec: AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec

            def __init__(self, disable: bool=..., max_rephrase_steps: _Optional[int]=..., model_spec: _Optional[_Union[AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec.ModelSpec, _Mapping]]=...) -> None:
                ...
        QUERY_CLASSIFICATION_SPEC_FIELD_NUMBER: _ClassVar[int]
        QUERY_REPHRASER_SPEC_FIELD_NUMBER: _ClassVar[int]
        DISABLE_SPELL_CORRECTION_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, query_classification_spec: _Optional[_Union[AnswerQueryRequest.QueryUnderstandingSpec.QueryClassificationSpec, _Mapping]]=..., query_rephraser_spec: _Optional[_Union[AnswerQueryRequest.QueryUnderstandingSpec.QueryRephraserSpec, _Mapping]]=..., disable_spell_correction: bool=...) -> None:
            ...

    class EndUserSpec(_message.Message):
        __slots__ = ('end_user_metadata',)

        class EndUserMetaData(_message.Message):
            __slots__ = ('chunk_info',)
            ...
            class ChunkInfo(_message.Message):
                ...
                DOCUMENT_METADATA_FIELD_NUMBER: _ClassVar[int]
                content: str
                document_metadata: AnswerQueryRequest.EndUserSpec.EndUserMetaData.ChunkInfo.DocumentMetadata

                def __init__(self, content: _Optional[str]=..., document_metadata: _Optional[_Union[AnswerQueryRequest.EndUserSpec.EndUserMetaData.ChunkInfo.DocumentMetadata, _Mapping]]=...) -> None:
                    ...
            CHUNK_INFO_FIELD_NUMBER: _ClassVar[int]
            chunk_info: AnswerQueryRequest.EndUserSpec.EndUserMetaData.ChunkInfo

            def __init__(self, chunk_info: _Optional[_Union[AnswerQueryRequest.EndUserSpec.EndUserMetaData.ChunkInfo, _Mapping]]=...) -> None:
                ...
        END_USER_METADATA_FIELD_NUMBER: _ClassVar[int]
        end_user_metadata: _containers.RepeatedCompositeFieldContainer[AnswerQueryRequest.EndUserSpec.EndUserMetaData]

        def __init__(self, end_user_metadata: _Optional[_Iterable[_Union[AnswerQueryRequest.EndUserSpec.EndUserMetaData, _Mapping]]]=...) -> None:
            ...
    ...
    USER_LABELS_FIELD_NUMBER: _ClassVar[int]
    END_USER_SPEC_FIELD_NUMBER: _ClassVar[int]
    serving_config: str
