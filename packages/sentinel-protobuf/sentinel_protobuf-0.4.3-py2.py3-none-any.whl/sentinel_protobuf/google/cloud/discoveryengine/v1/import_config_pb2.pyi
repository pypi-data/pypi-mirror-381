...
from google.cloud.discoveryengine.v1 import completion_pb2 as _completion_pb2
from google.cloud.discoveryengine.v1 import document_pb2 as _document_pb2
from google.cloud.discoveryengine.v1 import user_event_pb2 as _user_event_pb2
...
class FhirStoreSource(_message.Message):
    __slots__ = ('fhir_store', 'gcs_staging_dir', 'resource_types', 'update_from_latest_predefined_schema')
    FHIR_STORE_FIELD_NUMBER: _ClassVar[int]
    GCS_STAGING_DIR_FIELD_NUMBER: _ClassVar[int]
    RESOURCE_TYPES_FIELD_NUMBER: _ClassVar[int]
    UPDATE_FROM_LATEST_PREDEFINED_SCHEMA_FIELD_NUMBER: _ClassVar[int]
    fhir_store: str
    gcs_staging_dir: str
    resource_types: _containers.RepeatedScalarFieldContainer[str]
    update_from_latest_predefined_schema: bool

    def __init__(self, fhir_store: _Optional[str]=..., gcs_staging_dir: _Optional[str]=..., resource_types: _Optional[_Iterable[str]]=..., update_from_latest_predefined_schema: bool=...) -> None:
        ...
...
class ImportDocumentsRequest(_message.Message):
    __slots__ = ('inline_source', 'gcs_source', 'bigquery_source', 'fhir_store_source', 'spanner_source', 'cloud_sql_source', 'firestore_source', 'alloy_db_source', 'bigtable_source', 'parent', 'error_config', 'reconciliation_mode', 'update_mask', 'auto_generate_ids', 'id_field', 'force_refresh_content')
    ...
    FORCE_REFRESH_CONTENT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, inline_source: _Optional[_Union[ImportDocumentsRequest.InlineSource, _Mapping]]=..., gcs_source: _Optional[_Union[GcsSource, _Mapping]]=..., bigquery_source: _Optional[_Union[BigQuerySource, _Mapping]]=..., fhir_store_source: _Optional[_Union[FhirStoreSource, _Mapping]]=..., spanner_source: _Optional[_Union[SpannerSource, _Mapping]]=..., cloud_sql_source: _Optional[_Union[CloudSqlSource, _Mapping]]=..., firestore_source: _Optional[_Union[FirestoreSource, _Mapping]]=..., alloy_db_source: _Optional[_Union[AlloyDbSource, _Mapping]]=..., bigtable_source: _Optional[_Union[BigtableSource, _Mapping]]=..., parent: _Optional[str]=..., error_config: _Optional[_Union[ImportErrorConfig, _Mapping]]=..., reconciliation_mode: _Optional[_Union[ImportDocumentsRequest.ReconciliationMode, str]]=..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]]=..., auto_generate_ids: bool=..., id_field: _Optional[str]=..., force_refresh_content: bool=...) -> None:
        ...
