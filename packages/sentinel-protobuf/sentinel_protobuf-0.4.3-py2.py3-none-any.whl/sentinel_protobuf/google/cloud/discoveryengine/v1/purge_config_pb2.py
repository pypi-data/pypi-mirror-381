...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/discoveryengine/v1/purge_config.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PURGEUSEREVENTSREQUEST']._serialized_start = 258
    _globals['_PURGEUSEREVENTSREQUEST']._serialized_end = 384
    _globals['_PURGEUSEREVENTSRESPONSE']._serialized_start = 386
    _globals['_PURGEUSEREVENTSRESPONSE']._serialized_end = 432
    _globals['_PURGEUSEREVENTSMETADATA']._serialized_start = 435
    _globals['_PURGEUSEREVENTSMETADATA']._serialized_end = 604
    _globals['_PURGEERRORCONFIG']._serialized_start = 606
    _globals['_PURGEERRORCONFIG']._serialized_end = 661
    _globals['_PURGEDOCUMENTSREQUEST']._serialized_start = 664
    _globals['_PURGEDOCUMENTSREQUEST']._serialized_end = 1113
    _globals['_PURGEDOCUMENTSREQUEST_INLINESOURCE']._serialized_start = 1021
    _globals['_PURGEDOCUMENTSREQUEST_INLINESOURCE']._serialized_end = 1103
    _globals['_PURGEDOCUMENTSRESPONSE']._serialized_start = 1115
    _globals['_PURGEDOCUMENTSRESPONSE']._serialized_end = 1228
    _globals['_PURGEDOCUMENTSMETADATA']._serialized_start = 1231
    _globals['_PURGEDOCUMENTSMETADATA']._serialized_end = 1422
    _globals['_PURGESUGGESTIONDENYLISTENTRIESREQUEST']._serialized_start = 1424
    _globals['_PURGESUGGESTIONDENYLISTENTRIESREQUEST']._serialized_end = 1529
    _globals['_PURGESUGGESTIONDENYLISTENTRIESRESPONSE']._serialized_start = 1531
    _globals['_PURGESUGGESTIONDENYLISTENTRIESRESPONSE']._serialized_end = 1635
    _globals['_PURGESUGGESTIONDENYLISTENTRIESMETADATA']._serialized_start = 1638
    _globals['_PURGESUGGESTIONDENYLISTENTRIESMETADATA']._serialized_end = 1776
    _globals['_PURGECOMPLETIONSUGGESTIONSREQUEST']._serialized_start = 1778
    _globals['_PURGECOMPLETIONSUGGESTIONSREQUEST']._serialized_end = 1879
    _globals['_PURGECOMPLETIONSUGGESTIONSRESPONSE']._serialized_start = 1881
    _globals['_PURGECOMPLETIONSUGGESTIONSRESPONSE']._serialized_end = 1985
    _globals['_PURGECOMPLETIONSUGGESTIONSMETADATA']._serialized_start = 1988
    _globals['_PURGECOMPLETIONSUGGESTIONSMETADATA']._serialized_end = 2122