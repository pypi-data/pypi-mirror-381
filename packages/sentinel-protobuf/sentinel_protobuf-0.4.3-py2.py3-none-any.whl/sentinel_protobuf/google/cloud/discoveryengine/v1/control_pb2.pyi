...
class Control(_message.Message):
    __slots__ = ('boost_action', 'filter_action', 'redirect_action', 'synonyms_action', 'promote_action', 'name', 'display_name', 'associated_serving_config_ids', 'solution_type', 'use_cases', 'conditions')

    class BoostAction(_message.Message):
        __slots__ = ('fixed_boost', 'interpolation_boost_spec', 'boost', 'filter', 'data_store')

        class InterpolationBoostSpec(_message.Message):
            ...
            class AttributeType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                ATTRIBUTE_TYPE_UNSPECIFIED: _ClassVar[Control.BoostAction.InterpolationBoostSpec.AttributeType]
                NUMERICAL: _ClassVar[Control.BoostAction.InterpolationBoostSpec.AttributeType]
                FRESHNESS: _ClassVar[Control.BoostAction.InterpolationBoostSpec.AttributeType]
            ATTRIBUTE_TYPE_UNSPECIFIED: Control.BoostAction.InterpolationBoostSpec.AttributeType
            NUMERICAL: Control.BoostAction.InterpolationBoostSpec.AttributeType
            FRESHNESS: Control.BoostAction.InterpolationBoostSpec.AttributeType

            class InterpolationType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                INTERPOLATION_TYPE_UNSPECIFIED: _ClassVar[Control.BoostAction.InterpolationBoostSpec.InterpolationType]
                LINEAR: _ClassVar[Control.BoostAction.InterpolationBoostSpec.InterpolationType]
            INTERPOLATION_TYPE_UNSPECIFIED: Control.BoostAction.InterpolationBoostSpec.InterpolationType
            LINEAR: Control.BoostAction.InterpolationBoostSpec.InterpolationType
            ...
            field_name: str
            attribute_type: Control.BoostAction.InterpolationBoostSpec.AttributeType
            interpolation_type: Control.BoostAction.InterpolationBoostSpec.InterpolationType
            control_points: _containers.RepeatedCompositeFieldContainer[Control.BoostAction.InterpolationBoostSpec.ControlPoint]

            def __init__(self, field_name: _Optional[str]=..., attribute_type: _Optional[_Union[Control.BoostAction.InterpolationBoostSpec.AttributeType, str]]=..., interpolation_type: _Optional[_Union[Control.BoostAction.InterpolationBoostSpec.InterpolationType, str]]=..., control_points: _Optional[_Iterable[_Union[Control.BoostAction.InterpolationBoostSpec.ControlPoint, _Mapping]]]=...) -> None:
                ...
        FIXED_BOOST_FIELD_NUMBER: _ClassVar[int]
        INTERPOLATION_BOOST_SPEC_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, fixed_boost: _Optional[float]=..., interpolation_boost_spec: _Optional[_Union[Control.BoostAction.InterpolationBoostSpec, _Mapping]]=..., boost: _Optional[float]=..., filter: _Optional[str]=..., data_store: _Optional[str]=...) -> None:
            ...
    ...
    class PromoteAction(_message.Message):
        __slots__ = ('data_store', 'search_link_promotion')
        DATA_STORE_FIELD_NUMBER: _ClassVar[int]
        SEARCH_LINK_PROMOTION_FIELD_NUMBER: _ClassVar[int]
        data_store: str
        search_link_promotion: _common_pb2.SearchLinkPromotion

        def __init__(self, data_store: _Optional[str]=..., search_link_promotion: _Optional[_Union[_common_pb2.SearchLinkPromotion, _Mapping]]=...) -> None:
            ...
    ...
    PROMOTE_ACTION_FIELD_NUMBER: _ClassVar[int]
    ...
    promote_action: Control.PromoteAction
    name: str
    display_name: str
