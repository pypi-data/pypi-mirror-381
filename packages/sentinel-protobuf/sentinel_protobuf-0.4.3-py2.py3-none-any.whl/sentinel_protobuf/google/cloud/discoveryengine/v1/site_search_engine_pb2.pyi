...
class TargetSite(_message.Message):
    ...
    class IndexingStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        CANCELLABLE: _ClassVar[TargetSite.IndexingStatus]
        CANCELLED: _ClassVar[TargetSite.IndexingStatus]
    ...
    CANCELLABLE: TargetSite.IndexingStatus
    CANCELLED: TargetSite.IndexingStatus
...
class Sitemap(_message.Message):
    __slots__ = ('uri', 'name', 'create_time')
    ...
    def __init__(self, uri: _Optional[str]=..., name: _Optional[str]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...