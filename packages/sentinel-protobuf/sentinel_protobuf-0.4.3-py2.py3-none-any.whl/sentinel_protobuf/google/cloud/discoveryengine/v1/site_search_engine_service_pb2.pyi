...
from google.cloud.discoveryengine.v1 import site_search_engine_pb2 as _site_search_engine_pb2
...
class RecrawlUrisMetadata(_message.Message):
    __slots__ = ('create_time', 'update_time', 'invalid_uris', 'invalid_uris_count', 'noindex_uris', 'noindex_uris_count', 'uris_not_matching_target_sites', 'uris_not_matching_target_sites_count', 'valid_uris_count', 'success_count', 'pending_count', 'quota_exceeded_count')
    CREATE_TIME_FIELD_NUMBER: _ClassVar[int]
    UPDATE_TIME_FIELD_NUMBER: _ClassVar[int]
    INVALID_URIS_FIELD_NUMBER: _ClassVar[int]
    INVALID_URIS_COUNT_FIELD_NUMBER: _ClassVar[int]
    NOINDEX_URIS_FIELD_NUMBER: _ClassVar[int]
    NOINDEX_URIS_COUNT_FIELD_NUMBER: _ClassVar[int]
    ...
    noindex_uris: _containers.RepeatedScalarFieldContainer[str]
    ...
    def __init__(self, create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., invalid_uris: _Optional[_Iterable[str]]=..., invalid_uris_count: _Optional[int]=..., noindex_uris: _Optional[_Iterable[str]]=..., noindex_uris_count: _Optional[int]=..., uris_not_matching_target_sites: _Optional[_Iterable[str]]=..., uris_not_matching_target_sites_count: _Optional[int]=..., valid_uris_count: _Optional[int]=..., success_count: _Optional[int]=..., pending_count: _Optional[int]=..., quota_exceeded_count: _Optional[int]=...) -> None:
        ...
