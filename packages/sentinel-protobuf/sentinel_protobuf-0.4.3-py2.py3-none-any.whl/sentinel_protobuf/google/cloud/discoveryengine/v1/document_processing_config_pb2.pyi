...
class DocumentProcessingConfig(_message.Message):
    ...
    class ParsingConfig(_message.Message):
        ...
        class LayoutParsingConfig(_message.Message):
            __slots__ = ('enable_table_annotation', 'enable_image_annotation', 'structured_content_types', 'exclude_html_elements', 'exclude_html_classes', 'exclude_html_ids')
            ENABLE_TABLE_ANNOTATION_FIELD_NUMBER: _ClassVar[int]
            ENABLE_IMAGE_ANNOTATION_FIELD_NUMBER: _ClassVar[int]
            STRUCTURED_CONTENT_TYPES_FIELD_NUMBER: _ClassVar[int]
            EXCLUDE_HTML_ELEMENTS_FIELD_NUMBER: _ClassVar[int]
            EXCLUDE_HTML_CLASSES_FIELD_NUMBER: _ClassVar[int]
            EXCLUDE_HTML_IDS_FIELD_NUMBER: _ClassVar[int]
            enable_table_annotation: bool
            enable_image_annotation: bool
            structured_content_types: _containers.RepeatedScalarFieldContainer[str]
            exclude_html_elements: _containers.RepeatedScalarFieldContainer[str]
            exclude_html_classes: _containers.RepeatedScalarFieldContainer[str]
            exclude_html_ids: _containers.RepeatedScalarFieldContainer[str]

            def __init__(self, enable_table_annotation: bool=..., enable_image_annotation: bool=..., structured_content_types: _Optional[_Iterable[str]]=..., exclude_html_elements: _Optional[_Iterable[str]]=..., exclude_html_classes: _Optional[_Iterable[str]]=..., exclude_html_ids: _Optional[_Iterable[str]]=...) -> None:
                ...
