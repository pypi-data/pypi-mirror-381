...
from google.cloud.discoveryengine.v1beta import chunk_pb2 as _chunk_pb2
...
class SearchRequest(_message.Message):
    __slots__ = ('serving_config', 'branch', 'query', 'image_query', 'page_size', 'page_token', 'offset', 'one_box_page_size', 'data_store_specs', 'filter', 'canonical_filter', 'order_by', 'user_info', 'language_code', 'region_code', 'facet_specs', 'boost_spec', 'params', 'query_expansion_spec', 'spell_correction_spec', 'user_pseudo_id', 'content_search_spec', 'embedding_spec', 'ranking_expression', 'ranking_expression_backend', 'safe_search', 'user_labels', 'natural_language_query_understanding_spec', 'search_as_you_type_spec', 'session', 'session_spec', 'relevance_threshold', 'personalization_spec')
...
class SearchResponse(_message.Message):
    ...
    class OneBoxResult(_message.Message):
        ...
        class OneBoxType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            KNOWLEDGE_GRAPH: _ClassVar[SearchResponse.OneBoxResult.OneBoxType]
        ...
        KNOWLEDGE_GRAPH: SearchResponse.OneBoxResult.OneBoxType
