...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SITESEARCHENGINE']._serialized_start = 195
    _globals['_SITESEARCHENGINE']._serialized_end = 472
    _globals['_TARGETSITE']._serialized_start = 475
    _globals['_TARGETSITE']._serialized_end = 1669
    _globals['_TARGETSITE_FAILUREREASON']._serialized_start = 1043
    _globals['_TARGETSITE_FAILUREREASON']._serialized_end = 1216
    _globals['_TARGETSITE_FAILUREREASON_QUOTAFAILURE']._serialized_start = 1161
    _globals['_TARGETSITE_FAILUREREASON_QUOTAFAILURE']._serialized_end = 1205
    _globals['_TARGETSITE_TYPE']._serialized_start = 1218
    _globals['_TARGETSITE_TYPE']._serialized_end = 1272
    _globals['_TARGETSITE_INDEXINGSTATUS']._serialized_start = 1274
    _globals['_TARGETSITE_INDEXINGSTATUS']._serialized_end = 1377
    _globals['_SITEVERIFICATIONINFO']._serialized_start = 1672
    _globals['_SITEVERIFICATIONINFO']._serialized_end = 1967
    _globals['_SITEVERIFICATIONINFO_SITEVERIFICATIONSTATE']._serialized_start = 1859
    _globals['_SITEVERIFICATIONINFO_SITEVERIFICATIONSTATE']._serialized_end = 1967
    _globals['_SITEMAP']._serialized_start = 1970
    _globals['_SITEMAP']._serialized_end = 2349