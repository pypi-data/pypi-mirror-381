...
class Document(_message.Message):
    __slots__ = ('struct_data', 'json_data', 'name', 'id', 'schema_id', 'content', 'parent_document_id', 'derived_struct_data', 'index_time', 'index_status')
