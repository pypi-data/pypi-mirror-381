...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SUGGESTIONDENYLISTENTRY']._serialized_start = 129
    _globals['_SUGGESTIONDENYLISTENTRY']._serialized_end = 367
    _globals['_SUGGESTIONDENYLISTENTRY_MATCHOPERATOR']._serialized_start = 289
    _globals['_SUGGESTIONDENYLISTENTRY_MATCHOPERATOR']._serialized_end = 367
    _globals['_COMPLETIONSUGGESTION']._serialized_start = 370
    _globals['_COMPLETIONSUGGESTION']._serialized_end = 569