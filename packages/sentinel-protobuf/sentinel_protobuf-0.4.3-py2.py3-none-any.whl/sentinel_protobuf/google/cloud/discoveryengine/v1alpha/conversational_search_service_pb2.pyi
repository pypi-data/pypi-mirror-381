...
from google.cloud.discoveryengine.v1alpha import conversation_pb2 as _conversation_pb2
from google.cloud.discoveryengine.v1alpha import search_service_pb2 as _search_service_pb2
from google.cloud.discoveryengine.v1alpha import session_pb2 as _session_pb2
...
class AnswerQueryRequest(_message.Message):
    __slots__ = ('serving_config', 'query', 'session', 'safety_spec', 'related_questions_spec', 'answer_generation_spec', 'search_spec', 'query_understanding_spec', 'asynchronous_mode', 'user_pseudo_id', 'user_labels')
    ...
    class AnswerGenerationSpec(_message.Message):
        __slots__ = ('model_spec', 'prompt_spec', 'include_citations', 'answer_language_code', 'ignore_adversarial_query', 'ignore_non_answer_seeking_query', 'ignore_low_relevant_content')
    ...
    class SearchSpec(_message.Message):
        ...
        class SearchParams(_message.Message):
            __slots__ = ('max_return_results', 'filter', 'boost_spec', 'order_by', 'search_result_mode', 'custom_fine_tuning_spec', 'data_store_specs')
            ...
            def __init__(self, max_return_results: _Optional[int]=..., filter: _Optional[str]=..., boost_spec: _Optional[_Union[_search_service_pb2.SearchRequest.BoostSpec, _Mapping]]=..., order_by: _Optional[str]=..., search_result_mode: _Optional[_Union[_search_service_pb2.SearchRequest.ContentSearchSpec.SearchResultMode, str]]=..., custom_fine_tuning_spec: _Optional[_Union[_common_pb2.CustomFineTuningSpec, _Mapping]]=..., data_store_specs: _Optional[_Iterable[_Union[_search_service_pb2.SearchRequest.DataStoreSpec, _Mapping]]]=...) -> None:
                ...
        ...
        class SearchResultList(_message.Message):
            ...
            class SearchResult(_message.Message):
                ...
                class ChunkInfo(_message.Message):
                    __slots__ = ('chunk', 'content')
                    CHUNK_FIELD_NUMBER: _ClassVar[int]
                    CONTENT_FIELD_NUMBER: _ClassVar[int]
                    chunk: str
                    content: str

                    def __init__(self, chunk: _Optional[str]=..., content: _Optional[str]=...) -> None:
                        ...
