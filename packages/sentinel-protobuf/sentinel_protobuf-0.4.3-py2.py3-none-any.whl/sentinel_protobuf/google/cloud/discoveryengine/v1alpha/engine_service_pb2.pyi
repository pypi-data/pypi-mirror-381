...
from google.cloud.discoveryengine.v1alpha import engine_pb2 as _engine_pb2
...
class PauseEngineRequest(_message.Message):
    __slots__ = ('name',)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class ResumeEngineRequest(_message.Message):
    __slots__ = ('name',)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class TuneEngineRequest(_message.Message):
    __slots__ = ('name',)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class TuneEngineMetadata(_message.Message):
    __slots__ = ('engine',)
    ENGINE_FIELD_NUMBER: _ClassVar[int]
    engine: str
...
class TuneEngineResponse(_message.Message):
    __slots__ = ()
