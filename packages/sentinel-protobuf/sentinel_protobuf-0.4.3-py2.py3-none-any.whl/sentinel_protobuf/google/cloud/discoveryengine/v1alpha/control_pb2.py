...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/discoveryengine/v1alpha/control.proto')
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n2google/cloud/discoveryengine/v1alpha/control.proto\x12$google.cloud.discoveryengine.v1alpha\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a1google/cloud/discoveryengine/v1alpha/common.proto\x1a\x1fgoogle/protobuf/timestamp.proto"\xcc\x02\n\tCondition\x12N\n\x0bquery_terms\x18\x02 \x03(\x0b29.google.cloud.discoveryengine.v1alpha.Condition.QueryTerm\x12T\n\x11active_time_range\x18\x03 \x03(\x0b29.google.cloud.discoveryengine.v1alpha.Condition.TimeRange\x1a.\n\tQueryTerm\x12\r\n\x05value\x18\x01 \x01(\t\x12\x12\n\nfull_match\x18\x02 \x01(\x08\x1ai\n\tTimeRange\x12.\n\nstart_time\x18\x01 \x01(\x0b2\x1a.google.protobuf.Timestamp\x12,\n\x08end_time\x18\x02 \x01(\x0b2\x1a.google.protobuf.Timestamp"\xb7\n\n\x07Control\x12Q\n\x0cboost_action\x18\x06 \x01(\x0b29.google.cloud.discoveryengine.v1alpha.Control.BoostActionH\x00\x12S\n\rfilter_action\x18\x07 \x01(\x0b2:.google.cloud.discoveryengine.v1alpha.Control.FilterActionH\x00\x12W\n\x0fredirect_action\x18\t \x01(\x0b2<.google.cloud.discoveryengine.v1alpha.Control.RedirectActionH\x00\x12W\n\x0fsynonyms_action\x18\n \x01(\x0b2<.google.cloud.discoveryengine.v1alpha.Control.SynonymsActionH\x00\x12\x11\n\x04name\x18\x01 \x01(\tB\x03\xe0A\x05\x12\x19\n\x0cdisplay_name\x18\x02 \x01(\tB\x03\xe0A\x02\x12*\n\x1dassociated_serving_config_ids\x18\x03 \x03(\tB\x03\xe0A\x03\x12Q\n\rsolution_type\x18\x04 \x01(\x0e22.google.cloud.discoveryengine.v1alpha.SolutionTypeB\x06\xe0A\x02\xe0A\x05\x12F\n\tuse_cases\x18\x08 \x03(\x0e23.google.cloud.discoveryengine.v1alpha.SearchUseCase\x12C\n\nconditions\x18\x05 \x03(\x0b2/.google.cloud.discoveryengine.v1alpha.Condition\x1a|\n\x0bBoostAction\x12\x12\n\x05boost\x18\x01 \x01(\x02B\x03\xe0A\x02\x12\x13\n\x06filter\x18\x02 \x01(\tB\x03\xe0A\x02\x12D\n\ndata_store\x18\x03 \x01(\tB0\xe0A\x02\xfaA*\n(discoveryengine.googleapis.com/DataStore\x1ai\n\x0cFilterAction\x12\x13\n\x06filter\x18\x01 \x01(\tB\x03\xe0A\x02\x12D\n\ndata_store\x18\x02 \x01(\tB0\xe0A\x02\xfaA*\n(discoveryengine.googleapis.com/DataStore\x1a+\n\x0eRedirectAction\x12\x19\n\x0credirect_uri\x18\x01 \x01(\tB\x03\xe0A\x02\x1a"\n\x0eSynonymsAction\x12\x10\n\x08synonyms\x18\x01 \x03(\t:\xd3\x02\xeaA\xcf\x02\n&discoveryengine.googleapis.com/Control\x12Rprojects/{project}/locations/{location}/dataStores/{data_store}/controls/{control}\x12kprojects/{project}/locations/{location}/collections/{collection}/dataStores/{data_store}/controls/{control}\x12dprojects/{project}/locations/{location}/collections/{collection}/engines/{engine}/controls/{control}B\x08\n\x06actionB\x98\x02\n(com.google.cloud.discoveryengine.v1alphaB\x0cControlProtoP\x01ZRcloud.google.com/go/discoveryengine/apiv1alpha/discoveryenginepb;discoveryenginepb\xa2\x02\x0fDISCOVERYENGINE\xaa\x02$Google.Cloud.DiscoveryEngine.V1Alpha\xca\x02$Google\\Cloud\\DiscoveryEngine\\V1alpha\xea\x02\'Google::Cloud::DiscoveryEngine::V1alphab\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.cloud.discoveryengine.v1alpha.control_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONDITION']._serialized_start = 237
    _globals['_CONDITION']._serialized_end = 569
    _globals['_CONDITION_QUERYTERM']._serialized_start = 416
    _globals['_CONDITION_QUERYTERM']._serialized_end = 462
    _globals['_CONDITION_TIMERANGE']._serialized_start = 464
    _globals['_CONDITION_TIMERANGE']._serialized_end = 569
    _globals['_CONTROL']._serialized_start = 572
    _globals['_CONTROL']._serialized_end = 1907
    _globals['_CONTROL_BOOSTACTION']._serialized_start = 1243
    _globals['_CONTROL_BOOSTACTION']._serialized_end = 1367
    _globals['_CONTROL_FILTERACTION']._serialized_start = 1369
    _globals['_CONTROL_FILTERACTION']._serialized_end = 1474
    _globals['_CONTROL_REDIRECTACTION']._serialized_start = 1476
    _globals['_CONTROL_REDIRECTACTION']._serialized_end = 1519
    _globals['_CONTROL_SYNONYMSACTION']._serialized_start = 1521
    _globals['_CONTROL_SYNONYMSACTION']._serialized_end = 1555