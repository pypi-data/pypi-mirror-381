...
class CompleteQueryRequest(_message.Message):
    __slots__ = ('tenant', 'query', 'language_codes', 'page_size', 'company', 'scope', 'type')
    ...
    def __init__(self, tenant: _Optional[str]=..., query: _Optional[str]=..., language_codes: _Optional[_Iterable[str]]=..., page_size: _Optional[int]=..., company: _Optional[str]=..., scope: _Optional[_Union[CompleteQueryRequest.CompletionScope, str]]=..., type: _Optional[_Union[CompleteQueryRequest.CompletionType, str]]=...) -> None:
        ...
