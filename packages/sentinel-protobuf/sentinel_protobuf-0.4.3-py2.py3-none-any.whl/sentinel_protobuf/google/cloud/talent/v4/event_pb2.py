...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CLIENTEVENT']._serialized_start = 129
    _globals['_CLIENTEVENT']._serialized_end = 324
    _globals['_JOBEVENT']._serialized_start = 327
    _globals['_JOBEVENT']._serialized_end = 807
    _globals['_JOBEVENT_JOBEVENTTYPE']._serialized_start = 425
    _globals['_JOBEVENT_JOBEVENTTYPE']._serialized_end = 807