...
from google.cloud.talent.v4 import filters_pb2 as _filters_pb2
from google.cloud.talent.v4 import histogram_pb2 as _histogram_pb2
from google.cloud.talent.v4 import job_pb2 as _job_pb2
...
class SearchJobsRequest(_message.Message):
    __slots__ = ('parent', 'search_mode', 'request_metadata', 'job_query', 'enable_broadening', 'histogram_queries', 'job_view', 'offset', 'max_page_size', 'page_token', 'order_by', 'diversification_level', 'custom_ranking_info', 'disable_keyword_match', 'keyword_match_mode', 'relevance_threshold')
    ...
    class DiversificationLevel(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        ONE_PER_COMPANY: _ClassVar[SearchJobsRequest.DiversificationLevel]
        TWO_PER_COMPANY: _ClassVar[SearchJobsRequest.DiversificationLevel]
        MAX_THREE_PER_COMPANY: _ClassVar[SearchJobsRequest.DiversificationLevel]
        DIVERSIFY_BY_LOOSER_SIMILARITY: _ClassVar[SearchJobsRequest.DiversificationLevel]
    ...
    ONE_PER_COMPANY: SearchJobsRequest.DiversificationLevel
    TWO_PER_COMPANY: SearchJobsRequest.DiversificationLevel
    MAX_THREE_PER_COMPANY: SearchJobsRequest.DiversificationLevel
    DIVERSIFY_BY_LOOSER_SIMILARITY: SearchJobsRequest.DiversificationLevel
...
class BatchCreateJobsResponse(_message.Message):
    __slots__ = ('job_results',)
    JOB_RESULTS_FIELD_NUMBER: _ClassVar[int]
    job_results: _containers.RepeatedCompositeFieldContainer[JobResult]

    def __init__(self, job_results: _Optional[_Iterable[_Union[JobResult, _Mapping]]]=...) -> None:
        ...

class BatchUpdateJobsResponse(_message.Message):
    __slots__ = ('job_results',)
    JOB_RESULTS_FIELD_NUMBER: _ClassVar[int]
    job_results: _containers.RepeatedCompositeFieldContainer[JobResult]
...
class BatchDeleteJobsResponse(_message.Message):
    __slots__ = ('job_results',)
    JOB_RESULTS_FIELD_NUMBER: _ClassVar[int]
    job_results: _containers.RepeatedCompositeFieldContainer[JobResult]
