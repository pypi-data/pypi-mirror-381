...
class MuteConfig(_message.Message):
    __slots__ = ('name', 'display_name', 'description', 'filter', 'create_time', 'update_time', 'most_recent_editor', 'type', 'expiry_time')
