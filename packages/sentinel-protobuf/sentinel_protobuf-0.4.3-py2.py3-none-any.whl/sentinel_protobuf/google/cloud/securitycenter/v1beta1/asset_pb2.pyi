...
class Asset(_message.Message):
    __slots__ = ('name', 'security_center_properties', 'resource_properties', 'security_marks', 'create_time', 'update_time')

    class SecurityCenterProperties(_message.Message):
        __slots__ = ('resource_name', 'resource_type', 'resource_parent', 'resource_project', 'resource_owners')
        ...
        def __init__(self, resource_name: _Optional[str]=..., resource_type: _Optional[str]=..., resource_parent: _Optional[str]=..., resource_project: _Optional[str]=..., resource_owners: _Optional[_Iterable[str]]=...) -> None:
            ...
