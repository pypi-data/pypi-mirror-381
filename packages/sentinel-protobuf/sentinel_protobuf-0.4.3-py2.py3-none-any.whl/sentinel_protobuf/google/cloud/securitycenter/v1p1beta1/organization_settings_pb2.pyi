...
class OrganizationSettings(_message.Message):
    ...
    class AssetDiscoveryConfig(_message.Message):
        __slots__ = ('project_ids', 'inclusion_mode', 'folder_ids')
        ...
        def __init__(self, project_ids: _Optional[_Iterable[str]]=..., inclusion_mode: _Optional[_Union[OrganizationSettings.AssetDiscoveryConfig.InclusionMode, str]]=..., folder_ids: _Optional[_Iterable[str]]=...) -> None:
            ...
