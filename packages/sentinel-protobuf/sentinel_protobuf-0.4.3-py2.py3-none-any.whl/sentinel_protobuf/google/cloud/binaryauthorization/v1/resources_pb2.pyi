...
class Attestor(_message.Message):
    __slots__ = ('name', 'description', 'user_owned_grafeas_note', 'update_time')
    NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    USER_OWNED_GRAFEAS_NOTE_FIELD_NUMBER: _ClassVar[int]
    UPDATE_TIME_FIELD_NUMBER: _ClassVar[int]
    name: str
    description: str
    ...
    def __init__(self, name: _Optional[str]=..., description: _Optional[str]=..., user_owned_grafeas_note: _Optional[_Union[UserOwnedGrafeasNote, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...

class UserOwnedGrafeasNote(_message.Message):
