...
from google.cloud.datacatalog.v1 import policytagmanager_pb2 as _policytagmanager_pb2
...
class ReplaceTaxonomyRequest(_message.Message):
    __slots__ = ('name', 'serialized_taxonomy')
    NAME_FIELD_NUMBER: _ClassVar[int]
    SERIALIZED_TAXONOMY_FIELD_NUMBER: _ClassVar[int]
    name: str
    serialized_taxonomy: SerializedTaxonomy

    def __init__(self, name: _Optional[str]=..., serialized_taxonomy: _Optional[_Union[SerializedTaxonomy, _Mapping]]=...) -> None:
        ...

class ImportTaxonomiesRequest(_message.Message):
    __slots__ = ('parent', 'inline_source', 'cross_regional_source')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    INLINE_SOURCE_FIELD_NUMBER: _ClassVar[int]
    CROSS_REGIONAL_SOURCE_FIELD_NUMBER: _ClassVar[int]
    parent: str
    inline_source: InlineSource
    cross_regional_source: CrossRegionalSource

    def __init__(self, parent: _Optional[str]=..., inline_source: _Optional[_Union[InlineSource, _Mapping]]=..., cross_regional_source: _Optional[_Union[CrossRegionalSource, _Mapping]]=...) -> None:
        ...
...
class CrossRegionalSource(_message.Message):
    __slots__ = ('taxonomy',)
    TAXONOMY_FIELD_NUMBER: _ClassVar[int]
    taxonomy: str

    def __init__(self, taxonomy: _Optional[str]=...) -> None:
        ...
