...
class Tag(_message.Message):
    __slots__ = ('name', 'template', 'template_display_name', 'column', 'fields')
    ...
    def __init__(self, name: _Optional[str]=..., template: _Optional[str]=..., template_display_name: _Optional[str]=..., column: _Optional[str]=..., fields: _Optional[_Mapping[str, TagField]]=...) -> None:
        ...

class TagField(_message.Message):
    __slots__ = ('display_name', 'double_value', 'string_value', 'bool_value', 'timestamp_value', 'enum_value', 'order')
    ...
    def __init__(self, display_name: _Optional[str]=..., double_value: _Optional[float]=..., string_value: _Optional[str]=..., bool_value: bool=..., timestamp_value: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., enum_value: _Optional[_Union[TagField.EnumValue, _Mapping]]=..., order: _Optional[int]=...) -> None:
        ...

class TagTemplate(_message.Message):
    __slots__ = ('name', 'display_name', 'fields', 'dataplex_transfer_status')
    ...
    def __init__(self, name: _Optional[str]=..., display_name: _Optional[str]=..., fields: _Optional[_Mapping[str, TagTemplateField]]=..., dataplex_transfer_status: _Optional[_Union[TagTemplate.DataplexTransferStatus, str]]=...) -> None:
        ...
