...
class ProductLine(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    PRODUCT_LINE_UNSPECIFIED: _ClassVar[ProductLine]
    GOOGLE_CLOUD: _ClassVar[ProductLine]
    GOOGLE_MAPS: _ClassVar[ProductLine]
PRODUCT_LINE_UNSPECIFIED: ProductLine
GOOGLE_CLOUD: ProductLine
GOOGLE_MAPS: ProductLine
...
class CaseClassification(_message.Message):
    __slots__ = ('id', 'display_name', 'product')
    ...
    def __init__(self, id: _Optional[str]=..., display_name: _Optional[str]=..., product: _Optional[_Union[Product, _Mapping]]=...) -> None:
        ...

class Product(_message.Message):
    __slots__ = ('product_line',)
    PRODUCT_LINE_FIELD_NUMBER: _ClassVar[int]
    product_line: ProductLine

    def __init__(self, product_line: _Optional[_Union[ProductLine, str]]=...) -> None:
        ...