...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/support/v2beta/case.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PRODUCTLINE']._serialized_start = 1280
    _globals['_PRODUCTLINE']._serialized_end = 1358
    _globals['_CASE']._serialized_start = 206
    _globals['_CASE']._serialized_end = 1092
    _globals['_CASE_STATE']._serialized_start = 772
    _globals['_CASE_STATE']._serialized_end = 899
    _globals['_CASE_PRIORITY']._serialized_start = 901
    _globals['_CASE_PRIORITY']._serialized_end = 977
    _globals['_CASECLASSIFICATION']._serialized_start = 1094
    _globals['_CASECLASSIFICATION']._serialized_end = 1203
    _globals['_PRODUCT']._serialized_start = 1205
    _globals['_PRODUCT']._serialized_end = 1278