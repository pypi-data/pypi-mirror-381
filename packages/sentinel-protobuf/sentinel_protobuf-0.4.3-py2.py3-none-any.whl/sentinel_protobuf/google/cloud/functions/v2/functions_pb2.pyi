...
class OperationMetadata(_message.Message):
    __slots__ = ('create_time', 'end_time', 'target', 'verb', 'status_detail', 'cancel_requested', 'api_version', 'request_resource', 'stages', 'source_token', 'build_name', 'operation_type')
    CREATE_TIME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., end_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., target: _Optional[str]=..., verb: _Optional[str]=..., status_detail: _Optional[str]=..., cancel_requested: bool=..., api_version: _Optional[str]=..., request_resource: _Optional[_Union[_any_pb2.Any, _Mapping]]=..., stages: _Optional[_Iterable[_Union[Stage, _Mapping]]]=..., source_token: _Optional[str]=..., build_name: _Optional[str]=..., operation_type: _Optional[_Union[OperationType, str]]=...) -> None:
        ...
