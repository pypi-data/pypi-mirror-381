...
class RagQuery(_message.Message):
    __slots__ = ('text', 'rag_retrieval_config')
    TEXT_FIELD_NUMBER: _ClassVar[int]
    RAG_RETRIEVAL_CONFIG_FIELD_NUMBER: _ClassVar[int]
    text: str
    rag_retrieval_config: _tool_pb2.RagRetrievalConfig

    def __init__(self, text: _Optional[str]=..., rag_retrieval_config: _Optional[_Union[_tool_pb2.RagRetrievalConfig, _Mapping]]=...) -> None:
        ...
...
class RetrieveContextsRequest(_message.Message):
    ...
    class VertexRagStore(_message.Message):
        __slots__ = ('rag_resources', 'vector_distance_threshold')
        ...
        def __init__(self, rag_resources: _Optional[_Iterable[_Union[RetrieveContextsRequest.VertexRagStore.RagResource, _Mapping]]]=..., vector_distance_threshold: _Optional[float]=...) -> None:
            ...
...
class RagContexts(_message.Message):
    ...
    class Context(_message.Message):
        __slots__ = ('source_uri', 'source_display_name', 'text', 'score', 'chunk')
        ...
        def __init__(self, source_uri: _Optional[str]=..., source_display_name: _Optional[str]=..., text: _Optional[str]=..., score: _Optional[float]=..., chunk: _Optional[_Union[_vertex_rag_data_pb2.RagChunk, _Mapping]]=...) -> None:
            ...
