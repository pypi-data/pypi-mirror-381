...
class RagRetrievalConfig(_message.Message):
    __slots__ = ('top_k', 'filter', 'ranking')
    ...
    def __init__(self, top_k: _Optional[int]=..., filter: _Optional[_Union[RagRetrievalConfig.Filter, _Mapping]]=..., ranking: _Optional[_Union[RagRetrievalConfig.Ranking, _Mapping]]=...) -> None:
        ...