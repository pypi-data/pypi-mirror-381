...
class FeatureOnlineStore(_message.Message):
    __slots__ = ('bigtable', 'optimized', 'name', 'create_time', 'update_time', 'etag', 'labels', 'state', 'dedicated_serving_endpoint', 'encryption_spec', 'satisfies_pzs', 'satisfies_pzi')
