...
class DeployedIndex(_message.Message):
    __slots__ = ('id', 'index', 'display_name', 'create_time', 'private_endpoints', 'index_sync_time', 'automatic_resources', 'dedicated_resources', 'enable_access_logging', 'enable_datapoint_upsert_logging', 'deployed_index_auth_config', 'reserved_ip_ranges', 'deployment_group', 'deployment_tier', 'psc_automation_configs')

    class DeploymentTier(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        DEPLOYMENT_TIER_UNSPECIFIED: _ClassVar[DeployedIndex.DeploymentTier]
        STORAGE: _ClassVar[DeployedIndex.DeploymentTier]
    DEPLOYMENT_TIER_UNSPECIFIED: DeployedIndex.DeploymentTier
    STORAGE: DeployedIndex.DeploymentTier
