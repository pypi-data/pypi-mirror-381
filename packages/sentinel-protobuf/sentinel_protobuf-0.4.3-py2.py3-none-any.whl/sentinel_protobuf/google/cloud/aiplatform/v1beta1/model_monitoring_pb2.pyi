...
class ModelMonitoringConfig(_message.Message):
    __slots__ = ('objective_configs', 'alert_config', 'analysis_instance_schema_uri', 'stats_anomalies_base_directory')
    OBJECTIVE_CONFIGS_FIELD_NUMBER: _ClassVar[int]
    ...
    objective_configs: _containers.RepeatedCompositeFieldContainer[ModelMonitoringObjectiveConfig]
    ...
    def __init__(self, objective_configs: _Optional[_Iterable[_Union[ModelMonitoringObjectiveConfig, _Mapping]]]=..., alert_config: _Optional[_Union[ModelMonitoringAlertConfig, _Mapping]]=..., analysis_instance_schema_uri: _Optional[str]=..., stats_anomalies_base_directory: _Optional[_Union[_io_pb2.GcsDestination, _Mapping]]=...) -> None:
        ...
