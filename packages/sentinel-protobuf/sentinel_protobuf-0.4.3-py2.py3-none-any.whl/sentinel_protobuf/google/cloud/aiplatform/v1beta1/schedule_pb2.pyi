...
from google.cloud.aiplatform.v1beta1 import model_monitoring_service_pb2 as _model_monitoring_service_pb2
from google.cloud.aiplatform.v1beta1 import notebook_service_pb2 as _notebook_service_pb2
from google.cloud.aiplatform.v1beta1 import pipeline_service_pb2 as _pipeline_service_pb2
...
class Schedule(_message.Message):
    __slots__ = ('cron', 'create_pipeline_job_request', 'create_model_monitoring_job_request', 'create_notebook_execution_job_request', 'name', 'display_name', 'start_time', 'end_time', 'max_run_count', 'started_run_count', 'state', 'create_time', 'update_time', 'next_run_time', 'last_pause_time', 'last_resume_time', 'max_concurrent_run_count', 'allow_queueing', 'catch_up', 'last_scheduled_run_response')
    ...
    CREATE_MODEL_MONITORING_JOB_REQUEST_FIELD_NUMBER: _ClassVar[int]
    ...
    create_model_monitoring_job_request: _model_monitoring_service_pb2.CreateModelMonitoringJobRequest
