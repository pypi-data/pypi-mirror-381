...
class PrivateServiceConnectConfig(_message.Message):
    __slots__ = ('enable_private_service_connect', 'project_allowlist', 'psc_automation_configs', 'enable_secure_private_service_connect', 'service_attachment')
    ...
    def __init__(self, enable_private_service_connect: bool=..., project_allowlist: _Optional[_Iterable[str]]=..., psc_automation_configs: _Optional[_Iterable[_Union[PSCAutomationConfig, _Mapping]]]=..., enable_secure_private_service_connect: bool=..., service_attachment: _Optional[str]=...) -> None:
        ...
