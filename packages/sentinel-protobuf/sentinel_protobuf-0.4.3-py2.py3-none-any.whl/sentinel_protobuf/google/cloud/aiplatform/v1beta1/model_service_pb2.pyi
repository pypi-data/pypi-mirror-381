...
from google.cloud.aiplatform.v1beta1 import evaluated_annotation_pb2 as _evaluated_annotation_pb2
...
from google.cloud.aiplatform.v1beta1 import model_evaluation_pb2 as _model_evaluation_pb2
...
class RecommendSpecRequest(_message.Message):
    __slots__ = ('parent', 'gcs_uri', 'check_machine_availability', 'check_user_quota')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    GCS_URI_FIELD_NUMBER: _ClassVar[int]
    CHECK_MACHINE_AVAILABILITY_FIELD_NUMBER: _ClassVar[int]
    CHECK_USER_QUOTA_FIELD_NUMBER: _ClassVar[int]
    parent: str
    gcs_uri: str
    check_machine_availability: bool
    check_user_quota: bool

    def __init__(self, parent: _Optional[str]=..., gcs_uri: _Optional[str]=..., check_machine_availability: bool=..., check_user_quota: bool=...) -> None:
        ...

class RecommendSpecResponse(_message.Message):
    __slots__ = ('base_model', 'recommendations', 'specs')

    class MachineAndModelContainerSpec(_message.Message):
        __slots__ = ('machine_spec', 'container_spec')
        ...
        def __init__(self, machine_spec: _Optional[_Union[_machine_resources_pb2.MachineSpec, _Mapping]]=..., container_spec: _Optional[_Union[_model_pb2.ModelContainerSpec, _Mapping]]=...) -> None:
            ...

    class Recommendation(_message.Message):
        __slots__ = ('region', 'spec', 'user_quota_state')

        class QuotaState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            QUOTA_STATE_UNSPECIFIED: _ClassVar[RecommendSpecResponse.Recommendation.QuotaState]
            QUOTA_STATE_USER_HAS_QUOTA: _ClassVar[RecommendSpecResponse.Recommendation.QuotaState]
            QUOTA_STATE_NO_USER_QUOTA: _ClassVar[RecommendSpecResponse.Recommendation.QuotaState]
        QUOTA_STATE_UNSPECIFIED: RecommendSpecResponse.Recommendation.QuotaState
        QUOTA_STATE_USER_HAS_QUOTA: RecommendSpecResponse.Recommendation.QuotaState
        QUOTA_STATE_NO_USER_QUOTA: RecommendSpecResponse.Recommendation.QuotaState
        REGION_FIELD_NUMBER: _ClassVar[int]
        SPEC_FIELD_NUMBER: _ClassVar[int]
        USER_QUOTA_STATE_FIELD_NUMBER: _ClassVar[int]
        region: str
        spec: RecommendSpecResponse.MachineAndModelContainerSpec
        user_quota_state: RecommendSpecResponse.Recommendation.QuotaState

        def __init__(self, region: _Optional[str]=..., spec: _Optional[_Union[RecommendSpecResponse.MachineAndModelContainerSpec, _Mapping]]=..., user_quota_state: _Optional[_Union[RecommendSpecResponse.Recommendation.QuotaState, str]]=...) -> None:
            ...
    BASE_MODEL_FIELD_NUMBER: _ClassVar[int]
    RECOMMENDATIONS_FIELD_NUMBER: _ClassVar[int]
    SPECS_FIELD_NUMBER: _ClassVar[int]
    base_model: str
    recommendations: _containers.RepeatedCompositeFieldContainer[RecommendSpecResponse.Recommendation]
    specs: _containers.RepeatedCompositeFieldContainer[RecommendSpecResponse.MachineAndModelContainerSpec]

    def __init__(self, base_model: _Optional[str]=..., recommendations: _Optional[_Iterable[_Union[RecommendSpecResponse.Recommendation, _Mapping]]]=..., specs: _Optional[_Iterable[_Union[RecommendSpecResponse.MachineAndModelContainerSpec, _Mapping]]]=...) -> None:
        ...