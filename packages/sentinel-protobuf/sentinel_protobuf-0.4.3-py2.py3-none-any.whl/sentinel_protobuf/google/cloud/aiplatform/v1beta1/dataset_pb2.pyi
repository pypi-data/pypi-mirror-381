...
class ExportDataConfig(_message.Message):
    __slots__ = ('gcs_destination', 'fraction_split', 'annotations_filter')
    ...
    def __init__(self, gcs_destination: _Optional[_Union[_io_pb2.GcsDestination, _Mapping]]=..., fraction_split: _Optional[_Union[ExportFractionSplit, _Mapping]]=..., annotations_filter: _Optional[str]=...) -> None:
        ...
