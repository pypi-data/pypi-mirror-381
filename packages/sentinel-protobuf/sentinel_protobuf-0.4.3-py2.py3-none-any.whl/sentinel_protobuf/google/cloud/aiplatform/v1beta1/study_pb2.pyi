...
class StudySpec(_message.Message):
    __slots__ = ('decay_curve_stopping_spec', 'median_automated_stopping_spec', 'convex_stop_config', 'convex_automated_stopping_spec', 'metrics', 'parameters', 'algorithm', 'observation_noise', 'measurement_selection_type', 'transfer_learning_config', 'study_stopping_config')
    ...
    class ConvexStopConfig(_message.Message):
        __slots__ = ('max_num_steps', 'min_num_steps', 'autoregressive_order', 'learning_rate_parameter_name', 'use_seconds')
        MAX_NUM_STEPS_FIELD_NUMBER: _ClassVar[int]
        MIN_NUM_STEPS_FIELD_NUMBER: _ClassVar[int]
        AUTOREGRESSIVE_ORDER_FIELD_NUMBER: _ClassVar[int]
        LEARNING_RATE_PARAMETER_NAME_FIELD_NUMBER: _ClassVar[int]
        USE_SECONDS_FIELD_NUMBER: _ClassVar[int]
        max_num_steps: int
        min_num_steps: int
        ...
        def __init__(self, max_num_steps: _Optional[int]=..., min_num_steps: _Optional[int]=..., autoregressive_order: _Optional[int]=..., learning_rate_parameter_name: _Optional[str]=..., use_seconds: bool=...) -> None:
            ...

    class TransferLearningConfig(_message.Message):
        __slots__ = ('disable_transfer_learning', 'prior_study_names')
        DISABLE_TRANSFER_LEARNING_FIELD_NUMBER: _ClassVar[int]
        PRIOR_STUDY_NAMES_FIELD_NUMBER: _ClassVar[int]
        disable_transfer_learning: bool
        prior_study_names: _containers.RepeatedScalarFieldContainer[str]

        def __init__(self, disable_transfer_learning: bool=..., prior_study_names: _Optional[_Iterable[str]]=...) -> None:
            ...
    ...
    CONVEX_STOP_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    TRANSFER_LEARNING_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    convex_stop_config: StudySpec.ConvexStopConfig
    ...
    transfer_learning_config: StudySpec.TransferLearningConfig
    study_stopping_config: StudySpec.StudyStoppingConfig

    def __init__(self, decay_curve_stopping_spec: _Optional[_Union[StudySpec.DecayCurveAutomatedStoppingSpec, _Mapping]]=..., median_automated_stopping_spec: _Optional[_Union[StudySpec.MedianAutomatedStoppingSpec, _Mapping]]=..., convex_stop_config: _Optional[_Union[StudySpec.ConvexStopConfig, _Mapping]]=..., convex_automated_stopping_spec: _Optional[_Union[StudySpec.ConvexAutomatedStoppingSpec, _Mapping]]=..., metrics: _Optional[_Iterable[_Union[StudySpec.MetricSpec, _Mapping]]]=..., parameters: _Optional[_Iterable[_Union[StudySpec.ParameterSpec, _Mapping]]]=..., algorithm: _Optional[_Union[StudySpec.Algorithm, str]]=..., observation_noise: _Optional[_Union[StudySpec.ObservationNoise, str]]=..., measurement_selection_type: _Optional[_Union[StudySpec.MeasurementSelectionType, str]]=..., transfer_learning_config: _Optional[_Union[StudySpec.TransferLearningConfig, _Mapping]]=..., study_stopping_config: _Optional[_Union[StudySpec.StudyStoppingConfig, _Mapping]]=...) -> None:
        ...
