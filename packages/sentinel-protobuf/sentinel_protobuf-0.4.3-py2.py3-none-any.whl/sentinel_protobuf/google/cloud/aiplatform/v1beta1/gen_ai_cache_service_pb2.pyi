...
from google.cloud.aiplatform.v1beta1 import cached_content_pb2 as _cached_content_pb2
...
class CreateCachedContentRequest(_message.Message):
    __slots__ = ('parent', 'cached_content')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    CACHED_CONTENT_FIELD_NUMBER: _ClassVar[int]
    parent: str
    cached_content: _cached_content_pb2.CachedContent

    def __init__(self, parent: _Optional[str]=..., cached_content: _Optional[_Union[_cached_content_pb2.CachedContent, _Mapping]]=...) -> None:
        ...
