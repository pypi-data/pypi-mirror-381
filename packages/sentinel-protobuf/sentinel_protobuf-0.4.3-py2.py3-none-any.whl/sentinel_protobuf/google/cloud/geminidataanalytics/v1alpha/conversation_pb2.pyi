...
class UpdateConversationRequest(_message.Message):
    __slots__ = ('conversation', 'update_mask', 'request_id')
    CONVERSATION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, conversation: _Optional[_Union[Conversation, _Mapping]]=..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]]=..., request_id: _Optional[str]=...) -> None:
        ...
