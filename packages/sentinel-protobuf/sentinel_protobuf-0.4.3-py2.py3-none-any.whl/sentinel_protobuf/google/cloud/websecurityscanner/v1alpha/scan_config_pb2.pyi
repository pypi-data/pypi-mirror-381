...
class ScanConfig(_message.Message):
    __slots__ = ('name', 'display_name', 'max_qps', 'starting_urls', 'authentication', 'user_agent', 'blacklist_patterns', 'schedule', 'target_platforms', 'latest_run')
