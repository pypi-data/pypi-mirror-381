...
from google.cloud.websecurityscanner.v1beta import scan_run_error_trace_pb2 as _scan_run_error_trace_pb2
from google.cloud.websecurityscanner.v1beta import scan_run_warning_trace_pb2 as _scan_run_warning_trace_pb2
...
class ScanRun(_message.Message):
    __slots__ = ('name', 'execution_state', 'result_state', 'start_time', 'end_time', 'urls_crawled_count', 'urls_tested_count', 'has_vulnerabilities', 'progress_percent', 'error_trace', 'warning_traces')
    ...
    WARNING_TRACES_FIELD_NUMBER: _ClassVar[int]
    name: str
