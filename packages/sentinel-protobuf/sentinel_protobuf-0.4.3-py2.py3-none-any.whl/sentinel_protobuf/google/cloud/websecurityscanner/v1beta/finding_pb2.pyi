...
from google.cloud.websecurityscanner.v1beta import finding_addon_pb2 as _finding_addon_pb2
...
class Finding(_message.Message):
    __slots__ = ('name', 'finding_type', 'http_method', 'fuzzed_url', 'body', 'description', 'reproduction_url', 'frame_url', 'final_url', 'tracking_id', 'form', 'outdated_library', 'violating_resource', 'vulnerable_headers', 'vulnerable_parameters', 'xss')
