...
from google.cloud.recommender.v1beta1 import insight_pb2 as _insight_pb2
from google.cloud.recommender.v1beta1 import insight_type_config_pb2 as _insight_type_config_pb2
from google.cloud.recommender.v1beta1 import recommendation_pb2 as _recommendation_pb2
from google.cloud.recommender.v1beta1 import recommender_config_pb2 as _recommender_config_pb2
...
class ListRecommendersRequest(_message.Message):
...
class ListRecommendersResponse(_message.Message):
    __slots__ = ('recommenders', 'next_page_token')
    RECOMMENDERS_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    recommenders: _containers.RepeatedCompositeFieldContainer[_recommendation_pb2.RecommenderType]
    next_page_token: str

    def __init__(self, recommenders: _Optional[_Iterable[_Union[_recommendation_pb2.RecommenderType, _Mapping]]]=..., next_page_token: _Optional[str]=...) -> None:
        ...

class ListInsightTypesRequest(_message.Message):
    __slots__ = ('page_size', 'page_token')
    PAGE_SIZE_FIELD_NUMBER: _ClassVar[int]
    PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    page_size: int
...
class ListInsightTypesResponse(_message.Message):
    __slots__ = ('insight_types', 'next_page_token')
    INSIGHT_TYPES_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    insight_types: _containers.RepeatedCompositeFieldContainer[_insight_pb2.InsightType]
    next_page_token: str

    def __init__(self, insight_types: _Optional[_Iterable[_Union[_insight_pb2.InsightType, _Mapping]]]=..., next_page_token: _Optional[str]=...) -> None:
        ...