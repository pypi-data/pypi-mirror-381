...
class HumanAgentAssistantConfig(_message.Message):
    ...
    class SuggestionTriggerSettings(_message.Message):
        __slots__ = ('no_smalltalk', 'only_end_user')
        NO_SMALLTALK_FIELD_NUMBER: _ClassVar[int]
        ONLY_END_USER_FIELD_NUMBER: _ClassVar[int]
        no_smalltalk: bool
        only_end_user: bool

        def __init__(self, no_smalltalk: bool=..., only_end_user: bool=...) -> None:
            ...
...
class ClearSuggestionFeatureConfigRequest(_message.Message):
    ...
    conversation_profile: str
    participant_role: _participant_pb2.Participant.Role
    suggestion_feature_type: SuggestionFeature.Type

    def __init__(self, conversation_profile: _Optional[str]=..., participant_role: _Optional[_Union[_participant_pb2.Participant.Role, str]]=..., suggestion_feature_type: _Optional[_Union[SuggestionFeature.Type, str]]=...) -> None:
        ...
...
class SetSuggestionFeatureConfigOperationMetadata(_message.Message):
    ...
    def __init__(self, conversation_profile: _Optional[str]=..., participant_role: _Optional[_Union[_participant_pb2.Participant.Role, str]]=..., suggestion_feature_type: _Optional[_Union[SuggestionFeature.Type, str]]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
