...
class Document(_message.Message):
    __slots__ = ('name', 'display_name', 'mime_type', 'knowledge_types', 'content_uri', 'raw_content', 'enable_auto_reload', 'latest_reload_status', 'metadata', 'state')
    ...
    def __init__(self, name: _Optional[str]=..., display_name: _Optional[str]=..., mime_type: _Optional[str]=..., knowledge_types: _Optional[_Iterable[_Union[Document.KnowledgeType, str]]]=..., content_uri: _Optional[str]=..., raw_content: _Optional[bytes]=..., enable_auto_reload: bool=..., latest_reload_status: _Optional[_Union[Document.ReloadStatus, _Mapping]]=..., metadata: _Optional[_Mapping[str, str]]=..., state: _Optional[_Union[Document.State, str]]=...) -> None:
        ...
...
class CreateDocumentRequest(_message.Message):
    ...
    def __init__(self, parent: _Optional[str]=..., document: _Optional[_Union[Document, _Mapping]]=...) -> None:
        ...
...
class ReloadDocumentRequest(_message.Message):
    __slots__ = ('name', 'content_uri', 'import_gcs_custom_metadata', 'smart_messaging_partial_update')
    NAME_FIELD_NUMBER: _ClassVar[int]
    CONTENT_URI_FIELD_NUMBER: _ClassVar[int]
    IMPORT_GCS_CUSTOM_METADATA_FIELD_NUMBER: _ClassVar[int]
    SMART_MESSAGING_PARTIAL_UPDATE_FIELD_NUMBER: _ClassVar[int]
    name: str
    content_uri: str
    import_gcs_custom_metadata: bool
    smart_messaging_partial_update: bool

    def __init__(self, name: _Optional[str]=..., content_uri: _Optional[str]=..., import_gcs_custom_metadata: bool=..., smart_messaging_partial_update: bool=...) -> None:
        ...

class ExportDocumentRequest(_message.Message):
    __slots__ = ('name', 'gcs_destination', 'export_full_content', 'smart_messaging_partial_update')
    NAME_FIELD_NUMBER: _ClassVar[int]
    GCS_DESTINATION_FIELD_NUMBER: _ClassVar[int]
    EXPORT_FULL_CONTENT_FIELD_NUMBER: _ClassVar[int]
    SMART_MESSAGING_PARTIAL_UPDATE_FIELD_NUMBER: _ClassVar[int]
    name: str
    gcs_destination: _gcs_pb2.GcsDestination
    export_full_content: bool
    smart_messaging_partial_update: bool

    def __init__(self, name: _Optional[str]=..., gcs_destination: _Optional[_Union[_gcs_pb2.GcsDestination, _Mapping]]=..., export_full_content: bool=..., smart_messaging_partial_update: bool=...) -> None:
        ...
