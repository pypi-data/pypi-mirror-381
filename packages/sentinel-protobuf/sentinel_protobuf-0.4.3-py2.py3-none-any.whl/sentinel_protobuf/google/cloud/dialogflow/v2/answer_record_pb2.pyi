...
class AgentAssistantFeedback(_message.Message):
    ...
    class SummarizationFeedback(_message.Message):
        __slots__ = ('start_time', 'submit_time', 'summary_text', 'text_sections')
        ...
        def __init__(self, start_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., submit_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., summary_text: _Optional[str]=..., text_sections: _Optional[_Mapping[str, str]]=...) -> None:
            ...
