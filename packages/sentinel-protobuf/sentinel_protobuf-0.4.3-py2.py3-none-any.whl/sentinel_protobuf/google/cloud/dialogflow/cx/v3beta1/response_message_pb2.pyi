...
class ResponseMessage(_message.Message):
    __slots__ = ('text', 'payload', 'conversation_success', 'output_audio_text', 'live_agent_handoff', 'end_interaction', 'play_audio', 'mixed_audio', 'telephony_transfer_call', 'knowledge_info_card', 'tool_call', 'channel')
