...
class Fulfillment(_message.Message):
    __slots__ = ('messages', 'webhook', 'return_partial_responses', 'tag', 'set_parameter_actions', 'conditional_cases', 'advanced_settings', 'enable_generative_fallback', 'generators')
    ...
    class GeneratorSettings(_message.Message):
        __slots__ = ('generator', 'input_parameters', 'output_parameter')
        ...
        OUTPUT_PARAMETER_FIELD_NUMBER: _ClassVar[int]
        generator: str
        input_parameters: _containers.ScalarMap[str, str]
        output_parameter: str

        def __init__(self, generator: _Optional[str]=..., input_parameters: _Optional[_Mapping[str, str]]=..., output_parameter: _Optional[str]=...) -> None:
            ...
    ...
    generators: _containers.RepeatedCompositeFieldContainer[Fulfillment.GeneratorSettings]

    def __init__(self, messages: _Optional[_Iterable[_Union[_response_message_pb2.ResponseMessage, _Mapping]]]=..., webhook: _Optional[str]=..., return_partial_responses: bool=..., tag: _Optional[str]=..., set_parameter_actions: _Optional[_Iterable[_Union[Fulfillment.SetParameterAction, _Mapping]]]=..., conditional_cases: _Optional[_Iterable[_Union[Fulfillment.ConditionalCases, _Mapping]]]=..., advanced_settings: _Optional[_Union[_advanced_settings_pb2.AdvancedSettings, _Mapping]]=..., enable_generative_fallback: bool=..., generators: _Optional[_Iterable[_Union[Fulfillment.GeneratorSettings, _Mapping]]]=...) -> None:
        ...