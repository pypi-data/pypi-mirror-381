...
from google.cloud.dialogflow.cx.v3 import advanced_settings_pb2 as _advanced_settings_pb2
from google.cloud.dialogflow.cx.v3 import audio_config_pb2 as _audio_config_pb2
from google.cloud.dialogflow.cx.v3 import data_store_connection_pb2 as _data_store_connection_pb2
from google.cloud.dialogflow.cx.v3 import flow_pb2 as _flow_pb2
from google.cloud.dialogflow.cx.v3 import intent_pb2 as _intent_pb2
...
from google.cloud.dialogflow.cx.v3 import session_entity_type_pb2 as _session_entity_type_pb2
...
class QueryParameters(_message.Message):
    __slots__ = ('time_zone', 'geo_location', 'session_entity_types', 'payload', 'parameters', 'current_page', 'disable_webhook', 'analyze_query_text_sentiment', 'webhook_headers', 'flow_versions', 'channel', 'session_ttl', 'end_user_metadata', 'search_config', 'populate_data_store_connection_signals')
...
class QueryInput(_message.Message):
    __slots__ = ('text', 'intent', 'audio', 'event', 'dtmf', 'language_code')
    ...
    def __init__(self, text: _Optional[_Union[TextInput, _Mapping]]=..., intent: _Optional[_Union[IntentInput, _Mapping]]=..., audio: _Optional[_Union[AudioInput, _Mapping]]=..., event: _Optional[_Union[EventInput, _Mapping]]=..., dtmf: _Optional[_Union[DtmfInput, _Mapping]]=..., language_code: _Optional[str]=...) -> None:
        ...

class QueryResult(_message.Message):
    __slots__ = ('text', 'trigger_intent', 'transcript', 'trigger_event', 'dtmf', 'language_code', 'parameters', 'response_messages', 'webhook_ids', 'webhook_display_names', 'webhook_latencies', 'webhook_tags', 'webhook_statuses', 'webhook_payloads', 'current_page', 'current_flow', 'intent', 'intent_detection_confidence', 'match', 'diagnostic_info', 'sentiment_analysis_result', 'advanced_settings', 'allow_answer_feedback', 'data_store_connection_signals')
    TEXT_FIELD_NUMBER: _ClassVar[int]
