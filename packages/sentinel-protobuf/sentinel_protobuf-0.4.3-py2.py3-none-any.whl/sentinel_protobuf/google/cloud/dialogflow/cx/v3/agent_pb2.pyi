...
from google.cloud.dialogflow.cx.v3 import generative_settings_pb2 as _generative_settings_pb2
...
class Agent(_message.Message):
    __slots__ = ('name', 'display_name', 'default_language_code', 'supported_language_codes', 'time_zone', 'description', 'avatar_uri', 'speech_to_text_settings', 'start_flow', 'security_settings', 'enable_stackdriver_logging', 'enable_spell_correction', 'enable_multi_language_training', 'locked', 'advanced_settings', 'git_integration_settings', 'text_to_speech_settings', 'gen_app_builder_settings', 'answer_feedback_settings', 'personalization_settings', 'client_certificate_settings', 'satisfies_pzs', 'satisfies_pzi')

    class GitIntegrationSettings(_message.Message):
        __slots__ = ('github_settings',)
        ...
        def __init__(self, github_settings: _Optional[_Union[Agent.GitIntegrationSettings.GithubSettings, _Mapping]]=...) -> None:
            ...
