...
from google.cloud.dialogflow.cx.v3beta1 import safety_settings_pb2 as _safety_settings_pb2
...
class GenerativeSettings(_message.Message):
    __slots__ = ('name', 'fallback_settings', 'generative_safety_settings', 'knowledge_connector_settings', 'language_code', 'llm_model_settings')
