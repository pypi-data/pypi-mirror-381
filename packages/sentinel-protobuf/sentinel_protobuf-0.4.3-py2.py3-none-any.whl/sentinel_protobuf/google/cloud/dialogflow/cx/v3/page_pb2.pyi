...
from google.cloud.dialogflow.cx.v3 import fulfillment_pb2 as _fulfillment_pb2
...
class EventHandler(_message.Message):
    __slots__ = ('name', 'event', 'trigger_fulfillment', 'target_page', 'target_flow')
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str]=..., event: _Optional[str]=..., trigger_fulfillment: _Optional[_Union[_fulfillment_pb2.Fulfillment, _Mapping]]=..., target_page: _Optional[str]=..., target_flow: _Optional[str]=...) -> None:
        ...
