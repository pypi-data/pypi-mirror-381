...
class WebhookRequest(_message.Message):
    __slots__ = ('session', 'response_id', 'query_result', 'alternative_query_results', 'original_detect_intent_request')
    ...
    alternative_query_results: _containers.RepeatedCompositeFieldContainer[_session_pb2.QueryResult]
    original_detect_intent_request: OriginalDetectIntentRequest

    def __init__(self, session: _Optional[str]=..., response_id: _Optional[str]=..., query_result: _Optional[_Union[_session_pb2.QueryResult, _Mapping]]=..., alternative_query_results: _Optional[_Iterable[_Union[_session_pb2.QueryResult, _Mapping]]]=..., original_detect_intent_request: _Optional[_Union[OriginalDetectIntentRequest, _Mapping]]=...) -> None:
        ...

class WebhookResponse(_message.Message):
    __slots__ = ('fulfillment_text', 'fulfillment_messages', 'source', 'payload', 'output_contexts', 'followup_event_input', 'live_agent_handoff', 'end_interaction', 'session_entity_types')
