...
class InventoryView(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    INVENTORY_VIEW_UNSPECIFIED: _ClassVar[InventoryView]
    BASIC: _ClassVar[InventoryView]
    FULL: _ClassVar[InventoryView]
INVENTORY_VIEW_UNSPECIFIED: InventoryView
BASIC: InventoryView
FULL: InventoryView

class Inventory(_message.Message):
    __slots__ = ('name', 'os_info', 'items', 'update_time')
    ...
    class Item(_message.Message):
        __slots__ = ('id', 'origin_type', 'create_time', 'update_time', 'type', 'installed_package', 'available_package')

        class OriginType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            ORIGIN_TYPE_UNSPECIFIED: _ClassVar[Inventory.Item.OriginType]
            INVENTORY_REPORT: _ClassVar[Inventory.Item.OriginType]
        ORIGIN_TYPE_UNSPECIFIED: Inventory.Item.OriginType
        INVENTORY_REPORT: Inventory.Item.OriginType

        class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            TYPE_UNSPECIFIED: _ClassVar[Inventory.Item.Type]
            INSTALLED_PACKAGE: _ClassVar[Inventory.Item.Type]
            AVAILABLE_PACKAGE: _ClassVar[Inventory.Item.Type]
        TYPE_UNSPECIFIED: Inventory.Item.Type
        INSTALLED_PACKAGE: Inventory.Item.Type
        AVAILABLE_PACKAGE: Inventory.Item.Type
        ...
        AVAILABLE_PACKAGE_FIELD_NUMBER: _ClassVar[int]
        id: str
        origin_type: Inventory.Item.OriginType
        create_time: _timestamp_pb2.Timestamp
        update_time: _timestamp_pb2.Timestamp
        type: Inventory.Item.Type
        installed_package: Inventory.SoftwarePackage
        available_package: Inventory.SoftwarePackage

        def __init__(self, id: _Optional[str]=..., origin_type: _Optional[_Union[Inventory.Item.OriginType, str]]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., type: _Optional[_Union[Inventory.Item.Type, str]]=..., installed_package: _Optional[_Union[Inventory.SoftwarePackage, _Mapping]]=..., available_package: _Optional[_Union[Inventory.SoftwarePackage, _Mapping]]=...) -> None:
            ...
    ...
    class VersionedPackage(_message.Message):
        __slots__ = ('package_name', 'architecture', 'version')
        ...
        def __init__(self, package_name: _Optional[str]=..., architecture: _Optional[str]=..., version: _Optional[str]=...) -> None:
            ...
    ...
    class ItemsEntry(_message.Message):
        ...
        def __init__(self, key: _Optional[str]=..., value: _Optional[_Union[Inventory.Item, _Mapping]]=...) -> None:
            ...
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    items: _containers.MessageMap[str, Inventory.Item]
    update_time: _timestamp_pb2.Timestamp

    def __init__(self, name: _Optional[str]=..., os_info: _Optional[_Union[Inventory.OsInfo, _Mapping]]=..., items: _Optional[_Mapping[str, Inventory.Item]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class GetInventoryRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str]=..., view: _Optional[_Union[InventoryView, str]]=...) -> None:
        ...

class ListInventoriesRequest(_message.Message):
    ...
    def __init__(self, parent: _Optional[str]=..., view: _Optional[_Union[InventoryView, str]]=..., page_size: _Optional[int]=..., page_token: _Optional[str]=..., filter: _Optional[str]=...) -> None:
        ...

class ListInventoriesResponse(_message.Message):
    __slots__ = ('inventories', 'next_page_token')
    INVENTORIES_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    inventories: _containers.RepeatedCompositeFieldContainer[Inventory]
    next_page_token: str

    def __init__(self, inventories: _Optional[_Iterable[_Union[Inventory, _Mapping]]]=..., next_page_token: _Optional[str]=...) -> None:
        ...