...
from google.cloud.tasks.v2beta3 import target_pb2 as _target_pb2
...
class Queue(_message.Message):
    __slots__ = ('name', 'app_engine_http_queue', 'http_target', 'rate_limits', 'retry_config', 'state', 'purge_time', 'task_ttl', 'tombstone_ttl', 'stackdriver_logging_config', 'type', 'stats')
    ...
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        TYPE_UNSPECIFIED: _ClassVar[Queue.Type]
        PULL: _ClassVar[Queue.Type]
        PUSH: _ClassVar[Queue.Type]
    TYPE_UNSPECIFIED: Queue.Type
    PULL: Queue.Type
    PUSH: Queue.Type
    NAME_FIELD_NUMBER: _ClassVar[int]
    APP_ENGINE_HTTP_QUEUE_FIELD_NUMBER: _ClassVar[int]
    ...
    name: str
    app_engine_http_queue: _target_pb2.AppEngineHttpQueue
    ...
    def __init__(self, name: _Optional[str]=..., app_engine_http_queue: _Optional[_Union[_target_pb2.AppEngineHttpQueue, _Mapping]]=..., http_target: _Optional[_Union[_target_pb2.HttpTarget, _Mapping]]=..., rate_limits: _Optional[_Union[RateLimits, _Mapping]]=..., retry_config: _Optional[_Union[RetryConfig, _Mapping]]=..., state: _Optional[_Union[Queue.State, str]]=..., purge_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., task_ttl: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., tombstone_ttl: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., stackdriver_logging_config: _Optional[_Union[StackdriverLoggingConfig, _Mapping]]=..., type: _Optional[_Union[Queue.Type, str]]=..., stats: _Optional[_Union[QueueStats, _Mapping]]=...) -> None:
        ...
