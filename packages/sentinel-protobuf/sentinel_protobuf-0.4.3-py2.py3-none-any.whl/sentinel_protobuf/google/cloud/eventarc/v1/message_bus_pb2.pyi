...
class MessageBus(_message.Message):
    __slots__ = ('name', 'uid', 'etag', 'create_time', 'update_time', 'labels', 'annotations', 'display_name', 'crypto_key_name', 'logging_config')
