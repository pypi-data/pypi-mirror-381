...
class TranslateSpeechConfig(_message.Message):
    __slots__ = ('audio_encoding', 'source_language_code', 'target_language_code', 'alternative_source_language_codes', 'sample_rate_hertz', 'model')
    ...
    ALTERNATIVE_SOURCE_LANGUAGE_CODES_FIELD_NUMBER: _ClassVar[int]
    SAMPLE_RATE_HERTZ_FIELD_NUMBER: _ClassVar[int]
    MODEL_FIELD_NUMBER: _ClassVar[int]
    audio_encoding: str
    source_language_code: str
    target_language_code: str
    alternative_source_language_codes: _containers.RepeatedScalarFieldContainer[str]
    sample_rate_hertz: int
    model: str

    def __init__(self, audio_encoding: _Optional[str]=..., source_language_code: _Optional[str]=..., target_language_code: _Optional[str]=..., alternative_source_language_codes: _Optional[_Iterable[str]]=..., sample_rate_hertz: _Optional[int]=..., model: _Optional[str]=...) -> None:
        ...

class StreamingTranslateSpeechConfig(_message.Message):
    __slots__ = ('audio_config', 'single_utterance', 'stability', 'translation_mode', 'disable_interim_results')
    AUDIO_CONFIG_FIELD_NUMBER: _ClassVar[int]
    SINGLE_UTTERANCE_FIELD_NUMBER: _ClassVar[int]
    STABILITY_FIELD_NUMBER: _ClassVar[int]
    TRANSLATION_MODE_FIELD_NUMBER: _ClassVar[int]
    DISABLE_INTERIM_RESULTS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, audio_config: _Optional[_Union[TranslateSpeechConfig, _Mapping]]=..., single_utterance: bool=..., stability: _Optional[str]=..., translation_mode: _Optional[str]=..., disable_interim_results: bool=...) -> None:
        ...
...
class StreamingTranslateSpeechResult(_message.Message):
    __slots__ = ('text_translation_result', 'audio_translation_result', 'recognition_result', 'detected_source_language_code')
    ...
    class AudioTranslationResult(_message.Message):
        __slots__ = ('audio_translation',)
        AUDIO_TRANSLATION_FIELD_NUMBER: _ClassVar[int]
        audio_translation: bytes

        def __init__(self, audio_translation: _Optional[bytes]=...) -> None:
            ...
    TEXT_TRANSLATION_RESULT_FIELD_NUMBER: _ClassVar[int]
    AUDIO_TRANSLATION_RESULT_FIELD_NUMBER: _ClassVar[int]
    RECOGNITION_RESULT_FIELD_NUMBER: _ClassVar[int]
    DETECTED_SOURCE_LANGUAGE_CODE_FIELD_NUMBER: _ClassVar[int]
    text_translation_result: StreamingTranslateSpeechResult.TextTranslationResult
    audio_translation_result: StreamingTranslateSpeechResult.AudioTranslationResult
    recognition_result: str
    detected_source_language_code: str

    def __init__(self, text_translation_result: _Optional[_Union[StreamingTranslateSpeechResult.TextTranslationResult, _Mapping]]=..., audio_translation_result: _Optional[_Union[StreamingTranslateSpeechResult.AudioTranslationResult, _Mapping]]=..., recognition_result: _Optional[str]=..., detected_source_language_code: _Optional[str]=...) -> None:
        ...
