...
class TransferMetadataOptions(_message.Message):
    __slots__ = ('uid', 'gid', 'mode')

    class Uid(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UID_UNSPECIFIED: _ClassVar[TransferMetadataOptions.Uid]
        UID_SKIP: _ClassVar[TransferMetadataOptions.Uid]
        UID_NUMBER_PRESERVE: _ClassVar[TransferMetadataOptions.Uid]
    UID_UNSPECIFIED: TransferMetadataOptions.Uid
    UID_SKIP: TransferMetadataOptions.Uid
    UID_NUMBER_PRESERVE: TransferMetadataOptions.Uid

    class Gid(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        GID_UNSPECIFIED: _ClassVar[TransferMetadataOptions.Gid]
        GID_SKIP: _ClassVar[TransferMetadataOptions.Gid]
        GID_NUMBER_PRESERVE: _ClassVar[TransferMetadataOptions.Gid]
    GID_UNSPECIFIED: TransferMetadataOptions.Gid
    GID_SKIP: TransferMetadataOptions.Gid
    GID_NUMBER_PRESERVE: TransferMetadataOptions.Gid

    class Mode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        MODE_UNSPECIFIED: _ClassVar[TransferMetadataOptions.Mode]
        MODE_SKIP: _ClassVar[TransferMetadataOptions.Mode]
        MODE_PRESERVE: _ClassVar[TransferMetadataOptions.Mode]
    MODE_UNSPECIFIED: TransferMetadataOptions.Mode
    MODE_SKIP: TransferMetadataOptions.Mode
    MODE_PRESERVE: TransferMetadataOptions.Mode
    UID_FIELD_NUMBER: _ClassVar[int]
    GID_FIELD_NUMBER: _ClassVar[int]
    MODE_FIELD_NUMBER: _ClassVar[int]
    uid: TransferMetadataOptions.Uid
    gid: TransferMetadataOptions.Gid
    mode: TransferMetadataOptions.Mode

    def __init__(self, uid: _Optional[_Union[TransferMetadataOptions.Uid, str]]=..., gid: _Optional[_Union[TransferMetadataOptions.Gid, str]]=..., mode: _Optional[_Union[TransferMetadataOptions.Mode, str]]=...) -> None:
        ...
...
class ImportDataRequest(_message.Message):
    __slots__ = ('source_gcs_bucket', 'destination_parallelstore', 'name', 'request_id', 'service_account', 'metadata_options')
    ...
    request_id: str
    service_account: str
    metadata_options: TransferMetadataOptions

    def __init__(self, source_gcs_bucket: _Optional[_Union[SourceGcsBucket, _Mapping]]=..., destination_parallelstore: _Optional[_Union[DestinationParallelstore, _Mapping]]=..., name: _Optional[str]=..., request_id: _Optional[str]=..., service_account: _Optional[str]=..., metadata_options: _Optional[_Union[TransferMetadataOptions, _Mapping]]=...) -> None:
        ...

class ExportDataRequest(_message.Message):
    __slots__ = ('source_parallelstore', 'destination_gcs_bucket', 'name', 'request_id', 'service_account', 'metadata_options')
    ...
    def __init__(self, source_parallelstore: _Optional[_Union[SourceParallelstore, _Mapping]]=..., destination_gcs_bucket: _Optional[_Union[DestinationGcsBucket, _Mapping]]=..., name: _Optional[str]=..., request_id: _Optional[str]=..., service_account: _Optional[str]=..., metadata_options: _Optional[_Union[TransferMetadataOptions, _Mapping]]=...) -> None:
        ...
