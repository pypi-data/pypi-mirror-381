...
class Instance(_message.Message):
    __slots__ = ('name', 'display_name', 'labels', 'authorized_network', 'zones', 'node_count', 'node_config', 'memcache_version', 'parameters', 'memcache_nodes', 'create_time', 'update_time', 'state', 'memcache_full_version', 'instance_messages', 'discovery_endpoint', 'maintenance_policy', 'maintenance_schedule')
    ...
    class Node(_message.Message):
        __slots__ = ('node_id', 'zone', 'state', 'host', 'port', 'parameters')
        ...
        def __init__(self, node_id: _Optional[str]=..., zone: _Optional[str]=..., state: _Optional[_Union[Instance.Node.State, str]]=..., host: _Optional[str]=..., port: _Optional[int]=..., parameters: _Optional[_Union[MemcacheParameters, _Mapping]]=...) -> None:
            ...
