...
class CompleteQueryResponse(_message.Message):
    ...
    class CompletionResult(_message.Message):
        __slots__ = ('suggestion', 'attributes', 'facets', 'total_product_count')
        ...
        TOTAL_PRODUCT_COUNT_FIELD_NUMBER: _ClassVar[int]
        suggestion: str
        attributes: _containers.MessageMap[str, _common_pb2.CustomAttribute]
        facets: _containers.RepeatedCompositeFieldContainer[_search_service_pb2.SearchResponse.Facet]
        total_product_count: int

        def __init__(self, suggestion: _Optional[str]=..., attributes: _Optional[_Mapping[str, _common_pb2.CustomAttribute]]=..., facets: _Optional[_Iterable[_Union[_search_service_pb2.SearchResponse.Facet, _Mapping]]]=..., total_product_count: _Optional[int]=...) -> None:
            ...
