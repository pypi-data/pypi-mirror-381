...
from google.cloud.retail.v2alpha import purge_config_pb2 as _purge_config_pb2
...
class ListProductsRequest(_message.Message):
    __slots__ = ('parent', 'page_size', 'page_token', 'filter', 'read_mask', 'require_total_size')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, parent: _Optional[str]=..., page_size: _Optional[int]=..., page_token: _Optional[str]=..., filter: _Optional[str]=..., read_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]]=..., require_total_size: bool=...) -> None:
        ...

class ListProductsResponse(_message.Message):
    __slots__ = ('products', 'next_page_token', 'total_size')
    ...
    def __init__(self, products: _Optional[_Iterable[_Union[_product_pb2.Product, _Mapping]]]=..., next_page_token: _Optional[str]=..., total_size: _Optional[int]=...) -> None:
        ...
