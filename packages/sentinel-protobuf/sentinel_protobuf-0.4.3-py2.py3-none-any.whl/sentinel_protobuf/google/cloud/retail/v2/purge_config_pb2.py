...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PURGEMETADATA']._serialized_start = 162
    _globals['_PURGEMETADATA']._serialized_end = 177
    _globals['_PURGEPRODUCTSMETADATA']._serialized_start = 180
    _globals['_PURGEPRODUCTSMETADATA']._serialized_end = 347
    _globals['_PURGEPRODUCTSREQUEST']._serialized_start = 349
    _globals['_PURGEPRODUCTSREQUEST']._serialized_end = 461
    _globals['_PURGEPRODUCTSRESPONSE']._serialized_start = 463
    _globals['_PURGEPRODUCTSRESPONSE']._serialized_end = 565
    _globals['_PURGEUSEREVENTSREQUEST']._serialized_start = 567
    _globals['_PURGEUSEREVENTSREQUEST']._serialized_end = 682
    _globals['_PURGEUSEREVENTSRESPONSE']._serialized_start = 684
    _globals['_PURGEUSEREVENTSRESPONSE']._serialized_end = 738