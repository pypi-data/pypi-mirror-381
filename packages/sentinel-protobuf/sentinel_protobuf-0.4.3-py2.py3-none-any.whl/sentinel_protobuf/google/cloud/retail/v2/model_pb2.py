...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/retail/v2/model.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MODEL']._serialized_start = 193
    _globals['_MODEL']._serialized_end = 2008
    _globals['_MODEL_SERVINGCONFIGLIST']._serialized_start = 1057
    _globals['_MODEL_SERVINGCONFIGLIST']._serialized_end = 1109
    _globals['_MODEL_FREQUENTLYBOUGHTTOGETHERFEATURESCONFIG']._serialized_start = 1111
    _globals['_MODEL_FREQUENTLYBOUGHTTOGETHERFEATURESCONFIG']._serialized_end = 1238
    _globals['_MODEL_MODELFEATURESCONFIG']._serialized_start = 1241
    _globals['_MODEL_MODELFEATURESCONFIG']._serialized_end = 1402
    _globals['_MODEL_SERVINGSTATE']._serialized_start = 1404
    _globals['_MODEL_SERVINGSTATE']._serialized_end = 1486
    _globals['_MODEL_TRAININGSTATE']._serialized_start = 1488
    _globals['_MODEL_TRAININGSTATE']._serialized_end = 1561
    _globals['_MODEL_PERIODICTUNINGSTATE']._serialized_start = 1564
    _globals['_MODEL_PERIODICTUNINGSTATE']._serialized_end = 1708
    _globals['_MODEL_DATASTATE']._serialized_start = 1710
    _globals['_MODEL_DATASTATE']._serialized_end = 1778
    _globals['_MODEL_CONTEXTPRODUCTSTYPE']._serialized_start = 1780
    _globals['_MODEL_CONTEXTPRODUCTSTYPE']._serialized_end = 1899