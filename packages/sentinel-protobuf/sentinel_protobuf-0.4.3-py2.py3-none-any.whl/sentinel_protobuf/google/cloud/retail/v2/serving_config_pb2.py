...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/retail/v2/serving_config.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SERVINGCONFIG']._serialized_start = 214
    _globals['_SERVINGCONFIG']._serialized_end = 1260
    _globals['_SERVINGCONFIG_DIVERSITYTYPE']._serialized_start = 1024
    _globals['_SERVINGCONFIG_DIVERSITYTYPE']._serialized_end = 1124