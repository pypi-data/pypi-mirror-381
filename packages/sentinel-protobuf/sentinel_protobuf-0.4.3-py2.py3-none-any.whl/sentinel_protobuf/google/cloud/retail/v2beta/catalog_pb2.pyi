...
class CatalogAttribute(_message.Message):
    __slots__ = ('key', 'in_use', 'type', 'indexable_option', 'dynamic_facetable_option', 'searchable_option', 'recommendations_filtering_option', 'exact_searchable_option', 'retrievable_option', 'facet_config')
    ...
    RECOMMENDATIONS_FILTERING_OPTION_FIELD_NUMBER: _ClassVar[int]
    ...
    recommendations_filtering_option: _common_pb2.RecommendationsFilteringOption
...
class MerchantCenterLink(_message.Message):
    __slots__ = ('merchant_center_account_id', 'branch_id', 'destinations', 'region_code', 'language_code', 'feeds')
    ...
    region_code: str
    language_code: str
    feeds: _containers.RepeatedCompositeFieldContainer[MerchantCenterFeedFilter]

    def __init__(self, merchant_center_account_id: _Optional[int]=..., branch_id: _Optional[str]=..., destinations: _Optional[_Iterable[str]]=..., region_code: _Optional[str]=..., language_code: _Optional[str]=..., feeds: _Optional[_Iterable[_Union[MerchantCenterFeedFilter, _Mapping]]]=...) -> None:
        ...

class MerchantCenterFeedFilter(_message.Message):
    __slots__ = ('primary_feed_id', 'primary_feed_name')
    PRIMARY_FEED_ID_FIELD_NUMBER: _ClassVar[int]
    PRIMARY_FEED_NAME_FIELD_NUMBER: _ClassVar[int]
    primary_feed_id: int
    primary_feed_name: str

    def __init__(self, primary_feed_id: _Optional[int]=..., primary_feed_name: _Optional[str]=...) -> None:
        ...

class MerchantCenterLinkingConfig(_message.Message):
    __slots__ = ('links',)
    LINKS_FIELD_NUMBER: _ClassVar[int]
    links: _containers.RepeatedCompositeFieldContainer[MerchantCenterLink]

    def __init__(self, links: _Optional[_Iterable[_Union[MerchantCenterLink, _Mapping]]]=...) -> None:
        ...

class Catalog(_message.Message):
    __slots__ = ('name', 'display_name', 'product_level_config', 'merchant_center_linking_config')
    NAME_FIELD_NUMBER: _ClassVar[int]
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    PRODUCT_LEVEL_CONFIG_FIELD_NUMBER: _ClassVar[int]
    MERCHANT_CENTER_LINKING_CONFIG_FIELD_NUMBER: _ClassVar[int]
    name: str
    display_name: str
    product_level_config: ProductLevelConfig
    merchant_center_linking_config: MerchantCenterLinkingConfig

    def __init__(self, name: _Optional[str]=..., display_name: _Optional[str]=..., product_level_config: _Optional[_Union[ProductLevelConfig, _Mapping]]=..., merchant_center_linking_config: _Optional[_Union[MerchantCenterLinkingConfig, _Mapping]]=...) -> None:
        ...