...
class Service(_message.Message):
    __slots__ = ('hive_metastore_config', 'name', 'create_time', 'update_time', 'labels', 'network', 'endpoint_uri', 'port', 'state', 'state_message', 'artifact_gcs_uri', 'tier', 'metadata_integration', 'maintenance_window', 'uid', 'metadata_management_activity', 'release_channel', 'encryption_config', 'network_config', 'database_type', 'telemetry_config', 'scaling_config')
    ...
    METADATA_INTEGRATION_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, hive_metastore_config: _Optional[_Union[HiveMetastoreConfig, _Mapping]]=..., name: _Optional[str]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., labels: _Optional[_Mapping[str, str]]=..., network: _Optional[str]=..., endpoint_uri: _Optional[str]=..., port: _Optional[int]=..., state: _Optional[_Union[Service.State, str]]=..., state_message: _Optional[str]=..., artifact_gcs_uri: _Optional[str]=..., tier: _Optional[_Union[Service.Tier, str]]=..., metadata_integration: _Optional[_Union[MetadataIntegration, _Mapping]]=..., maintenance_window: _Optional[_Union[MaintenanceWindow, _Mapping]]=..., uid: _Optional[str]=..., metadata_management_activity: _Optional[_Union[MetadataManagementActivity, _Mapping]]=..., release_channel: _Optional[_Union[Service.ReleaseChannel, str]]=..., encryption_config: _Optional[_Union[EncryptionConfig, _Mapping]]=..., network_config: _Optional[_Union[NetworkConfig, _Mapping]]=..., database_type: _Optional[_Union[Service.DatabaseType, str]]=..., telemetry_config: _Optional[_Union[TelemetryConfig, _Mapping]]=..., scaling_config: _Optional[_Union[ScalingConfig, _Mapping]]=...) -> None:
        ...

class MetadataIntegration(_message.Message):
    __slots__ = ('data_catalog_config', 'dataplex_config')
    DATA_CATALOG_CONFIG_FIELD_NUMBER: _ClassVar[int]
    DATAPLEX_CONFIG_FIELD_NUMBER: _ClassVar[int]
    data_catalog_config: DataCatalogConfig
    dataplex_config: DataplexConfig

    def __init__(self, data_catalog_config: _Optional[_Union[DataCatalogConfig, _Mapping]]=..., dataplex_config: _Optional[_Union[DataplexConfig, _Mapping]]=...) -> None:
        ...

class DataCatalogConfig(_message.Message):
    __slots__ = ('enabled',)
...
class DataplexConfig(_message.Message):
    __slots__ = ('lake_resources',)

    class LakeResourcesEntry(_message.Message):
        __slots__ = ('key', 'value')
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
        key: str
        ...
        def __init__(self, key: _Optional[str]=..., value: _Optional[_Union[Lake, _Mapping]]=...) -> None:
            ...
    LAKE_RESOURCES_FIELD_NUMBER: _ClassVar[int]
    lake_resources: _containers.MessageMap[str, Lake]

    def __init__(self, lake_resources: _Optional[_Mapping[str, Lake]]=...) -> None:
        ...
...
class NetworkConfig(_message.Message):
    __slots__ = ('consumers', 'custom_routes_enabled')
    ...
    CUSTOM_ROUTES_ENABLED_FIELD_NUMBER: _ClassVar[int]
    consumers: _containers.RepeatedCompositeFieldContainer[NetworkConfig.Consumer]
    custom_routes_enabled: bool

    def __init__(self, consumers: _Optional[_Iterable[_Union[NetworkConfig.Consumer, _Mapping]]]=..., custom_routes_enabled: bool=...) -> None:
        ...
...
class RemoveIamPolicyRequest(_message.Message):
    __slots__ = ('resource', 'asynchronous')
    RESOURCE_FIELD_NUMBER: _ClassVar[int]
    ASYNCHRONOUS_FIELD_NUMBER: _ClassVar[int]
    resource: str
    asynchronous: bool

    def __init__(self, resource: _Optional[str]=..., asynchronous: bool=...) -> None:
        ...
