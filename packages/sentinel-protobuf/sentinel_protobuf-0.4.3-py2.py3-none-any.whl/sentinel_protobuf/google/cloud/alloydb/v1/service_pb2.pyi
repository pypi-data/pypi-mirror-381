...
class OperationMetadata(_message.Message):
    __slots__ = ('batch_create_instances_metadata', 'upgrade_cluster_status', 'create_time', 'end_time', 'target', 'verb', 'status_message', 'requested_cancellation', 'api_version')
