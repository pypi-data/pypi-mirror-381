...
from google.cloud.alloydb.v1beta import csql_resources_pb2 as _csql_resources_pb2
from google.cloud.alloydb.v1beta import gemini_pb2 as _gemini_pb2
...
class Cluster(_message.Message):
    __slots__ = ('backup_source', 'migration_source', 'cloudsql_backup_run_source', 'name', 'display_name', 'uid', 'create_time', 'update_time', 'delete_time', 'labels', 'state', 'cluster_type', 'database_version', 'network_config', 'network', 'etag', 'annotations', 'reconciling', 'initial_user', 'automated_backup_policy', 'ssl_config', 'encryption_config', 'encryption_info', 'continuous_backup_config', 'continuous_backup_info', 'secondary_config', 'primary_config', 'satisfies_pzs', 'psc_config', 'maintenance_update_policy', 'maintenance_schedule', 'gemini_config', 'subscription_type', 'trial_metadata', 'tags', 'service_account_email')
