...
class StreamingFeature(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    STREAMING_FEATURE_UNSPECIFIED: _ClassVar[StreamingFeature]
    STREAMING_LABEL_DETECTION: _ClassVar[StreamingFeature]
    STREAMING_SHOT_CHANGE_DETECTION: _ClassVar[StreamingFeature]
    STREAMING_EXPLICIT_CONTENT_DETECTION: _ClassVar[StreamingFeature]
    STREAMING_OBJECT_TRACKING: _ClassVar[StreamingFeature]
    STREAMING_AUTOML_ACTION_RECOGNITION: _ClassVar[StreamingFeature]
    STREAMING_AUTOML_CLASSIFICATION: _ClassVar[StreamingFeature]
    STREAMING_AUTOML_OBJECT_TRACKING: _ClassVar[StreamingFeature]
...
class Feature(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CELEBRITY_RECOGNITION: _ClassVar[Feature]
...
STREAMING_FEATURE_UNSPECIFIED: StreamingFeature
STREAMING_LABEL_DETECTION: StreamingFeature
STREAMING_SHOT_CHANGE_DETECTION: StreamingFeature
STREAMING_EXPLICIT_CONTENT_DETECTION: StreamingFeature
STREAMING_OBJECT_TRACKING: StreamingFeature
STREAMING_AUTOML_ACTION_RECOGNITION: StreamingFeature
STREAMING_AUTOML_CLASSIFICATION: StreamingFeature
STREAMING_AUTOML_OBJECT_TRACKING: StreamingFeature
...
class CelebrityTrack(_message.Message):
    __slots__ = ('celebrities', 'face_track')

    class RecognizedCelebrity(_message.Message):
        ...
        def __init__(self, celebrity: _Optional[_Union[Celebrity, _Mapping]]=..., confidence: _Optional[float]=...) -> None:
            ...
    CELEBRITIES_FIELD_NUMBER: _ClassVar[int]
    FACE_TRACK_FIELD_NUMBER: _ClassVar[int]
    celebrities: _containers.RepeatedCompositeFieldContainer[CelebrityTrack.RecognizedCelebrity]
    face_track: Track

    def __init__(self, celebrities: _Optional[_Iterable[_Union[CelebrityTrack.RecognizedCelebrity, _Mapping]]]=..., face_track: _Optional[_Union[Track, _Mapping]]=...) -> None:
        ...

class CelebrityRecognitionAnnotation(_message.Message):
    __slots__ = ('celebrity_tracks',)
    CELEBRITY_TRACKS_FIELD_NUMBER: _ClassVar[int]
    celebrity_tracks: _containers.RepeatedCompositeFieldContainer[CelebrityTrack]

    def __init__(self, celebrity_tracks: _Optional[_Iterable[_Union[CelebrityTrack, _Mapping]]]=...) -> None:
        ...
...
class FaceDetectionAnnotation(_message.Message):
    __slots__ = ('tracks', 'thumbnail')
    TRACKS_FIELD_NUMBER: _ClassVar[int]
    THUMBNAIL_FIELD_NUMBER: _ClassVar[int]
    tracks: _containers.RepeatedCompositeFieldContainer[Track]
    thumbnail: bytes

    def __init__(self, tracks: _Optional[_Iterable[_Union[Track, _Mapping]]]=..., thumbnail: _Optional[bytes]=...) -> None:
        ...
...
class VideoAnnotationResults(_message.Message):
    __slots__ = ('input_uri', 'segment', 'segment_label_annotations', 'segment_presence_label_annotations', 'shot_label_annotations', 'shot_presence_label_annotations', 'frame_label_annotations', 'face_detection_annotations', 'shot_annotations', 'explicit_annotation', 'speech_transcriptions', 'text_annotations', 'object_annotations', 'logo_recognition_annotations', 'person_detection_annotations', 'celebrity_recognition_annotations', 'error')
    INPUT_URI_FIELD_NUMBER: _ClassVar[int]
    SEGMENT_FIELD_NUMBER: _ClassVar[int]
    ...
    CELEBRITY_RECOGNITION_ANNOTATIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    celebrity_recognition_annotations: CelebrityRecognitionAnnotation
    error: _status_pb2.Status

    def __init__(self, input_uri: _Optional[str]=..., segment: _Optional[_Union[VideoSegment, _Mapping]]=..., segment_label_annotations: _Optional[_Iterable[_Union[LabelAnnotation, _Mapping]]]=..., segment_presence_label_annotations: _Optional[_Iterable[_Union[LabelAnnotation, _Mapping]]]=..., shot_label_annotations: _Optional[_Iterable[_Union[LabelAnnotation, _Mapping]]]=..., shot_presence_label_annotations: _Optional[_Iterable[_Union[LabelAnnotation, _Mapping]]]=..., frame_label_annotations: _Optional[_Iterable[_Union[LabelAnnotation, _Mapping]]]=..., face_detection_annotations: _Optional[_Iterable[_Union[FaceDetectionAnnotation, _Mapping]]]=..., shot_annotations: _Optional[_Iterable[_Union[VideoSegment, _Mapping]]]=..., explicit_annotation: _Optional[_Union[ExplicitContentAnnotation, _Mapping]]=..., speech_transcriptions: _Optional[_Iterable[_Union[SpeechTranscription, _Mapping]]]=..., text_annotations: _Optional[_Iterable[_Union[TextAnnotation, _Mapping]]]=..., object_annotations: _Optional[_Iterable[_Union[ObjectTrackingAnnotation, _Mapping]]]=..., logo_recognition_annotations: _Optional[_Iterable[_Union[LogoRecognitionAnnotation, _Mapping]]]=..., person_detection_annotations: _Optional[_Iterable[_Union[PersonDetectionAnnotation, _Mapping]]]=..., celebrity_recognition_annotations: _Optional[_Union[CelebrityRecognitionAnnotation, _Mapping]]=..., error: _Optional[_Union[_status_pb2.Status, _Mapping]]=...) -> None:
        ...
...
class StreamingAnnotateVideoRequest(_message.Message):
    __slots__ = ('video_config', 'input_content')
    VIDEO_CONFIG_FIELD_NUMBER: _ClassVar[int]
    INPUT_CONTENT_FIELD_NUMBER: _ClassVar[int]
    video_config: StreamingVideoConfig
    input_content: bytes

    def __init__(self, video_config: _Optional[_Union[StreamingVideoConfig, _Mapping]]=..., input_content: _Optional[bytes]=...) -> None:
        ...

class StreamingVideoConfig(_message.Message):
    __slots__ = ('shot_change_detection_config', 'label_detection_config', 'explicit_content_detection_config', 'object_tracking_config', 'automl_action_recognition_config', 'automl_classification_config', 'automl_object_tracking_config', 'feature', 'storage_config')
    SHOT_CHANGE_DETECTION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    LABEL_DETECTION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    EXPLICIT_CONTENT_DETECTION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    OBJECT_TRACKING_CONFIG_FIELD_NUMBER: _ClassVar[int]
    AUTOML_ACTION_RECOGNITION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    AUTOML_CLASSIFICATION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    AUTOML_OBJECT_TRACKING_CONFIG_FIELD_NUMBER: _ClassVar[int]
    FEATURE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, shot_change_detection_config: _Optional[_Union[StreamingShotChangeDetectionConfig, _Mapping]]=..., label_detection_config: _Optional[_Union[StreamingLabelDetectionConfig, _Mapping]]=..., explicit_content_detection_config: _Optional[_Union[StreamingExplicitContentDetectionConfig, _Mapping]]=..., object_tracking_config: _Optional[_Union[StreamingObjectTrackingConfig, _Mapping]]=..., automl_action_recognition_config: _Optional[_Union[StreamingAutomlActionRecognitionConfig, _Mapping]]=..., automl_classification_config: _Optional[_Union[StreamingAutomlClassificationConfig, _Mapping]]=..., automl_object_tracking_config: _Optional[_Union[StreamingAutomlObjectTrackingConfig, _Mapping]]=..., feature: _Optional[_Union[StreamingFeature, str]]=..., storage_config: _Optional[_Union[StreamingStorageConfig, _Mapping]]=...) -> None:
        ...

class StreamingAnnotateVideoResponse(_message.Message):
    __slots__ = ('error', 'annotation_results', 'annotation_results_uri')
    ERROR_FIELD_NUMBER: _ClassVar[int]
    ANNOTATION_RESULTS_FIELD_NUMBER: _ClassVar[int]
    ANNOTATION_RESULTS_URI_FIELD_NUMBER: _ClassVar[int]
    error: _status_pb2.Status
    annotation_results: StreamingVideoAnnotationResults
    annotation_results_uri: str

    def __init__(self, error: _Optional[_Union[_status_pb2.Status, _Mapping]]=..., annotation_results: _Optional[_Union[StreamingVideoAnnotationResults, _Mapping]]=..., annotation_results_uri: _Optional[str]=...) -> None:
        ...

class StreamingVideoAnnotationResults(_message.Message):
    __slots__ = ('shot_annotations', 'label_annotations', 'explicit_annotation', 'object_annotations')
    SHOT_ANNOTATIONS_FIELD_NUMBER: _ClassVar[int]
    LABEL_ANNOTATIONS_FIELD_NUMBER: _ClassVar[int]
    EXPLICIT_ANNOTATION_FIELD_NUMBER: _ClassVar[int]
    OBJECT_ANNOTATIONS_FIELD_NUMBER: _ClassVar[int]
    shot_annotations: _containers.RepeatedCompositeFieldContainer[VideoSegment]
    label_annotations: _containers.RepeatedCompositeFieldContainer[LabelAnnotation]
    explicit_annotation: ExplicitContentAnnotation
    object_annotations: _containers.RepeatedCompositeFieldContainer[ObjectTrackingAnnotation]

    def __init__(self, shot_annotations: _Optional[_Iterable[_Union[VideoSegment, _Mapping]]]=..., label_annotations: _Optional[_Iterable[_Union[LabelAnnotation, _Mapping]]]=..., explicit_annotation: _Optional[_Union[ExplicitContentAnnotation, _Mapping]]=..., object_annotations: _Optional[_Iterable[_Union[ObjectTrackingAnnotation, _Mapping]]]=...) -> None:
        ...

class StreamingShotChangeDetectionConfig(_message.Message):
    __slots__ = ()

    def __init__(self) -> None:
        ...

class StreamingLabelDetectionConfig(_message.Message):
    __slots__ = ('stationary_camera',)
    STATIONARY_CAMERA_FIELD_NUMBER: _ClassVar[int]
    stationary_camera: bool

    def __init__(self, stationary_camera: bool=...) -> None:
        ...

class StreamingExplicitContentDetectionConfig(_message.Message):
    __slots__ = ()

    def __init__(self) -> None:
        ...

class StreamingObjectTrackingConfig(_message.Message):
    __slots__ = ()

    def __init__(self) -> None:
        ...

class StreamingAutomlActionRecognitionConfig(_message.Message):
...
class StreamingAutomlClassificationConfig(_message.Message):
    __slots__ = ('model_name',)
    MODEL_NAME_FIELD_NUMBER: _ClassVar[int]
    model_name: str
...
class StreamingAutomlObjectTrackingConfig(_message.Message):
    __slots__ = ('model_name',)
    MODEL_NAME_FIELD_NUMBER: _ClassVar[int]
    model_name: str
...
class StreamingStorageConfig(_message.Message):
    __slots__ = ('enable_storage_annotation_result', 'annotation_result_storage_directory')
    ENABLE_STORAGE_ANNOTATION_RESULT_FIELD_NUMBER: _ClassVar[int]
    ANNOTATION_RESULT_STORAGE_DIRECTORY_FIELD_NUMBER: _ClassVar[int]
    enable_storage_annotation_result: bool
    annotation_result_storage_directory: str

    def __init__(self, enable_storage_annotation_result: bool=..., annotation_result_storage_directory: _Optional[str]=...) -> None:
        ...