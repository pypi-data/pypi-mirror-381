...
class ModelEvaluation(_message.Message):
    __slots__ = ('classification_evaluation_metrics', 'regression_evaluation_metrics', 'translation_evaluation_metrics', 'image_object_detection_evaluation_metrics', 'video_object_tracking_evaluation_metrics', 'text_sentiment_evaluation_metrics', 'text_extraction_evaluation_metrics', 'name', 'annotation_spec_id', 'display_name', 'create_time', 'evaluated_example_count')
    CLASSIFICATION_EVALUATION_METRICS_FIELD_NUMBER: _ClassVar[int]
    REGRESSION_EVALUATION_METRICS_FIELD_NUMBER: _ClassVar[int]
    ...
    VIDEO_OBJECT_TRACKING_EVALUATION_METRICS_FIELD_NUMBER: _ClassVar[int]
    ...
    regression_evaluation_metrics: _regression_pb2.RegressionEvaluationMetrics
    ...
    video_object_tracking_evaluation_metrics: _detection_pb2.VideoObjectTrackingEvaluationMetrics
