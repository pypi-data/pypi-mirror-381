...
class InstanceInfo(_message.Message):
    __slots__ = ('display_name', 'uri', 'interface', 'network_uri', 'internal_ip', 'external_ip', 'network_tags', 'service_account', 'psc_network_attachment_uri', 'running', 'status')

    class Status(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STATUS_UNSPECIFIED: _ClassVar[InstanceInfo.Status]
        RUNNING: _ClassVar[InstanceInfo.Status]
        NOT_RUNNING: _ClassVar[InstanceInfo.Status]
    STATUS_UNSPECIFIED: InstanceInfo.Status
    RUNNING: InstanceInfo.Status
    NOT_RUNNING: InstanceInfo.Status
    ...
    def __init__(self, display_name: _Optional[str]=..., uri: _Optional[str]=..., interface: _Optional[str]=..., network_uri: _Optional[str]=..., internal_ip: _Optional[str]=..., external_ip: _Optional[str]=..., network_tags: _Optional[_Iterable[str]]=..., service_account: _Optional[str]=..., psc_network_attachment_uri: _Optional[str]=..., running: bool=..., status: _Optional[_Union[InstanceInfo.Status, str]]=...) -> None:
        ...
...
class FirewallInfo(_message.Message):
    __slots__ = ('display_name', 'uri', 'direction', 'action', 'priority', 'network_uri', 'target_tags', 'target_service_accounts', 'policy', 'policy_uri', 'firewall_rule_type', 'policy_priority')
    ...
    POLICY_PRIORITY_FIELD_NUMBER: _ClassVar[int]
    display_name: str
    uri: str
    direction: str
    action: str
...
class RouteInfo(_message.Message):
    ...
    class NextHopType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        SECURE_WEB_PROXY_GATEWAY: _ClassVar[RouteInfo.NextHopType]
    ...
    SECURE_WEB_PROXY_GATEWAY: RouteInfo.NextHopType
...
class DeliverInfo(_message.Message):
    __slots__ = ('target', 'resource_uri', 'ip_address', 'storage_bucket', 'psc_google_api_target', 'google_service_type')
    ...
    class GoogleServiceType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        GOOGLE_SERVICE_TYPE_UNSPECIFIED: _ClassVar[DeliverInfo.GoogleServiceType]
        IAP: _ClassVar[DeliverInfo.GoogleServiceType]
        GFE_PROXY_OR_HEALTH_CHECK_PROBER: _ClassVar[DeliverInfo.GoogleServiceType]
        CLOUD_DNS: _ClassVar[DeliverInfo.GoogleServiceType]
        PRIVATE_GOOGLE_ACCESS: _ClassVar[DeliverInfo.GoogleServiceType]
        SERVERLESS_VPC_ACCESS: _ClassVar[DeliverInfo.GoogleServiceType]
    GOOGLE_SERVICE_TYPE_UNSPECIFIED: DeliverInfo.GoogleServiceType
    IAP: DeliverInfo.GoogleServiceType
    GFE_PROXY_OR_HEALTH_CHECK_PROBER: DeliverInfo.GoogleServiceType
    CLOUD_DNS: DeliverInfo.GoogleServiceType
    PRIVATE_GOOGLE_ACCESS: DeliverInfo.GoogleServiceType
    SERVERLESS_VPC_ACCESS: DeliverInfo.GoogleServiceType
    TARGET_FIELD_NUMBER: _ClassVar[int]
    ...
    storage_bucket: str
    psc_google_api_target: str
    google_service_type: DeliverInfo.GoogleServiceType

    def __init__(self, target: _Optional[_Union[DeliverInfo.Target, str]]=..., resource_uri: _Optional[str]=..., ip_address: _Optional[str]=..., storage_bucket: _Optional[str]=..., psc_google_api_target: _Optional[str]=..., google_service_type: _Optional[_Union[DeliverInfo.GoogleServiceType, str]]=...) -> None:
        ...
...
class ForwardInfo(_message.Message):
    ...
    class Target(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        SECURE_WEB_PROXY_GATEWAY: _ClassVar[ForwardInfo.Target]
    ...
    SECURE_WEB_PROXY_GATEWAY: ForwardInfo.Target
    TARGET_FIELD_NUMBER: _ClassVar[int]
    RESOURCE_URI_FIELD_NUMBER: _ClassVar[int]
    IP_ADDRESS_FIELD_NUMBER: _ClassVar[int]
...
class AbortInfo(_message.Message):
    ...
    class Cause(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        GOOGLE_MANAGED_SERVICE_AMBIGUOUS_ENDPOINT: _ClassVar[AbortInfo.Cause]
    ...
    GOOGLE_MANAGED_SERVICE_AMBIGUOUS_ENDPOINT: AbortInfo.Cause
...
class DropInfo(_message.Message):
    ...
    class Cause(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        NO_ROUTE_FROM_EXTERNAL_IPV6_SOURCE_TO_PRIVATE_IPV6_ADDRESS: _ClassVar[DropInfo.Cause]
        ...
        TRAFFIC_FROM_HYBRID_ENDPOINT_TO_INTERNET_DISALLOWED: _ClassVar[DropInfo.Cause]
        NO_MATCHING_NAT64_GATEWAY: _ClassVar[DropInfo.Cause]
        LOAD_BALANCER_BACKEND_IP_VERSION_MISMATCH: _ClassVar[DropInfo.Cause]
        NO_KNOWN_ROUTE_FROM_NCC_NETWORK_TO_DESTINATION: _ClassVar[DropInfo.Cause]
    ...
    NO_ROUTE_FROM_EXTERNAL_IPV6_SOURCE_TO_PRIVATE_IPV6_ADDRESS: DropInfo.Cause
    ...
    TRAFFIC_FROM_HYBRID_ENDPOINT_TO_INTERNET_DISALLOWED: DropInfo.Cause
    NO_MATCHING_NAT64_GATEWAY: DropInfo.Cause
    LOAD_BALANCER_BACKEND_IP_VERSION_MISMATCH: DropInfo.Cause
    NO_KNOWN_ROUTE_FROM_NCC_NETWORK_TO_DESTINATION: DropInfo.Cause
    CAUSE_FIELD_NUMBER: _ClassVar[int]
    RESOURCE_URI_FIELD_NUMBER: _ClassVar[int]
    SOURCE_IP_FIELD_NUMBER: _ClassVar[int]
    DESTINATION_IP_FIELD_NUMBER: _ClassVar[int]
