...
class VpcFlowLogsConfig(_message.Message):
    __slots__ = ('name', 'description', 'state', 'aggregation_interval', 'flow_sampling', 'metadata', 'metadata_fields', 'filter_expr', 'cross_project_metadata', 'target_resource_state', 'network', 'subnet', 'interconnect_attachment', 'vpn_tunnel', 'labels', 'create_time', 'update_time')
    ...
    class CrossProjectMetadata(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        CROSS_PROJECT_METADATA_UNSPECIFIED: _ClassVar[VpcFlowLogsConfig.CrossProjectMetadata]
        CROSS_PROJECT_METADATA_ENABLED: _ClassVar[VpcFlowLogsConfig.CrossProjectMetadata]
        CROSS_PROJECT_METADATA_DISABLED: _ClassVar[VpcFlowLogsConfig.CrossProjectMetadata]
    CROSS_PROJECT_METADATA_UNSPECIFIED: VpcFlowLogsConfig.CrossProjectMetadata
    CROSS_PROJECT_METADATA_ENABLED: VpcFlowLogsConfig.CrossProjectMetadata
    CROSS_PROJECT_METADATA_DISABLED: VpcFlowLogsConfig.CrossProjectMetadata
    ...
    CROSS_PROJECT_METADATA_FIELD_NUMBER: _ClassVar[int]
    ...
    filter_expr: str
    cross_project_metadata: VpcFlowLogsConfig.CrossProjectMetadata
