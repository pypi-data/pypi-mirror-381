...
class ListConnectorsResponse(_message.Message):
    __slots__ = ('connectors', 'next_page_token', 'unreachable')
    ...
    def __init__(self, connectors: _Optional[_Iterable[_Union[Connector, _Mapping]]]=..., next_page_token: _Optional[str]=..., unreachable: _Optional[_Iterable[str]]=...) -> None:
        ...