...
class NamespaceView(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    NAMESPACE_VIEW_UNSPECIFIED: _ClassVar[NamespaceView]
    NAMESPACE_VIEW_BASIC: _ClassVar[NamespaceView]
    NAMESPACE_VIEW_FULL: _ClassVar[NamespaceView]
NAMESPACE_VIEW_UNSPECIFIED: NamespaceView
NAMESPACE_VIEW_BASIC: NamespaceView
NAMESPACE_VIEW_FULL: NamespaceView
...
class Accelerator(_message.Message):
    ...
    def __init__(self, accelerator_type: _Optional[_Union[Accelerator.AcceleratorType, str]]=...) -> None:
        ...
...
class OperationMetadata(_message.Message):
    __slots__ = ('create_time', 'end_time', 'target', 'verb', 'status_detail', 'requested_cancellation', 'api_version')
    CREATE_TIME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., end_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., target: _Optional[str]=..., verb: _Optional[str]=..., status_detail: _Optional[str]=..., requested_cancellation: bool=..., api_version: _Optional[str]=...) -> None:
        ...

class RemoveIamPolicyRequest(_message.Message):
    __slots__ = ('resource',)
...
class RemoveIamPolicyResponse(_message.Message):
    __slots__ = ()
...
class ListNamespacesRequest(_message.Message):
    ...
    def __init__(self, parent: _Optional[str]=..., page_size: _Optional[int]=..., page_token: _Optional[str]=..., view: _Optional[_Union[NamespaceView, str]]=...) -> None:
        ...

class IAMPolicy(_message.Message):
    __slots__ = ('policy', 'status')
    POLICY_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    policy: _policy_pb2.Policy
    status: _status_pb2.Status

    def __init__(self, policy: _Optional[_Union[_policy_pb2.Policy, _Mapping]]=..., status: _Optional[_Union[_status_pb2.Status, _Mapping]]=...) -> None:
        ...

class Namespace(_message.Message):
    __slots__ = ('name', 'iam_policy')
    NAME_FIELD_NUMBER: _ClassVar[int]
    IAM_POLICY_FIELD_NUMBER: _ClassVar[int]
    name: str
    iam_policy: IAMPolicy

    def __init__(self, name: _Optional[str]=..., iam_policy: _Optional[_Union[IAMPolicy, _Mapping]]=...) -> None:
        ...
...
class DnsPeering(_message.Message):
    __slots__ = ('zone', 'domain', 'description', 'target_project', 'target_network')
    ZONE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, zone: _Optional[str]=..., domain: _Optional[str]=..., description: _Optional[str]=..., target_project: _Optional[str]=..., target_network: _Optional[str]=...) -> None:
        ...

class AddDnsPeeringRequest(_message.Message):
    __slots__ = ('parent', 'dns_peering')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    DNS_PEERING_FIELD_NUMBER: _ClassVar[int]
    parent: str
    dns_peering: DnsPeering

    def __init__(self, parent: _Optional[str]=..., dns_peering: _Optional[_Union[DnsPeering, _Mapping]]=...) -> None:
        ...

class AddDnsPeeringResponse(_message.Message):
    __slots__ = ()

    def __init__(self) -> None:
        ...

class RemoveDnsPeeringRequest(_message.Message):
    __slots__ = ('parent', 'zone')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    ZONE_FIELD_NUMBER: _ClassVar[int]
    parent: str
    zone: str

    def __init__(self, parent: _Optional[str]=..., zone: _Optional[str]=...) -> None:
        ...

class RemoveDnsPeeringResponse(_message.Message):
    __slots__ = ()

    def __init__(self) -> None:
        ...

class ListDnsPeeringsRequest(_message.Message):
...
class ListDnsPeeringsResponse(_message.Message):
    __slots__ = ('dns_peerings', 'next_page_token')
    DNS_PEERINGS_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    dns_peerings: _containers.RepeatedCompositeFieldContainer[DnsPeering]
    next_page_token: str

    def __init__(self, dns_peerings: _Optional[_Iterable[_Union[DnsPeering, _Mapping]]]=..., next_page_token: _Optional[str]=...) -> None:
        ...