...
class ListEndpointPoliciesResponse(_message.Message):
    __slots__ = ('endpoint_policies', 'next_page_token', 'unreachable')
    ...
    def __init__(self, endpoint_policies: _Optional[_Iterable[_Union[EndpointPolicy, _Mapping]]]=..., next_page_token: _Optional[str]=..., unreachable: _Optional[_Iterable[str]]=...) -> None:
        ...
