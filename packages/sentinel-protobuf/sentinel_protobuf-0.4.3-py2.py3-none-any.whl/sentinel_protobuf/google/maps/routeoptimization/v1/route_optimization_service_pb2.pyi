...
class BatchOptimizeToursRequest(_message.Message):
    ...
    class AsyncModelConfig(_message.Message):
        ...
        def __init__(self, display_name: _Optional[str]=..., input_config: _Optional[_Union[InputConfig, _Mapping]]=..., output_config: _Optional[_Union[OutputConfig, _Mapping]]=...) -> None:
            ...
...
class BatchOptimizeToursMetadata(_message.Message):
    __slots__ = ()
...
class ShipmentModel(_message.Message):
    ...
    def __init__(self, shipments: _Optional[_Iterable[_Union[Shipment, _Mapping]]]=..., vehicles: _Optional[_Iterable[_Union[Vehicle, _Mapping]]]=..., max_active_vehicles: _Optional[int]=..., global_start_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., global_end_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., global_duration_cost_per_hour: _Optional[float]=..., duration_distance_matrices: _Optional[_Iterable[_Union[ShipmentModel.DurationDistanceMatrix, _Mapping]]]=..., duration_distance_matrix_src_tags: _Optional[_Iterable[str]]=..., duration_distance_matrix_dst_tags: _Optional[_Iterable[str]]=..., transition_attributes: _Optional[_Iterable[_Union[TransitionAttributes, _Mapping]]]=..., shipment_type_incompatibilities: _Optional[_Iterable[_Union[ShipmentTypeIncompatibility, _Mapping]]]=..., shipment_type_requirements: _Optional[_Iterable[_Union[ShipmentTypeRequirement, _Mapping]]]=..., precedence_rules: _Optional[_Iterable[_Union[ShipmentModel.PrecedenceRule, _Mapping]]]=...) -> None:
        ...

class Shipment(_message.Message):
    __slots__ = ('display_name', 'pickups', 'deliveries', 'load_demands', 'penalty_cost', 'allowed_vehicle_indices', 'costs_per_vehicle', 'costs_per_vehicle_indices', 'pickup_to_delivery_relative_detour_limit', 'pickup_to_delivery_absolute_detour_limit', 'pickup_to_delivery_time_limit', 'shipment_type', 'label', 'ignore')

    class VisitRequest(_message.Message):
        __slots__ = ('arrival_location', 'arrival_waypoint', 'departure_location', 'departure_waypoint', 'tags', 'time_windows', 'duration', 'cost', 'load_demands', 'visit_types', 'label')
    ...
    def __init__(self, display_name: _Optional[str]=..., pickups: _Optional[_Iterable[_Union[Shipment.VisitRequest, _Mapping]]]=..., deliveries: _Optional[_Iterable[_Union[Shipment.VisitRequest, _Mapping]]]=..., load_demands: _Optional[_Mapping[str, Shipment.Load]]=..., penalty_cost: _Optional[float]=..., allowed_vehicle_indices: _Optional[_Iterable[int]]=..., costs_per_vehicle: _Optional[_Iterable[float]]=..., costs_per_vehicle_indices: _Optional[_Iterable[int]]=..., pickup_to_delivery_relative_detour_limit: _Optional[float]=..., pickup_to_delivery_absolute_detour_limit: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., pickup_to_delivery_time_limit: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., shipment_type: _Optional[str]=..., label: _Optional[str]=..., ignore: bool=...) -> None:
        ...
...
class Vehicle(_message.Message):
    __slots__ = ('display_name', 'travel_mode', 'route_modifiers', 'start_location', 'start_waypoint', 'end_location', 'end_waypoint', 'start_tags', 'end_tags', 'start_time_windows', 'end_time_windows', 'travel_duration_multiple', 'unloading_policy', 'load_limits', 'cost_per_hour', 'cost_per_traveled_hour', 'cost_per_kilometer', 'fixed_cost', 'used_if_route_is_empty', 'route_duration_limit', 'travel_duration_limit', 'route_distance_limit', 'extra_visit_duration_for_visit_type', 'break_rule', 'label', 'ignore')
...
class ShipmentRoute(_message.Message):
    __slots__ = ('vehicle_index', 'vehicle_label', 'vehicle_start_time', 'vehicle_end_time', 'visits', 'transitions', 'has_traffic_infeasibilities', 'route_polyline', 'breaks', 'metrics', 'route_costs', 'route_total_cost')

    class Visit(_message.Message):
        __slots__ = ('shipment_index', 'is_pickup', 'visit_request_index', 'start_time', 'load_demands', 'detour', 'shipment_label', 'visit_label')
...
class AggregatedMetrics(_message.Message):
    __slots__ = ('performed_shipment_count', 'travel_duration', 'wait_duration', 'delay_duration', 'break_duration', 'visit_duration', 'total_duration', 'travel_distance_meters', 'max_loads')
