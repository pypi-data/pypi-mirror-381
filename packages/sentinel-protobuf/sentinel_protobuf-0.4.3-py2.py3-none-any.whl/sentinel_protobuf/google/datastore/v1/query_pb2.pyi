...
class EntityResult(_message.Message):
    __slots__ = ('entity', 'version', 'create_time', 'update_time', 'cursor')
    ...
    def __init__(self, entity: _Optional[_Union[_entity_pb2.Entity, _Mapping]]=..., version: _Optional[int]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., cursor: _Optional[bytes]=...) -> None:
        ...

class Query(_message.Message):
    __slots__ = ('projection', 'kind', 'filter', 'order', 'distinct_on', 'start_cursor', 'end_cursor', 'offset', 'limit', 'find_nearest')
...
class AggregationQuery(_message.Message):
    ...
    class Aggregation(_message.Message):
        ...
        count: AggregationQuery.Aggregation.Count
        sum: AggregationQuery.Aggregation.Sum
        avg: AggregationQuery.Aggregation.Avg
        alias: str

        def __init__(self, count: _Optional[_Union[AggregationQuery.Aggregation.Count, _Mapping]]=..., sum: _Optional[_Union[AggregationQuery.Aggregation.Sum, _Mapping]]=..., avg: _Optional[_Union[AggregationQuery.Aggregation.Avg, _Mapping]]=..., alias: _Optional[str]=...) -> None:
            ...
    NESTED_QUERY_FIELD_NUMBER: _ClassVar[int]
    AGGREGATIONS_FIELD_NUMBER: _ClassVar[int]
    nested_query: Query
    aggregations: _containers.RepeatedCompositeFieldContainer[AggregationQuery.Aggregation]

    def __init__(self, nested_query: _Optional[_Union[Query, _Mapping]]=..., aggregations: _Optional[_Iterable[_Union[AggregationQuery.Aggregation, _Mapping]]]=...) -> None:
        ...
...
class PropertyFilter(_message.Message):
    ...
    class Operator(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        IN: _ClassVar[PropertyFilter.Operator]
        NOT_EQUAL: _ClassVar[PropertyFilter.Operator]
        HAS_ANCESTOR: _ClassVar[PropertyFilter.Operator]
        NOT_IN: _ClassVar[PropertyFilter.Operator]
    ...
    IN: PropertyFilter.Operator
    NOT_EQUAL: PropertyFilter.Operator
    HAS_ANCESTOR: PropertyFilter.Operator
    NOT_IN: PropertyFilter.Operator
    PROPERTY_FIELD_NUMBER: _ClassVar[int]
    OP_FIELD_NUMBER: _ClassVar[int]
...
class FindNearest(_message.Message):
    __slots__ = ('vector_property', 'query_vector', 'distance_measure', 'limit', 'distance_result_property', 'distance_threshold')

    class DistanceMeasure(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        DISTANCE_MEASURE_UNSPECIFIED: _ClassVar[FindNearest.DistanceMeasure]
        EUCLIDEAN: _ClassVar[FindNearest.DistanceMeasure]
        COSINE: _ClassVar[FindNearest.DistanceMeasure]
        DOT_PRODUCT: _ClassVar[FindNearest.DistanceMeasure]
    DISTANCE_MEASURE_UNSPECIFIED: FindNearest.DistanceMeasure
    EUCLIDEAN: FindNearest.DistanceMeasure
    COSINE: FindNearest.DistanceMeasure
    DOT_PRODUCT: FindNearest.DistanceMeasure
    ...
    LIMIT_FIELD_NUMBER: _ClassVar[int]
    DISTANCE_RESULT_PROPERTY_FIELD_NUMBER: _ClassVar[int]
    DISTANCE_THRESHOLD_FIELD_NUMBER: _ClassVar[int]
    vector_property: PropertyReference
    query_vector: _entity_pb2.Value
    distance_measure: FindNearest.DistanceMeasure
    limit: _wrappers_pb2.Int32Value
    distance_result_property: str
    distance_threshold: _wrappers_pb2.DoubleValue

    def __init__(self, vector_property: _Optional[_Union[PropertyReference, _Mapping]]=..., query_vector: _Optional[_Union[_entity_pb2.Value, _Mapping]]=..., distance_measure: _Optional[_Union[FindNearest.DistanceMeasure, str]]=..., limit: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]]=..., distance_result_property: _Optional[str]=..., distance_threshold: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]]=...) -> None:
        ...
...
class QueryResultBatch(_message.Message):
    __slots__ = ('skipped_results', 'skipped_cursor', 'entity_result_type', 'entity_results', 'end_cursor', 'more_results', 'snapshot_version', 'read_time')
