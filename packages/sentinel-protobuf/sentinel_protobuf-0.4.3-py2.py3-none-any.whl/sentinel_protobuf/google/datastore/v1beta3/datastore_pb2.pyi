...
from google.datastore.v1beta3 import query_pb2 as _query_pb2
...
class LookupRequest(_message.Message):
    __slots__ = ('project_id', 'read_options', 'keys')
    ...
    def __init__(self, project_id: _Optional[str]=..., read_options: _Optional[_Union[ReadOptions, _Mapping]]=..., keys: _Optional[_Iterable[_Union[_entity_pb2.Key, _Mapping]]]=...) -> None:
        ...
...
class LookupResponse(_message.Message):
    ...
    def __init__(self, found: _Optional[_Iterable[_Union[_query_pb2.EntityResult, _Mapping]]]=..., missing: _Optional[_Iterable[_Union[_query_pb2.EntityResult, _Mapping]]]=..., deferred: _Optional[_Iterable[_Union[_entity_pb2.Key, _Mapping]]]=...) -> None:
        ...

class RunQueryRequest(_message.Message):
    __slots__ = ('project_id', 'partition_id', 'read_options', 'query', 'gql_query')
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, project_id: _Optional[str]=..., partition_id: _Optional[_Union[_entity_pb2.PartitionId, _Mapping]]=..., read_options: _Optional[_Union[ReadOptions, _Mapping]]=..., query: _Optional[_Union[_query_pb2.Query, _Mapping]]=..., gql_query: _Optional[_Union[_query_pb2.GqlQuery, _Mapping]]=...) -> None:
        ...
...
class RunQueryResponse(_message.Message):
    ...
    def __init__(self, batch: _Optional[_Union[_query_pb2.QueryResultBatch, _Mapping]]=..., query: _Optional[_Union[_query_pb2.Query, _Mapping]]=...) -> None:
        ...

class BeginTransactionRequest(_message.Message):
    __slots__ = ('project_id', 'transaction_options')
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    TRANSACTION_OPTIONS_FIELD_NUMBER: _ClassVar[int]
    project_id: str
    transaction_options: TransactionOptions

    def __init__(self, project_id: _Optional[str]=..., transaction_options: _Optional[_Union[TransactionOptions, _Mapping]]=...) -> None:
        ...
...
class RollbackRequest(_message.Message):
    __slots__ = ('project_id', 'transaction')
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    project_id: str
    transaction: bytes

    def __init__(self, project_id: _Optional[str]=..., transaction: _Optional[bytes]=...) -> None:
        ...
...
class CommitRequest(_message.Message):
    __slots__ = ('project_id', 'mode', 'transaction', 'mutations')
    ...
    def __init__(self, project_id: _Optional[str]=..., mode: _Optional[_Union[CommitRequest.Mode, str]]=..., transaction: _Optional[bytes]=..., mutations: _Optional[_Iterable[_Union[Mutation, _Mapping]]]=...) -> None:
        ...
...
class CommitResponse(_message.Message):
    ...
    def __init__(self, mutation_results: _Optional[_Iterable[_Union[MutationResult, _Mapping]]]=..., index_updates: _Optional[int]=...) -> None:
        ...
...
class AllocateIdsRequest(_message.Message):
    ...
    def __init__(self, project_id: _Optional[str]=..., keys: _Optional[_Iterable[_Union[_entity_pb2.Key, _Mapping]]]=...) -> None:
        ...
...
class Mutation(_message.Message):
    __slots__ = ('insert', 'update', 'upsert', 'delete', 'base_version')
    ...
    def __init__(self, insert: _Optional[_Union[_entity_pb2.Entity, _Mapping]]=..., update: _Optional[_Union[_entity_pb2.Entity, _Mapping]]=..., upsert: _Optional[_Union[_entity_pb2.Entity, _Mapping]]=..., delete: _Optional[_Union[_entity_pb2.Key, _Mapping]]=..., base_version: _Optional[int]=...) -> None:
        ...

class MutationResult(_message.Message):
    __slots__ = ('key', 'version', 'conflict_detected')
    ...
    def __init__(self, key: _Optional[_Union[_entity_pb2.Key, _Mapping]]=..., version: _Optional[int]=..., conflict_detected: bool=...) -> None:
        ...
...
class ReadOptions(_message.Message):
    ...
    def __init__(self, read_consistency: _Optional[_Union[ReadOptions.ReadConsistency, str]]=..., transaction: _Optional[bytes]=...) -> None:
        ...
