...
class Model(_message.Message):
    __slots__ = ('name', 'base_model_id', 'version', 'display_name', 'description', 'input_token_limit', 'output_token_limit', 'supported_generation_methods', 'temperature', 'max_temperature', 'top_p', 'top_k')
