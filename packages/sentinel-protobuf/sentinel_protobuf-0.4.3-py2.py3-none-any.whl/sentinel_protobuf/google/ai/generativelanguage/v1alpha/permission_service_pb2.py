...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ai/generativelanguage/v1alpha/permission_service.proto')
_sym_db = _symbol_database.Default()
from .....google.ai.generativelanguage.v1alpha import permission_pb2 as google_dot_ai_dot_generativelanguage_dot_v1alpha_dot_permission__pb2
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n=google/ai/generativelanguage/v1alpha/permission_service.proto\x12$google.ai.generativelanguage.v1alpha\x1a5google/ai/generativelanguage/v1alpha/permission.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto"\xaa\x01\n\x17CreatePermissionRequest\x12D\n\x06parent\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\x12,generativelanguage.googleapis.com/Permission\x12I\n\npermission\x18\x02 \x01(\x0b20.google.ai.generativelanguage.v1alpha.PermissionB\x03\xe0A\x02"Z\n\x14GetPermissionRequest\x12B\n\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n,generativelanguage.googleapis.com/Permission"d\n\x16ListPermissionsRequest\x12\x19\n\x06parent\x18\x01 \x01(\tB\t\xe0A\x02\xfaA\x03\n\x01*\x12\x16\n\tpage_size\x18\x02 \x01(\x05B\x03\xe0A\x01\x12\x17\n\npage_token\x18\x03 \x01(\tB\x03\xe0A\x01"y\n\x17ListPermissionsResponse\x12E\n\x0bpermissions\x18\x01 \x03(\x0b20.google.ai.generativelanguage.v1alpha.Permission\x12\x17\n\x0fnext_page_token\x18\x02 \x01(\t"\x9a\x01\n\x17UpdatePermissionRequest\x12I\n\npermission\x18\x01 \x01(\x0b20.google.ai.generativelanguage.v1alpha.PermissionB\x03\xe0A\x02\x124\n\x0bupdate_mask\x18\x02 \x01(\x0b2\x1a.google.protobuf.FieldMaskB\x03\xe0A\x02"]\n\x17DeletePermissionRequest\x12B\n\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\n,generativelanguage.googleapis.com/Permission"z\n\x18TransferOwnershipRequest\x12B\n\x04name\x18\x01 \x01(\tB4\xe0A\x02\xfaA.\x12,generativelanguage.googleapis.com/Permission\x12\x1a\n\remail_address\x18\x02 \x01(\tB\x03\xe0A\x02"\x1b\n\x19TransferOwnershipResponse2\x82\x0c\n\x11PermissionService\x12\x90\x02\n\x10CreatePermission\x12=.google.ai.generativelanguage.v1alpha.CreatePermissionRequest\x1a0.google.ai.generativelanguage.v1alpha.Permission"\x8a\x01\xdaA\x11parent,permission\x82\xd3\xe4\x93\x02p"+/v1alpha/{parent=tunedModels/*}/permissions:\npermissionZ5"\'/v1alpha/{parent=corpora/*}/permissions:\npermission\x12\xe4\x01\n\rGetPermission\x12:.google.ai.generativelanguage.v1alpha.GetPermissionRequest\x1a0.google.ai.generativelanguage.v1alpha.Permission"e\xdaA\x04name\x82\xd3\xe4\x93\x02X\x12+/v1alpha/{name=tunedModels/*/permissions/*}Z)\x12\'/v1alpha/{name=corpora/*/permissions/*}\x12\xf7\x01\n\x0fListPermissions\x12<.google.ai.generativelanguage.v1alpha.ListPermissionsRequest\x1a=.google.ai.generativelanguage.v1alpha.ListPermissionsResponse"g\xdaA\x06parent\x82\xd3\xe4\x93\x02X\x12+/v1alpha/{parent=tunedModels/*}/permissionsZ)\x12\'/v1alpha/{parent=corpora/*}/permissions\x12\xac\x02\n\x10UpdatePermission\x12=.google.ai.generativelanguage.v1alpha.UpdatePermissionRequest\x1a0.google.ai.generativelanguage.v1alpha.Permission"\xa6\x01\xdaA\x16permission,update_mask\x82\xd3\xe4\x93\x02\x86\x0126/v1alpha/{permission.name=tunedModels/*/permissions/*}:\npermissionZ@22/v1alpha/{permission.name=corpora/*/permissions/*}:\npermission\x12\xd0\x01\n\x10DeletePermission\x12=.google.ai.generativelanguage.v1alpha.DeletePermissionRequest\x1a\x16.google.protobuf.Empty"e\xdaA\x04name\x82\xd3\xe4\x93\x02X*+/v1alpha/{name=tunedModels/*/permissions/*}Z)*\'/v1alpha/{name=corpora/*/permissions/*}\x12\xd0\x01\n\x11TransferOwnership\x12>.google.ai.generativelanguage.v1alpha.TransferOwnershipRequest\x1a?.google.ai.generativelanguage.v1alpha.TransferOwnershipResponse":\x82\xd3\xe4\x93\x024"//v1alpha/{name=tunedModels/*}:transferOwnership:\x01*\x1a$\xcaA!generativelanguage.googleapis.comB\xa4\x01\n(com.google.ai.generativelanguage.v1alphaB\x16PermissionServiceProtoP\x01Z^cloud.google.com/go/ai/generativelanguage/apiv1alpha/generativelanguagepb;generativelanguagepbb\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.ai.generativelanguage.v1alpha.permission_service_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    _globals['DESCRIPTOR']._loaded_options = None
    _globals['DESCRIPTOR']._serialized_options = b'\n(com.google.ai.generativelanguage.v1alphaB\x16PermissionServiceProtoP\x01Z^cloud.google.com/go/ai/generativelanguage/apiv1alpha/generativelanguagepb;generativelanguagepb'
    ...
    _globals['_PERMISSIONSERVICE'].methods_by_name['CreatePermission']._serialized_options = b'\xdaA\x11parent,permission\x82\xd3\xe4\x93\x02p"+/v1alpha/{parent=tunedModels/*}/permissions:\npermissionZ5"\'/v1alpha/{parent=corpora/*}/permissions:\npermission'
    _globals['_PERMISSIONSERVICE'].methods_by_name['GetPermission']._loaded_options = None
    _globals['_PERMISSIONSERVICE'].methods_by_name['GetPermission']._serialized_options = b"\xdaA\x04name\x82\xd3\xe4\x93\x02X\x12+/v1alpha/{name=tunedModels/*/permissions/*}Z)\x12'/v1alpha/{name=corpora/*/permissions/*}"
    _globals['_PERMISSIONSERVICE'].methods_by_name['ListPermissions']._loaded_options = None
    _globals['_PERMISSIONSERVICE'].methods_by_name['ListPermissions']._serialized_options = b"\xdaA\x06parent\x82\xd3\xe4\x93\x02X\x12+/v1alpha/{parent=tunedModels/*}/permissionsZ)\x12'/v1alpha/{parent=corpora/*}/permissions"
    _globals['_PERMISSIONSERVICE'].methods_by_name['UpdatePermission']._loaded_options = None
    _globals['_PERMISSIONSERVICE'].methods_by_name['UpdatePermission']._serialized_options = b'\xdaA\x16permission,update_mask\x82\xd3\xe4\x93\x02\x86\x0126/v1alpha/{permission.name=tunedModels/*/permissions/*}:\npermissionZ@22/v1alpha/{permission.name=corpora/*/permissions/*}:\npermission'
    _globals['_PERMISSIONSERVICE'].methods_by_name['DeletePermission']._loaded_options = None
    _globals['_PERMISSIONSERVICE'].methods_by_name['DeletePermission']._serialized_options = b"\xdaA\x04name\x82\xd3\xe4\x93\x02X*+/v1alpha/{name=tunedModels/*/permissions/*}Z)*'/v1alpha/{name=corpora/*/permissions/*}"
    _globals['_PERMISSIONSERVICE'].methods_by_name['TransferOwnership']._loaded_options = None
    _globals['_PERMISSIONSERVICE'].methods_by_name['TransferOwnership']._serialized_options = b'\x82\xd3\xe4\x93\x024"//v1alpha/{name=tunedModels/*}:transferOwnership:\x01*'
    ...
    _globals['_PERMISSIONSERVICE']._serialized_end = 2770