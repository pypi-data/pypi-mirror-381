from google.ai.generativelanguage.v1beta import citation_pb2 as _citation_pb2
from google.ai.generativelanguage.v1beta import content_pb2 as _content_pb2
from google.ai.generativelanguage.v1beta import retriever_pb2 as _retriever_pb2
from google.ai.generativelanguage.v1beta import safety_pb2 as _safety_pb2
...
class TaskType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CODE_RETRIEVAL_QUERY: _ClassVar[TaskType]
...
class SpeakerVoiceConfig(_message.Message):
    __slots__ = ('speaker', 'voice_config')
    SPEAKER_FIELD_NUMBER: _ClassVar[int]
    VOICE_CONFIG_FIELD_NUMBER: _ClassVar[int]
    speaker: str
    voice_config: VoiceConfig

    def __init__(self, speaker: _Optional[str]=..., voice_config: _Optional[_Union[VoiceConfig, _Mapping]]=...) -> None:
        ...

class MultiSpeakerVoiceConfig(_message.Message):
    __slots__ = ('speaker_voice_configs',)
    SPEAKER_VOICE_CONFIGS_FIELD_NUMBER: _ClassVar[int]
    speaker_voice_configs: _containers.RepeatedCompositeFieldContainer[SpeakerVoiceConfig]

    def __init__(self, speaker_voice_configs: _Optional[_Iterable[_Union[SpeakerVoiceConfig, _Mapping]]]=...) -> None:
        ...

class SpeechConfig(_message.Message):
    __slots__ = ('voice_config', 'multi_speaker_voice_config', 'language_code')
    VOICE_CONFIG_FIELD_NUMBER: _ClassVar[int]
    MULTI_SPEAKER_VOICE_CONFIG_FIELD_NUMBER: _ClassVar[int]
    LANGUAGE_CODE_FIELD_NUMBER: _ClassVar[int]
    voice_config: VoiceConfig
    multi_speaker_voice_config: MultiSpeakerVoiceConfig
    language_code: str

    def __init__(self, voice_config: _Optional[_Union[VoiceConfig, _Mapping]]=..., multi_speaker_voice_config: _Optional[_Union[MultiSpeakerVoiceConfig, _Mapping]]=..., language_code: _Optional[str]=...) -> None:
        ...
...
class GenerationConfig(_message.Message):
    __slots__ = ('candidate_count', 'stop_sequences', 'max_output_tokens', 'temperature', 'top_p', 'top_k', 'seed', 'response_mime_type', 'response_schema', 'response_json_schema', 'presence_penalty', 'frequency_penalty', 'response_logprobs', 'logprobs', 'enable_enhanced_civic_answers', 'response_modalities', 'speech_config', 'thinking_config', 'media_resolution')
    ...
    class MediaResolution(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        MEDIA_RESOLUTION_UNSPECIFIED: _ClassVar[GenerationConfig.MediaResolution]
        MEDIA_RESOLUTION_LOW: _ClassVar[GenerationConfig.MediaResolution]
        MEDIA_RESOLUTION_MEDIUM: _ClassVar[GenerationConfig.MediaResolution]
        MEDIA_RESOLUTION_HIGH: _ClassVar[GenerationConfig.MediaResolution]
    MEDIA_RESOLUTION_UNSPECIFIED: GenerationConfig.MediaResolution
    MEDIA_RESOLUTION_LOW: GenerationConfig.MediaResolution
    MEDIA_RESOLUTION_MEDIUM: GenerationConfig.MediaResolution
    MEDIA_RESOLUTION_HIGH: GenerationConfig.MediaResolution
    ...
    MEDIA_RESOLUTION_FIELD_NUMBER: _ClassVar[int]
    candidate_count: int
    ...
    def __init__(self, candidate_count: _Optional[int]=..., stop_sequences: _Optional[_Iterable[str]]=..., max_output_tokens: _Optional[int]=..., temperature: _Optional[float]=..., top_p: _Optional[float]=..., top_k: _Optional[int]=..., seed: _Optional[int]=..., response_mime_type: _Optional[str]=..., response_schema: _Optional[_Union[_content_pb2.Schema, _Mapping]]=..., response_json_schema: _Optional[_Union[_struct_pb2.Value, _Mapping]]=..., presence_penalty: _Optional[float]=..., frequency_penalty: _Optional[float]=..., response_logprobs: bool=..., logprobs: _Optional[int]=..., enable_enhanced_civic_answers: bool=..., response_modalities: _Optional[_Iterable[_Union[GenerationConfig.Modality, str]]]=..., speech_config: _Optional[_Union[SpeechConfig, _Mapping]]=..., thinking_config: _Optional[_Union[ThinkingConfig, _Mapping]]=..., media_resolution: _Optional[_Union[GenerationConfig.MediaResolution, str]]=...) -> None:
        ...
...
class GenerateContentResponse(_message.Message):
    __slots__ = ('candidates', 'prompt_feedback', 'usage_metadata', 'model_version', 'response_id')
    ...
    class UsageMetadata(_message.Message):
        __slots__ = ('prompt_token_count', 'cached_content_token_count', 'candidates_token_count', 'tool_use_prompt_token_count', 'thoughts_token_count', 'total_token_count', 'prompt_tokens_details', 'cache_tokens_details', 'candidates_tokens_details', 'tool_use_prompt_tokens_details')
        ...
        TOOL_USE_PROMPT_TOKEN_COUNT_FIELD_NUMBER: _ClassVar[int]
        ...
        TOOL_USE_PROMPT_TOKENS_DETAILS_FIELD_NUMBER: _ClassVar[int]
        ...
        tool_use_prompt_tokens_details: _containers.RepeatedCompositeFieldContainer[_content_pb2.ModalityTokenCount]

        def __init__(self, prompt_token_count: _Optional[int]=..., cached_content_token_count: _Optional[int]=..., candidates_token_count: _Optional[int]=..., tool_use_prompt_token_count: _Optional[int]=..., thoughts_token_count: _Optional[int]=..., total_token_count: _Optional[int]=..., prompt_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=..., cache_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=..., candidates_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=..., tool_use_prompt_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=...) -> None:
            ...
    ...
    def __init__(self, candidates: _Optional[_Iterable[_Union[Candidate, _Mapping]]]=..., prompt_feedback: _Optional[_Union[GenerateContentResponse.PromptFeedback, _Mapping]]=..., usage_metadata: _Optional[_Union[GenerateContentResponse.UsageMetadata, _Mapping]]=..., model_version: _Optional[str]=..., response_id: _Optional[str]=...) -> None:
        ...

class Candidate(_message.Message):
    __slots__ = ('index', 'content', 'finish_reason', 'safety_ratings', 'citation_metadata', 'token_count', 'grounding_attributions', 'grounding_metadata', 'avg_logprobs', 'logprobs_result', 'url_context_metadata')
    ...
    class FinishReason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        UNEXPECTED_TOOL_CALL: _ClassVar[Candidate.FinishReason]
    ...
    UNEXPECTED_TOOL_CALL: Candidate.FinishReason
...
class CountTokensResponse(_message.Message):
    __slots__ = ('total_tokens', 'cached_content_token_count', 'prompt_tokens_details', 'cache_tokens_details')
    ...
    def __init__(self, total_tokens: _Optional[int]=..., cached_content_token_count: _Optional[int]=..., prompt_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=..., cache_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=...) -> None:
        ...

class RealtimeInputConfig(_message.Message):
    __slots__ = ('automatic_activity_detection', 'activity_handling', 'turn_coverage')

    class ActivityHandling(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        ACTIVITY_HANDLING_UNSPECIFIED: _ClassVar[RealtimeInputConfig.ActivityHandling]
        START_OF_ACTIVITY_INTERRUPTS: _ClassVar[RealtimeInputConfig.ActivityHandling]
        NO_INTERRUPTION: _ClassVar[RealtimeInputConfig.ActivityHandling]
    ACTIVITY_HANDLING_UNSPECIFIED: RealtimeInputConfig.ActivityHandling
    START_OF_ACTIVITY_INTERRUPTS: RealtimeInputConfig.ActivityHandling
    NO_INTERRUPTION: RealtimeInputConfig.ActivityHandling

    class TurnCoverage(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        TURN_COVERAGE_UNSPECIFIED: _ClassVar[RealtimeInputConfig.TurnCoverage]
        TURN_INCLUDES_ONLY_ACTIVITY: _ClassVar[RealtimeInputConfig.TurnCoverage]
        TURN_INCLUDES_ALL_INPUT: _ClassVar[RealtimeInputConfig.TurnCoverage]
    TURN_COVERAGE_UNSPECIFIED: RealtimeInputConfig.TurnCoverage
    TURN_INCLUDES_ONLY_ACTIVITY: RealtimeInputConfig.TurnCoverage
    TURN_INCLUDES_ALL_INPUT: RealtimeInputConfig.TurnCoverage

    class AutomaticActivityDetection(_message.Message):
        __slots__ = ('disabled', 'start_of_speech_sensitivity', 'prefix_padding_ms', 'end_of_speech_sensitivity', 'silence_duration_ms')

        class StartSensitivity(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            START_SENSITIVITY_UNSPECIFIED: _ClassVar[RealtimeInputConfig.AutomaticActivityDetection.StartSensitivity]
            START_SENSITIVITY_HIGH: _ClassVar[RealtimeInputConfig.AutomaticActivityDetection.StartSensitivity]
            START_SENSITIVITY_LOW: _ClassVar[RealtimeInputConfig.AutomaticActivityDetection.StartSensitivity]
        START_SENSITIVITY_UNSPECIFIED: RealtimeInputConfig.AutomaticActivityDetection.StartSensitivity
        START_SENSITIVITY_HIGH: RealtimeInputConfig.AutomaticActivityDetection.StartSensitivity
        START_SENSITIVITY_LOW: RealtimeInputConfig.AutomaticActivityDetection.StartSensitivity

        class EndSensitivity(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            END_SENSITIVITY_UNSPECIFIED: _ClassVar[RealtimeInputConfig.AutomaticActivityDetection.EndSensitivity]
            END_SENSITIVITY_HIGH: _ClassVar[RealtimeInputConfig.AutomaticActivityDetection.EndSensitivity]
            END_SENSITIVITY_LOW: _ClassVar[RealtimeInputConfig.AutomaticActivityDetection.EndSensitivity]
        END_SENSITIVITY_UNSPECIFIED: RealtimeInputConfig.AutomaticActivityDetection.EndSensitivity
        END_SENSITIVITY_HIGH: RealtimeInputConfig.AutomaticActivityDetection.EndSensitivity
        END_SENSITIVITY_LOW: RealtimeInputConfig.AutomaticActivityDetection.EndSensitivity
        DISABLED_FIELD_NUMBER: _ClassVar[int]
        START_OF_SPEECH_SENSITIVITY_FIELD_NUMBER: _ClassVar[int]
        PREFIX_PADDING_MS_FIELD_NUMBER: _ClassVar[int]
        END_OF_SPEECH_SENSITIVITY_FIELD_NUMBER: _ClassVar[int]
        SILENCE_DURATION_MS_FIELD_NUMBER: _ClassVar[int]
        disabled: bool
        start_of_speech_sensitivity: RealtimeInputConfig.AutomaticActivityDetection.StartSensitivity
        prefix_padding_ms: int
        end_of_speech_sensitivity: RealtimeInputConfig.AutomaticActivityDetection.EndSensitivity
        silence_duration_ms: int

        def __init__(self, disabled: bool=..., start_of_speech_sensitivity: _Optional[_Union[RealtimeInputConfig.AutomaticActivityDetection.StartSensitivity, str]]=..., prefix_padding_ms: _Optional[int]=..., end_of_speech_sensitivity: _Optional[_Union[RealtimeInputConfig.AutomaticActivityDetection.EndSensitivity, str]]=..., silence_duration_ms: _Optional[int]=...) -> None:
            ...
    AUTOMATIC_ACTIVITY_DETECTION_FIELD_NUMBER: _ClassVar[int]
    ACTIVITY_HANDLING_FIELD_NUMBER: _ClassVar[int]
    TURN_COVERAGE_FIELD_NUMBER: _ClassVar[int]
    automatic_activity_detection: RealtimeInputConfig.AutomaticActivityDetection
    activity_handling: RealtimeInputConfig.ActivityHandling
    turn_coverage: RealtimeInputConfig.TurnCoverage

    def __init__(self, automatic_activity_detection: _Optional[_Union[RealtimeInputConfig.AutomaticActivityDetection, _Mapping]]=..., activity_handling: _Optional[_Union[RealtimeInputConfig.ActivityHandling, str]]=..., turn_coverage: _Optional[_Union[RealtimeInputConfig.TurnCoverage, str]]=...) -> None:
        ...

class SessionResumptionConfig(_message.Message):
    __slots__ = ('handle',)
...
class ContextWindowCompressionConfig(_message.Message):
    __slots__ = ('sliding_window', 'trigger_tokens')

    class SlidingWindow(_message.Message):
        __slots__ = ('target_tokens',)
        TARGET_TOKENS_FIELD_NUMBER: _ClassVar[int]
        target_tokens: int

        def __init__(self, target_tokens: _Optional[int]=...) -> None:
            ...
    SLIDING_WINDOW_FIELD_NUMBER: _ClassVar[int]
    TRIGGER_TOKENS_FIELD_NUMBER: _ClassVar[int]
    sliding_window: ContextWindowCompressionConfig.SlidingWindow
    trigger_tokens: int

    def __init__(self, sliding_window: _Optional[_Union[ContextWindowCompressionConfig.SlidingWindow, _Mapping]]=..., trigger_tokens: _Optional[int]=...) -> None:
        ...

class AudioTranscriptionConfig(_message.Message):
    __slots__ = ()
...
class BidiGenerateContentSetup(_message.Message):
    __slots__ = ('model', 'generation_config', 'system_instruction', 'tools', 'realtime_input_config', 'session_resumption', 'context_window_compression', 'input_audio_transcription', 'output_audio_transcription')
    MODEL_FIELD_NUMBER: _ClassVar[int]
    GENERATION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    SYSTEM_INSTRUCTION_FIELD_NUMBER: _ClassVar[int]
    TOOLS_FIELD_NUMBER: _ClassVar[int]
    REALTIME_INPUT_CONFIG_FIELD_NUMBER: _ClassVar[int]
    SESSION_RESUMPTION_FIELD_NUMBER: _ClassVar[int]
    CONTEXT_WINDOW_COMPRESSION_FIELD_NUMBER: _ClassVar[int]
    INPUT_AUDIO_TRANSCRIPTION_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_AUDIO_TRANSCRIPTION_FIELD_NUMBER: _ClassVar[int]
    model: str
    generation_config: GenerationConfig
    system_instruction: _content_pb2.Content
    tools: _containers.RepeatedCompositeFieldContainer[_content_pb2.Tool]
    ...
    def __init__(self, model: _Optional[str]=..., generation_config: _Optional[_Union[GenerationConfig, _Mapping]]=..., system_instruction: _Optional[_Union[_content_pb2.Content, _Mapping]]=..., tools: _Optional[_Iterable[_Union[_content_pb2.Tool, _Mapping]]]=..., realtime_input_config: _Optional[_Union[RealtimeInputConfig, _Mapping]]=..., session_resumption: _Optional[_Union[SessionResumptionConfig, _Mapping]]=..., context_window_compression: _Optional[_Union[ContextWindowCompressionConfig, _Mapping]]=..., input_audio_transcription: _Optional[_Union[AudioTranscriptionConfig, _Mapping]]=..., output_audio_transcription: _Optional[_Union[AudioTranscriptionConfig, _Mapping]]=...) -> None:
        ...
...
class BidiGenerateContentRealtimeInput(_message.Message):
    __slots__ = ('media_chunks', 'audio', 'audio_stream_end', 'video', 'text', 'activity_start', 'activity_end')

    class ActivityStart(_message.Message):
        __slots__ = ()

        def __init__(self) -> None:
            ...

    class ActivityEnd(_message.Message):
        __slots__ = ()
    ...
    AUDIO_STREAM_END_FIELD_NUMBER: _ClassVar[int]
    VIDEO_FIELD_NUMBER: _ClassVar[int]
    TEXT_FIELD_NUMBER: _ClassVar[int]
    ACTIVITY_START_FIELD_NUMBER: _ClassVar[int]
    ACTIVITY_END_FIELD_NUMBER: _ClassVar[int]
    media_chunks: _containers.RepeatedCompositeFieldContainer[_content_pb2.Blob]
    audio: _content_pb2.Blob
    audio_stream_end: bool
    video: _content_pb2.Blob
    text: str
    activity_start: BidiGenerateContentRealtimeInput.ActivityStart
    activity_end: BidiGenerateContentRealtimeInput.ActivityEnd

    def __init__(self, media_chunks: _Optional[_Iterable[_Union[_content_pb2.Blob, _Mapping]]]=..., audio: _Optional[_Union[_content_pb2.Blob, _Mapping]]=..., audio_stream_end: bool=..., video: _Optional[_Union[_content_pb2.Blob, _Mapping]]=..., text: _Optional[str]=..., activity_start: _Optional[_Union[BidiGenerateContentRealtimeInput.ActivityStart, _Mapping]]=..., activity_end: _Optional[_Union[BidiGenerateContentRealtimeInput.ActivityEnd, _Mapping]]=...) -> None:
        ...
...
class BidiGenerateContentServerContent(_message.Message):
    __slots__ = ('model_turn', 'generation_complete', 'turn_complete', 'interrupted', 'grounding_metadata', 'input_transcription', 'output_transcription', 'url_context_metadata')
    MODEL_TURN_FIELD_NUMBER: _ClassVar[int]
    GENERATION_COMPLETE_FIELD_NUMBER: _ClassVar[int]
    TURN_COMPLETE_FIELD_NUMBER: _ClassVar[int]
    INTERRUPTED_FIELD_NUMBER: _ClassVar[int]
    GROUNDING_METADATA_FIELD_NUMBER: _ClassVar[int]
    INPUT_TRANSCRIPTION_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_TRANSCRIPTION_FIELD_NUMBER: _ClassVar[int]
    URL_CONTEXT_METADATA_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, model_turn: _Optional[_Union[_content_pb2.Content, _Mapping]]=..., generation_complete: bool=..., turn_complete: bool=..., interrupted: bool=..., grounding_metadata: _Optional[_Union[GroundingMetadata, _Mapping]]=..., input_transcription: _Optional[_Union[BidiGenerateContentTranscription, _Mapping]]=..., output_transcription: _Optional[_Union[BidiGenerateContentTranscription, _Mapping]]=..., url_context_metadata: _Optional[_Union[UrlContextMetadata, _Mapping]]=...) -> None:
        ...
...
class GoAway(_message.Message):
    ...
    time_left: _duration_pb2.Duration

    def __init__(self, time_left: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=...) -> None:
        ...

class SessionResumptionUpdate(_message.Message):
    __slots__ = ('new_handle', 'resumable')
    NEW_HANDLE_FIELD_NUMBER: _ClassVar[int]
    RESUMABLE_FIELD_NUMBER: _ClassVar[int]
    new_handle: str
    resumable: bool

    def __init__(self, new_handle: _Optional[str]=..., resumable: bool=...) -> None:
        ...

class BidiGenerateContentTranscription(_message.Message):
    __slots__ = ('text',)
    TEXT_FIELD_NUMBER: _ClassVar[int]
    text: str
...
class BidiGenerateContentServerMessage(_message.Message):
    __slots__ = ('setup_complete', 'server_content', 'tool_call', 'tool_call_cancellation', 'go_away', 'session_resumption_update', 'usage_metadata')
    ...
    SESSION_RESUMPTION_UPDATE_FIELD_NUMBER: _ClassVar[int]
    USAGE_METADATA_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, setup_complete: _Optional[_Union[BidiGenerateContentSetupComplete, _Mapping]]=..., server_content: _Optional[_Union[BidiGenerateContentServerContent, _Mapping]]=..., tool_call: _Optional[_Union[BidiGenerateContentToolCall, _Mapping]]=..., tool_call_cancellation: _Optional[_Union[BidiGenerateContentToolCallCancellation, _Mapping]]=..., go_away: _Optional[_Union[GoAway, _Mapping]]=..., session_resumption_update: _Optional[_Union[SessionResumptionUpdate, _Mapping]]=..., usage_metadata: _Optional[_Union[UsageMetadata, _Mapping]]=...) -> None:
        ...

class UsageMetadata(_message.Message):
    __slots__ = ('prompt_token_count', 'cached_content_token_count', 'response_token_count', 'tool_use_prompt_token_count', 'thoughts_token_count', 'total_token_count', 'prompt_tokens_details', 'cache_tokens_details', 'response_tokens_details', 'tool_use_prompt_tokens_details')
    PROMPT_TOKEN_COUNT_FIELD_NUMBER: _ClassVar[int]
    CACHED_CONTENT_TOKEN_COUNT_FIELD_NUMBER: _ClassVar[int]
    RESPONSE_TOKEN_COUNT_FIELD_NUMBER: _ClassVar[int]
    TOOL_USE_PROMPT_TOKEN_COUNT_FIELD_NUMBER: _ClassVar[int]
    THOUGHTS_TOKEN_COUNT_FIELD_NUMBER: _ClassVar[int]
    TOTAL_TOKEN_COUNT_FIELD_NUMBER: _ClassVar[int]
    PROMPT_TOKENS_DETAILS_FIELD_NUMBER: _ClassVar[int]
    CACHE_TOKENS_DETAILS_FIELD_NUMBER: _ClassVar[int]
    RESPONSE_TOKENS_DETAILS_FIELD_NUMBER: _ClassVar[int]
    TOOL_USE_PROMPT_TOKENS_DETAILS_FIELD_NUMBER: _ClassVar[int]
    prompt_token_count: int
    cached_content_token_count: int
    ...
    prompt_tokens_details: _containers.RepeatedCompositeFieldContainer[_content_pb2.ModalityTokenCount]
    cache_tokens_details: _containers.RepeatedCompositeFieldContainer[_content_pb2.ModalityTokenCount]
    response_tokens_details: _containers.RepeatedCompositeFieldContainer[_content_pb2.ModalityTokenCount]
    tool_use_prompt_tokens_details: _containers.RepeatedCompositeFieldContainer[_content_pb2.ModalityTokenCount]

    def __init__(self, prompt_token_count: _Optional[int]=..., cached_content_token_count: _Optional[int]=..., response_token_count: _Optional[int]=..., tool_use_prompt_token_count: _Optional[int]=..., thoughts_token_count: _Optional[int]=..., total_token_count: _Optional[int]=..., prompt_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=..., cache_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=..., response_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=..., tool_use_prompt_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=...) -> None:
        ...