from google.ads.admanager.v1 import company_messages_pb2 as _company_messages_pb2
...
class ListCompaniesResponse(_message.Message):
    __slots__ = ('companies', 'next_page_token', 'total_size')
    COMPANIES_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    TOTAL_SIZE_FIELD_NUMBER: _ClassVar[int]
    companies: _containers.RepeatedCompositeFieldContainer[_company_messages_pb2.Company]
    next_page_token: str
    total_size: int

    def __init__(self, companies: _Optional[_Iterable[_Union[_company_messages_pb2.Company, _Mapping]]]=..., next_page_token: _Optional[str]=..., total_size: _Optional[int]=...) -> None:
        ...