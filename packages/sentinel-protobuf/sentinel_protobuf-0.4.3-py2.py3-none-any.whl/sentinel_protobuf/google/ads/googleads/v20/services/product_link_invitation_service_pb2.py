...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PRODUCTLINKINVITATIONSERVICE'].methods_by_name['CreateProductLinkInvitation']._serialized_options = b'\xdaA#customer_id,product_link_invitation\x82\xd3\xe4\x93\x02A"</v20/customers/{customer_id=*}/productLinkInvitations:create:\x01*'
    _globals['_PRODUCTLINKINVITATIONSERVICE'].methods_by_name['UpdateProductLinkInvitation']._loaded_options = None
    _globals['_PRODUCTLINKINVITATIONSERVICE'].methods_by_name['UpdateProductLinkInvitation']._serialized_options = b'\xdaA8customer_id,product_link_invitation_status,resource_name\x82\xd3\xe4\x93\x02A"</v20/customers/{customer_id=*}/productLinkInvitations:update:\x01*'
    _globals['_PRODUCTLINKINVITATIONSERVICE'].methods_by_name['RemoveProductLinkInvitation']._loaded_options = None
    _globals['_PRODUCTLINKINVITATIONSERVICE'].methods_by_name['RemoveProductLinkInvitation']._serialized_options = b'\xdaA\x19customer_id,resource_name\x82\xd3\xe4\x93\x02A"</v20/customers/{customer_id=*}/productLinkInvitations:remove:\x01*'
