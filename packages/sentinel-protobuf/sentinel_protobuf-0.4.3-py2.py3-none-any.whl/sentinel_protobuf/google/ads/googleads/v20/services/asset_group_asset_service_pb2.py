...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v20/services/asset_group_asset_service.proto')
_sym_db = _symbol_database.Default()
from ......google.ads.googleads.v20.resources import asset_group_asset_pb2 as google_dot_ads_dot_googleads_dot_v20_dot_resources_dot_asset__group__asset__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ASSETGROUPASSETSERVICE'].methods_by_name['MutateAssetGroupAssets']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02;"6/v20/customers/{customer_id=*}/assetGroupAssets:mutate:\x01*'
