...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v20/services/conversion_upload_service.proto')
_sym_db = _symbol_database.Default()
from ......google.ads.googleads.v20.common import consent_pb2 as google_dot_ads_dot_googleads_dot_v20_dot_common_dot_consent__pb2
...
from ......google.ads.googleads.v20.enums import conversion_customer_type_pb2 as google_dot_ads_dot_googleads_dot_v20_dot_enums_dot_conversion__customer__type__pb2
from ......google.ads.googleads.v20.enums import conversion_environment_enum_pb2 as google_dot_ads_dot_googleads_dot_v20_dot_enums_dot_conversion__environment__enum__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONVERSIONUPLOADSERVICE'].methods_by_name['UploadClickConversions']._serialized_options = b'\xdaA\'customer_id,conversions,partial_failure\x82\xd3\xe4\x93\x02:"5/v20/customers/{customer_id=*}:uploadClickConversions:\x01*'
    _globals['_CONVERSIONUPLOADSERVICE'].methods_by_name['UploadCallConversions']._loaded_options = None
    _globals['_CONVERSIONUPLOADSERVICE'].methods_by_name['UploadCallConversions']._serialized_options = b'\xdaA\'customer_id,conversions,partial_failure\x82\xd3\xe4\x93\x029"4/v20/customers/{customer_id=*}:uploadCallConversions:\x01*'
    _globals['_UPLOADCLICKCONVERSIONSREQUEST']._serialized_start = 507
    _globals['_UPLOADCLICKCONVERSIONSREQUEST']._serialized_end = 755
    _globals['_UPLOADCLICKCONVERSIONSRESPONSE']._serialized_start = 758
    _globals['_UPLOADCLICKCONVERSIONSRESPONSE']._serialized_end = 932
    _globals['_UPLOADCALLCONVERSIONSREQUEST']._serialized_start = 935
    _globals['_UPLOADCALLCONVERSIONSREQUEST']._serialized_end = 1121
    _globals['_UPLOADCALLCONVERSIONSRESPONSE']._serialized_start = 1124
    _globals['_UPLOADCALLCONVERSIONSRESPONSE']._serialized_end = 1280
    _globals['_CLICKCONVERSION']._serialized_start = 1283
    _globals['_CLICKCONVERSION']._serialized_end = 2432
    _globals['_CALLCONVERSION']._serialized_start = 2435
    _globals['_CALLCONVERSION']._serialized_end = 2897
    _globals['_EXTERNALATTRIBUTIONDATA']._serialized_start = 2900
    _globals['_EXTERNALATTRIBUTIONDATA']._serialized_end = 3071
    _globals['_CLICKCONVERSIONRESULT']._serialized_start = 3074
    _globals['_CLICKCONVERSIONRESULT']._serialized_end = 3348
    _globals['_CALLCONVERSIONRESULT']._serialized_start = 3351
    _globals['_CALLCONVERSIONRESULT']._serialized_end = 3585
    _globals['_CUSTOMVARIABLE']._serialized_start = 3587
    _globals['_CUSTOMVARIABLE']._serialized_end = 3710
    _globals['_CARTDATA']._serialized_start = 3713
    _globals['_CARTDATA']._serialized_end = 3962
    _globals['_CARTDATA_ITEM']._serialized_start = 3898
    _globals['_CARTDATA_ITEM']._serialized_end = 3962
    _globals['_SESSIONATTRIBUTEKEYVALUEPAIR']._serialized_start = 3964
    _globals['_SESSIONATTRIBUTEKEYVALUEPAIR']._serialized_end = 4068
    _globals['_SESSIONATTRIBUTESKEYVALUEPAIRS']._serialized_start = 4070
    _globals['_SESSIONATTRIBUTESKEYVALUEPAIRS']._serialized_end = 4197
    _globals['_CONVERSIONUPLOADSERVICE']._serialized_start = 4200
    _globals['_CONVERSIONUPLOADSERVICE']._serialized_end = 4828