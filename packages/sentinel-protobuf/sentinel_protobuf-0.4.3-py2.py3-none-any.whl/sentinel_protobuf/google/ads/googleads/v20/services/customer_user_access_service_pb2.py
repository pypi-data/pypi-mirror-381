...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CUSTOMERUSERACCESSSERVICE'].methods_by_name['MutateCustomerUserAccess']._serialized_options = b'\xdaA\x15customer_id,operation\x82\xd3\xe4\x93\x02?":/v20/customers/{customer_id=*}/customerUserAccesses:mutate:\x01*'
