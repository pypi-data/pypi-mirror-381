...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v20/services/conversion_goal_campaign_config_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONVERSIONGOALCAMPAIGNCONFIGSERVICE'].methods_by_name['MutateConversionGoalCampaignConfigs']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02H"C/v20/customers/{customer_id=*}/conversionGoalCampaignConfigs:mutate:\x01*'
