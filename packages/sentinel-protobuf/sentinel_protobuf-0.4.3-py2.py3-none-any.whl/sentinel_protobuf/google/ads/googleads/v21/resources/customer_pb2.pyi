...
from google.ads.googleads.v21.enums import conversion_tracking_status_enum_pb2 as _conversion_tracking_status_enum_pb2
from google.ads.googleads.v21.enums import customer_pay_per_conversion_eligibility_failure_reason_pb2 as _customer_pay_per_conversion_eligibility_failure_reason_pb2
from google.ads.googleads.v21.enums import customer_status_pb2 as _customer_status_pb2
from google.ads.googleads.v21.enums import local_services_verification_status_pb2 as _local_services_verification_status_pb2
...
class Customer(_message.Message):
    ...
    VIDEO_CUSTOMER_FIELD_NUMBER: _ClassVar[int]
    resource_name: str
    id: int
...
class VideoCustomer(_message.Message):
    __slots__ = ('third_party_integration_partners',)
    THIRD_PARTY_INTEGRATION_PARTNERS_FIELD_NUMBER: _ClassVar[int]
    third_party_integration_partners: _third_party_integration_partners_pb2.CustomerThirdPartyIntegrationPartners

    def __init__(self, third_party_integration_partners: _Optional[_Union[_third_party_integration_partners_pb2.CustomerThirdPartyIntegrationPartners, _Mapping]]=...) -> None:
        ...