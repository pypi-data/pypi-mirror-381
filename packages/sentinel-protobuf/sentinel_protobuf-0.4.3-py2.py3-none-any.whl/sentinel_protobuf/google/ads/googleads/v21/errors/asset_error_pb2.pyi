...
class AssetErrorEnum(_message.Message):
    ...
    class AssetError(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS: _ClassVar[AssetErrorEnum.AssetError]
        PROMOTION_BARCODE_INVALID_FORMAT: _ClassVar[AssetErrorEnum.AssetError]
        UNSUPPORTED_BARCODE_TYPE: _ClassVar[AssetErrorEnum.AssetError]
        PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS: _ClassVar[AssetErrorEnum.AssetError]
        PROMOTION_QR_CODE_INVALID_FORMAT: _ClassVar[AssetErrorEnum.AssetError]
    ...
    PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS: AssetErrorEnum.AssetError
    PROMOTION_BARCODE_INVALID_FORMAT: AssetErrorEnum.AssetError
    UNSUPPORTED_BARCODE_TYPE: AssetErrorEnum.AssetError
    PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS: AssetErrorEnum.AssetError
    PROMOTION_QR_CODE_INVALID_FORMAT: AssetErrorEnum.AssetError
