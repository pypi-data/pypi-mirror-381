...
class BiddingErrorEnum(_message.Message):
    ...
    class BiddingError(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        TARGET_ROAS_TOLERANCE_PERCENT_MILLIS_MUST_BE_INTEGER: _ClassVar[BiddingErrorEnum.BiddingError]
    ...
    TARGET_ROAS_TOLERANCE_PERCENT_MILLIS_MUST_BE_INTEGER: BiddingErrorEnum.BiddingError
