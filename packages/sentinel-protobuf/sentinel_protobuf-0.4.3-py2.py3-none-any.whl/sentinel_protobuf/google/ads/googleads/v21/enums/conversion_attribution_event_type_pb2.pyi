...
class ConversionAttributionEventTypeEnum(_message.Message):
    ...
    class ConversionAttributionEventType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        ENGAGED_VIEW: _ClassVar[ConversionAttributionEventTypeEnum.ConversionAttributionEventType]
    ...
    ENGAGED_VIEW: ConversionAttributionEventTypeEnum.ConversionAttributionEventType
