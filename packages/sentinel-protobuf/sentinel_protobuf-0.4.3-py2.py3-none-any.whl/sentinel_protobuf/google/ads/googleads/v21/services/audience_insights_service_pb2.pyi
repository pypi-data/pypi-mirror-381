...
from google.ads.googleads.v21.enums import audience_insights_marketing_objective_pb2 as _audience_insights_marketing_objective_pb2
...
class GenerateTargetingSuggestionMetricsRequest(_message.Message):
    ...
    INSIGHTS_APPLICATION_INFO_FIELD_NUMBER: _ClassVar[int]
    customer_id: str
    audiences: _containers.RepeatedCompositeFieldContainer[InsightsAudience]
    customer_insights_group: str
    insights_application_info: _additional_application_info_pb2.AdditionalApplicationInfo

    def __init__(self, customer_id: _Optional[str]=..., audiences: _Optional[_Iterable[_Union[InsightsAudience, _Mapping]]]=..., customer_insights_group: _Optional[str]=..., insights_application_info: _Optional[_Union[_additional_application_info_pb2.AdditionalApplicationInfo, _Mapping]]=...) -> None:
        ...
...
class InsightsAudience(_message.Message):
    __slots__ = ('country_locations', 'sub_country_locations', 'gender', 'age_ranges', 'parental_status', 'income_ranges', 'lineups', 'user_list', 'topic_audience_combinations')
    COUNTRY_LOCATIONS_FIELD_NUMBER: _ClassVar[int]
    SUB_COUNTRY_LOCATIONS_FIELD_NUMBER: _ClassVar[int]
    GENDER_FIELD_NUMBER: _ClassVar[int]
    AGE_RANGES_FIELD_NUMBER: _ClassVar[int]
