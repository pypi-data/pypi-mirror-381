...
class ClickTypeEnum(_message.Message):
    ...
    class ClickType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        VEHICLE_ASSETS: _ClassVar[ClickTypeEnum.ClickType]
        PRODUCT_ASSETS: _ClassVar[ClickTypeEnum.ClickType]
        VIDEO_CHANNEL_CLICK: _ClassVar[ClickTypeEnum.ClickType]
        VIDEO_RELATED_VIDEOS_CLICK: _ClassVar[ClickTypeEnum.ClickType]
    ...
    VEHICLE_ASSETS: ClickTypeEnum.ClickType
    PRODUCT_ASSETS: ClickTypeEnum.ClickType
    VIDEO_CHANNEL_CLICK: ClickTypeEnum.ClickType
    VIDEO_RELATED_VIDEOS_CLICK: ClickTypeEnum.ClickType
