...
class CustomerNegativeCriterion(_message.Message):
    __slots__ = ('resource_name', 'id', 'type', 'content_label', 'mobile_application', 'mobile_app_category', 'placement', 'youtube_video', 'youtube_channel', 'negative_keyword_list', 'ip_block', 'placement_list')
    ...
    PLACEMENT_LIST_FIELD_NUMBER: _ClassVar[int]
    resource_name: str
    id: int
