...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v21/services/campaign_asset_set_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CAMPAIGNASSETSETSERVICE'].methods_by_name['MutateCampaignAssetSets']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02<"7/v21/customers/{customer_id=*}/campaignAssetSets:mutate:\x01*'
