from google.ads.googleads.v21.common import bidding_pb2 as _bidding_pb2
from google.ads.googleads.v21.common import custom_parameter_pb2 as _custom_parameter_pb2
from google.ads.googleads.v21.common import frequency_cap_pb2 as _frequency_cap_pb2
from google.ads.googleads.v21.common import real_time_bidding_setting_pb2 as _real_time_bidding_setting_pb2
from google.ads.googleads.v21.common import targeting_setting_pb2 as _targeting_setting_pb2
from google.ads.googleads.v21.common import third_party_integration_partners_pb2 as _third_party_integration_partners_pb2
from google.ads.googleads.v21.enums import ad_group_type_pb2 as _ad_group_type_pb2
from google.ads.googleads.v21.enums import ad_serving_optimization_status_pb2 as _ad_serving_optimization_status_pb2
...
from google.ads.googleads.v21.enums import app_campaign_app_store_pb2 as _app_campaign_app_store_pb2
from google.ads.googleads.v21.enums import app_campaign_bidding_strategy_goal_type_pb2 as _app_campaign_bidding_strategy_goal_type_pb2
from google.ads.googleads.v21.enums import asset_automation_status_pb2 as _asset_automation_status_pb2
from google.ads.googleads.v21.enums import asset_automation_type_pb2 as _asset_automation_type_pb2
from google.ads.googleads.v21.enums import asset_field_type_pb2 as _asset_field_type_pb2
from google.ads.googleads.v21.enums import asset_set_type_pb2 as _asset_set_type_pb2
from google.ads.googleads.v21.enums import bidding_strategy_system_status_pb2 as _bidding_strategy_system_status_pb2
from google.ads.googleads.v21.enums import bidding_strategy_type_pb2 as _bidding_strategy_type_pb2
from google.ads.googleads.v21.enums import brand_safety_suitability_pb2 as _brand_safety_suitability_pb2
from google.ads.googleads.v21.enums import campaign_experiment_type_pb2 as _campaign_experiment_type_pb2
from google.ads.googleads.v21.enums import campaign_keyword_match_type_pb2 as _campaign_keyword_match_type_pb2
from google.ads.googleads.v21.enums import campaign_primary_status_pb2 as _campaign_primary_status_pb2
from google.ads.googleads.v21.enums import campaign_primary_status_reason_pb2 as _campaign_primary_status_reason_pb2
from google.ads.googleads.v21.enums import campaign_serving_status_pb2 as _campaign_serving_status_pb2
from google.ads.googleads.v21.enums import campaign_status_pb2 as _campaign_status_pb2
from google.ads.googleads.v21.enums import eu_political_advertising_status_pb2 as _eu_political_advertising_status_pb2
from google.ads.googleads.v21.enums import listing_type_pb2 as _listing_type_pb2
from google.ads.googleads.v21.enums import location_source_type_pb2 as _location_source_type_pb2
from google.ads.googleads.v21.enums import negative_geo_target_type_pb2 as _negative_geo_target_type_pb2
from google.ads.googleads.v21.enums import non_skippable_max_duration_pb2 as _non_skippable_max_duration_pb2
from google.ads.googleads.v21.enums import non_skippable_min_duration_pb2 as _non_skippable_min_duration_pb2
from google.ads.googleads.v21.enums import optimization_goal_type_pb2 as _optimization_goal_type_pb2
from google.ads.googleads.v21.enums import payment_mode_pb2 as _payment_mode_pb2
from google.ads.googleads.v21.enums import performance_max_upgrade_status_pb2 as _performance_max_upgrade_status_pb2
from google.ads.googleads.v21.enums import positive_geo_target_type_pb2 as _positive_geo_target_type_pb2
from google.ads.googleads.v21.enums import vanity_pharma_display_url_mode_pb2 as _vanity_pharma_display_url_mode_pb2
from google.ads.googleads.v21.enums import vanity_pharma_text_pb2 as _vanity_pharma_text_pb2
from google.ads.googleads.v21.enums import video_ad_format_restriction_pb2 as _video_ad_format_restriction_pb2
from google.ads.googleads.v21.enums import video_ad_sequence_interaction_type_pb2 as _video_ad_sequence_interaction_type_pb2
from google.ads.googleads.v21.enums import video_ad_sequence_minimum_duration_pb2 as _video_ad_sequence_minimum_duration_pb2
...
class Campaign(_message.Message):
    ...
    class VideoCampaignSettings(_message.Message):
        __slots__ = ('video_ad_sequence', 'video_ad_inventory_control', 'video_ad_format_control')

        class VideoAdInventoryControl(_message.Message):
            __slots__ = ('allow_in_stream', 'allow_in_feed', 'allow_shorts', 'allow_non_skippable_in_stream')
            ...
            ALLOW_NON_SKIPPABLE_IN_STREAM_FIELD_NUMBER: _ClassVar[int]
            allow_in_stream: bool
            allow_in_feed: bool
            allow_shorts: bool
            allow_non_skippable_in_stream: bool

            def __init__(self, allow_in_stream: bool=..., allow_in_feed: bool=..., allow_shorts: bool=..., allow_non_skippable_in_stream: bool=...) -> None:
                ...
        ...
        class VideoAdSequence(_message.Message):
            __slots__ = ('steps', 'minimum_duration')
            STEPS_FIELD_NUMBER: _ClassVar[int]
            MINIMUM_DURATION_FIELD_NUMBER: _ClassVar[int]
            steps: _containers.RepeatedCompositeFieldContainer[Campaign.VideoCampaignSettings.VideoAdSequenceStep]
            minimum_duration: _video_ad_sequence_minimum_duration_pb2.VideoAdSequenceMinimumDurationEnum.VideoAdSequenceMinimumDuration

            def __init__(self, steps: _Optional[_Iterable[_Union[Campaign.VideoCampaignSettings.VideoAdSequenceStep, _Mapping]]]=..., minimum_duration: _Optional[_Union[_video_ad_sequence_minimum_duration_pb2.VideoAdSequenceMinimumDurationEnum.VideoAdSequenceMinimumDuration, str]]=...) -> None:
                ...

        class VideoAdSequenceStep(_message.Message):
            __slots__ = ('video_ad_sequence_step_id', 'asset_id', 'ad_group_type', 'previous_step_id', 'previous_step_interaction_type')
            VIDEO_AD_SEQUENCE_STEP_ID_FIELD_NUMBER: _ClassVar[int]
            ASSET_ID_FIELD_NUMBER: _ClassVar[int]
            AD_GROUP_TYPE_FIELD_NUMBER: _ClassVar[int]
            PREVIOUS_STEP_ID_FIELD_NUMBER: _ClassVar[int]
            PREVIOUS_STEP_INTERACTION_TYPE_FIELD_NUMBER: _ClassVar[int]
            video_ad_sequence_step_id: int
            asset_id: int
            ad_group_type: _ad_group_type_pb2.AdGroupTypeEnum.AdGroupType
            previous_step_id: int
            previous_step_interaction_type: _video_ad_sequence_interaction_type_pb2.VideoAdSequenceInteractionTypeEnum.VideoAdSequenceInteractionType

            def __init__(self, video_ad_sequence_step_id: _Optional[int]=..., asset_id: _Optional[int]=..., ad_group_type: _Optional[_Union[_ad_group_type_pb2.AdGroupTypeEnum.AdGroupType, str]]=..., previous_step_id: _Optional[int]=..., previous_step_interaction_type: _Optional[_Union[_video_ad_sequence_interaction_type_pb2.VideoAdSequenceInteractionTypeEnum.VideoAdSequenceInteractionType, str]]=...) -> None:
                ...
        VIDEO_AD_SEQUENCE_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, video_ad_sequence: _Optional[_Union[Campaign.VideoCampaignSettings.VideoAdSequence, _Mapping]]=..., video_ad_inventory_control: _Optional[_Union[Campaign.VideoCampaignSettings.VideoAdInventoryControl, _Mapping]]=..., video_ad_format_control: _Optional[_Union[Campaign.VideoCampaignSettings.VideoAdFormatControl, _Mapping]]=...) -> None:
            ...
    ...
    class AiMaxSetting(_message.Message):
        __slots__ = ('enable_ai_max', 'bundling_required')

        class AiMaxBundlingRequired(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            UNSPECIFIED: _ClassVar[Campaign.AiMaxSetting.AiMaxBundlingRequired]
            UNKNOWN: _ClassVar[Campaign.AiMaxSetting.AiMaxBundlingRequired]
            NOT_REQUIRED: _ClassVar[Campaign.AiMaxSetting.AiMaxBundlingRequired]
            REQUIRED: _ClassVar[Campaign.AiMaxSetting.AiMaxBundlingRequired]
        UNSPECIFIED: Campaign.AiMaxSetting.AiMaxBundlingRequired
        UNKNOWN: Campaign.AiMaxSetting.AiMaxBundlingRequired
        NOT_REQUIRED: Campaign.AiMaxSetting.AiMaxBundlingRequired
        REQUIRED: Campaign.AiMaxSetting.AiMaxBundlingRequired
        ENABLE_AI_MAX_FIELD_NUMBER: _ClassVar[int]
        BUNDLING_REQUIRED_FIELD_NUMBER: _ClassVar[int]
        enable_ai_max: bool
        bundling_required: Campaign.AiMaxSetting.AiMaxBundlingRequired

        def __init__(self, enable_ai_max: bool=..., bundling_required: _Optional[_Union[Campaign.AiMaxSetting.AiMaxBundlingRequired, str]]=...) -> None:
            ...
    ...
    THIRD_PARTY_INTEGRATION_PARTNERS_FIELD_NUMBER: _ClassVar[int]
    AI_MAX_SETTING_FIELD_NUMBER: _ClassVar[int]
    ...
    third_party_integration_partners: _third_party_integration_partners_pb2.CampaignThirdPartyIntegrationPartners
