from google.ads.googleads.v21.common import additional_application_info_pb2 as _additional_application_info_pb2
from google.ads.googleads.v21.common import audience_insights_attribute_pb2 as _audience_insights_attribute_pb2
from google.ads.googleads.v21.common import criteria_pb2 as _criteria_pb2
from google.ads.googleads.v21.enums import insights_trend_pb2 as _insights_trend_pb2
...
class GenerateCreatorInsightsRequest(_message.Message):
    __slots__ = ('customer_id', 'customer_insights_group', 'insights_application_info', 'country_locations', 'sub_country_locations', 'search_attributes', 'search_brand', 'search_channels')
...
class GenerateTrendingInsightsRequest(_message.Message):
    __slots__ = ('customer_id', 'customer_insights_group', 'insights_application_info', 'country_location', 'search_audience', 'search_topics')
    CUSTOMER_ID_FIELD_NUMBER: _ClassVar[int]
    CUSTOMER_INSIGHTS_GROUP_FIELD_NUMBER: _ClassVar[int]
    INSIGHTS_APPLICATION_INFO_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, customer_id: _Optional[str]=..., customer_insights_group: _Optional[str]=..., insights_application_info: _Optional[_Union[_additional_application_info_pb2.AdditionalApplicationInfo, _Mapping]]=..., country_location: _Optional[_Union[_criteria_pb2.LocationInfo, _Mapping]]=..., search_audience: _Optional[_Union[SearchAudience, _Mapping]]=..., search_topics: _Optional[_Union[SearchTopics, _Mapping]]=...) -> None:
        ...
...
class YouTubeMetrics(_message.Message):
    __slots__ = ('subscriber_count', 'views_count', 'video_count', 'likes_count', 'shares_count', 'comments_count', 'engagement_rate', 'average_views_per_video', 'average_likes_per_video', 'average_shares_per_video', 'average_comments_per_video', 'shorts_views_count', 'shorts_video_count', 'is_active_shorts_creator', 'is_brand_connect_creator')
    ...
    SHARES_COUNT_FIELD_NUMBER: _ClassVar[int]
    COMMENTS_COUNT_FIELD_NUMBER: _ClassVar[int]
    ENGAGEMENT_RATE_FIELD_NUMBER: _ClassVar[int]
    AVERAGE_VIEWS_PER_VIDEO_FIELD_NUMBER: _ClassVar[int]
    AVERAGE_LIKES_PER_VIDEO_FIELD_NUMBER: _ClassVar[int]
    AVERAGE_SHARES_PER_VIDEO_FIELD_NUMBER: _ClassVar[int]
    AVERAGE_COMMENTS_PER_VIDEO_FIELD_NUMBER: _ClassVar[int]
    SHORTS_VIEWS_COUNT_FIELD_NUMBER: _ClassVar[int]
    SHORTS_VIDEO_COUNT_FIELD_NUMBER: _ClassVar[int]
    IS_ACTIVE_SHORTS_CREATOR_FIELD_NUMBER: _ClassVar[int]
    IS_BRAND_CONNECT_CREATOR_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, subscriber_count: _Optional[int]=..., views_count: _Optional[int]=..., video_count: _Optional[int]=..., likes_count: _Optional[int]=..., shares_count: _Optional[int]=..., comments_count: _Optional[int]=..., engagement_rate: _Optional[float]=..., average_views_per_video: _Optional[float]=..., average_likes_per_video: _Optional[float]=..., average_shares_per_video: _Optional[float]=..., average_comments_per_video: _Optional[float]=..., shorts_views_count: _Optional[int]=..., shorts_video_count: _Optional[int]=..., is_active_shorts_creator: bool=..., is_brand_connect_creator: bool=...) -> None:
        ...

class YouTubeChannelInsights(_message.Message):
    __slots__ = ('display_name', 'youtube_channel', 'channel_url', 'channel_description', 'handle', 'thumbnail_url', 'publish_date', 'country_location', 'channel_metrics', 'channel_audience_attributes', 'channel_attributes', 'top_videos', 'channel_type')
...
class TrendInsightMetrics(_message.Message):
    __slots__ = ('views_count', 'audience_share')
    VIEWS_COUNT_FIELD_NUMBER: _ClassVar[int]
    AUDIENCE_SHARE_FIELD_NUMBER: _ClassVar[int]
    views_count: int
    audience_share: float

    def __init__(self, views_count: _Optional[int]=..., audience_share: _Optional[float]=...) -> None:
        ...