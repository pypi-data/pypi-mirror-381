...
from google.ads.googleads.v21.enums import ad_group_ad_rotation_mode_pb2 as _ad_group_ad_rotation_mode_pb2
from google.ads.googleads.v21.enums import ad_group_primary_status_pb2 as _ad_group_primary_status_pb2
from google.ads.googleads.v21.enums import ad_group_primary_status_reason_pb2 as _ad_group_primary_status_reason_pb2
from google.ads.googleads.v21.enums import ad_group_status_pb2 as _ad_group_status_pb2
...
from google.ads.googleads.v21.enums import demand_gen_channel_config_pb2 as _demand_gen_channel_config_pb2
from google.ads.googleads.v21.enums import demand_gen_channel_strategy_pb2 as _demand_gen_channel_strategy_pb2
from google.ads.googleads.v21.enums import targeting_dimension_pb2 as _targeting_dimension_pb2
...
class AdGroup(_message.Message):
    ...
    class VideoAdGroupSettings(_message.Message):
        __slots__ = ('video_ad_sequence',)

        class VideoAdSequenceStepSetting(_message.Message):
            __slots__ = ('step_id',)
        ...
        def __init__(self, video_ad_sequence: _Optional[_Union[AdGroup.VideoAdGroupSettings.VideoAdSequenceStepSetting, _Mapping]]=...) -> None:
            ...

    class AiMaxAdGroupSetting(_message.Message):
        __slots__ = ('disable_search_term_matching',)
        DISABLE_SEARCH_TERM_MATCHING_FIELD_NUMBER: _ClassVar[int]
        disable_search_term_matching: bool

        def __init__(self, disable_search_term_matching: bool=...) -> None:
            ...
    ...
    VIDEO_AD_GROUP_SETTINGS_FIELD_NUMBER: _ClassVar[int]
    AI_MAX_AD_GROUP_SETTING_FIELD_NUMBER: _ClassVar[int]
    resource_name: str
    id: int
    name: str
