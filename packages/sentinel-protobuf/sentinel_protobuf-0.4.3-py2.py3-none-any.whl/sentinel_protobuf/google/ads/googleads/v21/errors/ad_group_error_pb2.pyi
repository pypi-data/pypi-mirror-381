...
class AdGroupErrorEnum(_message.Message):
    ...
    class AdGroupError(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING: _ClassVar[AdGroupErrorEnum.AdGroupError]
        INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING: _ClassVar[AdGroupErrorEnum.AdGroupError]
        DUPLICATE_STEP_ID: _ClassVar[AdGroupErrorEnum.AdGroupError]
    ...
    INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING: AdGroupErrorEnum.AdGroupError
    INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING: AdGroupErrorEnum.AdGroupError
    DUPLICATE_STEP_ID: AdGroupErrorEnum.AdGroupError
