...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v19/services/ad_group_customizer_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ADGROUPCUSTOMIZERSERVICE'].methods_by_name['MutateAdGroupCustomizers']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02="8/v19/customers/{customer_id=*}/adGroupCustomizers:mutate:\x01*'
