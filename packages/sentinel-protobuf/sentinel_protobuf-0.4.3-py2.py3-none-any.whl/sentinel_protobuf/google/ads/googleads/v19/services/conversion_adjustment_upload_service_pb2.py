...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v19/services/conversion_adjustment_upload_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONVERSIONADJUSTMENTUPLOADSERVICE'].methods_by_name['UploadConversionAdjustments']._serialized_options = b'\xdaA2customer_id,conversion_adjustments,partial_failure\x82\xd3\xe4\x93\x02?":/v19/customers/{customer_id=*}:uploadConversionAdjustments:\x01*'
