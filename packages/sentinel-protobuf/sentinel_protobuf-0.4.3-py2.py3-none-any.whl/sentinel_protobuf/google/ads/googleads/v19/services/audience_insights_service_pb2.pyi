...
from google.ads.googleads.v19.enums import audience_insights_dimension_pb2 as _audience_insights_dimension_pb2
from google.ads.googleads.v19.enums import audience_insights_marketing_objective_pb2 as _audience_insights_marketing_objective_pb2
...
class GenerateSuggestedTargetingInsightsRequest(_message.Message):
    __slots__ = ('customer_id', 'customer_insights_group', 'audience_definition', 'audience_description')
    CUSTOMER_ID_FIELD_NUMBER: _ClassVar[int]
    CUSTOMER_INSIGHTS_GROUP_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, customer_id: _Optional[str]=..., customer_insights_group: _Optional[str]=..., audience_definition: _Optional[_Union[InsightsAudienceDefinition, _Mapping]]=..., audience_description: _Optional[_Union[InsightsAudienceDescription, _Mapping]]=...) -> None:
        ...
...
class GenerateTargetingSuggestionMetricsRequest(_message.Message):
    __slots__ = ('customer_id', 'audiences', 'customer_insights_group')
    CUSTOMER_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, customer_id: _Optional[str]=..., audiences: _Optional[_Iterable[_Union[BasicInsightsAudience, _Mapping]]]=..., customer_insights_group: _Optional[str]=...) -> None:
        ...
