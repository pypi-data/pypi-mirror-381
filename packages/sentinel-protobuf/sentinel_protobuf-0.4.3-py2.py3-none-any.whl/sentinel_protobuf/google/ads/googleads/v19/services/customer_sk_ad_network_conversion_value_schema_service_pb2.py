...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CUSTOMERSKADNETWORKCONVERSIONVALUESCHEMASERVICE'].methods_by_name['MutateCustomerSkAdNetworkConversionValueSchema']._serialized_options = b'\x82\xd3\xe4\x93\x02T"O/v19/customers/{customer_id=*}/customerSkAdNetworkConversionValueSchemas:mutate:\x01*'
