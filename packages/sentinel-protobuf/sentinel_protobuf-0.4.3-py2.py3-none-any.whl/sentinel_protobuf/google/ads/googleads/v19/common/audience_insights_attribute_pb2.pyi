...
from google.ads.googleads.v19.enums import insights_knowledge_graph_entity_capabilities_pb2 as _insights_knowledge_graph_entity_capabilities_pb2
...
class AudienceInsightsAttributeMetadata(_message.Message):
    __slots__ = ('dimension', 'attribute', 'display_name', 'display_info', 'potential_youtube_reach', 'subscriber_share', 'viewer_share', 'youtube_channel_metadata', 'youtube_video_metadata', 'dynamic_attribute_metadata', 'location_attribute_metadata', 'user_interest_attribute_metadata', 'knowledge_graph_attribute_metadata')
