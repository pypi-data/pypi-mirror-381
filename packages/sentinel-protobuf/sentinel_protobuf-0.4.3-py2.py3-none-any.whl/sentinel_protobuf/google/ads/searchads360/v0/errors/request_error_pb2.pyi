...
class RequestErrorEnum(_message.Message):
    ...
    class RequestError(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        INVALID_PRODUCT_NAME: _ClassVar[RequestErrorEnum.RequestError]
        ...
        LOGIN_OR_LINKED_CUSTOMER_ID_PARAMETER_REQUIRED: _ClassVar[RequestErrorEnum.RequestError]
        ...
        PRODUCT_NOT_SUPPORTED: _ClassVar[RequestErrorEnum.RequestError]
    ...
    INVALID_PRODUCT_NAME: RequestErrorEnum.RequestError
    ...
    LOGIN_OR_LINKED_CUSTOMER_ID_PARAMETER_REQUIRED: RequestErrorEnum.RequestError
    ...
    PRODUCT_NOT_SUPPORTED: RequestErrorEnum.RequestError
