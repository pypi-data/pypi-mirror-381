...
class AdGroupAsset(_message.Message):
    __slots__ = ('resource_name', 'ad_group', 'asset', 'status')
    ...
    def __init__(self, resource_name: _Optional[str]=..., ad_group: _Optional[str]=..., asset: _Optional[str]=..., status: _Optional[_Union[_asset_link_status_pb2.AssetLinkStatusEnum.AssetLinkStatus, str]]=...) -> None:
        ...