...
from google.iam.v2 import deny_pb2 as _deny_pb2
...
class Policy(_message.Message):
    __slots__ = ('name', 'uid', 'kind', 'display_name', 'annotations', 'etag', 'create_time', 'update_time', 'delete_time', 'rules', 'managing_authority')
    ...
    MANAGING_AUTHORITY_FIELD_NUMBER: _ClassVar[int]
    name: str
    uid: str
    kind: str
    display_name: str
