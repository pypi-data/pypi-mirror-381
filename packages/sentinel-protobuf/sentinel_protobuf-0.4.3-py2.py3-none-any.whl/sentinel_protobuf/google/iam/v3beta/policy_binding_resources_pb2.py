...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/iam/v3beta/policy_binding_resources.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_POLICYBINDING']._serialized_start = 218
    _globals['_POLICYBINDING']._serialized_end = 1212
    _globals['_POLICYBINDING_TARGET']._serialized_start = 739
    _globals['_POLICYBINDING_TARGET']._serialized_end = 787
    _globals['_POLICYBINDING_ANNOTATIONSENTRY']._serialized_start = 789
    _globals['_POLICYBINDING_ANNOTATIONSENTRY']._serialized_end = 839
    _globals['_POLICYBINDING_POLICYKIND']._serialized_start = 841
    _globals['_POLICYBINDING_POLICYKIND']._serialized_end = 913