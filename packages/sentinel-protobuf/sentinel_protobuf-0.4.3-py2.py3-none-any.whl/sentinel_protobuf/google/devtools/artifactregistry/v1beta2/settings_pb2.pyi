...
class ProjectSettings(_message.Message):
    __slots__ = ('name', 'legacy_redirection_state')
    ...
    def __init__(self, name: _Optional[str]=..., legacy_redirection_state: _Optional[_Union[ProjectSettings.RedirectionState, str]]=...) -> None:
        ...
