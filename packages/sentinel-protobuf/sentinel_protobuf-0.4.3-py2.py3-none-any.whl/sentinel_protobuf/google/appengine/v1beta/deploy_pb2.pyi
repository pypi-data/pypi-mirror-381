...
class Deployment(_message.Message):
    __slots__ = ('files', 'container', 'zip', 'build', 'cloud_build_options')
    ...
    def __init__(self, files: _Optional[_Mapping[str, FileInfo]]=..., container: _Optional[_Union[ContainerInfo, _Mapping]]=..., zip: _Optional[_Union[ZipInfo, _Mapping]]=..., build: _Optional[_Union[BuildInfo, _Mapping]]=..., cloud_build_options: _Optional[_Union[CloudBuildOptions, _Mapping]]=...) -> None:
        ...
