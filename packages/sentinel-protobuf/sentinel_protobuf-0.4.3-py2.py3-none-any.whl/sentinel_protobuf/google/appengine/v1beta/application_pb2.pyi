...
class Application(_message.Message):
    __slots__ = ('name', 'id', 'dispatch_rules', 'auth_domain', 'location_id', 'code_bucket', 'default_cookie_expiration', 'serving_status', 'default_hostname', 'default_bucket', 'iap', 'gcr_domain', 'database_type', 'feature_settings')
    ...
    def __init__(self, name: _Optional[str]=..., id: _Optional[str]=..., dispatch_rules: _Optional[_Iterable[_Union[UrlDispatchRule, _Mapping]]]=..., auth_domain: _Optional[str]=..., location_id: _Optional[str]=..., code_bucket: _Optional[str]=..., default_cookie_expiration: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., serving_status: _Optional[_Union[Application.ServingStatus, str]]=..., default_hostname: _Optional[str]=..., default_bucket: _Optional[str]=..., iap: _Optional[_Union[Application.IdentityAwareProxy, _Mapping]]=..., gcr_domain: _Optional[str]=..., database_type: _Optional[_Union[Application.DatabaseType, str]]=..., feature_settings: _Optional[_Union[Application.FeatureSettings, _Mapping]]=...) -> None:
        ...
