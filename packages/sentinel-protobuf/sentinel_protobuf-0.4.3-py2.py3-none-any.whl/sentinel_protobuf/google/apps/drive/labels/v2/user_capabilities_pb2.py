...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/apps/drive/labels/v2/user_capabilities.proto')
_sym_db = _symbol_database.Default()
from ......google.api import field_behavior_pb2 as google_dot_api_dot_field__behavior__pb2
from ......google.api import resource_pb2 as google_dot_api_dot_resource__pb2
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n3google/apps/drive/labels/v2/user_capabilities.proto\x12\x1bgoogle.apps.drive.labels.v2\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto"\x8a\x02\n\x10UserCapabilities\x12\x11\n\x04name\x18\x01 \x01(\tB\x03\xe0A\x03\x12%\n\x18can_access_label_manager\x18\x02 \x01(\x08B\x03\xe0A\x03\x12$\n\x17can_administrate_labels\x18\x03 \x01(\x08B\x03\xe0A\x03\x12%\n\x18can_create_shared_labels\x18\x04 \x01(\x08B\x03\xe0A\x03\x12$\n\x17can_create_admin_labels\x18\x05 \x01(\x08B\x03\xe0A\x03:I\xeaAF\n+drivelabels.googleapis.com/UserCapabilities\x12\x17users/{id}/capabilitiesB\x84\x01\n\x1fcom.google.apps.drive.labels.v2B\x15UserCapabilitiesProtoP\x01ZAgoogle.golang.org/genproto/googleapis/apps/drive/labels/v2;labels\xa2\x02\x04DLBLb\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.apps.drive.labels.v2.user_capabilities_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    _globals['DESCRIPTOR']._loaded_options = None
    _globals['DESCRIPTOR']._serialized_options = b'\n\x1fcom.google.apps.drive.labels.v2B\x15UserCapabilitiesProtoP\x01ZAgoogle.golang.org/genproto/googleapis/apps/drive/labels/v2;labels\xa2\x02\x04DLBL'
    ...
    _globals['_USERCAPABILITIES']._serialized_start = 145
    _globals['_USERCAPABILITIES']._serialized_end = 411