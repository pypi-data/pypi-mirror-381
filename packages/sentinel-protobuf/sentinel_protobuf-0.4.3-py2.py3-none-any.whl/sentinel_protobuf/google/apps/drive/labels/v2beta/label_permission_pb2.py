...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LABELPERMISSION']._serialized_start = 119
    _globals['_LABELPERMISSION']._serialized_end = 559
    _globals['_LABELPERMISSION_LABELROLE']._serialized_start = 365
    _globals['_LABELPERMISSION_LABELROLE']._serialized_end = 456