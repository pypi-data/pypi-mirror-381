...
class SheetsAddOnManifest(_message.Message):
    ...
    on_file_scope_granted_trigger: SheetsExtensionPoint

    def __init__(self, homepage_trigger: _Optional[_Union[_extension_point_pb2.HomepageExtensionPoint, _Mapping]]=..., on_file_scope_granted_trigger: _Optional[_Union[SheetsExtensionPoint, _Mapping]]=...) -> None:
        ...

class SheetsExtensionPoint(_message.Message):
