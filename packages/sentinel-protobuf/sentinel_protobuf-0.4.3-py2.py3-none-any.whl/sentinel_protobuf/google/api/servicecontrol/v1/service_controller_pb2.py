...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/api/servicecontrol/v1/service_controller.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'\n com.google.api.servicecontrol.v1B\x16ServiceControllerProtoP\x01ZJcloud.google.com/go/servicecontrol/apiv1/servicecontrolpb;servicecontrolpb\xf8\x01\x01\xa2\x02\x04GASC\xaa\x02\x1eGoogle.Cloud.ServiceControl.V1\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V1\xea\x02!Google::Cloud::ServiceControl::V1'
    ...
    _globals['_SERVICECONTROLLER'].methods_by_name['Check']._serialized_options = b'\x82\xd3\xe4\x93\x02&"!/v1/services/{service_name}:check:\x01*'
    _globals['_SERVICECONTROLLER'].methods_by_name['Report']._loaded_options = None
    _globals['_SERVICECONTROLLER'].methods_by_name['Report']._serialized_options = b'\x82\xd3\xe4\x93\x02\'""/v1/services/{service_name}:report:\x01*'
