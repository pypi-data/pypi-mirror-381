...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/api/servicecontrol/v2/service_controller.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'\n com.google.api.servicecontrol.v2B\x16ServiceControllerProtoP\x01ZJgoogle.golang.org/genproto/googleapis/api/servicecontrol/v2;servicecontrol\xaa\x02\x1eGoogle.Cloud.ServiceControl.V2\xca\x02\x1eGoogle\\Cloud\\ServiceControl\\V2\xea\x02!Google::Cloud::ServiceControl::V2'
    _globals['_CHECKRESPONSE_HEADERSENTRY']._loaded_options = None
    _globals['_CHECKRESPONSE_HEADERSENTRY']._serialized_options = b'8\x01'
    _globals['_SERVICECONTROLLER']._loaded_options = None
    _globals['_SERVICECONTROLLER']._serialized_options = b'\xcaA\x1dservicecontrol.googleapis.com\xd2A]https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/servicecontrol'
    _globals['_SERVICECONTROLLER'].methods_by_name['Check']._loaded_options = None
    _globals['_SERVICECONTROLLER'].methods_by_name['Check']._serialized_options = b'\x82\xd3\xe4\x93\x02&"!/v2/services/{service_name}:check:\x01*'
    _globals['_SERVICECONTROLLER'].methods_by_name['Report']._loaded_options = None
    _globals['_SERVICECONTROLLER'].methods_by_name['Report']._serialized_options = b'\x82\xd3\xe4\x93\x02\'""/v2/services/{service_name}:report:\x01*'
