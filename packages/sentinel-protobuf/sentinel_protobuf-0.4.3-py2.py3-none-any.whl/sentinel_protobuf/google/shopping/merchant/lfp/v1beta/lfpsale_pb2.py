...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/shopping/merchant/lfp/v1beta/lfpsale.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LFPSALESERVICE'].methods_by_name['InsertLfpSale']._serialized_options = b'\x82\xd3\xe4\x93\x02;"//lfp/v1beta/{parent=accounts/*}/lfpSales:insert:\x08lfp_sale'
    _globals['_LFPSALE']._serialized_start = 302
    _globals['_LFPSALE']._serialized_end = 790
    _globals['_INSERTLFPSALEREQUEST']._serialized_start = 792
    _globals['_INSERTLFPSALEREQUEST']._serialized_end = 904
    _globals['_LFPSALESERVICE']._serialized_start = 907
    _globals['_LFPSALESERVICE']._serialized_end = 1186