...
class RegionalInventory(_message.Message):
    __slots__ = ('name', 'account', 'region', 'regional_inventory_attributes')
    NAME_FIELD_NUMBER: _ClassVar[int]
    ACCOUNT_FIELD_NUMBER: _ClassVar[int]
    REGION_FIELD_NUMBER: _ClassVar[int]
    REGIONAL_INVENTORY_ATTRIBUTES_FIELD_NUMBER: _ClassVar[int]
    name: str
    account: int
    region: str
    regional_inventory_attributes: _inventories_common_pb2.RegionalInventoryAttributes

    def __init__(self, name: _Optional[str]=..., account: _Optional[int]=..., region: _Optional[str]=..., regional_inventory_attributes: _Optional[_Union[_inventories_common_pb2.RegionalInventoryAttributes, _Mapping]]=...) -> None:
        ...
