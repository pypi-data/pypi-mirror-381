...
class UpdateOnlineReturnPolicyRequest(_message.Message):
    __slots__ = ('online_return_policy', 'update_mask')
    ONLINE_RETURN_POLICY_FIELD_NUMBER: _ClassVar[int]
    UPDATE_MASK_FIELD_NUMBER: _ClassVar[int]
    online_return_policy: OnlineReturnPolicy
    update_mask: _field_mask_pb2.FieldMask

    def __init__(self, online_return_policy: _Optional[_Union[OnlineReturnPolicy, _Mapping]]=..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]]=...) -> None:
        ...
