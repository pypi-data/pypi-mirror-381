...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/nft/v1beta1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERY'].methods_by_name['Balance']._serialized_options = b'\x82\xd3\xe4\x93\x020\x12./cosmos/nft/v1beta1/balance/{owner}/{class_id}'
    _globals['_QUERY'].methods_by_name['Owner']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Owner']._serialized_options = b'\x82\xd3\xe4\x93\x02+\x12)/cosmos/nft/v1beta1/owner/{class_id}/{id}'
    _globals['_QUERY'].methods_by_name['Supply']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Supply']._serialized_options = b"\x82\xd3\xe4\x93\x02'\x12%/cosmos/nft/v1beta1/supply/{class_id}"
    _globals['_QUERY'].methods_by_name['NFTs']._loaded_options = None
    _globals['_QUERY'].methods_by_name['NFTs']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1a\x12\x18/cosmos/nft/v1beta1/nfts'
    _globals['_QUERY'].methods_by_name['NFT']._loaded_options = None
    _globals['_QUERY'].methods_by_name['NFT']._serialized_options = b'\x82\xd3\xe4\x93\x02*\x12(/cosmos/nft/v1beta1/nfts/{class_id}/{id}'
    _globals['_QUERY'].methods_by_name['Class']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Class']._serialized_options = b'\x82\xd3\xe4\x93\x02(\x12&/cosmos/nft/v1beta1/classes/{class_id}'
    _globals['_QUERY'].methods_by_name['Classes']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Classes']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1d\x12\x1b/cosmos/nft/v1beta1/classes'
