...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/auth/v1beta1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYACCOUNTSRESPONSE'].fields_by_name['accounts']._serialized_options = b'\xca\xb4-\x1ccosmos.auth.v1beta1.AccountI'
    _globals['_QUERYACCOUNTREQUEST'].fields_by_name['address']._loaded_options = None
    _globals['_QUERYACCOUNTREQUEST'].fields_by_name['address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_QUERYACCOUNTREQUEST']._loaded_options = None
    _globals['_QUERYACCOUNTREQUEST']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_QUERYACCOUNTRESPONSE'].fields_by_name['account']._loaded_options = None
    _globals['_QUERYACCOUNTRESPONSE'].fields_by_name['account']._serialized_options = b'\xca\xb4-\x1ccosmos.auth.v1beta1.AccountI'
    ...
    _globals['_QUERYMODULEACCOUNTSRESPONSE'].fields_by_name['accounts']._serialized_options = b'\xca\xb4-"cosmos.auth.v1beta1.ModuleAccountI'
    _globals['_QUERYMODULEACCOUNTBYNAMERESPONSE'].fields_by_name['account']._loaded_options = None
    _globals['_QUERYMODULEACCOUNTBYNAMERESPONSE'].fields_by_name['account']._serialized_options = b'\xca\xb4-"cosmos.auth.v1beta1.ModuleAccountI'
    _globals['_QUERYACCOUNTADDRESSBYIDREQUEST'].fields_by_name['id']._loaded_options = None
    _globals['_QUERYACCOUNTADDRESSBYIDREQUEST'].fields_by_name['id']._serialized_options = b'\x18\x01'
    _globals['_QUERYACCOUNTADDRESSBYIDRESPONSE'].fields_by_name['account_address']._loaded_options = None
    _globals['_QUERYACCOUNTADDRESSBYIDRESPONSE'].fields_by_name['account_address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_QUERYACCOUNTINFOREQUEST'].fields_by_name['address']._loaded_options = None
    _globals['_QUERYACCOUNTINFOREQUEST'].fields_by_name['address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_QUERY'].methods_by_name['Accounts']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Accounts']._serialized_options = b'\x88\xe7\xb0*\x01\x82\xd3\xe4\x93\x02\x1f\x12\x1d/cosmos/auth/v1beta1/accounts'
    _globals['_QUERY'].methods_by_name['Account']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Account']._serialized_options = b"\x88\xe7\xb0*\x01\x82\xd3\xe4\x93\x02)\x12'/cosmos/auth/v1beta1/accounts/{address}"
    _globals['_QUERY'].methods_by_name['AccountAddressByID']._loaded_options = None
    _globals['_QUERY'].methods_by_name['AccountAddressByID']._serialized_options = b"\x88\xe7\xb0*\x01\x82\xd3\xe4\x93\x02)\x12'/cosmos/auth/v1beta1/address_by_id/{id}"
    _globals['_QUERY'].methods_by_name['Params']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\x88\xe7\xb0*\x01\x82\xd3\xe4\x93\x02\x1d\x12\x1b/cosmos/auth/v1beta1/params'
    _globals['_QUERY'].methods_by_name['ModuleAccounts']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ModuleAccounts']._serialized_options = b'\x88\xe7\xb0*\x01\x82\xd3\xe4\x93\x02&\x12$/cosmos/auth/v1beta1/module_accounts'
    _globals['_QUERY'].methods_by_name['ModuleAccountByName']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ModuleAccountByName']._serialized_options = b'\x88\xe7\xb0*\x01\x82\xd3\xe4\x93\x02-\x12+/cosmos/auth/v1beta1/module_accounts/{name}'
    _globals['_QUERY'].methods_by_name['Bech32Prefix']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Bech32Prefix']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1d\x12\x1b/cosmos/auth/v1beta1/bech32'
    _globals['_QUERY'].methods_by_name['AddressBytesToString']._loaded_options = None
    _globals['_QUERY'].methods_by_name['AddressBytesToString']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/cosmos/auth/v1beta1/bech32/{address_bytes}'
    _globals['_QUERY'].methods_by_name['AddressStringToBytes']._loaded_options = None
    _globals['_QUERY'].methods_by_name['AddressStringToBytes']._serialized_options = b'\x82\xd3\xe4\x93\x02.\x12,/cosmos/auth/v1beta1/bech32/{address_string}'
    _globals['_QUERY'].methods_by_name['AccountInfo']._loaded_options = None
    _globals['_QUERY'].methods_by_name['AccountInfo']._serialized_options = b'\x88\xe7\xb0*\x01\x82\xd3\xe4\x93\x02-\x12+/cosmos/auth/v1beta1/account_info/{address}'
