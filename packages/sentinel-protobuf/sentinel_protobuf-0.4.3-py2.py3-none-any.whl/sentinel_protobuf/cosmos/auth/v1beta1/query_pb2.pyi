...
class QueryAccountAddressByIDRequest(_message.Message):
    ...
    def __init__(self, id: _Optional[int]=..., account_id: _Optional[int]=...) -> None:
        ...
...
class QueryAccountInfoRequest(_message.Message):
    __slots__ = ('address',)
    ADDRESS_FIELD_NUMBER: _ClassVar[int]
    address: str
...
class QueryAccountInfoResponse(_message.Message):
    __slots__ = ('info',)
    INFO_FIELD_NUMBER: _ClassVar[int]
    info: _auth_pb2.BaseAccount

    def __init__(self, info: _Optional[_Union[_auth_pb2.BaseAccount, _Mapping]]=...) -> None:
        ...