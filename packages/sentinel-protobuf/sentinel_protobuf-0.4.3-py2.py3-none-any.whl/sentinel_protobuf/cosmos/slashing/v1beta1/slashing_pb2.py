...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/slashing/v1beta1/slashing.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_VALIDATORSIGNINGINFO'].fields_by_name['address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    ...
    _globals['_VALIDATORSIGNINGINFO']._serialized_options = b'\x98\xa0\x1f\x00\xe8\xa0\x1f\x01'
    _globals['_PARAMS'].fields_by_name['min_signed_per_window']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['min_signed_per_window']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Dec\xa8\xe7\xb0*\x01'
    ...
    _globals['_PARAMS'].fields_by_name['slash_fraction_double_sign']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Dec\xa8\xe7\xb0*\x01'
    _globals['_PARAMS'].fields_by_name['slash_fraction_downtime']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['slash_fraction_downtime']._serialized_options = b'\xc8\xde\x1f\x00\xda\xde\x1f&github.com/cosmos/cosmos-sdk/types.Dec\xa8\xe7\xb0*\x01'
