...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/upgrade/v1beta1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYUPGRADEDCONSENSUSSTATEREQUEST']._serialized_options = b'\x18\x01'
    _globals['_QUERYUPGRADEDCONSENSUSSTATERESPONSE']._loaded_options = None
    _globals['_QUERYUPGRADEDCONSENSUSSTATERESPONSE']._serialized_options = b'\x18\x01'
    _globals['_QUERY'].methods_by_name['CurrentPlan']._loaded_options = None
    _globals['_QUERY'].methods_by_name['CurrentPlan']._serialized_options = b'\x82\xd3\xe4\x93\x02&\x12$/cosmos/upgrade/v1beta1/current_plan'
    _globals['_QUERY'].methods_by_name['AppliedPlan']._loaded_options = None
    _globals['_QUERY'].methods_by_name['AppliedPlan']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/cosmos/upgrade/v1beta1/applied_plan/{name}'
    _globals['_QUERY'].methods_by_name['UpgradedConsensusState']._loaded_options = None
    _globals['_QUERY'].methods_by_name['UpgradedConsensusState']._serialized_options = b'\x88\x02\x01\x82\xd3\xe4\x93\x02@\x12>/cosmos/upgrade/v1beta1/upgraded_consensus_state/{last_height}'
    _globals['_QUERY'].methods_by_name['ModuleVersions']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ModuleVersions']._serialized_options = b"\x82\xd3\xe4\x93\x02)\x12'/cosmos/upgrade/v1beta1/module_versions"
    _globals['_QUERY'].methods_by_name['Authority']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Authority']._serialized_options = b'\x82\xd3\xe4\x93\x02#\x12!/cosmos/upgrade/v1beta1/authority'
