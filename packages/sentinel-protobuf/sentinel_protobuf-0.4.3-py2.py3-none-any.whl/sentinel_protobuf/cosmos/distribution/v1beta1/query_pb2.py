...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYVALIDATORDISTRIBUTIONINFOREQUEST'].fields_by_name['validator_address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_QUERYVALIDATORDISTRIBUTIONINFORESPONSE'].fields_by_name['operator_address']._loaded_options = None
    _globals['_QUERYVALIDATORDISTRIBUTIONINFORESPONSE'].fields_by_name['operator_address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
