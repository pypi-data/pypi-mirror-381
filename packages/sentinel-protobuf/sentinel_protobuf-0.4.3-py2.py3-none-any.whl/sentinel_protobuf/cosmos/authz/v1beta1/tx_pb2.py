...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/authz/v1beta1/tx.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGGRANT'].fields_by_name['granter']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_MSGGRANT'].fields_by_name['grantee']._loaded_options = None
    _globals['_MSGGRANT'].fields_by_name['grantee']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_MSGGRANT'].fields_by_name['grant']._loaded_options = None
    _globals['_MSGGRANT'].fields_by_name['grant']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_MSGGRANT']._loaded_options = None
    _globals['_MSGGRANT']._serialized_options = b'\x82\xe7\xb0*\x07granter\x8a\xe7\xb0*\x13cosmos-sdk/MsgGrant'
    _globals['_MSGEXEC'].fields_by_name['grantee']._loaded_options = None
    _globals['_MSGEXEC'].fields_by_name['grantee']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_MSGEXEC'].fields_by_name['msgs']._loaded_options = None
    _globals['_MSGEXEC'].fields_by_name['msgs']._serialized_options = b'\xca\xb4-\x17cosmos.base.v1beta1.Msg'
    _globals['_MSGEXEC']._loaded_options = None
    _globals['_MSGEXEC']._serialized_options = b'\x82\xe7\xb0*\x07grantee\x8a\xe7\xb0*\x12cosmos-sdk/MsgExec'
    _globals['_MSGREVOKE'].fields_by_name['granter']._loaded_options = None
    _globals['_MSGREVOKE'].fields_by_name['granter']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_MSGREVOKE'].fields_by_name['grantee']._loaded_options = None
    _globals['_MSGREVOKE'].fields_by_name['grantee']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_MSGREVOKE']._loaded_options = None
    _globals['_MSGREVOKE']._serialized_options = b'\x82\xe7\xb0*\x07granter\x8a\xe7\xb0*\x14cosmos-sdk/MsgRevoke'
