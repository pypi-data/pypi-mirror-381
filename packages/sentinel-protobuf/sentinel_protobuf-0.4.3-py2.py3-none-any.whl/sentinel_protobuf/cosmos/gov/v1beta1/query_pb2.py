...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/gov/v1beta1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYPROPOSALRESPONSE'].fields_by_name['proposal']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    ...
    _globals['_QUERYPROPOSALSREQUEST']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_QUERYPROPOSALSRESPONSE'].fields_by_name['proposals']._loaded_options = None
    _globals['_QUERYPROPOSALSRESPONSE'].fields_by_name['proposals']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    ...
    _globals['_QUERYVOTEREQUEST']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_QUERYVOTERESPONSE'].fields_by_name['vote']._loaded_options = None
    _globals['_QUERYVOTERESPONSE'].fields_by_name['vote']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_QUERYVOTESRESPONSE'].fields_by_name['votes']._loaded_options = None
    _globals['_QUERYVOTESRESPONSE'].fields_by_name['votes']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['voting_params']._loaded_options = None
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['voting_params']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['deposit_params']._loaded_options = None
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['deposit_params']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['tally_params']._loaded_options = None
    _globals['_QUERYPARAMSRESPONSE'].fields_by_name['tally_params']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    ...
    _globals['_QUERYDEPOSITREQUEST']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_QUERYDEPOSITRESPONSE'].fields_by_name['deposit']._loaded_options = None
    _globals['_QUERYDEPOSITRESPONSE'].fields_by_name['deposit']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_QUERYDEPOSITSRESPONSE'].fields_by_name['deposits']._loaded_options = None
    _globals['_QUERYDEPOSITSRESPONSE'].fields_by_name['deposits']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    ...
    _globals['_QUERY'].methods_by_name['Proposal']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/cosmos/gov/v1beta1/proposals/{proposal_id}'
    _globals['_QUERY'].methods_by_name['Proposals']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Proposals']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1f\x12\x1d/cosmos/gov/v1beta1/proposals'
    _globals['_QUERY'].methods_by_name['Vote']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Vote']._serialized_options = b'\x82\xd3\xe4\x93\x02;\x129/cosmos/gov/v1beta1/proposals/{proposal_id}/votes/{voter}'
    _globals['_QUERY'].methods_by_name['Votes']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Votes']._serialized_options = b'\x82\xd3\xe4\x93\x023\x121/cosmos/gov/v1beta1/proposals/{proposal_id}/votes'
    _globals['_QUERY'].methods_by_name['Params']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\x82\xd3\xe4\x93\x02*\x12(/cosmos/gov/v1beta1/params/{params_type}'
    _globals['_QUERY'].methods_by_name['Deposit']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Deposit']._serialized_options = b'\x82\xd3\xe4\x93\x02B\x12@/cosmos/gov/v1beta1/proposals/{proposal_id}/deposits/{depositor}'
    _globals['_QUERY'].methods_by_name['Deposits']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Deposits']._serialized_options = b'\x82\xd3\xe4\x93\x026\x124/cosmos/gov/v1beta1/proposals/{proposal_id}/deposits'
    _globals['_QUERY'].methods_by_name['TallyResult']._loaded_options = None
    _globals['_QUERY'].methods_by_name['TallyResult']._serialized_options = b'\x82\xd3\xe4\x93\x023\x121/cosmos/gov/v1beta1/proposals/{proposal_id}/tally'
