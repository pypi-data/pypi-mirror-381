...
class GenesisState(_message.Message):
    __slots__ = ('starting_proposal_id', 'deposits', 'votes', 'proposals', 'deposit_params', 'voting_params', 'tally_params', 'params')
    ...
    def __init__(self, starting_proposal_id: _Optional[int]=..., deposits: _Optional[_Iterable[_Union[_gov_pb2.Deposit, _Mapping]]]=..., votes: _Optional[_Iterable[_Union[_gov_pb2.Vote, _Mapping]]]=..., proposals: _Optional[_Iterable[_Union[_gov_pb2.Proposal, _Mapping]]]=..., deposit_params: _Optional[_Union[_gov_pb2.DepositParams, _Mapping]]=..., voting_params: _Optional[_Union[_gov_pb2.VotingParams, _Mapping]]=..., tally_params: _Optional[_Union[_gov_pb2.TallyParams, _Mapping]]=..., params: _Optional[_Union[_gov_pb2.Params, _Mapping]]=...) -> None:
        ...