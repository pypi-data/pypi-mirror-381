...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/capability/v1beta1/genesis.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENESISOWNERS'].fields_by_name['index_owners']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_GENESISSTATE'].fields_by_name['owners']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['owners']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
