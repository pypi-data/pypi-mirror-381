...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/tx/signing/v1beta1/signing.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SIGNMODE']._serialized_end = 953
