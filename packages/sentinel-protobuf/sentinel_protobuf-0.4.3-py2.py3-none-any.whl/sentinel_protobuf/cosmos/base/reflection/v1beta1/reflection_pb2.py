...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/base/reflection/v1beta1/reflection.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_REFLECTIONSERVICE'].methods_by_name['ListAllInterfaces']._serialized_options = b'\x82\xd3\xe4\x93\x02,\x12*/cosmos/base/reflection/v1beta1/interfaces'
    _globals['_REFLECTIONSERVICE'].methods_by_name['ListImplementations']._loaded_options = None
    _globals['_REFLECTIONSERVICE'].methods_by_name['ListImplementations']._serialized_options = b'\x82\xd3\xe4\x93\x02M\x12K/cosmos/base/reflection/v1beta1/interfaces/{interface_name}/implementations'
