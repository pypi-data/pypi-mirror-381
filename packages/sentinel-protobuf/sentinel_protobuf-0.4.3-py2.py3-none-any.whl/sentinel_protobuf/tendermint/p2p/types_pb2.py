...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'tendermint/p2p/types.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_NETADDRESS'].fields_by_name['id']._serialized_options = b'\xe2\xde\x1f\x02ID'
    _globals['_NETADDRESS'].fields_by_name['ip']._loaded_options = None
    _globals['_NETADDRESS'].fields_by_name['ip']._serialized_options = b'\xe2\xde\x1f\x02IP'
    _globals['_PROTOCOLVERSION'].fields_by_name['p2p']._loaded_options = None
    _globals['_PROTOCOLVERSION'].fields_by_name['p2p']._serialized_options = b'\xe2\xde\x1f\x03P2P'
    _globals['_DEFAULTNODEINFO'].fields_by_name['protocol_version']._loaded_options = None
    _globals['_DEFAULTNODEINFO'].fields_by_name['protocol_version']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_DEFAULTNODEINFO'].fields_by_name['default_node_id']._loaded_options = None
    _globals['_DEFAULTNODEINFO'].fields_by_name['default_node_id']._serialized_options = b'\xe2\xde\x1f\rDefaultNodeID'
    _globals['_DEFAULTNODEINFO'].fields_by_name['other']._loaded_options = None
    _globals['_DEFAULTNODEINFO'].fields_by_name['other']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_DEFAULTNODEINFOOTHER'].fields_by_name['rpc_address']._loaded_options = None
    _globals['_DEFAULTNODEINFOOTHER'].fields_by_name['rpc_address']._serialized_options = b'\xe2\xde\x1f\nRPCAddress'
