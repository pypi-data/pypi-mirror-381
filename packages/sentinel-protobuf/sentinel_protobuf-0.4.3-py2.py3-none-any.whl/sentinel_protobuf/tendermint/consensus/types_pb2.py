...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'tendermint/consensus/types.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_NEWVALIDBLOCK'].fields_by_name['block_part_set_header']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_PROPOSAL'].fields_by_name['proposal']._loaded_options = None
    _globals['_PROPOSAL'].fields_by_name['proposal']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_PROPOSALPOL'].fields_by_name['proposal_pol']._loaded_options = None
    _globals['_PROPOSALPOL'].fields_by_name['proposal_pol']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_BLOCKPART'].fields_by_name['part']._loaded_options = None
    _globals['_BLOCKPART'].fields_by_name['part']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_VOTESETMAJ23'].fields_by_name['block_id']._loaded_options = None
    _globals['_VOTESETMAJ23'].fields_by_name['block_id']._serialized_options = b'\xc8\xde\x1f\x00\xe2\xde\x1f\x07BlockID'
    _globals['_VOTESETBITS'].fields_by_name['block_id']._loaded_options = None
    _globals['_VOTESETBITS'].fields_by_name['block_id']._serialized_options = b'\xc8\xde\x1f\x00\xe2\xde\x1f\x07BlockID'
    _globals['_VOTESETBITS'].fields_by_name['votes']._loaded_options = None
    _globals['_VOTESETBITS'].fields_by_name['votes']._serialized_options = b'\xc8\xde\x1f\x00'
