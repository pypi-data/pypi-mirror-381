...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'tendermint/consensus/wal.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGINFO'].fields_by_name['msg']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_MSGINFO'].fields_by_name['peer_id']._loaded_options = None
    _globals['_MSGINFO'].fields_by_name['peer_id']._serialized_options = b'\xe2\xde\x1f\x06PeerID'
    _globals['_TIMEOUTINFO'].fields_by_name['duration']._loaded_options = None
    _globals['_TIMEOUTINFO'].fields_by_name['duration']._serialized_options = b'\xc8\xde\x1f\x00\x98\xdf\x1f\x01'
    _globals['_TIMEDWALMESSAGE'].fields_by_name['time']._loaded_options = None
    _globals['_TIMEDWALMESSAGE'].fields_by_name['time']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01'
