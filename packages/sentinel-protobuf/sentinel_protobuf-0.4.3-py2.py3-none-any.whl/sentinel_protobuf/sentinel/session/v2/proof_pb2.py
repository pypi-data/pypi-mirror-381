...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'sentinel/session/v2/proof.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PROOF']._serialized_end = 283