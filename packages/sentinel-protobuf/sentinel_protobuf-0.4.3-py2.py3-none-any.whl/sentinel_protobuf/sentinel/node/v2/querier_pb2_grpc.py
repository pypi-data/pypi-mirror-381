...
if _version_not_supported:
    raise RuntimeError(f'The grpc package installed is at version {GRPC_VERSION},' + f' but the generated code in sentinel/node/v2/querier_pb2_grpc.py depends on' + f' grpcio>={GRPC_GENERATED_VERSION}.' + f' Please upgrade your grpc module to grpcio>={GRPC_GENERATED_VERSION}' + f' or downgrade your generated code using grpcio-tools<={GRPC_VERSION}.')
...
class QueryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.QueryNodes = channel.unary_unary('/sentinel.node.v2.QueryService/QueryNodes', request_serializer=sentinel_dot_node_dot_v2_dot_querier__pb2.QueryNodesRequest.SerializeToString, response_deserializer=sentinel_dot_node_dot_v2_dot_querier__pb2.QueryNodesResponse.FromString, _registered_method=True)
        self.QueryNodesForPlan = channel.unary_unary('/sentinel.node.v2.QueryService/QueryNodesForPlan', request_serializer=sentinel_dot_node_dot_v2_dot_querier__pb2.QueryNodesForPlanRequest.SerializeToString, response_deserializer=sentinel_dot_node_dot_v2_dot_querier__pb2.QueryNodesForPlanResponse.FromString, _registered_method=True)
        self.QueryNode = channel.unary_unary('/sentinel.node.v2.QueryService/QueryNode', request_serializer=sentinel_dot_node_dot_v2_dot_querier__pb2.QueryNodeRequest.SerializeToString, response_deserializer=sentinel_dot_node_dot_v2_dot_querier__pb2.QueryNodeResponse.FromString, _registered_method=True)
        self.QueryParams = channel.unary_unary('/sentinel.node.v2.QueryService/QueryParams', request_serializer=sentinel_dot_node_dot_v2_dot_querier__pb2.QueryParamsRequest.SerializeToString, response_deserializer=sentinel_dot_node_dot_v2_dot_querier__pb2.QueryParamsResponse.FromString, _registered_method=True)
...
def add_QueryServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('sentinel.node.v2.QueryService', rpc_method_handlers)
