...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/lightclients/solomachine/v3/solomachine.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CLIENTSTATE'].fields_by_name['is_frozen']._serialized_options = b'\xf2\xde\x1f\x10yaml:"is_frozen"'
