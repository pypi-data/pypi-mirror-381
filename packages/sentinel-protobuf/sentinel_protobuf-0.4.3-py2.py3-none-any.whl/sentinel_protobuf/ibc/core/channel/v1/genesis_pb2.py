...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENESISSTATE'].fields_by_name['channels']._serialized_options = b'\xc8\xde\x1f\x00\xfa\xde\x1f\x11IdentifiedChannel'
    _globals['_GENESISSTATE'].fields_by_name['acknowledgements']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['acknowledgements']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['commitments']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['commitments']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['receipts']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['receipts']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_GENESISSTATE'].fields_by_name['send_sequences']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['send_sequences']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x15yaml:"send_sequences"'
    _globals['_GENESISSTATE'].fields_by_name['recv_sequences']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['recv_sequences']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x15yaml:"recv_sequences"'
    _globals['_GENESISSTATE'].fields_by_name['ack_sequences']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['ack_sequences']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x14yaml:"ack_sequences"'
    _globals['_GENESISSTATE'].fields_by_name['next_channel_sequence']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['next_channel_sequence']._serialized_options = b'\xf2\xde\x1f\x1cyaml:"next_channel_sequence"'
    _globals['_PACKETSEQUENCE'].fields_by_name['port_id']._loaded_options = None
    _globals['_PACKETSEQUENCE'].fields_by_name['port_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"port_id"'
    _globals['_PACKETSEQUENCE'].fields_by_name['channel_id']._loaded_options = None
    _globals['_PACKETSEQUENCE'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
