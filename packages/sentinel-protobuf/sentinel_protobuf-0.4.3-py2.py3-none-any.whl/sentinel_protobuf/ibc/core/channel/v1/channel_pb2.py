...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_STATE']._serialized_options = b'\x88\xa3\x1e\x00'
    _globals['_STATE'].values_by_name['STATE_UNINITIALIZED_UNSPECIFIED']._loaded_options = None
    _globals['_STATE'].values_by_name['STATE_UNINITIALIZED_UNSPECIFIED']._serialized_options = b'\x8a\x9d \rUNINITIALIZED'
    _globals['_STATE'].values_by_name['STATE_INIT']._loaded_options = None
    _globals['_STATE'].values_by_name['STATE_INIT']._serialized_options = b'\x8a\x9d \x04INIT'
    _globals['_STATE'].values_by_name['STATE_TRYOPEN']._loaded_options = None
    _globals['_STATE'].values_by_name['STATE_TRYOPEN']._serialized_options = b'\x8a\x9d \x07TRYOPEN'
    _globals['_STATE'].values_by_name['STATE_OPEN']._loaded_options = None
    _globals['_STATE'].values_by_name['STATE_OPEN']._serialized_options = b'\x8a\x9d \x04OPEN'
    _globals['_STATE'].values_by_name['STATE_CLOSED']._loaded_options = None
    _globals['_STATE'].values_by_name['STATE_CLOSED']._serialized_options = b'\x8a\x9d \x06CLOSED'
    _globals['_ORDER']._loaded_options = None
    _globals['_ORDER']._serialized_options = b'\x88\xa3\x1e\x00'
    _globals['_ORDER'].values_by_name['ORDER_NONE_UNSPECIFIED']._loaded_options = None
    _globals['_ORDER'].values_by_name['ORDER_NONE_UNSPECIFIED']._serialized_options = b'\x8a\x9d \x04NONE'
    _globals['_ORDER'].values_by_name['ORDER_UNORDERED']._loaded_options = None
    _globals['_ORDER'].values_by_name['ORDER_UNORDERED']._serialized_options = b'\x8a\x9d \tUNORDERED'
    _globals['_ORDER'].values_by_name['ORDER_ORDERED']._loaded_options = None
    _globals['_ORDER'].values_by_name['ORDER_ORDERED']._serialized_options = b'\x8a\x9d \x07ORDERED'
    _globals['_CHANNEL'].fields_by_name['counterparty']._loaded_options = None
    _globals['_CHANNEL'].fields_by_name['counterparty']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_CHANNEL'].fields_by_name['connection_hops']._loaded_options = None
    _globals['_CHANNEL'].fields_by_name['connection_hops']._serialized_options = b'\xf2\xde\x1f\x16yaml:"connection_hops"'
    _globals['_CHANNEL']._loaded_options = None
    _globals['_CHANNEL']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_IDENTIFIEDCHANNEL'].fields_by_name['counterparty']._loaded_options = None
    _globals['_IDENTIFIEDCHANNEL'].fields_by_name['counterparty']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_IDENTIFIEDCHANNEL'].fields_by_name['connection_hops']._loaded_options = None
    _globals['_IDENTIFIEDCHANNEL'].fields_by_name['connection_hops']._serialized_options = b'\xf2\xde\x1f\x16yaml:"connection_hops"'
    _globals['_IDENTIFIEDCHANNEL']._loaded_options = None
    _globals['_IDENTIFIEDCHANNEL']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_COUNTERPARTY'].fields_by_name['port_id']._loaded_options = None
    _globals['_COUNTERPARTY'].fields_by_name['port_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"port_id"'
    _globals['_COUNTERPARTY'].fields_by_name['channel_id']._loaded_options = None
    _globals['_COUNTERPARTY'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
    _globals['_COUNTERPARTY']._loaded_options = None
    _globals['_COUNTERPARTY']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_PACKET'].fields_by_name['source_port']._loaded_options = None
    _globals['_PACKET'].fields_by_name['source_port']._serialized_options = b'\xf2\xde\x1f\x12yaml:"source_port"'
    _globals['_PACKET'].fields_by_name['source_channel']._loaded_options = None
    _globals['_PACKET'].fields_by_name['source_channel']._serialized_options = b'\xf2\xde\x1f\x15yaml:"source_channel"'
    _globals['_PACKET'].fields_by_name['destination_port']._loaded_options = None
    _globals['_PACKET'].fields_by_name['destination_port']._serialized_options = b'\xf2\xde\x1f\x17yaml:"destination_port"'
    _globals['_PACKET'].fields_by_name['destination_channel']._loaded_options = None
    _globals['_PACKET'].fields_by_name['destination_channel']._serialized_options = b'\xf2\xde\x1f\x1ayaml:"destination_channel"'
    _globals['_PACKET'].fields_by_name['timeout_height']._loaded_options = None
    _globals['_PACKET'].fields_by_name['timeout_height']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x15yaml:"timeout_height"'
    _globals['_PACKET'].fields_by_name['timeout_timestamp']._loaded_options = None
    _globals['_PACKET'].fields_by_name['timeout_timestamp']._serialized_options = b'\xf2\xde\x1f\x18yaml:"timeout_timestamp"'
    _globals['_PACKET']._loaded_options = None
    _globals['_PACKET']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_PACKETSTATE'].fields_by_name['port_id']._loaded_options = None
    _globals['_PACKETSTATE'].fields_by_name['port_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"port_id"'
    _globals['_PACKETSTATE'].fields_by_name['channel_id']._loaded_options = None
    _globals['_PACKETSTATE'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
    _globals['_PACKETSTATE']._loaded_options = None
    _globals['_PACKETSTATE']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_PACKETID'].fields_by_name['port_id']._loaded_options = None
    _globals['_PACKETID'].fields_by_name['port_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"port_id"'
    _globals['_PACKETID'].fields_by_name['channel_id']._loaded_options = None
    _globals['_PACKETID'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
    _globals['_PACKETID']._loaded_options = None
    _globals['_PACKETID']._serialized_options = b'\x88\xa0\x1f\x00'
