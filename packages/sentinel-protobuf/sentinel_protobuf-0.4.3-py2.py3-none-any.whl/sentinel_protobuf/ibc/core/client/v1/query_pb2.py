...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/core/client/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYCLIENTSTATERESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYCLIENTSTATESRESPONSE'].fields_by_name['client_states']._loaded_options = None
    _globals['_QUERYCLIENTSTATESRESPONSE'].fields_by_name['client_states']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f\x16IdentifiedClientStates'
    _globals['_QUERYCONSENSUSSTATERESPONSE'].fields_by_name['proof_height']._loaded_options = None
    _globals['_QUERYCONSENSUSSTATERESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYCONSENSUSSTATESRESPONSE'].fields_by_name['consensus_states']._loaded_options = None
    _globals['_QUERYCONSENSUSSTATESRESPONSE'].fields_by_name['consensus_states']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYCONSENSUSSTATEHEIGHTSRESPONSE'].fields_by_name['consensus_state_heights']._loaded_options = None
    _globals['_QUERYCONSENSUSSTATEHEIGHTSRESPONSE'].fields_by_name['consensus_state_heights']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERY'].methods_by_name['ClientState']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ClientState']._serialized_options = b'\x82\xd3\xe4\x93\x02/\x12-/ibc/core/client/v1/client_states/{client_id}'
    _globals['_QUERY'].methods_by_name['ClientStates']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ClientStates']._serialized_options = b'\x82\xd3\xe4\x93\x02#\x12!/ibc/core/client/v1/client_states'
    _globals['_QUERY'].methods_by_name['ConsensusState']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ConsensusState']._serialized_options = b'\x82\xd3\xe4\x93\x02f\x12d/ibc/core/client/v1/consensus_states/{client_id}/revision/{revision_number}/height/{revision_height}'
    _globals['_QUERY'].methods_by_name['ConsensusStates']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ConsensusStates']._serialized_options = b'\x82\xd3\xe4\x93\x022\x120/ibc/core/client/v1/consensus_states/{client_id}'
    _globals['_QUERY'].methods_by_name['ConsensusStateHeights']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ConsensusStateHeights']._serialized_options = b'\x82\xd3\xe4\x93\x02:\x128/ibc/core/client/v1/consensus_states/{client_id}/heights'
    _globals['_QUERY'].methods_by_name['ClientStatus']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ClientStatus']._serialized_options = b'\x82\xd3\xe4\x93\x02/\x12-/ibc/core/client/v1/client_status/{client_id}'
    _globals['_QUERY'].methods_by_name['ClientParams']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ClientParams']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1c\x12\x1a/ibc/core/client/v1/params'
    _globals['_QUERY'].methods_by_name['UpgradedClientState']._loaded_options = None
    _globals['_QUERY'].methods_by_name['UpgradedClientState']._serialized_options = b'\x82\xd3\xe4\x93\x02,\x12*/ibc/core/client/v1/upgraded_client_states'
    _globals['_QUERY'].methods_by_name['UpgradedConsensusState']._loaded_options = None
    _globals['_QUERY'].methods_by_name['UpgradedConsensusState']._serialized_options = b'\x82\xd3\xe4\x93\x02/\x12-/ibc/core/client/v1/upgraded_consensus_states'
    ...
    _globals['_QUERY']._serialized_end = 3582