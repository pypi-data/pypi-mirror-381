...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_GENESISSTATE'].fields_by_name['clients']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f\x16IdentifiedClientStates'
    _globals['_GENESISSTATE'].fields_by_name['clients_consensus']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['clients_consensus']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x18yaml:"clients_consensus"\xaa\xdf\x1f\x16ClientsConsensusStates'
    _globals['_GENESISSTATE'].fields_by_name['clients_metadata']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['clients_metadata']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x17yaml:"clients_metadata"'
    ...
    _globals['_GENESISSTATE'].fields_by_name['create_localhost']._serialized_options = b'\xf2\xde\x1f\x17yaml:"create_localhost"'
    _globals['_GENESISSTATE'].fields_by_name['next_client_sequence']._loaded_options = None
    _globals['_GENESISSTATE'].fields_by_name['next_client_sequence']._serialized_options = b'\xf2\xde\x1f\x1byaml:"next_client_sequence"'
    _globals['_GENESISMETADATA']._loaded_options = None
    _globals['_GENESISMETADATA']._serialized_options = b'\x88\xa0\x1f\x00'
    _globals['_IDENTIFIEDGENESISMETADATA'].fields_by_name['client_id']._loaded_options = None
    _globals['_IDENTIFIEDGENESISMETADATA'].fields_by_name['client_id']._serialized_options = b'\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_IDENTIFIEDGENESISMETADATA'].fields_by_name['client_metadata']._loaded_options = None
    _globals['_IDENTIFIEDGENESISMETADATA'].fields_by_name['client_metadata']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x16yaml:"client_metadata"'
