...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/core/client/v1/tx.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGCREATECLIENT'].fields_by_name['client_state']._loaded_options = None
    _globals['_MSGCREATECLIENT'].fields_by_name['client_state']._serialized_options = b'\xf2\xde\x1f\x13yaml:"client_state"'
    _globals['_MSGCREATECLIENT'].fields_by_name['consensus_state']._loaded_options = None
    _globals['_MSGCREATECLIENT'].fields_by_name['consensus_state']._serialized_options = b'\xf2\xde\x1f\x16yaml:"consensus_state"'
    _globals['_MSGCREATECLIENT']._loaded_options = None
    _globals['_MSGCREATECLIENT']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGUPDATECLIENT'].fields_by_name['client_id']._loaded_options = None
    _globals['_MSGUPDATECLIENT'].fields_by_name['client_id']._serialized_options = b'\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_MSGUPDATECLIENT']._loaded_options = None
    _globals['_MSGUPDATECLIENT']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGUPGRADECLIENT'].fields_by_name['client_id']._loaded_options = None
    _globals['_MSGUPGRADECLIENT'].fields_by_name['client_id']._serialized_options = b'\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_MSGUPGRADECLIENT'].fields_by_name['client_state']._loaded_options = None
    _globals['_MSGUPGRADECLIENT'].fields_by_name['client_state']._serialized_options = b'\xf2\xde\x1f\x13yaml:"client_state"'
    _globals['_MSGUPGRADECLIENT'].fields_by_name['consensus_state']._loaded_options = None
    _globals['_MSGUPGRADECLIENT'].fields_by_name['consensus_state']._serialized_options = b'\xf2\xde\x1f\x16yaml:"consensus_state"'
    _globals['_MSGUPGRADECLIENT'].fields_by_name['proof_upgrade_client']._loaded_options = None
    _globals['_MSGUPGRADECLIENT'].fields_by_name['proof_upgrade_client']._serialized_options = b'\xf2\xde\x1f\x1byaml:"proof_upgrade_client"'
    _globals['_MSGUPGRADECLIENT'].fields_by_name['proof_upgrade_consensus_state']._loaded_options = None
    _globals['_MSGUPGRADECLIENT'].fields_by_name['proof_upgrade_consensus_state']._serialized_options = b'\xf2\xde\x1f$yaml:"proof_upgrade_consensus_state"'
    _globals['_MSGUPGRADECLIENT']._loaded_options = None
    _globals['_MSGUPGRADECLIENT']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGSUBMITMISBEHAVIOUR'].fields_by_name['client_id']._loaded_options = None
    _globals['_MSGSUBMITMISBEHAVIOUR'].fields_by_name['client_id']._serialized_options = b'\x18\x01\xf2\xde\x1f\x10yaml:"client_id"'
    _globals['_MSGSUBMITMISBEHAVIOUR'].fields_by_name['misbehaviour']._loaded_options = None
    _globals['_MSGSUBMITMISBEHAVIOUR'].fields_by_name['misbehaviour']._serialized_options = b'\x18\x01'
    _globals['_MSGSUBMITMISBEHAVIOUR'].fields_by_name['signer']._loaded_options = None
    _globals['_MSGSUBMITMISBEHAVIOUR'].fields_by_name['signer']._serialized_options = b'\x18\x01'
    _globals['_MSGSUBMITMISBEHAVIOUR']._loaded_options = None
    _globals['_MSGSUBMITMISBEHAVIOUR']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
