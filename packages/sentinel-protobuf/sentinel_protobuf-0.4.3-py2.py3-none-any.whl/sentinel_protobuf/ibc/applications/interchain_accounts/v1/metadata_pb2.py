...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/applications/interchain_accounts/v1/metadata.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_METADATA'].fields_by_name['controller_connection_id']._loaded_options = None
    _globals['_METADATA'].fields_by_name['controller_connection_id']._serialized_options = b'\xf2\xde\x1f\x1fyaml:"controller_connection_id"'
    _globals['_METADATA'].fields_by_name['host_connection_id']._loaded_options = None
    _globals['_METADATA'].fields_by_name['host_connection_id']._serialized_options = b'\xf2\xde\x1f\x19yaml:"host_connection_id"'
