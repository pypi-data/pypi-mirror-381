...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/applications/transfer/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYTOTALESCROWFORDENOMRESPONSE'].fields_by_name['amount']._serialized_options = b'\xc8\xde\x1f\x00'
    ...
    _globals['_QUERY'].methods_by_name['TotalEscrowForDenom']._serialized_options = b'\x82\xd3\xe4\x93\x026\x124/ibc/apps/transfer/v1/denoms/{denom=**}/total_escrow'
