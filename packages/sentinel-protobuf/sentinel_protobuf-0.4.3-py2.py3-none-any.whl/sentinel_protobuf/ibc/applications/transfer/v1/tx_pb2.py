...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/applications/transfer/v1/tx.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGTRANSFER'].fields_by_name['source_port']._serialized_options = b'\xf2\xde\x1f\x12yaml:"source_port"'
    _globals['_MSGTRANSFER'].fields_by_name['source_channel']._loaded_options = None
    _globals['_MSGTRANSFER'].fields_by_name['source_channel']._serialized_options = b'\xf2\xde\x1f\x15yaml:"source_channel"'
    _globals['_MSGTRANSFER'].fields_by_name['token']._loaded_options = None
    _globals['_MSGTRANSFER'].fields_by_name['token']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_MSGTRANSFER'].fields_by_name['timeout_height']._loaded_options = None
    _globals['_MSGTRANSFER'].fields_by_name['timeout_height']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x15yaml:"timeout_height"'
    _globals['_MSGTRANSFER'].fields_by_name['timeout_timestamp']._loaded_options = None
    _globals['_MSGTRANSFER'].fields_by_name['timeout_timestamp']._serialized_options = b'\xf2\xde\x1f\x18yaml:"timeout_timestamp"'
    _globals['_MSGTRANSFER']._loaded_options = None
    _globals['_MSGTRANSFER']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
