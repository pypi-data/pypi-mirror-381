...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CONFIG']._serialized_options = b'\xba\xc0\x96\xda\x01(\n&github.com/cosmos/cosmos-sdk/x/auth/tx'
