...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/tx/v1beta1/service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BROADCASTMODE'].values_by_name['BROADCAST_MODE_BLOCK']._serialized_options = b'\x08\x01'
    _globals['_GETTXSEVENTREQUEST'].fields_by_name['pagination']._loaded_options = None
    _globals['_GETTXSEVENTREQUEST'].fields_by_name['pagination']._serialized_options = b'\x18\x01'
    _globals['_GETTXSEVENTRESPONSE'].fields_by_name['pagination']._loaded_options = None
    _globals['_GETTXSEVENTRESPONSE'].fields_by_name['pagination']._serialized_options = b'\x18\x01'
    _globals['_SIMULATEREQUEST'].fields_by_name['tx']._loaded_options = None
    _globals['_SIMULATEREQUEST'].fields_by_name['tx']._serialized_options = b'\x18\x01'
    _globals['_SERVICE'].methods_by_name['Simulate']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['Simulate']._serialized_options = b'\x82\xd3\xe4\x93\x02 "\x1b/cosmos/tx/v1beta1/simulate:\x01*'
    _globals['_SERVICE'].methods_by_name['GetTx']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['GetTx']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1f\x12\x1d/cosmos/tx/v1beta1/txs/{hash}'
    _globals['_SERVICE'].methods_by_name['BroadcastTx']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['BroadcastTx']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1b"\x16/cosmos/tx/v1beta1/txs:\x01*'
    _globals['_SERVICE'].methods_by_name['GetTxsEvent']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['GetTxsEvent']._serialized_options = b'\x82\xd3\xe4\x93\x02\x18\x12\x16/cosmos/tx/v1beta1/txs'
    _globals['_SERVICE'].methods_by_name['GetBlockWithTxs']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['GetBlockWithTxs']._serialized_options = b"\x82\xd3\xe4\x93\x02'\x12%/cosmos/tx/v1beta1/txs/block/{height}"
    _globals['_SERVICE'].methods_by_name['TxDecode']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['TxDecode']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1e"\x19/cosmos/tx/v1beta1/decode:\x01*'
    _globals['_SERVICE'].methods_by_name['TxEncode']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['TxEncode']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1e"\x19/cosmos/tx/v1beta1/encode:\x01*'
    _globals['_SERVICE'].methods_by_name['TxEncodeAmino']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['TxEncodeAmino']._serialized_options = b'\x82\xd3\xe4\x93\x02$"\x1f/cosmos/tx/v1beta1/encode/amino:\x01*'
    _globals['_SERVICE'].methods_by_name['TxDecodeAmino']._loaded_options = None
    _globals['_SERVICE'].methods_by_name['TxDecodeAmino']._serialized_options = b'\x82\xd3\xe4\x93\x02$"\x1f/cosmos/tx/v1beta1/decode/amino:\x01*'
