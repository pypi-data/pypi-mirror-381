...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/crypto/multisig/v1beta1/multisig.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MULTISIGNATURE']._serialized_options = b'\xd0\xa1\x1f\x01'
    _globals['_COMPACTBITARRAY']._loaded_options = None
    _globals['_COMPACTBITARRAY']._serialized_options = b'\x98\xa0\x1f\x00'
