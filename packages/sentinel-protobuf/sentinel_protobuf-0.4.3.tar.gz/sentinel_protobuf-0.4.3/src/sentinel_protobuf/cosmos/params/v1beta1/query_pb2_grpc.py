...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Params = channel.unary_unary('/cosmos.params.v1beta1.Query/Params', request_serializer=cosmos_dot_params_dot_v1beta1_dot_query__pb2.QueryParamsRequest.SerializeToString, response_deserializer=cosmos_dot_params_dot_v1beta1_dot_query__pb2.QueryParamsResponse.FromString, _registered_method=True)
        self.Subspaces = channel.unary_unary('/cosmos.params.v1beta1.Query/Subspaces', request_serializer=cosmos_dot_params_dot_v1beta1_dot_query__pb2.QuerySubspacesRequest.SerializeToString, response_deserializer=cosmos_dot_params_dot_v1beta1_dot_query__pb2.QuerySubspacesResponse.FromString, _registered_method=True)
...
class Query(object):
    ...
    def Params(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cosmos.params.v1beta1.Query/Params', cosmos_dot_params_dot_v1beta1_dot_query__pb2.QueryParamsRequest.SerializeToString, cosmos_dot_params_dot_v1beta1_dot_query__pb2.QueryParamsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)
    ...
    def Subspaces(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cosmos.params.v1beta1.Query/Subspaces', cosmos_dot_params_dot_v1beta1_dot_query__pb2.QuerySubspacesRequest.SerializeToString, cosmos_dot_params_dot_v1beta1_dot_query__pb2.QuerySubspacesResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)