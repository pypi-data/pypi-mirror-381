...
class SendAuthorization(_message.Message):
    __slots__ = ('spend_limit', 'allow_list')
    ...
    def __init__(self, spend_limit: _Optional[_Iterable[_Union[_coin_pb2.Coin, _Mapping]]]=..., allow_list: _Optional[_Iterable[str]]=...) -> None:
        ...