...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/bank/v1beta1/tx.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGSEND'].fields_by_name['from_address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_MSGSEND'].fields_by_name['to_address']._loaded_options = None
    _globals['_MSGSEND'].fields_by_name['to_address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_MSGSEND'].fields_by_name['amount']._loaded_options = None
    _globals['_MSGSEND'].fields_by_name['amount']._serialized_options = b'\xc8\xde\x1f\x00\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins\xa8\xe7\xb0*\x01'
    _globals['_MSGSEND']._loaded_options = None
    _globals['_MSGSEND']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00\x82\xe7\xb0*\x0cfrom_address\x8a\xe7\xb0*\x12cosmos-sdk/MsgSend'
    _globals['_MSGMULTISEND'].fields_by_name['inputs']._loaded_options = None
    _globals['_MSGMULTISEND'].fields_by_name['inputs']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_MSGMULTISEND'].fields_by_name['outputs']._loaded_options = None
    _globals['_MSGMULTISEND'].fields_by_name['outputs']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_MSGMULTISEND']._loaded_options = None
    _globals['_MSGMULTISEND']._serialized_options = b'\xe8\xa0\x1f\x00\x82\xe7\xb0*\x06inputs\x8a\xe7\xb0*\x17cosmos-sdk/MsgMultiSend'
    ...
    _globals['_MSGUPDATEPARAMS']._serialized_options = b'\x82\xe7\xb0*\tauthority\x8a\xe7\xb0*!cosmos-sdk/x/bank/MsgUpdateParams'
    _globals['_MSGSETSENDENABLED'].fields_by_name['authority']._loaded_options = None
    _globals['_MSGSETSENDENABLED'].fields_by_name['authority']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_MSGSETSENDENABLED']._loaded_options = None
    _globals['_MSGSETSENDENABLED']._serialized_options = b'\x82\xe7\xb0*\tauthority\x8a\xe7\xb0*\x1ccosmos-sdk/MsgSetSendEnabled'
