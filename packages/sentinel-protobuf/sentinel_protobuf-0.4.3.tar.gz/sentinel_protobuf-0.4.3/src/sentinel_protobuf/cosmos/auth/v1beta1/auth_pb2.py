...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MODULEACCOUNT']._serialized_options = b'\x88\xa0\x1f\x00\xca\xb4-"cosmos.auth.v1beta1.ModuleAccountI\x8a\xe7\xb0*\x18cosmos-sdk/ModuleAccount'
