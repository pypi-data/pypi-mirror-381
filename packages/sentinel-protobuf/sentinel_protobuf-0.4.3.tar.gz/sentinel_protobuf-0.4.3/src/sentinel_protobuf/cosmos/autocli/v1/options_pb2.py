...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_FLAGOPTIONS']._serialized_end = 1082
    _globals['_POSITIONALARGDESCRIPTOR']._serialized_start = 1084
    _globals['_POSITIONALARGDESCRIPTOR']._serialized_end = 1147