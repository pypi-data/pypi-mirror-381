...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/autocli/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_APPOPTIONSRESPONSE_MODULEOPTIONSENTRY']._serialized_options = b'8\x01'
    _globals['_QUERY'].methods_by_name['AppOptions']._loaded_options = None
    _globals['_QUERY'].methods_by_name['AppOptions']._serialized_options = b'\x88\xe7\xb0*\x00'
