...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.AppOptions = channel.unary_unary('/cosmos.autocli.v1.Query/AppOptions', request_serializer=cosmos_dot_autocli_dot_v1_dot_query__pb2.AppOptionsRequest.SerializeToString, response_deserializer=cosmos_dot_autocli_dot_v1_dot_query__pb2.AppOptionsResponse.FromString, _registered_method=True)
...
class Query(object):
    ...
    def AppOptions(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/cosmos.autocli.v1.Query/AppOptions', cosmos_dot_autocli_dot_v1_dot_query__pb2.AppOptionsRequest.SerializeToString, cosmos_dot_autocli_dot_v1_dot_query__pb2.AppOptionsResponse.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)