...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/feegrant/v1beta1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYALLOWANCEREQUEST'].fields_by_name['granter']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_QUERYALLOWANCEREQUEST'].fields_by_name['grantee']._loaded_options = None
    _globals['_QUERYALLOWANCEREQUEST'].fields_by_name['grantee']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_QUERYALLOWANCESREQUEST'].fields_by_name['grantee']._loaded_options = None
    _globals['_QUERYALLOWANCESREQUEST'].fields_by_name['grantee']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_QUERYALLOWANCESBYGRANTERREQUEST'].fields_by_name['granter']._loaded_options = None
    _globals['_QUERYALLOWANCESBYGRANTERREQUEST'].fields_by_name['granter']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_QUERY'].methods_by_name['Allowance']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Allowance']._serialized_options = b'\x82\xd3\xe4\x93\x028\x126/cosmos/feegrant/v1beta1/allowance/{granter}/{grantee}'
    _globals['_QUERY'].methods_by_name['Allowances']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Allowances']._serialized_options = b'\x82\xd3\xe4\x93\x02/\x12-/cosmos/feegrant/v1beta1/allowances/{grantee}'
    _globals['_QUERY'].methods_by_name['AllowancesByGranter']._loaded_options = None
    _globals['_QUERY'].methods_by_name['AllowancesByGranter']._serialized_options = b'\x82\xd3\xe4\x93\x02+\x12)/cosmos/feegrant/v1beta1/issued/{granter}'
