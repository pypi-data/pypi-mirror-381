...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/base/snapshots/v1beta1/snapshot.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SNAPSHOTITEM'].fields_by_name['kv']._serialized_options = b'\x18\x01\xe2\xde\x1f\x02KV'
    _globals['_SNAPSHOTITEM'].fields_by_name['schema']._loaded_options = None
    _globals['_SNAPSHOTITEM'].fields_by_name['schema']._serialized_options = b'\x18\x01'
    _globals['_SNAPSHOTKVITEM']._loaded_options = None
    _globals['_SNAPSHOTKVITEM']._serialized_options = b'\x18\x01'
    _globals['_SNAPSHOTSCHEMA']._loaded_options = None
    _globals['_SNAPSHOTSCHEMA']._serialized_options = b'\x18\x01'
