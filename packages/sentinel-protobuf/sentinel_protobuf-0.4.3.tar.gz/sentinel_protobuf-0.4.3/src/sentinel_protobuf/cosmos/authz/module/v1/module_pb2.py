...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/authz/module/v1/module.proto')
_sym_db = _symbol_database.Default()
from .....cosmos.app.v1alpha1 import module_pb2 as cosmos_dot_app_dot_v1alpha1_dot_module__pb2
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n#cosmos/authz/module/v1/module.proto\x12\x16cosmos.authz.module.v1\x1a cosmos/app/v1alpha1/module.proto"6\n\x06Module:,\xba\xc0\x96\xda\x01&\n$github.com/cosmos/cosmos-sdk/x/authzb\x06proto3')
_globals = globals()
