...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/gov/v1/gov.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_WEIGHTEDVOTEOPTION'].fields_by_name['weight']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
    ...
    _globals['_DEPOSIT'].fields_by_name['amount']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_PROPOSAL'].fields_by_name['submit_time']._loaded_options = None
    _globals['_PROPOSAL'].fields_by_name['submit_time']._serialized_options = b'\x90\xdf\x1f\x01'
    _globals['_PROPOSAL'].fields_by_name['deposit_end_time']._loaded_options = None
    _globals['_PROPOSAL'].fields_by_name['deposit_end_time']._serialized_options = b'\x90\xdf\x1f\x01'
    _globals['_PROPOSAL'].fields_by_name['total_deposit']._loaded_options = None
    _globals['_PROPOSAL'].fields_by_name['total_deposit']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_PROPOSAL'].fields_by_name['voting_start_time']._loaded_options = None
    _globals['_PROPOSAL'].fields_by_name['voting_start_time']._serialized_options = b'\x90\xdf\x1f\x01'
    _globals['_PROPOSAL'].fields_by_name['voting_end_time']._loaded_options = None
    _globals['_PROPOSAL'].fields_by_name['voting_end_time']._serialized_options = b'\x90\xdf\x1f\x01'
    _globals['_PROPOSAL'].fields_by_name['proposer']._loaded_options = None
    _globals['_PROPOSAL'].fields_by_name['proposer']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_TALLYRESULT'].fields_by_name['yes_count']._loaded_options = None
    _globals['_TALLYRESULT'].fields_by_name['yes_count']._serialized_options = b'\xd2\xb4-\ncosmos.Int'
    _globals['_TALLYRESULT'].fields_by_name['abstain_count']._loaded_options = None
    _globals['_TALLYRESULT'].fields_by_name['abstain_count']._serialized_options = b'\xd2\xb4-\ncosmos.Int'
    _globals['_TALLYRESULT'].fields_by_name['no_count']._loaded_options = None
    _globals['_TALLYRESULT'].fields_by_name['no_count']._serialized_options = b'\xd2\xb4-\ncosmos.Int'
    _globals['_TALLYRESULT'].fields_by_name['no_with_veto_count']._loaded_options = None
    _globals['_TALLYRESULT'].fields_by_name['no_with_veto_count']._serialized_options = b'\xd2\xb4-\ncosmos.Int'
    ...
    _globals['_DEPOSITPARAMS'].fields_by_name['min_deposit']._serialized_options = b'\xc8\xde\x1f\x00\xea\xde\x1f\x15min_deposit,omitempty'
    _globals['_DEPOSITPARAMS'].fields_by_name['max_deposit_period']._loaded_options = None
    _globals['_DEPOSITPARAMS'].fields_by_name['max_deposit_period']._serialized_options = b'\xea\xde\x1f\x1cmax_deposit_period,omitempty\x98\xdf\x1f\x01'
    _globals['_VOTINGPARAMS'].fields_by_name['voting_period']._loaded_options = None
    _globals['_VOTINGPARAMS'].fields_by_name['voting_period']._serialized_options = b'\x98\xdf\x1f\x01'
    _globals['_TALLYPARAMS'].fields_by_name['quorum']._loaded_options = None
    _globals['_TALLYPARAMS'].fields_by_name['quorum']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
    _globals['_TALLYPARAMS'].fields_by_name['threshold']._loaded_options = None
    _globals['_TALLYPARAMS'].fields_by_name['threshold']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
    _globals['_TALLYPARAMS'].fields_by_name['veto_threshold']._loaded_options = None
    _globals['_TALLYPARAMS'].fields_by_name['veto_threshold']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
    _globals['_PARAMS'].fields_by_name['min_deposit']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['min_deposit']._serialized_options = b'\xc8\xde\x1f\x00\xa8\xe7\xb0*\x01'
    _globals['_PARAMS'].fields_by_name['max_deposit_period']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['max_deposit_period']._serialized_options = b'\x98\xdf\x1f\x01'
    _globals['_PARAMS'].fields_by_name['voting_period']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['voting_period']._serialized_options = b'\x98\xdf\x1f\x01'
    _globals['_PARAMS'].fields_by_name['quorum']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['quorum']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
    _globals['_PARAMS'].fields_by_name['threshold']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['threshold']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
    _globals['_PARAMS'].fields_by_name['veto_threshold']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['veto_threshold']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
    _globals['_PARAMS'].fields_by_name['min_initial_deposit_ratio']._loaded_options = None
    _globals['_PARAMS'].fields_by_name['min_initial_deposit_ratio']._serialized_options = b'\xd2\xb4-\ncosmos.Dec'
