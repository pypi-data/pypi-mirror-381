...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'cosmos/evidence/v1beta1/evidence.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'Z-github.com/cosmos/cosmos-sdk/x/evidence/types\xa8\xe2\x1e\x01'
    _globals['_EQUIVOCATION'].fields_by_name['time']._loaded_options = None
    _globals['_EQUIVOCATION'].fields_by_name['time']._serialized_options = b'\xc8\xde\x1f\x00\x90\xdf\x1f\x01\xa8\xe7\xb0*\x01'
    _globals['_EQUIVOCATION'].fields_by_name['consensus_address']._loaded_options = None
    _globals['_EQUIVOCATION'].fields_by_name['consensus_address']._serialized_options = b'\xd2\xb4-\x14cosmos.AddressString'
    _globals['_EQUIVOCATION']._loaded_options = None
    _globals['_EQUIVOCATION']._serialized_options = b'\x88\xa0\x1f\x00\x98\xa0\x1f\x00\xe8\xa0\x1f\x00\x8a\xe7\xb0*\x17cosmos-sdk/Equivocation'
