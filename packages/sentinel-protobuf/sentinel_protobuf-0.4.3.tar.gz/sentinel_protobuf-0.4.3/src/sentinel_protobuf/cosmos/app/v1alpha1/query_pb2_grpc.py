...
class QueryStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Config = channel.unary_unary('/cosmos.app.v1alpha1.Query/Config', request_serializer=cosmos_dot_app_dot_v1alpha1_dot_query__pb2.QueryConfigRequest.SerializeToString, response_deserializer=cosmos_dot_app_dot_v1alpha1_dot_query__pb2.QueryConfigResponse.FromString, _registered_method=True)
