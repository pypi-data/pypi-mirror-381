...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'sentinel/plan/v3/querier.proto')
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n\x1esentinel/plan/v3/querier.proto\x12\x10sentinel.plan.v3\x1a*cosmos/base/query/v1beta1/pagination.proto\x1a\x14gogoproto/gogo.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1bsentinel/plan/v3/plan.proto\x1a\x1esentinel/types/v1/status.proto"z\n\x11QueryPlansRequest\x12)\n\x06status\x18\x01 \x01(\x0e2\x19.sentinel.types.v1.Status\x12:\n\npagination\x18\x02 \x01(\x0b2&.cosmos.base.query.v1beta1.PageRequest"\x96\x01\n\x1cQueryPlansForProviderRequest\x12\x0f\n\x07address\x18\x01 \x01(\t\x12)\n\x06status\x18\x02 \x01(\x0e2\x19.sentinel.types.v1.Status\x12:\n\npagination\x18\x03 \x01(\x0b2&.cosmos.base.query.v1beta1.PageRequest"\x1e\n\x10QueryPlanRequest\x12\n\n\x02id\x18\x01 \x01(\x04"~\n\x12QueryPlansResponse\x12+\n\x05plans\x18\x01 \x03(\x0b2\x16.sentinel.plan.v3.PlanB\x04\xc8\xde\x1f\x00\x12;\n\npagination\x18\x02 \x01(\x0b2\'.cosmos.base.query.v1beta1.PageResponse"\x89\x01\n\x1dQueryPlansForProviderResponse\x12+\n\x05plans\x18\x01 \x03(\x0b2\x16.sentinel.plan.v3.PlanB\x04\xc8\xde\x1f\x00\x12;\n\npagination\x18\x02 \x01(\x0b2\'.cosmos.base.query.v1beta1.PageResponse"?\n\x11QueryPlanResponse\x12*\n\x04plan\x18\x01 \x01(\x0b2\x16.sentinel.plan.v3.PlanB\x04\xc8\xde\x1f\x002\xb4\x03\n\x0cQueryService\x12x\n\nQueryPlans\x12#.sentinel.plan.v3.QueryPlansRequest\x1a$.sentinel.plan.v3.QueryPlansResponse"\x1f\x82\xd3\xe4\x93\x02\x19\x12\x17/sentinel/plan/v3/plans\x12\xad\x01\n\x15QueryPlansForProvider\x12..sentinel.plan.v3.QueryPlansForProviderRequest\x1a/.sentinel.plan.v3.QueryPlansForProviderResponse"3\x82\xd3\xe4\x93\x02-\x12+/sentinel/plan/v3/providers/{address}/plans\x12z\n\tQueryPlan\x12".sentinel.plan.v3.QueryPlanRequest\x1a#.sentinel.plan.v3.QueryPlanResponse"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/sentinel/plan/v3/plans/{id}BFZ<github.com/sentinel-official/sentinelhub/v12/x/plan/types/v3\xc8\xe1\x1e\x00\xa8\xe2\x1e\x00b\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'sentinel.plan.v3.querier_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYSERVICE'].methods_by_name['QueryPlans']._serialized_options = b'\x82\xd3\xe4\x93\x02\x19\x12\x17/sentinel/plan/v3/plans'
    _globals['_QUERYSERVICE'].methods_by_name['QueryPlansForProvider']._loaded_options = None
    _globals['_QUERYSERVICE'].methods_by_name['QueryPlansForProvider']._serialized_options = b'\x82\xd3\xe4\x93\x02-\x12+/sentinel/plan/v3/providers/{address}/plans'
    _globals['_QUERYSERVICE'].methods_by_name['QueryPlan']._loaded_options = None
    _globals['_QUERYSERVICE'].methods_by_name['QueryPlan']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1e\x12\x1c/sentinel/plan/v3/plans/{id}'
