...
class QuerySessionsResponse(_message.Message):
    ...
    def __init__(self, sessions: _Optional[_Iterable[_Union[_any_pb2.Any, _Mapping]]]=..., pagination: _Optional[_Union[_pagination_pb2.PageResponse, _Mapping]]=...) -> None:
        ...
...
class QuerySessionResponse(_message.Message):
    ...
    session: _any_pb2.Any

    def __init__(self, session: _Optional[_Union[_any_pb2.Any, _Mapping]]=...) -> None:
        ...
