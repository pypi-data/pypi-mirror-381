...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'sentinel/provider/v2/genesis.proto')
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n"sentinel/provider/v2/genesis.proto\x12\x14sentinel.provider.v2\x1a\x14gogoproto/gogo.proto\x1a!sentinel/provider/v2/params.proto\x1a#sentinel/provider/v2/provider.proto"{\n\x0cGenesisState\x127\n\tproviders\x18\x01 \x03(\x0b2\x1e.sentinel.provider.v2.ProviderB\x04\xc8\xde\x1f\x00\x122\n\x06params\x18\x02 \x01(\x0b2\x1c.sentinel.provider.v2.ParamsB\x04\xc8\xde\x1f\x00BJZ@github.com/sentinel-official/sentinelhub/v12/x/provider/types/v2\xc8\xe1\x1e\x00\xa8\xe2\x1e\x00b\x06proto3')
_globals = globals()
