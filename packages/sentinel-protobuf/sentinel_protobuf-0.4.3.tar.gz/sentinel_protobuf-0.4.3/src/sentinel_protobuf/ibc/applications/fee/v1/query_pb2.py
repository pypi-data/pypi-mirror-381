...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/applications/fee/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYINCENTIVIZEDPACKETSRESPONSE'].fields_by_name['incentivized_packets']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYINCENTIVIZEDPACKETREQUEST'].fields_by_name['packet_id']._loaded_options = None
    _globals['_QUERYINCENTIVIZEDPACKETREQUEST'].fields_by_name['packet_id']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYINCENTIVIZEDPACKETRESPONSE'].fields_by_name['incentivized_packet']._loaded_options = None
    _globals['_QUERYINCENTIVIZEDPACKETRESPONSE'].fields_by_name['incentivized_packet']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYTOTALRECVFEESREQUEST'].fields_by_name['packet_id']._loaded_options = None
    _globals['_QUERYTOTALRECVFEESREQUEST'].fields_by_name['packet_id']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYTOTALRECVFEESRESPONSE'].fields_by_name['recv_fees']._loaded_options = None
    _globals['_QUERYTOTALRECVFEESRESPONSE'].fields_by_name['recv_fees']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x10yaml:"recv_fees"\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_QUERYTOTALACKFEESREQUEST'].fields_by_name['packet_id']._loaded_options = None
    _globals['_QUERYTOTALACKFEESREQUEST'].fields_by_name['packet_id']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYTOTALACKFEESRESPONSE'].fields_by_name['ack_fees']._loaded_options = None
    _globals['_QUERYTOTALACKFEESRESPONSE'].fields_by_name['ack_fees']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x0fyaml:"ack_fees"\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_QUERYTOTALTIMEOUTFEESREQUEST'].fields_by_name['packet_id']._loaded_options = None
    _globals['_QUERYTOTALTIMEOUTFEESREQUEST'].fields_by_name['packet_id']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYTOTALTIMEOUTFEESRESPONSE'].fields_by_name['timeout_fees']._loaded_options = None
    _globals['_QUERYTOTALTIMEOUTFEESRESPONSE'].fields_by_name['timeout_fees']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x13yaml:"timeout_fees"\xaa\xdf\x1f(github.com/cosmos/cosmos-sdk/types.Coins'
    _globals['_QUERYPAYEEREQUEST'].fields_by_name['channel_id']._loaded_options = None
    _globals['_QUERYPAYEEREQUEST'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
    _globals['_QUERYPAYEERESPONSE'].fields_by_name['payee_address']._loaded_options = None
    _globals['_QUERYPAYEERESPONSE'].fields_by_name['payee_address']._serialized_options = b'\xf2\xde\x1f\x14yaml:"payee_address"'
    _globals['_QUERYCOUNTERPARTYPAYEEREQUEST'].fields_by_name['channel_id']._loaded_options = None
    _globals['_QUERYCOUNTERPARTYPAYEEREQUEST'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
    _globals['_QUERYCOUNTERPARTYPAYEERESPONSE'].fields_by_name['counterparty_payee']._loaded_options = None
    _globals['_QUERYCOUNTERPARTYPAYEERESPONSE'].fields_by_name['counterparty_payee']._serialized_options = b'\xf2\xde\x1f\x19yaml:"counterparty_payee"'
    _globals['_QUERYFEEENABLEDCHANNELSRESPONSE'].fields_by_name['fee_enabled_channels']._loaded_options = None
    _globals['_QUERYFEEENABLEDCHANNELSRESPONSE'].fields_by_name['fee_enabled_channels']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x1byaml:"fee_enabled_channels"'
    _globals['_QUERYFEEENABLEDCHANNELREQUEST'].fields_by_name['port_id']._loaded_options = None
    _globals['_QUERYFEEENABLEDCHANNELREQUEST'].fields_by_name['port_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"port_id"'
    _globals['_QUERYFEEENABLEDCHANNELREQUEST'].fields_by_name['channel_id']._loaded_options = None
    _globals['_QUERYFEEENABLEDCHANNELREQUEST'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
    _globals['_QUERYFEEENABLEDCHANNELRESPONSE'].fields_by_name['fee_enabled']._loaded_options = None
    _globals['_QUERYFEEENABLEDCHANNELRESPONSE'].fields_by_name['fee_enabled']._serialized_options = b'\xf2\xde\x1f\x12yaml:"fee_enabled"'
    _globals['_QUERY'].methods_by_name['IncentivizedPackets']._loaded_options = None
    _globals['_QUERY'].methods_by_name['IncentivizedPackets']._serialized_options = b"\x82\xd3\xe4\x93\x02'\x12%/ibc/apps/fee/v1/incentivized_packets"
    _globals['_QUERY'].methods_by_name['IncentivizedPacket']._loaded_options = None
    _globals['_QUERY'].methods_by_name['IncentivizedPacket']._serialized_options = b'\x82\xd3\xe4\x93\x02\x7f\x12}/ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/incentivized_packet'
    _globals['_QUERY'].methods_by_name['IncentivizedPacketsForChannel']._loaded_options = None
    _globals['_QUERY'].methods_by_name['IncentivizedPacketsForChannel']._serialized_options = b'\x82\xd3\xe4\x93\x02M\x12K/ibc/apps/fee/v1/channels/{channel_id}/ports/{port_id}/incentivized_packets'
    _globals['_QUERY'].methods_by_name['TotalRecvFees']._loaded_options = None
    _globals['_QUERY'].methods_by_name['TotalRecvFees']._serialized_options = b'\x82\xd3\xe4\x93\x02{\x12y/ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_recv_fees'
    _globals['_QUERY'].methods_by_name['TotalAckFees']._loaded_options = None
    _globals['_QUERY'].methods_by_name['TotalAckFees']._serialized_options = b'\x82\xd3\xe4\x93\x02z\x12x/ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_ack_fees'
    _globals['_QUERY'].methods_by_name['TotalTimeoutFees']._loaded_options = None
    _globals['_QUERY'].methods_by_name['TotalTimeoutFees']._serialized_options = b'\x82\xd3\xe4\x93\x02~\x12|/ibc/apps/fee/v1/channels/{packet_id.channel_id}/ports/{packet_id.port_id}/sequences/{packet_id.sequence}/total_timeout_fees'
    _globals['_QUERY'].methods_by_name['Payee']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Payee']._serialized_options = b'\x82\xd3\xe4\x93\x02A\x12?/ibc/apps/fee/v1/channels/{channel_id}/relayers/{relayer}/payee'
    _globals['_QUERY'].methods_by_name['CounterpartyPayee']._loaded_options = None
    _globals['_QUERY'].methods_by_name['CounterpartyPayee']._serialized_options = b'\x82\xd3\xe4\x93\x02N\x12L/ibc/apps/fee/v1/channels/{channel_id}/relayers/{relayer}/counterparty_payee'
    _globals['_QUERY'].methods_by_name['FeeEnabledChannels']._loaded_options = None
    _globals['_QUERY'].methods_by_name['FeeEnabledChannels']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1e\x12\x1c/ibc/apps/fee/v1/fee_enabled'
    _globals['_QUERY'].methods_by_name['FeeEnabledChannel']._loaded_options = None
    _globals['_QUERY'].methods_by_name['FeeEnabledChannel']._serialized_options = b'\x82\xd3\xe4\x93\x02D\x12B/ibc/apps/fee/v1/channels/{channel_id}/ports/{port_id}/fee_enabled'
