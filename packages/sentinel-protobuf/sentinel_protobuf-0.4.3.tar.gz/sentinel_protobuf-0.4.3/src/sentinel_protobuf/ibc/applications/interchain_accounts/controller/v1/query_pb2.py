...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/applications/interchain_accounts/controller/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYINTERCHAINACCOUNTREQUEST'].fields_by_name['connection_id']._loaded_options = None
    _globals['_QUERYINTERCHAINACCOUNTREQUEST'].fields_by_name['connection_id']._serialized_options = b'\xf2\xde\x1f\x14yaml:"connection_id"'
    _globals['_QUERY'].methods_by_name['InterchainAccount']._loaded_options = None
    _globals['_QUERY'].methods_by_name['InterchainAccount']._serialized_options = b'\x82\xd3\xe4\x93\x02X\x12V/ibc/apps/interchain_accounts/controller/v1/owners/{owner}/connections/{connection_id}'
    _globals['_QUERY'].methods_by_name['Params']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Params']._serialized_options = b'\x82\xd3\xe4\x93\x024\x122/ibc/apps/interchain_accounts/controller/v1/params'
