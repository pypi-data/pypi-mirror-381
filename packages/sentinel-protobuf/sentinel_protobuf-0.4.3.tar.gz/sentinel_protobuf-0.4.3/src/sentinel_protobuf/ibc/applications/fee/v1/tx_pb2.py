...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/applications/fee/v1/tx.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MSGREGISTERPAYEE'].fields_by_name['port_id']._loaded_options = None
    _globals['_MSGREGISTERPAYEE'].fields_by_name['port_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"port_id"'
    _globals['_MSGREGISTERPAYEE'].fields_by_name['channel_id']._loaded_options = None
    _globals['_MSGREGISTERPAYEE'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
    _globals['_MSGREGISTERPAYEE']._loaded_options = None
    _globals['_MSGREGISTERPAYEE']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGREGISTERCOUNTERPARTYPAYEE'].fields_by_name['port_id']._loaded_options = None
    _globals['_MSGREGISTERCOUNTERPARTYPAYEE'].fields_by_name['port_id']._serialized_options = b'\xf2\xde\x1f\x0eyaml:"port_id"'
    _globals['_MSGREGISTERCOUNTERPARTYPAYEE'].fields_by_name['channel_id']._loaded_options = None
    _globals['_MSGREGISTERCOUNTERPARTYPAYEE'].fields_by_name['channel_id']._serialized_options = b'\xf2\xde\x1f\x11yaml:"channel_id"'
    _globals['_MSGREGISTERCOUNTERPARTYPAYEE'].fields_by_name['counterparty_payee']._loaded_options = None
    _globals['_MSGREGISTERCOUNTERPARTYPAYEE'].fields_by_name['counterparty_payee']._serialized_options = b'\xf2\xde\x1f\x19yaml:"counterparty_payee"'
    _globals['_MSGREGISTERCOUNTERPARTYPAYEE']._loaded_options = None
    _globals['_MSGREGISTERCOUNTERPARTYPAYEE']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGPAYPACKETFEE'].fields_by_name['fee']._loaded_options = None
    _globals['_MSGPAYPACKETFEE'].fields_by_name['fee']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_MSGPAYPACKETFEE'].fields_by_name['source_port_id']._loaded_options = None
    _globals['_MSGPAYPACKETFEE'].fields_by_name['source_port_id']._serialized_options = b'\xf2\xde\x1f\x15yaml:"source_port_id"'
    _globals['_MSGPAYPACKETFEE'].fields_by_name['source_channel_id']._loaded_options = None
    _globals['_MSGPAYPACKETFEE'].fields_by_name['source_channel_id']._serialized_options = b'\xf2\xde\x1f\x18yaml:"source_channel_id"'
    _globals['_MSGPAYPACKETFEE']._loaded_options = None
    _globals['_MSGPAYPACKETFEE']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
    _globals['_MSGPAYPACKETFEEASYNC'].fields_by_name['packet_id']._loaded_options = None
    _globals['_MSGPAYPACKETFEEASYNC'].fields_by_name['packet_id']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x10yaml:"packet_id"'
    _globals['_MSGPAYPACKETFEEASYNC'].fields_by_name['packet_fee']._loaded_options = None
    _globals['_MSGPAYPACKETFEEASYNC'].fields_by_name['packet_fee']._serialized_options = b'\xc8\xde\x1f\x00\xf2\xde\x1f\x11yaml:"packet_fee"'
    _globals['_MSGPAYPACKETFEEASYNC']._loaded_options = None
    _globals['_MSGPAYPACKETFEEASYNC']._serialized_options = b'\x88\xa0\x1f\x00\xe8\xa0\x1f\x00'
