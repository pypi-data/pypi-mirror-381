...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_TYPE']._serialized_options = b'\x88\xa3\x1e\x00'
    _globals['_TYPE'].values_by_name['TYPE_UNSPECIFIED']._loaded_options = None
    _globals['_TYPE'].values_by_name['TYPE_UNSPECIFIED']._serialized_options = b'\x8a\x9d \x0bUNSPECIFIED'
    _globals['_TYPE'].values_by_name['TYPE_EXECUTE_TX']._loaded_options = None
    _globals['_TYPE'].values_by_name['TYPE_EXECUTE_TX']._serialized_options = b'\x8a\x9d \nEXECUTE_TX'
