...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'ibc/core/channel/v1/query.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_QUERYCHANNELRESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYCHANNELSRESPONSE'].fields_by_name['height']._loaded_options = None
    _globals['_QUERYCHANNELSRESPONSE'].fields_by_name['height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYCONNECTIONCHANNELSRESPONSE'].fields_by_name['height']._loaded_options = None
    _globals['_QUERYCONNECTIONCHANNELSRESPONSE'].fields_by_name['height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYCHANNELCLIENTSTATERESPONSE'].fields_by_name['proof_height']._loaded_options = None
    _globals['_QUERYCHANNELCLIENTSTATERESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYCHANNELCONSENSUSSTATERESPONSE'].fields_by_name['proof_height']._loaded_options = None
    _globals['_QUERYCHANNELCONSENSUSSTATERESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYPACKETCOMMITMENTRESPONSE'].fields_by_name['proof_height']._loaded_options = None
    _globals['_QUERYPACKETCOMMITMENTRESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYPACKETCOMMITMENTSRESPONSE'].fields_by_name['height']._loaded_options = None
    _globals['_QUERYPACKETCOMMITMENTSRESPONSE'].fields_by_name['height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYPACKETRECEIPTRESPONSE'].fields_by_name['proof_height']._loaded_options = None
    _globals['_QUERYPACKETRECEIPTRESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYPACKETACKNOWLEDGEMENTRESPONSE'].fields_by_name['proof_height']._loaded_options = None
    _globals['_QUERYPACKETACKNOWLEDGEMENTRESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYPACKETACKNOWLEDGEMENTSRESPONSE'].fields_by_name['height']._loaded_options = None
    _globals['_QUERYPACKETACKNOWLEDGEMENTSRESPONSE'].fields_by_name['height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYUNRECEIVEDPACKETSRESPONSE'].fields_by_name['height']._loaded_options = None
    _globals['_QUERYUNRECEIVEDPACKETSRESPONSE'].fields_by_name['height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYUNRECEIVEDACKSRESPONSE'].fields_by_name['height']._loaded_options = None
    _globals['_QUERYUNRECEIVEDACKSRESPONSE'].fields_by_name['height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERYNEXTSEQUENCERECEIVERESPONSE'].fields_by_name['proof_height']._loaded_options = None
    _globals['_QUERYNEXTSEQUENCERECEIVERESPONSE'].fields_by_name['proof_height']._serialized_options = b'\xc8\xde\x1f\x00'
    _globals['_QUERY'].methods_by_name['Channel']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Channel']._serialized_options = b'\x82\xd3\xe4\x93\x02<\x12:/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}'
    _globals['_QUERY'].methods_by_name['Channels']._loaded_options = None
    _globals['_QUERY'].methods_by_name['Channels']._serialized_options = b'\x82\xd3\xe4\x93\x02\x1f\x12\x1d/ibc/core/channel/v1/channels'
    _globals['_QUERY'].methods_by_name['ConnectionChannels']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ConnectionChannels']._serialized_options = b'\x82\xd3\xe4\x93\x028\x126/ibc/core/channel/v1/connections/{connection}/channels'
    _globals['_QUERY'].methods_by_name['ChannelClientState']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ChannelClientState']._serialized_options = b'\x82\xd3\xe4\x93\x02I\x12G/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/client_state'
    _globals['_QUERY'].methods_by_name['ChannelConsensusState']._loaded_options = None
    _globals['_QUERY'].methods_by_name['ChannelConsensusState']._serialized_options = b'\x82\xd3\xe4\x93\x02\x80\x01\x12~/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/consensus_state/revision/{revision_number}/height/{revision_height}'
    _globals['_QUERY'].methods_by_name['PacketCommitment']._loaded_options = None
    _globals['_QUERY'].methods_by_name['PacketCommitment']._serialized_options = b'\x82\xd3\xe4\x93\x02Z\x12X/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/packet_commitments/{sequence}'
    _globals['_QUERY'].methods_by_name['PacketCommitments']._loaded_options = None
    _globals['_QUERY'].methods_by_name['PacketCommitments']._serialized_options = b'\x82\xd3\xe4\x93\x02O\x12M/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/packet_commitments'
    _globals['_QUERY'].methods_by_name['PacketReceipt']._loaded_options = None
    _globals['_QUERY'].methods_by_name['PacketReceipt']._serialized_options = b'\x82\xd3\xe4\x93\x02W\x12U/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/packet_receipts/{sequence}'
    _globals['_QUERY'].methods_by_name['PacketAcknowledgement']._loaded_options = None
    _globals['_QUERY'].methods_by_name['PacketAcknowledgement']._serialized_options = b'\x82\xd3\xe4\x93\x02S\x12Q/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/packet_acks/{sequence}'
    _globals['_QUERY'].methods_by_name['PacketAcknowledgements']._loaded_options = None
    _globals['_QUERY'].methods_by_name['PacketAcknowledgements']._serialized_options = b'\x82\xd3\xe4\x93\x02T\x12R/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/packet_acknowledgements'
    _globals['_QUERY'].methods_by_name['UnreceivedPackets']._loaded_options = None
    _globals['_QUERY'].methods_by_name['UnreceivedPackets']._serialized_options = b'\x82\xd3\xe4\x93\x02\x80\x01\x12~/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/packet_commitments/{packet_commitment_sequences}/unreceived_packets'
    _globals['_QUERY'].methods_by_name['UnreceivedAcks']._loaded_options = None
    _globals['_QUERY'].methods_by_name['UnreceivedAcks']._serialized_options = b'\x82\xd3\xe4\x93\x02v\x12t/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/packet_commitments/{packet_ack_sequences}/unreceived_acks'
    _globals['_QUERY'].methods_by_name['NextSequenceReceive']._loaded_options = None
    _globals['_QUERY'].methods_by_name['NextSequenceReceive']._serialized_options = b'\x82\xd3\xe4\x93\x02J\x12H/ibc/core/channel/v1/channels/{channel_id}/ports/{port_id}/next_sequence'
