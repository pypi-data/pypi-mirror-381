from google.appengine.v1 import app_yaml_pb2 as _app_yaml_pb2
from google.appengine.v1 import deploy_pb2 as _deploy_pb2
...
class AutomaticScaling(_message.Message):
    __slots__ = ('cool_down_period', 'cpu_utilization', 'max_concurrent_requests', 'max_idle_instances', 'max_total_instances', 'max_pending_latency', 'min_idle_instances', 'min_total_instances', 'min_pending_latency', 'request_utilization', 'disk_utilization', 'network_utilization', 'standard_scheduler_settings')
    ...
    def __init__(self, cool_down_period: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., cpu_utilization: _Optional[_Union[CpuUtilization, _Mapping]]=..., max_concurrent_requests: _Optional[int]=..., max_idle_instances: _Optional[int]=..., max_total_instances: _Optional[int]=..., max_pending_latency: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., min_idle_instances: _Optional[int]=..., min_total_instances: _Optional[int]=..., min_pending_latency: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., request_utilization: _Optional[_Union[RequestUtilization, _Mapping]]=..., disk_utilization: _Optional[_Union[DiskUtilization, _Mapping]]=..., network_utilization: _Optional[_Union[NetworkUtilization, _Mapping]]=..., standard_scheduler_settings: _Optional[_Union[StandardSchedulerSettings, _Mapping]]=...) -> None:
        ...
...
class VpcAccessConnector(_message.Message):
    __slots__ = ('name', 'egress_setting')

    class EgressSetting(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        EGRESS_SETTING_UNSPECIFIED: _ClassVar[VpcAccessConnector.EgressSetting]
        ALL_TRAFFIC: _ClassVar[VpcAccessConnector.EgressSetting]
        PRIVATE_IP_RANGES: _ClassVar[VpcAccessConnector.EgressSetting]
    EGRESS_SETTING_UNSPECIFIED: VpcAccessConnector.EgressSetting
    ALL_TRAFFIC: VpcAccessConnector.EgressSetting
    PRIVATE_IP_RANGES: VpcAccessConnector.EgressSetting
    NAME_FIELD_NUMBER: _ClassVar[int]
    EGRESS_SETTING_FIELD_NUMBER: _ClassVar[int]
    name: str
    egress_setting: VpcAccessConnector.EgressSetting

    def __init__(self, name: _Optional[str]=..., egress_setting: _Optional[_Union[VpcAccessConnector.EgressSetting, str]]=...) -> None:
        ...
