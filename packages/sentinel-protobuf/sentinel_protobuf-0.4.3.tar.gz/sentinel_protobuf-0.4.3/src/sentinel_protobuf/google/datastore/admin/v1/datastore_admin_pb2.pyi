...
from google.datastore.admin.v1 import index_pb2 as _index_pb2
from google.datastore.admin.v1 import migration_pb2 as _migration_pb2
...
class OperationType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CREATE_INDEX: _ClassVar[OperationType]
    DELETE_INDEX: _ClassVar[OperationType]
OPERATION_TYPE_UNSPECIFIED: OperationType
EXPORT_ENTITIES: OperationType
IMPORT_ENTITIES: OperationType
CREATE_INDEX: OperationType
DELETE_INDEX: OperationType
...
class CreateIndexRequest(_message.Message):
    __slots__ = ('project_id', 'index')
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    INDEX_FIELD_NUMBER: _ClassVar[int]
    project_id: str
    index: _index_pb2.Index

    def __init__(self, project_id: _Optional[str]=..., index: _Optional[_Union[_index_pb2.Index, _Mapping]]=...) -> None:
        ...

class DeleteIndexRequest(_message.Message):
    __slots__ = ('project_id', 'index_id')
    PROJECT_ID_FIELD_NUMBER: _ClassVar[int]
    INDEX_ID_FIELD_NUMBER: _ClassVar[int]
    project_id: str
    index_id: str

    def __init__(self, project_id: _Optional[str]=..., index_id: _Optional[str]=...) -> None:
        ...
...
class IndexOperationMetadata(_message.Message):
    __slots__ = ('common', 'progress_entities', 'index_id')
    COMMON_FIELD_NUMBER: _ClassVar[int]
    PROGRESS_ENTITIES_FIELD_NUMBER: _ClassVar[int]
    INDEX_ID_FIELD_NUMBER: _ClassVar[int]
    common: CommonMetadata
    ...
    def __init__(self, common: _Optional[_Union[CommonMetadata, _Mapping]]=..., progress_entities: _Optional[_Union[Progress, _Mapping]]=..., index_id: _Optional[str]=...) -> None:
        ...

class DatastoreFirestoreMigrationMetadata(_message.Message):
    __slots__ = ('migration_state', 'migration_step')
    MIGRATION_STATE_FIELD_NUMBER: _ClassVar[int]
    MIGRATION_STEP_FIELD_NUMBER: _ClassVar[int]
    migration_state: _migration_pb2.MigrationState
    migration_step: _migration_pb2.MigrationStep

    def __init__(self, migration_state: _Optional[_Union[_migration_pb2.MigrationState, str]]=..., migration_step: _Optional[_Union[_migration_pb2.MigrationStep, str]]=...) -> None:
        ...