    ...
    class Bytes(_message.Message):
        ...
        class Encoding(_message.Message):
            ...
            class Raw(_message.Message):
                __slots__ = ('escape_nulls',)
                ESCAPE_NULLS_FIELD_NUMBER: _ClassVar[int]
                escape_nulls: bool

                def __init__(self, escape_nulls: bool=...) -> None:
                    ...
    ...
    class String(_message.Message):
        ...
        class Encoding(_message.Message):
            ...
            class Utf8Bytes(_message.Message):
                __slots__ = ('null_escape_char',)
                NULL_ESCAPE_CHAR_FIELD_NUMBER: _ClassVar[int]
                null_escape_char: str

                def __init__(self, null_escape_char: _Optional[str]=...) -> None:
                    ...
