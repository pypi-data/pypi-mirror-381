...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/shopping/merchant/lfp/v1/lfpinventory.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LFPINVENTORYSERVICE'].methods_by_name['InsertLfpInventory']._serialized_options = b'\x82\xd3\xe4\x93\x02B"1/lfp/v1/{parent=accounts/*}/lfpInventories:insert:\rlfp_inventory'
    _globals['_LFPINVENTORY']._serialized_start = 270
    _globals['_LFPINVENTORY']._serialized_end = 944
    _globals['_INSERTLFPINVENTORYREQUEST']._serialized_start = 947
    _globals['_INSERTLFPINVENTORYREQUEST']._serialized_end = 1114
    _globals['_LFPINVENTORYSERVICE']._serialized_start = 1117
    _globals['_LFPINVENTORYSERVICE']._serialized_end = 1415