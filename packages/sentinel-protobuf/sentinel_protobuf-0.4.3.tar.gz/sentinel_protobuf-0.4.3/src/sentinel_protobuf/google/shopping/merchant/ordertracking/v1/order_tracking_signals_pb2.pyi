...
class OrderTrackingSignal(_message.Message):
    ...
    class LineItemDetails(_message.Message):
        __slots__ = ('line_item_id', 'product_id', 'gtins', 'mpn', 'product_title', 'brand', 'quantity')
        ...
        def __init__(self, line_item_id: _Optional[str]=..., product_id: _Optional[str]=..., gtins: _Optional[_Iterable[str]]=..., mpn: _Optional[str]=..., product_title: _Optional[str]=..., brand: _Optional[str]=..., quantity: _Optional[int]=...) -> None:
            ...
