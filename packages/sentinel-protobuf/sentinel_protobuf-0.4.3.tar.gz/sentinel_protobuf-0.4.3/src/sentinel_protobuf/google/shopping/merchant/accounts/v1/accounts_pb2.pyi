...
from google.shopping.merchant.accounts.v1 import accountservices_pb2 as _accountservices_pb2
from google.shopping.merchant.accounts.v1 import user_pb2 as _user_pb2
...
class CreateAndConfigureAccountRequest(_message.Message):
    __slots__ = ('account', 'user', 'service')

    class AddUser(_message.Message):
        ...
        def __init__(self, user_id: _Optional[str]=..., user: _Optional[_Union[_user_pb2.User, _Mapping]]=...) -> None:
            ...
    ...
    account: Account
    user: _containers.RepeatedCompositeFieldContainer[CreateAndConfigureAccountRequest.AddUser]
    service: _containers.RepeatedCompositeFieldContainer[CreateAndConfigureAccountRequest.AddAccountService]

    def __init__(self, account: _Optional[_Union[Account, _Mapping]]=..., user: _Optional[_Iterable[_Union[CreateAndConfigureAccountRequest.AddUser, _Mapping]]]=..., service: _Optional[_Iterable[_Union[CreateAndConfigureAccountRequest.AddAccountService, _Mapping]]]=...) -> None:
        ...
