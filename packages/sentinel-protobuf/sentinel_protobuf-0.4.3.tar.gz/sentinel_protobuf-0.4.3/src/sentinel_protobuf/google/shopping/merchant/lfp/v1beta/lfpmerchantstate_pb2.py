...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LFPMERCHANTSTATESERVICE'].methods_by_name['GetLfpMerchantState']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x023\x121/lfp/v1beta/{name=accounts/*/lfpMerchantStates/*}'
    _globals['_LFPMERCHANTSTATE']._serialized_start = 215
    _globals['_LFPMERCHANTSTATE']._serialized_end = 2111
    _globals['_LFPMERCHANTSTATE_LFPSTORESTATE']._serialized_start = 564
    _globals['_LFPMERCHANTSTATE_LFPSTORESTATE']._serialized_end = 880
    _globals['_LFPMERCHANTSTATE_LFPSTORESTATE_STOREMATCHINGSTATE']._serialized_start = 755
    _globals['_LFPMERCHANTSTATE_LFPSTORESTATE_STOREMATCHINGSTATE']._serialized_end = 880
    _globals['_LFPMERCHANTSTATE_INVENTORYSTATS']._serialized_start = 883
    _globals['_LFPMERCHANTSTATE_INVENTORYSTATS']._serialized_end = 1019
    _globals['_LFPMERCHANTSTATE_COUNTRYSETTINGS']._serialized_start = 1022
    _globals['_LFPMERCHANTSTATE_COUNTRYSETTINGS']._serialized_end = 1963
    _globals['_LFPMERCHANTSTATE_COUNTRYSETTINGS_VERIFICATIONSTATE']._serialized_start = 1671
    _globals['_LFPMERCHANTSTATE_COUNTRYSETTINGS_VERIFICATIONSTATE']._serialized_end = 1832
    _globals['_LFPMERCHANTSTATE_COUNTRYSETTINGS_PRODUCTPAGETYPE']._serialized_start = 1835
    _globals['_LFPMERCHANTSTATE_COUNTRYSETTINGS_PRODUCTPAGETYPE']._serialized_end = 1963
    _globals['_GETLFPMERCHANTSTATEREQUEST']._serialized_start = 2113
    _globals['_GETLFPMERCHANTSTATEREQUEST']._serialized_end = 2208
    _globals['_LFPMERCHANTSTATESERVICE']._serialized_start = 2211
    _globals['_LFPMERCHANTSTATESERVICE']._serialized_end = 2519