...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/shopping/merchant/lfp/v1beta/lfpstore.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b"\n'com.google.shopping.merchant.lfp.v1betaB\rLfpStoreProtoP\x01Z?cloud.google.com/go/shopping/merchant/lfp/apiv1beta/lfppb;lfppb"
    ...
    _globals['_LFPSTORESERVICE'].methods_by_name['GetLfpStore']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x02+\x12)/lfp/v1beta/{name=accounts/*/lfpStores/*}'
    _globals['_LFPSTORESERVICE'].methods_by_name['InsertLfpStore']._loaded_options = None
    _globals['_LFPSTORESERVICE'].methods_by_name['InsertLfpStore']._serialized_options = b'\xdaA\x10parent,lfp_store\x82\xd3\xe4\x93\x02="0/lfp/v1beta/{parent=accounts/*}/lfpStores:insert:\tlfp_store'
    _globals['_LFPSTORESERVICE'].methods_by_name['DeleteLfpStore']._loaded_options = None
    _globals['_LFPSTORESERVICE'].methods_by_name['DeleteLfpStore']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x02+*)/lfp/v1beta/{name=accounts/*/lfpStores/*}'
    _globals['_LFPSTORESERVICE'].methods_by_name['ListLfpStores']._loaded_options = None
    _globals['_LFPSTORESERVICE'].methods_by_name['ListLfpStores']._serialized_options = b'\xdaA\x06parent\x82\xd3\xe4\x93\x02+\x12)/lfp/v1beta/{parent=accounts/*}/lfpStores'
