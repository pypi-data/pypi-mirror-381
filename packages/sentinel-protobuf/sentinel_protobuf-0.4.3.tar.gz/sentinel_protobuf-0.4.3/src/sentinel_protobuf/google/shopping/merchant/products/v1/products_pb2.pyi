...
class Product(_message.Message):
    __slots__ = ('name', 'legacy_local', 'offer_id', 'content_language', 'feed_label', 'data_source', 'version_number', 'product_attributes', 'custom_attributes', 'product_status', 'automated_discounts')
    ...
    def __init__(self, name: _Optional[str]=..., legacy_local: bool=..., offer_id: _Optional[str]=..., content_language: _Optional[str]=..., feed_label: _Optional[str]=..., data_source: _Optional[str]=..., version_number: _Optional[int]=..., product_attributes: _Optional[_Union[_products_common_pb2.ProductAttributes, _Mapping]]=..., custom_attributes: _Optional[_Iterable[_Union[_types_pb2.CustomAttribute, _Mapping]]]=..., product_status: _Optional[_Union[_products_common_pb2.ProductStatus, _Mapping]]=..., automated_discounts: _Optional[_Union[_products_common_pb2.AutomatedDiscounts, _Mapping]]=...) -> None:
        ...
