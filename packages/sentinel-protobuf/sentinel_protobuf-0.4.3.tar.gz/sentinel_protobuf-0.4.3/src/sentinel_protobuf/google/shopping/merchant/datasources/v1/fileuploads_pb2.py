...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/shopping/merchant/datasources/v1/fileuploads.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_FILEUPLOADSSERVICE'].methods_by_name['GetFileUpload']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x02?\x12=/datasources/v1/{name=accounts/*/dataSources/*/fileUploads/*}'
    _globals['_FILEUPLOAD']._serialized_start = 251
    _globals['_FILEUPLOAD']._serialized_end = 1145
    _globals['_FILEUPLOAD_ISSUE']._serialized_start = 630
    _globals['_FILEUPLOAD_ISSUE']._serialized_end = 907
    _globals['_FILEUPLOAD_ISSUE_SEVERITY']._serialized_start = 847
    _globals['_FILEUPLOAD_ISSUE_SEVERITY']._serialized_end = 907
    _globals['_FILEUPLOAD_PROCESSINGSTATE']._serialized_start = 909
    _globals['_FILEUPLOAD_PROCESSINGSTATE']._serialized_end = 1004
    _globals['_GETFILEUPLOADREQUEST']._serialized_start = 1147
    _globals['_GETFILEUPLOADREQUEST']._serialized_end = 1230
    _globals['_FILEUPLOADSSERVICE']._serialized_start = 1233
    _globals['_FILEUPLOADSSERVICE']._serialized_end = 1538