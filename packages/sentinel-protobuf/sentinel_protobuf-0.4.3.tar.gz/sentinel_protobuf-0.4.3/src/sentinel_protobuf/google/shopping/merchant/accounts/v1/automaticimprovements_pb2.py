...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/shopping/merchant/accounts/v1/automaticimprovements.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_AUTOMATICIMPROVEMENTSSERVICE'].methods_by_name['GetAutomaticImprovements']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x026\x124/accounts/v1/{name=accounts/*/automaticImprovements}'
    _globals['_AUTOMATICIMPROVEMENTSSERVICE'].methods_by_name['UpdateAutomaticImprovements']._loaded_options = None
    _globals['_AUTOMATICIMPROVEMENTSSERVICE'].methods_by_name['UpdateAutomaticImprovements']._serialized_options = b'\xdaA"automatic_improvements,update_mask\x82\xd3\xe4\x93\x02e2K/accounts/v1/{automatic_improvements.name=accounts/*/automaticImprovements}:\x16automatic_improvements'
    _globals['_AUTOMATICIMPROVEMENTS']._serialized_start = 256
    _globals['_AUTOMATICIMPROVEMENTS']._serialized_end = 800
    _globals['_AUTOMATICITEMUPDATES']._serialized_start = 803
    _globals['_AUTOMATICITEMUPDATES']._serialized_end = 1481
    _globals['_AUTOMATICITEMUPDATES_ITEMUPDATESACCOUNTLEVELSETTINGS']._serialized_start = 1166
    _globals['_AUTOMATICITEMUPDATES_ITEMUPDATESACCOUNTLEVELSETTINGS']._serialized_end = 1481
    _globals['_AUTOMATICIMAGEIMPROVEMENTS']._serialized_start = 1484
    _globals['_AUTOMATICIMAGEIMPROVEMENTS']._serialized_end = 1900
    _globals['_AUTOMATICIMAGEIMPROVEMENTS_IMAGEIMPROVEMENTSACCOUNTLEVELSETTINGS']._serialized_start = 1733
    _globals['_AUTOMATICIMAGEIMPROVEMENTS_IMAGEIMPROVEMENTSACCOUNTLEVELSETTINGS']._serialized_end = 1860
    _globals['_AUTOMATICSHIPPINGIMPROVEMENTS']._serialized_start = 1902
    _globals['_AUTOMATICSHIPPINGIMPROVEMENTS']._serialized_end = 2007
    _globals['_GETAUTOMATICIMPROVEMENTSREQUEST']._serialized_start = 2009
    _globals['_GETAUTOMATICIMPROVEMENTSREQUEST']._serialized_end = 2114
    _globals['_UPDATEAUTOMATICIMPROVEMENTSREQUEST']._serialized_start = 2117
    _globals['_UPDATEAUTOMATICIMPROVEMENTSREQUEST']._serialized_end = 2305
    _globals['_AUTOMATICIMPROVEMENTSSERVICE']._serialized_start = 2308
    _globals['_AUTOMATICIMPROVEMENTSSERVICE']._serialized_end = 2955