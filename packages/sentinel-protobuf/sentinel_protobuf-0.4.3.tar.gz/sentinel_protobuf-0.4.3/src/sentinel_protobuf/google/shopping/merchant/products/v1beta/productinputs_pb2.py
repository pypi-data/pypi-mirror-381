...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/shopping/merchant/products/v1beta/productinputs.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'\n,com.google.shopping.merchant.products.v1betaB\x12ProductInputsProtoP\x01ZNcloud.google.com/go/shopping/merchant/products/apiv1beta/productspb;productspb'
    ...
    _globals['_PRODUCTINPUT'].fields_by_name['channel']._serialized_options = b'\xe0A\x05'
    ...
    _globals['_PRODUCTINPUT'].fields_by_name['attributes']._serialized_options = b'\xe0A\x01'
    ...
    _globals['_PRODUCTINPUTSSERVICE'].methods_by_name['InsertProductInput']._serialized_options = b'\x82\xd3\xe4\x93\x02J"9/products/v1beta/{parent=accounts/*}/productInputs:insert:\rproduct_input'
    _globals['_PRODUCTINPUTSSERVICE'].methods_by_name['UpdateProductInput']._loaded_options = None
    _globals['_PRODUCTINPUTSSERVICE'].methods_by_name['UpdateProductInput']._serialized_options = b'\xdaA\x19product_input,update_mask\x82\xd3\xe4\x93\x02Q2@/products/v1beta/{product_input.name=accounts/*/productInputs/*}:\rproduct_input'
    _globals['_PRODUCTINPUTSSERVICE'].methods_by_name['DeleteProductInput']._loaded_options = None
    _globals['_PRODUCTINPUTSSERVICE'].methods_by_name['DeleteProductInput']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x024*2/products/v1beta/{name=accounts/*/productInputs/*}'
    _globals['_PRODUCTINPUT']._serialized_start = 383
    _globals['_PRODUCTINPUT']._serialized_end = 921
    _globals['_INSERTPRODUCTINPUTREQUEST']._serialized_start = 924
    _globals['_INSERTPRODUCTINPUTREQUEST']._serialized_end = 1121
    _globals['_UPDATEPRODUCTINPUTREQUEST']._serialized_start = 1124
    _globals['_UPDATEPRODUCTINPUTREQUEST']._serialized_end = 1315
    _globals['_DELETEPRODUCTINPUTREQUEST']._serialized_start = 1317
    _globals['_DELETEPRODUCTINPUTREQUEST']._serialized_end = 1433
    _globals['_PRODUCTINPUTSSERVICE']._serialized_start = 1436
    _globals['_PRODUCTINPUTSSERVICE']._serialized_end = 2209