...
class ReportRow(_message.Message):
    ...
    YOUTUBE_CREATOR_PERFORMANCE_VIEW_FIELD_NUMBER: _ClassVar[int]
    YOUTUBE_CONTENT_PERFORMANCE_VIEW_FIELD_NUMBER: _ClassVar[int]
    YOUTUBE_PRODUCT_PERFORMANCE_VIEW_FIELD_NUMBER: _ClassVar[int]
...
class YoutubeCreatorPerformanceView(_message.Message):
    __slots__ = ('date', 'title', 'channel_id', 'gross_sales', 'commissions', 'orders', 'views', 'clicks', 'net_sales')
    DATE_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    CHANNEL_ID_FIELD_NUMBER: _ClassVar[int]
    GROSS_SALES_FIELD_NUMBER: _ClassVar[int]
    COMMISSIONS_FIELD_NUMBER: _ClassVar[int]
    ORDERS_FIELD_NUMBER: _ClassVar[int]
    VIEWS_FIELD_NUMBER: _ClassVar[int]
    CLICKS_FIELD_NUMBER: _ClassVar[int]
    NET_SALES_FIELD_NUMBER: _ClassVar[int]
    date: _date_pb2.Date
    title: str
    channel_id: str
    gross_sales: _types_pb2.Price
    commissions: _types_pb2.Price
    orders: int
    views: int
    clicks: int
    net_sales: _types_pb2.Price

    def __init__(self, date: _Optional[_Union[_date_pb2.Date, _Mapping]]=..., title: _Optional[str]=..., channel_id: _Optional[str]=..., gross_sales: _Optional[_Union[_types_pb2.Price, _Mapping]]=..., commissions: _Optional[_Union[_types_pb2.Price, _Mapping]]=..., orders: _Optional[int]=..., views: _Optional[int]=..., clicks: _Optional[int]=..., net_sales: _Optional[_Union[_types_pb2.Price, _Mapping]]=...) -> None:
        ...

class YoutubeContentPerformanceView(_message.Message):
    __slots__ = ('date', 'title', 'video_id', 'channel_title', 'channel_id', 'gross_sales', 'commissions', 'orders', 'views', 'clicks', 'net_sales', 'tagged_product_ids')
    DATE_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    ...
    CLICKS_FIELD_NUMBER: _ClassVar[int]
    NET_SALES_FIELD_NUMBER: _ClassVar[int]
    TAGGED_PRODUCT_IDS_FIELD_NUMBER: _ClassVar[int]
    date: _date_pb2.Date
    title: str
    video_id: str
    channel_title: str
    ...
    clicks: int
    net_sales: _types_pb2.Price
    tagged_product_ids: _containers.RepeatedScalarFieldContainer[str]

    def __init__(self, date: _Optional[_Union[_date_pb2.Date, _Mapping]]=..., title: _Optional[str]=..., video_id: _Optional[str]=..., channel_title: _Optional[str]=..., channel_id: _Optional[str]=..., gross_sales: _Optional[_Union[_types_pb2.Price, _Mapping]]=..., commissions: _Optional[_Union[_types_pb2.Price, _Mapping]]=..., orders: _Optional[int]=..., views: _Optional[int]=..., clicks: _Optional[int]=..., net_sales: _Optional[_Union[_types_pb2.Price, _Mapping]]=..., tagged_product_ids: _Optional[_Iterable[str]]=...) -> None:
        ...

class YoutubeProductPerformanceView(_message.Message):
    __slots__ = ('date', 'title', 'offer_id', 'distinct_video_count', 'distinct_creator_count', 'gross_sales', 'commissions', 'orders', 'views', 'clicks', 'net_sales', 'tagged_creator_count', 'tagged_video_count')
    DATE_FIELD_NUMBER: _ClassVar[int]
    TITLE_FIELD_NUMBER: _ClassVar[int]
    OFFER_ID_FIELD_NUMBER: _ClassVar[int]
    DISTINCT_VIDEO_COUNT_FIELD_NUMBER: _ClassVar[int]
    DISTINCT_CREATOR_COUNT_FIELD_NUMBER: _ClassVar[int]
    GROSS_SALES_FIELD_NUMBER: _ClassVar[int]
    COMMISSIONS_FIELD_NUMBER: _ClassVar[int]
    ORDERS_FIELD_NUMBER: _ClassVar[int]
    VIEWS_FIELD_NUMBER: _ClassVar[int]
    CLICKS_FIELD_NUMBER: _ClassVar[int]
    NET_SALES_FIELD_NUMBER: _ClassVar[int]
    TAGGED_CREATOR_COUNT_FIELD_NUMBER: _ClassVar[int]
    TAGGED_VIDEO_COUNT_FIELD_NUMBER: _ClassVar[int]
    date: _date_pb2.Date
    title: str
    offer_id: str
    distinct_video_count: int
    distinct_creator_count: int
    gross_sales: _types_pb2.Price
    commissions: _types_pb2.Price
    orders: int
    views: int
    ...
    def __init__(self, date: _Optional[_Union[_date_pb2.Date, _Mapping]]=..., title: _Optional[str]=..., offer_id: _Optional[str]=..., distinct_video_count: _Optional[int]=..., distinct_creator_count: _Optional[int]=..., gross_sales: _Optional[_Union[_types_pb2.Price, _Mapping]]=..., commissions: _Optional[_Union[_types_pb2.Price, _Mapping]]=..., orders: _Optional[int]=..., views: _Optional[int]=..., clicks: _Optional[int]=..., net_sales: _Optional[_Union[_types_pb2.Price, _Mapping]]=..., tagged_creator_count: _Optional[int]=..., tagged_video_count: _Optional[int]=...) -> None:
        ...