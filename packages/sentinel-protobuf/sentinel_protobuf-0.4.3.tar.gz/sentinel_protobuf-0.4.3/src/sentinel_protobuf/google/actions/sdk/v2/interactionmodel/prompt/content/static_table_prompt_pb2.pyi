...
class StaticTablePrompt(_message.Message):
    ...
    def __init__(self, title: _Optional[str]=..., subtitle: _Optional[str]=..., image: _Optional[_Union[_static_image_prompt_pb2.StaticImagePrompt, _Mapping]]=..., columns: _Optional[_Iterable[_Union[TableColumn, _Mapping]]]=..., rows: _Optional[_Iterable[_Union[TableRow, _Mapping]]]=..., button: _Optional[_Union[_static_link_prompt_pb2.StaticLinkPrompt, _Mapping]]=...) -> None:
        ...
