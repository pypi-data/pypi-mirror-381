...
class StaticCollectionPrompt(_message.Message):
    ...
    title: str
    subtitle: str
    items: _containers.RepeatedCompositeFieldContainer[StaticCollectionPrompt.CollectionItem]
    image_fill: _static_image_prompt_pb2.StaticImagePrompt.ImageFill

    def __init__(self, title: _Optional[str]=..., subtitle: _Optional[str]=..., items: _Optional[_Iterable[_Union[StaticCollectionPrompt.CollectionItem, _Mapping]]]=..., image_fill: _Optional[_Union[_static_image_prompt_pb2.StaticImagePrompt.ImageFill, str]]=...) -> None:
        ...