...
class ConditionalEvent(_message.Message):
    __slots__ = ('condition', 'transition_to_scene', 'handler')
    ...
    def __init__(self, condition: _Optional[str]=..., transition_to_scene: _Optional[str]=..., handler: _Optional[_Union[_event_handler_pb2.EventHandler, _Mapping]]=...) -> None:
        ...