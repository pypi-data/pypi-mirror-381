...
class IntentEvent(_message.Message):
    __slots__ = ('intent', 'transition_to_scene', 'handler')
    ...
    def __init__(self, intent: _Optional[str]=..., transition_to_scene: _Optional[str]=..., handler: _Optional[_Union[_event_handler_pb2.EventHandler, _Mapping]]=...) -> None:
        ...