...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/apps/drive/labels/v2beta/label_lock.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_LABELLOCK']._serialized_start = 225
    _globals['_LABELLOCK']._serialized_end = 790
    _globals['_LABELLOCK_CAPABILITIES']._serialized_start = 621
    _globals['_LABELLOCK_CAPABILITIES']._serialized_end = 660
    _globals['_LABELLOCK_STATE']._serialized_start = 662
    _globals['_LABELLOCK_STATE']._serialized_end = 718