...
class SlidesAddOnManifest(_message.Message):
    ...
    on_file_scope_granted_trigger: SlidesExtensionPoint

    def __init__(self, homepage_trigger: _Optional[_Union[_extension_point_pb2.HomepageExtensionPoint, _Mapping]]=..., on_file_scope_granted_trigger: _Optional[_Union[SlidesExtensionPoint, _Mapping]]=...) -> None:
        ...

class SlidesExtensionPoint(_message.Message):
