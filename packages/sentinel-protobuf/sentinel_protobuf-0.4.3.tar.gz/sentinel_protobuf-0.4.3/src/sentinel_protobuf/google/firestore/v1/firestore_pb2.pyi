...
from google.firestore.v1 import aggregation_result_pb2 as _aggregation_result_pb2
from google.firestore.v1 import common_pb2 as _common_pb2
from google.firestore.v1 import document_pb2 as _document_pb2
from google.firestore.v1 import query_pb2 as _query_pb2
from google.firestore.v1 import query_profile_pb2 as _query_profile_pb2
from google.firestore.v1 import write_pb2 as _write_pb2
...
class RunQueryRequest(_message.Message):
    __slots__ = ('parent', 'structured_query', 'transaction', 'new_transaction', 'read_time', 'explain_options')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, parent: _Optional[str]=..., structured_query: _Optional[_Union[_query_pb2.StructuredQuery, _Mapping]]=..., transaction: _Optional[bytes]=..., new_transaction: _Optional[_Union[_common_pb2.TransactionOptions, _Mapping]]=..., read_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., explain_options: _Optional[_Union[_query_profile_pb2.ExplainOptions, _Mapping]]=...) -> None:
        ...

class RunQueryResponse(_message.Message):
    __slots__ = ('transaction', 'document', 'read_time', 'skipped_results', 'done', 'explain_metrics')
    TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    DOCUMENT_FIELD_NUMBER: _ClassVar[int]
    READ_TIME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, transaction: _Optional[bytes]=..., document: _Optional[_Union[_document_pb2.Document, _Mapping]]=..., read_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., skipped_results: _Optional[int]=..., done: bool=..., explain_metrics: _Optional[_Union[_query_profile_pb2.ExplainMetrics, _Mapping]]=...) -> None:
        ...

class RunAggregationQueryRequest(_message.Message):
    __slots__ = ('parent', 'structured_aggregation_query', 'transaction', 'new_transaction', 'read_time', 'explain_options')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    STRUCTURED_AGGREGATION_QUERY_FIELD_NUMBER: _ClassVar[int]
    TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    NEW_TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    READ_TIME_FIELD_NUMBER: _ClassVar[int]
    EXPLAIN_OPTIONS_FIELD_NUMBER: _ClassVar[int]
    parent: str
    structured_aggregation_query: _query_pb2.StructuredAggregationQuery
    transaction: bytes
    new_transaction: _common_pb2.TransactionOptions
    read_time: _timestamp_pb2.Timestamp
    explain_options: _query_profile_pb2.ExplainOptions

    def __init__(self, parent: _Optional[str]=..., structured_aggregation_query: _Optional[_Union[_query_pb2.StructuredAggregationQuery, _Mapping]]=..., transaction: _Optional[bytes]=..., new_transaction: _Optional[_Union[_common_pb2.TransactionOptions, _Mapping]]=..., read_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., explain_options: _Optional[_Union[_query_profile_pb2.ExplainOptions, _Mapping]]=...) -> None:
        ...

class RunAggregationQueryResponse(_message.Message):
    __slots__ = ('result', 'transaction', 'read_time', 'explain_metrics')
    RESULT_FIELD_NUMBER: _ClassVar[int]
    TRANSACTION_FIELD_NUMBER: _ClassVar[int]
    READ_TIME_FIELD_NUMBER: _ClassVar[int]
    EXPLAIN_METRICS_FIELD_NUMBER: _ClassVar[int]
    result: _aggregation_result_pb2.AggregationResult
    transaction: bytes
    read_time: _timestamp_pb2.Timestamp
    explain_metrics: _query_profile_pb2.ExplainMetrics

    def __init__(self, result: _Optional[_Union[_aggregation_result_pb2.AggregationResult, _Mapping]]=..., transaction: _Optional[bytes]=..., read_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., explain_metrics: _Optional[_Union[_query_profile_pb2.ExplainMetrics, _Mapping]]=...) -> None:
        ...

class PartitionQueryRequest(_message.Message):
    __slots__ = ('parent', 'structured_query', 'partition_count', 'page_token', 'page_size', 'read_time')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    STRUCTURED_QUERY_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, parent: _Optional[str]=..., structured_query: _Optional[_Union[_query_pb2.StructuredQuery, _Mapping]]=..., partition_count: _Optional[int]=..., page_token: _Optional[str]=..., page_size: _Optional[int]=..., read_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class Target(_message.Message):
    __slots__ = ('query', 'documents', 'resume_token', 'read_time', 'target_id', 'once', 'expected_count')
    ...
    target_id: int
    once: bool
    expected_count: _wrappers_pb2.Int32Value

    def __init__(self, query: _Optional[_Union[Target.QueryTarget, _Mapping]]=..., documents: _Optional[_Union[Target.DocumentsTarget, _Mapping]]=..., resume_token: _Optional[bytes]=..., read_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., target_id: _Optional[int]=..., once: bool=..., expected_count: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]]=...) -> None:
        ...
...
class ListCollectionIdsRequest(_message.Message):
    __slots__ = ('parent', 'page_size', 'page_token', 'read_time')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    PAGE_SIZE_FIELD_NUMBER: _ClassVar[int]
    PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    READ_TIME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, parent: _Optional[str]=..., page_size: _Optional[int]=..., page_token: _Optional[str]=..., read_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
