...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CUSTOMERLIFECYCLEGOALSERVICE'].methods_by_name['ConfigureCustomerLifecycleGoals']._serialized_options = b'\xdaA\x15customer_id,operation\x82\xd3\xe4\x93\x02Y"T/v20/customers/{customer_id=*}/customerLifecycleGoal:configureCustomerLifecycleGoals:\x01*'
