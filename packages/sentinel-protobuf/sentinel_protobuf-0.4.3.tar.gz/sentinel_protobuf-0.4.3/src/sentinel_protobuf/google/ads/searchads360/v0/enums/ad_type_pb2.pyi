...
class AdTypeEnum(_message.Message):
    ...
    class AdType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        CALL_ONLY_AD: _ClassVar[AdTypeEnum.AdType]
        ...
        GMAIL_AD: _ClassVar[AdTypeEnum.AdType]
        ...
        VIDEO_OUTSTREAM_AD: _ClassVar[AdTypeEnum.AdType]
        VIDEO_TRUEVIEW_DISCOVERY_AD: _ClassVar[AdTypeEnum.AdType]
        ...
        DISCOVERY_MULTI_ASSET_AD: _ClassVar[AdTypeEnum.AdType]
        DISCOVERY_CAROUSEL_AD: _ClassVar[AdTypeEnum.AdType]
        TRAVEL_AD: _ClassVar[AdTypeEnum.AdType]
        DISCOVERY_VIDEO_RESPONSIVE_AD: _ClassVar[AdTypeEnum.AdType]
        MULTIMEDIA_AD: _ClassVar[AdTypeEnum.AdType]
    UNSPECIFIED: AdTypeEnum.AdType
    UNKNOWN: AdTypeEnum.AdType
    TEXT_AD: AdTypeEnum.AdType
    EXPANDED_TEXT_AD: AdTypeEnum.AdType
    CALL_ONLY_AD: AdTypeEnum.AdType
    ...
    VIDEO_OUTSTREAM_AD: AdTypeEnum.AdType
    VIDEO_TRUEVIEW_DISCOVERY_AD: AdTypeEnum.AdType
    ...
    DISCOVERY_MULTI_ASSET_AD: AdTypeEnum.AdType
    DISCOVERY_CAROUSEL_AD: AdTypeEnum.AdType
    TRAVEL_AD: AdTypeEnum.AdType
    DISCOVERY_VIDEO_RESPONSIVE_AD: AdTypeEnum.AdType
    MULTIMEDIA_AD: AdTypeEnum.AdType
