...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v20/services/bidding_strategy_service.proto')
...
from ......google.ads.googleads.v20.resources import bidding_strategy_pb2 as google_dot_ads_dot_googleads_dot_v20_dot_resources_dot_bidding__strategy__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BIDDINGSTRATEGYSERVICE'].methods_by_name['MutateBiddingStrategies']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02<"7/v20/customers/{customer_id=*}/biddingStrategies:mutate:\x01*'
