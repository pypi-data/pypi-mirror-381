...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v21/services/conversion_upload_service.proto')
_sym_db = _symbol_database.Default()
from ......google.ads.googleads.v21.common import consent_pb2 as google_dot_ads_dot_googleads_dot_v21_dot_common_dot_consent__pb2
...
from ......google.ads.googleads.v21.enums import conversion_customer_type_pb2 as google_dot_ads_dot_googleads_dot_v21_dot_enums_dot_conversion__customer__type__pb2
from ......google.ads.googleads.v21.enums import conversion_environment_enum_pb2 as google_dot_ads_dot_googleads_dot_v21_dot_enums_dot_conversion__environment__enum__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CLICKCONVERSION'].fields_by_name['user_ip_address']._loaded_options = None
    _globals['_CLICKCONVERSION'].fields_by_name['user_ip_address']._serialized_options = b'\xe2\x8c\xcf\xd7\x08\x02\x08\x04'
    ...
    _globals['_CONVERSIONUPLOADSERVICE'].methods_by_name['UploadClickConversions']._serialized_options = b'\xdaA\'customer_id,conversions,partial_failure\x82\xd3\xe4\x93\x02:"5/v21/customers/{customer_id=*}:uploadClickConversions:\x01*'
    _globals['_CONVERSIONUPLOADSERVICE'].methods_by_name['UploadCallConversions']._loaded_options = None
    _globals['_CONVERSIONUPLOADSERVICE'].methods_by_name['UploadCallConversions']._serialized_options = b'\xdaA\'customer_id,conversions,partial_failure\x82\xd3\xe4\x93\x029"4/v21/customers/{customer_id=*}:uploadCallConversions:\x01*'
    _globals['_UPLOADCLICKCONVERSIONSREQUEST']._serialized_start = 507
    _globals['_UPLOADCLICKCONVERSIONSREQUEST']._serialized_end = 732
    _globals['_UPLOADCLICKCONVERSIONSRESPONSE']._serialized_start = 735
    _globals['_UPLOADCLICKCONVERSIONSRESPONSE']._serialized_end = 909
    _globals['_UPLOADCALLCONVERSIONSREQUEST']._serialized_start = 912
    _globals['_UPLOADCALLCONVERSIONSREQUEST']._serialized_end = 1098
    _globals['_UPLOADCALLCONVERSIONSRESPONSE']._serialized_start = 1101
    _globals['_UPLOADCALLCONVERSIONSRESPONSE']._serialized_end = 1257
    _globals['_CLICKCONVERSION']._serialized_start = 1260
    _globals['_CLICKCONVERSION']._serialized_end = 2409
    _globals['_CALLCONVERSION']._serialized_start = 2412
    _globals['_CALLCONVERSION']._serialized_end = 2874
    _globals['_EXTERNALATTRIBUTIONDATA']._serialized_start = 2877
    _globals['_EXTERNALATTRIBUTIONDATA']._serialized_end = 3048
    _globals['_CLICKCONVERSIONRESULT']._serialized_start = 3051
    _globals['_CLICKCONVERSIONRESULT']._serialized_end = 3325
    _globals['_CALLCONVERSIONRESULT']._serialized_start = 3328
    _globals['_CALLCONVERSIONRESULT']._serialized_end = 3562
    _globals['_CUSTOMVARIABLE']._serialized_start = 3564
    _globals['_CUSTOMVARIABLE']._serialized_end = 3687
    _globals['_CARTDATA']._serialized_start = 3690
    _globals['_CARTDATA']._serialized_end = 3939
    _globals['_CARTDATA_ITEM']._serialized_start = 3875
    _globals['_CARTDATA_ITEM']._serialized_end = 3939
    _globals['_SESSIONATTRIBUTEKEYVALUEPAIR']._serialized_start = 3941
    _globals['_SESSIONATTRIBUTEKEYVALUEPAIR']._serialized_end = 4045
    _globals['_SESSIONATTRIBUTESKEYVALUEPAIRS']._serialized_start = 4047
    _globals['_SESSIONATTRIBUTESKEYVALUEPAIRS']._serialized_end = 4174
    _globals['_CONVERSIONUPLOADSERVICE']._serialized_start = 4177
    _globals['_CONVERSIONUPLOADSERVICE']._serialized_end = 4805