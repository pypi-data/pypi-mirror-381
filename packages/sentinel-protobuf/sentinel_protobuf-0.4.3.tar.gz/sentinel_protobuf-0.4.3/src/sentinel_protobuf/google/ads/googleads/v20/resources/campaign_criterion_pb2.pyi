...
from google.ads.googleads.v20.enums import campaign_criterion_status_pb2 as _campaign_criterion_status_pb2
...
class CampaignCriterion(_message.Message):
    ...
    WEBPAGE_LIST_FIELD_NUMBER: _ClassVar[int]
    resource_name: str
    campaign: str
    criterion_id: int
    display_name: str
