...
class CampaignPrimaryStatusReasonEnum(_message.Message):
    ...
    class CampaignPrimaryStatusReason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        MISSING_LOCATION_TARGETING: _ClassVar[CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason]
    ...
    MISSING_LOCATION_TARGETING: CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason
