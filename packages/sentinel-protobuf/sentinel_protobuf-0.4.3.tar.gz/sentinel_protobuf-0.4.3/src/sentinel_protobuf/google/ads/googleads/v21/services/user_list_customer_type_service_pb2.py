...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_USERLISTCUSTOMERTYPESERVICE'].methods_by_name['MutateUserListCustomerTypes']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02@";/v21/customers/{customer_id=*}/userListCustomerTypes:mutate:\x01*'
