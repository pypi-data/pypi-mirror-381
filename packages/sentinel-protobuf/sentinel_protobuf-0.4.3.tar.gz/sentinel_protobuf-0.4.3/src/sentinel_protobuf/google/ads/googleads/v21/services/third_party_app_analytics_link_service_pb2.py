...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_THIRDPARTYAPPANALYTICSLINKSERVICE'].methods_by_name['RegenerateShareableLinkId']._serialized_options = b'\x82\xd3\xe4\x93\x02]"X/v21/{resource_name=customers/*/thirdPartyAppAnalyticsLinks/*}:regenerateShareableLinkId:\x01*'
