...
from google.ads.googleads.v21.enums import frequency_cap_time_unit_pb2 as _frequency_cap_time_unit_pb2
from google.ads.googleads.v21.enums import reach_plan_age_range_pb2 as _reach_plan_age_range_pb2
from google.ads.googleads.v21.enums import reach_plan_conversion_rate_model_pb2 as _reach_plan_conversion_rate_model_pb2
from google.ads.googleads.v21.enums import reach_plan_network_pb2 as _reach_plan_network_pb2
from google.ads.googleads.v21.enums import reach_plan_plannable_user_list_status_pb2 as _reach_plan_plannable_user_list_status_pb2
from google.ads.googleads.v21.enums import reach_plan_surface_pb2 as _reach_plan_surface_pb2
...
class ListPlannableUserInterestsRequest(_message.Message):
    __slots__ = ('customer_id', 'user_interest_taxonomy_types', 'name_query', 'path_query', 'reach_application_info')
    CUSTOMER_ID_FIELD_NUMBER: _ClassVar[int]
    USER_INTEREST_TAXONOMY_TYPES_FIELD_NUMBER: _ClassVar[int]
    NAME_QUERY_FIELD_NUMBER: _ClassVar[int]
    PATH_QUERY_FIELD_NUMBER: _ClassVar[int]
    REACH_APPLICATION_INFO_FIELD_NUMBER: _ClassVar[int]
    customer_id: str
    user_interest_taxonomy_types: _containers.RepeatedScalarFieldContainer[_user_interest_taxonomy_type_pb2.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType]
    name_query: str
    path_query: str
    reach_application_info: _additional_application_info_pb2.AdditionalApplicationInfo

    def __init__(self, customer_id: _Optional[str]=..., user_interest_taxonomy_types: _Optional[_Iterable[_Union[_user_interest_taxonomy_type_pb2.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType, str]]]=..., name_query: _Optional[str]=..., path_query: _Optional[str]=..., reach_application_info: _Optional[_Union[_additional_application_info_pb2.AdditionalApplicationInfo, _Mapping]]=...) -> None:
        ...

class ListPlannableUserInterestsResponse(_message.Message):
    __slots__ = ('plannable_user_interests',)
    PLANNABLE_USER_INTERESTS_FIELD_NUMBER: _ClassVar[int]
    plannable_user_interests: _containers.RepeatedCompositeFieldContainer[PlannableUserInterest]

    def __init__(self, plannable_user_interests: _Optional[_Iterable[_Union[PlannableUserInterest, _Mapping]]]=...) -> None:
        ...

class PlannableUserInterest(_message.Message):
    __slots__ = ('user_interest', 'user_interest_type', 'user_interest_display_name', 'user_interest_path')
    USER_INTEREST_FIELD_NUMBER: _ClassVar[int]
    USER_INTEREST_TYPE_FIELD_NUMBER: _ClassVar[int]
    USER_INTEREST_DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    USER_INTEREST_PATH_FIELD_NUMBER: _ClassVar[int]
    user_interest: _criteria_pb2.UserInterestInfo
    user_interest_type: _user_interest_taxonomy_type_pb2.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType
    user_interest_display_name: str
    user_interest_path: str

    def __init__(self, user_interest: _Optional[_Union[_criteria_pb2.UserInterestInfo, _Mapping]]=..., user_interest_type: _Optional[_Union[_user_interest_taxonomy_type_pb2.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType, str]]=..., user_interest_display_name: _Optional[str]=..., user_interest_path: _Optional[str]=...) -> None:
        ...
