...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v19/services/experiment_service.proto')
_sym_db = _symbol_database.Default()
from ......google.ads.googleads.v19.resources import experiment_pb2 as google_dot_ads_dot_googleads_dot_v19_dot_resources_dot_experiment__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_EXPERIMENTSERVICE'].methods_by_name['MutateExperiments']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x026"1/v19/customers/{customer_id=*}/experiments:mutate:\x01*'
    _globals['_EXPERIMENTSERVICE'].methods_by_name['EndExperiment']._loaded_options = None
    _globals['_EXPERIMENTSERVICE'].methods_by_name['EndExperiment']._serialized_options = b'\xdaA\nexperiment\x82\xd3\xe4\x93\x02>"9/v19/{experiment=customers/*/experiments/*}:endExperiment:\x01*'
    _globals['_EXPERIMENTSERVICE'].methods_by_name['ListExperimentAsyncErrors']._loaded_options = None
    _globals['_EXPERIMENTSERVICE'].methods_by_name['ListExperimentAsyncErrors']._serialized_options = b'\xdaA\rresource_name\x82\xd3\xe4\x93\x02J\x12H/v19/{resource_name=customers/*/experiments/*}:listExperimentAsyncErrors'
    _globals['_EXPERIMENTSERVICE'].methods_by_name['GraduateExperiment']._loaded_options = None
    _globals['_EXPERIMENTSERVICE'].methods_by_name['GraduateExperiment']._serialized_options = b'\xdaA#experiment,campaign_budget_mappings\x82\xd3\xe4\x93\x02C">/v19/{experiment=customers/*/experiments/*}:graduateExperiment:\x01*'
    _globals['_EXPERIMENTSERVICE'].methods_by_name['ScheduleExperiment']._loaded_options = None
    _globals['_EXPERIMENTSERVICE'].methods_by_name['ScheduleExperiment']._serialized_options = b'\xcaAU\n\x15google.protobuf.Empty\x12<google.ads.googleads.v19.services.ScheduleExperimentMetadata\xdaA\rresource_name\x82\xd3\xe4\x93\x02F"A/v19/{resource_name=customers/*/experiments/*}:scheduleExperiment:\x01*'
    _globals['_EXPERIMENTSERVICE'].methods_by_name['PromoteExperiment']._loaded_options = None
    _globals['_EXPERIMENTSERVICE'].methods_by_name['PromoteExperiment']._serialized_options = b'\xcaAT\n\x15google.protobuf.Empty\x12;google.ads.googleads.v19.services.PromoteExperimentMetadata\xdaA\rresource_name\x82\xd3\xe4\x93\x02E"@/v19/{resource_name=customers/*/experiments/*}:promoteExperiment:\x01*'
