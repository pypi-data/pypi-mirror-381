...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v19/services/campaign_bid_modifier_service.proto')
...
from ......google.ads.googleads.v19.resources import campaign_bid_modifier_pb2 as google_dot_ads_dot_googleads_dot_v19_dot_resources_dot_campaign__bid__modifier__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CAMPAIGNBIDMODIFIERSERVICE'].methods_by_name['MutateCampaignBidModifiers']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02?":/v19/customers/{customer_id=*}/campaignBidModifiers:mutate:\x01*'
