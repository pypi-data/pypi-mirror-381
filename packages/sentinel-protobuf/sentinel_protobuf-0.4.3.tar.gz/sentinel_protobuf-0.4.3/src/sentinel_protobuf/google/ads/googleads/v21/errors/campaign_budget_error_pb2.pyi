...
class CampaignBudgetErrorEnum(_message.Message):
    ...
    class CampaignBudgetError(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        BUDGET_BELOW_PER_DAY_MINIMUM: _ClassVar[CampaignBudgetErrorEnum.CampaignBudgetError]
    ...
    BUDGET_BELOW_PER_DAY_MINIMUM: CampaignBudgetErrorEnum.CampaignBudgetError
