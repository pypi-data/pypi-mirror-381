...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v21/services/ad_group_criterion_customizer_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ADGROUPCRITERIONCUSTOMIZERSERVICE'].methods_by_name['MutateAdGroupCriterionCustomizers']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02F"A/v21/customers/{customer_id=*}/AdGroupCriterionCustomizers:mutate:\x01*'
