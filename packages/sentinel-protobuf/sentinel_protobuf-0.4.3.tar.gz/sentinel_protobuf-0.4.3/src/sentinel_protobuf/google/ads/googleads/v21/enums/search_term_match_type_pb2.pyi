...
class SearchTermMatchTypeEnum(_message.Message):
    ...
    class SearchTermMatchType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        AI_MAX: _ClassVar[SearchTermMatchTypeEnum.SearchTermMatchType]
        PERFORMANCE_MAX: _ClassVar[SearchTermMatchTypeEnum.SearchTermMatchType]
    ...
    AI_MAX: SearchTermMatchTypeEnum.SearchTermMatchType
    PERFORMANCE_MAX: SearchTermMatchTypeEnum.SearchTermMatchType
