...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v19/services/smart_campaign_setting_service.proto')
...
from ......google.ads.googleads.v19.enums import smart_campaign_not_eligible_reason_pb2 as google_dot_ads_dot_googleads_dot_v19_dot_enums_dot_smart__campaign__not__eligible__reason__pb2
from ......google.ads.googleads.v19.enums import smart_campaign_status_pb2 as google_dot_ads_dot_googleads_dot_v19_dot_enums_dot_smart__campaign__status__pb2
from ......google.ads.googleads.v19.resources import smart_campaign_setting_pb2 as google_dot_ads_dot_googleads_dot_v19_dot_resources_dot_smart__campaign__setting__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SMARTCAMPAIGNSETTINGSERVICE'].methods_by_name['GetSmartCampaignStatus']._serialized_options = b'\xdaA\rresource_name\x82\xd3\xe4\x93\x02Q\x12O/v19/{resource_name=customers/*/smartCampaignSettings/*}:getSmartCampaignStatus'
    _globals['_SMARTCAMPAIGNSETTINGSERVICE'].methods_by_name['MutateSmartCampaignSettings']._loaded_options = None
    _globals['_SMARTCAMPAIGNSETTINGSERVICE'].methods_by_name['MutateSmartCampaignSettings']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02@";/v19/customers/{customer_id=*}/smartCampaignSettings:mutate:\x01*'
