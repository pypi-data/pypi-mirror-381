...
class SharedCriterion(_message.Message):
    __slots__ = ('resource_name', 'shared_set', 'criterion_id', 'type', 'keyword', 'youtube_video', 'youtube_channel', 'placement', 'mobile_app_category', 'mobile_application', 'brand')
