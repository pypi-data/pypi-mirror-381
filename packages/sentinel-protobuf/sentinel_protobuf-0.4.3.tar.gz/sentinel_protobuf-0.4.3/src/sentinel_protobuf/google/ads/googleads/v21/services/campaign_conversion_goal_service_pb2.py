...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_CAMPAIGNCONVERSIONGOALSERVICE'].methods_by_name['MutateCampaignConversionGoals']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02B"=/v21/customers/{customer_id=*}/campaignConversionGoals:mutate:\x01*'
