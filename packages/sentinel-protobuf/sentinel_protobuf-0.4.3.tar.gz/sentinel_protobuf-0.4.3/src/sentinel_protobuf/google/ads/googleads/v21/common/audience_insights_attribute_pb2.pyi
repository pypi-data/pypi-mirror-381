...
from google.ads.googleads.v21.enums import audience_insights_dimension_pb2 as _audience_insights_dimension_pb2
from google.ads.googleads.v21.enums import insights_knowledge_graph_entity_capabilities_pb2 as _insights_knowledge_graph_entity_capabilities_pb2
...
class AudienceInsightsAttributeMetadata(_message.Message):
    ...
    USER_LIST_ATTRIBUTE_METADATA_FIELD_NUMBER: _ClassVar[int]
...
class YouTubeVideoAttributeMetadata(_message.Message):
    __slots__ = ('thumbnail_url', 'video_url', 'views_count', 'likes_count', 'comments_count')
    ...
    def __init__(self, thumbnail_url: _Optional[str]=..., video_url: _Optional[str]=..., views_count: _Optional[int]=..., likes_count: _Optional[int]=..., comments_count: _Optional[int]=...) -> None:
        ...
...
class KnowledgeGraphAttributeMetadata(_message.Message):
    __slots__ = ('entity_capabilities', 'related_categories')
    ENTITY_CAPABILITIES_FIELD_NUMBER: _ClassVar[int]
    RELATED_CATEGORIES_FIELD_NUMBER: _ClassVar[int]
    ...
    related_categories: _containers.RepeatedCompositeFieldContainer[AudienceInsightsAttributeMetadata]

    def __init__(self, entity_capabilities: _Optional[_Iterable[_Union[_insights_knowledge_graph_entity_capabilities_pb2.InsightsKnowledgeGraphEntityCapabilitiesEnum.InsightsKnowledgeGraphEntityCapabilities, str]]]=..., related_categories: _Optional[_Iterable[_Union[AudienceInsightsAttributeMetadata, _Mapping]]]=...) -> None:
        ...

class UserListAttributeMetadata(_message.Message):
    __slots__ = ('user_list_type',)
    USER_LIST_TYPE_FIELD_NUMBER: _ClassVar[int]
    user_list_type: _user_list_type_pb2.UserListTypeEnum.UserListType

    def __init__(self, user_list_type: _Optional[_Union[_user_list_type_pb2.UserListTypeEnum.UserListType, str]]=...) -> None:
        ...

class AudienceInsightsAttributeMetadataGroup(_message.Message):
