...
class BiddingStrategyTypeEnum(_message.Message):
    ...
    class BiddingStrategyType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        FIXED_CPM: _ClassVar[BiddingStrategyTypeEnum.BiddingStrategyType]
        ...
        TARGET_CPV: _ClassVar[BiddingStrategyTypeEnum.BiddingStrategyType]
    ...
    FIXED_CPM: BiddingStrategyTypeEnum.BiddingStrategyType
    ...
    TARGET_CPV: BiddingStrategyTypeEnum.BiddingStrategyType
