...
from google.ads.googleads.v19.enums import conversion_customer_type_pb2 as _conversion_customer_type_pb2
from google.ads.googleads.v19.enums import conversion_environment_enum_pb2 as _conversion_environment_enum_pb2
...
class ClickConversion(_message.Message):
    __slots__ = ('gclid', 'gbraid', 'wbraid', 'conversion_action', 'conversion_date_time', 'conversion_value', 'currency_code', 'order_id', 'external_attribution_data', 'custom_variables', 'cart_data', 'user_identifiers', 'conversion_environment', 'consent', 'customer_type', 'session_attributes_encoded', 'session_attributes_key_value_pairs')
