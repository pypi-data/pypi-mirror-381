...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v20/services/travel_asset_suggestion_service.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_TRAVELASSETSUGGESTIONSERVICE'].methods_by_name['SuggestTravelAssets']._serialized_options = b'\xdaA\x1bcustomer_id,language_option\x82\xd3\xe4\x93\x027"2/v20/customers/{customer_id=*}:suggestTravelAssets:\x01*'
