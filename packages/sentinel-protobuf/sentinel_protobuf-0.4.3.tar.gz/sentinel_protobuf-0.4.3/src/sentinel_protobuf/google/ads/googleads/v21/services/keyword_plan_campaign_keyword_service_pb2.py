...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v21/services/keyword_plan_campaign_keyword_service.proto')
_sym_db = _symbol_database.Default()
from ......google.ads.googleads.v21.resources import keyword_plan_campaign_keyword_pb2 as google_dot_ads_dot_googleads_dot_v21_dot_resources_dot_keyword__plan__campaign__keyword__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_KEYWORDPLANCAMPAIGNKEYWORDSERVICE'].methods_by_name['MutateKeywordPlanCampaignKeywords']._serialized_options = b'\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02F"A/v21/customers/{customer_id=*}/keywordPlanCampaignKeywords:mutate:\x01*'
