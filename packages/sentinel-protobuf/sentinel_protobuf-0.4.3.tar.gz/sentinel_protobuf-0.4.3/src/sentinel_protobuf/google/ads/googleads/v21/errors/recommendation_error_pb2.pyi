...
class RecommendationErrorEnum(_message.Message):
    ...
    class RecommendationError(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        MERCHANT_CENTER_ACCOUNT_ID_NOT_SUPPORTED_ADVERTISING_CHANNEL_TYPE: _ClassVar[RecommendationErrorEnum.RecommendationError]
    ...
    MERCHANT_CENTER_ACCOUNT_ID_NOT_SUPPORTED_ADVERTISING_CHANNEL_TYPE: RecommendationErrorEnum.RecommendationError
