from google.ads.googleads.v19.enums import change_status_operation_pb2 as _change_status_operation_pb2
from google.ads.googleads.v19.enums import change_status_resource_type_pb2 as _change_status_resource_type_pb2
...
class ChangeStatus(_message.Message):
    __slots__ = ('resource_name', 'last_change_date_time', 'resource_type', 'campaign', 'ad_group', 'resource_status', 'ad_group_ad', 'ad_group_criterion', 'campaign_criterion', 'ad_group_bid_modifier', 'shared_set', 'campaign_shared_set', 'asset', 'customer_asset', 'campaign_asset', 'ad_group_asset', 'combined_audience', 'asset_group', 'campaign_budget')
