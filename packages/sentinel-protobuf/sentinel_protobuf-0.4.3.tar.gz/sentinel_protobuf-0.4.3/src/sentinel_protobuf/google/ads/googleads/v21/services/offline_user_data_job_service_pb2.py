...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/ads/googleads/v21/services/offline_user_data_job_service.proto')
...
from ......google.ads.googleads.v21.resources import offline_user_data_job_pb2 as google_dot_ads_dot_googleads_dot_v21_dot_resources_dot_offline__user__data__job__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_OFFLINEUSERDATAJOBSERVICE'].methods_by_name['CreateOfflineUserDataJob']._serialized_options = b'\xdaA\x0fcustomer_id,job\x82\xd3\xe4\x93\x02>"9/v21/customers/{customer_id=*}/offlineUserDataJobs:create:\x01*'
    _globals['_OFFLINEUSERDATAJOBSERVICE'].methods_by_name['AddOfflineUserDataJobOperations']._loaded_options = None
    _globals['_OFFLINEUSERDATAJOBSERVICE'].methods_by_name['AddOfflineUserDataJobOperations']._serialized_options = b'\xdaA\x18resource_name,operations\x82\xd3\xe4\x93\x02I"D/v21/{resource_name=customers/*/offlineUserDataJobs/*}:addOperations:\x01*'
    _globals['_OFFLINEUSERDATAJOBSERVICE'].methods_by_name['RunOfflineUserDataJob']._loaded_options = None
    _globals['_OFFLINEUSERDATAJOBSERVICE'].methods_by_name['RunOfflineUserDataJob']._serialized_options = b'\xcaAV\n\x15google.protobuf.Empty\x12=google.ads.googleads.v21.resources.OfflineUserDataJobMetadata\xdaA\rresource_name\x82\xd3\xe4\x93\x02?":/v21/{resource_name=customers/*/offlineUserDataJobs/*}:run:\x01*'
