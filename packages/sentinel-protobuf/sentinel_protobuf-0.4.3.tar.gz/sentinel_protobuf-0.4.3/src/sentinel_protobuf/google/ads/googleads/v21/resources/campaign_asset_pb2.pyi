...
class CampaignAsset(_message.Message):
    __slots__ = ('resource_name', 'campaign', 'asset', 'field_type', 'source', 'status', 'primary_status', 'primary_status_details', 'primary_status_reasons')
