...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/cloudcontrolspartner/v1beta/violations.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_VIOLATION']._serialized_start = 225
    _globals['_VIOLATION']._serialized_end = 1946
    _globals['_VIOLATION_REMEDIATION']._serialized_start = 700
    _globals['_VIOLATION_REMEDIATION']._serialized_end = 1676
    _globals['_VIOLATION_REMEDIATION_INSTRUCTIONS']._serialized_start = 959
    _globals['_VIOLATION_REMEDIATION_INSTRUCTIONS']._serialized_end = 1353
    _globals['_VIOLATION_REMEDIATION_INSTRUCTIONS_GCLOUD']._serialized_start = 1205
    _globals['_VIOLATION_REMEDIATION_INSTRUCTIONS_GCLOUD']._serialized_end = 1279
    _globals['_VIOLATION_REMEDIATION_INSTRUCTIONS_CONSOLE']._serialized_start = 1281
    _globals['_VIOLATION_REMEDIATION_INSTRUCTIONS_CONSOLE']._serialized_end = 1353
    _globals['_VIOLATION_REMEDIATION_REMEDIATIONTYPE']._serialized_start = 1356
    _globals['_VIOLATION_REMEDIATION_REMEDIATIONTYPE']._serialized_end = 1676
    _globals['_VIOLATION_STATE']._serialized_start = 1678
    _globals['_VIOLATION_STATE']._serialized_end = 1753
    _globals['_LISTVIOLATIONSREQUEST']._serialized_start = 1949
    _globals['_LISTVIOLATIONSREQUEST']._serialized_end = 2182
    _globals['_LISTVIOLATIONSRESPONSE']._serialized_start = 2185
    _globals['_LISTVIOLATIONSRESPONSE']._serialized_end = 2328
    _globals['_GETVIOLATIONREQUEST']._serialized_start = 2330
    _globals['_GETVIOLATIONREQUEST']._serialized_end = 2420