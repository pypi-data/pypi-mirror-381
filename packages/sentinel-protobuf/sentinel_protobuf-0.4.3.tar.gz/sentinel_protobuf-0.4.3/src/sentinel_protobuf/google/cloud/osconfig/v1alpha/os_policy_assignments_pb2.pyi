...
from google.cloud.osconfig.v1alpha import os_policy_pb2 as _os_policy_pb2
from google.cloud.osconfig.v1alpha import osconfig_common_pb2 as _osconfig_common_pb2
...
class OSPolicyAssignment(_message.Message):
    ...
    class InstanceFilter(_message.Message):
        __slots__ = ('all', 'os_short_names', 'inclusion_labels', 'exclusion_labels', 'inventories')
        ...
        OS_SHORT_NAMES_FIELD_NUMBER: _ClassVar[int]
        ...
        all: bool
        os_short_names: _containers.RepeatedScalarFieldContainer[str]
        ...
        def __init__(self, all: bool=..., os_short_names: _Optional[_Iterable[str]]=..., inclusion_labels: _Optional[_Iterable[_Union[OSPolicyAssignment.LabelSet, _Mapping]]]=..., exclusion_labels: _Optional[_Iterable[_Union[OSPolicyAssignment.LabelSet, _Mapping]]]=..., inventories: _Optional[_Iterable[_Union[OSPolicyAssignment.InstanceFilter.Inventory, _Mapping]]]=...) -> None:
            ...
