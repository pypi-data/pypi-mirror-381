...
from google.cloud.devicestreaming.v1 import adb_service_pb2 as _adb_service_pb2
...
class CreateDeviceSessionRequest(_message.Message):
    __slots__ = ('parent', 'device_session', 'device_session_id')
    ...
    def __init__(self, parent: _Optional[str]=..., device_session: _Optional[_Union[DeviceSession, _Mapping]]=..., device_session_id: _Optional[str]=...) -> None:
        ...
