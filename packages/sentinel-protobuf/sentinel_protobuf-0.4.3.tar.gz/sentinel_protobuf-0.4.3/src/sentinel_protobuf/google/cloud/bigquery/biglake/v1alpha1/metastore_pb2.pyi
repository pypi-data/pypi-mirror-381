...
class Lock(_message.Message):
    __slots__ = ('table_id', 'name', 'create_time', 'type', 'state')

    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        TYPE_UNSPECIFIED: _ClassVar[Lock.Type]
        EXCLUSIVE: _ClassVar[Lock.Type]
    TYPE_UNSPECIFIED: Lock.Type
    EXCLUSIVE: Lock.Type

    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STATE_UNSPECIFIED: _ClassVar[Lock.State]
        WAITING: _ClassVar[Lock.State]
        ACQUIRED: _ClassVar[Lock.State]
    STATE_UNSPECIFIED: Lock.State
    WAITING: Lock.State
    ACQUIRED: Lock.State
    ...
    def __init__(self, table_id: _Optional[str]=..., name: _Optional[str]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., type: _Optional[_Union[Lock.Type, str]]=..., state: _Optional[_Union[Lock.State, str]]=...) -> None:
        ...
...
class CreateLockRequest(_message.Message):
    __slots__ = ('parent', 'lock')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    LOCK_FIELD_NUMBER: _ClassVar[int]
    parent: str
    lock: Lock

    def __init__(self, parent: _Optional[str]=..., lock: _Optional[_Union[Lock, _Mapping]]=...) -> None:
        ...
...
class CheckLockRequest(_message.Message):
    __slots__ = ('name',)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class ListLocksResponse(_message.Message):
    __slots__ = ('locks', 'next_page_token')
    LOCKS_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    locks: _containers.RepeatedCompositeFieldContainer[Lock]
    next_page_token: str

    def __init__(self, locks: _Optional[_Iterable[_Union[Lock, _Mapping]]]=..., next_page_token: _Optional[str]=...) -> None:
        ...
