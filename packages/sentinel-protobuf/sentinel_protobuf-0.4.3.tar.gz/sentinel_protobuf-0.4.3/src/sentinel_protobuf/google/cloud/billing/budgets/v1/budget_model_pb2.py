...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/billing/budgets/v1/budget_model.proto')
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n2google/cloud/billing/budgets/v1/budget_model.proto\x12\x1fgoogle.cloud.billing.budgets.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x16google/type/date.proto\x1a\x17google/type/money.proto"\xcf\x03\n\x06Budget\x12\x11\n\x04name\x18\x01 \x01(\tB\x03\xe0A\x03\x12\x14\n\x0cdisplay_name\x18\x02 \x01(\t\x12C\n\rbudget_filter\x18\x03 \x01(\x0b2\'.google.cloud.billing.budgets.v1.FilterB\x03\xe0A\x01\x12B\n\x06amount\x18\x04 \x01(\x0b2-.google.cloud.billing.budgets.v1.BudgetAmountB\x03\xe0A\x02\x12L\n\x0fthreshold_rules\x18\x05 \x03(\x0b2..google.cloud.billing.budgets.v1.ThresholdRuleB\x03\xe0A\x01\x12S\n\x12notifications_rule\x18\x06 \x01(\x0b22.google.cloud.billing.budgets.v1.NotificationsRuleB\x03\xe0A\x01\x12\x11\n\x04etag\x18\x07 \x01(\tB\x03\xe0A\x01:]\xeaAZ\n$billingbudgets.googleapis.com/Budget\x122billingAccounts/{billing_account}/budgets/{budget}"\xa0\x01\n\x0cBudgetAmount\x12.\n\x10specified_amount\x18\x01 \x01(\x0b2\x12.google.type.MoneyH\x00\x12O\n\x12last_period_amount\x18\x02 \x01(\x0b21.google.cloud.billing.budgets.v1.LastPeriodAmountH\x00B\x0f\n\rbudget_amount"\x12\n\x10LastPeriodAmount"\xc8\x01\n\rThresholdRule\x12\x1e\n\x11threshold_percent\x18\x01 \x01(\x01B\x03\xe0A\x02\x12N\n\x0bspend_basis\x18\x02 \x01(\x0e24.google.cloud.billing.budgets.v1.ThresholdRule.BasisB\x03\xe0A\x01"G\n\x05Basis\x12\x15\n\x11BASIS_UNSPECIFIED\x10\x00\x12\x11\n\rCURRENT_SPEND\x10\x01\x12\x14\n\x10FORECASTED_SPEND\x10\x02"\xd5\x01\n\x11NotificationsRule\x12\x19\n\x0cpubsub_topic\x18\x01 \x01(\tB\x03\xe0A\x01\x12\x1b\n\x0eschema_version\x18\x02 \x01(\tB\x03\xe0A\x01\x12-\n monitoring_notification_channels\x18\x03 \x03(\tB\x03\xe0A\x01\x12+\n\x1edisable_default_iam_recipients\x18\x04 \x01(\x08B\x03\xe0A\x01\x12,\n\x1fenable_project_level_recipients\x18\x05 \x01(\x08B\x03\xe0A\x01"\xc4\x05\n\x06Filter\x12\x15\n\x08projects\x18\x01 \x03(\tB\x03\xe0A\x01\x12\x1f\n\x12resource_ancestors\x18\x02 \x03(\tB\x03\xe0A\x01\x12\x19\n\x0ccredit_types\x18\x07 \x03(\tB\x03\xe0A\x01\x12a\n\x16credit_types_treatment\x18\x04 \x01(\x0e2<.google.cloud.billing.budgets.v1.Filter.CreditTypesTreatmentB\x03\xe0A\x01\x12\x15\n\x08services\x18\x03 \x03(\tB\x03\xe0A\x01\x12\x18\n\x0bsubaccounts\x18\x05 \x03(\tB\x03\xe0A\x01\x12H\n\x06labels\x18\x06 \x03(\x0b23.google.cloud.billing.budgets.v1.Filter.LabelsEntryB\x03\xe0A\x01\x12O\n\x0fcalendar_period\x18\x08 \x01(\x0e2/.google.cloud.billing.budgets.v1.CalendarPeriodB\x03\xe0A\x01H\x00\x12K\n\rcustom_period\x18\t \x01(\x0b2-.google.cloud.billing.budgets.v1.CustomPeriodB\x03\xe0A\x01H\x00\x1aI\n\x0bLabelsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12)\n\x05value\x18\x02 \x01(\x0b2\x1a.google.protobuf.ListValue:\x028\x01"\x8f\x01\n\x14CreditTypesTreatment\x12&\n"CREDIT_TYPES_TREATMENT_UNSPECIFIED\x10\x00\x12\x17\n\x13INCLUDE_ALL_CREDITS\x10\x01\x12\x17\n\x13EXCLUDE_ALL_CREDITS\x10\x02\x12\x1d\n\x19INCLUDE_SPECIFIED_CREDITS\x10\x03B\x0e\n\x0cusage_period"d\n\x0cCustomPeriod\x12*\n\nstart_date\x18\x01 \x01(\x0b2\x11.google.type.DateB\x03\xe0A\x02\x12(\n\x08end_date\x18\x02 \x01(\x0b2\x11.google.type.DateB\x03\xe0A\x01*S\n\x0eCalendarPeriod\x12\x1f\n\x1bCALENDAR_PERIOD_UNSPECIFIED\x10\x00\x12\t\n\x05MONTH\x10\x01\x12\x0b\n\x07QUARTER\x10\x02\x12\x08\n\x04YEAR\x10\x03Bx\n#com.google.cloud.billing.budgets.v1B\x10BudgetModelProtoP\x01Z=cloud.google.com/go/billing/budgets/apiv1/budgetspb;budgetspbb\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.cloud.billing.budgets.v1.budget_model_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    _globals['DESCRIPTOR']._loaded_options = None
    _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.billing.budgets.v1B\x10BudgetModelProtoP\x01Z=cloud.google.com/go/billing/budgets/apiv1/budgetspb;budgetspb'
    ...
    _globals['_BUDGET'].fields_by_name['notifications_rule']._loaded_options = None
    _globals['_BUDGET'].fields_by_name['notifications_rule']._serialized_options = b'\xe0A\x01'
    ...
    _globals['_NOTIFICATIONSRULE'].fields_by_name['pubsub_topic']._loaded_options = None
    _globals['_NOTIFICATIONSRULE'].fields_by_name['pubsub_topic']._serialized_options = b'\xe0A\x01'
    _globals['_NOTIFICATIONSRULE'].fields_by_name['schema_version']._loaded_options = None
    _globals['_NOTIFICATIONSRULE'].fields_by_name['schema_version']._serialized_options = b'\xe0A\x01'
    _globals['_NOTIFICATIONSRULE'].fields_by_name['monitoring_notification_channels']._loaded_options = None
    _globals['_NOTIFICATIONSRULE'].fields_by_name['monitoring_notification_channels']._serialized_options = b'\xe0A\x01'
    _globals['_NOTIFICATIONSRULE'].fields_by_name['disable_default_iam_recipients']._loaded_options = None
    _globals['_NOTIFICATIONSRULE'].fields_by_name['disable_default_iam_recipients']._serialized_options = b'\xe0A\x01'
    _globals['_NOTIFICATIONSRULE'].fields_by_name['enable_project_level_recipients']._loaded_options = None
    _globals['_NOTIFICATIONSRULE'].fields_by_name['enable_project_level_recipients']._serialized_options = b'\xe0A\x01'
    ...
    _globals['_CALENDARPERIOD']._serialized_start = 2107
    _globals['_CALENDARPERIOD']._serialized_end = 2190
    _globals['_BUDGET']._serialized_start = 227
    _globals['_BUDGET']._serialized_end = 690
    _globals['_BUDGETAMOUNT']._serialized_start = 693
    _globals['_BUDGETAMOUNT']._serialized_end = 853
    _globals['_LASTPERIODAMOUNT']._serialized_start = 855
    _globals['_LASTPERIODAMOUNT']._serialized_end = 873
    _globals['_THRESHOLDRULE']._serialized_start = 876
    _globals['_THRESHOLDRULE']._serialized_end = 1076
    _globals['_THRESHOLDRULE_BASIS']._serialized_start = 1005
    _globals['_THRESHOLDRULE_BASIS']._serialized_end = 1076
    _globals['_NOTIFICATIONSRULE']._serialized_start = 1079
    _globals['_NOTIFICATIONSRULE']._serialized_end = 1292
    _globals['_FILTER']._serialized_start = 1295
    _globals['_FILTER']._serialized_end = 2003
    _globals['_FILTER_LABELSENTRY']._serialized_start = 1768
    _globals['_FILTER_LABELSENTRY']._serialized_end = 1841
    _globals['_FILTER_CREDITTYPESTREATMENT']._serialized_start = 1844
    _globals['_FILTER_CREDITTYPESTREATMENT']._serialized_end = 1987
    _globals['_CUSTOMPERIOD']._serialized_start = 2005
    _globals['_CUSTOMPERIOD']._serialized_end = 2105