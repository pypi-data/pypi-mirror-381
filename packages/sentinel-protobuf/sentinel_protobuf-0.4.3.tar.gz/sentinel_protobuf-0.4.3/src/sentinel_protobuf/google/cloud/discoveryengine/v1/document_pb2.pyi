...
class Document(_message.Message):
    ...
    class IndexStatus(_message.Message):
        __slots__ = ('index_time', 'error_samples', 'pending_message')
        INDEX_TIME_FIELD_NUMBER: _ClassVar[int]
        ERROR_SAMPLES_FIELD_NUMBER: _ClassVar[int]
        PENDING_MESSAGE_FIELD_NUMBER: _ClassVar[int]
        index_time: _timestamp_pb2.Timestamp
        error_samples: _containers.RepeatedCompositeFieldContainer[_status_pb2.Status]
        pending_message: str

        def __init__(self, index_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., error_samples: _Optional[_Iterable[_Union[_status_pb2.Status, _Mapping]]]=..., pending_message: _Optional[str]=...) -> None:
            ...
