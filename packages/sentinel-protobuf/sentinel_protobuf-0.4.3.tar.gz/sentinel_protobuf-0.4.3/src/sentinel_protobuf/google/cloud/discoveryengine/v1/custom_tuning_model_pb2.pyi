...
class CustomTuningModel(_message.Message):
    __slots__ = ('name', 'display_name', 'model_version', 'model_state', 'create_time', 'training_start_time', 'metrics', 'error_message')
