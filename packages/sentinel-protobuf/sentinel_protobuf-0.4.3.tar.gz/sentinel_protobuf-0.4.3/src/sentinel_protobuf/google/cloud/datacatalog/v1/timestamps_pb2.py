...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SYSTEMTIMESTAMPS']._serialized_start = 144
    _globals['_SYSTEMTIMESTAMPS']._serialized_end = 314