...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/aiplatform/v1beta1/deployment_resource_pool.proto')
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n>google/cloud/aiplatform/v1beta1/deployment_resource_pool.proto\x12\x1fgoogle.cloud.aiplatform.v1beta1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a5google/cloud/aiplatform/v1beta1/encryption_spec.proto\x1a7google/cloud/aiplatform/v1beta1/machine_resources.proto\x1a\x1fgoogle/protobuf/timestamp.proto"\x8b\x04\n\x16DeploymentResourcePool\x12\x11\n\x04name\x18\x01 \x01(\tB\x03\xe0A\x05\x12U\n\x13dedicated_resources\x18\x02 \x01(\x0b23.google.cloud.aiplatform.v1beta1.DedicatedResourcesB\x03\xe0A\x02\x12H\n\x0fencryption_spec\x18\x05 \x01(\x0b2/.google.cloud.aiplatform.v1beta1.EncryptionSpec\x12\x17\n\x0fservice_account\x18\x06 \x01(\t\x12!\n\x19disable_container_logging\x18\x07 \x01(\x08\x124\n\x0bcreate_time\x18\x04 \x01(\x0b2\x1a.google.protobuf.TimestampB\x03\xe0A\x03\x12\x1a\n\rsatisfies_pzs\x18\x08 \x01(\x08B\x03\xe0A\x03\x12\x1a\n\rsatisfies_pzi\x18\t \x01(\x08B\x03\xe0A\x03:\x92\x01\xeaA\x8e\x01\n0aiplatform.googleapis.com/DeploymentResourcePool\x12Zprojects/{project}/locations/{location}/deploymentResourcePools/{deployment_resource_pool}B\xf2\x01\n#com.google.cloud.aiplatform.v1beta1B\x1bDeploymentResourcePoolProtoP\x01ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\xaa\x02\x1fGoogle.Cloud.AIPlatform.V1Beta1\xca\x02\x1fGoogle\\Cloud\\AIPlatform\\V1beta1\xea\x02"Google::Cloud::AIPlatform::V1beta1b\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.cloud.aiplatform.v1beta1.deployment_resource_pool_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    _globals['DESCRIPTOR']._loaded_options = None
    _globals['DESCRIPTOR']._serialized_options = b'\n#com.google.cloud.aiplatform.v1beta1B\x1bDeploymentResourcePoolProtoP\x01ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformpb\xaa\x02\x1fGoogle.Cloud.AIPlatform.V1Beta1\xca\x02\x1fGoogle\\Cloud\\AIPlatform\\V1beta1\xea\x02"Google::Cloud::AIPlatform::V1beta1'
    ...
    _globals['_DEPLOYMENTRESOURCEPOOL']._serialized_start = 305
    _globals['_DEPLOYMENTRESOURCEPOOL']._serialized_end = 828