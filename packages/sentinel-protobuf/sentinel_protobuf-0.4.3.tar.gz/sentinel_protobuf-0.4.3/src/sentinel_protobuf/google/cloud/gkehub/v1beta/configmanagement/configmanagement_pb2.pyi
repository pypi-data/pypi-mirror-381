...
class MembershipSpec(_message.Message):
    __slots__ = ('config_sync', 'policy_controller', 'binauthz', 'hierarchy_controller', 'version', 'cluster', 'management')
    ...
    def __init__(self, config_sync: _Optional[_Union[ConfigSync, _Mapping]]=..., policy_controller: _Optional[_Union[PolicyController, _Mapping]]=..., binauthz: _Optional[_Union[BinauthzConfig, _Mapping]]=..., hierarchy_controller: _Optional[_Union[HierarchyControllerConfig, _Mapping]]=..., version: _Optional[str]=..., cluster: _Optional[str]=..., management: _Optional[_Union[MembershipSpec.Management, str]]=...) -> None:
        ...

class ConfigSync(_message.Message):
    __slots__ = ('git', 'source_format', 'enabled', 'prevent_drift', 'oci', 'stop_syncing')
    ...
    STOP_SYNCING_FIELD_NUMBER: _ClassVar[int]
    git: GitConfig
    source_format: str
    enabled: bool
    prevent_drift: bool
    ...
    def __init__(self, git: _Optional[_Union[GitConfig, _Mapping]]=..., source_format: _Optional[str]=..., enabled: bool=..., prevent_drift: bool=..., oci: _Optional[_Union[OciConfig, _Mapping]]=..., stop_syncing: bool=...) -> None:
        ...
...
class PolicyController(_message.Message):
    __slots__ = ('enabled', 'template_library_installed', 'audit_interval_seconds', 'exemptable_namespaces', 'referential_rules_enabled', 'log_denies_enabled', 'mutation_enabled', 'monitoring', 'update_time')
    ENABLED_FIELD_NUMBER: _ClassVar[int]
    ...
    monitoring: PolicyControllerMonitoring
    update_time: _timestamp_pb2.Timestamp

    def __init__(self, enabled: bool=..., template_library_installed: bool=..., audit_interval_seconds: _Optional[int]=..., exemptable_namespaces: _Optional[_Iterable[str]]=..., referential_rules_enabled: bool=..., log_denies_enabled: bool=..., mutation_enabled: bool=..., monitoring: _Optional[_Union[PolicyControllerMonitoring, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...

class PolicyControllerMonitoring(_message.Message):
    __slots__ = ('backends',)

    class MonitoringBackend(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        MONITORING_BACKEND_UNSPECIFIED: _ClassVar[PolicyControllerMonitoring.MonitoringBackend]
        PROMETHEUS: _ClassVar[PolicyControllerMonitoring.MonitoringBackend]
        CLOUD_MONITORING: _ClassVar[PolicyControllerMonitoring.MonitoringBackend]
    MONITORING_BACKEND_UNSPECIFIED: PolicyControllerMonitoring.MonitoringBackend
    PROMETHEUS: PolicyControllerMonitoring.MonitoringBackend
    CLOUD_MONITORING: PolicyControllerMonitoring.MonitoringBackend
    BACKENDS_FIELD_NUMBER: _ClassVar[int]
    backends: _containers.RepeatedScalarFieldContainer[PolicyControllerMonitoring.MonitoringBackend]

    def __init__(self, backends: _Optional[_Iterable[_Union[PolicyControllerMonitoring.MonitoringBackend, str]]]=...) -> None:
        ...
...
class ConfigSyncState(_message.Message):
    __slots__ = ('version', 'deployment_state', 'sync_state', 'errors', 'rootsync_crd', 'reposync_crd', 'state', 'cluster_level_stop_syncing_state', 'cr_count')
    ...
    class StopSyncingState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STOP_SYNCING_STATE_UNSPECIFIED: _ClassVar[ConfigSyncState.StopSyncingState]
        NOT_STOPPED: _ClassVar[ConfigSyncState.StopSyncingState]
        PENDING: _ClassVar[ConfigSyncState.StopSyncingState]
        STOPPED: _ClassVar[ConfigSyncState.StopSyncingState]
    STOP_SYNCING_STATE_UNSPECIFIED: ConfigSyncState.StopSyncingState
    NOT_STOPPED: ConfigSyncState.StopSyncingState
    PENDING: ConfigSyncState.StopSyncingState
    STOPPED: ConfigSyncState.StopSyncingState
    VERSION_FIELD_NUMBER: _ClassVar[int]
    DEPLOYMENT_STATE_FIELD_NUMBER: _ClassVar[int]
    ...
    STATE_FIELD_NUMBER: _ClassVar[int]
    CLUSTER_LEVEL_STOP_SYNCING_STATE_FIELD_NUMBER: _ClassVar[int]
    CR_COUNT_FIELD_NUMBER: _ClassVar[int]
    ...
    cluster_level_stop_syncing_state: ConfigSyncState.StopSyncingState
    cr_count: int

    def __init__(self, version: _Optional[_Union[ConfigSyncVersion, _Mapping]]=..., deployment_state: _Optional[_Union[ConfigSyncDeploymentState, _Mapping]]=..., sync_state: _Optional[_Union[SyncState, _Mapping]]=..., errors: _Optional[_Iterable[_Union[ConfigSyncError, _Mapping]]]=..., rootsync_crd: _Optional[_Union[ConfigSyncState.CRDState, str]]=..., reposync_crd: _Optional[_Union[ConfigSyncState.CRDState, str]]=..., state: _Optional[_Union[ConfigSyncState.State, str]]=..., cluster_level_stop_syncing_state: _Optional[_Union[ConfigSyncState.StopSyncingState, str]]=..., cr_count: _Optional[int]=...) -> None:
        ...
...
class ConfigSyncVersion(_message.Message):
    __slots__ = ('importer', 'syncer', 'git_sync', 'monitor', 'reconciler_manager', 'root_reconciler', 'admission_webhook', 'resource_group_controller_manager', 'otel_collector')
    ...
    RESOURCE_GROUP_CONTROLLER_MANAGER_FIELD_NUMBER: _ClassVar[int]
    ...
    resource_group_controller_manager: str
    otel_collector: str

    def __init__(self, importer: _Optional[str]=..., syncer: _Optional[str]=..., git_sync: _Optional[str]=..., monitor: _Optional[str]=..., reconciler_manager: _Optional[str]=..., root_reconciler: _Optional[str]=..., admission_webhook: _Optional[str]=..., resource_group_controller_manager: _Optional[str]=..., otel_collector: _Optional[str]=...) -> None:
        ...
...
class PolicyControllerState(_message.Message):
    __slots__ = ('version', 'deployment_state', 'migration')
    VERSION_FIELD_NUMBER: _ClassVar[int]
    DEPLOYMENT_STATE_FIELD_NUMBER: _ClassVar[int]
    MIGRATION_FIELD_NUMBER: _ClassVar[int]
    version: PolicyControllerVersion
    deployment_state: GatekeeperDeploymentState
    migration: PolicyControllerMigration

    def __init__(self, version: _Optional[_Union[PolicyControllerVersion, _Mapping]]=..., deployment_state: _Optional[_Union[GatekeeperDeploymentState, _Mapping]]=..., migration: _Optional[_Union[PolicyControllerMigration, _Mapping]]=...) -> None:
        ...
...
class PolicyControllerMigration(_message.Message):
    __slots__ = ('stage', 'copy_time')

    class Stage(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STAGE_UNSPECIFIED: _ClassVar[PolicyControllerMigration.Stage]
        ACM_MANAGED: _ClassVar[PolicyControllerMigration.Stage]
        POCO_MANAGED: _ClassVar[PolicyControllerMigration.Stage]
    STAGE_UNSPECIFIED: PolicyControllerMigration.Stage
    ACM_MANAGED: PolicyControllerMigration.Stage
    POCO_MANAGED: PolicyControllerMigration.Stage
    STAGE_FIELD_NUMBER: _ClassVar[int]
    COPY_TIME_FIELD_NUMBER: _ClassVar[int]
    stage: PolicyControllerMigration.Stage
    copy_time: _timestamp_pb2.Timestamp

    def __init__(self, stage: _Optional[_Union[PolicyControllerMigration.Stage, str]]=..., copy_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
