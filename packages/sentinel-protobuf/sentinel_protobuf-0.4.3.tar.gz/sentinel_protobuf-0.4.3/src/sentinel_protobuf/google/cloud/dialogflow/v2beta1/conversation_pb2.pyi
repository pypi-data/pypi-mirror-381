...
from google.cloud.dialogflow.v2beta1 import conversation_profile_pb2 as _conversation_profile_pb2
...
class Conversation(_message.Message):
    __slots__ = ('name', 'lifecycle_state', 'conversation_profile', 'phone_number', 'conversation_stage', 'start_time', 'end_time', 'telephony_connection_info', 'ingested_context_references')
    ...
    def __init__(self, name: _Optional[str]=..., lifecycle_state: _Optional[_Union[Conversation.LifecycleState, str]]=..., conversation_profile: _Optional[str]=..., phone_number: _Optional[_Union[ConversationPhoneNumber, _Mapping]]=..., conversation_stage: _Optional[_Union[Conversation.ConversationStage, str]]=..., start_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., end_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., telephony_connection_info: _Optional[_Union[Conversation.TelephonyConnectionInfo, _Mapping]]=..., ingested_context_references: _Optional[_Mapping[str, Conversation.ContextReference]]=...) -> None:
        ...
...
class CreateMessageRequest(_message.Message):
    ...
    parent: str
    message: _participant_pb2.Message

    def __init__(self, parent: _Optional[str]=..., message: _Optional[_Union[_participant_pb2.Message, _Mapping]]=...) -> None:
        ...

class BatchCreateMessagesRequest(_message.Message):
    __slots__ = ('parent', 'requests')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    REQUESTS_FIELD_NUMBER: _ClassVar[int]
    parent: str
    requests: _containers.RepeatedCompositeFieldContainer[CreateMessageRequest]

    def __init__(self, parent: _Optional[str]=..., requests: _Optional[_Iterable[_Union[CreateMessageRequest, _Mapping]]]=...) -> None:
        ...

class BatchCreateMessagesResponse(_message.Message):
    __slots__ = ('messages',)
    MESSAGES_FIELD_NUMBER: _ClassVar[int]
    messages: _containers.RepeatedCompositeFieldContainer[_participant_pb2.Message]

    def __init__(self, messages: _Optional[_Iterable[_Union[_participant_pb2.Message, _Mapping]]]=...) -> None:
        ...
