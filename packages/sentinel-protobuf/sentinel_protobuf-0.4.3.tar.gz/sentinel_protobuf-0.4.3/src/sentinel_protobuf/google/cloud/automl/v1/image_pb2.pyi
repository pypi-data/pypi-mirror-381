...
class ImageClassificationModelMetadata(_message.Message):
    __slots__ = ('base_model_id', 'train_budget_milli_node_hours', 'train_cost_milli_node_hours', 'stop_reason', 'model_type', 'node_qps', 'node_count')
    ...
    def __init__(self, base_model_id: _Optional[str]=..., train_budget_milli_node_hours: _Optional[int]=..., train_cost_milli_node_hours: _Optional[int]=..., stop_reason: _Optional[str]=..., model_type: _Optional[str]=..., node_qps: _Optional[float]=..., node_count: _Optional[int]=...) -> None:
        ...
