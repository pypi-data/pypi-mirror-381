...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/aiplatform/v1/model_deployment_monitoring_job.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_MODELDEPLOYMENTMONITORINGOBJECTIVETYPE']._serialized_start = 3989
    _globals['_MODELDEPLOYMENTMONITORINGOBJECTIVETYPE']._serialized_end = 4195
    _globals['_MODELDEPLOYMENTMONITORINGJOB']._serialized_start = 518
    _globals['_MODELDEPLOYMENTMONITORINGJOB']._serialized_end = 2667
    _globals['_MODELDEPLOYMENTMONITORINGJOB_LATESTMONITORINGPIPELINEMETADATA']._serialized_start = 2227
    _globals['_MODELDEPLOYMENTMONITORINGJOB_LATESTMONITORINGPIPELINEMETADATA']._serialized_end = 2343
    _globals['_MODELDEPLOYMENTMONITORINGJOB_LABELSENTRY']._serialized_start = 2345
    _globals['_MODELDEPLOYMENTMONITORINGJOB_LABELSENTRY']._serialized_end = 2390
    _globals['_MODELDEPLOYMENTMONITORINGJOB_MONITORINGSCHEDULESTATE']._serialized_start = 2392
    _globals['_MODELDEPLOYMENTMONITORINGJOB_MONITORINGSCHEDULESTATE']._serialized_end = 2499
    _globals['_MODELDEPLOYMENTMONITORINGBIGQUERYTABLE']._serialized_start = 2670
    _globals['_MODELDEPLOYMENTMONITORINGBIGQUERYTABLE']._serialized_end = 3116
    _globals['_MODELDEPLOYMENTMONITORINGBIGQUERYTABLE_LOGSOURCE']._serialized_start = 2987
    _globals['_MODELDEPLOYMENTMONITORINGBIGQUERYTABLE_LOGSOURCE']._serialized_end = 3053
    _globals['_MODELDEPLOYMENTMONITORINGBIGQUERYTABLE_LOGTYPE']._serialized_start = 3055
    _globals['_MODELDEPLOYMENTMONITORINGBIGQUERYTABLE_LOGTYPE']._serialized_end = 3116
    _globals['_MODELDEPLOYMENTMONITORINGOBJECTIVECONFIG']._serialized_start = 3119
    _globals['_MODELDEPLOYMENTMONITORINGOBJECTIVECONFIG']._serialized_end = 3274
    _globals['_MODELDEPLOYMENTMONITORINGSCHEDULECONFIG']._serialized_start = 3277
    _globals['_MODELDEPLOYMENTMONITORINGSCHEDULECONFIG']._serialized_end = 3427
    _globals['_MODELMONITORINGSTATSANOMALIES']._serialized_start = 3430
    _globals['_MODELMONITORINGSTATSANOMALIES']._serialized_end = 3986
    _globals['_MODELMONITORINGSTATSANOMALIES_FEATUREHISTORICSTATSANOMALIES']._serialized_start = 3713
    _globals['_MODELMONITORINGSTATSANOMALIES_FEATUREHISTORICSTATSANOMALIES']._serialized_end = 3986