...
class ProductSetPurgeConfig(_message.Message):
    __slots__ = ('product_set_id',)
    PRODUCT_SET_ID_FIELD_NUMBER: _ClassVar[int]
    product_set_id: str

    def __init__(self, product_set_id: _Optional[str]=...) -> None:
        ...

class PurgeProductsRequest(_message.Message):
    __slots__ = ('product_set_purge_config', 'delete_orphan_products', 'parent', 'force')
    PRODUCT_SET_PURGE_CONFIG_FIELD_NUMBER: _ClassVar[int]
    DELETE_ORPHAN_PRODUCTS_FIELD_NUMBER: _ClassVar[int]
    PARENT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, product_set_purge_config: _Optional[_Union[ProductSetPurgeConfig, _Mapping]]=..., delete_orphan_products: bool=..., parent: _Optional[str]=..., force: bool=...) -> None:
        ...