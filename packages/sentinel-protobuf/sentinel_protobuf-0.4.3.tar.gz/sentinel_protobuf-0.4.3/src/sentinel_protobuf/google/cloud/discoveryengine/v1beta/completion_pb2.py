...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SUGGESTIONDENYLISTENTRY']._serialized_start = 127
    _globals['_SUGGESTIONDENYLISTENTRY']._serialized_end = 364
    _globals['_SUGGESTIONDENYLISTENTRY_MATCHOPERATOR']._serialized_start = 286
    _globals['_SUGGESTIONDENYLISTENTRY_MATCHOPERATOR']._serialized_end = 364
    _globals['_COMPLETIONSUGGESTION']._serialized_start = 367
    _globals['_COMPLETIONSUGGESTION']._serialized_end = 566