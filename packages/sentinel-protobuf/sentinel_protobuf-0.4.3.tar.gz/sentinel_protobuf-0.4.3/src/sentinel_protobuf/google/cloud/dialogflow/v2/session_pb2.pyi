...
class DetectIntentResponse(_message.Message):
    __slots__ = ('response_id', 'query_result', 'webhook_status', 'output_audio', 'output_audio_config')
    ...
    def __init__(self, response_id: _Optional[str]=..., query_result: _Optional[_Union[QueryResult, _Mapping]]=..., webhook_status: _Optional[_Union[_status_pb2.Status, _Mapping]]=..., output_audio: _Optional[bytes]=..., output_audio_config: _Optional[_Union[_audio_config_pb2.OutputAudioConfig, _Mapping]]=...) -> None:
        ...

class QueryParameters(_message.Message):
    __slots__ = ('time_zone', 'geo_location', 'contexts', 'reset_contexts', 'session_entity_types', 'payload', 'sentiment_analysis_request_config', 'webhook_headers', 'platform')
...
class QueryInput(_message.Message):
    ...
    def __init__(self, audio_config: _Optional[_Union[_audio_config_pb2.InputAudioConfig, _Mapping]]=..., text: _Optional[_Union[TextInput, _Mapping]]=..., event: _Optional[_Union[EventInput, _Mapping]]=...) -> None:
        ...

class QueryResult(_message.Message):
    __slots__ = ('query_text', 'language_code', 'speech_recognition_confidence', 'action', 'parameters', 'all_required_params_present', 'cancels_slot_filling', 'fulfillment_text', 'fulfillment_messages', 'webhook_source', 'webhook_payload', 'output_contexts', 'intent', 'intent_detection_confidence', 'diagnostic_info', 'sentiment_analysis_result')
...
class StreamingDetectIntentResponse(_message.Message):
    __slots__ = ('response_id', 'recognition_result', 'query_result', 'webhook_status', 'output_audio', 'output_audio_config', 'debugging_info')
    RESPONSE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, response_id: _Optional[str]=..., recognition_result: _Optional[_Union[StreamingRecognitionResult, _Mapping]]=..., query_result: _Optional[_Union[QueryResult, _Mapping]]=..., webhook_status: _Optional[_Union[_status_pb2.Status, _Mapping]]=..., output_audio: _Optional[bytes]=..., output_audio_config: _Optional[_Union[_audio_config_pb2.OutputAudioConfig, _Mapping]]=..., debugging_info: _Optional[_Union[CloudConversationDebuggingInfo, _Mapping]]=...) -> None:
        ...

class StreamingRecognitionResult(_message.Message):
    __slots__ = ('message_type', 'transcript', 'is_final', 'confidence', 'speech_word_info', 'speech_end_offset', 'language_code')
    ...
    def __init__(self, message_type: _Optional[_Union[StreamingRecognitionResult.MessageType, str]]=..., transcript: _Optional[str]=..., is_final: bool=..., confidence: _Optional[float]=..., speech_word_info: _Optional[_Iterable[_Union[_audio_config_pb2.SpeechWordInfo, _Mapping]]]=..., speech_end_offset: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., language_code: _Optional[str]=...) -> None:
        ...
