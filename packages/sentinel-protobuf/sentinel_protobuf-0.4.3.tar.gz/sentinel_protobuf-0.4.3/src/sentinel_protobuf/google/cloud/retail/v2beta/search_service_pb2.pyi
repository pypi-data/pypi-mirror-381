...
class SearchRequest(_message.Message):
    __slots__ = ('placement', 'branch', 'query', 'visitor_id', 'user_info', 'page_size', 'page_token', 'offset', 'filter', 'canonical_filter', 'order_by', 'facet_specs', 'dynamic_facet_spec', 'boost_spec', 'query_expansion_spec', 'variant_rollup_keys', 'page_categories', 'search_mode', 'personalization_spec', 'labels', 'spell_correction_spec', 'entity', 'conversational_search_spec', 'tile_navigation_spec', 'language_code', 'region_code', 'place_id')
...
class SearchResponse(_message.Message):
    ...
    class SearchResult(_message.Message):
        __slots__ = ('id', 'product', 'matching_variant_count', 'matching_variant_fields', 'variant_rollup_values', 'personal_labels')
