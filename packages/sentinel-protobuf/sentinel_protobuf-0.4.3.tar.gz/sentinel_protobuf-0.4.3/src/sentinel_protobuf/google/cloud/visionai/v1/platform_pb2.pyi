...
from google.cloud.visionai.v1 import annotations_pb2 as _annotations_pb2_1
...
class ModelType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PRODUCT_RECOGNIZER: _ClassVar[ModelType]
    TAG_RECOGNIZER: _ClassVar[ModelType]
    SYNTH_ID: _ClassVar[ModelType]
...
class DataType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    PROTO: _ClassVar[DataType]
    PLACEHOLDER: _ClassVar[DataType]
...
PRODUCT_RECOGNIZER: ModelType
TAG_RECOGNIZER: ModelType
SYNTH_ID: ModelType
...
class Application(_message.Message):
    __slots__ = ('name', 'create_time', 'update_time', 'labels', 'display_name', 'description', 'application_configs', 'runtime_info', 'state', 'billing_mode')
    ...
    class BillingMode(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        BILLING_MODE_UNSPECIFIED: _ClassVar[Application.BillingMode]
        PAYG: _ClassVar[Application.BillingMode]
        MONTHLY: _ClassVar[Application.BillingMode]
    BILLING_MODE_UNSPECIFIED: Application.BillingMode
    PAYG: Application.BillingMode
    MONTHLY: Application.BillingMode
    ...
    billing_mode: Application.BillingMode

    def __init__(self, name: _Optional[str]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., labels: _Optional[_Mapping[str, str]]=..., display_name: _Optional[str]=..., description: _Optional[str]=..., application_configs: _Optional[_Union[ApplicationConfigs, _Mapping]]=..., runtime_info: _Optional[_Union[Application.ApplicationRuntimeInfo, _Mapping]]=..., state: _Optional[_Union[Application.State, str]]=..., billing_mode: _Optional[_Union[Application.BillingMode, str]]=...) -> None:
        ...
...
class Instance(_message.Message):
    __slots__ = ('name', 'create_time', 'update_time', 'labels', 'display_name', 'description', 'instance_type', 'input_resources', 'output_resources', 'state')
    ...
    class InstanceType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        STREAMING_PREDICTION: _ClassVar[Instance.InstanceType]
        BATCH_PREDICTION: _ClassVar[Instance.InstanceType]
        ONLINE_PREDICTION: _ClassVar[Instance.InstanceType]
    INSTANCE_TYPE_UNSPECIFIED: Instance.InstanceType
    STREAMING_PREDICTION: Instance.InstanceType
    BATCH_PREDICTION: Instance.InstanceType
    ONLINE_PREDICTION: Instance.InstanceType
    ...
    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        FINISHED: _ClassVar[Instance.State]
    ...
    class InputResource(_message.Message):
        __slots__ = ('input_resource', 'annotated_stream', 'data_type', 'consumer_node', 'input_resource_binding', 'annotations')
        ...
        def __init__(self, input_resource: _Optional[str]=..., annotated_stream: _Optional[_Union[StreamWithAnnotation, _Mapping]]=..., data_type: _Optional[_Union[DataType, str]]=..., consumer_node: _Optional[str]=..., input_resource_binding: _Optional[str]=..., annotations: _Optional[_Union[ResourceAnnotations, _Mapping]]=...) -> None:
            ...
    ...
    def __init__(self, name: _Optional[str]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., labels: _Optional[_Mapping[str, str]]=..., display_name: _Optional[str]=..., description: _Optional[str]=..., instance_type: _Optional[_Union[Instance.InstanceType, str]]=..., input_resources: _Optional[_Iterable[_Union[Instance.InputResource, _Mapping]]]=..., output_resources: _Optional[_Iterable[_Union[Instance.OutputResource, _Mapping]]]=..., state: _Optional[_Union[Instance.State, str]]=...) -> None:
        ...
...
class Processor(_message.Message):
    __slots__ = ('name', 'create_time', 'update_time', 'labels', 'display_name', 'description', 'processor_type', 'model_type', 'custom_processor_source_info', 'state', 'processor_io_spec', 'configuration_typeurl', 'supported_annotation_types', 'supports_post_processing', 'supported_instance_types')
    ...
    SUPPORTED_INSTANCE_TYPES_FIELD_NUMBER: _ClassVar[int]
    name: str
    create_time: _timestamp_pb2.Timestamp
    update_time: _timestamp_pb2.Timestamp
    labels: _containers.ScalarMap[str, str]
...
class ProcessorIOSpec(_message.Message):
    ...
    class GraphInputChannelSpec(_message.Message):
        ...
        def __init__(self, name: _Optional[str]=..., data_type: _Optional[_Union[DataType, str]]=..., accepted_data_type_uris: _Optional[_Iterable[str]]=..., required: bool=..., max_connection_allowed: _Optional[int]=...) -> None:
            ...
    ...
    class GraphOutputChannelSpec(_message.Message):
        ...
        def __init__(self, name: _Optional[str]=..., data_type: _Optional[_Union[DataType, str]]=..., data_type_uri: _Optional[str]=...) -> None:
            ...
...
class CustomProcessorSourceInfo(_message.Message):
    __slots__ = ('vertex_model', 'product_recognizer_artifact', 'source_type', 'additional_info', 'model_schema')
    ...
    class SourceType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        PRODUCT_RECOGNIZER: _ClassVar[CustomProcessorSourceInfo.SourceType]
    ...
    PRODUCT_RECOGNIZER: CustomProcessorSourceInfo.SourceType

    class ProductRecognizerArtifact(_message.Message):
        __slots__ = ('retail_product_recognition_index', 'vertex_model')
        RETAIL_PRODUCT_RECOGNITION_INDEX_FIELD_NUMBER: _ClassVar[int]
        VERTEX_MODEL_FIELD_NUMBER: _ClassVar[int]
        retail_product_recognition_index: str
        vertex_model: str

        def __init__(self, retail_product_recognition_index: _Optional[str]=..., vertex_model: _Optional[str]=...) -> None:
            ...
    ...
    class AdditionalInfoEntry(_message.Message):
        ...
        def __init__(self, key: _Optional[str]=..., value: _Optional[str]=...) -> None:
            ...
    VERTEX_MODEL_FIELD_NUMBER: _ClassVar[int]
    PRODUCT_RECOGNIZER_ARTIFACT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, vertex_model: _Optional[str]=..., product_recognizer_artifact: _Optional[_Union[CustomProcessorSourceInfo.ProductRecognizerArtifact, _Mapping]]=..., source_type: _Optional[_Union[CustomProcessorSourceInfo.SourceType, str]]=..., additional_info: _Optional[_Mapping[str, str]]=..., model_schema: _Optional[_Union[CustomProcessorSourceInfo.ModelSchema, _Mapping]]=...) -> None:
        ...

class ProcessorConfig(_message.Message):
    __slots__ = ('video_stream_input_config', 'ai_enabled_devices_input_config', 'media_warehouse_config', 'person_blur_config', 'occupancy_count_config', 'person_vehicle_detection_config', 'vertex_automl_vision_config', 'vertex_automl_video_config', 'vertex_custom_config', 'general_object_detection_config', 'big_query_config', 'gcs_output_config', 'product_recognizer_config', 'personal_protective_equipment_detection_config', 'tag_recognizer_config', 'universal_input_config', 'experimental_config')
    ...
    PRODUCT_RECOGNIZER_CONFIG_FIELD_NUMBER: _ClassVar[int]
    PERSONAL_PROTECTIVE_EQUIPMENT_DETECTION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    TAG_RECOGNIZER_CONFIG_FIELD_NUMBER: _ClassVar[int]
    UNIVERSAL_INPUT_CONFIG_FIELD_NUMBER: _ClassVar[int]
...
class VertexCustomConfig(_message.Message):
    __slots__ = ('max_prediction_fps', 'dedicated_resources', 'post_processing_cloud_function', 'attach_application_metadata', 'dynamic_config_input_topic')
    ...
    DYNAMIC_CONFIG_INPUT_TOPIC_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, max_prediction_fps: _Optional[int]=..., dedicated_resources: _Optional[_Union[DedicatedResources, _Mapping]]=..., post_processing_cloud_function: _Optional[str]=..., attach_application_metadata: bool=..., dynamic_config_input_topic: _Optional[str]=...) -> None:
        ...
...
class UniversalInputConfig(_message.Message):
    __slots__ = ()
...
class ProductRecognizerConfig(_message.Message):
    __slots__ = ('retail_endpoint', 'recognition_confidence_threshold')
    RETAIL_ENDPOINT_FIELD_NUMBER: _ClassVar[int]
    RECOGNITION_CONFIDENCE_THRESHOLD_FIELD_NUMBER: _ClassVar[int]
    retail_endpoint: str
    recognition_confidence_threshold: float

    def __init__(self, retail_endpoint: _Optional[str]=..., recognition_confidence_threshold: _Optional[float]=...) -> None:
        ...

class TagRecognizerConfig(_message.Message):
    __slots__ = ('entity_detection_confidence_threshold', 'tag_parsing_config')
    ENTITY_DETECTION_CONFIDENCE_THRESHOLD_FIELD_NUMBER: _ClassVar[int]
    TAG_PARSING_CONFIG_FIELD_NUMBER: _ClassVar[int]
    entity_detection_confidence_threshold: float
    tag_parsing_config: TagParsingConfig

    def __init__(self, entity_detection_confidence_threshold: _Optional[float]=..., tag_parsing_config: _Optional[_Union[TagParsingConfig, _Mapping]]=...) -> None:
        ...

class TagParsingConfig(_message.Message):
    __slots__ = ('entity_parsing_configs',)

    class EntityParsingConfig(_message.Message):
        __slots__ = ('entity_class', 'regex', 'entity_matching_strategy')

        class EntityMatchingStrategy(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            ENTITY_MATCHING_STRATEGY_UNSPECIFIED: _ClassVar[TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy]
            MULTI_LINE_MATCHING: _ClassVar[TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy]
            MAX_OVERLAP_AREA: _ClassVar[TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy]
        ENTITY_MATCHING_STRATEGY_UNSPECIFIED: TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy
        MULTI_LINE_MATCHING: TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy
        MAX_OVERLAP_AREA: TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy
        ENTITY_CLASS_FIELD_NUMBER: _ClassVar[int]
        REGEX_FIELD_NUMBER: _ClassVar[int]
        ENTITY_MATCHING_STRATEGY_FIELD_NUMBER: _ClassVar[int]
        entity_class: str
        regex: str
        entity_matching_strategy: TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy

        def __init__(self, entity_class: _Optional[str]=..., regex: _Optional[str]=..., entity_matching_strategy: _Optional[_Union[TagParsingConfig.EntityParsingConfig.EntityMatchingStrategy, str]]=...) -> None:
            ...
    ENTITY_PARSING_CONFIGS_FIELD_NUMBER: _ClassVar[int]
    entity_parsing_configs: _containers.RepeatedCompositeFieldContainer[TagParsingConfig.EntityParsingConfig]

    def __init__(self, entity_parsing_configs: _Optional[_Iterable[_Union[TagParsingConfig.EntityParsingConfig, _Mapping]]]=...) -> None:
        ...