...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_OPERATIONMETADATA']._serialized_start = 168
    _globals['_OPERATIONMETADATA']._serialized_end = 424