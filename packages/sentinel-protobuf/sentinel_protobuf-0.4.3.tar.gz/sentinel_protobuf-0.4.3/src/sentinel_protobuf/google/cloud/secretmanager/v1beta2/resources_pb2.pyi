...
class Secret(_message.Message):
    __slots__ = ('name', 'replication', 'create_time', 'labels', 'topics', 'expire_time', 'ttl', 'etag', 'rotation', 'version_aliases', 'annotations', 'version_destroy_ttl', 'customer_managed_encryption')
