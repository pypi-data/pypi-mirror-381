...
class ServingConfig(_message.Message):
    __slots__ = ('media_config', 'generic_config', 'name', 'display_name', 'solution_type', 'model_id', 'diversity_level', 'ranking_expression', 'create_time', 'update_time', 'filter_control_ids', 'boost_control_ids', 'redirect_control_ids', 'synonyms_control_ids', 'oneway_synonyms_control_ids', 'dissociate_control_ids', 'replacement_control_ids', 'ignore_control_ids', 'promote_control_ids')
    ...
    PROMOTE_CONTROL_IDS_FIELD_NUMBER: _ClassVar[int]
