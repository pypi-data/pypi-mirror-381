...
class Channel(_message.Message):
    __slots__ = ('name', 'uid', 'create_time', 'update_time', 'provider', 'pubsub_topic', 'state', 'activation_token', 'crypto_key_name', 'satisfies_pzs', 'labels')
