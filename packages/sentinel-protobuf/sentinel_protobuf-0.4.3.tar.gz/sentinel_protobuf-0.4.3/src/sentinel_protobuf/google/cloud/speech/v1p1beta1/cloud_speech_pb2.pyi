...
from google.cloud.speech.v1p1beta1 import resource_pb2 as _resource_pb2
...
class RecognitionMetadata(_message.Message):
    __slots__ = ('interaction_type', 'industry_naics_code_of_audio', 'microphone_distance', 'original_media_type', 'recording_device_type', 'recording_device_name', 'original_mime_type', 'obfuscated_id', 'audio_topic')
    ...
    OBFUSCATED_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, interaction_type: _Optional[_Union[RecognitionMetadata.InteractionType, str]]=..., industry_naics_code_of_audio: _Optional[int]=..., microphone_distance: _Optional[_Union[RecognitionMetadata.MicrophoneDistance, str]]=..., original_media_type: _Optional[_Union[RecognitionMetadata.OriginalMediaType, str]]=..., recording_device_type: _Optional[_Union[RecognitionMetadata.RecordingDeviceType, str]]=..., recording_device_name: _Optional[str]=..., original_mime_type: _Optional[str]=..., obfuscated_id: _Optional[int]=..., audio_topic: _Optional[str]=...) -> None:
        ...
...
class RecognizeResponse(_message.Message):
    __slots__ = ('results', 'total_billed_time', 'speech_adaptation_info', 'request_id', 'using_legacy_models')
    RESULTS_FIELD_NUMBER: _ClassVar[int]
    TOTAL_BILLED_TIME_FIELD_NUMBER: _ClassVar[int]
    SPEECH_ADAPTATION_INFO_FIELD_NUMBER: _ClassVar[int]
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    USING_LEGACY_MODELS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, results: _Optional[_Iterable[_Union[SpeechRecognitionResult, _Mapping]]]=..., total_billed_time: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., speech_adaptation_info: _Optional[_Union[SpeechAdaptationInfo, _Mapping]]=..., request_id: _Optional[int]=..., using_legacy_models: bool=...) -> None:
        ...
...
class LongRunningRecognizeMetadata(_message.Message):
    __slots__ = ('progress_percent', 'start_time', 'last_update_time', 'uri', 'output_config')
    ...
    def __init__(self, progress_percent: _Optional[int]=..., start_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., last_update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., uri: _Optional[str]=..., output_config: _Optional[_Union[TranscriptOutputConfig, _Mapping]]=...) -> None:
        ...
