...
from google.cloud.geminidataanalytics.v1alpha import context_pb2 as _context_pb2
from google.cloud.geminidataanalytics.v1alpha import conversation_pb2 as _conversation_pb2
...
class SystemMessage(_message.Message):
    __slots__ = ('text', 'schema', 'data', 'analysis', 'chart', 'error', 'example_queries', 'group_id')
    TEXT_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, text: _Optional[_Union[TextMessage, _Mapping]]=..., schema: _Optional[_Union[SchemaMessage, _Mapping]]=..., data: _Optional[_Union[DataMessage, _Mapping]]=..., analysis: _Optional[_Union[AnalysisMessage, _Mapping]]=..., chart: _Optional[_Union[ChartMessage, _Mapping]]=..., error: _Optional[_Union[ErrorMessage, _Mapping]]=..., example_queries: _Optional[_Union[ExampleQueries, _Mapping]]=..., group_id: _Optional[int]=...) -> None:
        ...

class TextMessage(_message.Message):
    __slots__ = ('parts', 'text_type')

    class TextType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        TEXT_TYPE_UNSPECIFIED: _ClassVar[TextMessage.TextType]
        FINAL_RESPONSE: _ClassVar[TextMessage.TextType]
        THOUGHT: _ClassVar[TextMessage.TextType]
    TEXT_TYPE_UNSPECIFIED: TextMessage.TextType
    FINAL_RESPONSE: TextMessage.TextType
    THOUGHT: TextMessage.TextType
    PARTS_FIELD_NUMBER: _ClassVar[int]
    TEXT_TYPE_FIELD_NUMBER: _ClassVar[int]
    parts: _containers.RepeatedScalarFieldContainer[str]
    text_type: TextMessage.TextType

    def __init__(self, parts: _Optional[_Iterable[str]]=..., text_type: _Optional[_Union[TextMessage.TextType, str]]=...) -> None:
        ...
...
class DataQuery(_message.Message):
    __slots__ = ('looker', 'question', 'name', 'datasources')
    ...
    def __init__(self, looker: _Optional[_Union[LookerQuery, _Mapping]]=..., question: _Optional[str]=..., name: _Optional[str]=..., datasources: _Optional[_Iterable[_Union[_datasource_pb2.Datasource, _Mapping]]]=...) -> None:
        ...
...
class ExampleQueries(_message.Message):
    __slots__ = ('example_queries',)
    EXAMPLE_QUERIES_FIELD_NUMBER: _ClassVar[int]
    example_queries: _containers.RepeatedCompositeFieldContainer[_context_pb2.ExampleQuery]

    def __init__(self, example_queries: _Optional[_Iterable[_Union[_context_pb2.ExampleQuery, _Mapping]]]=...) -> None:
        ...
