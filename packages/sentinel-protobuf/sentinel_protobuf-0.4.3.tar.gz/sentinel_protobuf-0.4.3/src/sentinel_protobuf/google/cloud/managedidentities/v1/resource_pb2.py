...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DOMAIN'].fields_by_name['name']._serialized_options = b'\xe0A\x02'
    ...
    _globals['_TRUST'].fields_by_name['target_domain_name']._loaded_options = None
    _globals['_TRUST'].fields_by_name['target_domain_name']._serialized_options = b'\xe0A\x02'
    _globals['_TRUST'].fields_by_name['trust_type']._loaded_options = None
    _globals['_TRUST'].fields_by_name['trust_type']._serialized_options = b'\xe0A\x02'
    _globals['_TRUST'].fields_by_name['trust_direction']._loaded_options = None
    _globals['_TRUST'].fields_by_name['trust_direction']._serialized_options = b'\xe0A\x02'
    _globals['_TRUST'].fields_by_name['selective_authentication']._loaded_options = None
    _globals['_TRUST'].fields_by_name['selective_authentication']._serialized_options = b'\xe0A\x01'
    _globals['_TRUST'].fields_by_name['target_dns_ip_addresses']._loaded_options = None
    _globals['_TRUST'].fields_by_name['target_dns_ip_addresses']._serialized_options = b'\xe0A\x02'
    _globals['_TRUST'].fields_by_name['trust_handshake_secret']._loaded_options = None
    _globals['_TRUST'].fields_by_name['trust_handshake_secret']._serialized_options = b'\xe0A\x02'
    ...
    _globals['_DOMAIN']._serialized_start = 181
    _globals['_DOMAIN']._serialized_end = 979
    _globals['_DOMAIN_LABELSENTRY']._serialized_start = 684
    _globals['_DOMAIN_LABELSENTRY']._serialized_end = 729
    _globals['_DOMAIN_STATE']._serialized_start = 732
    _globals['_DOMAIN_STATE']._serialized_end = 875
    _globals['_TRUST']._serialized_start = 982
    _globals['_TRUST']._serialized_end = 1847
    _globals['_TRUST_STATE']._serialized_start = 1578
    _globals['_TRUST_STATE']._serialized_end = 1683
    _globals['_TRUST_TRUSTTYPE']._serialized_start = 1685
    _globals['_TRUST_TRUSTTYPE']._serialized_end = 1750
    _globals['_TRUST_TRUSTDIRECTION']._serialized_start = 1752
    _globals['_TRUST_TRUSTDIRECTION']._serialized_end = 1847