...
class UserEvent(_message.Message):
    __slots__ = ('event_type', 'user_pseudo_id', 'engine', 'data_store', 'event_time', 'user_info', 'direct_user_request', 'session_id', 'page_info', 'attribution_token', 'filter', 'documents', 'panel', 'search_info', 'completion_info', 'transaction_info', 'tag_ids', 'promotion_ids', 'attributes', 'media_info', 'panels')
