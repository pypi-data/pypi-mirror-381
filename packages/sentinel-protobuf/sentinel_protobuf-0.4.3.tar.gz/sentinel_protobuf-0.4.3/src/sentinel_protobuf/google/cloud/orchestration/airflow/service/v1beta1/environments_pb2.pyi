...
from google.cloud.orchestration.airflow.service.v1beta1 import operations_pb2 as _operations_pb2
...
class RestartWebServerRequest(_message.Message):
    __slots__ = ('name',)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class EnvironmentConfig(_message.Message):
    __slots__ = ('gke_cluster', 'dag_gcs_prefix', 'node_count', 'software_config', 'node_config', 'private_environment_config', 'web_server_network_access_control', 'database_config', 'web_server_config', 'airflow_uri', 'airflow_byoid_uri', 'encryption_config', 'maintenance_window', 'workloads_config', 'environment_size', 'master_authorized_networks_config', 'recovery_config', 'data_retention_config', 'resilience_mode')
    ...
    def __init__(self, gke_cluster: _Optional[str]=..., dag_gcs_prefix: _Optional[str]=..., node_count: _Optional[int]=..., software_config: _Optional[_Union[SoftwareConfig, _Mapping]]=..., node_config: _Optional[_Union[NodeConfig, _Mapping]]=..., private_environment_config: _Optional[_Union[PrivateEnvironmentConfig, _Mapping]]=..., web_server_network_access_control: _Optional[_Union[WebServerNetworkAccessControl, _Mapping]]=..., database_config: _Optional[_Union[DatabaseConfig, _Mapping]]=..., web_server_config: _Optional[_Union[WebServerConfig, _Mapping]]=..., airflow_uri: _Optional[str]=..., airflow_byoid_uri: _Optional[str]=..., encryption_config: _Optional[_Union[EncryptionConfig, _Mapping]]=..., maintenance_window: _Optional[_Union[MaintenanceWindow, _Mapping]]=..., workloads_config: _Optional[_Union[WorkloadsConfig, _Mapping]]=..., environment_size: _Optional[_Union[EnvironmentConfig.EnvironmentSize, str]]=..., master_authorized_networks_config: _Optional[_Union[MasterAuthorizedNetworksConfig, _Mapping]]=..., recovery_config: _Optional[_Union[RecoveryConfig, _Mapping]]=..., data_retention_config: _Optional[_Union[DataRetentionConfig, _Mapping]]=..., resilience_mode: _Optional[_Union[EnvironmentConfig.ResilienceMode, str]]=...) -> None:
        ...
...
class IPAllocationPolicy(_message.Message):
    __slots__ = ('use_ip_aliases', 'cluster_secondary_range_name', 'services_secondary_range_name', 'cluster_ipv4_cidr_block', 'services_ipv4_cidr_block')
    ...
    def __init__(self, use_ip_aliases: bool=..., cluster_secondary_range_name: _Optional[str]=..., services_secondary_range_name: _Optional[str]=..., cluster_ipv4_cidr_block: _Optional[str]=..., services_ipv4_cidr_block: _Optional[str]=...) -> None:
        ...

class NodeConfig(_message.Message):
    __slots__ = ('location', 'machine_type', 'network', 'subnetwork', 'disk_size_gb', 'oauth_scopes', 'service_account', 'tags', 'ip_allocation_policy', 'max_pods_per_node', 'enable_ip_masq_agent', 'composer_network_attachment', 'composer_internal_ipv4_cidr_block')
...
class DataRetentionConfig(_message.Message):
    __slots__ = ('airflow_database_retention_days', 'task_logs_retention_config', 'airflow_metadata_retention_config')
    AIRFLOW_DATABASE_RETENTION_DAYS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, airflow_database_retention_days: _Optional[int]=..., task_logs_retention_config: _Optional[_Union[TaskLogsRetentionConfig, _Mapping]]=..., airflow_metadata_retention_config: _Optional[_Union[AirflowMetadataRetentionPolicyConfig, _Mapping]]=...) -> None:
        ...
