...
class FactChunk(_message.Message):
    __slots__ = ('chunk_text', 'source', 'index', 'source_metadata', 'uri', 'title', 'domain')
    ...
    def __init__(self, chunk_text: _Optional[str]=..., source: _Optional[str]=..., index: _Optional[int]=..., source_metadata: _Optional[_Mapping[str, str]]=..., uri: _Optional[str]=..., title: _Optional[str]=..., domain: _Optional[str]=...) -> None:
        ...