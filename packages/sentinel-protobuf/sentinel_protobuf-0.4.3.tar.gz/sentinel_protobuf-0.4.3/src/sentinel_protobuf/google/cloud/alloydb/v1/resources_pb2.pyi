...
from google.cloud.alloydb.v1 import csql_resources_pb2 as _csql_resources_pb2
...
class Instance(_message.Message):
    ...
    class ObservabilityInstanceConfig(_message.Message):
        __slots__ = ('enabled', 'preserve_comments', 'track_wait_events', 'track_wait_event_types', 'max_query_string_length', 'record_application_tags', 'query_plans_per_minute', 'track_active_queries')
        ENABLED_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, enabled: bool=..., preserve_comments: bool=..., track_wait_events: bool=..., track_wait_event_types: bool=..., max_query_string_length: _Optional[int]=..., record_application_tags: bool=..., query_plans_per_minute: _Optional[int]=..., track_active_queries: bool=...) -> None:
            ...
...
class Backup(_message.Message):
    __slots__ = ('name', 'display_name', 'uid', 'create_time', 'update_time', 'delete_time', 'create_completion_time', 'labels', 'state', 'type', 'description', 'cluster_uid', 'cluster_name', 'reconciling', 'encryption_config', 'encryption_info', 'etag', 'annotations', 'size_bytes', 'expiry_time', 'expiry_quantity', 'satisfies_pzs', 'database_version', 'tags')
...
class Database(_message.Message):
    __slots__ = ('name', 'charset', 'collation', 'character_type', 'database_template', 'is_template_database')
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str]=..., charset: _Optional[str]=..., collation: _Optional[str]=..., character_type: _Optional[str]=..., database_template: _Optional[str]=..., is_template_database: bool=...) -> None:
        ...