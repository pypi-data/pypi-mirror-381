...
class ClassificationEvaluationMetrics(_message.Message):
    __slots__ = ('au_prc', 'au_roc', 'log_loss', 'confidence_metrics_entry', 'confusion_matrix', 'annotation_spec_id')
    ...
    def __init__(self, au_prc: _Optional[float]=..., au_roc: _Optional[float]=..., log_loss: _Optional[float]=..., confidence_metrics_entry: _Optional[_Iterable[_Union[ClassificationEvaluationMetrics.ConfidenceMetricsEntry, _Mapping]]]=..., confusion_matrix: _Optional[_Union[ClassificationEvaluationMetrics.ConfusionMatrix, _Mapping]]=..., annotation_spec_id: _Optional[_Iterable[str]]=...) -> None:
        ...