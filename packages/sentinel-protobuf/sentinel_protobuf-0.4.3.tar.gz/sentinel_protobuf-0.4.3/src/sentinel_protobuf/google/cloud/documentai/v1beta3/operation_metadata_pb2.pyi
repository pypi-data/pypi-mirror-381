...
class CommonOperationMetadata(_message.Message):
    __slots__ = ('state', 'state_message', 'resource', 'create_time', 'update_time')
    ...
    def __init__(self, state: _Optional[_Union[CommonOperationMetadata.State, str]]=..., state_message: _Optional[str]=..., resource: _Optional[str]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...