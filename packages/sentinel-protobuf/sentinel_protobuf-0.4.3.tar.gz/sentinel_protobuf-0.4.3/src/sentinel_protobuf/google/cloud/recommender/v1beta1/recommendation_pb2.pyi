...
class CostProjection(_message.Message):
    __slots__ = ('cost', 'duration')
    COST_FIELD_NUMBER: _ClassVar[int]
    DURATION_FIELD_NUMBER: _ClassVar[int]
    cost: _money_pb2.Money
    duration: _duration_pb2.Duration

    def __init__(self, cost: _Optional[_Union[_money_pb2.Money, _Mapping]]=..., duration: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=...) -> None:
        ...
...
class Impact(_message.Message):
    __slots__ = ('category', 'cost_projection', 'security_projection', 'sustainability_projection')
    ...
    def __init__(self, category: _Optional[_Union[Impact.Category, str]]=..., cost_projection: _Optional[_Union[CostProjection, _Mapping]]=..., security_projection: _Optional[_Union[SecurityProjection, _Mapping]]=..., sustainability_projection: _Optional[_Union[SustainabilityProjection, _Mapping]]=...) -> None:
        ...
...
class RecommenderType(_message.Message):
    __slots__ = ('name',)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
