...
class EnvoyHeaders(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    ENVOY_HEADERS_UNSPECIFIED: _ClassVar[EnvoyHeaders]
    NONE: _ClassVar[EnvoyHeaders]
    DEBUG_HEADERS: _ClassVar[EnvoyHeaders]
ENVOY_HEADERS_UNSPECIFIED: EnvoyHeaders
NONE: EnvoyHeaders
DEBUG_HEADERS: EnvoyHeaders
