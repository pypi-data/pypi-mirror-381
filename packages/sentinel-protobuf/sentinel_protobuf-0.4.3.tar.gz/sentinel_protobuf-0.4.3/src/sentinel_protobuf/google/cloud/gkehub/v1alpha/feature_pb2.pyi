...
from google.cloud.gkehub.v1alpha.cloudauditlogging import cloudauditlogging_pb2 as _cloudauditlogging_pb2
from google.cloud.gkehub.v1alpha.configmanagement import configmanagement_pb2 as _configmanagement_pb2
from google.cloud.gkehub.v1alpha.metering import metering_pb2 as _metering_pb2
from google.cloud.gkehub.v1alpha.multiclusteringress import multiclusteringress_pb2 as _multiclusteringress_pb2
from google.cloud.gkehub.v1alpha.servicemesh import servicemesh_pb2 as _servicemesh_pb2
...
class CommonFeatureSpec(_message.Message):
    __slots__ = ('multiclusteringress', 'cloudauditlogging')
    MULTICLUSTERINGRESS_FIELD_NUMBER: _ClassVar[int]
    CLOUDAUDITLOGGING_FIELD_NUMBER: _ClassVar[int]
    multiclusteringress: _multiclusteringress_pb2.FeatureSpec
    cloudauditlogging: _cloudauditlogging_pb2.FeatureSpec

    def __init__(self, multiclusteringress: _Optional[_Union[_multiclusteringress_pb2.FeatureSpec, _Mapping]]=..., cloudauditlogging: _Optional[_Union[_cloudauditlogging_pb2.FeatureSpec, _Mapping]]=...) -> None:
        ...

class CommonFeatureState(_message.Message):
    __slots__ = ('servicemesh', 'state')
    SERVICEMESH_FIELD_NUMBER: _ClassVar[int]
    STATE_FIELD_NUMBER: _ClassVar[int]
    servicemesh: _servicemesh_pb2.FeatureState
    state: FeatureState

    def __init__(self, servicemesh: _Optional[_Union[_servicemesh_pb2.FeatureState, _Mapping]]=..., state: _Optional[_Union[FeatureState, _Mapping]]=...) -> None:
        ...

class MembershipFeatureSpec(_message.Message):
    __slots__ = ('configmanagement',)
    CONFIGMANAGEMENT_FIELD_NUMBER: _ClassVar[int]
    configmanagement: _configmanagement_pb2.MembershipSpec

    def __init__(self, configmanagement: _Optional[_Union[_configmanagement_pb2.MembershipSpec, _Mapping]]=...) -> None:
        ...

class MembershipFeatureState(_message.Message):
    __slots__ = ('servicemesh', 'metering', 'configmanagement', 'state')
    SERVICEMESH_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, servicemesh: _Optional[_Union[_servicemesh_pb2.MembershipState, _Mapping]]=..., metering: _Optional[_Union[_metering_pb2.MembershipState, _Mapping]]=..., configmanagement: _Optional[_Union[_configmanagement_pb2.MembershipState, _Mapping]]=..., state: _Optional[_Union[FeatureState, _Mapping]]=...) -> None:
        ...