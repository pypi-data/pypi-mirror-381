...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/securitycenter/v1/security_marks.proto')
_sym_db = _symbol_database.Default()
from .....google.api import resource_pb2 as google_dot_api_dot_resource__pb2
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n3google/cloud/securitycenter/v1/security_marks.proto\x12\x1egoogle.cloud.securitycenter.v1\x1a\x19google/api/resource.proto"\xd5\x04\n\rSecurityMarks\x12\x0c\n\x04name\x18\x01 \x01(\t\x12G\n\x05marks\x18\x02 \x03(\x0b28.google.cloud.securitycenter.v1.SecurityMarks.MarksEntry\x12\x16\n\x0ecanonical_name\x18\x03 \x01(\t\x1a,\n\nMarksEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t:\x028\x01:\xa6\x03\xeaA\xa2\x03\n+securitycenter.googleapis.com/SecurityMarks\x129organizations/{organization}/assets/{asset}/securityMarks\x12Norganizations/{organization}/sources/{source}/findings/{finding}/securityMarks\x12-folders/{folder}/assets/{asset}/securityMarks\x12/projects/{project}/assets/{asset}/securityMarks\x12Bfolders/{folder}/sources/{source}/findings/{finding}/securityMarks\x12Dprojects/{project}/sources/{source}/findings/{finding}/securityMarksB\xd8\x01\n"com.google.cloud.securitycenter.v1P\x01ZJcloud.google.com/go/securitycenter/apiv1/securitycenterpb;securitycenterpb\xaa\x02\x1eGoogle.Cloud.SecurityCenter.V1\xca\x02\x1eGoogle\\Cloud\\SecurityCenter\\V1\xea\x02!Google::Cloud::SecurityCenter::V1b\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.cloud.securitycenter.v1.security_marks_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SECURITYMARKS']._serialized_end = 712
