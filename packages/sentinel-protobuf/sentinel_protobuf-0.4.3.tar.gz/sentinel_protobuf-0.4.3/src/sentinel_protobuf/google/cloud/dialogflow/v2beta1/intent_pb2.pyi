...
class Intent(_message.Message):
    __slots__ = ('name', 'display_name', 'webhook_state', 'priority', 'is_fallback', 'ml_enabled', 'ml_disabled', 'live_agent_handoff', 'end_interaction', 'input_context_names', 'events', 'training_phrases', 'action', 'output_contexts', 'reset_contexts', 'parameters', 'messages', 'default_response_platforms', 'root_followup_intent_name', 'parent_followup_intent_name', 'followup_intent_info')
    ...
    class Message(_message.Message):
        __slots__ = ('text', 'image', 'quick_replies', 'card', 'payload', 'simple_responses', 'basic_card', 'suggestions', 'link_out_suggestion', 'list_select', 'carousel_select', 'telephony_play_audio', 'telephony_synthesize_speech', 'telephony_transfer_call', 'rbm_text', 'rbm_standalone_rich_card', 'rbm_carousel_rich_card', 'browse_carousel_card', 'table_card', 'media_content', 'platform')
        ...
        class Platform(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            TELEPHONY: _ClassVar[Intent.Message.Platform]
        ...
        TELEPHONY: Intent.Message.Platform
        ...
        class TelephonyPlayAudio(_message.Message):
            __slots__ = ('audio_uri',)
            AUDIO_URI_FIELD_NUMBER: _ClassVar[int]
            audio_uri: str

            def __init__(self, audio_uri: _Optional[str]=...) -> None:
                ...

        class TelephonySynthesizeSpeech(_message.Message):
            __slots__ = ('text', 'ssml')
            TEXT_FIELD_NUMBER: _ClassVar[int]
            SSML_FIELD_NUMBER: _ClassVar[int]
            text: str
            ...
            def __init__(self, text: _Optional[str]=..., ssml: _Optional[str]=...) -> None:
                ...
        ...
        class RbmText(_message.Message):
            __slots__ = ('text', 'rbm_suggestion')
            TEXT_FIELD_NUMBER: _ClassVar[int]
            RBM_SUGGESTION_FIELD_NUMBER: _ClassVar[int]
            text: str
            rbm_suggestion: _containers.RepeatedCompositeFieldContainer[Intent.Message.RbmSuggestion]

            def __init__(self, text: _Optional[str]=..., rbm_suggestion: _Optional[_Iterable[_Union[Intent.Message.RbmSuggestion, _Mapping]]]=...) -> None:
                ...

        class RbmCarouselCard(_message.Message):
            __slots__ = ('card_width', 'card_contents')

            class CardWidth(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                CARD_WIDTH_UNSPECIFIED: _ClassVar[Intent.Message.RbmCarouselCard.CardWidth]
                SMALL: _ClassVar[Intent.Message.RbmCarouselCard.CardWidth]
                MEDIUM: _ClassVar[Intent.Message.RbmCarouselCard.CardWidth]
            CARD_WIDTH_UNSPECIFIED: Intent.Message.RbmCarouselCard.CardWidth
            SMALL: Intent.Message.RbmCarouselCard.CardWidth
            MEDIUM: Intent.Message.RbmCarouselCard.CardWidth
            CARD_WIDTH_FIELD_NUMBER: _ClassVar[int]
            CARD_CONTENTS_FIELD_NUMBER: _ClassVar[int]
            card_width: Intent.Message.RbmCarouselCard.CardWidth
            card_contents: _containers.RepeatedCompositeFieldContainer[Intent.Message.RbmCardContent]

            def __init__(self, card_width: _Optional[_Union[Intent.Message.RbmCarouselCard.CardWidth, str]]=..., card_contents: _Optional[_Iterable[_Union[Intent.Message.RbmCardContent, _Mapping]]]=...) -> None:
                ...

        class RbmStandaloneCard(_message.Message):
            __slots__ = ('card_orientation', 'thumbnail_image_alignment', 'card_content')

            class CardOrientation(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                CARD_ORIENTATION_UNSPECIFIED: _ClassVar[Intent.Message.RbmStandaloneCard.CardOrientation]
                HORIZONTAL: _ClassVar[Intent.Message.RbmStandaloneCard.CardOrientation]
                VERTICAL: _ClassVar[Intent.Message.RbmStandaloneCard.CardOrientation]
            CARD_ORIENTATION_UNSPECIFIED: Intent.Message.RbmStandaloneCard.CardOrientation
            HORIZONTAL: Intent.Message.RbmStandaloneCard.CardOrientation
            VERTICAL: Intent.Message.RbmStandaloneCard.CardOrientation

            class ThumbnailImageAlignment(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                __slots__ = ()
                THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED: _ClassVar[Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment]
                LEFT: _ClassVar[Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment]
                RIGHT: _ClassVar[Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment]
            THUMBNAIL_IMAGE_ALIGNMENT_UNSPECIFIED: Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment
            LEFT: Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment
            RIGHT: Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment
            CARD_ORIENTATION_FIELD_NUMBER: _ClassVar[int]
            THUMBNAIL_IMAGE_ALIGNMENT_FIELD_NUMBER: _ClassVar[int]
            CARD_CONTENT_FIELD_NUMBER: _ClassVar[int]
            card_orientation: Intent.Message.RbmStandaloneCard.CardOrientation
            thumbnail_image_alignment: Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment
            card_content: Intent.Message.RbmCardContent

            def __init__(self, card_orientation: _Optional[_Union[Intent.Message.RbmStandaloneCard.CardOrientation, str]]=..., thumbnail_image_alignment: _Optional[_Union[Intent.Message.RbmStandaloneCard.ThumbnailImageAlignment, str]]=..., card_content: _Optional[_Union[Intent.Message.RbmCardContent, _Mapping]]=...) -> None:
                ...

        class RbmCardContent(_message.Message):
            __slots__ = ('title', 'description', 'media', 'suggestions')

            class RbmMedia(_message.Message):
                __slots__ = ('file_uri', 'thumbnail_uri', 'height')

                class Height(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                    __slots__ = ()
                    HEIGHT_UNSPECIFIED: _ClassVar[Intent.Message.RbmCardContent.RbmMedia.Height]
                    SHORT: _ClassVar[Intent.Message.RbmCardContent.RbmMedia.Height]
                    MEDIUM: _ClassVar[Intent.Message.RbmCardContent.RbmMedia.Height]
                    TALL: _ClassVar[Intent.Message.RbmCardContent.RbmMedia.Height]
                HEIGHT_UNSPECIFIED: Intent.Message.RbmCardContent.RbmMedia.Height
                SHORT: Intent.Message.RbmCardContent.RbmMedia.Height
                MEDIUM: Intent.Message.RbmCardContent.RbmMedia.Height
                TALL: Intent.Message.RbmCardContent.RbmMedia.Height
                ...
                def __init__(self, file_uri: _Optional[str]=..., thumbnail_uri: _Optional[str]=..., height: _Optional[_Union[Intent.Message.RbmCardContent.RbmMedia.Height, str]]=...) -> None:
                    ...
            TITLE_FIELD_NUMBER: _ClassVar[int]
            DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
            ...
            title: str
            description: str
            media: Intent.Message.RbmCardContent.RbmMedia
            suggestions: _containers.RepeatedCompositeFieldContainer[Intent.Message.RbmSuggestion]

            def __init__(self, title: _Optional[str]=..., description: _Optional[str]=..., media: _Optional[_Union[Intent.Message.RbmCardContent.RbmMedia, _Mapping]]=..., suggestions: _Optional[_Iterable[_Union[Intent.Message.RbmSuggestion, _Mapping]]]=...) -> None:
                ...

        class RbmSuggestion(_message.Message):
            __slots__ = ('reply', 'action')
            REPLY_FIELD_NUMBER: _ClassVar[int]
            ACTION_FIELD_NUMBER: _ClassVar[int]
            reply: Intent.Message.RbmSuggestedReply
            action: Intent.Message.RbmSuggestedAction

            def __init__(self, reply: _Optional[_Union[Intent.Message.RbmSuggestedReply, _Mapping]]=..., action: _Optional[_Union[Intent.Message.RbmSuggestedAction, _Mapping]]=...) -> None:
                ...

        class RbmSuggestedReply(_message.Message):
            __slots__ = ('text', 'postback_data')
            TEXT_FIELD_NUMBER: _ClassVar[int]
            POSTBACK_DATA_FIELD_NUMBER: _ClassVar[int]
            text: str
            postback_data: str

            def __init__(self, text: _Optional[str]=..., postback_data: _Optional[str]=...) -> None:
                ...

        class RbmSuggestedAction(_message.Message):
            __slots__ = ('text', 'postback_data', 'dial', 'open_url', 'share_location')

            class RbmSuggestedActionDial(_message.Message):
                __slots__ = ('phone_number',)
                PHONE_NUMBER_FIELD_NUMBER: _ClassVar[int]
                phone_number: str
            ...
            class RbmSuggestedActionOpenUri(_message.Message):
                __slots__ = ('uri',)
                URI_FIELD_NUMBER: _ClassVar[int]
                uri: str
            ...
            class RbmSuggestedActionShareLocation(_message.Message):
                __slots__ = ()
            ...
            open_url: Intent.Message.RbmSuggestedAction.RbmSuggestedActionOpenUri
            share_location: Intent.Message.RbmSuggestedAction.RbmSuggestedActionShareLocation

            def __init__(self, text: _Optional[str]=..., postback_data: _Optional[str]=..., dial: _Optional[_Union[Intent.Message.RbmSuggestedAction.RbmSuggestedActionDial, _Mapping]]=..., open_url: _Optional[_Union[Intent.Message.RbmSuggestedAction.RbmSuggestedActionOpenUri, _Mapping]]=..., share_location: _Optional[_Union[Intent.Message.RbmSuggestedAction.RbmSuggestedActionShareLocation, _Mapping]]=...) -> None:
                ...
        ...
        TELEPHONY_PLAY_AUDIO_FIELD_NUMBER: _ClassVar[int]
        TELEPHONY_SYNTHESIZE_SPEECH_FIELD_NUMBER: _ClassVar[int]
        TELEPHONY_TRANSFER_CALL_FIELD_NUMBER: _ClassVar[int]
        RBM_TEXT_FIELD_NUMBER: _ClassVar[int]
        RBM_STANDALONE_RICH_CARD_FIELD_NUMBER: _ClassVar[int]
        RBM_CAROUSEL_RICH_CARD_FIELD_NUMBER: _ClassVar[int]
        ...
        telephony_play_audio: Intent.Message.TelephonyPlayAudio
        telephony_synthesize_speech: Intent.Message.TelephonySynthesizeSpeech
        telephony_transfer_call: Intent.Message.TelephonyTransferCall
        rbm_text: Intent.Message.RbmText
        rbm_standalone_rich_card: Intent.Message.RbmStandaloneCard
        rbm_carousel_rich_card: Intent.Message.RbmCarouselCard
        ...
        def __init__(self, text: _Optional[_Union[Intent.Message.Text, _Mapping]]=..., image: _Optional[_Union[Intent.Message.Image, _Mapping]]=..., quick_replies: _Optional[_Union[Intent.Message.QuickReplies, _Mapping]]=..., card: _Optional[_Union[Intent.Message.Card, _Mapping]]=..., payload: _Optional[_Union[_struct_pb2.Struct, _Mapping]]=..., simple_responses: _Optional[_Union[Intent.Message.SimpleResponses, _Mapping]]=..., basic_card: _Optional[_Union[Intent.Message.BasicCard, _Mapping]]=..., suggestions: _Optional[_Union[Intent.Message.Suggestions, _Mapping]]=..., link_out_suggestion: _Optional[_Union[Intent.Message.LinkOutSuggestion, _Mapping]]=..., list_select: _Optional[_Union[Intent.Message.ListSelect, _Mapping]]=..., carousel_select: _Optional[_Union[Intent.Message.CarouselSelect, _Mapping]]=..., telephony_play_audio: _Optional[_Union[Intent.Message.TelephonyPlayAudio, _Mapping]]=..., telephony_synthesize_speech: _Optional[_Union[Intent.Message.TelephonySynthesizeSpeech, _Mapping]]=..., telephony_transfer_call: _Optional[_Union[Intent.Message.TelephonyTransferCall, _Mapping]]=..., rbm_text: _Optional[_Union[Intent.Message.RbmText, _Mapping]]=..., rbm_standalone_rich_card: _Optional[_Union[Intent.Message.RbmStandaloneCard, _Mapping]]=..., rbm_carousel_rich_card: _Optional[_Union[Intent.Message.RbmCarouselCard, _Mapping]]=..., browse_carousel_card: _Optional[_Union[Intent.Message.BrowseCarouselCard, _Mapping]]=..., table_card: _Optional[_Union[Intent.Message.TableCard, _Mapping]]=..., media_content: _Optional[_Union[Intent.Message.MediaContent, _Mapping]]=..., platform: _Optional[_Union[Intent.Message.Platform, str]]=...) -> None:
            ...
