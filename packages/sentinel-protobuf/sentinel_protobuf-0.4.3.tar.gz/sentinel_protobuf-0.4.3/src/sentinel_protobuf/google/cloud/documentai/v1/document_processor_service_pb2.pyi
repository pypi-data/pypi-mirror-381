...
from google.cloud.documentai.v1 import document_io_pb2 as _document_io_pb2
...
from google.cloud.documentai.v1 import operation_metadata_pb2 as _operation_metadata_pb2
from google.cloud.documentai.v1 import processor_pb2 as _processor_pb2
from google.cloud.documentai.v1 import processor_type_pb2 as _processor_type_pb2
...
class ProcessOptions(_message.Message):
    ...
    class LayoutConfig(_message.Message):
        __slots__ = ('chunking_config', 'return_images', 'return_bounding_boxes')
        ...
        def __init__(self, chunking_config: _Optional[_Union[ProcessOptions.LayoutConfig.ChunkingConfig, _Mapping]]=..., return_images: bool=..., return_bounding_boxes: bool=...) -> None:
            ...
...
class ProcessRequest(_message.Message):
    __slots__ = ('inline_document', 'raw_document', 'gcs_document', 'name', 'skip_human_review', 'field_mask', 'process_options', 'labels', 'imageless_mode')
...
class ProcessResponse(_message.Message):
    __slots__ = ('document', 'human_review_status')
    DOCUMENT_FIELD_NUMBER: _ClassVar[int]
    HUMAN_REVIEW_STATUS_FIELD_NUMBER: _ClassVar[int]
    document: _document_pb2.Document
    human_review_status: HumanReviewStatus

    def __init__(self, document: _Optional[_Union[_document_pb2.Document, _Mapping]]=..., human_review_status: _Optional[_Union[HumanReviewStatus, _Mapping]]=...) -> None:
        ...

class BatchProcessRequest(_message.Message):
    __slots__ = ('name', 'input_documents', 'document_output_config', 'skip_human_review', 'process_options', 'labels')
...
class BatchProcessMetadata(_message.Message):
    ...
    class IndividualProcessStatus(_message.Message):
        __slots__ = ('input_gcs_source', 'status', 'output_gcs_destination', 'human_review_status')
        ...
        def __init__(self, input_gcs_source: _Optional[str]=..., status: _Optional[_Union[_status_pb2.Status, _Mapping]]=..., output_gcs_destination: _Optional[str]=..., human_review_status: _Optional[_Union[HumanReviewStatus, _Mapping]]=...) -> None:
            ...
    STATE_FIELD_NUMBER: _ClassVar[int]
    STATE_MESSAGE_FIELD_NUMBER: _ClassVar[int]
...
class ReviewDocumentRequest(_message.Message):
    __slots__ = ('inline_document', 'human_review_config', 'enable_schema_validation', 'priority', 'document_schema')
    ...
    def __init__(self, inline_document: _Optional[_Union[_document_pb2.Document, _Mapping]]=..., human_review_config: _Optional[str]=..., enable_schema_validation: bool=..., priority: _Optional[_Union[ReviewDocumentRequest.Priority, str]]=..., document_schema: _Optional[_Union[_document_schema_pb2.DocumentSchema, _Mapping]]=...) -> None:
        ...
...
class ReviewDocumentOperationMetadata(_message.Message):
    __slots__ = ('common_metadata', 'question_id')
    COMMON_METADATA_FIELD_NUMBER: _ClassVar[int]
    QUESTION_ID_FIELD_NUMBER: _ClassVar[int]
    common_metadata: _operation_metadata_pb2.CommonOperationMetadata
    question_id: str

    def __init__(self, common_metadata: _Optional[_Union[_operation_metadata_pb2.CommonOperationMetadata, _Mapping]]=..., question_id: _Optional[str]=...) -> None:
        ...
