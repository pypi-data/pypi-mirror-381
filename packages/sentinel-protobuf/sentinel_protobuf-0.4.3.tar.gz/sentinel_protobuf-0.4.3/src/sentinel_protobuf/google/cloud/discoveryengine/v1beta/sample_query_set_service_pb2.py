...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['GetSampleQuerySet']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x029\x127/v1beta/{name=projects/*/locations/*/sampleQuerySets/*}'
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['ListSampleQuerySets']._loaded_options = None
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['ListSampleQuerySets']._serialized_options = b'\xdaA\x06parent\x82\xd3\xe4\x93\x029\x127/v1beta/{parent=projects/*/locations/*}/sampleQuerySets'
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['CreateSampleQuerySet']._loaded_options = None
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['CreateSampleQuerySet']._serialized_options = b'\xdaA+parent,sample_query_set,sample_query_set_id\x82\xd3\xe4\x93\x02K"7/v1beta/{parent=projects/*/locations/*}/sampleQuerySets:\x10sample_query_set'
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['UpdateSampleQuerySet']._loaded_options = None
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['UpdateSampleQuerySet']._serialized_options = b'\xdaA\x1csample_query_set,update_mask\x82\xd3\xe4\x93\x02\\2H/v1beta/{sample_query_set.name=projects/*/locations/*/sampleQuerySets/*}:\x10sample_query_set'
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['DeleteSampleQuerySet']._loaded_options = None
    _globals['_SAMPLEQUERYSETSERVICE'].methods_by_name['DeleteSampleQuerySet']._serialized_options = b'\xdaA\x04name\x82\xd3\xe4\x93\x029*7/v1beta/{name=projects/*/locations/*/sampleQuerySets/*}'
    _globals['_GETSAMPLEQUERYSETREQUEST']._serialized_start = 345
    _globals['_GETSAMPLEQUERYSETREQUEST']._serialized_end = 440
    _globals['_LISTSAMPLEQUERYSETSREQUEST']._serialized_start = 443
    _globals['_LISTSAMPLEQUERYSETSREQUEST']._serialized_end = 575
    _globals['_LISTSAMPLEQUERYSETSRESPONSE']._serialized_start = 578
    _globals['_LISTSAMPLEQUERYSETSRESPONSE']._serialized_end = 712
    _globals['_CREATESAMPLEQUERYSETREQUEST']._serialized_start = 715
    _globals['_CREATESAMPLEQUERYSETREQUEST']._serialized_end = 927
    _globals['_UPDATESAMPLEQUERYSETREQUEST']._serialized_start = 930
    _globals['_UPDATESAMPLEQUERYSETREQUEST']._serialized_end = 1092
    _globals['_DELETESAMPLEQUERYSETREQUEST']._serialized_start = 1094
    _globals['_DELETESAMPLEQUERYSETREQUEST']._serialized_end = 1192
    _globals['_SAMPLEQUERYSETSERVICE']._serialized_start = 1195
    _globals['_SAMPLEQUERYSETSERVICE']._serialized_end = 2477