...
class DeployedModel(_message.Message):
    __slots__ = ('dedicated_resources', 'automatic_resources', 'shared_resources', 'id', 'model', 'model_version_id', 'display_name', 'create_time', 'explanation_spec', 'disable_explanations', 'service_account', 'disable_container_logging', 'enable_access_logging', 'private_endpoints', 'faster_deployment_config', 'status', 'system_labels', 'checkpoint_id', 'speculative_decoding_spec')
...
class PredictRequestResponseLoggingConfig(_message.Message):
    __slots__ = ('enabled', 'sampling_rate', 'bigquery_destination')
    ...
    def __init__(self, enabled: bool=..., sampling_rate: _Optional[float]=..., bigquery_destination: _Optional[_Union[_io_pb2.BigQueryDestination, _Mapping]]=...) -> None:
        ...
