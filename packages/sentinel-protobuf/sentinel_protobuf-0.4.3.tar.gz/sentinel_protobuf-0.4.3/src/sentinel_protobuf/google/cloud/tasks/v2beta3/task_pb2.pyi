...
class Task(_message.Message):
    __slots__ = ('name', 'app_engine_http_request', 'http_request', 'pull_message', 'schedule_time', 'create_time', 'dispatch_deadline', 'dispatch_count', 'response_count', 'first_attempt', 'last_attempt', 'view')
