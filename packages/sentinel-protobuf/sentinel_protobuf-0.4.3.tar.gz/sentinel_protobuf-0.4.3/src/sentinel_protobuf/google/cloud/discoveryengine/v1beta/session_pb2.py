...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_SESSION']._serialized_start = 234
    _globals['_SESSION']._serialized_end = 1342
    _globals['_SESSION_TURN']._serialized_start = 577
    _globals['_SESSION_TURN']._serialized_end = 932
    _globals['_SESSION_TURN_QUERYCONFIGENTRY']._serialized_start = 882
    _globals['_SESSION_TURN_QUERYCONFIGENTRY']._serialized_end = 932
    _globals['_SESSION_STATE']._serialized_start = 934
    _globals['_SESSION_STATE']._serialized_end = 981
    _globals['_QUERY']._serialized_start = 1344
