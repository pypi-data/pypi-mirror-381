...
class WorkstationConfig(_message.Message):
    __slots__ = ('name', 'display_name', 'uid', 'reconciling', 'annotations', 'labels', 'create_time', 'update_time', 'delete_time', 'etag', 'idle_timeout', 'running_timeout', 'host', 'persistent_directories', 'ephemeral_directories', 'container', 'encryption_key', 'readiness_checks', 'replica_zones', 'degraded', 'conditions', 'enable_audit_agent')

    class Host(_message.Message):
        __slots__ = ('gce_instance',)

        class GceInstance(_message.Message):
            __slots__ = ('machine_type', 'service_account', 'service_account_scopes', 'tags', 'pool_size', 'pooled_instances', 'disable_public_ip_addresses', 'enable_nested_virtualization', 'shielded_instance_config', 'confidential_instance_config', 'boot_disk_size_gb', 'accelerators')
    ...
    class EphemeralDirectory(_message.Message):
        __slots__ = ('gce_pd', 'mount_path')

        class GcePersistentDisk(_message.Message):
            __slots__ = ('disk_type', 'source_snapshot', 'source_image', 'read_only')
            DISK_TYPE_FIELD_NUMBER: _ClassVar[int]
            SOURCE_SNAPSHOT_FIELD_NUMBER: _ClassVar[int]
            ...
            def __init__(self, disk_type: _Optional[str]=..., source_snapshot: _Optional[str]=..., source_image: _Optional[str]=..., read_only: bool=...) -> None:
                ...
        GCE_PD_FIELD_NUMBER: _ClassVar[int]
        MOUNT_PATH_FIELD_NUMBER: _ClassVar[int]
        gce_pd: WorkstationConfig.EphemeralDirectory.GcePersistentDisk
        mount_path: str

        def __init__(self, gce_pd: _Optional[_Union[WorkstationConfig.EphemeralDirectory.GcePersistentDisk, _Mapping]]=..., mount_path: _Optional[str]=...) -> None:
            ...
    ...
    EPHEMERAL_DIRECTORIES_FIELD_NUMBER: _ClassVar[int]
    ...
    DEGRADED_FIELD_NUMBER: _ClassVar[int]
    CONDITIONS_FIELD_NUMBER: _ClassVar[int]
    ENABLE_AUDIT_AGENT_FIELD_NUMBER: _ClassVar[int]
    name: str
    display_name: str
    uid: str
    reconciling: bool
    ...
    ephemeral_directories: _containers.RepeatedCompositeFieldContainer[WorkstationConfig.EphemeralDirectory]
    ...
    def __init__(self, name: _Optional[str]=..., display_name: _Optional[str]=..., uid: _Optional[str]=..., reconciling: bool=..., annotations: _Optional[_Mapping[str, str]]=..., labels: _Optional[_Mapping[str, str]]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., delete_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., etag: _Optional[str]=..., idle_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., running_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., host: _Optional[_Union[WorkstationConfig.Host, _Mapping]]=..., persistent_directories: _Optional[_Iterable[_Union[WorkstationConfig.PersistentDirectory, _Mapping]]]=..., ephemeral_directories: _Optional[_Iterable[_Union[WorkstationConfig.EphemeralDirectory, _Mapping]]]=..., container: _Optional[_Union[WorkstationConfig.Container, _Mapping]]=..., encryption_key: _Optional[_Union[WorkstationConfig.CustomerEncryptionKey, _Mapping]]=..., readiness_checks: _Optional[_Iterable[_Union[WorkstationConfig.ReadinessCheck, _Mapping]]]=..., replica_zones: _Optional[_Iterable[str]]=..., degraded: bool=..., conditions: _Optional[_Iterable[_Union[_status_pb2.Status, _Mapping]]]=..., enable_audit_agent: bool=...) -> None:
        ...

class Workstation(_message.Message):
    __slots__ = ('name', 'display_name', 'uid', 'reconciling', 'annotations', 'labels', 'create_time', 'update_time', 'start_time', 'delete_time', 'etag', 'state', 'host', 'env')
    ...
    def __init__(self, name: _Optional[str]=..., display_name: _Optional[str]=..., uid: _Optional[str]=..., reconciling: bool=..., annotations: _Optional[_Mapping[str, str]]=..., labels: _Optional[_Mapping[str, str]]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., start_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., delete_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., etag: _Optional[str]=..., state: _Optional[_Union[Workstation.State, str]]=..., host: _Optional[str]=..., env: _Optional[_Mapping[str, str]]=...) -> None:
        ...
