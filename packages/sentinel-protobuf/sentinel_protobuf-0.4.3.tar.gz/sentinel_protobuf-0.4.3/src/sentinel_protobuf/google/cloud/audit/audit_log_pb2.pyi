...
class AuditLog(_message.Message):
    __slots__ = ('service_name', 'method_name', 'resource_name', 'resource_location', 'resource_original_state', 'num_response_items', 'status', 'authentication_info', 'authorization_info', 'policy_violation_info', 'request_metadata', 'request', 'response', 'metadata', 'service_data')
...
class AuthenticationInfo(_message.Message):
    __slots__ = ('principal_email', 'authority_selector', 'third_party_principal', 'service_account_key_name', 'service_account_delegation_info', 'principal_subject')
...
class AuthorizationInfo(_message.Message):
    __slots__ = ('resource', 'permission', 'granted', 'resource_attributes', 'permission_type')
...
class RequestMetadata(_message.Message):
    __slots__ = ('caller_ip', 'caller_supplied_user_agent', 'caller_network', 'request_attributes', 'destination_attributes')
