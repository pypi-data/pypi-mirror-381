...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_DATAAGENT']._serialized_start = 263
    _globals['_DATAAGENT']._serialized_end = 938
    _globals['_DATAAGENT_LABELSENTRY']._serialized_start = 744
    _globals['_DATAAGENT_LABELSENTRY']._serialized_end = 789