...
from google.cloud.batch.v1alpha import volume_pb2 as _volume_pb2
...
class ComputeResource(_message.Message):
    __slots__ = ('cpu_milli', 'memory_mib', 'gpu_count', 'boot_disk_mib')
    ...
    def __init__(self, cpu_milli: _Optional[int]=..., memory_mib: _Optional[int]=..., gpu_count: _Optional[int]=..., boot_disk_mib: _Optional[int]=...) -> None:
        ...
...
class TaskExecution(_message.Message):
    __slots__ = ('exit_code', 'stderr_snippet')
    EXIT_CODE_FIELD_NUMBER: _ClassVar[int]
    STDERR_SNIPPET_FIELD_NUMBER: _ClassVar[int]
    exit_code: int
    stderr_snippet: str

    def __init__(self, exit_code: _Optional[int]=..., stderr_snippet: _Optional[str]=...) -> None:
        ...

class TaskStatus(_message.Message):
    __slots__ = ('state', 'status_events', 'resource_usage')
    ...
    def __init__(self, state: _Optional[_Union[TaskStatus.State, str]]=..., status_events: _Optional[_Iterable[_Union[StatusEvent, _Mapping]]]=..., resource_usage: _Optional[_Union[TaskResourceUsage, _Mapping]]=...) -> None:
        ...

class TaskResourceUsage(_message.Message):
