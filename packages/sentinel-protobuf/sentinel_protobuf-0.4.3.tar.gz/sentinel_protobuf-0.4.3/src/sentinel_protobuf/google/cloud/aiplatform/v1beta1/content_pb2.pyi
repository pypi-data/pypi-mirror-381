...
class Part(_message.Message):
    __slots__ = ('text', 'inline_data', 'file_data', 'function_call', 'function_response', 'executable_code', 'code_execution_result', 'video_metadata', 'thought', 'thought_signature')
...
class GenerationConfig(_message.Message):
    __slots__ = ('temperature', 'top_p', 'top_k', 'candidate_count', 'max_output_tokens', 'stop_sequences', 'response_logprobs', 'logprobs', 'presence_penalty', 'frequency_penalty', 'seed', 'response_mime_type', 'response_schema', 'response_json_schema', 'routing_config', 'audio_timestamp', 'response_modalities', 'media_resolution', 'speech_config', 'thinking_config', 'model_config')
    ...
    class ModelConfig(_message.Message):
        __slots__ = ('feature_selection_preference',)

        class FeatureSelectionPreference(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            FEATURE_SELECTION_PREFERENCE_UNSPECIFIED: _ClassVar[GenerationConfig.ModelConfig.FeatureSelectionPreference]
            PRIORITIZE_QUALITY: _ClassVar[GenerationConfig.ModelConfig.FeatureSelectionPreference]
            BALANCED: _ClassVar[GenerationConfig.ModelConfig.FeatureSelectionPreference]
            PRIORITIZE_COST: _ClassVar[GenerationConfig.ModelConfig.FeatureSelectionPreference]
        FEATURE_SELECTION_PREFERENCE_UNSPECIFIED: GenerationConfig.ModelConfig.FeatureSelectionPreference
        PRIORITIZE_QUALITY: GenerationConfig.ModelConfig.FeatureSelectionPreference
        BALANCED: GenerationConfig.ModelConfig.FeatureSelectionPreference
        PRIORITIZE_COST: GenerationConfig.ModelConfig.FeatureSelectionPreference
        FEATURE_SELECTION_PREFERENCE_FIELD_NUMBER: _ClassVar[int]
        feature_selection_preference: GenerationConfig.ModelConfig.FeatureSelectionPreference

        def __init__(self, feature_selection_preference: _Optional[_Union[GenerationConfig.ModelConfig.FeatureSelectionPreference, str]]=...) -> None:
            ...
    ...
    AUDIO_TIMESTAMP_FIELD_NUMBER: _ClassVar[int]
...
class Candidate(_message.Message):
    __slots__ = ('index', 'content', 'avg_logprobs', 'logprobs_result', 'finish_reason', 'safety_ratings', 'finish_message', 'citation_metadata', 'grounding_metadata', 'url_context_metadata')
...
class GroundingMetadata(_message.Message):
    __slots__ = ('web_search_queries', 'search_entry_point', 'retrieval_queries', 'grounding_chunks', 'grounding_supports', 'retrieval_metadata', 'google_maps_widget_context_token', 'source_flagging_uris')
    ...
    RETRIEVAL_QUERIES_FIELD_NUMBER: _ClassVar[int]
    ...
    retrieval_queries: _containers.RepeatedScalarFieldContainer[str]
