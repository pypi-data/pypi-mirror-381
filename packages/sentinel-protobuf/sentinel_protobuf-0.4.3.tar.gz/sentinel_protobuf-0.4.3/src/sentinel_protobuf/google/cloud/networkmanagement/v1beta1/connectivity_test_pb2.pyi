...
from google.cloud.networkmanagement.v1beta1 import trace_pb2 as _trace_pb2
...
class ProbingDetails(_message.Message):
    __slots__ = ('result', 'verify_time', 'error', 'abort_cause', 'sent_probe_count', 'successful_probe_count', 'endpoint_info', 'probing_latency', 'destination_egress_location', 'edge_responses', 'probed_all_devices')
    ...
    class SingleEdgeResponse(_message.Message):
        __slots__ = ('result', 'sent_probe_count', 'successful_probe_count', 'probing_latency', 'destination_egress_location', 'destination_router')
        RESULT_FIELD_NUMBER: _ClassVar[int]
        ...
        DESTINATION_ROUTER_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, result: _Optional[_Union[ProbingDetails.ProbingResult, str]]=..., sent_probe_count: _Optional[int]=..., successful_probe_count: _Optional[int]=..., probing_latency: _Optional[_Union[LatencyDistribution, _Mapping]]=..., destination_egress_location: _Optional[_Union[ProbingDetails.EdgeLocation, _Mapping]]=..., destination_router: _Optional[str]=...) -> None:
            ...
    RESULT_FIELD_NUMBER: _ClassVar[int]
    VERIFY_TIME_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    ...
    PROBING_LATENCY_FIELD_NUMBER: _ClassVar[int]
    DESTINATION_EGRESS_LOCATION_FIELD_NUMBER: _ClassVar[int]
    EDGE_RESPONSES_FIELD_NUMBER: _ClassVar[int]
    PROBED_ALL_DEVICES_FIELD_NUMBER: _ClassVar[int]
    result: ProbingDetails.ProbingResult
    verify_time: _timestamp_pb2.Timestamp
    error: _status_pb2.Status
    ...
    probing_latency: LatencyDistribution
    destination_egress_location: ProbingDetails.EdgeLocation
    edge_responses: _containers.RepeatedCompositeFieldContainer[ProbingDetails.SingleEdgeResponse]
    probed_all_devices: bool

    def __init__(self, result: _Optional[_Union[ProbingDetails.ProbingResult, str]]=..., verify_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., error: _Optional[_Union[_status_pb2.Status, _Mapping]]=..., abort_cause: _Optional[_Union[ProbingDetails.ProbingAbortCause, str]]=..., sent_probe_count: _Optional[int]=..., successful_probe_count: _Optional[int]=..., endpoint_info: _Optional[_Union[_trace_pb2.EndpointInfo, _Mapping]]=..., probing_latency: _Optional[_Union[LatencyDistribution, _Mapping]]=..., destination_egress_location: _Optional[_Union[ProbingDetails.EdgeLocation, _Mapping]]=..., edge_responses: _Optional[_Iterable[_Union[ProbingDetails.SingleEdgeResponse, _Mapping]]]=..., probed_all_devices: bool=...) -> None:
        ...