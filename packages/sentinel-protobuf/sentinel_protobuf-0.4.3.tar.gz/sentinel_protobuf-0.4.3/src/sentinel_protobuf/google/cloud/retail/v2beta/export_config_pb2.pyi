...
class ExportProductsRequest(_message.Message):
    __slots__ = ('parent', 'output_config', 'filter')
    ...
    def __init__(self, parent: _Optional[str]=..., output_config: _Optional[_Union[OutputConfig, _Mapping]]=..., filter: _Optional[str]=...) -> None:
        ...

class ExportUserEventsRequest(_message.Message):
    __slots__ = ('parent', 'output_config', 'filter')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_CONFIG_FIELD_NUMBER: _ClassVar[int]
    FILTER_FIELD_NUMBER: _ClassVar[int]
...
class ExportUserEventsResponse(_message.Message):
    __slots__ = ('error_samples', 'errors_config', 'output_result')
    ERROR_SAMPLES_FIELD_NUMBER: _ClassVar[int]
    ERRORS_CONFIG_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_RESULT_FIELD_NUMBER: _ClassVar[int]
