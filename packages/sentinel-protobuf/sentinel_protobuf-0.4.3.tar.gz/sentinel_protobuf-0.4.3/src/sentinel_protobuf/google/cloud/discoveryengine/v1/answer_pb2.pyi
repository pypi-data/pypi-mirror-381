...
class Answer(_message.Message):
    __slots__ = ('name', 'state', 'answer_text', 'grounding_score', 'citations', 'grounding_supports', 'references', 'related_questions', 'steps', 'query_understanding_info', 'answer_skipped_reasons', 'create_time', 'complete_time', 'safety_ratings')
    ...
    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        STREAMING: _ClassVar[Answer.State]
    ...
    class AnswerSkippedReason(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        NON_ANSWER_SEEKING_QUERY_IGNORED_V2: _ClassVar[Answer.AnswerSkippedReason]
        LOW_GROUNDED_ANSWER: _ClassVar[Answer.AnswerSkippedReason]
        USER_DEFINED_CLASSIFICATION_QUERY_IGNORED: _ClassVar[Answer.AnswerSkippedReason]
        UNHELPFUL_ANSWER: _ClassVar[Answer.AnswerSkippedReason]
    ...
    NON_ANSWER_SEEKING_QUERY_IGNORED_V2: Answer.AnswerSkippedReason
    LOW_GROUNDED_ANSWER: Answer.AnswerSkippedReason
    USER_DEFINED_CLASSIFICATION_QUERY_IGNORED: Answer.AnswerSkippedReason
    UNHELPFUL_ANSWER: Answer.AnswerSkippedReason
    ...
    class GroundingSupport(_message.Message):
        __slots__ = ('start_index', 'end_index', 'grounding_score', 'grounding_check_required', 'sources')
        START_INDEX_FIELD_NUMBER: _ClassVar[int]
        END_INDEX_FIELD_NUMBER: _ClassVar[int]
        ...
        def __init__(self, start_index: _Optional[int]=..., end_index: _Optional[int]=..., grounding_score: _Optional[float]=..., grounding_check_required: bool=..., sources: _Optional[_Iterable[_Union[Answer.CitationSource, _Mapping]]]=...) -> None:
            ...
    ...
    class Reference(_message.Message):
        ...
        class StructuredDocumentInfo(_message.Message):
            __slots__ = ('document', 'struct_data', 'title', 'uri')
            DOCUMENT_FIELD_NUMBER: _ClassVar[int]
            STRUCT_DATA_FIELD_NUMBER: _ClassVar[int]
            TITLE_FIELD_NUMBER: _ClassVar[int]
            URI_FIELD_NUMBER: _ClassVar[int]
            ...
            def __init__(self, document: _Optional[str]=..., struct_data: _Optional[_Union[_struct_pb2.Struct, _Mapping]]=..., title: _Optional[str]=..., uri: _Optional[str]=...) -> None:
                ...
    ...
    class QueryUnderstandingInfo(_message.Message):
        ...
        class QueryClassificationInfo(_message.Message):
            ...
            class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
                ...
                NON_ANSWER_SEEKING_QUERY_V2: _ClassVar[Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type]
                USER_DEFINED_CLASSIFICATION_QUERY: _ClassVar[Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type]
            ...
            NON_ANSWER_SEEKING_QUERY_V2: Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type
            USER_DEFINED_CLASSIFICATION_QUERY: Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type
    ...
    grounding_supports: _containers.RepeatedCompositeFieldContainer[Answer.GroundingSupport]
    ...
    def __init__(self, name: _Optional[str]=..., state: _Optional[_Union[Answer.State, str]]=..., answer_text: _Optional[str]=..., grounding_score: _Optional[float]=..., citations: _Optional[_Iterable[_Union[Answer.Citation, _Mapping]]]=..., grounding_supports: _Optional[_Iterable[_Union[Answer.GroundingSupport, _Mapping]]]=..., references: _Optional[_Iterable[_Union[Answer.Reference, _Mapping]]]=..., related_questions: _Optional[_Iterable[str]]=..., steps: _Optional[_Iterable[_Union[Answer.Step, _Mapping]]]=..., query_understanding_info: _Optional[_Union[Answer.QueryUnderstandingInfo, _Mapping]]=..., answer_skipped_reasons: _Optional[_Iterable[_Union[Answer.AnswerSkippedReason, str]]]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., complete_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., safety_ratings: _Optional[_Iterable[_Union[_safety_pb2.SafetyRating, _Mapping]]]=...) -> None:
        ...