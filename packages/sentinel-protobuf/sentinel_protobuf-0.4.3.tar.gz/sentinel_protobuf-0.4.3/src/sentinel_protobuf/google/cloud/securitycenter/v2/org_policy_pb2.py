...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_ORGPOLICY'].fields_by_name['name']._loaded_options = None
    _globals['_ORGPOLICY'].fields_by_name['name']._serialized_options = b'\xe0A\x08'
    ...
    _globals['_ORGPOLICY']._serialized_start = 144
    _globals['_ORGPOLICY']._serialized_end = 363