...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_INSIGHTTYPE']._loaded_options = None
    _globals['_INSIGHTTYPE']._serialized_options = b'\xeaA\xf0\x02\n&recommender.googleapis.com/InsightType\x12Cprojects/{project}/locations/{location}/insightTypes/{insight_type}\x12RbillingAccounts/{billing_account}/locations/{location}/insightTypes/{insight_type}\x12Afolders/{folder}/locations/{location}/insightTypes/{insight_type}\x12Morganizations/{organization}/locations/{location}/insightTypes/{insight_type}\x12\x1binsightTypes/{insight_type}'
    _globals['_INSIGHT']._serialized_start = 207
    _globals['_INSIGHT']._serialized_end = 1433
    _globals['_INSIGHT_RECOMMENDATIONREFERENCE']._serialized_start = 785
    _globals['_INSIGHT_RECOMMENDATIONREFERENCE']._serialized_end = 834
    _globals['_INSIGHT_CATEGORY']._serialized_start = 836
    _globals['_INSIGHT_CATEGORY']._serialized_end = 932
    _globals['_INSIGHT_SEVERITY']._serialized_start = 934
    _globals['_INSIGHT_SEVERITY']._serialized_end = 1015
    _globals['_INSIGHTSTATEINFO']._serialized_start = 1436
    _globals['_INSIGHTSTATEINFO']._serialized_end = 1749
    _globals['_INSIGHTSTATEINFO_STATEMETADATAENTRY']._serialized_start = 1624
    _globals['_INSIGHTSTATEINFO_STATEMETADATAENTRY']._serialized_end = 1676
    _globals['_INSIGHTSTATEINFO_STATE']._serialized_start = 1678
    _globals['_INSIGHTSTATEINFO_STATE']._serialized_end = 1749
    _globals['_INSIGHTTYPE']._serialized_start = 1752
    _globals['_INSIGHTTYPE']._serialized_end = 2154