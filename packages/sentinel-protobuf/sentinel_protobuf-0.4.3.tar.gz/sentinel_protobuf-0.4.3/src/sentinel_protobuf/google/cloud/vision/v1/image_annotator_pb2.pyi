...
from google.cloud.vision.v1 import product_search_pb2 as _product_search_pb2
from google.cloud.vision.v1 import text_annotation_pb2 as _text_annotation_pb2
from google.cloud.vision.v1 import web_detection_pb2 as _web_detection_pb2
...
class FaceAnnotation(_message.Message):
    ...
    class Landmark(_message.Message):
        ...
        class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            ...
            LEFT_CHEEK_CENTER: _ClassVar[FaceAnnotation.Landmark.Type]
            RIGHT_CHEEK_CENTER: _ClassVar[FaceAnnotation.Landmark.Type]
        ...
        LEFT_CHEEK_CENTER: FaceAnnotation.Landmark.Type
        RIGHT_CHEEK_CENTER: FaceAnnotation.Landmark.Type
        TYPE_FIELD_NUMBER: _ClassVar[int]
...
class ImageContext(_message.Message):
    __slots__ = ('lat_long_rect', 'language_hints', 'crop_hints_params', 'product_search_params', 'web_detection_params', 'text_detection_params')
    ...
    def __init__(self, lat_long_rect: _Optional[_Union[LatLongRect, _Mapping]]=..., language_hints: _Optional[_Iterable[str]]=..., crop_hints_params: _Optional[_Union[CropHintsParams, _Mapping]]=..., product_search_params: _Optional[_Union[_product_search_pb2.ProductSearchParams, _Mapping]]=..., web_detection_params: _Optional[_Union[WebDetectionParams, _Mapping]]=..., text_detection_params: _Optional[_Union[TextDetectionParams, _Mapping]]=...) -> None:
        ...
...
class BatchAnnotateImagesRequest(_message.Message):
    __slots__ = ('requests', 'parent', 'labels')
    ...
    def __init__(self, requests: _Optional[_Iterable[_Union[AnnotateImageRequest, _Mapping]]]=..., parent: _Optional[str]=..., labels: _Optional[_Mapping[str, str]]=...) -> None:
        ...
...
class BatchAnnotateFilesRequest(_message.Message):
    ...
    def __init__(self, requests: _Optional[_Iterable[_Union[AnnotateFileRequest, _Mapping]]]=..., parent: _Optional[str]=..., labels: _Optional[_Mapping[str, str]]=...) -> None:
        ...
...
class AsyncBatchAnnotateImagesRequest(_message.Message):
    __slots__ = ('requests', 'output_config', 'parent', 'labels')
    ...
    def __init__(self, requests: _Optional[_Iterable[_Union[AnnotateImageRequest, _Mapping]]]=..., output_config: _Optional[_Union[OutputConfig, _Mapping]]=..., parent: _Optional[str]=..., labels: _Optional[_Mapping[str, str]]=...) -> None:
        ...
...
class AsyncBatchAnnotateFilesRequest(_message.Message):
    ...
    def __init__(self, requests: _Optional[_Iterable[_Union[AsyncAnnotateFileRequest, _Mapping]]]=..., parent: _Optional[str]=..., labels: _Optional[_Mapping[str, str]]=...) -> None:
        ...
