...
class TableFieldSchema(_message.Message):
    __slots__ = ('name', 'type', 'mode', 'fields', 'description', 'max_length', 'precision', 'scale', 'default_value_expression', 'range_element_type')
    ...
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        RANGE: _ClassVar[TableFieldSchema.Type]
    ...
    class FieldElementType(_message.Message):
        ...
        def __init__(self, type: _Optional[_Union[TableFieldSchema.Type, str]]=...) -> None:
            ...
    ...
    def __init__(self, name: _Optional[str]=..., type: _Optional[_Union[TableFieldSchema.Type, str]]=..., mode: _Optional[_Union[TableFieldSchema.Mode, str]]=..., fields: _Optional[_Iterable[_Union[TableFieldSchema, _Mapping]]]=..., description: _Optional[str]=..., max_length: _Optional[int]=..., precision: _Optional[int]=..., scale: _Optional[int]=..., default_value_expression: _Optional[str]=..., range_element_type: _Optional[_Union[TableFieldSchema.FieldElementType, _Mapping]]=...) -> None:
        ...