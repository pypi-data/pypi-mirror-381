...
class Policy(_message.Message):
    ...
    class ListPolicy(_message.Message):
        ...
        def __init__(self, allowed_values: _Optional[_Iterable[str]]=..., denied_values: _Optional[_Iterable[str]]=..., all_values: _Optional[_Union[Policy.ListPolicy.AllValues, str]]=..., suggested_value: _Optional[str]=..., inherit_from_parent: bool=...) -> None:
            ...
    ...
    def __init__(self, version: _Optional[int]=..., constraint: _Optional[str]=..., etag: _Optional[bytes]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., list_policy: _Optional[_Union[Policy.ListPolicy, _Mapping]]=..., boolean_policy: _Optional[_Union[Policy.BooleanPolicy, _Mapping]]=..., restore_default: _Optional[_Union[Policy.RestoreDefault, _Mapping]]=...) -> None:
        ...