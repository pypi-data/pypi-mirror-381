...
class ImportProductsRequest(_message.Message):
    __slots__ = ('parent', 'request_id', 'input_config', 'errors_config', 'update_mask', 'reconciliation_mode', 'notification_pubsub_topic', 'skip_default_branch_protection')
    ...
    SKIP_DEFAULT_BRANCH_PROTECTION_FIELD_NUMBER: _ClassVar[int]
    parent: str
    request_id: str
    ...
    def __init__(self, parent: _Optional[str]=..., request_id: _Optional[str]=..., input_config: _Optional[_Union[ProductInputConfig, _Mapping]]=..., errors_config: _Optional[_Union[ImportErrorsConfig, _Mapping]]=..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]]=..., reconciliation_mode: _Optional[_Union[ImportProductsRequest.ReconciliationMode, str]]=..., notification_pubsub_topic: _Optional[str]=..., skip_default_branch_protection: bool=...) -> None:
        ...
...
class ImportMetadata(_message.Message):
    __slots__ = ('create_time', 'update_time', 'success_count', 'failure_count', 'request_id', 'notification_pubsub_topic', 'transformed_user_events_metadata')
    ...
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    NOTIFICATION_PUBSUB_TOPIC_FIELD_NUMBER: _ClassVar[int]
    TRANSFORMED_USER_EVENTS_METADATA_FIELD_NUMBER: _ClassVar[int]
    ...
    request_id: str
    notification_pubsub_topic: str
    transformed_user_events_metadata: TransformedUserEventsMetadata

    def __init__(self, create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., success_count: _Optional[int]=..., failure_count: _Optional[int]=..., request_id: _Optional[str]=..., notification_pubsub_topic: _Optional[str]=..., transformed_user_events_metadata: _Optional[_Union[TransformedUserEventsMetadata, _Mapping]]=...) -> None:
        ...

class TransformedUserEventsMetadata(_message.Message):
    __slots__ = ('source_events_count', 'transformed_events_count')
    SOURCE_EVENTS_COUNT_FIELD_NUMBER: _ClassVar[int]
    TRANSFORMED_EVENTS_COUNT_FIELD_NUMBER: _ClassVar[int]
    source_events_count: int
    transformed_events_count: int

    def __init__(self, source_events_count: _Optional[int]=..., transformed_events_count: _Optional[int]=...) -> None:
        ...
