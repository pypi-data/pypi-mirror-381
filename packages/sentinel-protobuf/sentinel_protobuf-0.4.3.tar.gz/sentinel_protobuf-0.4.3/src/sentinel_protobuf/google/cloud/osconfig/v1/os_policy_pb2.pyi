...
class OSPolicy(_message.Message):
    ...
    class ResourceGroup(_message.Message):
        __slots__ = ('inventory_filters', 'resources')
        ...
        def __init__(self, inventory_filters: _Optional[_Iterable[_Union[OSPolicy.InventoryFilter, _Mapping]]]=..., resources: _Optional[_Iterable[_Union[OSPolicy.Resource, _Mapping]]]=...) -> None:
            ...
    ID_FIELD_NUMBER: _ClassVar[int]
