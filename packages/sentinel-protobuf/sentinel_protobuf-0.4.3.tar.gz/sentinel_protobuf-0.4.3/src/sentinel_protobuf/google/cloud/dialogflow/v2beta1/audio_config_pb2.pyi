...
class InputAudioConfig(_message.Message):
    __slots__ = ('audio_encoding', 'sample_rate_hertz', 'language_code', 'enable_word_info', 'phrase_hints', 'speech_contexts', 'model', 'model_variant', 'single_utterance', 'disable_no_speech_recognized_event', 'barge_in_config', 'enable_automatic_punctuation', 'default_no_speech_timeout', 'phrase_sets', 'opt_out_conformer_model_migration')
    ...
    DEFAULT_NO_SPEECH_TIMEOUT_FIELD_NUMBER: _ClassVar[int]
    ...
    default_no_speech_timeout: _duration_pb2.Duration
    phrase_sets: _containers.RepeatedScalarFieldContainer[str]
    opt_out_conformer_model_migration: bool

    def __init__(self, audio_encoding: _Optional[_Union[AudioEncoding, str]]=..., sample_rate_hertz: _Optional[int]=..., language_code: _Optional[str]=..., enable_word_info: bool=..., phrase_hints: _Optional[_Iterable[str]]=..., speech_contexts: _Optional[_Iterable[_Union[SpeechContext, _Mapping]]]=..., model: _Optional[str]=..., model_variant: _Optional[_Union[SpeechModelVariant, str]]=..., single_utterance: bool=..., disable_no_speech_recognized_event: bool=..., barge_in_config: _Optional[_Union[BargeInConfig, _Mapping]]=..., enable_automatic_punctuation: bool=..., default_no_speech_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]]=..., phrase_sets: _Optional[_Iterable[str]]=..., opt_out_conformer_model_migration: bool=...) -> None:
        ...
