...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PURGEMETADATA']._serialized_start = 172
    _globals['_PURGEMETADATA']._serialized_end = 187
    _globals['_PURGEPRODUCTSMETADATA']._serialized_start = 190
    _globals['_PURGEPRODUCTSMETADATA']._serialized_end = 357
    _globals['_PURGEPRODUCTSREQUEST']._serialized_start = 359
    _globals['_PURGEPRODUCTSREQUEST']._serialized_end = 471
    _globals['_PURGEPRODUCTSRESPONSE']._serialized_start = 473
    _globals['_PURGEPRODUCTSRESPONSE']._serialized_end = 575
    _globals['_PURGEUSEREVENTSREQUEST']._serialized_start = 577
    _globals['_PURGEUSEREVENTSREQUEST']._serialized_end = 692
    _globals['_PURGEUSEREVENTSRESPONSE']._serialized_start = 694
    _globals['_PURGEUSEREVENTSRESPONSE']._serialized_end = 748