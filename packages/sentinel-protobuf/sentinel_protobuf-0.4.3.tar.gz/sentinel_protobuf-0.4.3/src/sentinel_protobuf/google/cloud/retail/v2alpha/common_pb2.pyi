...
class LocalInventory(_message.Message):
    __slots__ = ('place_id', 'price_info', 'availability', 'attributes', 'fulfillment_types')

    class Availability(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        AVAILABILITY_UNSPECIFIED: _ClassVar[LocalInventory.Availability]
        IN_STOCK: _ClassVar[LocalInventory.Availability]
        OUT_OF_STOCK: _ClassVar[LocalInventory.Availability]
        PREORDER: _ClassVar[LocalInventory.Availability]
        BACKORDER: _ClassVar[LocalInventory.Availability]
    AVAILABILITY_UNSPECIFIED: LocalInventory.Availability
    IN_STOCK: LocalInventory.Availability
    OUT_OF_STOCK: LocalInventory.Availability
    PREORDER: LocalInventory.Availability
    BACKORDER: LocalInventory.Availability
    ...
    availability: LocalInventory.Availability
    attributes: _containers.MessageMap[str, CustomAttribute]
    fulfillment_types: _containers.RepeatedScalarFieldContainer[str]

    def __init__(self, place_id: _Optional[str]=..., price_info: _Optional[_Union[PriceInfo, _Mapping]]=..., availability: _Optional[_Union[LocalInventory.Availability, str]]=..., attributes: _Optional[_Mapping[str, CustomAttribute]]=..., fulfillment_types: _Optional[_Iterable[str]]=...) -> None:
        ...
