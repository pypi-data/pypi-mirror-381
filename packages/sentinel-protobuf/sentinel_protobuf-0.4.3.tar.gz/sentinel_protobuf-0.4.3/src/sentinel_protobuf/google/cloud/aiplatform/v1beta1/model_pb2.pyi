...
from google.cloud.aiplatform.v1beta1 import deployed_model_ref_pb2 as _deployed_model_ref_pb2
...
class Model(_message.Message):
    __slots__ = ('name', 'version_id', 'version_aliases', 'version_create_time', 'version_update_time', 'display_name', 'description', 'version_description', 'default_checkpoint_id', 'predict_schemata', 'metadata_schema_uri', 'metadata', 'supported_export_formats', 'training_pipeline', 'container_spec', 'artifact_uri', 'supported_deployment_resources_types', 'supported_input_storage_formats', 'supported_output_storage_formats', 'create_time', 'update_time', 'deployed_models', 'explanation_spec', 'etag', 'labels', 'encryption_spec', 'model_source_info', 'original_model_info', 'metadata_artifact', 'base_model_source', 'satisfies_pzs', 'satisfies_pzi', 'checkpoints')
