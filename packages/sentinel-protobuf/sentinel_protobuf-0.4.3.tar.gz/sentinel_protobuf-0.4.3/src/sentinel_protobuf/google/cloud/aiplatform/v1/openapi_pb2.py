...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/aiplatform/v1/openapi.proto')
_sym_db = _symbol_database.Default()
from .....google.api import field_behavior_pb2 as google_dot_api_dot_field__behavior__pb2
from google.protobuf import struct_pb2 as google_dot_protobuf_dot_struct__pb2
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n(google/cloud/aiplatform/v1/openapi.proto\x12\x1agoogle.cloud.aiplatform.v1\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1cgoogle/protobuf/struct.proto"\x90\x08\n\x06Schema\x123\n\x04type\x18\x01 \x01(\x0e2 .google.cloud.aiplatform.v1.TypeB\x03\xe0A\x01\x12\x13\n\x06format\x18\x07 \x01(\tB\x03\xe0A\x01\x12\x12\n\x05title\x18\x18 \x01(\tB\x03\xe0A\x01\x12\x18\n\x0bdescription\x18\x08 \x01(\tB\x03\xe0A\x01\x12\x15\n\x08nullable\x18\x06 \x01(\x08B\x03\xe0A\x01\x12,\n\x07default\x18\x17 \x01(\x0b2\x16.google.protobuf.ValueB\x03\xe0A\x01\x126\n\x05items\x18\x02 \x01(\x0b2".google.cloud.aiplatform.v1.SchemaB\x03\xe0A\x01\x12\x16\n\tmin_items\x18\x15 \x01(\x03B\x03\xe0A\x01\x12\x16\n\tmax_items\x18\x16 \x01(\x03B\x03\xe0A\x01\x12\x11\n\x04enum\x18\t \x03(\tB\x03\xe0A\x01\x12K\n\nproperties\x18\x03 \x03(\x0b22.google.cloud.aiplatform.v1.Schema.PropertiesEntryB\x03\xe0A\x01\x12\x1e\n\x11property_ordering\x18\x19 \x03(\tB\x03\xe0A\x01\x12\x15\n\x08required\x18\x05 \x03(\tB\x03\xe0A\x01\x12\x1b\n\x0emin_properties\x18\x0e \x01(\x03B\x03\xe0A\x01\x12\x1b\n\x0emax_properties\x18\x0f \x01(\x03B\x03\xe0A\x01\x12\x14\n\x07minimum\x18\x10 \x01(\x01B\x03\xe0A\x01\x12\x14\n\x07maximum\x18\x11 \x01(\x01B\x03\xe0A\x01\x12\x17\n\nmin_length\x18\x12 \x01(\x03B\x03\xe0A\x01\x12\x17\n\nmax_length\x18\x13 \x01(\x03B\x03\xe0A\x01\x12\x14\n\x07pattern\x18\x14 \x01(\tB\x03\xe0A\x01\x12,\n\x07example\x18\x04 \x01(\x0b2\x16.google.protobuf.ValueB\x03\xe0A\x01\x127\n\x06any_of\x18\x0b \x03(\x0b2".google.cloud.aiplatform.v1.SchemaB\x03\xe0A\x01\x12:\n\x15additional_properties\x18\x1a \x01(\x0b2\x16.google.protobuf.ValueB\x03\xe0A\x01\x12\x10\n\x03ref\x18\x1b \x01(\tB\x03\xe0A\x01\x12?\n\x04defs\x18\x1c \x03(\x0b2,.google.cloud.aiplatform.v1.Schema.DefsEntryB\x03\xe0A\x01\x1aU\n\x0fPropertiesEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x121\n\x05value\x18\x02 \x01(\x0b2".google.cloud.aiplatform.v1.Schema:\x028\x01\x1aO\n\tDefsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x121\n\x05value\x18\x02 \x01(\x0b2".google.cloud.aiplatform.v1.Schema:\x028\x01*e\n\x04Type\x12\x14\n\x10TYPE_UNSPECIFIED\x10\x00\x12\n\n\x06STRING\x10\x01\x12\n\n\x06NUMBER\x10\x02\x12\x0b\n\x07INTEGER\x10\x03\x12\x0b\n\x07BOOLEAN\x10\x04\x12\t\n\x05ARRAY\x10\x05\x12\n\n\x06OBJECT\x10\x06B\xca\x01\n\x1ecom.google.cloud.aiplatform.v1B\x0cOpenApiProtoP\x01Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\xaa\x02\x1aGoogle.Cloud.AIPlatform.V1\xca\x02\x1aGoogle\\Cloud\\AIPlatform\\V1\xea\x02\x1dGoogle::Cloud::AIPlatform::V1b\x06proto3')
_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'google.cloud.aiplatform.v1.openapi_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
    _globals['DESCRIPTOR']._loaded_options = None
    _globals['DESCRIPTOR']._serialized_options = b'\n\x1ecom.google.cloud.aiplatform.v1B\x0cOpenApiProtoP\x01Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\xaa\x02\x1aGoogle.Cloud.AIPlatform.V1\xca\x02\x1aGoogle\\Cloud\\AIPlatform\\V1\xea\x02\x1dGoogle::Cloud::AIPlatform::V1'
    ...
    _globals['_TYPE']._serialized_start = 1178
    _globals['_TYPE']._serialized_end = 1279
    _globals['_SCHEMA']._serialized_start = 136
    _globals['_SCHEMA']._serialized_end = 1176
    _globals['_SCHEMA_PROPERTIESENTRY']._serialized_start = 1010
    _globals['_SCHEMA_PROPERTIESENTRY']._serialized_end = 1095
    _globals['_SCHEMA_DEFSENTRY']._serialized_start = 1097
    _globals['_SCHEMA_DEFSENTRY']._serialized_end = 1176