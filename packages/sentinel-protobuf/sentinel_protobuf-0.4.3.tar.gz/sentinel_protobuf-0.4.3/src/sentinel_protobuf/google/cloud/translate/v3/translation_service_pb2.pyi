from google.cloud.translate.v3 import adaptive_mt_pb2 as _adaptive_mt_pb2
from google.cloud.translate.v3 import automl_translation_pb2 as _automl_translation_pb2
...
from google.cloud.translate.v3.adaptive_mt_pb2 import AdaptiveMtDataset as AdaptiveMtDataset
from google.cloud.translate.v3.adaptive_mt_pb2 import CreateAdaptiveMtDatasetRequest as CreateAdaptiveMtDatasetRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import DeleteAdaptiveMtDatasetRequest as DeleteAdaptiveMtDatasetRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import GetAdaptiveMtDatasetRequest as GetAdaptiveMtDatasetRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import ListAdaptiveMtDatasetsRequest as ListAdaptiveMtDatasetsRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import ListAdaptiveMtDatasetsResponse as ListAdaptiveMtDatasetsResponse
from google.cloud.translate.v3.adaptive_mt_pb2 import AdaptiveMtTranslateRequest as AdaptiveMtTranslateRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import AdaptiveMtTranslation as AdaptiveMtTranslation
from google.cloud.translate.v3.adaptive_mt_pb2 import AdaptiveMtTranslateResponse as AdaptiveMtTranslateResponse
from google.cloud.translate.v3.adaptive_mt_pb2 import AdaptiveMtFile as AdaptiveMtFile
from google.cloud.translate.v3.adaptive_mt_pb2 import GetAdaptiveMtFileRequest as GetAdaptiveMtFileRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import DeleteAdaptiveMtFileRequest as DeleteAdaptiveMtFileRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import ImportAdaptiveMtFileRequest as ImportAdaptiveMtFileRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import ImportAdaptiveMtFileResponse as ImportAdaptiveMtFileResponse
from google.cloud.translate.v3.adaptive_mt_pb2 import ListAdaptiveMtFilesRequest as ListAdaptiveMtFilesRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import ListAdaptiveMtFilesResponse as ListAdaptiveMtFilesResponse
from google.cloud.translate.v3.adaptive_mt_pb2 import AdaptiveMtSentence as AdaptiveMtSentence
from google.cloud.translate.v3.adaptive_mt_pb2 import ListAdaptiveMtSentencesRequest as ListAdaptiveMtSentencesRequest
from google.cloud.translate.v3.adaptive_mt_pb2 import ListAdaptiveMtSentencesResponse as ListAdaptiveMtSentencesResponse
from google.cloud.translate.v3.automl_translation_pb2 import ImportDataRequest as ImportDataRequest
from google.cloud.translate.v3.automl_translation_pb2 import DatasetInputConfig as DatasetInputConfig
from google.cloud.translate.v3.automl_translation_pb2 import ImportDataMetadata as ImportDataMetadata
from google.cloud.translate.v3.automl_translation_pb2 import ExportDataRequest as ExportDataRequest
from google.cloud.translate.v3.automl_translation_pb2 import DatasetOutputConfig as DatasetOutputConfig
from google.cloud.translate.v3.automl_translation_pb2 import ExportDataMetadata as ExportDataMetadata
from google.cloud.translate.v3.automl_translation_pb2 import DeleteDatasetRequest as DeleteDatasetRequest
from google.cloud.translate.v3.automl_translation_pb2 import DeleteDatasetMetadata as DeleteDatasetMetadata
from google.cloud.translate.v3.automl_translation_pb2 import GetDatasetRequest as GetDatasetRequest
from google.cloud.translate.v3.automl_translation_pb2 import ListDatasetsRequest as ListDatasetsRequest
from google.cloud.translate.v3.automl_translation_pb2 import ListDatasetsResponse as ListDatasetsResponse
from google.cloud.translate.v3.automl_translation_pb2 import CreateDatasetRequest as CreateDatasetRequest
from google.cloud.translate.v3.automl_translation_pb2 import CreateDatasetMetadata as CreateDatasetMetadata
from google.cloud.translate.v3.automl_translation_pb2 import ListExamplesRequest as ListExamplesRequest
from google.cloud.translate.v3.automl_translation_pb2 import ListExamplesResponse as ListExamplesResponse
from google.cloud.translate.v3.automl_translation_pb2 import Example as Example
from google.cloud.translate.v3.automl_translation_pb2 import BatchTransferResourcesResponse as BatchTransferResourcesResponse
from google.cloud.translate.v3.automl_translation_pb2 import Dataset as Dataset
from google.cloud.translate.v3.automl_translation_pb2 import CreateModelRequest as CreateModelRequest
from google.cloud.translate.v3.automl_translation_pb2 import CreateModelMetadata as CreateModelMetadata
from google.cloud.translate.v3.automl_translation_pb2 import ListModelsRequest as ListModelsRequest
from google.cloud.translate.v3.automl_translation_pb2 import ListModelsResponse as ListModelsResponse
from google.cloud.translate.v3.automl_translation_pb2 import GetModelRequest as GetModelRequest
from google.cloud.translate.v3.automl_translation_pb2 import DeleteModelRequest as DeleteModelRequest
from google.cloud.translate.v3.automl_translation_pb2 import DeleteModelMetadata as DeleteModelMetadata
from google.cloud.translate.v3.automl_translation_pb2 import Model as Model
from google.cloud.translate.v3.common_pb2 import GcsInputSource as GcsInputSource
from google.cloud.translate.v3.common_pb2 import FileInputSource as FileInputSource
from google.cloud.translate.v3.common_pb2 import GcsOutputDestination as GcsOutputDestination
from google.cloud.translate.v3.common_pb2 import GlossaryEntry as GlossaryEntry
from google.cloud.translate.v3.common_pb2 import GlossaryTerm as GlossaryTerm
from google.cloud.translate.v3.common_pb2 import OperationState as OperationState
DESCRIPTOR: _descriptor.FileDescriptor
OPERATION_STATE_UNSPECIFIED: _common_pb2.OperationState
OPERATION_STATE_RUNNING: _common_pb2.OperationState
OPERATION_STATE_SUCCEEDED: _common_pb2.OperationState
OPERATION_STATE_FAILED: _common_pb2.OperationState
OPERATION_STATE_CANCELLING: _common_pb2.OperationState
OPERATION_STATE_CANCELLED: _common_pb2.OperationState

class TransliterationConfig(_message.Message):
    __slots__ = ('enable_transliteration',)
    ENABLE_TRANSLITERATION_FIELD_NUMBER: _ClassVar[int]
    enable_transliteration: bool

    def __init__(self, enable_transliteration: bool=...) -> None:
        ...

class TranslateTextRequest(_message.Message):
    __slots__ = ('contents', 'mime_type', 'source_language_code', 'target_language_code', 'parent', 'model', 'glossary_config', 'transliteration_config', 'labels')
    ...
    TRANSLITERATION_CONFIG_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, contents: _Optional[_Iterable[str]]=..., mime_type: _Optional[str]=..., source_language_code: _Optional[str]=..., target_language_code: _Optional[str]=..., parent: _Optional[str]=..., model: _Optional[str]=..., glossary_config: _Optional[_Union[TranslateTextGlossaryConfig, _Mapping]]=..., transliteration_config: _Optional[_Union[TransliterationConfig, _Mapping]]=..., labels: _Optional[_Mapping[str, str]]=...) -> None:
        ...
...
class RomanizeTextRequest(_message.Message):
    __slots__ = ('parent', 'contents', 'source_language_code')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    CONTENTS_FIELD_NUMBER: _ClassVar[int]
    SOURCE_LANGUAGE_CODE_FIELD_NUMBER: _ClassVar[int]
    parent: str
    ...
    def __init__(self, parent: _Optional[str]=..., contents: _Optional[_Iterable[str]]=..., source_language_code: _Optional[str]=...) -> None:
        ...

class Romanization(_message.Message):
    __slots__ = ('romanized_text', 'detected_language_code')
    ROMANIZED_TEXT_FIELD_NUMBER: _ClassVar[int]
    DETECTED_LANGUAGE_CODE_FIELD_NUMBER: _ClassVar[int]
    romanized_text: str
    detected_language_code: str

    def __init__(self, romanized_text: _Optional[str]=..., detected_language_code: _Optional[str]=...) -> None:
        ...

class RomanizeTextResponse(_message.Message):
    __slots__ = ('romanizations',)
    ROMANIZATIONS_FIELD_NUMBER: _ClassVar[int]
    romanizations: _containers.RepeatedCompositeFieldContainer[Romanization]

    def __init__(self, romanizations: _Optional[_Iterable[_Union[Romanization, _Mapping]]]=...) -> None:
        ...
...
class Glossary(_message.Message):
    __slots__ = ('name', 'language_pair', 'language_codes_set', 'input_config', 'entry_count', 'submit_time', 'end_time', 'display_name')
...
class UpdateGlossaryRequest(_message.Message):
    __slots__ = ('glossary', 'update_mask')
    GLOSSARY_FIELD_NUMBER: _ClassVar[int]
    UPDATE_MASK_FIELD_NUMBER: _ClassVar[int]
    glossary: Glossary
    update_mask: _field_mask_pb2.FieldMask

    def __init__(self, glossary: _Optional[_Union[Glossary, _Mapping]]=..., update_mask: _Optional[_Union[_field_mask_pb2.FieldMask, _Mapping]]=...) -> None:
        ...
...
class GetGlossaryEntryRequest(_message.Message):
    __slots__ = ('name',)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class DeleteGlossaryEntryRequest(_message.Message):
    __slots__ = ('name',)
    NAME_FIELD_NUMBER: _ClassVar[int]
    name: str
...
class ListGlossaryEntriesRequest(_message.Message):
...
class ListGlossaryEntriesResponse(_message.Message):
    __slots__ = ('glossary_entries', 'next_page_token')
    GLOSSARY_ENTRIES_FIELD_NUMBER: _ClassVar[int]
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    glossary_entries: _containers.RepeatedCompositeFieldContainer[_common_pb2.GlossaryEntry]
    next_page_token: str

    def __init__(self, glossary_entries: _Optional[_Iterable[_Union[_common_pb2.GlossaryEntry, _Mapping]]]=..., next_page_token: _Optional[str]=...) -> None:
        ...

class CreateGlossaryEntryRequest(_message.Message):
    __slots__ = ('parent', 'glossary_entry')
    PARENT_FIELD_NUMBER: _ClassVar[int]
    GLOSSARY_ENTRY_FIELD_NUMBER: _ClassVar[int]
    parent: str
    glossary_entry: _common_pb2.GlossaryEntry

    def __init__(self, parent: _Optional[str]=..., glossary_entry: _Optional[_Union[_common_pb2.GlossaryEntry, _Mapping]]=...) -> None:
        ...

class UpdateGlossaryEntryRequest(_message.Message):
    __slots__ = ('glossary_entry',)
    GLOSSARY_ENTRY_FIELD_NUMBER: _ClassVar[int]
    glossary_entry: _common_pb2.GlossaryEntry

    def __init__(self, glossary_entry: _Optional[_Union[_common_pb2.GlossaryEntry, _Mapping]]=...) -> None:
        ...
...
class UpdateGlossaryMetadata(_message.Message):
    __slots__ = ('glossary', 'state', 'submit_time')

    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        STATE_UNSPECIFIED: _ClassVar[UpdateGlossaryMetadata.State]
        RUNNING: _ClassVar[UpdateGlossaryMetadata.State]
        SUCCEEDED: _ClassVar[UpdateGlossaryMetadata.State]
        FAILED: _ClassVar[UpdateGlossaryMetadata.State]
        CANCELLING: _ClassVar[UpdateGlossaryMetadata.State]
        CANCELLED: _ClassVar[UpdateGlossaryMetadata.State]
    STATE_UNSPECIFIED: UpdateGlossaryMetadata.State
    RUNNING: UpdateGlossaryMetadata.State
    SUCCEEDED: UpdateGlossaryMetadata.State
    FAILED: UpdateGlossaryMetadata.State
    CANCELLING: UpdateGlossaryMetadata.State
    CANCELLED: UpdateGlossaryMetadata.State
    GLOSSARY_FIELD_NUMBER: _ClassVar[int]
    STATE_FIELD_NUMBER: _ClassVar[int]
    SUBMIT_TIME_FIELD_NUMBER: _ClassVar[int]
    glossary: Glossary
    state: UpdateGlossaryMetadata.State
    submit_time: _timestamp_pb2.Timestamp

    def __init__(self, glossary: _Optional[_Union[Glossary, _Mapping]]=..., state: _Optional[_Union[UpdateGlossaryMetadata.State, str]]=..., submit_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
