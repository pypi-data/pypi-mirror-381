...
from google.cloud.discoveryengine.v1 import grounding_pb2 as _grounding_pb2
...
class GenerateGroundedContentRequest(_message.Message):
    ...
    class GenerationSpec(_message.Message):
        __slots__ = ('model_id', 'language_code', 'temperature', 'top_p', 'top_k', 'frequency_penalty', 'seed', 'presence_penalty', 'max_output_tokens')
        ...
        def __init__(self, model_id: _Optional[str]=..., language_code: _Optional[str]=..., temperature: _Optional[float]=..., top_p: _Optional[float]=..., top_k: _Optional[int]=..., frequency_penalty: _Optional[float]=..., seed: _Optional[int]=..., presence_penalty: _Optional[float]=..., max_output_tokens: _Optional[int]=...) -> None:
            ...
    ...
    class GroundingSource(_message.Message):
        __slots__ = ('inline_source', 'search_source', 'google_search_source', 'enterprise_web_retrieval_source')
        ...
        class EnterpriseWebRetrievalSource(_message.Message):
            __slots__ = ()
        ...
        ENTERPRISE_WEB_RETRIEVAL_SOURCE_FIELD_NUMBER: _ClassVar[int]
        ...
        enterprise_web_retrieval_source: GenerateGroundedContentRequest.GroundingSource.EnterpriseWebRetrievalSource

        def __init__(self, inline_source: _Optional[_Union[GenerateGroundedContentRequest.GroundingSource.InlineSource, _Mapping]]=..., search_source: _Optional[_Union[GenerateGroundedContentRequest.GroundingSource.SearchSource, _Mapping]]=..., google_search_source: _Optional[_Union[GenerateGroundedContentRequest.GroundingSource.GoogleSearchSource, _Mapping]]=..., enterprise_web_retrieval_source: _Optional[_Union[GenerateGroundedContentRequest.GroundingSource.EnterpriseWebRetrievalSource, _Mapping]]=...) -> None:
            ...
...
class GenerateGroundedContentResponse(_message.Message):
    ...
    class Candidate(_message.Message):
        ...
        class GroundingMetadata(_message.Message):
            __slots__ = ('retrieval_metadata', 'support_chunks', 'web_search_queries', 'search_entry_point', 'grounding_support', 'images')
            ...
            class ImageMetadata(_message.Message):
                __slots__ = ('image', 'thumbnail', 'source')

                class WebsiteInfo(_message.Message):
                    __slots__ = ('uri', 'title')
                ...
                SOURCE_FIELD_NUMBER: _ClassVar[int]
                image: GenerateGroundedContentResponse.Candidate.GroundingMetadata.ImageMetadata.Image
                thumbnail: GenerateGroundedContentResponse.Candidate.GroundingMetadata.ImageMetadata.Image
                source: GenerateGroundedContentResponse.Candidate.GroundingMetadata.ImageMetadata.WebsiteInfo

                def __init__(self, image: _Optional[_Union[GenerateGroundedContentResponse.Candidate.GroundingMetadata.ImageMetadata.Image, _Mapping]]=..., thumbnail: _Optional[_Union[GenerateGroundedContentResponse.Candidate.GroundingMetadata.ImageMetadata.Image, _Mapping]]=..., source: _Optional[_Union[GenerateGroundedContentResponse.Candidate.GroundingMetadata.ImageMetadata.WebsiteInfo, _Mapping]]=...) -> None:
                    ...
...
class CheckGroundingSpec(_message.Message):
    __slots__ = ('citation_threshold', 'enable_claim_level_score')
    CITATION_THRESHOLD_FIELD_NUMBER: _ClassVar[int]
    ENABLE_CLAIM_LEVEL_SCORE_FIELD_NUMBER: _ClassVar[int]
    citation_threshold: float
    enable_claim_level_score: bool

    def __init__(self, citation_threshold: _Optional[float]=..., enable_claim_level_score: bool=...) -> None:
        ...
...
class CheckGroundingResponse(_message.Message):
    ...
    class Claim(_message.Message):
        __slots__ = ('start_pos', 'end_pos', 'claim_text', 'citation_indices', 'grounding_check_required', 'score')
        ...
        def __init__(self, start_pos: _Optional[int]=..., end_pos: _Optional[int]=..., claim_text: _Optional[str]=..., citation_indices: _Optional[_Iterable[int]]=..., grounding_check_required: bool=..., score: _Optional[float]=...) -> None:
            ...
    SUPPORT_SCORE_FIELD_NUMBER: _ClassVar[int]
