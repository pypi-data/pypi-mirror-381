...
class LocationFilter(_message.Message):
    __slots__ = ('address', 'region_code', 'lat_lng', 'distance_in_miles', 'telecommute_preference', 'negated')
    ...
    def __init__(self, address: _Optional[str]=..., region_code: _Optional[str]=..., lat_lng: _Optional[_Union[_latlng_pb2.LatLng, _Mapping]]=..., distance_in_miles: _Optional[float]=..., telecommute_preference: _Optional[_Union[LocationFilter.TelecommutePreference, str]]=..., negated: bool=...) -> None:
        ...
