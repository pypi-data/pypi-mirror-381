...
from google.cloud.securitycenter.v2 import access_pb2 as _access_pb2
from google.cloud.securitycenter.v2 import affected_resources_pb2 as _affected_resources_pb2
from google.cloud.securitycenter.v2 import ai_model_pb2 as _ai_model_pb2
from google.cloud.securitycenter.v2 import application_pb2 as _application_pb2
from google.cloud.securitycenter.v2 import attack_exposure_pb2 as _attack_exposure_pb2
from google.cloud.securitycenter.v2 import backup_disaster_recovery_pb2 as _backup_disaster_recovery_pb2
from google.cloud.securitycenter.v2 import chokepoint_pb2 as _chokepoint_pb2
from google.cloud.securitycenter.v2 import cloud_armor_pb2 as _cloud_armor_pb2
from google.cloud.securitycenter.v2 import cloud_dlp_data_profile_pb2 as _cloud_dlp_data_profile_pb2
from google.cloud.securitycenter.v2 import cloud_dlp_inspection_pb2 as _cloud_dlp_inspection_pb2
from google.cloud.securitycenter.v2 import compliance_pb2 as _compliance_pb2
from google.cloud.securitycenter.v2 import connection_pb2 as _connection_pb2
from google.cloud.securitycenter.v2 import contact_details_pb2 as _contact_details_pb2
from google.cloud.securitycenter.v2 import container_pb2 as _container_pb2
from google.cloud.securitycenter.v2 import data_access_event_pb2 as _data_access_event_pb2
from google.cloud.securitycenter.v2 import data_flow_event_pb2 as _data_flow_event_pb2
from google.cloud.securitycenter.v2 import data_retention_deletion_event_pb2 as _data_retention_deletion_event_pb2
from google.cloud.securitycenter.v2 import database_pb2 as _database_pb2
from google.cloud.securitycenter.v2 import disk_pb2 as _disk_pb2
from google.cloud.securitycenter.v2 import exfiltration_pb2 as _exfiltration_pb2
...
from google.cloud.securitycenter.v2 import group_membership_pb2 as _group_membership_pb2
from google.cloud.securitycenter.v2 import iam_binding_pb2 as _iam_binding_pb2
from google.cloud.securitycenter.v2 import indicator_pb2 as _indicator_pb2
from google.cloud.securitycenter.v2 import ip_rules_pb2 as _ip_rules_pb2
from google.cloud.securitycenter.v2 import job_pb2 as _job_pb2
from google.cloud.securitycenter.v2 import kernel_rootkit_pb2 as _kernel_rootkit_pb2
from google.cloud.securitycenter.v2 import kubernetes_pb2 as _kubernetes_pb2
from google.cloud.securitycenter.v2 import load_balancer_pb2 as _load_balancer_pb2
from google.cloud.securitycenter.v2 import log_entry_pb2 as _log_entry_pb2
from google.cloud.securitycenter.v2 import mitre_attack_pb2 as _mitre_attack_pb2
from google.cloud.securitycenter.v2 import network_pb2 as _network_pb2
from google.cloud.securitycenter.v2 import notebook_pb2 as _notebook_pb2
from google.cloud.securitycenter.v2 import org_policy_pb2 as _org_policy_pb2
from google.cloud.securitycenter.v2 import process_pb2 as _process_pb2
from google.cloud.securitycenter.v2 import security_marks_pb2 as _security_marks_pb2
from google.cloud.securitycenter.v2 import security_posture_pb2 as _security_posture_pb2
from google.cloud.securitycenter.v2 import toxic_combination_pb2 as _toxic_combination_pb2
from google.cloud.securitycenter.v2 import vertex_ai_pb2 as _vertex_ai_pb2
from google.cloud.securitycenter.v2 import vulnerability_pb2 as _vulnerability_pb2
...
class Finding(_message.Message):
    __slots__ = ('name', 'canonical_name', 'parent', 'resource_name', 'state', 'category', 'external_uri', 'source_properties', 'security_marks', 'event_time', 'create_time', 'severity', 'mute', 'mute_info', 'finding_class', 'indicator', 'vulnerability', 'mute_update_time', 'external_systems', 'mitre_attack', 'access', 'connections', 'mute_initiator', 'processes', 'contacts', 'compliances', 'parent_display_name', 'description', 'exfiltration', 'iam_bindings', 'next_steps', 'module_name', 'containers', 'kubernetes', 'database', 'attack_exposure', 'files', 'cloud_dlp_inspection', 'cloud_dlp_data_profile', 'kernel_rootkit', 'org_policies', 'job', 'application', 'ip_rules', 'backup_disaster_recovery', 'security_posture', 'log_entries', 'load_balancers', 'cloud_armor', 'notebook', 'toxic_combination', 'group_memberships', 'disk', 'data_access_events', 'data_flow_events', 'networks', 'data_retention_deletion_events', 'affected_resources', 'ai_model', 'chokepoint', 'vertex_ai')
    ...
    class FindingClass(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        SENSITIVE_DATA_RISK: _ClassVar[Finding.FindingClass]
        CHOKEPOINT: _ClassVar[Finding.FindingClass]
    ...
    SENSITIVE_DATA_RISK: Finding.FindingClass
    CHOKEPOINT: Finding.FindingClass
    ...
    DATA_FLOW_EVENTS_FIELD_NUMBER: _ClassVar[int]
    NETWORKS_FIELD_NUMBER: _ClassVar[int]
    DATA_RETENTION_DELETION_EVENTS_FIELD_NUMBER: _ClassVar[int]
    AFFECTED_RESOURCES_FIELD_NUMBER: _ClassVar[int]
    AI_MODEL_FIELD_NUMBER: _ClassVar[int]
    CHOKEPOINT_FIELD_NUMBER: _ClassVar[int]
    ...
    ip_rules: _ip_rules_pb2.IpRules
    ...
    disk: _disk_pb2.Disk
    data_access_events: _containers.RepeatedCompositeFieldContainer[_data_access_event_pb2.DataAccessEvent]
    data_flow_events: _containers.RepeatedCompositeFieldContainer[_data_flow_event_pb2.DataFlowEvent]
    networks: _containers.RepeatedCompositeFieldContainer[_network_pb2.Network]
    data_retention_deletion_events: _containers.RepeatedCompositeFieldContainer[_data_retention_deletion_event_pb2.DataRetentionDeletionEvent]
    affected_resources: _affected_resources_pb2.AffectedResources
    ai_model: _ai_model_pb2.AiModel
    chokepoint: _chokepoint_pb2.Chokepoint
    vertex_ai: _vertex_ai_pb2.VertexAi

    def __init__(self, name: _Optional[str]=..., canonical_name: _Optional[str]=..., parent: _Optional[str]=..., resource_name: _Optional[str]=..., state: _Optional[_Union[Finding.State, str]]=..., category: _Optional[str]=..., external_uri: _Optional[str]=..., source_properties: _Optional[_Mapping[str, _struct_pb2.Value]]=..., security_marks: _Optional[_Union[_security_marks_pb2.SecurityMarks, _Mapping]]=..., event_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., create_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., severity: _Optional[_Union[Finding.Severity, str]]=..., mute: _Optional[_Union[Finding.Mute, str]]=..., mute_info: _Optional[_Union[Finding.MuteInfo, _Mapping]]=..., finding_class: _Optional[_Union[Finding.FindingClass, str]]=..., indicator: _Optional[_Union[_indicator_pb2.Indicator, _Mapping]]=..., vulnerability: _Optional[_Union[_vulnerability_pb2.Vulnerability, _Mapping]]=..., mute_update_time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]]=..., external_systems: _Optional[_Mapping[str, _external_system_pb2.ExternalSystem]]=..., mitre_attack: _Optional[_Union[_mitre_attack_pb2.MitreAttack, _Mapping]]=..., access: _Optional[_Union[_access_pb2.Access, _Mapping]]=..., connections: _Optional[_Iterable[_Union[_connection_pb2.Connection, _Mapping]]]=..., mute_initiator: _Optional[str]=..., processes: _Optional[_Iterable[_Union[_process_pb2.Process, _Mapping]]]=..., contacts: _Optional[_Mapping[str, _contact_details_pb2.ContactDetails]]=..., compliances: _Optional[_Iterable[_Union[_compliance_pb2.Compliance, _Mapping]]]=..., parent_display_name: _Optional[str]=..., description: _Optional[str]=..., exfiltration: _Optional[_Union[_exfiltration_pb2.Exfiltration, _Mapping]]=..., iam_bindings: _Optional[_Iterable[_Union[_iam_binding_pb2.IamBinding, _Mapping]]]=..., next_steps: _Optional[str]=..., module_name: _Optional[str]=..., containers: _Optional[_Iterable[_Union[_container_pb2.Container, _Mapping]]]=..., kubernetes: _Optional[_Union[_kubernetes_pb2.Kubernetes, _Mapping]]=..., database: _Optional[_Union[_database_pb2.Database, _Mapping]]=..., attack_exposure: _Optional[_Union[_attack_exposure_pb2.AttackExposure, _Mapping]]=..., files: _Optional[_Iterable[_Union[_file_pb2.File, _Mapping]]]=..., cloud_dlp_inspection: _Optional[_Union[_cloud_dlp_inspection_pb2.CloudDlpInspection, _Mapping]]=..., cloud_dlp_data_profile: _Optional[_Union[_cloud_dlp_data_profile_pb2.CloudDlpDataProfile, _Mapping]]=..., kernel_rootkit: _Optional[_Union[_kernel_rootkit_pb2.KernelRootkit, _Mapping]]=..., org_policies: _Optional[_Iterable[_Union[_org_policy_pb2.OrgPolicy, _Mapping]]]=..., job: _Optional[_Union[_job_pb2.Job, _Mapping]]=..., application: _Optional[_Union[_application_pb2.Application, _Mapping]]=..., ip_rules: _Optional[_Union[_ip_rules_pb2.IpRules, _Mapping]]=..., backup_disaster_recovery: _Optional[_Union[_backup_disaster_recovery_pb2.BackupDisasterRecovery, _Mapping]]=..., security_posture: _Optional[_Union[_security_posture_pb2.SecurityPosture, _Mapping]]=..., log_entries: _Optional[_Iterable[_Union[_log_entry_pb2.LogEntry, _Mapping]]]=..., load_balancers: _Optional[_Iterable[_Union[_load_balancer_pb2.LoadBalancer, _Mapping]]]=..., cloud_armor: _Optional[_Union[_cloud_armor_pb2.CloudArmor, _Mapping]]=..., notebook: _Optional[_Union[_notebook_pb2.Notebook, _Mapping]]=..., toxic_combination: _Optional[_Union[_toxic_combination_pb2.ToxicCombination, _Mapping]]=..., group_memberships: _Optional[_Iterable[_Union[_group_membership_pb2.GroupMembership, _Mapping]]]=..., disk: _Optional[_Union[_disk_pb2.Disk, _Mapping]]=..., data_access_events: _Optional[_Iterable[_Union[_data_access_event_pb2.DataAccessEvent, _Mapping]]]=..., data_flow_events: _Optional[_Iterable[_Union[_data_flow_event_pb2.DataFlowEvent, _Mapping]]]=..., networks: _Optional[_Iterable[_Union[_network_pb2.Network, _Mapping]]]=..., data_retention_deletion_events: _Optional[_Iterable[_Union[_data_retention_deletion_event_pb2.DataRetentionDeletionEvent, _Mapping]]]=..., affected_resources: _Optional[_Union[_affected_resources_pb2.AffectedResources, _Mapping]]=..., ai_model: _Optional[_Union[_ai_model_pb2.AiModel, _Mapping]]=..., chokepoint: _Optional[_Union[_chokepoint_pb2.Chokepoint, _Mapping]]=..., vertex_ai: _Optional[_Union[_vertex_ai_pb2.VertexAi, _Mapping]]=...) -> None:
        ...