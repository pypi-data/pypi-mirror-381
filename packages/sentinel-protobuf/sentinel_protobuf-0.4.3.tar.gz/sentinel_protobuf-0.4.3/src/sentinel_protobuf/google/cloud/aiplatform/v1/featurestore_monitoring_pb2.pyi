...
class FeaturestoreMonitoringConfig(_message.Message):
    ...
    class SnapshotAnalysis(_message.Message):
        __slots__ = ('disabled', 'monitoring_interval_days', 'staleness_days')
        ...
        def __init__(self, disabled: bool=..., monitoring_interval_days: _Optional[int]=..., staleness_days: _Optional[int]=...) -> None:
            ...
