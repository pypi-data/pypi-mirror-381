...
from google.cloud.vision.v1p4beta1 import face_pb2 as _face_pb2
from google.cloud.vision.v1p4beta1 import geometry_pb2 as _geometry_pb2
from google.cloud.vision.v1p4beta1 import product_search_pb2 as _product_search_pb2
from google.cloud.vision.v1p4beta1 import text_annotation_pb2 as _text_annotation_pb2
from google.cloud.vision.v1p4beta1 import web_detection_pb2 as _web_detection_pb2
...
class Feature(_message.Message):
    ...
    class Type(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        PRODUCT_SEARCH: _ClassVar[Feature.Type]
        OBJECT_LOCALIZATION: _ClassVar[Feature.Type]
    ...
    PRODUCT_SEARCH: Feature.Type
    OBJECT_LOCALIZATION: Feature.Type
...
class FaceAnnotation(_message.Message):
    __slots__ = ('bounding_poly', 'fd_bounding_poly', 'landmarks', 'roll_angle', 'pan_angle', 'tilt_angle', 'detection_confidence', 'landmarking_confidence', 'joy_likelihood', 'sorrow_likelihood', 'anger_likelihood', 'surprise_likelihood', 'under_exposed_likelihood', 'blurred_likelihood', 'headwear_likelihood', 'recognition_result')
...
class LocalizedObjectAnnotation(_message.Message):
    __slots__ = ('mid', 'language_code', 'name', 'score', 'bounding_poly')
    MID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, mid: _Optional[str]=..., language_code: _Optional[str]=..., name: _Optional[str]=..., score: _Optional[float]=..., bounding_poly: _Optional[_Union[_geometry_pb2.BoundingPoly, _Mapping]]=...) -> None:
        ...
...
class ImageContext(_message.Message):
    __slots__ = ('lat_long_rect', 'language_hints', 'crop_hints_params', 'face_recognition_params', 'product_search_params', 'web_detection_params', 'text_detection_params')
    ...
    FACE_RECOGNITION_PARAMS_FIELD_NUMBER: _ClassVar[int]
    PRODUCT_SEARCH_PARAMS_FIELD_NUMBER: _ClassVar[int]
    ...
    face_recognition_params: _face_pb2.FaceRecognitionParams
    product_search_params: _product_search_pb2.ProductSearchParams
    web_detection_params: WebDetectionParams
    text_detection_params: TextDetectionParams

    def __init__(self, lat_long_rect: _Optional[_Union[LatLongRect, _Mapping]]=..., language_hints: _Optional[_Iterable[str]]=..., crop_hints_params: _Optional[_Union[CropHintsParams, _Mapping]]=..., face_recognition_params: _Optional[_Union[_face_pb2.FaceRecognitionParams, _Mapping]]=..., product_search_params: _Optional[_Union[_product_search_pb2.ProductSearchParams, _Mapping]]=..., web_detection_params: _Optional[_Union[WebDetectionParams, _Mapping]]=..., text_detection_params: _Optional[_Union[TextDetectionParams, _Mapping]]=...) -> None:
        ...
...
class AnnotateImageResponse(_message.Message):
    __slots__ = ('face_annotations', 'landmark_annotations', 'logo_annotations', 'label_annotations', 'localized_object_annotations', 'text_annotations', 'full_text_annotation', 'safe_search_annotation', 'image_properties_annotation', 'crop_hints_annotation', 'web_detection', 'product_search_results', 'error', 'context')
    ...
    LOCALIZED_OBJECT_ANNOTATIONS_FIELD_NUMBER: _ClassVar[int]
    ...
    PRODUCT_SEARCH_RESULTS_FIELD_NUMBER: _ClassVar[int]
    ...
    localized_object_annotations: _containers.RepeatedCompositeFieldContainer[LocalizedObjectAnnotation]
    ...
    product_search_results: _product_search_pb2.ProductSearchResults
    error: _status_pb2.Status
    context: ImageAnnotationContext

    def __init__(self, face_annotations: _Optional[_Iterable[_Union[FaceAnnotation, _Mapping]]]=..., landmark_annotations: _Optional[_Iterable[_Union[EntityAnnotation, _Mapping]]]=..., logo_annotations: _Optional[_Iterable[_Union[EntityAnnotation, _Mapping]]]=..., label_annotations: _Optional[_Iterable[_Union[EntityAnnotation, _Mapping]]]=..., localized_object_annotations: _Optional[_Iterable[_Union[LocalizedObjectAnnotation, _Mapping]]]=..., text_annotations: _Optional[_Iterable[_Union[EntityAnnotation, _Mapping]]]=..., full_text_annotation: _Optional[_Union[_text_annotation_pb2.TextAnnotation, _Mapping]]=..., safe_search_annotation: _Optional[_Union[SafeSearchAnnotation, _Mapping]]=..., image_properties_annotation: _Optional[_Union[ImageProperties, _Mapping]]=..., crop_hints_annotation: _Optional[_Union[CropHintsAnnotation, _Mapping]]=..., web_detection: _Optional[_Union[_web_detection_pb2.WebDetection, _Mapping]]=..., product_search_results: _Optional[_Union[_product_search_pb2.ProductSearchResults, _Mapping]]=..., error: _Optional[_Union[_status_pb2.Status, _Mapping]]=..., context: _Optional[_Union[ImageAnnotationContext, _Mapping]]=...) -> None:
        ...
...
class AnnotateFileRequest(_message.Message):
    __slots__ = ('input_config', 'features', 'image_context', 'pages')
    ...
    def __init__(self, input_config: _Optional[_Union[InputConfig, _Mapping]]=..., features: _Optional[_Iterable[_Union[Feature, _Mapping]]]=..., image_context: _Optional[_Union[ImageContext, _Mapping]]=..., pages: _Optional[_Iterable[int]]=...) -> None:
        ...

class AnnotateFileResponse(_message.Message):
    __slots__ = ('input_config', 'responses', 'total_pages', 'error')
    INPUT_CONFIG_FIELD_NUMBER: _ClassVar[int]
    RESPONSES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, input_config: _Optional[_Union[InputConfig, _Mapping]]=..., responses: _Optional[_Iterable[_Union[AnnotateImageResponse, _Mapping]]]=..., total_pages: _Optional[int]=..., error: _Optional[_Union[_status_pb2.Status, _Mapping]]=...) -> None:
        ...

class BatchAnnotateFilesRequest(_message.Message):
    __slots__ = ('requests',)
    REQUESTS_FIELD_NUMBER: _ClassVar[int]
    requests: _containers.RepeatedCompositeFieldContainer[AnnotateFileRequest]

    def __init__(self, requests: _Optional[_Iterable[_Union[AnnotateFileRequest, _Mapping]]]=...) -> None:
        ...

class BatchAnnotateFilesResponse(_message.Message):
    __slots__ = ('responses',)
    RESPONSES_FIELD_NUMBER: _ClassVar[int]
    responses: _containers.RepeatedCompositeFieldContainer[AnnotateFileResponse]

    def __init__(self, responses: _Optional[_Iterable[_Union[AnnotateFileResponse, _Mapping]]]=...) -> None:
        ...
...
class AsyncBatchAnnotateImagesRequest(_message.Message):
    __slots__ = ('requests', 'output_config')
    REQUESTS_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_CONFIG_FIELD_NUMBER: _ClassVar[int]
    requests: _containers.RepeatedCompositeFieldContainer[AnnotateImageRequest]
    output_config: OutputConfig

    def __init__(self, requests: _Optional[_Iterable[_Union[AnnotateImageRequest, _Mapping]]]=..., output_config: _Optional[_Union[OutputConfig, _Mapping]]=...) -> None:
        ...

class AsyncBatchAnnotateImagesResponse(_message.Message):
    __slots__ = ('output_config',)
    OUTPUT_CONFIG_FIELD_NUMBER: _ClassVar[int]
    output_config: OutputConfig
...
class InputConfig(_message.Message):
    __slots__ = ('gcs_source', 'content', 'mime_type')
    ...
    def __init__(self, gcs_source: _Optional[_Union[GcsSource, _Mapping]]=..., content: _Optional[bytes]=..., mime_type: _Optional[str]=...) -> None:
        ...
