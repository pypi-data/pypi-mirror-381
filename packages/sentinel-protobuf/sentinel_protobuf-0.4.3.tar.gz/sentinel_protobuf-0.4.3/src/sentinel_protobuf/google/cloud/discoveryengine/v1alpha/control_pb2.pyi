...
class Condition(_message.Message):
    __slots__ = ('query_terms', 'active_time_range')
    ...
    def __init__(self, query_terms: _Optional[_Iterable[_Union[Condition.QueryTerm, _Mapping]]]=..., active_time_range: _Optional[_Iterable[_Union[Condition.TimeRange, _Mapping]]]=...) -> None:
        ...
