...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_BIGQUERYDATESHARDEDSPEC'].fields_by_name['latest_shard_resource']._loaded_options = None
    _globals['_BIGQUERYDATESHARDEDSPEC'].fields_by_name['latest_shard_resource']._serialized_options = b'\xe0A\x03'
    _globals['_TABLESOURCETYPE']._serialized_start = 663
    _globals['_TABLESOURCETYPE']._serialized_end = 786
    _globals['_BIGQUERYTABLESPEC']._serialized_start = 138
    _globals['_BIGQUERYTABLESPEC']._serialized_end = 370
    _globals['_VIEWSPEC']._serialized_start = 372
    _globals['_VIEWSPEC']._serialized_end = 407
    _globals['_TABLESPEC']._serialized_start = 409
    _globals['_TABLESPEC']._serialized_end = 485
    _globals['_BIGQUERYDATESHARDEDSPEC']._serialized_start = 488
    _globals['_BIGQUERYDATESHARDEDSPEC']._serialized_end = 661