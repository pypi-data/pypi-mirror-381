...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 5, 29, 0, '', 'google/cloud/retail/v2beta/product.proto')
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_PRODUCT']._serialized_start = 349
    _globals['_PRODUCT']._serialized_end = 2156
    _globals['_PRODUCT_ATTRIBUTESENTRY']._serialized_start = 1734
    _globals['_PRODUCT_ATTRIBUTESENTRY']._serialized_end = 1828
    _globals['_PRODUCT_TYPE']._serialized_start = 1830
    _globals['_PRODUCT_TYPE']._serialized_end = 1900
    _globals['_PRODUCT_AVAILABILITY']._serialized_start = 1902
    _globals['_PRODUCT_AVAILABILITY']._serialized_end = 2007