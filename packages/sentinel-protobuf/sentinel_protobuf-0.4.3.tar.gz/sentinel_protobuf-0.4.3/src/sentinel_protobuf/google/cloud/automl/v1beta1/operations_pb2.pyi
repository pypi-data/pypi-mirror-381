...
class OperationMetadata(_message.Message):
    __slots__ = ('delete_details', 'deploy_model_details', 'undeploy_model_details', 'create_model_details', 'import_data_details', 'batch_predict_details', 'export_data_details', 'export_model_details', 'export_evaluated_examples_details', 'progress_percent', 'partial_failures', 'create_time', 'update_time')
    ...
    EXPORT_EVALUATED_EXAMPLES_DETAILS_FIELD_NUMBER: _ClassVar[int]
...
class ExportDataOperationMetadata(_message.Message):
    ...
    class ExportDataOutputInfo(_message.Message):
        __slots__ = ('gcs_output_directory', 'bigquery_output_dataset')
        ...
        def __init__(self, gcs_output_directory: _Optional[str]=..., bigquery_output_dataset: _Optional[str]=...) -> None:
            ...
...
class ExportEvaluatedExamplesOperationMetadata(_message.Message):
    __slots__ = ('output_info',)

    class ExportEvaluatedExamplesOutputInfo(_message.Message):
        __slots__ = ('bigquery_output_dataset',)
        BIGQUERY_OUTPUT_DATASET_FIELD_NUMBER: _ClassVar[int]
        bigquery_output_dataset: str

        def __init__(self, bigquery_output_dataset: _Optional[str]=...) -> None:
            ...
    OUTPUT_INFO_FIELD_NUMBER: _ClassVar[int]
    output_info: ExportEvaluatedExamplesOperationMetadata.ExportEvaluatedExamplesOutputInfo

    def __init__(self, output_info: _Optional[_Union[ExportEvaluatedExamplesOperationMetadata.ExportEvaluatedExamplesOutputInfo, _Mapping]]=...) -> None:
        ...