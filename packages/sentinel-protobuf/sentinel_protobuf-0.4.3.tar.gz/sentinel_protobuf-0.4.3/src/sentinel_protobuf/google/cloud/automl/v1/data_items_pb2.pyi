...
from google.cloud.automl.v1 import text_segment_pb2 as _text_segment_pb2
...
class Image(_message.Message):
    __slots__ = ('image_bytes', 'thumbnail_uri')
    IMAGE_BYTES_FIELD_NUMBER: _ClassVar[int]
    THUMBNAIL_URI_FIELD_NUMBER: _ClassVar[int]
    image_bytes: bytes
    thumbnail_uri: str

    def __init__(self, image_bytes: _Optional[bytes]=..., thumbnail_uri: _Optional[str]=...) -> None:
        ...
...
class ExamplePayload(_message.Message):
    __slots__ = ('image', 'text_snippet', 'document')
    ...
    def __init__(self, image: _Optional[_Union[Image, _Mapping]]=..., text_snippet: _Optional[_Union[TextSnippet, _Mapping]]=..., document: _Optional[_Union[Document, _Mapping]]=...) -> None:
        ...