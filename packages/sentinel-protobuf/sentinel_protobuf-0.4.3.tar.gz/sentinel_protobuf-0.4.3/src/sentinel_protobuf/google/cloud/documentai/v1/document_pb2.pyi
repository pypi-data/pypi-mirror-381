...
from google.cloud.documentai.v1 import barcode_pb2 as _barcode_pb2
from google.cloud.documentai.v1 import geometry_pb2 as _geometry_pb2
...
class Document(_message.Message):
    __slots__ = ('uri', 'content', 'docid', 'mime_type', 'text', 'text_styles', 'pages', 'entities', 'entity_relations', 'text_changes', 'shard_info', 'error', 'revisions', 'document_layout', 'chunked_document')
    ...
    class Entity(_message.Message):
        __slots__ = ('text_anchor', 'type', 'mention_text', 'mention_id', 'confidence', 'page_anchor', 'id', 'normalized_value', 'properties', 'provenance', 'redacted', 'method')

        class Method(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
            __slots__ = ()
            METHOD_UNSPECIFIED: _ClassVar[Document.Entity.Method]
            EXTRACT: _ClassVar[Document.Entity.Method]
            DERIVE: _ClassVar[Document.Entity.Method]
        METHOD_UNSPECIFIED: Document.Entity.Method
        EXTRACT: Document.Entity.Method
        DERIVE: Document.Entity.Method

        class NormalizedValue(_message.Message):
            __slots__ = ('money_value', 'date_value', 'datetime_value', 'address_value', 'boolean_value', 'integer_value', 'float_value', 'signature_value', 'text')
            ...
            SIGNATURE_VALUE_FIELD_NUMBER: _ClassVar[int]
            ...
            def __init__(self, money_value: _Optional[_Union[_money_pb2.Money, _Mapping]]=..., date_value: _Optional[_Union[_date_pb2.Date, _Mapping]]=..., datetime_value: _Optional[_Union[_datetime_pb2.DateTime, _Mapping]]=..., address_value: _Optional[_Union[_postal_address_pb2.PostalAddress, _Mapping]]=..., boolean_value: bool=..., integer_value: _Optional[int]=..., float_value: _Optional[float]=..., signature_value: bool=..., text: _Optional[str]=...) -> None:
                ...
        TEXT_ANCHOR_FIELD_NUMBER: _ClassVar[int]
        TYPE_FIELD_NUMBER: _ClassVar[int]
    ...
    class DocumentLayout(_message.Message):
        ...
        class DocumentLayoutBlock(_message.Message):
            __slots__ = ('text_block', 'table_block', 'list_block', 'block_id', 'page_span', 'bounding_box')
            ...
            def __init__(self, text_block: _Optional[_Union[Document.DocumentLayout.DocumentLayoutBlock.LayoutTextBlock, _Mapping]]=..., table_block: _Optional[_Union[Document.DocumentLayout.DocumentLayoutBlock.LayoutTableBlock, _Mapping]]=..., list_block: _Optional[_Union[Document.DocumentLayout.DocumentLayoutBlock.LayoutListBlock, _Mapping]]=..., block_id: _Optional[str]=..., page_span: _Optional[_Union[Document.DocumentLayout.DocumentLayoutBlock.LayoutPageSpan, _Mapping]]=..., bounding_box: _Optional[_Union[_geometry_pb2.BoundingPoly, _Mapping]]=...) -> None:
                ...
        BLOCKS_FIELD_NUMBER: _ClassVar[int]
        blocks: _containers.RepeatedCompositeFieldContainer[Document.DocumentLayout.DocumentLayoutBlock]
    ...
    class ChunkedDocument(_message.Message):
        ...
        class Chunk(_message.Message):
            __slots__ = ('chunk_id', 'source_block_ids', 'content', 'page_span', 'page_headers', 'page_footers')
            ...
            def __init__(self, chunk_id: _Optional[str]=..., source_block_ids: _Optional[_Iterable[str]]=..., content: _Optional[str]=..., page_span: _Optional[_Union[Document.ChunkedDocument.Chunk.ChunkPageSpan, _Mapping]]=..., page_headers: _Optional[_Iterable[_Union[Document.ChunkedDocument.Chunk.ChunkPageHeader, _Mapping]]]=..., page_footers: _Optional[_Iterable[_Union[Document.ChunkedDocument.Chunk.ChunkPageFooter, _Mapping]]]=...) -> None:
                ...
