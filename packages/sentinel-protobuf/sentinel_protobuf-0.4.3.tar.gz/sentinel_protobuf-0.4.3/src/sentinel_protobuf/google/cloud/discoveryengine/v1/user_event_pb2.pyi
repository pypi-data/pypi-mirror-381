...
class UserEvent(_message.Message):
    __slots__ = ('event_type', 'conversion_type', 'user_pseudo_id', 'engine', 'data_store', 'event_time', 'user_info', 'direct_user_request', 'session_id', 'page_info', 'attribution_token', 'filter', 'documents', 'panel', 'search_info', 'completion_info', 'transaction_info', 'tag_ids', 'promotion_ids', 'attributes', 'media_info', 'panels')
...
class DocumentInfo(_message.Message):
    __slots__ = ('id', 'name', 'uri', 'quantity', 'promotion_ids', 'joined', 'conversion_value')
    ...
    def __init__(self, id: _Optional[str]=..., name: _Optional[str]=..., uri: _Optional[str]=..., quantity: _Optional[int]=..., promotion_ids: _Optional[_Iterable[str]]=..., joined: bool=..., conversion_value: _Optional[float]=...) -> None:
        ...

class PanelInfo(_message.Message):
    __slots__ = ('panel_id', 'display_name', 'panel_position', 'total_panels', 'documents')
    ...
    def __init__(self, panel_id: _Optional[str]=..., display_name: _Optional[str]=..., panel_position: _Optional[int]=..., total_panels: _Optional[int]=..., documents: _Optional[_Iterable[_Union[DocumentInfo, _Mapping]]]=...) -> None:
        ...
