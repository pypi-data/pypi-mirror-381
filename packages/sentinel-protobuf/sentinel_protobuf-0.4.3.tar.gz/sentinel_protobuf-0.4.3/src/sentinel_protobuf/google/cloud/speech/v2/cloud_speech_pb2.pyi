...
class DenoiserConfig(_message.Message):
    __slots__ = ('denoise_audio', 'snr_threshold')
    DENOISE_AUDIO_FIELD_NUMBER: _ClassVar[int]
    SNR_THRESHOLD_FIELD_NUMBER: _ClassVar[int]
    denoise_audio: bool
    snr_threshold: float

    def __init__(self, denoise_audio: bool=..., snr_threshold: _Optional[float]=...) -> None:
        ...

class RecognitionConfig(_message.Message):
    __slots__ = ('auto_decoding_config', 'explicit_decoding_config', 'model', 'language_codes', 'features', 'adaptation', 'transcript_normalization', 'translation_config', 'denoiser_config')
    ...
    DENOISER_CONFIG_FIELD_NUMBER: _ClassVar[int]
