...
class TuningExamples(_message.Message):
    __slots__ = ('examples', 'multiturn_examples')
    EXAMPLES_FIELD_NUMBER: _ClassVar[int]
    MULTITURN_EXAMPLES_FIELD_NUMBER: _ClassVar[int]
    examples: _containers.RepeatedCompositeFieldContainer[TuningExample]
    multiturn_examples: _containers.RepeatedCompositeFieldContainer[TuningMultiturnExample]

    def __init__(self, examples: _Optional[_Iterable[_Union[TuningExample, _Mapping]]]=..., multiturn_examples: _Optional[_Iterable[_Union[TuningMultiturnExample, _Mapping]]]=...) -> None:
        ...

class TuningPart(_message.Message):
    __slots__ = ('text',)
...
class TuningContent(_message.Message):
    __slots__ = ('parts', 'role')
    PARTS_FIELD_NUMBER: _ClassVar[int]
    ROLE_FIELD_NUMBER: _ClassVar[int]
    parts: _containers.RepeatedCompositeFieldContainer[TuningPart]
    role: str

    def __init__(self, parts: _Optional[_Iterable[_Union[TuningPart, _Mapping]]]=..., role: _Optional[str]=...) -> None:
        ...

class TuningMultiturnExample(_message.Message):
    __slots__ = ('system_instruction', 'contents')
    SYSTEM_INSTRUCTION_FIELD_NUMBER: _ClassVar[int]
    CONTENTS_FIELD_NUMBER: _ClassVar[int]
    system_instruction: TuningContent
    contents: _containers.RepeatedCompositeFieldContainer[TuningContent]

    def __init__(self, system_instruction: _Optional[_Union[TuningContent, _Mapping]]=..., contents: _Optional[_Iterable[_Union[TuningContent, _Mapping]]]=...) -> None:
        ...
