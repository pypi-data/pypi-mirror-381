...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['DESCRIPTOR']._serialized_options = b'\n(com.google.ai.generativelanguage.v1beta3B\x0fTunedModelProtoP\x01Z^cloud.google.com/go/ai/generativelanguage/apiv1beta3/generativelanguagepb;generativelanguagepb'
    ...
    _globals['_HYPERPARAMETERS'].fields_by_name['learning_rate']._serialized_options = b'\xe0A\x05'
    ...
    _globals['_TUNINGEXAMPLES'].fields_by_name['examples']._serialized_options = b'\xe0A\x02'
