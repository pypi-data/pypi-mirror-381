from google.ai.generativelanguage.v1 import citation_pb2 as _citation_pb2
from google.ai.generativelanguage.v1 import content_pb2 as _content_pb2
from google.ai.generativelanguage.v1 import safety_pb2 as _safety_pb2
...
class GenerateContentRequest(_message.Message):
    __slots__ = ('model', 'contents', 'safety_settings', 'generation_config')
    ...
    def __init__(self, model: _Optional[str]=..., contents: _Optional[_Iterable[_Union[_content_pb2.Content, _Mapping]]]=..., safety_settings: _Optional[_Iterable[_Union[_safety_pb2.SafetySetting, _Mapping]]]=..., generation_config: _Optional[_Union[GenerationConfig, _Mapping]]=...) -> None:
        ...

class GenerationConfig(_message.Message):
    __slots__ = ('candidate_count', 'stop_sequences', 'max_output_tokens', 'temperature', 'top_p', 'top_k', 'seed', 'presence_penalty', 'frequency_penalty', 'response_logprobs', 'logprobs', 'enable_enhanced_civic_answers')
    ...
    def __init__(self, candidate_count: _Optional[int]=..., stop_sequences: _Optional[_Iterable[str]]=..., max_output_tokens: _Optional[int]=..., temperature: _Optional[float]=..., top_p: _Optional[float]=..., top_k: _Optional[int]=..., seed: _Optional[int]=..., presence_penalty: _Optional[float]=..., frequency_penalty: _Optional[float]=..., response_logprobs: bool=..., logprobs: _Optional[int]=..., enable_enhanced_civic_answers: bool=...) -> None:
        ...
...
class GenerateContentResponse(_message.Message):
    ...
    class UsageMetadata(_message.Message):
        __slots__ = ('prompt_token_count', 'candidates_token_count', 'tool_use_prompt_token_count', 'thoughts_token_count', 'total_token_count', 'prompt_tokens_details', 'cache_tokens_details', 'candidates_tokens_details', 'tool_use_prompt_tokens_details')
...
class Candidate(_message.Message):
    __slots__ = ('index', 'content', 'finish_reason', 'safety_ratings', 'citation_metadata', 'token_count', 'grounding_metadata', 'avg_logprobs', 'logprobs_result', 'url_context_metadata')
...
class CountTokensResponse(_message.Message):
    __slots__ = ('total_tokens', 'prompt_tokens_details', 'cache_tokens_details')
    ...
    def __init__(self, total_tokens: _Optional[int]=..., prompt_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=..., cache_tokens_details: _Optional[_Iterable[_Union[_content_pb2.ModalityTokenCount, _Mapping]]]=...) -> None:
        ...