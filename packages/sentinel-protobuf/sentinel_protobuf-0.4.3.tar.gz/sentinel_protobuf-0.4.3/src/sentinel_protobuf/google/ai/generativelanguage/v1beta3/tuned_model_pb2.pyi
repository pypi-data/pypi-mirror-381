...
class TunedModel(_message.Message):
    __slots__ = ('tuned_model_source', 'base_model', 'name', 'display_name', 'description', 'temperature', 'top_p', 'top_k', 'state', 'create_time', 'update_time', 'tuning_task')
...
class Hyperparameters(_message.Message):
    __slots__ = ('epoch_count', 'batch_size', 'learning_rate')
    ...
    def __init__(self, epoch_count: _Optional[int]=..., batch_size: _Optional[int]=..., learning_rate: _Optional[float]=...) -> None:
        ...
