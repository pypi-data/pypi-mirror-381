...
------------ | ------------- | ------------- | -------------
*AsyncApi* | [**create_async_prescription**](docs/AsyncApi.md#create_async_prescription) | **POST** /swifty/1/async/prescription | Create a new prescription that will be processed asynchronously.
