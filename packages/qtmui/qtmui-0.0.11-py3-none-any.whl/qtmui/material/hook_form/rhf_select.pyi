...
class RHFSelect:
    def __init__(self, name: str, label: str, native: bool, maxHeight: int, onChange: Optional[Callable], PaperPropsSx: object, helperText: str, children: object, selected: bool, **kwargs): ...
