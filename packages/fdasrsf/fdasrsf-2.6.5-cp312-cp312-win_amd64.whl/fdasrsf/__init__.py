...
from .plot_style import (
    ...
    plot_curve,
    plot_reg_open_curve,
    plot_geod_open_curve,
    plot_geod_close_curve,
)
...
from .fPCA import fdavpca, fdahpca, fdahpcah, fdajpca, fdajpcah
...
from .elastic_changepoint import (
...
from .curve_regression import (
    oc_elastic_regression,
    oc_elastic_logistic,
    preproc_open_curve,
    oc_elastic_mlogistic,
)
