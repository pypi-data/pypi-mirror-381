...
class _BackgroundFrameGenerator:
    ...
    def full_black(
        ...
        """
        return _BackgroundFrameGenerator._full_color(
            color = 'black',
            size = size,
            dtype = dtype,
            pts = pts,
    ...
    def _full_color(
        ...
        *For internal use only*
        ...
        # In the RGBFrameGenerator we use alpha
        # in the [0, 255] range
        # alpha is actually the color presence,
        # which is the opposite to transparency
        alpha = (
...
class VideoFrameGenerator:
    ...
    background: _BackgroundFrameGenerator = _BackgroundFrameGenerator
    """
    Shortcut to the background generation.
    """
