...
from floorplan_epc_detector.samclip.utils.tokenization_utils import PreTrainedTokenizer
from floorplan_epc_detector.samclip.utils.tokenization_utils_base import AddedToken
from floorplan_epc_detector.samclip.utils import sentencepiece_model_pb2_new as sentencepiece_model_pb2

if TYPE_CHECKING:
    from floorplan_epc_detector.samclip.utils.tokenization_utils_base import TextInput
from floorplan_epc_detector.samclip.utils import logging, requires_backends
...
class SiglipTokenizer(PreTrainedTokenizer):
    ...
    def get_spm_processor(self):
        ...
        with open(self.vocab_file, "rb") as f:
            sp_model = f.read()
            ##changed from import_protobuf()
            model_pb2 = sentencepiece_model_pb2
