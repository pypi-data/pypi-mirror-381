    ...
    def __init__(
        ...
        if 'siglip' in type:
            ...
            if not os.path.exists(tokenizer_path):
                ...
                # Add download URL for the tokenizer file
                tokenizer_url = "https://drive.google.com/file/d/1FGhJS6mzMzd_tN1rwCZZ5OQrEWETqGBg/view?usp=drive_link"
                gdown.download(url=tokenizer_url, output=tokenizer_path, fuzzy=True)
    ...
    def _load_model(self, path: str):
        ...
        try:
            if os.path.exists(path):
                ...
                logging.info(f"Model file not found at {path}, downloading...")
                ...
                if not os.path.exists(path):
                    raise RuntimeError(f"Failed to download model file to {path}")
