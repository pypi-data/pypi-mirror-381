...
def test():
    ...
    composition_mass = [0.3, 0.2, 0.5]

    # Define the material
    material = Material(name = material_name, components = [MaterialComponent(name = 'TOLUENE', mole_fraction=0.3), 
                                                            MaterialComponent(name = 'PROPANE', mole_fraction= 0.2),
                                                            MaterialComponent(name = 'N-BUTANE', mole_fraction= 0.5)], component_count= 3)
