...
from pypws.materials import get_component_by_name

def test_get_component_by_name_1_2_PROPYLENE_OXIDE():
    ...
    # Invoke the method.
    print ('Running get_component_by_name')
    materialComponentData = get_component_by_name('1,2-PROPYLENE OXIDE')
