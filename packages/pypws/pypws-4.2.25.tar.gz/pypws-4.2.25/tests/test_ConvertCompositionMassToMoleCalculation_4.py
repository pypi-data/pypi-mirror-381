...
def test():
    ...
    composition_mass = [0.2, 0.2, 0.6]

    # Define the material
    material = Material(name = material_name, components = [MaterialComponent(name = 'N-BUTANE', mole_fraction=0.2), 
                                                            MaterialComponent(name = 'N-DECANE', mole_fraction= 0.2),
                                                            MaterialComponent(name = 'ETHANE', mole_fraction= 0.6)], component_count= 3)
