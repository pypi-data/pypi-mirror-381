...
def test():
    ...
    explosion_output_config = ExplosionOutputConfig(overpressure_level = 2068)
    ...
    if resultCode == resultCode.SUCCESS:
        ...
        if not isinstance(late_explosion_calculation.explosion_unif_conf_overpressure_result.exploded_mass, (int, float)) or late_explosion_calculation.explosion_unif_conf_overpressure_result.exploded_mass == 0:
        ...
        if not isinstance(late_explosion_calculation.explosion_unif_conf_overpressure_result.ignition_time, (int, float)) or late_explosion_calculation.explosion_unif_conf_overpressure_result.ignition_time == 0:
        ...
        if not isinstance(late_explosion_calculation.explosion_unif_conf_overpressure_result.maximum_distance, (int, float)) or late_explosion_calculation.explosion_unif_conf_overpressure_result.maximum_distance == 0:
