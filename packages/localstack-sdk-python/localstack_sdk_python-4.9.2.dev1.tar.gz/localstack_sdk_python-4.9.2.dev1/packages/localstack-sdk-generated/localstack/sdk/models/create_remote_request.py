...
class CreateRemoteRequest(BaseModel):
    ...
    remote_url: Optional[StrictStr] = Field(default=None, description="URL of the remote server.")
    __properties: ClassVar[List[str]] = ["protocols", "remote_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateRemoteRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateRemoteRequest from a dict"""
        if obj is None:
            return None
