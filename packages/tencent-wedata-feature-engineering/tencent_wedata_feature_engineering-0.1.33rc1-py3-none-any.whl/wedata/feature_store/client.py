...
class FeatureStoreClient:
    ...
    def register_table(self, name: str, timestamp_key: str, engine_type: EngineTypes,
                       database_name: Optional[str] = None,
    ...
    def drop_table(self, name: str, database_name: Optional[str] = None, is_auto_delete_online=False) -> None:
        """
        删除特征表
        ...
        Args:
            ...
            is_auto_delete_online: 是否自动删除在线特征表（默认不删除）
        Returns:
            None
        """

        return self._feature_table_client.drop_table(name, database_name, is_auto_delete_online=is_auto_delete_online)
