...
if __name__ == "__main__":
    result = check_package_version("pyspark", "3.1.0", ">=")
    print(result)
#     # 测试示例
#
#     tests = [
...
#     ]
#
#     for installed, spec, expected in tests:
#         result = compare_versions(installed, spec)
#         print(f"{installed} {spec} -> {result} (Expected: {expected}) {'✅' if result == expected else '❌'}")