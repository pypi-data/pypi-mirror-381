...
def is_version_upgrade(app="flexlar", bench_path=".", branch=None):
...
def get_current_flexlar_version(bench_path="."):
	try:
		return get_major_version(get_current_version("flexlar", bench_path=bench_path))
	except OSError:
		return 0
