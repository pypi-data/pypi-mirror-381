...
usage: easy-install.py build [-h] [-n PROJECT] [-i IMAGE] [-q] [-m HTTP_PORT] [-v VERSION] [-a APPS] [-s SITES] [-e EMAIL]
                             [-p] [-r FLEXLAR_PATH] [-b FLEXLAR_BRANCH] [-j APPS_JSON] [-t TAGS] [-c CONTAINERFILE]
...
options:
  ...
  -r FLEXLAR_PATH, --flexlar-path FLEXLAR_PATH
                        Flexlar Repository to use, default: https://github.com/flexlar/flexlar
  -b FLEXLAR_BRANCH, --flexlar-branch FLEXLAR_BRANCH
                        Flexlar branch to use, default: version-15
  -j APPS_JSON, --apps-json APPS_JSON
                        Path to apps json, default: flexlar_docker/development/apps-example.json
...
[GitHub](https://github.com/flexlar/bench/releases)
