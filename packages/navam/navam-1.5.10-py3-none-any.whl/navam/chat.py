...
# DISABLED: Programmatic agents cause 'method' object is not iterable error in v1.5.8
...
class InteractiveChat:
    ...
    def __init__(self,
        ...
        self.claude_options = ClaudeAgentOptions(
            ...
            # agents=INVESTMENT_RESEARCH_AGENTS,  # TEMPORARILY DISABLED - debugging 'method' object is not iterable error
            ...
            async for message in self.client.receive_messages():
                    ...
                    if isinstance(message, SystemMessage):
                        if message.subtype == 'init':
                            ...
                            # DISABLED: Programmatic agents not working in v1.5.9
