...
class ReceivePaymentResponse:
    ...
    def __init__(self, *, destination: "str", liquid_expiration_blockheight: "typing.Optional[int]", bitcoin_expiration_blockheight: "typing.Optional[int]"):
        self.destination = destination
    ...
    def __str__(self):
        return "ReceivePaymentResponse(destination={}, liquid_expiration_blockheight={}, bitcoin_expiration_blockheight={})".format(self.destination, self.liquid_expiration_blockheight, self.bitcoin_expiration_blockheight)
...
class _UniffiConverterTypeReceivePaymentResponse(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return ReceivePaymentResponse(
            destination=_UniffiConverterString.read(buf),
            liquid_expiration_blockheight=_UniffiConverterOptionalUInt32.read(buf),
            bitcoin_expiration_blockheight=_UniffiConverterOptionalUInt32.read(buf),
        )
...
class PaymentDetails:
    ...
    class BITCOIN:
        ...
        bitcoin_expiration_blockheight: "int"
        liquid_expiration_blockheight: "int"
        ...
        def __init__(self,swap_id: "str", bitcoin_address: "str", description: "str", auto_accepted_fees: "bool", bitcoin_expiration_blockheight: "int", liquid_expiration_blockheight: "int", lockup_tx_id: "typing.Optional[str]", claim_tx_id: "typing.Optional[str]", refund_tx_id: "typing.Optional[str]", refund_tx_amount_sat: "typing.Optional[int]"):
            self.swap_id = swap_id
...
class _UniffiConverterTypePaymentDetails(_UniffiConverterRustBuffer):
    ...
    def check_lower(value):
        ...
        if value.is_bitcoin():
            ...
            _UniffiConverterUInt32.check_lower(value.bitcoin_expiration_blockheight)
            _UniffiConverterUInt32.check_lower(value.liquid_expiration_blockheight)
    ...
    def write(value, buf):
        ...
        if value.is_bitcoin():
            ...
            _UniffiConverterUInt32.write(value.bitcoin_expiration_blockheight, buf)
            _UniffiConverterUInt32.write(value.liquid_expiration_blockheight, buf)
