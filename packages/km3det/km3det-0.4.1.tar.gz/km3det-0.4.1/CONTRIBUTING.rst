...
https://git.km3net.de/km3py/km3det/issues

You can browse all the issues here: https://git.km3net.de/km3py/km3det/issues
...
Check out our KanBan board https://git.km3net.de/km3py/km3det/boards,
...
Go to https://git.km3net.de/km3py/km3det and click on "Fork".

After that, you will have a full copy of the code with write access under an URL
like this: ``https://git.km3net.de/YOUR_USERNAME/km3det``
...
Go to https://git.km3net.de/km3py/km3det/merge_requests/new and select your
