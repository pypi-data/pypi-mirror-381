...
try:
    ...
    version = get_version("km3det")
except ImportError:
    from pkg_resources import get_distribution

    version = get_distribution("km3det").version

# -- Project information -----------------------------------------------------
short_version = ".".join(version.split(".")[:2])
project = "km3det {}".format(short_version)
...
html_title = "km3det {}".format(version)
