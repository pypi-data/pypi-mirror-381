...
from databricks.ml_features.utils import request_context, utils, validation_utils
...
from databricks.ml_features.utils.feature_serving_endpoint_utils import (
    ...
    validate_endpoint_name_specified,
)
...
class FeatureStoreClient:
    ...
    .. note::
        Use :class:`Databricks FeatureEngineeringClient <databricks.feature_engineering.client.FeatureEngineeringClient>` for feature tables in Unity Catalog
    """
    ...
    def __init__(
        ...
        self._publish_client = PublishClient(
            ...
            spark_client=self._spark_client,
            spark_client_helper=self._spark_client_helper,
            workspace_client=None,  # WorkspaceClient is only used by FeatureEngineeringClient
        )
        ...
        **kwargs,
        ...
        return self._compute_client._create_table(
            ...
            req_context=RequestContext(
                ...
                request_context.FEATURE_STORE_CLIENT,
            ),
        )
    ...
    def create_table(
        ...
        **kwargs,
        ...
        :param timestamp_keys: Columns containing the event time associated with feature value.
          Timestamp keys should be part of the primary keys.
          Combined, the timestamp keys and other primary keys of the feature table uniquely identify the feature value
        ...
        return self._compute_client.create_table(
            ...
            description=description,
            tags=tags,
            client_name=request_context.FEATURE_STORE_CLIENT,
            **kwargs,
        )
    ...
    def register_table(
        ...
        *,
        ...
        :param delta_table: A Delta table name. The table must exist in the metastore.
          For workspace-local table, the format is ``<database_name>.<table_name>``, for example ``dev.user_features``.
          For table in Unity Catalog, the format is ``<catalog_name>.<schema_name>.<table_name>``, for example ``ml.dev.user_features``.
        ...
        :return: A :class:`FeatureTable <databricks.ml_features.entities.feature_table.FeatureTable>` object.
        """
    ...
    def get_table(self, name: str) -> FeatureTable:
        ...
        return self._compute_client.get_table(
            name=name,
            req_context=RequestContext(
                request_context.GET_TABLE, request_context.FEATURE_STORE_CLIENT
            ),
        )
    ...
    def drop_table(self, name: str) -> None:
        ...
        self._compute_client.drop_table(
            name=name, client_name=request_context.FEATURE_STORE_CLIENT
        )
    ...
    def get_feature_table(self, name: str) -> FeatureTable:
        ...
        return self._compute_client.get_table(
            name=name,
            req_context=RequestContext(
                request_context.GET_FEATURE_TABLE, request_context.FEATURE_STORE_CLIENT
            ),
        )
    ...
    def read_table(self, name: str, **kwargs) -> DataFrame:
        ...
        return self._compute_client.read_table(
            name=name, client_name=request_context.FEATURE_STORE_CLIENT, **kwargs
        )
    ...
    def write_table(
        ...
        :param name: A feature table name. Raises an exception if this feature table does not exist.
          For workspace-local feature table, the format is ``<database_name>.<table_name>``, for example ``dev.user_features``.
          For feature table in Unity Catalog, the format is ``<catalog_name>.<schema_name>.<table_name>``, for example ``ml.dev.user_features``.
        ...
        return self._compute_client.write_table(
            ...
            req_context=RequestContext(
                request_context.WRITE_TABLE, request_context.FEATURE_STORE_CLIENT
            ),
        )
    ...
    def add_data_sources(
        ...
        *,
        ...
        if uc_utils.is_uc_entity(feature_table_name):
            raise uc_utils.unsupported_api_error_uc("add_data_sources")
        req_context = RequestContext(
            request_context.ADD_DATA_SOURCES, request_context.FEATURE_STORE_CLIENT
        )
    ...
    def delete_data_sources(
        ...
        *,
        ...
        .. Note::
            ...
            Deleting data sources is NOT supported for feature tables in Unity Catalog.
        ...
        if uc_utils.is_uc_entity(feature_table_name):
            raise uc_utils.unsupported_api_error_uc("delete_data_sources")
        req_context = RequestContext(
            request_context.DELETE_DATA_SOURCES, request_context.FEATURE_STORE_CLIENT
        )
        feature_table = self._catalog_client.get_feature_table(
            feature_table_name, req_context
        )
    ...
    def publish_table(
        ...
        *,
        ...
        # format mode string to lowercase. This means customers can use "MERGE", "merge", etc.
    ...
    def create_training_set(
        ...
        **kwargs,
        ...
        """
        Create a :class:`TrainingSet <databricks.ml_features.training_set.TrainingSet>`.
        ...
        # Rename parameter feature_lookups to features. feature_lookups may contain either:
        # documented type FeatureLookup (as the parameter name suggests), or undocumented type FeatureFunctions.
    ...
    def create_feature_serving_endpoint(
        ...
        *,
        ...
        return self._feature_serving_endpoint_client.create_feature_serving_endpoint(
            name,
            format_endpoint_core_config(config, self._spark_client),
            client_name=request_context.FEATURE_STORE_CLIENT,
        )
    ...
    def get_feature_serving_endpoint(
        ...
        return self._feature_serving_endpoint_client.get_feature_serving_endpoint(name)
    ...
    def delete_feature_serving_endpoint(self, *, name=None, **kwargs) -> None:
        ...
        legacy_endpoint_name = kwargs.get("endpoint_name")
        name = format_feature_serving_endpoint_name(name, legacy_endpoint_name, _logger)
        self._feature_serving_endpoint_client.delete_feature_serving_endpoint(name)
    ...
    def delete_feature_spec(self, *, name: str) -> None:
        ...
        self._databricks_client.delete_uc_function(full_spec_name)
