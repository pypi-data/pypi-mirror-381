"""
Setup script for types-boto3-cloudformation.
...
setup(
    ...
    version="1.40.44",
    packages=["types_boto3_cloudformation"],
    url="https://github.com/youtype/mypy_boto3_builder",
    license="MIT License",
    author="Vlad Emelianov",
    author_email="vlad.emelianov.nz@gmail.com",
    description="Type annotations for boto3 CloudFormation 1.40.44 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    package_data={"types_boto3_cloudformation": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
