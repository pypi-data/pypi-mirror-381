...
class IndexingSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["algorithm", "fft_max_unit_cell_A", "fft_min_unit_cell_A", "fft_high_resolution_A", "fft_num_vectors", "tolerance", "thread_count", "geom_refinement_algorithm", "unit_cell_dist_tolerance", "index_ice_rings"]
