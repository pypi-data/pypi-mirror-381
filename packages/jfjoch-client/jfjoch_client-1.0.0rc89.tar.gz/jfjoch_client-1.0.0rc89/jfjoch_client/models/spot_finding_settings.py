...
class SpotFindingSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enable", "indexing", "signal_to_noise_threshold", "photon_count_threshold", "min_pix_per_spot", "max_pix_per_spot", "high_resolution_limit", "low_resolution_limit", "high_resolution_limit_for_spot_count_low_res", "quick_integration", "ice_ring_width_q_recipA"]
