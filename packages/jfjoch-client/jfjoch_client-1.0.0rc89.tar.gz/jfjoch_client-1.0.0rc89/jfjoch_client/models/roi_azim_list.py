...
class RoiAzimList(BaseModel):
    """
    List of azimuthal ROIs
    """ # noqa: E501
    rois: Optional[Annotated[List[RoiAzimuthal], Field(max_length=12)]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rois": [RoiAzimuthal.from_dict(_item) for _item in obj["rois"]] if obj.get("rois") is not None else None
        })
        return _obj
