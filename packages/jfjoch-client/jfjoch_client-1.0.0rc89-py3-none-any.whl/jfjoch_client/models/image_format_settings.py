...
"""
    ...
    The version of the OpenAPI document: 1.0.0-rc.89
...
class ImageFormatSettings(BaseModel):
    ...
    bit_depth_image: Optional[StrictInt] = Field(default=None, description="Bit depth of resulting image (it doesn't affect the detector read-out value) If not provided value is adjusted automatically ")
    ...
    jungfrau_mask_pixels_without_g0: Optional[StrictBool] = Field(default=True, description="JUNGFRAU: mask pixels that don't operate in G0, but do operate in G1 and G1. This should be turned off for cases, where detector is operated at room temperature with long exposure time. ")
    apply_mask: StrictBool = Field(description="Masked pixels are set to special value in the images produced by Jungfraujoch ")
    ...
    __properties: ClassVar[List[str]] = ["summation", "geometry_transform", "jungfrau_conversion", "jungfrau_conversion_factor_keV", "bit_depth_image", "signed_output", "mask_module_edges", "mask_chip_edges", "jungfrau_mask_pixels_without_g0", "apply_mask", "jungfrau_pedestal_g0_rms_limit"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jungfrau_mask_pixels_without_g0": obj.get("jungfrau_mask_pixels_without_g0") if obj.get("jungfrau_mask_pixels_without_g0") is not None else True,
            "apply_mask": obj.get("apply_mask") if obj.get("apply_mask") is not None else False,
