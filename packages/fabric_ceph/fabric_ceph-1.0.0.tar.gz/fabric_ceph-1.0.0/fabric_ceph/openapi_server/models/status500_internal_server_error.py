...
from fabric_ceph.openapi_server.models.status500_internal_server_error_errors import Status500InternalServerErrorErrors  # noqa: E501
...
class Status500InternalServerError(Model):
    ...
    def __init__(self, errors=None, type='error', size=1, status=500):  # noqa: E501
        """Status500InternalServerError - a model defined in OpenAPI
