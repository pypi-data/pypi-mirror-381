...
from fabric_ceph.openapi_server.models.status401_unauthorized_errors import Status401UnauthorizedErrors  # noqa: E501
...
class Status401Unauthorized(Model):
    ...
    def __init__(self, errors=None, type='error', size=1, status=401):  # noqa: E501
        """Status401Unauthorized - a model defined in OpenAPI
