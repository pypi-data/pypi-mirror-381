...
from fabric_ceph.openapi_server.models.status404_not_found_errors import Status404NotFoundErrors  # noqa: E501
...
class Status404NotFound(Model):
    ...
    def __init__(self, errors=None, type='error', size=1, status=404):  # noqa: E501
        """Status404NotFound - a model defined in OpenAPI
