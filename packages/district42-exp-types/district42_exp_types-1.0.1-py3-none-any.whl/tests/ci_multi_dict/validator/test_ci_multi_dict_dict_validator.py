...
def test_ci_multi_dict_no_keys_validation():
    with given:
...
def test_ci_multi_dict_keys_validation():
    with given:
        sch = schema_ci_multi_dict({
            "id": schema.int,
            "name": schema.str,
...
def test_ci_multi_dict_extra_key_validation_error():
    with given:
        sch = schema_ci_multi_dict({})
        value = {"id": 1}
...
def test_ci_multi_dict_missing_key_validation_error():
    with given:
        sch = schema_ci_multi_dict({
            "id": schema.int,
            "name": schema.str,
...
def test_ci_multi_dict_nested_keys_validation():
    with given:
        sch = schema_ci_multi_dict({
            "result": schema_ci_multi_dict({
                "id": schema.int,
                "name": schema.str,
            })
        })
...
def test_ci_multi_dict_nested_extra_key_valudidation_error():
    with given:
        sch = schema_ci_multi_dict({
            "result": schema_ci_multi_dict({
                "id": schema.int,
...
def test_ci_multi_dict_nested_missing_key_valudidation_error():
    with given:
        sch = schema_ci_multi_dict({
            "result": schema_ci_multi_dict({
                "id": schema.int,
